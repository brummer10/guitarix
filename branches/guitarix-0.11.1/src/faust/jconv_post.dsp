...
dry = 1 - wet;
deltadelay = vslider("diff_delay[name:Delta Delay][tooltip:delay left or right channel by the specified amount (unit: ms)]",   0, -10, 10, 0.01)*millisec : smoothi(0.999);
