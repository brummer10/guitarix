...
#define GX_IS_SMALL_KNOB_R_CLASS(obj) (G_TYPE_CHECK_CLASS_TYPE ((klass),  GX_TYPE_SMALL_KNOB_R))
#define GX_SMALL_KNOB_R_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), GX_TYPE_SMALL_KNOB_R, GxSmallKnobRClass))

typedef struct _GxSmallKnobR GxSmallKnobR;
typedef struct _GxSmallKnobRClass GxSmallKnobRClass;

struct _GxSmallKnobR {
	GxKnob parent;
};

struct _GxSmallKnobRClass {
