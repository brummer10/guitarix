...
#ifndef _GXWMM_WHEEL_VERTICAL_H
#define _GXWMM_WHEEL_VERTICAL_H
...
class WheelVertical: public Gxw::Regler {
  ...
  virtual ~WheelVertical();

#ifndef DOXYGEN_SHOULD_SKIP_THIS

private:
  friend class WheelVertical_Class;
  static CppClassType wheel_vertical_class_;

  // noncopyable
  WheelVertical(const WheelVertical&);
  WheelVertical& operator=(const WheelVertical&);
...
private:
	...
	public:
	WheelVertical();
	explicit WheelVertical(Gtk::Adjustment& adjustment);
