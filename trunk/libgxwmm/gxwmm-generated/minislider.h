...
using GxMiniSlider = struct _GxMiniSlider;
using GxMiniSliderClass = struct _GxMiniSliderClass;
...
class MiniSlider: public Gxw::HSlider {
  ...
  MiniSlider(MiniSlider&& src) noexcept;
  MiniSlider& operator=(MiniSlider&& src) noexcept;

  // noncopyable
  MiniSlider(const MiniSlider&) = delete;
  MiniSlider& operator=(const MiniSlider&) = delete;

  ~MiniSlider() noexcept override;
...
private:
	...
	public:
	MiniSlider();
	explicit MiniSlider(const Glib::RefPtr<Gtk::Adjustment>& adjustment);
