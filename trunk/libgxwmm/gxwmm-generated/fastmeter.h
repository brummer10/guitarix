...
/** Size of meter.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< bool > property_horiz() ;
...
/** Meter is drawn horizontally.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< bool > property_horiz() const;

        /** Type of meter: 0->stand-alone; 1->stereo left; 2->stereo right;.
   *
   * Default value: 0
   *
   * @return A PropertyProxy that allows you to get or set the value of the property,
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy< int > property_type() ;
...
/** Type of meter: 0->stand-alone; 1->stereo left; 2->stereo right;.
   ...
   * or receive notification when the value of the property changes.
   */
  Glib::PropertyProxy_ReadOnly< int > property_type() const;
