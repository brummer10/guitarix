...
using GxHSlider = struct _GxHSlider;
using GxHSliderClass = struct _GxHSliderClass;
...
class HSlider: public Gxw::Regler {
  ...
  HSlider(HSlider&& src) noexcept;
  HSlider& operator=(HSlider&& src) noexcept;

  // noncopyable
  HSlider(const HSlider&) = delete;
  HSlider& operator=(const HSlider&) = delete;

  ~HSlider() noexcept override;
...
private:
	...
	public:
	HSlider();
	explicit HSlider(const Glib::RefPtr<Gtk::Adjustment>& adjustment);
