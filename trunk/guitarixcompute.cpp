...
public:
	...
	virtual void instanceInit(int samplingFreq) 
	{
		...
		fConst12 = expf((0 - (314.159271f / fSamplingFreq)));
		fslider16 = 440.0f;
		fConst13 = (6.283185f / fSamplingFreq);
		fslider17 = 1.0f;
		fConst14 = (0.5f * (1 - (fConst12 * fConst12)));
    ...
    virtual void buildUserInterface(UI* interface)
    {
        ...
        interface->closeBox();
        interface->addHorizontalSlider("balance", &fslider20, 0.f, -1.f, 1.f, 1.e-01f);
        interface->openFrameBox("");
        interface->openExpanderBox(" jconv ", &fexpand2);
        interface->openHandleBox("  ");
        interface->openVerticalBox("");
	interface->addHorizontalSlider("wet/dry", &fslider19,  0.f, -1.f, 1.f, 1.e-01f);
        ...
        interface->addVerticalSlider("out", &fslider13, 0.f, -40.f, 40.f, 0.1f);
        interface->closeBox();
...
//	interface->setReset(&fslider9, 0.64f, &fslider8, 1.000000e-02f, &fslider10, 2.0f, &fentry1, 130.0f, &fentry0, 5000.0f,  &fcheckbox2, 1.0, &fslider6, 5000.0f, &fslider7, 130.0f, &fcheckbox3, 1.0, &fslider4, 0.12f, &fslider5, 1.0f);
        interface->openHandleBox("  ");
        interface->addVerticalSlider("  drive ", &fslider9, 0.64f, 0.f, 1.f, 1.e-02f);
        ...
        interface->addVerticalSlider("RoomSize", &fslider12, 0.500000f, 0.000000f, 1.000000f, 2.500000e-02f);
       ...
       // interface->closeBox();
        ...
        interface->openHorizontalBox("");
        interface->addVerticalSlider("freq", &fslider16, 440.000000f, 20.000000f, 2200.000000f, 10.000000f);
        interface->addVerticalSlider("peak", &fslider17, 1.000000f, 0.000000f, 10.000000f, 0.200000f);
        interface->closeBox();
       ...
       // interface->closeBox();      
        ...
        interface->addHorizontalSlider(" feedforward", &fslider18, 0.000000f, -1.000000f, 1.000000f, 1.000000e-02f);
        interface->openFrameBox("");
		...
		virtual void compute (int count, float** input, float** output) 
		{
			...
			float 	fSlow58 = powf(2.0f, (2.3f * fSlow56));
			float 	fSlow59 = (1 - (fConst10 * (fSlow58 / powf(2.0f, (1.0f + (2.0f * (1.0f - fSlow56)))))));
			float 	fSlow60 = (9.999871e-04f * (0 - (2.0f * (fSlow59 * cosf((fConst9 * fSlow58))))));
			float 	fSlow61 = (9.999871e-04f * (fSlow59 * fSlow59));
			int 	iSlow62 = int(fcheckbox5);
			float 	fSlow63 = (0.7f + (0.28f * fslider12));
			int 	iSlow64 = int(fcheckbox6);
			float 	fSlow65 = (9.999871e-04f * powf(10, (5.000000e-02f * fslider13)));
			int 	iSlow66 = int((1 + int((int((int((fConst11 * fslider14)) - 1)) & 131071))));
			float 	fSlow67 = (1.000000e-02f * fslider15);
			int 	iSlow68 = int(fcheckbox7);
			float 	fSlow69 = (2 * cosf((fConst13 * fslider16)));
			float 	fSlow70 = (fConst14 * fslider17);
			int 	iSlow71 = int(fcheckbox8);
			float 	fSlow72 = fslider18;
			float 	fSlow73 = fslider19;
			float 	fSlow74 = (1 - max(0, (0 - fSlow73)));
			float 	fSlow75 = fslider20;
			float 	fSlow76 = (1 - max(0, fSlow75));
			float 	fSlow77 = (fSlow76 * fSlow74);
			float 	fSlow78 = (1 - max(0, fSlow73));
			float 	fSlow79 = (fSlow76 * fSlow78);
			int 	iSlow80 = int(checkbox7);
			float 	fSlow81 = (1 - max(0, (0 - fSlow75)));
			float 	fSlow82 = (fSlow81 * fSlow74);
			float 	fSlow83 = (fSlow81 * fSlow78);
			...
			for (int i=0; i<count; i++) {
				...
				fRec20[0] = (fSlow60 + (0.999f * fRec20[1]));
				fRec21[0] = (fSlow61 + (0.999f * fRec21[1]));
				fRec18[0] = (0 - (((fRec21[0] * fRec18[2]) + (fRec20[0] * fRec18[1])) - (fRec1[0] * fRec19[0])));
				S3[1] = (fRec18[0] - fRec18[1]);
				float fTemp8 = S3[iSlow62];
				S2[0] = fTemp8;
				fRec31[0] = (0.5f * (fRec30[1] + fRec31[1]));
				float fTemp9 = (1.500000e-02f * fTemp8);
				fVec10[IOTA&2047] = (fTemp9 + (fSlow63 * fRec31[0]));
				fRec30[0] = fVec10[(IOTA-1640)&2047];
				fRec33[0] = (0.5f * (fRec32[1] + fRec33[1]));
				fVec11[IOTA&2047] = (fTemp9 + (fSlow63 * fRec33[0]));
				fRec32[0] = fVec11[(IOTA-1580)&2047];
				fRec35[0] = (0.5f * (fRec34[1] + fRec35[1]));
				fVec12[IOTA&2047] = (fTemp9 + (fSlow63 * fRec35[0]));
				fRec34[0] = fVec12[(IOTA-1514)&2047];
				fRec37[0] = (0.5f * (fRec36[1] + fRec37[1]));
				fVec13[IOTA&2047] = (fTemp9 + (fSlow63 * fRec37[0]));
				fRec36[0] = fVec13[(IOTA-1445)&2047];
				fRec39[0] = (0.5f * (fRec38[1] + fRec39[1]));
				fVec14[IOTA&2047] = (fTemp9 + (fSlow63 * fRec39[0]));
				fRec38[0] = fVec14[(IOTA-1379)&2047];
				fRec41[0] = (0.5f * (fRec40[1] + fRec41[1]));
				fVec15[IOTA&2047] = (fTemp9 + (fSlow63 * fRec41[0]));
				fRec40[0] = fVec15[(IOTA-1300)&2047];
				fRec43[0] = (0.5f * (fRec42[1] + fRec43[1]));
				fVec16[IOTA&2047] = (fTemp9 + (fSlow63 * fRec43[0]));
				fRec42[0] = fVec16[(IOTA-1211)&2047];
				fRec45[0] = (0.5f * (fRec44[1] + fRec45[1]));
				fVec17[IOTA&2047] = (fTemp9 + (fSlow63 * fRec45[0]));
				...
				S2[1] = ((0.5f * fRec23) + (1.0075f * fTemp8));
				fRec46[0] = (fSlow65 + (0.999f * fRec46[1]));
				float fTemp11 = (fRec46[0] * S2[iSlow64]);
				S1[0] = fTemp11;
				fRec47[IOTA&262143] = (fTemp11 + (fSlow67 * fRec47[(IOTA-iSlow66)&262143]));
				S1[1] = fRec47[(IOTA-0)&262143];
				float fTemp12 = S1[iSlow68];
				fVec22[0] = fTemp12;
				S0[0] = fVec22[0];
				fRec48[0] = ((fSlow70 * (fVec22[0] - fVec22[2])) + (fConst12 * ((fSlow69 * fRec48[1]) - (fConst12 * fRec48[2]))));
				S0[1] = (fRec48[0] + fVec22[0]);
				float fTemp13 = S0[iSlow71];
				fVec23[0] = fTemp13;
				fRec0[0] = ((fVec23[0] + (fSlow72 * fVec23[3])) - (fSlow0 * fRec0[5]));
				output0[i] = (fSlow77 * fRec0[0]);
				float 	S9[2];
				S9[0] = (fSlow79 * fRec0[0]);
				S9[1] = (fSlow76 * fRec0[0]);
				output1[i] = S9[iSlow80];
				output2[i] = (fSlow82 * fRec0[0]);
				float 	S10[2];
				S10[0] = (fSlow83 * fRec0[0]);
				S10[1] = (fSlow81 * fRec0[0]);
				output3[i] = S10[iSlow80];
				// post processing
