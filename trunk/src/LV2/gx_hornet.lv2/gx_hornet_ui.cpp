...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        .bg =       { 0.13, 0.22, 0.19, 1.00},
        .base =     { 0.13, 0.22, 0.19, 1.00},
    ...
    main->color_scheme->prelight = (Colors) {
        .fg =       { 1.0, 0.0, 1.0, 1.0},
        .bg =       { 0.13, 0.17, 0.19, 1.00},
        .base =     { 0.13, 0.17, 0.19, 1.00},
...
static void draw_window(void *w_, void* user_data) {
    ...
    cairo_set_source_surface (w->crb, w->image,240,15);
    cairo_paint (w->crb);
