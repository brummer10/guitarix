...
void GXPluginGUI::set_skin()
{
  ...
  toparse +=     "'}}\n"
                 ...
                 " { \n"
                 " font_name = 'droid serif italic 8'\n"
                 "    fg[NORMAL] = '#afafaf' \n"
                 " }\n";
  toparse +=     addKnob;
...
void GXPluginGUI::set_plug_name( const char * plugin_uri)
{
  ...
  if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp#12ax7f", plugin_uri) == 0)
    {
      plugskin = "amp26.png";
      plug_name = "12ax7f";
      set_knob("mc-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp#12AT7f", plugin_uri) == 0)
    {
      plugskin = "amp27.png";
      plug_name = "12AT7f";
      set_knob("black-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp#6DJ8f", plugin_uri) == 0)
    {
      plugskin = "amp28.png";
      plug_name = "6DJ8f";
      set_knob("mc-knob");
