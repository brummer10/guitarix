...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        .bg =       { 0.65, 0.22, 0.00, 1.00},
        .base =     { 0.65, 0.22, 0.00, 1.00},
    ...
    main->color_scheme->prelight = (Colors) {
        .fg =       { 1.0, 1.0, 1.0, 1.0},
        .bg =       { 0.42, 0.22, 0.00, 1.00},
        .base =     { 0.42, 0.22, 0.00, 1.00},
