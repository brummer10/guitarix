...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_hfb_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_hfb_GUI *self)
  {
...
void Gx_hfb_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_hfb_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_hfb_gui#_hfb_", plugin_uri) == 0)
    {
      plug_name = "_hfb_";
      //set_knob("nk-knob");
    }
...
{
  Gx_hfb_GUI* self = new Gx_hfb_GUI();
...
{
  Gx_hfb_GUI *pluginGui = static_cast<Gx_hfb_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_hfb_GUI *self = static_cast<Gx_hfb_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_hfb_", instantiate, cleanup, port_event, NULL}
};
