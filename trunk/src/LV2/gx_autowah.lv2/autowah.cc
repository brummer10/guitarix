// generated from file './faust/autowah.dsp' by dsp2cc:
...
#define fslider2 (*fslider2_)
	double 	fSlow0 = (2.384185791015625e-10 * double(fslider0));
	double 	fSlow1 = double(fslider2);
	double 	fSlow2 = (0.01 * (fSlow1 * double(fslider1)));
