...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_mxrdist_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_mxrdist_GUI *self)
  {
...
void Gx_mxrdist_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_mxrdist_GUI::set_skin()
{
  ...
  toparse +=     " style 'guitarix_knobs' {\n"
                 ...
                 "    GxKnob::x_center          = -1\n"
                 "    GxKnob::y_center          = -1\n"
                 "    GxKnob::ring_radius       = 42\n"
                 "    GxKnob::ring_width        = 6\n"
                 "    GxKnob::ring_led_size     = 2\n"
                 "    GxKnob::ring_led_distance = 2\n"
                 "    GxKnob::indicator_radius  = 30\n"
                 "    GxKnob::indicator_width   = 2\n"
...
void Gx_mxrdist_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_mxrdist_gui#_mxrdist_", plugin_uri) == 0)
    {
      plug_name = "MXR Distortion";
      //set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_mxrdist_GUI::make_gui()
{
...
{
  Gx_mxrdist_GUI* self = new Gx_mxrdist_GUI();
...
{
  Gx_mxrdist_GUI *pluginGui = static_cast<Gx_mxrdist_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_mxrdist_GUI *self = static_cast<Gx_mxrdist_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_mxrdist_", instantiate, cleanup, port_event, NULL}
};
