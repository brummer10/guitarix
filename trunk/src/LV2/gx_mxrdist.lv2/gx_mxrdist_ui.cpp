...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        .bg =       { 0.55, 0.39, 0.00, 1.00},
        .base =     { 0.55, 0.39, 0.00, 1.00},
    ...
    main->color_scheme->prelight = (Colors) {
        .fg =       { 1.0, 1.0, 1.0, 1.0},
        .bg =       { 0.23, 0.22, 0.00, 1.00},
        .base =     { 0.23, 0.22, 0.00, 1.00},
    ...
    main->color_scheme->selected = (Colors) {
        .fg =       { 0.9, 0.9, 0.9, 1.0},
        .bg =       { 0.70, 0.40, 0.00, 1.00},
        .base =     { 0.70, 0.40, 0.00, 1.00},
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
    ...
    ui->win->label = "GxMXR Distortion";
    widget_get_png(ui->win, LDVAR(guitarix_dark_png));
    ui->screw = surface_get_png(ui->win, ui->screw, LDVAR(screw_png));
    // connect the expose func
    ui->win->func.expose_callback = draw_window;
    // create knob widgets
    ui->widget[0] = add_my_knob(ui->widget[0], VOLUME,"Volume", ui,40, 25, 80, 105);
    set_adjustment(ui->widget[0]->adj,0.5, 0.5, 0.0, 1.0, 0.01, CL_CONTINUOS);

    ui->widget[1] = add_my_knob(ui->widget[1], DRIVE,"Drive", ui,140, 25, 80, 105);
