...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_mbdelay_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_mbdelay_GUI *self)
  {
...
void Gx_mbdelay_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_mbdelay_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_mbdelay_#_mbdelay_", plugin_uri) == 0)
    {
      plug_name = "_mbdelay_";
      set_knob("nm-knob");
    }
...
GtkWidget* Gx_mbdelay_GUI::make_gui()
{
...
{
  Gx_mbdelay_GUI* self = new Gx_mbdelay_GUI();
...
{
  Gx_mbdelay_GUI *pluginGui = static_cast<Gx_mbdelay_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_mbdelay_GUI *self = static_cast<Gx_mbdelay_GUI*>(ui);
