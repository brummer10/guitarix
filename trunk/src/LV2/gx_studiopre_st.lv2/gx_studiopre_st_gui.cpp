...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(gx_studiopre_stGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(gx_studiopre_stGUI *self)
  {
...
void gx_studiopre_stGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void gx_studiopre_stGUI::set_skin()
{
...
void gx_studiopre_stGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";
...
GtkWidget* gx_studiopre_stGUI::make_gui()
{
...
{
  gx_studiopre_stGUI* self = new gx_studiopre_stGUI();
...
{
  gx_studiopre_stGUI *pluginGui = static_cast<gx_studiopre_stGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  gx_studiopre_stGUI *self = static_cast<gx_studiopre_stGUI*>(ui);
