...
plug_name(plugname)
{
  ...
  make_label(&m_hbox3_, "CHANNEL A", true ) ;
  make_label(&m_hbox3_, "CHANNEL B", true ) ;
  ...
  // Right channel
  m_hbox6_.set_spacing(10);
  m_hbox6_.set_border_width(0);
  m_hbox6_.set_homogeneous(true);
  m_hbox4_.pack_start(m_hbox6_, Gtk::PACK_SHRINK);

  m_vbox7.set_spacing( 6 ) ;
  m_vbox8.set_spacing( 6 ) ;
  ...
  m_hbox6_.pack_start(m_vbox7, Gtk::PACK_SHRINK);
  m_hbox6_.pack_start(m_vbox8, Gtk::PACK_SHRINK);
  m_hbox6_.pack_start(m_vbox9, Gtk::PACK_SHRINK);
  m_hbox6_.pack_start(m_vbox10, Gtk::PACK_SHRINK);
  m_hbox6_.pack_start(m_vbox11, Gtk::PACK_SHRINK);
  ...
  // setup the hBox
//  make_label( &m_hbox2_, "Guitarix Effects", true ) ;
 // make_label( &m_hbox2_, "Redeye", false ) ;
  ...
  m_hbox_.set_size_request( 900 ) ;
  m_paintbox.pack_start(m_hbox_);

  //Add main biox to paintbox
