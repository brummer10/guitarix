...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (3.08e-07 * fSlow15 + fSlow1 * (3.781250000000001e-07 - fSlow2) + fSlow0 * (1.2375000000000003e-05 * fSlow1 + 3.982e-06) + 9.955000000000001e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 4.628250000000001e-11) + fSlow15 * (fSlow4 + 8.470000000000002e-11 * (1.0 - fSlow1));
