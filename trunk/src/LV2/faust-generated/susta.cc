...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst30 = (fConst6 * (1.75646845862514e-15 + (fConst6 * ((fConst6 * (6.98874158230498e-20 - fConst15)) - 1.4095256819997e-16))));
	fConst31 = (1.29152092545966e-14 + (fConst6 * ((fConst6 * (1.47460849525455e-16 + (fConst6 * (fConst17 - 7.00613593632107e-20)))) - 2.81034919192636e-15)));
	fConst32 = (3.30317585349598e-14 + (fConst6 * ((fConst6 * (1.41224926366503e-16 + (fConst6 * (fConst13 - 5.71785438210912e-20)))) - 3.77185698680303e-15)));
...
#define fslider1 (*fslider1_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec14[0] = ((double)input0[i] - ((((((fRec14[1] * (5.7392712832204e-13 + ((fRec13[0] * ((fConst6 * ((fRec12[0] * (fConst68 + (fConst67 * fRec12[0]))) + fConst66)) - 4.74823869654287e-13)) + (fConst6 * ((fRec12[0] * (fConst65 + (fConst64 * fRec12[0]))) + fConst63))))) + (fRec14[2] * (1.14785425664408e-12 + ((fRec13[0] * ((fConst6 * ((fRec12[0] * (fConst62 + (fConst61 * fRec12[0]))) + fConst60)) - 9.49647739308574e-13)) + (fConst6 * ((fRec12[0] * (fConst59 + (fConst58 * fRec12[0]))) + fConst57)))))) + (fRec14[3] * (1.14785425664408e-12 + ((fRec13[0] * ((fConst6 * ((fRec12[0] * (fConst56 + (fConst54 * fRec12[0]))) + fConst52)) - 9.49647739308574e-13)) + (fConst6 * ((fRec12[0] * (fConst50 + (fConst48 * fRec12[0]))) + fConst46)))))) + (fRec14[4] * (5.7392712832204e-13 + ((fRec13[0] * ((fConst6 * ((fRec12[0] * (fConst44 + (fConst42 * fRec12[0]))) + fConst40)) - 4.74823869654287e-13)) + (fConst6 * ((fRec12[0] * (fConst38 + (fConst36 * fRec12[0]))) + fConst34)))))) + (fRec14[5] * (1.14785425664408e-13 + ((fRec13[0] * ((fConst6 * (fConst32 + (fRec12[0] * (fConst31 + (fConst30 * fRec12[0]))))) - 9.49647739308574e-14)) + (fConst6 * ((fRec12[0] * (fConst29 + (fConst28 * fRec12[0]))) + fConst27)))))) / fTemp0));
