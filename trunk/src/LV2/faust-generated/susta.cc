...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst84 = ((fConst1 * (4.02356549528453e-22 - fConst70)) - 1.23525177556824e-17);
	fConst85 = ((fConst1 * (4.02356549528453e-20 - fConst64)) - 1.23525177556824e-15);
	fConst86 = ((fConst1 * (fConst66 - 3.78902721530964e-20)) - 2.68904213585766e-17);
	fConst87 = ((fConst1 * (fConst68 - 3.78902721530964e-22)) - 2.68904213585766e-19);
...
#define fslider1 (*fslider1_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (((((((fRec14[0] * (((fRec13[0] * (fConst91 + (fConst90 * fRec12[0]))) + (fConst89 * fRec12[0])) + fConst88)) + (fRec14[1] * (((fRec13[0] * (fConst87 + (fConst86 * fRec12[0]))) + (fConst85 * fRec12[0])) + fConst84))) + (fRec14[2] * (fConst83 + ((fRec13[0] * (fConst82 + (fConst81 * fRec12[0]))) + (fConst80 * fRec12[0]))))) + (fRec14[3] * (((fRec13[0] * (fConst79 + (fConst77 * fRec12[0]))) + (fConst75 * fRec12[0])) + fConst73))) + (fRec14[4] * (fConst71 + ((fRec13[0] * (fConst69 + (fConst67 * fRec12[0]))) + (fConst65 * fRec12[0]))))) + (fRec14[5] * (((fRec13[0] * (fConst21 + (fConst19 * fRec12[0]))) + (fConst17 * fRec12[0])) + fConst15))) / fTemp0);
		fVec0[0] = fTemp1;
