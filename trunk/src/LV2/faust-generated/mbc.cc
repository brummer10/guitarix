...
#define fVbargraph9 (*fVbargraph9_)
	...
	double fThen5 = std::exp((0.0 - (fConst1 / (iSlow48 ? 1.0 : fSlow47))));
	double fSlow49 = (iSlow48 ? 0.0 : fThen5);
	...
	double fThen7 = std::exp((0.0 - (fConst1 / (iSlow51 ? 1.0 : fSlow46))));
	double fSlow52 = (iSlow51 ? 0.0 : fThen7);
	double fSlow53 = double(fHslider9);
	int iSlow54 = (std::fabs(fSlow53) < 2.2204460492503131e-16);
	double fThen9 = std::exp((0.0 - (fConst1 / (iSlow54 ? 1.0 : fSlow53))));
	double fSlow55 = (iSlow54 ? 0.0 : fThen9);
	...
	double fThen20 = std::exp((0.0 - (fConst1 / (iSlow72 ? 1.0 : fSlow71))));
	double fSlow73 = (iSlow72 ? 0.0 : fThen20);
	...
	double fThen22 = std::exp((0.0 - (fConst1 / (iSlow75 ? 1.0 : fSlow70))));
	double fSlow76 = (iSlow75 ? 0.0 : fThen22);
	double fSlow77 = double(fHslider15);
	int iSlow78 = (std::fabs(fSlow77) < 2.2204460492503131e-16);
	double fThen24 = std::exp((0.0 - (fConst1 / (iSlow78 ? 1.0 : fSlow77))));
	double fSlow79 = (iSlow78 ? 0.0 : fThen24);
	...
	double fThen35 = std::exp((0.0 - (fConst1 / (iSlow96 ? 1.0 : fSlow95))));
	double fSlow97 = (iSlow96 ? 0.0 : fThen35);
	...
	double fThen37 = std::exp((0.0 - (fConst1 / (iSlow99 ? 1.0 : fSlow94))));
	double fSlow100 = (iSlow99 ? 0.0 : fThen37);
	double fSlow101 = double(fHslider21);
	int iSlow102 = (std::fabs(fSlow101) < 2.2204460492503131e-16);
	double fThen39 = std::exp((0.0 - (fConst1 / (iSlow102 ? 1.0 : fSlow101))));
	double fSlow103 = (iSlow102 ? 0.0 : fThen39);
	...
	double fThen50 = std::exp((0.0 - (fConst1 / (iSlow119 ? 1.0 : fSlow118))));
	double fSlow120 = (iSlow119 ? 0.0 : fThen50);
	...
	double fThen52 = std::exp((0.0 - (fConst1 / (iSlow122 ? 1.0 : fSlow117))));
	double fSlow123 = (iSlow122 ? 0.0 : fThen52);
	double fSlow124 = double(fHslider27);
	int iSlow125 = (std::fabs(fSlow124) < 2.2204460492503131e-16);
	double fThen54 = std::exp((0.0 - (fConst1 / (iSlow125 ? 1.0 : fSlow124))));
	double fSlow126 = (iSlow125 ? 0.0 : fThen54);
	...
	double fThen65 = std::exp((0.0 - (fConst1 / (iSlow136 ? 1.0 : fSlow135))));
	double fSlow137 = (iSlow136 ? 0.0 : fThen65);
	...
	double fThen67 = std::exp((0.0 - (fConst1 / (iSlow139 ? 1.0 : fSlow134))));
	double fSlow140 = (iSlow139 ? 0.0 : fThen67);
	double fSlow141 = double(fHslider33);
	int iSlow142 = (std::fabs(fSlow141) < 2.2204460492503131e-16);
	double fThen69 = std::exp((0.0 - (fConst1 / (iSlow142 ? 1.0 : fSlow141))));
	double fSlow143 = (iSlow142 ? 0.0 : fThen69);
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp11 = ((fRec13[1] > fTemp10) ? fSlow55 : fSlow52);
		fRec14[0] = ((fRec14[1] * fTemp11) + (fTemp10 * (1.0 - fTemp11)));
		fRec13[0] = fRec14[0];
		fRec12[0] = ((fRec12[1] * fSlow49) + (fSlow50 * (std::max<double>((fSlow2 + (20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec13[0])))), 0.0) * fSlow56)));
		...
		double fTemp25 = ((fRec29[1] > fTemp24) ? fSlow79 : fSlow76);
		fRec30[0] = ((fRec30[1] * fTemp25) + (fTemp24 * (1.0 - fTemp25)));
		fRec29[0] = fRec30[0];
		fRec28[0] = ((fRec28[1] * fSlow73) + (fSlow74 * (std::max<double>((fSlow59 + (20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec29[0])))), 0.0) * fSlow80)));
		...
		double fTemp38 = ((fRec44[1] > fTemp37) ? fSlow103 : fSlow100);
		fRec45[0] = ((fRec45[1] * fTemp38) + (fTemp37 * (1.0 - fTemp38)));
		fRec44[0] = fRec45[0];
		fRec43[0] = ((fRec43[1] * fSlow97) + (fSlow98 * (std::max<double>((fSlow83 + (20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec44[0])))), 0.0) * fSlow104)));
		...
		double fTemp50 = ((fRec58[1] > fTemp49) ? fSlow126 : fSlow123);
		fRec59[0] = ((fRec59[1] * fTemp50) + (fTemp49 * (1.0 - fTemp50)));
		fRec58[0] = fRec59[0];
		fRec57[0] = ((fRec57[1] * fSlow120) + (fSlow121 * (std::max<double>((fSlow107 + (20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec58[0])))), 0.0) * fSlow127)));
		...
		double fTemp60 = ((fRec70[1] > fTemp59) ? fSlow143 : fSlow140);
		fRec71[0] = ((fRec71[1] * fTemp60) + (fTemp59 * (1.0 - fTemp60)));
		fRec70[0] = fRec71[0];
		fRec69[0] = ((fRec69[1] * fSlow137) + (fSlow138 * (std::max<double>((fSlow130 + (20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec70[0])))), 0.0) * fSlow144)));
