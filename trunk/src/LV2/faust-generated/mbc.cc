...
#define fVbargraph9 (*fVbargraph9_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp12 = (fSlow1 * (fRec3[0] * (iSlow5 ? fTemp8 : (fTemp9 * std::pow(10.0, (0.050000000000000003 * fRec12[0]))))));
		...
		fRec19[0] = (iTemp15 ? std::max<double>(fRec19[1], fTemp21) : fTemp21);
		...
		double fTemp26 = (fSlow58 * (fRec18[0] * (iSlow62 ? fTemp22 : (fTemp23 * std::pow(10.0, (0.050000000000000003 * fRec28[0]))))));
		double fTemp27 = std::max<double>(fConst1, std::fabs(fTemp26));
		fRec15[0] = (iTemp14 ? std::max<double>(fRec15[1], fTemp27) : fTemp27);
		iRec16[0] = (iTemp14 ? (iRec16[1] + 1) : 1);
		...
		fRec35[0] = (iTemp29 ? std::max<double>(fRec35[1], fTemp34) : fTemp34);
		iRec36[0] = (iTemp29 ? (iRec36[1] + 1) : 1);
		...
		double fTemp39 = (fSlow82 * (fRec34[0] * (iSlow86 ? fTemp35 : (fTemp36 * std::pow(10.0, (0.050000000000000003 * fRec43[0]))))));
		double fTemp40 = std::max<double>(fConst1, std::fabs(fTemp39));
		fRec31[0] = (iTemp28 ? std::max<double>(fRec31[1], fTemp40) : fTemp40);
		iRec32[0] = (iTemp28 ? (iRec32[1] + 1) : 1);
		...
		fRec50[0] = (iTemp42 ? std::max<double>(fRec50[1], fTemp46) : fTemp46);
		iRec51[0] = (iTemp42 ? (iRec51[1] + 1) : 1);
		...
		double fTemp51 = (fSlow106 * (fRec49[0] * (iSlow110 ? fTemp47 : (fTemp48 * std::pow(10.0, (0.050000000000000003 * fRec57[0]))))));
		double fTemp52 = std::max<double>(fConst1, std::fabs(fTemp51));
		fRec46[0] = (iTemp41 ? std::max<double>(fRec46[1], fTemp52) : fTemp52);
		iRec47[0] = (iTemp41 ? (iRec47[1] + 1) : 1);
		...
		fRec64[0] = (iTemp54 ? std::max<double>(fRec64[1], fTemp56) : fTemp56);
		iRec65[0] = (iTemp54 ? (iRec65[1] + 1) : 1);
		...
		double fTemp61 = (fSlow129 * (fRec63[0] * (iSlow133 ? fTemp57 : (fTemp58 * std::pow(10.0, (0.050000000000000003 * fRec69[0]))))));
		double fTemp62 = std::max<double>(fConst1, std::fabs(fTemp61));
		fRec60[0] = (iTemp53 ? std::max<double>(fRec60[1], fTemp62) : fTemp62);
		iRec61[0] = (iTemp53 ? (iRec61[1] + 1) : 1);
