...
#define fVbargraph9 (*fVbargraph9_)
	...
	double fSlow46 = 1.0 / std::max<double>(2.2204460492503131e-16, double(fHslider7)) + -1.0;
	double fSlow47 = double(fHslider8);
	double fSlow48 = 0.5 * fSlow47;
	int iSlow49 = std::fabs(fSlow48) < 2.2204460492503131e-16;
	double fThen5 = std::exp(0.0 - fConst1 / ((iSlow49) ? 1.0 : fSlow48));
	double fSlow50 = ((iSlow49) ? 0.0 : fThen5);
	double fSlow51 = 1.0 - fSlow50;
	int iSlow52 = std::fabs(fSlow47) < 2.2204460492503131e-16;
	double fThen7 = std::exp(0.0 - fConst1 / ((iSlow52) ? 1.0 : fSlow47));
	double fSlow53 = ((iSlow52) ? 0.0 : fThen7);
	double fSlow54 = double(fHslider9);
	int iSlow55 = std::fabs(fSlow54) < 2.2204460492503131e-16;
	double fThen9 = std::exp(0.0 - fConst1 / ((iSlow55) ? 1.0 : fSlow54));
	double fSlow56 = ((iSlow55) ? 0.0 : fThen9);
	...
	double fSlow70 = 1.0 / std::max<double>(2.2204460492503131e-16, double(fHslider13)) + -1.0;
	double fSlow71 = double(fHslider14);
	double fSlow72 = 0.5 * fSlow71;
	int iSlow73 = std::fabs(fSlow72) < 2.2204460492503131e-16;
	double fThen20 = std::exp(0.0 - fConst1 / ((iSlow73) ? 1.0 : fSlow72));
	double fSlow74 = ((iSlow73) ? 0.0 : fThen20);
	double fSlow75 = 1.0 - fSlow74;
	int iSlow76 = std::fabs(fSlow71) < 2.2204460492503131e-16;
	double fThen22 = std::exp(0.0 - fConst1 / ((iSlow76) ? 1.0 : fSlow71));
	double fSlow77 = ((iSlow76) ? 0.0 : fThen22);
	double fSlow78 = double(fHslider15);
	int iSlow79 = std::fabs(fSlow78) < 2.2204460492503131e-16;
	double fThen24 = std::exp(0.0 - fConst1 / ((iSlow79) ? 1.0 : fSlow78));
	double fSlow80 = ((iSlow79) ? 0.0 : fThen24);
	...
	double fSlow94 = 1.0 / std::max<double>(2.2204460492503131e-16, double(fHslider19)) + -1.0;
	double fSlow95 = double(fHslider20);
	double fSlow96 = 0.5 * fSlow95;
	int iSlow97 = std::fabs(fSlow96) < 2.2204460492503131e-16;
	double fThen35 = std::exp(0.0 - fConst1 / ((iSlow97) ? 1.0 : fSlow96));
	double fSlow98 = ((iSlow97) ? 0.0 : fThen35);
	double fSlow99 = 1.0 - fSlow98;
	int iSlow100 = std::fabs(fSlow95) < 2.2204460492503131e-16;
	double fThen37 = std::exp(0.0 - fConst1 / ((iSlow100) ? 1.0 : fSlow95));
	double fSlow101 = ((iSlow100) ? 0.0 : fThen37);
	double fSlow102 = double(fHslider21);
	int iSlow103 = std::fabs(fSlow102) < 2.2204460492503131e-16;
	double fThen39 = std::exp(0.0 - fConst1 / ((iSlow103) ? 1.0 : fSlow102));
	double fSlow104 = ((iSlow103) ? 0.0 : fThen39);
	...
	double fSlow117 = 1.0 / std::max<double>(2.2204460492503131e-16, double(fHslider25)) + -1.0;
	double fSlow118 = double(fHslider26);
	double fSlow119 = 0.5 * fSlow118;
	int iSlow120 = std::fabs(fSlow119) < 2.2204460492503131e-16;
	double fThen50 = std::exp(0.0 - fConst1 / ((iSlow120) ? 1.0 : fSlow119));
	double fSlow121 = ((iSlow120) ? 0.0 : fThen50);
	double fSlow122 = 1.0 - fSlow121;
	int iSlow123 = std::fabs(fSlow118) < 2.2204460492503131e-16;
	double fThen52 = std::exp(0.0 - fConst1 / ((iSlow123) ? 1.0 : fSlow118));
	double fSlow124 = ((iSlow123) ? 0.0 : fThen52);
	double fSlow125 = double(fHslider27);
	int iSlow126 = std::fabs(fSlow125) < 2.2204460492503131e-16;
	double fThen54 = std::exp(0.0 - fConst1 / ((iSlow126) ? 1.0 : fSlow125));
	double fSlow127 = ((iSlow126) ? 0.0 : fThen54);
	...
	double fSlow134 = 1.0 / std::max<double>(2.2204460492503131e-16, double(fHslider31)) + -1.0;
	double fSlow135 = double(fHslider32);
	double fSlow136 = 0.5 * fSlow135;
	int iSlow137 = std::fabs(fSlow136) < 2.2204460492503131e-16;
	double fThen65 = std::exp(0.0 - fConst1 / ((iSlow137) ? 1.0 : fSlow136));
	double fSlow138 = ((iSlow137) ? 0.0 : fThen65);
	double fSlow139 = 1.0 - fSlow138;
	int iSlow140 = std::fabs(fSlow135) < 2.2204460492503131e-16;
	double fThen67 = std::exp(0.0 - fConst1 / ((iSlow140) ? 1.0 : fSlow135));
	double fSlow141 = ((iSlow140) ? 0.0 : fThen67);
	double fSlow142 = double(fHslider33);
	int iSlow143 = std::fabs(fSlow142) < 2.2204460492503131e-16;
	double fThen69 = std::exp(0.0 - fConst1 / ((iSlow143) ? 1.0 : fSlow142));
	double fSlow144 = ((iSlow143) ? 0.0 : fThen69);
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fElse0 = std::max<double>(fRec4[1], fTemp7);
		fRec4[0] = ((iTemp1) ? fElse0 : fTemp7);
		int iElse1 = iRec5[1] + 1;
		iRec5[0] = ((iTemp1) ? iElse1 : 1);
		fRec6[0] = ((iTemp1) ? fRec6[1] : fRec4[1]);
		fVbargraph0 = FAUSTFLOAT(fRec6[0]);
		double fTemp8 = fTemp6;
		double fTemp9 = ((iSlow5) ? 0.0 : fTemp8);
		double fTemp10 = std::fabs(fTemp9);
		double fTemp11 = ((fRec13[1] > fTemp10) ? fSlow56 : fSlow53);
		fRec14[0] = fTemp10 * (1.0 - fTemp11) + fTemp11 * fRec14[1];
		fRec13[0] = fRec14[0];
		fRec12[0] = fSlow46 * fSlow51 * std::max<double>(fSlow2 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec13[0])), 0.0) + fSlow50 * fRec12[1];
		double fThen11 = fTemp9 * std::pow(10.0, 0.050000000000000003 * fRec12[0]);
		double fTemp12 = fSlow1 * fRec3[0] * ((iSlow5) ? fTemp8 : fThen11);
		double fTemp13 = std::max<double>(fConst1, std::fabs(fTemp12));
		double fElse12 = std::max<double>(fRec0[1], fTemp13);
		fRec0[0] = ((iTemp0) ? fElse12 : fTemp13);
		int iElse13 = iRec1[1] + 1;
		iRec1[0] = ((iTemp0) ? iElse13 : 1);
		fRec2[0] = ((iTemp0) ? fRec2[1] : fRec0[1]);
		fVbargraph1 = FAUSTFLOAT(fRec2[0]);
		int iTemp14 = iRec16[1] < 4096;
		...
		double fTemp17 = fSlow9 * fTemp16;
		fVec1[0] = fTemp17;
		fRec25[0] = fSlow65 * fVec1[1] - fSlow66 * (fSlow23 * fRec25[1] - fSlow67 * fTemp16);
		fRec24[0] = fRec25[0] - fSlow64 * (fSlow68 * fRec24[2] + fSlow27 * fRec24[1]);
		double fTemp18 = fSlow36 * fRec23[1];
		fRec23[0] = fSlow64 * (fSlow26 * fRec24[0] + fSlow69 * fRec24[1] + fSlow26 * fRec24[2]) - fSlow31 * (fSlow33 * fRec23[2] + fTemp18);
		double fTemp19 = fSlow45 * fRec22[1];
		fRec22[0] = (fRec23[2] + fSlow31 * (fTemp18 + fSlow33 * fRec23[0])) - fSlow40 * (fSlow42 * fRec22[2] + fTemp19);
		double fTemp20 = fRec22[2] + fSlow40 * (fTemp19 + fSlow42 * fRec22[0]);
		double fTemp21 = std::max<double>(fConst1, std::fabs(fTemp20));
		double fElse15 = std::max<double>(fRec19[1], fTemp21);
		fRec19[0] = ((iTemp15) ? fElse15 : fTemp21);
		int iElse16 = iRec20[1] + 1;
		iRec20[0] = ((iTemp15) ? iElse16 : 1);
		fRec21[0] = ((iTemp15) ? fRec21[1] : fRec19[1]);
		fVbargraph2 = FAUSTFLOAT(fRec21[0]);
		double fTemp22 = fTemp20;
		double fTemp23 = ((iSlow62) ? 0.0 : fTemp22);
		double fTemp24 = std::fabs(fTemp23);
		double fTemp25 = ((fRec29[1] > fTemp24) ? fSlow80 : fSlow77);
		fRec30[0] = fTemp24 * (1.0 - fTemp25) + fTemp25 * fRec30[1];
		fRec29[0] = fRec30[0];
		fRec28[0] = fSlow70 * fSlow75 * std::max<double>(fSlow59 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec29[0])), 0.0) + fSlow74 * fRec28[1];
		double fThen26 = fTemp23 * std::pow(10.0, 0.050000000000000003 * fRec28[0]);
		double fTemp26 = fSlow58 * fRec18[0] * ((iSlow62) ? fTemp22 : fThen26);
		double fTemp27 = std::max<double>(fConst1, std::fabs(fTemp26));
		double fElse27 = std::max<double>(fRec15[1], fTemp27);
		fRec15[0] = ((iTemp14) ? fElse27 : fTemp27);
		int iElse28 = iRec16[1] + 1;
		iRec16[0] = ((iTemp14) ? iElse28 : 1);
		fRec17[0] = ((iTemp14) ? fRec17[1] : fRec15[1]);
		fVbargraph3 = FAUSTFLOAT(fRec17[0]);
		int iTemp28 = iRec32[1] < 4096;
		fRec34[0] = fSlow85 + 0.999 * fRec34[1];
		int iTemp29 = iRec36[1] < 4096;
		fRec42[0] = 0.0 - fSlow66 * (fSlow23 * fRec42[1] - (fTemp17 + fVec1[1]));
		fRec41[0] = fRec42[0] - fSlow64 * (fSlow68 * fRec41[2] + fSlow27 * fRec41[1]);
		double fTemp30 = fRec41[2] + fRec41[0] + 2.0 * fRec41[1];
		double fTemp31 = fSlow64 * fTemp30;
		fVec2[0] = fTemp31;
		fRec40[0] = fSlow89 * fVec2[1] - fSlow90 * (fSlow32 * fRec40[1] - fSlow91 * fTemp30);
		fRec39[0] = fRec40[0] - fSlow88 * (fSlow92 * fRec39[2] + fSlow36 * fRec39[1]);
		double fTemp32 = fSlow45 * fRec38[1];
		fRec38[0] = fSlow88 * (fSlow35 * fRec39[0] + fSlow93 * fRec39[1] + fSlow35 * fRec39[2]) - fSlow40 * (fSlow42 * fRec38[2] + fTemp32);
		double fTemp33 = fRec38[2] + fSlow40 * (fTemp32 + fSlow42 * fRec38[0]);
		double fTemp34 = std::max<double>(fConst1, std::fabs(fTemp33));
		double fElse30 = std::max<double>(fRec35[1], fTemp34);
		fRec35[0] = ((iTemp29) ? fElse30 : fTemp34);
		int iElse31 = iRec36[1] + 1;
		iRec36[0] = ((iTemp29) ? iElse31 : 1);
		fRec37[0] = ((iTemp29) ? fRec37[1] : fRec35[1]);
		fVbargraph4 = FAUSTFLOAT(fRec37[0]);
		double fTemp35 = fTemp33;
		double fTemp36 = ((iSlow86) ? 0.0 : fTemp35);
		double fTemp37 = std::fabs(fTemp36);
		double fTemp38 = ((fRec44[1] > fTemp37) ? fSlow104 : fSlow101);
		fRec45[0] = fTemp37 * (1.0 - fTemp38) + fTemp38 * fRec45[1];
		fRec44[0] = fRec45[0];
		fRec43[0] = fSlow94 * fSlow99 * std::max<double>(fSlow83 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec44[0])), 0.0) + fSlow98 * fRec43[1];
		double fThen41 = fTemp36 * std::pow(10.0, 0.050000000000000003 * fRec43[0]);
		double fTemp39 = fSlow82 * fRec34[0] * ((iSlow86) ? fTemp35 : fThen41);
		double fTemp40 = std::max<double>(fConst1, std::fabs(fTemp39));
		double fElse42 = std::max<double>(fRec31[1], fTemp40);
		fRec31[0] = ((iTemp28) ? fElse42 : fTemp40);
		int iElse43 = iRec32[1] + 1;
		iRec32[0] = ((iTemp28) ? iElse43 : 1);
		fRec33[0] = ((iTemp28) ? fRec33[1] : fRec31[1]);
		fVbargraph5 = FAUSTFLOAT(fRec33[0]);
		int iTemp41 = iRec47[1] < 4096;
		fRec49[0] = fSlow109 + 0.999 * fRec49[1];
		int iTemp42 = iRec51[1] < 4096;
		fRec56[0] = 0.0 - fSlow90 * (fSlow32 * fRec56[1] - (fTemp31 + fVec2[1]));
		fRec55[0] = fRec56[0] - fSlow88 * (fSlow92 * fRec55[2] + fSlow36 * fRec55[1]);
		double fTemp43 = fRec55[2] + fRec55[0] + 2.0 * fRec55[1];
		double fTemp44 = fSlow88 * fTemp43;
		fVec3[0] = fTemp44;
		fRec54[0] = fSlow112 * fVec3[1] - fSlow113 * (fSlow41 * fRec54[1] - fSlow114 * fTemp43);
		fRec53[0] = fRec54[0] - fSlow111 * (fSlow115 * fRec53[2] + fSlow45 * fRec53[1]);
		double fTemp45 = fSlow111 * (fSlow44 * fRec53[0] + fSlow116 * fRec53[1] + fSlow44 * fRec53[2]);
		double fTemp46 = std::max<double>(fConst1, std::fabs(fTemp45));
		double fElse45 = std::max<double>(fRec50[1], fTemp46);
		fRec50[0] = ((iTemp42) ? fElse45 : fTemp46);
		int iElse46 = iRec51[1] + 1;
		iRec51[0] = ((iTemp42) ? iElse46 : 1);
		fRec52[0] = ((iTemp42) ? fRec52[1] : fRec50[1]);
		fVbargraph6 = FAUSTFLOAT(fRec52[0]);
		double fTemp47 = fTemp45;
		double fTemp48 = ((iSlow110) ? 0.0 : fTemp47);
		double fTemp49 = std::fabs(fTemp48);
		double fTemp50 = ((fRec58[1] > fTemp49) ? fSlow127 : fSlow124);
		fRec59[0] = fTemp49 * (1.0 - fTemp50) + fTemp50 * fRec59[1];
		fRec58[0] = fRec59[0];
		fRec57[0] = fSlow117 * fSlow122 * std::max<double>(fSlow107 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec58[0])), 0.0) + fSlow121 * fRec57[1];
		double fThen56 = fTemp48 * std::pow(10.0, 0.050000000000000003 * fRec57[0]);
		double fTemp51 = fSlow106 * fRec49[0] * ((iSlow110) ? fTemp47 : fThen56);
		double fTemp52 = std::max<double>(fConst1, std::fabs(fTemp51));
		double fElse57 = std::max<double>(fRec46[1], fTemp52);
		fRec46[0] = ((iTemp41) ? fElse57 : fTemp52);
		int iElse58 = iRec47[1] + 1;
		iRec47[0] = ((iTemp41) ? iElse58 : 1);
		fRec48[0] = ((iTemp41) ? fRec48[1] : fRec46[1]);
		fVbargraph7 = FAUSTFLOAT(fRec48[0]);
		int iTemp53 = iRec61[1] < 4096;
		fRec63[0] = fSlow132 + 0.999 * fRec63[1];
		int iTemp54 = iRec65[1] < 4096;
		fRec68[0] = 0.0 - fSlow113 * (fSlow41 * fRec68[1] - (fTemp44 + fVec3[1]));
		fRec67[0] = fRec68[0] - fSlow111 * (fSlow115 * fRec67[2] + fSlow45 * fRec67[1]);
		double fTemp55 = fSlow111 * (fRec67[2] + fRec67[0] + 2.0 * fRec67[1]);
		double fTemp56 = std::max<double>(fConst1, std::fabs(fTemp55));
		double fElse60 = std::max<double>(fRec64[1], fTemp56);
		fRec64[0] = ((iTemp54) ? fElse60 : fTemp56);
		int iElse61 = iRec65[1] + 1;
		iRec65[0] = ((iTemp54) ? iElse61 : 1);
		fRec66[0] = ((iTemp54) ? fRec66[1] : fRec64[1]);
		fVbargraph8 = FAUSTFLOAT(fRec66[0]);
		double fTemp57 = fTemp55;
		double fTemp58 = ((iSlow133) ? 0.0 : fTemp57);
		double fTemp59 = std::fabs(fTemp58);
		double fTemp60 = ((fRec70[1] > fTemp59) ? fSlow144 : fSlow141);
		fRec71[0] = fTemp59 * (1.0 - fTemp60) + fTemp60 * fRec71[1];
		fRec70[0] = fRec71[0];
		fRec69[0] = fSlow134 * fSlow139 * std::max<double>(fSlow130 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec70[0])), 0.0) + fSlow138 * fRec69[1];
		double fThen71 = fTemp58 * std::pow(10.0, 0.050000000000000003 * fRec69[0]);
		double fTemp61 = fSlow129 * fRec63[0] * ((iSlow133) ? fTemp57 : fThen71);
		double fTemp62 = std::max<double>(fConst1, std::fabs(fTemp61));
		double fElse72 = std::max<double>(fRec60[1], fTemp62);
		fRec60[0] = ((iTemp53) ? fElse72 : fTemp62);
		int iElse73 = iRec61[1] + 1;
		iRec61[0] = ((iTemp53) ? iElse73 : 1);
		fRec62[0] = ((iTemp53) ? fRec62[1] : fRec60[1]);
		fVbargraph9 = FAUSTFLOAT(fRec62[0]);
		output0[i0] = FAUSTFLOAT(fTemp12 + fTemp26 + fTemp39 + fTemp51 + fTemp61);
		fRec3[1] = fRec3[0];
		fVec0[1] = fVec0[0];
		fRec11[1] = fRec11[0];
		fRec10[2] = fRec10[1];
...
void Dsp::connect(uint32_t port,void* data)
{
	...
	case MAKEUPTHRESHOLD5: 
		...
		break;
	case RATIO1: 
		fHslider31_ = (float*)data; // , 2.0, 1.0, 100.0, 0.10000000000000001 
		break;
	case RATIO2: 
		fHslider25_ = (float*)data; // , 2.0, 1.0, 100.0, 0.10000000000000001 
		break;
	case RATIO3: 
		fHslider19_ = (float*)data; // , 2.0, 1.0, 100.0, 0.10000000000000001 
		break;
	case RATIO4: 
		fHslider13_ = (float*)data; // , 2.0, 1.0, 100.0, 0.10000000000000001 
		break;
	case RATIO5: 
		fHslider7_ = (float*)data; // , 2.0, 1.0, 100.0, 0.10000000000000001 
		break;
	case ATTACK1: 
		fHslider32_ = (float*)data; // , 0.012, 0.001, 1.0, 0.001 
		break;
	case ATTACK2: 
		fHslider26_ = (float*)data; // , 0.012, 0.001, 1.0, 0.001 
		break;
	case ATTACK3: 
		fHslider20_ = (float*)data; // , 0.012, 0.001, 1.0, 0.001 
		break;
	case ATTACK4: 
		fHslider14_ = (float*)data; // , 0.012, 0.001, 1.0, 0.001 
		break;
	case ATTACK5: 
		fHslider8_ = (float*)data; // , 0.012, 0.001, 1.0, 0.001 
		break;
	case RELEASE1: 
