...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec46[0] = fConst11 * (fConst10 * fRec46[1] + 0.05 * fTemp32);
		...
		double fTemp35 = (fTemp33 + fTemp34) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec48[1]) + 1e+05);
		fVec8[0] = fTemp35;
		fRec51[0] = fConst67 * (1.5e+03 * (fTemp35 + fVec8[1]) - fConst66 * fRec51[1]);
		fRec48[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp34 + fRec51[0] + fTemp33 + -1.271609) + -45.22606666666667;
		double fTemp36 = fRec48[0] - fRec48[1];
		fRec47[0] = fConst8 * (fConst7 * fTemp36 - fConst3 * fRec47[1]);
		fRec52[0] = fConst11 * (fConst10 * fRec52[1] + 0.05 * fTemp36);
		...
		double fTemp40 = (fTemp38 + fTemp39) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp40;
		fRec53[0] = fConst67 * (1.5e+03 * (fTemp40 + fVec10[1]) - fConst66 * fRec53[1]);
		fRec13[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp39 + fRec53[0] + fTemp38 + -1.271609) + -45.22606666666667;
		double fTemp41 = fRec13[0] - fRec13[1];
		fRec12[0] = fConst8 * (fConst7 * fTemp41 - fConst3 * fRec12[1]);
		fRec54[0] = fConst11 * (fConst10 * fRec54[1] + 0.05 * fTemp41);
		...
		double fTemp44 = (fTemp42 + fTemp43) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp44;
		fRec55[0] = fConst6 * (8.2e+02 * (fTemp44 + fVec11[1]) - fConst5 * fRec55[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp43 + fRec55[0] + fTemp42 + -0.797043) + -32.799634146341475;
		double fTemp45 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst8 * (fConst7 * fTemp45 - fConst3 * fRec0[1]);
		fRec56[0] = fConst11 * (fConst10 * fRec56[1] + 0.05 * fTemp45);
