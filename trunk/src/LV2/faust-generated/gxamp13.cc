...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = (0.024937655860349125 * (fRec29[0] * fTemp17));
		double fTemp20 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow5 * std::max<double>(-0.69999999999999996, std::min<double>(0.69999999999999996, fTemp19)))));
		fRec37[0] = (fTemp19 - (fConst30 * ((fConst35 * fRec37[2]) + (fConst36 * fRec37[1]))));
		double fTemp21 = (fRec37[2] + (fRec37[0] + (2.0 * fRec37[1])));
		fVec3[0] = fTemp21;
		fRec36[0] = ((fConst30 * ((fConst34 * fTemp21) + (fConst37 * fVec3[1]))) - (fConst38 * fRec36[1]));
		...
		fVec4[0] = fTemp22;
		fRec33[0] = ((fConst22 * ((fConst24 * fTemp22) + (fConst43 * fVec4[1]))) - (fConst45 * fRec33[1]));
		fRec32[0] = (fRec33[0] - (fConst17 * ((fConst46 * fRec32[2]) + (fConst47 * fRec32[1]))));
		double fTemp23 = (fConst57 * fRec31[1]);
		fRec31[0] = ((fConst17 * (((fConst19 * fRec32[0]) + (fConst48 * fRec32[1])) + (fConst19 * fRec32[2]))) - (fConst52 * ((fConst54 * fRec31[2]) + fTemp23)));
		double fTemp24 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (fRec31[2] + (fConst52 * (fTemp23 + (fConst54 * fRec31[0])))))));
		...
		double fTemp25 = (fConst47 * fRec39[1]);
		fRec39[0] = ((fConst22 * (((fConst41 * fRec40[0]) + (fConst59 * fRec40[1])) + (fConst41 * fRec40[2]))) - (fConst60 * ((fConst61 * fRec39[2]) + fTemp25)));
		double fTemp26 = (fConst57 * fRec38[1]);
		fRec38[0] = ((fRec39[2] + (fConst60 * (fTemp25 + (fConst61 * fRec39[0])))) - (fConst52 * ((fConst54 * fRec38[2]) + fTemp26)));
		double fTemp27 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec38[2] + (fConst52 * (fTemp26 + (fConst54 * fRec38[0])))))));
		fRec45[0] = (0.0 - (fConst64 * ((fConst44 * fRec45[1]) - (fConst22 * (fTemp22 + fVec4[1])))));
		fRec44[0] = (fRec45[0] - (fConst17 * ((fConst46 * fRec44[2]) + (fConst47 * fRec44[1]))));
		double fTemp28 = (fRec44[2] + (fRec44[0] + (2.0 * fRec44[1])));
		fVec5[0] = fTemp28;
		fRec43[0] = ((fConst17 * ((fConst63 * fTemp28) + (fConst65 * fVec5[1]))) - (fConst66 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst62 * ((fConst67 * fRec42[2]) + (fConst57 * fRec42[1]))));
		double fTemp29 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow9 * (((fConst56 * fRec42[0]) + (fConst68 * fRec42[1])) + (fConst56 * fRec42[2])))));
		fRec47[0] = (0.0 - (fConst69 * ((fConst53 * fRec47[1]) - (fConst17 * (fTemp28 + fVec5[1])))));
		fRec46[0] = (fRec47[0] - (fConst62 * ((fConst67 * fRec46[2]) + (fConst57 * fRec46[1]))));
		double fTemp30 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow10 * (fRec46[2] + (fRec46[0] + (2.0 * fRec46[1]))))));
		...
		fVec6[0] = fTemp31;
		fRec30[0] = (0.0 - (fConst5 * ((fConst6 * fRec30[1]) - (fTemp31 + fVec6[1]))));
		double fTemp32 = ((fTemp17 * ((fTemp18 * ((fSlow2 * ((0.099750623441396499 * (1.0 - std::fabs((0.024937655860349125 * (fTemp18 * fTemp17))))) + -0.024937655860349125)) + 0.024937655860349125)) + (fSlow4 * fRec29[0]))) + ((0.5 * (fTemp20 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp20))))) + (fSlow6 * fRec30[0])));
		fVec7[0] = fTemp32;
		fRec25[0] = ((0.93028479253239138 * (fTemp32 + fVec7[1])) - (0.86056958506478287 * fRec25[1]));
		fRec24[0] = (fRec25[0] - ((1.8405051250752198 * fRec24[1]) + (0.86129424393186271 * fRec24[2])));
		double fTemp33 = (0.92544984225177063 * (fRec24[0] + fRec24[2]));
		double fTemp34 = (1.8508996845035413 * fRec24[1]);
		double fTemp35 = ((fTemp34 + fTemp33) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp35;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp35 + fVec8[1])) - (fConst72 * fRec48[1])));
		double fTemp36 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp33 + (fRec48[0] + fTemp34)) + -1.8639460000000001))));
		fRec23[0] = ((fTemp36 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp36))) + 100000.0))) + -130.0);
		...
		double fTemp37 = (fRec16[0] * fRec49[0]);
		fVec9[0] = fTemp37;
		fRec15[0] = (0.0 - (fConst5 * ((fConst6 * fRec15[1]) - (fTemp37 + fVec9[1]))));
		...
		double fTemp38 = (0.92544984225177063 * (fRec13[0] + fRec13[2]));
		double fTemp39 = (1.8508996845035413 * fRec13[1]);
		double fTemp40 = ((fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp40;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp40 + fVec10[1])) - (fConst12 * fRec50[1])));
		double fTemp41 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp38 + (fRec50[0] + fTemp39)) + -1.271609))));
		fRec12[0] = ((fTemp41 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp41))) + 100000.0))) + -130.0);
		...
		double fTemp42 = (0.92544984225177063 * (fRec2[0] + fRec2[2]));
		double fTemp43 = (1.8508996845035413 * fRec2[1]);
		double fTemp44 = ((fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp44;
		fRec51[0] = (fConst8 * ((820.0 * (fTemp44 + fVec11[1])) - (fConst9 * fRec51[1])));
		double fTemp45 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp42 + (fRec51[0] + fTemp43)) + -0.79704299999999995))));
		fRec1[0] = ((fTemp45 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp45))) + 100000.0))) + -130.0);
