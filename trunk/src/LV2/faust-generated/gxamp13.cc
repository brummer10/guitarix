...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp33 = (fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp33;
		fRec50[0] = fConst71 * (2700.0 * (fTemp33 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(fTemp31 + fRec50[0] + fTemp32 + -1.8639460000000001))) + -60.964962962962957;
		fRec24[0] = 0.050000000000000003 * (fConst4 * fRec25[0] + fConst11 * fRec25[1]) - fConst12 * fRec24[1];
		fRec51[0] = fConst14 * (fConst15 * fRec51[1] + 0.050000000000000003 * (fRec25[0] - fRec25[1]));
		...
		double fTemp37 = (fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp37;
		fRec53[0] = fConst17 * (1500.0 * (fTemp37 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp35 + fRec53[0] + fTemp36 + -1.271609))) + -45.226066666666668;
		fRec12[0] = 0.050000000000000003 * (fConst4 * fRec13[0] + fConst11 * fRec13[1]) - fConst12 * fRec12[1];
		fRec54[0] = fConst14 * (fConst15 * fRec54[1] + 0.050000000000000003 * (fRec13[0] - fRec13[1]));
		...
		fRec1[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp38 + fRec55[0] + fTemp39 + -0.79704299999999995))) + -32.799634146341475;
		fRec0[0] = 0.050000000000000003 * (fConst4 * fRec1[0] + fConst11 * fRec1[1]) - fConst12 * fRec0[1];
		fRec56[0] = fConst14 * (fConst15 * fRec56[1] + 0.050000000000000003 * (fRec1[0] - fRec1[1]));
