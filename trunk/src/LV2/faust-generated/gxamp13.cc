...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp30 = (fTemp28 + fTemp29) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec20[1]) + 1e+05);
		fVec7[0] = fTemp30;
		fRec45[0] = fConst69 * (2.7e+03 * (fTemp30 + fVec7[1]) - fConst68 * fRec45[1]);
		fRec20[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp29 + fRec45[0] + fTemp28 + -1.863946) + -60.96496296296296;
		...
		double fTemp33 = (fTemp31 + fTemp32) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec48[1]) + 1e+05);
		fVec8[0] = fTemp33;
		fRec51[0] = fConst72 * (1.5e+03 * (fTemp33 + fVec8[1]) - fConst71 * fRec51[1]);
		fRec48[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp32 + fRec51[0] + fTemp31 + -1.271609) + -45.22606666666667;
		...
		double fTemp37 = (fTemp35 + fTemp36) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp37;
		fRec53[0] = fConst72 * (1.5e+03 * (fTemp37 + fVec10[1]) - fConst71 * fRec53[1]);
		fRec13[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp36 + fRec53[0] + fTemp35 + -1.271609) + -45.22606666666667;
		...
		double fTemp40 = (fTemp38 + fTemp39) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp40;
		fRec55[0] = fConst7 * (8.2e+02 * (fTemp40 + fVec11[1]) - fConst6 * fRec55[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp39 + fRec55[0] + fTemp38 + -0.797043) + -32.799634146341475;
