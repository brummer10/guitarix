...
#define fVslider2 (*fVslider2_)
	...
	double fSlow3 = 4.7117500000000004e-07 * fSlow2;
	double fSlow4 = 1.1779375000000001e-05 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -4.199450000000001e-06 - fSlow3) + fSlow1 + 5.718000000000001e-06);
	double fSlow6 = 7.343750000000001e-09 * fSlow0;
	double fSlow7 = 4.1125e-11 * fSlow2;
	double fSlow8 = 1.0281250000000001e-09 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -2.52625e-10) + fSlow6 + 2.9375e-10);
	double fSlow10 = 0.0250625 * fSlow0;
	double fSlow11 = 0.00047000000000000004 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.015765);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 2.9375e-10 * fSlow18) + fSlow2 * (fSlow8 + 4.1125e-11 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (9.187500000000001e-07 * fSlow19 + fSlow2 * (5.0055e-07 - fSlow3) + fSlow0 * (1.1779375000000001e-05 * fSlow2 + 2.48125e-06) + 9.925e-08);
	double fSlow23 = fConst0 * (fSlow10 + fSlow11 + 6.25e-05 * fSlow19 + 0.0010025);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-4.199450000000001e-06 - fSlow3)) + 5.718000000000001e-06) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-2.52625e-10 - fSlow7)) + 2.9375e-10)));
