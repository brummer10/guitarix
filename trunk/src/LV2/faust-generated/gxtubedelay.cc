...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst5 = (0.0 - fConst4);
	double fConst6 = std::tan((37699.111843077517 / fConst0));
	double fConst7 = (1.0 / fConst6);
	fConst8 = (1.0 / (((fConst7 + 1.4142135623730949) / fConst6) + 1.0));
	double fConst9 = std::tan((376.99111843077515 / fConst0));
	double fConst10 = (1.0 / fConst9);
	...
	double fConst19 = (2.0824050069881302e-05 * fConst0);
	double fConst20 = (fConst19 + 0.00044559664569599199);
	fConst21 = (fConst0 / fConst20);
	double fConst22 = std::tan((20517.741620594938 / fConst0));
	...
	double fConst34 = std::tan((3769.9111843077517 / fConst0));
	...
	double fConst43 = std::tan((659.73445725385659 / fConst0));
	double fConst44 = (1.0 / fConst43);
	double fConst45 = (fConst44 + 1.0);
	fConst46 = (1.0 / ((fConst45 / fConst43) + 1.0));
	fConst47 = (1.0 - fConst44);
	fConst48 = (1.0 - (fConst47 / fConst43));
	double fConst49 = mydsp_faustpower2_f(fConst43);
	fConst50 = (1.0 / fConst49);
	fConst51 = (2.0 * (1.0 - fConst50));
	double fConst52 = std::tan((270.1769682087222 / fConst0));
...
#define fVslider4 (*fVslider4_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fThen0 = double(input12ax7clip(double(fTemp5)));
		double fElse0 = double(input12ax7_negclip(double(fTemp5)));
		double fTemp6 = ((fConst8 * (fRec3[2] + (fRec3[0] + (2.0 * fRec3[1])))) + (int(signbit(double(fTemp5))) ? fElse0 : fThen0));
		fVec1[(IOTA & 262143)] = fTemp6;
		fRec12[0] = (fSlow3 + (0.99299999999999999 * fRec12[1]));
		double fThen2 = (((fRec14[1] == 1.0) & (fSlow4 != fRec16[1])) ? fConst64 : 0.0);
		double fThen4 = (((fRec14[1] == 0.0) & (fSlow4 != fRec15[1])) ? fConst63 : fThen2);
		double fElse4 = (((fRec14[1] > 0.0) & (fRec14[1] < 1.0)) ? fRec13[1] : 0.0);
		double fTemp7 = ((fRec13[1] != 0.0) ? fElse4 : fThen4);
		fRec13[0] = fTemp7;
		...
		double fThen7 = double(output12ax7clip(double(fTemp11)));
		double fElse7 = double(output12ax7_negclip(double(fTemp11)));
		...
		double fThen8 = double(input12ax7clip(double(fTemp15)));
		double fElse8 = double(input12ax7_negclip(double(fTemp15)));
		double fTemp16 = ((fConst8 * (fRec19[2] + (fRec19[0] + (2.0 * fRec19[1])))) + (int(signbit(double(fTemp15))) ? fElse8 : fThen8));
		...
		double fThen9 = double(output12ax7clip(double(fTemp18)));
		double fElse9 = double(output12ax7_negclip(double(fTemp18)));
		...
		double fThen10 = double(input12ax7clip(double(fTemp21)));
		double fElse10 = double(input12ax7_negclip(double(fTemp21)));
		double fTemp22 = ((fConst8 * (fRec30[2] + (fRec30[0] + (2.0 * fRec30[1])))) + (int(signbit(double(fTemp21))) ? fElse10 : fThen10));
		...
		double fThen11 = double(output12ax7clip(double(fTemp24)));
		double fElse11 = double(output12ax7_negclip(double(fTemp24)));
		...
		double fThen12 = double(input12ax7clip(double(fTemp26)));
		double fElse12 = double(input12ax7_negclip(double(fTemp26)));
		double fTemp27 = ((fConst8 * (fRec40[2] + (fRec40[0] + (2.0 * fRec40[1])))) + (int(signbit(double(fTemp26))) ? fElse12 : fThen12));
		...
		double fThen13 = double(output12ax7clip(double(fTemp29)));
		double fElse13 = double(output12ax7_negclip(double(fTemp29)));
		...
		double fThen14 = double(input12ax7clip(double(fTemp30)));
		double fElse14 = double(input12ax7_negclip(double(fTemp30)));
		double fTemp31 = ((fConst8 * (fRec49[2] + (fRec49[0] + (2.0 * fRec49[1])))) + (int(signbit(double(fTemp30))) ? fElse14 : fThen14));
		...
		double fThen15 = double(output12ax7clip(double(fTemp33)));
		double fElse15 = double(output12ax7_negclip(double(fTemp33)));
		output0[i0] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp11))) ? fElse7 : fThen7) + (int(signbit(double(fTemp18))) ? fElse9 : fThen9)) + (int(signbit(double(fTemp24))) ? fElse11 : fThen11)) + (int(signbit(double(fTemp29))) ? fElse13 : fThen13)) + (int(signbit(double(fTemp33))) ? fElse15 : fThen15))));
		fRec0[1] = fRec0[0];
		fRec4[2] = fRec4[1];
		fRec4[1] = fRec4[0];
		fRec3[2] = fRec3[1];
