...
#define fVslider4 (*fVslider4_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		output0[i0] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp11))) ? double(output12ax7_negclip(double(fTemp11))) : double(output12ax7clip(double(fTemp11)))) + (int(signbit(double(fTemp18))) ? double(output12ax7_negclip(double(fTemp18))) : double(output12ax7clip(double(fTemp18))))) + (int(signbit(double(fTemp24))) ? double(output12ax7_negclip(double(fTemp24))) : double(output12ax7clip(double(fTemp24))))) + (int(signbit(double(fTemp29))) ? double(output12ax7_negclip(double(fTemp29))) : double(output12ax7clip(double(fTemp29))))) + (int(signbit(double(fTemp33))) ? double(output12ax7_negclip(double(fTemp33))) : double(output12ax7clip(double(fTemp33)))))));
		fRec0[1] = fRec0[0];
		fRec4[2] = fRec4[1];
		fRec4[1] = fRec4[0];
		fRec3[2] = fRec3[1];
