...
#define fVslider0 (*fVslider0_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fElse0 = std::max<double>(fRec0[1], fTemp7);
		...
		double fElse3 = std::max<double>(fRec12[1], fTemp15);
		fRec12[0] = (iTemp8 ? fElse3 : fTemp15);
		int iElse4 = (iRec13[1] + 1);
		iRec13[0] = (iTemp8 ? iElse4 : 1);
		...
		double fElse6 = std::max<double>(fRec24[1], fTemp22);
		fRec24[0] = (iTemp16 ? fElse6 : fTemp22);
		int iElse7 = (iRec25[1] + 1);
		iRec25[0] = (iTemp16 ? iElse7 : 1);
		...
		double fElse9 = std::max<double>(fRec35[1], fTemp28);
		fRec35[0] = (iTemp23 ? fElse9 : fTemp28);
		int iElse10 = (iRec36[1] + 1);
		iRec36[0] = (iTemp23 ? iElse10 : 1);
		...
		double fElse12 = std::max<double>(fRec45[1], fTemp32);
		fRec45[0] = (iTemp29 ? fElse12 : fTemp32);
		int iElse13 = (iRec46[1] + 1);
		iRec46[0] = (iTemp29 ? iElse13 : 1);
