...
#define fVbargraph4 (*fVbargraph4_)
	...
	double fSlow40 = 0.0010000000000000009 * double(fHslider4);
	...
	double fSlow44 = 0.0010000000000000009 * double(fHslider7);
	double fSlow45 = 1.0 - fSlow37 / fSlow1;
	double fSlow46 = 1.0 / (fSlow38 / fSlow1 + 1.0);
	double fSlow47 = 1.0 / (fSlow9 * fSlow13);
	double fSlow48 = 0.0010000000000000009 * double(fHslider8);
	double fSlow49 = 0.0010000000000000009 * double(fHslider9);
	...
	double fSlow54 = 0.0010000000000000009 * double(fHslider11);
	double fSlow55 = 1.0 - fSlow31 / fSlow15;
	double fSlow56 = 1.0 / (fSlow32 / fSlow15 + 1.0);
	double fSlow57 = 1.0 / (fSlow23 * fSlow27);
	double fSlow58 = 0.0010000000000000009 * double(fHslider12);
	double fSlow59 = 0.0010000000000000009 * double(fHslider13);
