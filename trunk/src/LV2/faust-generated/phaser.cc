...
#define fHslider7 (*fHslider7_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		float fTemp2 = fRec5[1] * std::cos(fSlow11 * fTemp0);
		float fTemp3 = fRec6[1] * std::cos(fSlow8 * fTemp0);
		float fTemp4 = float(input0[i0]);
		fRec6[0] = fSlow16 * fTemp4 + fSlow15 * fRec0[1] - (fSlow14 * fTemp3 + fSlow13 * fRec6[2]);
		fRec5[0] = fSlow13 * (fRec6[0] - fRec5[2]) + fRec6[2] + fSlow14 * (fTemp3 - fTemp2);
		float fTemp5 = fRec4[1] * std::cos(fSlow10 * fTemp0);
		fRec4[0] = fSlow14 * (fTemp2 - fTemp5) + fRec5[2] + fSlow13 * (fRec5[0] - fRec4[2]);
		fRec1[0] = fSlow13 * (fRec4[0] - fRec1[2]) + fRec4[2] + fSlow14 * (fTemp5 - fTemp1);
		fRec0[0] = fSlow13 * fRec1[0] + fSlow14 * fTemp1 + fRec1[2];
		output0[i0] = FAUSTFLOAT(fSlow16 * fTemp4 * fSlow17 + fRec0[0] * fSlow1);
