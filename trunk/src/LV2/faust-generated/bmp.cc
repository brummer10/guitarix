...
#define fslider2 (*fslider2_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec4[0] = (min(0.801341155829, max(-0.674681752538, (fConst0 * ((((fRec6[0] * (fConst38 + (fConst37 * fRec5[0]))) + (fConst0 * (fRec6[1] * ((0 - (4.52586774307001e-12 * fRec5[0])) - 4.52586774307001e-14)))) + (fRec6[2] * (fConst28 + (fConst26 * fRec5[0])))) / fTemp2)))) - (fConst18 * ((fConst17 * fRec4[1]) + (fConst16 * fRec4[2]))));
		fRec3[0] = (min(0.801341155829, max(-0.674681752538, (fConst18 * (((fConst42 * fRec4[0]) + (fConst41 * fRec4[1])) + (fConst40 * fRec4[2]))))) - (fConst14 * ((fConst13 * fRec3[1]) + (fConst11 * fRec3[2]))));
