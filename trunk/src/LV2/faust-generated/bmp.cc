...
inline void Dsp::init(uint32_t RsamplingFreq)
{
	...
	double fConst3 = (fConst0 * std::sin((75398.223686155034 / fConst0)));
	...
	double fConst8 = (4.3388468105506801e-10 * fConst0);
	double fConst9 = ((fConst0 * (fConst8 + 6.8680901344593704e-09)) + 2.6522670215943701e-08);
	fConst10 = (fConst7 / fConst9);
	double fConst11 = (3.6868885846545499e-10 * fConst0);
	fConst12 = (1.0 / ((fConst0 * (fConst11 + 3.0348555108869402e-06)) + 0.00486780557301784));
	double fConst13 = (3.9204879585950002e-10 * fConst0);
	fConst14 = (1.0 / ((fConst0 * (fConst13 + 2.0047872746271098e-06)) + 0.00048978515761155495));
	double fConst15 = (7.6673121439986096e-12 * fConst0);
	fConst16 = (fConst0 * (fConst15 + -3.9949085717896201e-05));
	double fConst17 = (2.0828770493449602e-05 * fConst0);
	...
	double fConst22 = (1.2821120020392999e-10 * fConst0);
	fConst23 = (fConst22 + -6.2652181541007596e-07);
	double fConst24 = (1.12312054615984e-09 * fConst0);
	fConst25 = (fConst24 + -2.8621970465474001e-06);
	double fConst26 = (1.1344651981412601e-09 * fConst0);
	...
	double fConst31 = (2.26293387153501e-14 * fConst0);
	fConst32 = (fConst31 + -1.17905906929765e-07);
	double fConst33 = (2.26293387153501e-12 * fConst0);
	...
	double fConst41 = (7.3737771693091102e-10 * fConst7);
	...
	double fConst51 = (4435.1896285973553 / fConst3);
...
#define fVslider2 (*fVslider2_)
	...
	for (int i0 = 0; (i0 < ReCount); i0 = (i0 + 1)) {
		fRec5[0] = (double(buf[i0]) - (fConst18 * ((fConst21 * fRec5[2]) + (0.000438032628543473 * fRec5[1]))));
		...
		buf[i0] = FAUSTFLOAT((fConst5 * ((fTemp3 + (fConst52 * fRec0[0])) + (fConst53 * fRec0[2]))));
		fRec5[2] = fRec5[1];
		fRec5[1] = fRec5[0];
		fRec6[1] = fRec6[0];
		fRec4[2] = fRec4[1];
