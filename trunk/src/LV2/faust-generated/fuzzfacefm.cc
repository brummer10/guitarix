...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (7.31444772672817e-10 + ((fRec9[0] * (6.96979875434139e-54 + (fConst1 * ((fRec8[0] * (fConst25 + (fConst23 * fRec8[0]))) + fConst21)))) + (fConst1 * (((fRec8[0] * (fConst19 + (fConst17 * fRec8[0]))) + (fRec10[0] * (((fRec9[0] * (fConst15 + (fConst1 * (fRec8[0] * (fConst13 + (fConst11 * fRec8[0])))))) + (fConst1 * (fRec8[0] * (fConst9 + (fConst7 * fRec8[0]))))) + fConst5))) + fConst3))));
		fRec11[0] = ((0.993 * fRec11[1]) + fSlow3);
		double fTemp3 = (1.63788262077463e-13 * fRec11[0]);
		double fTemp4 = (1.66004130328897e-15 * fRec11[0]);
		double fTemp5 = (1.12927979815576e-15 * fRec11[0]);
		double fTemp6 = (1.11420586447254e-13 * fRec11[0]);
		fRec12[0] = ((double)input0[i] - ((((fRec12[1] * (2.19433431801845e-09 + ((fRec9[0] * (2.09093962630242e-53 + (fConst1 * ((fRec8[0] * (fConst81 + (fConst80 * fRec8[0]))) + fConst79)))) + (fConst1 * (((fRec8[0] * (fConst78 + (fConst77 * fRec8[0]))) + (fRec10[0] * (((fRec9[0] * (fConst76 + (fConst1 * (fRec8[0] * (fConst75 + (fConst74 * fRec8[0])))))) + (fConst1 * (fRec8[0] * (fConst73 + (fConst72 * fRec8[0]))))) + fConst71))) + fConst70))))) + (fRec12[2] * (2.19433431801845e-09 + ((fRec9[0] * (2.09093962630242e-53 + (fConst1 * ((fRec8[0] * (fConst69 + (fConst67 * fRec8[0]))) + fConst65)))) + (fConst1 * (fConst63 + ((fRec8[0] * (fConst61 + (fConst59 * fRec8[0]))) + (fRec10[0] * (((fRec9[0] * (fConst57 + (fConst1 * (fRec8[0] * (fConst55 + (fConst53 * fRec8[0])))))) + (fConst1 * (fRec8[0] * (fConst51 + (fConst49 * fRec8[0]))))) + fConst47))))))))) + (fRec12[3] * (7.31444772672817e-10 + ((fRec9[0] * (6.96979875434139e-54 + (fConst1 * ((fRec8[0] * (fConst45 + (fConst44 * fRec8[0]))) + fConst43)))) + (fConst1 * (((fRec8[0] * (fConst42 + (fConst41 * fRec8[0]))) + (fRec10[0] * (((fRec9[0] * (fConst40 + (fConst1 * (fRec8[0] * (fConst39 + (fConst38 * fRec8[0])))))) + (fConst1 * (fRec8[0] * (fConst37 + (fConst36 * fRec8[0]))))) + fConst35))) + fConst34)))))) / fTemp2));
		double fTemp7 = (4.98012390986691e-15 * fRec11[0]);
		double fTemp8 = (4.91364786232388e-13 * fRec11[0]);
		double fTemp9 = (3.34261759341761e-13 * fRec11[0]);
		double fTemp10 = (3.38783939446729e-15 * fRec11[0]);
		fRec7[0] = ((fConst98 * (((((fRec12[0] * ((((fRec9[0] * (((fConst1 * (fRec8[0] * (1.39275733059067e-13 + ((fRec8[0] * (1.4115997476947e-15 + (0 - fTemp5))) - fTemp6)))) + (fConst97 * fRec11[0])) + fConst96)) + (fConst1 * (fRec8[0] * ((fTemp3 + (fRec8[0] * (fTemp4 - 2.07505162911121e-15))) - 2.04735327596828e-13)))) + (fConst95 * fRec11[0])) + fConst94)) + (fRec12[1] * ((((fRec9[0] * (((fConst1 * (fRec8[0] * ((fTemp9 + (fRec8[0] * (fTemp10 - 4.23479924308411e-15))) - 4.17827199177201e-13))) + (fConst93 * fRec11[0])) + fConst92)) + (fConst1 * (fRec8[0] * (6.14205982790485e-13 + ((fRec8[0] * (6.22515488733364e-15 + (0 - fTemp7))) - fTemp8))))) + (fConst91 * fRec11[0])) + fConst90))) + (fRec12[2] * (fConst89 + (((fRec9[0] * (((fConst1 * (fRec8[0] * (4.17827199177201e-13 + ((fRec8[0] * (4.23479924308411e-15 + (0 - fTemp10))) - fTemp9)))) + (fConst87 * fRec11[0])) + fConst85)) + (fConst1 * (fRec8[0] * ((fTemp8 + (fRec8[0] * (fTemp7 - 6.22515488733364e-15))) - 6.14205982790485e-13)))) + (fConst83 * fRec11[0]))))) + (fRec12[3] * ((((fRec9[0] * (fConst33 + ((fConst1 * (fRec8[0] * ((fTemp6 + (fRec8[0] * (fTemp5 - 1.4115997476947e-15))) - 1.39275733059067e-13))) + (fConst31 * fRec11[0])))) + (fConst1 * (fRec8[0] * (2.04735327596828e-13 + ((fRec8[0] * (2.07505162911121e-15 + (0 - fTemp4))) - fTemp3))))) + (fConst29 * fRec11[0])) + fConst27))) / fTemp2)) - (fTemp1 + fRec7[2]));
		double fTemp11 = (fRec7[2] + (fRec7[0] + fTemp1));
		fVec0[0] = fTemp11;
		fRec6[0] = ((1.0000000000000002 * (fVec0[0] + fVec0[1])) - (0.9999999999999998 * fRec6[1]));
		fRec13[0] = ((fConst102 * fRec13[1]) + (fConst101 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec13[0] + fRec6[0]) - 5.562895)) - 43.96685185185183);
		fRec4[0] = ((fConst107 * fRec4[1]) + (fConst106 * ((fConst103 * fRec5[0]) + (fConst104 * fRec5[1]))));
		fRec3[0] = (fRec4[0] - (fTemp0 + fRec3[2]));
		double fTemp12 = (fRec3[2] + (fRec3[0] + fTemp0));
		fVec1[0] = fTemp12;
		fRec2[0] = ((1.0000000000000002 * (fVec1[0] + fVec1[1])) - (0.9999999999999998 * fRec2[1]));
		fRec14[0] = ((fConst102 * fRec14[1]) + (fConst101 * (fRec1[1] + fRec1[2])));
