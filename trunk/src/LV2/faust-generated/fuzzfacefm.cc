...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst83 = 4.96344910142255e-13 * fConst0;
	fConst84 = 3.79791692463729e-12 - fConst83;
	fConst85 = 6.20431137677819e-13 * fConst0;
	fConst86 = fConst85 + -4.74739615579661e-12;
	fConst87 = 3.37649598736228e-13 * fConst0;
	fConst88 = fConst87 + -2.58361695553557e-12;
	fConst89 = 4.22061998420285e-13 * fConst0;
	...
	fConst99 = 3.141592653589793 / fConst0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp9 = (fRec12[0] * (fRec9[0] * (fConst30 * fRec8[0] * (fRec8[0] * (1.4115997476947e-15 - fTemp3) - fTemp4 + 1.39275733059067e-13) + fConst5 * (fConst98 + fConst97 * fRec11[0])) + fConst30 * fRec8[0] * (fTemp1 + fRec8[0] * (fTemp2 + -2.07505162911121e-15) + -2.04735327596828e-13) + fConst5 * (fConst96 + fConst95 * fRec11[0])) + fRec12[1] * (fRec9[0] * (fConst30 * fRec8[0] * (fTemp7 + fRec8[0] * (fTemp8 + -4.23479924308411e-15) + -4.17827199177201e-13) + fConst5 * (fConst94 + fConst93 * fRec11[0])) + fConst30 * fRec8[0] * (fRec8[0] * (6.22515488733364e-15 - fTemp5) - fTemp6 + 6.14205982790485e-13) + fConst5 * (fConst92 + fConst91 * fRec11[0])) + fRec12[2] * (fRec9[0] * (fConst30 * fRec8[0] * (fRec8[0] * (4.23479924308411e-15 - fTemp8) - fTemp7 + 4.17827199177201e-13) + fConst5 * (fConst90 + fConst88 * fRec11[0])) + fConst30 * fRec8[0] * (fTemp6 + fRec8[0] * (fTemp5 + -6.22515488733364e-15) + -6.14205982790485e-13) + fConst5 * (fConst86 + fConst84 * fRec11[0])) + fRec12[3] * (fRec9[0] * (fConst30 * fRec8[0] * (fTemp4 + fRec8[0] * (fTemp3 + -1.4115997476947e-15) + -1.39275733059067e-13) + fConst5 * (fConst34 + fConst32 * fRec11[0])) + fConst30 * fRec8[0] * (fRec8[0] * (2.07505162911121e-15 - fTemp2) - fTemp1 + 2.04735327596828e-13) + fConst5 * (fConst29 + fConst27 * fRec11[0]))) / fTemp0;
		fVec0[0] = fTemp9;
