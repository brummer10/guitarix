...
#define fVslider2 (*fVslider2_)
	...
	double fSlow3 = 2.9448437500000003e-06 * fSlow2;
	double fSlow4 = 2.9448437500000007e-05 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -8.731718750000001e-06 - fSlow3) + fSlow1 + 1.2916875000000002e-05);
	double fSlow6 = 7.343750000000001e-09 * fSlow0;
	double fSlow7 = 2.5703125000000003e-10 * fSlow2;
	double fSlow8 = 2.5703125000000004e-09 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -4.773437500000001e-10) + fSlow6 + 7.343750000000001e-10);
	double fSlow10 = 0.0250625 * fSlow0;
	double fSlow11 = 0.001175 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.01726875);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 7.343750000000001e-10 * fSlow18) + fSlow2 * (fSlow8 + 2.5703125000000003e-10 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (9.187500000000001e-07 * fSlow19 + fSlow2 * (3.0182812500000004e-06 - fSlow3) + fSlow0 * (2.9448437500000007e-05 * fSlow2 + 2.48125e-06) + 2.48125e-07);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-8.731718750000001e-06 - fSlow3)) + 1.2916875000000002e-05) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-4.773437500000001e-10 - fSlow7)) + 7.343750000000001e-10)));
