...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp17 + (fRec34[0] + fTemp18)) + -1.581656)))) + -191.42014814814814);
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp27 = ((fTemp26 + fTemp25) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp27;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp27 + fVec9[1])) - (fConst70 * fRec36[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp25 + (fRec36[0] + fTemp26)) + -0.84070299999999998)))) + -147.47524390243905);
		...
		double fTemp46 = ((fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec49[1]))) + 100000.0));
		fVec15[0] = fTemp46;
		fRec70[0] = (fConst63 * ((2700.0 * (fTemp46 + fVec15[1])) - (fConst64 * fRec70[1])));
		fRec49[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp44 + (fRec70[0] + fTemp45)) + -1.581656)))) + -191.42014814814814);
		...
		double fTemp50 = ((fTemp49 + fTemp48) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec44[1]))) + 100000.0));
		fVec17[0] = fTemp50;
		fRec71[0] = (fConst66 * ((1500.0 * (fTemp50 + fVec17[1])) - (fConst67 * fRec71[1])));
		fRec44[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp48 + (fRec71[0] + fTemp49)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp54 = ((fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec39[1]))) + 100000.0));
		fVec19[0] = fTemp54;
		fRec72[0] = (fConst69 * ((820.0 * (fTemp54 + fVec19[1])) - (fConst70 * fRec72[1])));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp52 + (fRec72[0] + fTemp53)) + -0.84070299999999998)))) + -147.47524390243905);
