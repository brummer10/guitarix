...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec37[0] = ((fConst67 * fRec37[1]) + (fConst66 * (1e-15 + (fTemp21 + fVec11[1]))));
		...
		fRec49[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec70[0] + (0.9254498422517706 * (fRec50[0] + (fRec50[2] + (2.0 * fRec50[1]))))) - 1.581656)) - 191.42014814814814);
		fRec48[0] = ((fConst31 * fRec48[1]) + (fConst59 * ((fConst27 * fRec49[0]) + (fConst28 * fRec49[1]))));
		double fTemp39 = (fRec35[0] * fRec48[0]);
		fVec18[0] = fTemp39;
		fRec47[0] = ((fConst54 * fRec47[1]) + (fConst53 * (fVec18[0] + fVec18[1])));
		...
		fRec71[0] = ((fConst63 * fRec71[1]) + (fConst62 * (1e-15 + (fTemp40 + fVec20[1]))));
		fRec44[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec71[0] + (0.9254498422517706 * (fRec45[0] + (fRec45[2] + (2.0 * fRec45[1]))))) - 1.204285)) - 169.71433333333334);
		fRec43[0] = ((fConst31 * fRec43[1]) + (fConst59 * ((fConst27 * fRec44[0]) + (fConst28 * fRec44[1]))));
		double fTemp41 = (fRec35[0] * fRec43[0]);
		fVec21[0] = fTemp41;
		fRec42[0] = ((fConst54 * fRec42[1]) + (fConst53 * (fVec21[0] + fVec21[1])));
		...
		fRec72[0] = ((fConst67 * fRec72[1]) + (fConst66 * (1e-15 + (fTemp42 + fVec23[1]))));
		fRec39[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec72[0] + (0.9254498422517706 * (fRec40[0] + (fRec40[2] + (2.0 * fRec40[1]))))) - 0.840703)) - 147.47524390243905);
		fRec38[0] = ((fConst31 * fRec38[1]) + (fConst59 * ((fConst27 * fRec39[0]) + (fConst28 * fRec39[1]))));
		output1[i] = (FAUSTFLOAT)(fRec0[0] * fRec38[0]);
		// post processing
		fRec38[1] = fRec38[0];
		fRec39[1] = fRec39[0];
		fRec72[1] = fRec72[0];
