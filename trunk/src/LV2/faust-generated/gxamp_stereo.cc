...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AX7_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec33[0] = fConst55 * (2.7e+03 * (fTemp19 + fVec5[1]) - fConst54 * fRec33[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp18 + fRec33[0] + fTemp17 + -1.581656) + -191.42014814814814;
		...
		double fTemp24 = (fTemp22 + fTemp23) / (Ranode(TUBE_TABLE_12AX7_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp24;
		fRec36[0] = fConst62 * (1.5e+03 * (fTemp24 + fVec7[1]) - fConst61 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp23 + fRec36[0] + fTemp22 + -1.204285) + -169.71433333333334;
		...
		double fTemp29 = (fTemp27 + fTemp28) / (Ranode(TUBE_TABLE_12AX7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp29;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp29 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp28 + fRec38[0] + fTemp27 + -0.840703) + -147.47524390243905;
		double fTemp30 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst32 * (fConst56 * fTemp30 - fConst3 * fRec0[1]);
		...
		fRec63[0] = fTemp32 + (1e-15 - fConst30 * (fConst28 * fRec63[2] + fConst26 * fRec63[1]));
		double fTemp35 = fRec63[2] + fRec63[0] + 2.0 * fRec63[1];
		fVec10[0] = fTemp35;
		fRec62[0] = -(fConst32 * (fConst3 * fRec62[1] - fConst31 * (fTemp35 - fVec10[1])));
		fRec61[0] = -(fConst34 * (fConst33 * fRec61[1] - (fRec62[0] + fRec62[1])));
		fRec60[0] = fRec61[0] - fConst24 * (fConst22 * fRec60[2] + fConst20 * fRec60[1]);
		double fTemp36 = fRec60[2] + fRec60[0] + 2.0 * fRec60[1];
		fVec11[0] = fTemp36;
		fRec59[0] = -(fConst37 * (fConst35 * fRec59[1] - fConst24 * (fTemp36 + fVec11[1])));
		fRec58[0] = fRec59[0] - fConst17 * (fConst15 * fRec58[2] + fConst13 * fRec58[1]);
		double fTemp37 = fRec58[2] + fRec58[0] + 2.0 * fRec58[1];
		fVec12[0] = fTemp37;
		fRec57[0] = -(fConst40 * (fConst38 * fRec57[1] - fConst17 * (fTemp37 + fVec12[1])));
		fRec56[0] = fRec57[0] - fConst10 * (fConst8 * fRec56[2] + fConst6 * fRec56[1]);
		double fTemp38 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * (fRec56[2] + fRec56[0] + 2.0 * fRec56[1])));
		fRec65[0] = -(fConst40 * (fConst38 * fRec65[1] - fConst41 * (fTemp37 - fVec12[1])));
		fRec64[0] = fRec65[0] - fConst10 * (fConst8 * fRec64[2] + fConst6 * fRec64[1]);
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fRec64[2] + (fRec64[0] - 2.0 * fRec64[1]))));
		double fTemp40 = fConst6 * fRec66[1];
		double fTemp41 = fConst13 * fRec67[1];
		fRec69[0] = -(fConst34 * (fConst33 * fRec69[1] - fConst21 * (fRec62[0] - fRec62[1])));
		fRec68[0] = fRec69[0] - fConst24 * (fConst22 * fRec68[2] + fConst20 * fRec68[1]);
		fRec67[0] = fConst47 * (fRec68[2] + (fRec68[0] - 2.0 * fRec68[1])) - fConst46 * (fConst45 * fRec67[2] + fTemp41);
		fRec66[0] = fRec67[2] + fConst46 * (fTemp41 + fConst45 * fRec67[0]) - fConst44 * (fConst43 * fRec66[2] + fTemp40);
		double fTemp42 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec66[2] + fConst44 * (fTemp40 + fConst43 * fRec66[0]))));
		double fTemp43 = fConst6 * fRec70[1];
		fRec72[0] = -(fConst37 * (fConst35 * fRec72[1] - fConst48 * (fTemp36 - fVec11[1])));
		fRec71[0] = fRec72[0] - fConst17 * (fConst15 * fRec71[2] + fConst13 * fRec71[1]);
		fRec70[0] = fConst49 * (fRec71[2] + (fRec71[0] - 2.0 * fRec71[1])) - fConst44 * (fConst43 * fRec70[2] + fTemp43);
		double fTemp44 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec70[2] + fConst44 * (fTemp43 + fConst43 * fRec70[0]))));
		...
		fVec13[0] = fTemp45;
		fRec55[0] = -(fConst52 * (fConst51 * fRec55[1] - (fTemp45 + fVec13[1])));
		...
		double fTemp49 = (fTemp47 + fTemp48) / (Ranode(TUBE_TABLE_12AX7_68k, fRec52[1]) + 1e+05);
		fVec15[0] = fTemp49;
		fRec73[0] = fConst55 * (2.7e+03 * (fTemp49 + fVec15[1]) - fConst54 * fRec73[1]);
		fRec52[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp48 + fRec73[0] + fTemp47 + -1.581656) + -191.42014814814814;
		double fTemp50 = fRec52[0] - fRec52[1];
		fRec51[0] = fConst32 * (fConst56 * fTemp50 - fConst3 * fRec51[1]);
		fRec74[0] = fConst59 * (fConst58 * fRec74[1] + 0.025 * fTemp50);
		double fTemp51 = fRec35[0] * ((iSlow1) ? fRec74[0] : fRec51[0]);
		fVec16[0] = fTemp51;
		fRec50[0] = -(fConst52 * (fConst51 * fRec50[1] - (fTemp51 + fVec16[1])));
		...
		double fTemp54 = (fTemp52 + fTemp53) / (Ranode(TUBE_TABLE_12AX7_250k, fRec47[1]) + 1e+05);
		fVec17[0] = fTemp54;
		fRec75[0] = fConst62 * (1.5e+03 * (fTemp54 + fVec17[1]) - fConst61 * fRec75[1]);
		fRec47[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp53 + fRec75[0] + fTemp52 + -1.204285) + -169.71433333333334;
		double fTemp55 = fRec47[0] - fRec47[1];
		fRec46[0] = fConst32 * (fConst56 * fTemp55 - fConst3 * fRec46[1]);
		fRec76[0] = fConst59 * (fConst58 * fRec76[1] + 0.025 * fTemp55);
		double fTemp56 = fRec35[0] * ((iSlow1) ? fRec76[0] : fRec46[0]);
		fVec18[0] = fTemp56;
		fRec45[0] = -(fConst52 * (fConst51 * fRec45[1] - (fTemp56 + fVec18[1])));
		...
		double fTemp59 = (fTemp57 + fTemp58) / (Ranode(TUBE_TABLE_12AX7_250k, fRec42[1]) + 1e+05);
		fVec19[0] = fTemp59;
		fRec77[0] = fConst65 * (8.2e+02 * (fTemp59 + fVec19[1]) - fConst64 * fRec77[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp58 + fRec77[0] + fTemp57 + -0.840703) + -147.47524390243905;
		double fTemp60 = fRec42[0] - fRec42[1];
		fRec41[0] = fConst32 * (fConst56 * fTemp60 - fConst3 * fRec41[1]);
