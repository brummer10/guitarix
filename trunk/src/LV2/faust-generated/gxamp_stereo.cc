...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fSlow11 * fRec12[0]) + ((fSlow6 * fTemp5) + ((fSlow4 * ((fTemp4 * (4 - (4 * fabs(fTemp4)))) - fTemp4)) + (fRec11[0] + fTemp2)))) - 1.581655999999998)) - 191.42014814814814);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fSlow11 * fRec41[0]) + ((fSlow6 * fTemp25) + ((fSlow4 * ((fTemp24 * (4 - (4 * fabs(fTemp24)))) - fTemp24)) + (fRec40[0] + fTemp22)))) - 1.581655999999998)) - 191.42014814814814);
