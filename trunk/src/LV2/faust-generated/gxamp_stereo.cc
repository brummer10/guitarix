...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp21 + (fRec36[0] + fTemp22)) + -1.204285)))) + -169.71433333333334);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp25 + (fRec38[0] + fTemp26)) + -0.84070299999999998)))) + -147.47524390243905);
		...
		double fTemp46 = ((fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec52[1]))) + 100000.0));
		fVec15[0] = fTemp46;
		fRec73[0] = (fConst60 * ((2700.0 * (fTemp46 + fVec15[1])) - (fConst61 * fRec73[1])));
		fRec52[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp44 + (fRec73[0] + fTemp45)) + -1.581656)))) + -191.42014814814814);
		...
		double fTemp50 = ((fTemp49 + fTemp48) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec47[1]))) + 100000.0));
		fVec17[0] = fTemp50;
		fRec75[0] = (fConst66 * ((1500.0 * (fTemp50 + fVec17[1])) - (fConst67 * fRec75[1])));
		fRec47[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp48 + (fRec75[0] + fTemp49)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp54 = ((fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec42[1]))) + 100000.0));
		fVec19[0] = fTemp54;
		fRec77[0] = (fConst69 * ((820.0 * (fTemp54 + fVec19[1])) - (fConst70 * fRec77[1])));
		fRec42[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp52 + (fRec77[0] + fTemp53)) + -0.84070299999999998)))) + -147.47524390243905);
