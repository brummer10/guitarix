...
#define fVslider9 (*fVslider9_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		output0[i0] = FAUSTFLOAT((((((int(signbit(double(fTemp29))) ? double(alembic_out_negclip(double(fTemp29))) : double(alembic_outclip(double(fTemp29)))) + (int(signbit(double(fTemp36))) ? double(alembic_out_negclip(double(fTemp36))) : double(alembic_outclip(double(fTemp36))))) + (int(signbit(double(fTemp42))) ? double(alembic_out_negclip(double(fTemp42))) : double(alembic_outclip(double(fTemp42))))) + (int(signbit(double(fTemp47))) ? double(alembic_out_negclip(double(fTemp47))) : double(alembic_outclip(double(fTemp47))))) + (int(signbit(double(fTemp51))) ? double(alembic_out_negclip(double(fTemp51))) : double(alembic_outclip(double(fTemp51))))));
		...
		fRec43[0] = ((iSlow7 ? (int(signbit(double(fTemp80))) ? double(alembic_norm_negclip(double(fTemp80))) : double(alembic_normclip(double(fTemp80)))) : (int(signbit(double(fTemp69))) ? double(alembic_brite_negclip(double(fTemp69))) : double(alembic_briteclip(double(fTemp69))))) - (fConst467 * ((fConst468 * fRec43[1]) + (fConst469 * fRec43[2]))));
		...
		fRec55[0] = ((iSlow7 ? (int(signbit(double(fTemp87))) ? double(alembic_norm_negclip(double(fTemp87))) : double(alembic_normclip(double(fTemp87)))) : (int(signbit(double(fTemp86))) ? double(alembic_brite_negclip(double(fTemp86))) : double(alembic_briteclip(double(fTemp86))))) - (fConst467 * ((fConst468 * fRec55[1]) + (fConst469 * fRec55[2]))));
		...
		fRec64[0] = ((iSlow7 ? (int(signbit(double(fTemp93))) ? double(alembic_norm_negclip(double(fTemp93))) : double(alembic_normclip(double(fTemp93)))) : (int(signbit(double(fTemp92))) ? double(alembic_brite_negclip(double(fTemp92))) : double(alembic_briteclip(double(fTemp92))))) - (fConst467 * ((fConst468 * fRec64[1]) + (fConst469 * fRec64[2]))));
		...
		fRec72[0] = ((iSlow7 ? (int(signbit(double(fTemp98))) ? double(alembic_norm_negclip(double(fTemp98))) : double(alembic_normclip(double(fTemp98)))) : (int(signbit(double(fTemp97))) ? double(alembic_brite_negclip(double(fTemp97))) : double(alembic_briteclip(double(fTemp97))))) - (fConst467 * ((fConst468 * fRec72[1]) + (fConst469 * fRec72[2]))));
		...
		fRec79[0] = ((iSlow7 ? (int(signbit(double(fTemp102))) ? double(alembic_norm_negclip(double(fTemp102))) : double(alembic_normclip(double(fTemp102)))) : (int(signbit(double(fTemp101))) ? double(alembic_brite_negclip(double(fTemp101))) : double(alembic_briteclip(double(fTemp101))))) - (fConst467 * ((fConst468 * fRec79[1]) + (fConst469 * fRec79[2]))));
		double fTemp103 = (fConst3 * (fRec42[0] * (((fConst5 * fRec79[0]) + (fConst470 * fRec79[1])) + (fConst471 * fRec79[2]))));
		output1[i0] = FAUSTFLOAT((((((int(signbit(double(fTemp81))) ? double(alembic_out_negclip(double(fTemp81))) : double(alembic_outclip(double(fTemp81)))) + (int(signbit(double(fTemp88))) ? double(alembic_out_negclip(double(fTemp88))) : double(alembic_outclip(double(fTemp88))))) + (int(signbit(double(fTemp94))) ? double(alembic_out_negclip(double(fTemp94))) : double(alembic_outclip(double(fTemp94))))) + (int(signbit(double(fTemp99))) ? double(alembic_out_negclip(double(fTemp99))) : double(alembic_outclip(double(fTemp99))))) + (int(signbit(double(fTemp103))) ? double(alembic_out_negclip(double(fTemp103))) : double(alembic_outclip(double(fTemp103))))));
		fRec0[1] = fRec0[0];
		fRec2[1] = fRec2[0];
		fVec0[1] = fVec0[0];
		fRec8[1] = fRec8[0];
