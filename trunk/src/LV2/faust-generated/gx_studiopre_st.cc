...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst2 = ((fConst0 * (fConst1 + 7.8166451752789406e-09)) + 2.6830723178064399e-08);
...
#define fVslider9 (*fVslider9_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp52 = double(input1[i]);
		fVec4[0] = fTemp52;
		...
		output1[i] = FAUSTFLOAT((((((int(signbit(double(fTemp81))) ? double(alembic_out_negclip(double(fTemp81))) : double(alembic_outclip(double(fTemp81)))) + (int(signbit(double(fTemp88))) ? double(alembic_out_negclip(double(fTemp88))) : double(alembic_outclip(double(fTemp88))))) + (int(signbit(double(fTemp94))) ? double(alembic_out_negclip(double(fTemp94))) : double(alembic_outclip(double(fTemp94))))) + (int(signbit(double(fTemp99))) ? double(alembic_out_negclip(double(fTemp99))) : double(alembic_outclip(double(fTemp99))))) + (int(signbit(double(fTemp103))) ? double(alembic_out_negclip(double(fTemp103))) : double(alembic_outclip(double(fTemp103))))));
		fRec0[1] = fRec0[0];
		fRec2[1] = fRec2[0];
		fVec0[1] = fVec0[0];
		fRec8[1] = fRec8[0];
