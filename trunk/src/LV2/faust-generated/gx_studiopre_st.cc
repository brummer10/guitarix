...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst24 = mydsp_faustpower4_f(fConst0);
	...
	double fConst239 = 1.0 / fConst236;
	fConst240 = (fConst239 + -1.0000000000000004) / fConst236 + 1.0;
	double fConst241 = (fConst239 + 1.0000000000000004) / fConst236 + 1.0;
	...
	double fConst246 = 1.0 / fConst243;
	fConst247 = (fConst246 + -1.0000000000000004) / fConst243 + 1.0;
	double fConst248 = (fConst246 + 1.0000000000000004) / fConst243 + 1.0;
	...
	double fConst253 = 1.0 / fConst250;
	fConst254 = (fConst253 + -1.0000000000000004) / fConst250 + 1.0;
	double fConst255 = (fConst253 + 1.0000000000000004) / fConst250 + 1.0;
	...
	double fConst291 = 1.29836854896493e-19 * fConst0;
	...
	double fConst307 = 8.65579032643287e-20 * fConst0;
	...
	double fConst395 = 8.18130326224871e-18 * fConst3;
	fConst396 = 6.5367111784465e-15 - fConst395;
	double fConst397 = 7.3410535767349e-18 * fConst3;
	...
	fConst470 = 1.69523126835804e-07 - fConst469;
	fConst471 = -1.69523126835804e-07 - fConst469;
	fConst472 = 5.0856938050741e-08 * fConst3;
...
#define fVslider9 (*fVslider9_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp30 = fConst5 * fRec15[0] * (fConst472 * fRec0[1] + fConst0 * (fConst471 * fRec0[0] + fConst470 * fRec0[2]));
		...
		double fTemp34 = fConst5 * fRec15[0] * (fConst472 * fRec16[1] + fConst0 * (fConst471 * fRec16[0] + fConst470 * fRec16[2]));
		...
		double fTemp39 = fConst5 * fRec15[0] * (fConst472 * fRec21[1] + fConst0 * (fConst471 * fRec21[0] + fConst470 * fRec21[2]));
		...
		double fTemp45 = fConst5 * fRec15[0] * (fConst472 * fRec27[1] + fConst0 * (fConst471 * fRec27[0] + fConst470 * fRec27[2]));
		...
		double fTemp52 = fConst5 * fRec15[0] * (fConst472 * fRec34[1] + fConst0 * (fConst471 * fRec34[0] + fConst470 * fRec34[2]));
		...
		double fTemp83 = fConst5 * fRec57[0] * (fConst472 * fRec42[1] + fConst0 * (fConst471 * fRec42[0] + fConst470 * fRec42[2]));
		...
		double fTemp87 = fConst5 * fRec57[0] * (fConst472 * fRec58[1] + fConst0 * (fConst471 * fRec58[0] + fConst470 * fRec58[2]));
		...
		double fTemp92 = fConst5 * fRec57[0] * (fConst472 * fRec63[1] + fConst0 * (fConst471 * fRec63[0] + fConst470 * fRec63[2]));
		...
		double fTemp98 = fConst5 * fRec57[0] * (fConst472 * fRec69[1] + fConst0 * (fConst471 * fRec69[0] + fConst470 * fRec69[2]));
		...
		double fTemp105 = fConst5 * fRec57[0] * (fConst472 * fRec76[1] + fConst0 * (fConst471 * fRec76[0] + fConst470 * fRec76[2]));
