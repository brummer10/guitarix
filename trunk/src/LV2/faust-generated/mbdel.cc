...
#define fVbargraph4 (*fVbargraph4_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp7 = fVec1[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec12[0])))) & 524287)];
		fRec3[0] = (fTemp7 + (fRec11[0] * (fVec1[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec13[0])))) & 524287)] - fTemp7)));
		double fTemp8 = std::max<double>(fConst1, std::fabs(fRec3[0]));
		fRec0[0] = (iTemp1 ? std::max<double>(fRec0[1], fTemp8) : fTemp8);
		...
		double fTemp16 = fVec3[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec27[0])))) & 524287)];
		fRec17[0] = (fTemp16 + (fRec26[0] * (fVec3[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec28[0])))) & 524287)] - fTemp16)));
		...
		double fTemp24 = fVec5[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec41[0])))) & 524287)];
		fRec32[0] = (fTemp24 + (fRec40[0] * (fVec5[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec42[0])))) & 524287)] - fTemp24)));
		...
		double fTemp31 = fVec7[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec54[0])))) & 524287)];
		fRec46[0] = (fTemp31 + (fRec53[0] * (fVec7[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec55[0])))) & 524287)] - fTemp31)));
		...
		double fTemp36 = fVec8[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec65[0])))) & 524287)];
		fRec59[0] = (fTemp36 + (fRec64[0] * (fVec8[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec66[0])))) & 524287)] - fTemp36)));
