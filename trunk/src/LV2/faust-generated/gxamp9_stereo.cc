...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec15[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec40[0] + (0.9254498422517706 * (fRec16[2] + (fRec16[0] + (2.0 * fRec16[1]))))) - 1.581656)) - 191.42014814814814);
		...
		fRec42[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec45[0] + (0.9254498422517706 * (fRec43[2] + (fRec43[0] + (2.0 * fRec43[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec46[0] + (0.9254498422517706 * (fRec9[2] + (fRec9[0] + (2.0 * fRec9[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec48[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec51[0] + (0.9254498422517706 * (fRec49[2] + (fRec49[0] + (2.0 * fRec49[1]))))) - 0.840702)) - 147.47536585365856);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec52[0] + (0.9254498422517706 * (fRec3[2] + (fRec3[0] + (2.0 * fRec3[1]))))) - 0.840702)) - 147.47536585365856);
		...
		fRec71[0] = ((0.9999 * fRec71[1]) + (9.999999999998899e-05 * fTemp40));
		double fTemp41 = max(fRec71[0], fTemp40);
		fVec16[IOTA&32767] = fTemp41;
		fRec70[0] = ((fVec16[IOTA&32767] + fRec70[1]) - fVec16[(IOTA-iConst27)&32767]);
		fRec69[0] = ((0.999 * fRec69[1]) + (fConst28 * fRec70[0]));
		double fTemp42 = max((double)-1, min(-0.01, (fVec16[IOTA&32767] - (1.0 + (1.02 * fRec69[0])))));
		...
		fRec80[0] = (fTemp52 - (fConst26 * ((fConst24 * fRec80[2]) + (fConst22 * fRec80[1]))));
		double fTemp53 = (fRec80[2] + (fRec80[0] + (2 * fRec80[1])));
		fVec17[0] = fTemp53;
		fRec79[0] = ((fConst33 * fRec79[1]) + (fConst32 * ((fConst29 * fVec17[0]) + (fConst30 * fVec17[1]))));
		fRec78[0] = ((fConst36 * fRec78[1]) + (fConst35 * (fRec79[0] + fRec79[1])));
		fRec77[0] = (fRec78[0] - (fConst20 * ((fConst18 * fRec77[2]) + (fConst16 * fRec77[1]))));
		double fTemp54 = (fRec77[2] + (fRec77[0] + (2 * fRec77[1])));
		fVec18[0] = fTemp54;
		fRec76[0] = ((fConst39 * fRec76[1]) + (fConst38 * (fVec18[0] + fVec18[1])));
		fRec75[0] = (fRec76[0] - (fConst13 * ((fConst11 * fRec75[2]) + (fConst9 * fRec75[1]))));
		double fTemp55 = (fRec75[2] + (fRec75[0] + (2 * fRec75[1])));
		fVec19[0] = fTemp55;
		fRec74[0] = ((fConst42 * fRec74[1]) + (fConst41 * (fVec19[0] + fVec19[1])));
		fRec73[0] = (fRec74[0] - (fConst6 * ((fConst5 * fRec73[2]) + (fConst3 * fRec73[1]))));
		double fTemp56 = max((double)-1, min((double)1, (fSlow4 * (fRec73[2] + (fRec73[0] + (2 * fRec73[1]))))));
		...
		fRec87[0] = ((fConst36 * fRec87[1]) + (fConst35 * ((fConst17 * fRec79[0]) + (fConst49 * fRec79[1]))));
		...
		double fTemp65 = (1e-15 + (((0.5 * (fTemp64 * (1 - (0.3333333333333333 * faustpower<2>(fTemp64))))) + (fSlow10 * fRec72[0])) + (fTemp51 * (fTemp26 + (fTemp27 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp27 * fTemp51))))) - 0.024937655860349125))))))));
		fVec21[0] = fTemp65;
		...
		fRec66[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec90[0] + (0.9254498422517706 * (fRec67[2] + (fRec67[0] + (2.0 * fRec67[1]))))) - 1.581656)) - 191.42014814814814);
		...
		fRec92[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec95[0] + (0.9254498422517706 * (fRec93[2] + (fRec93[0] + (2.0 * fRec93[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec60[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec96[0] + (0.9254498422517706 * (fRec61[2] + (fRec61[0] + (2.0 * fRec61[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec98[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec101[0] + (0.9254498422517706 * (fRec99[2] + (fRec99[0] + (2.0 * fRec99[1]))))) - 0.840702)) - 147.47536585365856);
		...
		fRec54[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec102[0] + (0.9254498422517706 * (fRec55[2] + (fRec55[0] + (2.0 * fRec55[1]))))) - 0.840702)) - 147.47536585365856);
