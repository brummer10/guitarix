...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp34 = (fTemp33 + fTemp32) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp34;
		fRec50[0] = fConst71 * (2700.0 * (fTemp34 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(fTemp32 + fRec50[0] + fTemp33 + -1.581656))) + -191.42014814814814;
		...
		double fTemp38 = (fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp38;
		fRec53[0] = fConst17 * (1500.0 * (fTemp38 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp36 + fRec53[0] + fTemp37 + -1.204285))) + -169.71433333333334;
		...
		double fTemp41 = (fTemp40 + fTemp39) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0);
		fVec11[0] = fTemp41;
		fRec55[0] = fConst9 * (820.0 * (fTemp41 + fVec11[1]) - fConst10 * fRec55[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp39 + fRec55[0] + fTemp40 + -0.84070199999999995))) + -147.47536585365856;
		...
		double fTemp44 = (fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec65[1]))) + 100000.0);
		fVec12[0] = fTemp44;
		fRec68[0] = fConst9 * (820.0 * (fTemp44 + fVec12[1]) - fConst10 * fRec68[1]);
		fRec65[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp42 + fRec68[0] + fTemp43 + -0.84070199999999995))) + -147.47536585365856;
		...
		double fTemp47 = (fTemp46 + fTemp45) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec77[1]))) + 100000.0);
		fVec13[0] = fTemp47;
		fRec80[0] = fConst17 * (1500.0 * (fTemp47 + fVec13[1]) - fConst18 * fRec80[1]);
		fRec77[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp45 + fRec80[0] + fTemp46 + -1.204285))) + -169.71433333333334;
		...
		double fTemp74 = (fTemp73 + fTemp72) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec83[1]))) + 100000.0);
		fVec20[0] = fTemp74;
		fRec107[0] = fConst71 * (2700.0 * (fTemp74 + fVec20[1]) - fConst72 * fRec107[1]);
		fRec83[0] = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(fTemp72 + fRec107[0] + fTemp73 + -1.581656))) + -191.42014814814814;
		...
		double fTemp78 = (fTemp77 + fTemp76) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec71[1]))) + 100000.0);
		fVec22[0] = fTemp78;
		fRec109[0] = fConst17 * (1500.0 * (fTemp78 + fVec22[1]) - fConst18 * fRec109[1]);
		fRec71[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp76 + fRec109[0] + fTemp77 + -1.204285))) + -169.71433333333334;
		...
		double fTemp81 = (fTemp80 + fTemp79) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec59[1]))) + 100000.0);
		fVec23[0] = fTemp81;
		fRec111[0] = fConst9 * (820.0 * (fTemp81 + fVec23[1]) - fConst10 * fRec111[1]);
		fRec59[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp79 + fRec111[0] + fTemp80 + -0.84070199999999995))) + -147.47536585365856;
