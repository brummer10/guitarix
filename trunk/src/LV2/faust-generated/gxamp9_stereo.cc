...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp2 = ((fTemp1 + fTemp0) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec7[1]))) + 100000.0));
		fVec0[0] = fTemp2;
		fRec10[0] = (fConst8 * ((820.0 * (fTemp2 + fVec0[1])) - (fConst9 * fRec10[1])));
		double fTemp3 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp0 + (fRec10[0] + fTemp1)) + -0.84070199999999995))));
		fRec7[0] = ((fTemp3 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp3))) + 100000.0))) + -250.0);
		...
		double fTemp7 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp4 + (fRec21[0] + fTemp5)) + -1.204285))));
		fRec18[0] = ((fTemp7 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp7))) + 100000.0))) + -250.0);
		...
		double fTemp36 = ((fTemp35 + fTemp34) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp36;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp36 + fVec8[1])) - (fConst72 * fRec48[1])));
		double fTemp37 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp34 + (fRec48[0] + fTemp35)) + -1.581656))));
		fRec23[0] = ((fTemp37 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp37))) + 100000.0))) + -250.0);
		...
		double fTemp41 = ((fTemp40 + fTemp39) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp41;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp41 + fVec10[1])) - (fConst12 * fRec50[1])));
		double fTemp42 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp39 + (fRec50[0] + fTemp40)) + -1.204285))));
		fRec12[0] = ((fTemp42 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp42))) + 100000.0))) + -250.0);
		...
		double fTemp45 = ((fTemp44 + fTemp43) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp45;
		fRec51[0] = (fConst8 * ((820.0 * (fTemp45 + fVec11[1])) - (fConst9 * fRec51[1])));
		double fTemp46 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp43 + (fRec51[0] + fTemp44)) + -0.84070199999999995))));
		fRec1[0] = ((fTemp46 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp46))) + 100000.0))) + -250.0);
		...
		double fTemp49 = ((fTemp48 + fTemp47) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec60[1]))) + 100000.0));
		fVec12[0] = fTemp49;
		fRec63[0] = (fConst8 * ((820.0 * (fTemp49 + fVec12[1])) - (fConst9 * fRec63[1])));
		double fTemp50 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp47 + (fRec63[0] + fTemp48)) + -0.84070199999999995))));
		fRec60[0] = ((fTemp50 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp50))) + 100000.0))) + -250.0);
		...
		double fTemp53 = ((fTemp52 + fTemp51) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec71[1]))) + 100000.0));
		fVec13[0] = fTemp53;
		fRec74[0] = (fConst11 * ((1500.0 * (fTemp53 + fVec13[1])) - (fConst12 * fRec74[1])));
		double fTemp54 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp51 + (fRec74[0] + fTemp52)) + -1.204285))));
		fRec71[0] = ((fTemp54 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp54))) + 100000.0))) + -250.0);
		...
		double fTemp81 = ((fTemp80 + fTemp79) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec76[1]))) + 100000.0));
		fVec20[0] = fTemp81;
		fRec100[0] = (fConst71 * ((2700.0 * (fTemp81 + fVec20[1])) - (fConst72 * fRec100[1])));
		double fTemp82 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp79 + (fRec100[0] + fTemp80)) + -1.581656))));
		fRec76[0] = ((fTemp82 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp82))) + 100000.0))) + -250.0);
		...
		double fTemp86 = ((fTemp85 + fTemp84) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec65[1]))) + 100000.0));
		fVec22[0] = fTemp86;
		fRec101[0] = (fConst11 * ((1500.0 * (fTemp86 + fVec22[1])) - (fConst12 * fRec101[1])));
		double fTemp87 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp84 + (fRec101[0] + fTemp85)) + -1.204285))));
		fRec65[0] = ((fTemp87 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp87))) + 100000.0))) + -250.0);
		...
		double fTemp90 = ((fTemp89 + fTemp88) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec54[1]))) + 100000.0));
		fVec23[0] = fTemp90;
		fRec102[0] = (fConst8 * ((820.0 * (fTemp90 + fVec23[1])) - (fConst9 * fRec102[1])));
		double fTemp91 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp88 + (fRec102[0] + fTemp89)) + -0.84070199999999995))));
		fRec54[0] = ((fTemp91 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp91))) + 100000.0))) + -250.0);
