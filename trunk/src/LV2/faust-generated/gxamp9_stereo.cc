...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fTemp13 * (fTemp27 + (fTemp26 * (0.024937655860349125 + (fSlow11 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp26 * fTemp13))))) - 0.024937655860349125)))))) + ((0.5 * (fTemp25 * (1 - (0.3333333333333333 * faustpower<2>(fTemp25))))) + (fRec34[0] + (fSlow10 * fRec12[0])))) - 1.581656)) - 191.42014814814814);
		...
		fRec36[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec37[0] + fRec9[1]) - 1.204285)) - 169.71433333333334);
		...
		fRec6[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec38[0] + fRec7[0]) - 1.204285)) - 169.71433333333334);
		fRec5[0] = ((fConst61 * ((fConst39 * fRec6[1]) + (fConst1 * fRec6[0]))) + (fConst3 * fRec5[1]));
		fRec41[0] = ((fConst69 * (fRec40[1] + fRec40[2])) + (fConst68 * fRec41[1]));
		fRec40[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec41[0] + fRec4[1]) - 0.840702)) - 147.47536585365856);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec42[0] + fRec3[0]) - 0.840702)) - 147.47536585365856);
		...
		fRec52[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fTemp42 * ((fTemp26 * (0.024937655860349125 + (fSlow11 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp26 * fTemp42))))) - 0.024937655860349125)))) + fTemp27)) + ((0.5 * (fTemp54 * (1 - (0.3333333333333333 * faustpower<2>(fTemp54))))) + (fRec74[0] + (fSlow10 * fRec53[0])))) - 1.581656)) - 191.42014814814814);
		...
		fRec76[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec77[0] + fRec50[1]) - 1.204285)) - 169.71433333333334);
		...
		fRec48[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec78[0] + fRec49[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec80[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec81[0] + fRec46[1]) - 0.840702)) - 147.47536585365856);
		...
		fRec44[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec82[0] + fRec45[0]) - 0.840702)) - 147.47536585365856);
