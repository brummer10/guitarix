...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp28 = (fTemp26 + fTemp27) / (Ranode(TUBE_TABLE_12AT7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp28;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp28 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp27 + fRec38[0] + fTemp26 + -1.256962) + -96.7119512195122;
