...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -2.617753)))) + -153.04618518518518);
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp20 + (fRec36[0] + fTemp21)) + -1.887332)))) + -124.17786666666666);
		...
		double fTemp26 = ((fTemp25 + fTemp24) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp26;
		fRec38[0] = (fConst69 * ((820.0 * (fTemp26 + fVec9[1])) - (fConst70 * fRec38[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp24 + (fRec38[0] + fTemp25)) + -1.2569619999999999)))) + -96.711951219512201);
