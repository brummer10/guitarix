...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp18 = ((fTemp17 + fTemp16) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp18;
		fRec34[0] = (fConst63 * ((2700.0 * (fTemp18 + fVec5[1])) - (fConst64 * fRec34[1])));
		double fTemp19 = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -2.617753))));
		fRec12[0] = ((fTemp19 + (0.00096953814814814819 * (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fTemp19))) + 100000.0))) + -250.0);
		...
		double fTemp24 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -1.887332))));
		fRec7[0] = ((fTemp24 + (0.0012582213333333333 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp24))) + 100000.0))) + -250.0);
		...
		double fTemp28 = ((fTemp27 + fTemp26) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp28;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp29 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp26 + (fRec36[0] + fTemp27)) + -1.2569619999999999))));
		fRec1[0] = ((fTemp29 + (0.001532880487804878 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp29))) + 100000.0))) + -250.0);
