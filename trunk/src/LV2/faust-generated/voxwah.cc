...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec5[0] = 0.0070000000000000062 * (1.0 - std::max<double>(0.029999999999999999, std::min<double>(0.97999999999999998, fRec6[0]))) + 0.99299999999999999 * fRec5[1];
		double fThen0 = std::max<double>(0.029999999999999999, std::min<double>(1.0, 0.5 * (fRec2[0] + 1.0)));
