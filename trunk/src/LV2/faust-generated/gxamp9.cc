...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp5 = ((fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec18[1]))) + 100000.0));
		fVec1[0] = fTemp5;
		fRec21[0] = (fConst11 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst12 * fRec21[1])));
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp3 + (fRec21[0] + fTemp4)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp33 = ((fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp33;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp33 + fVec8[1])) - (fConst72 * fRec48[1])));
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp31 + (fRec48[0] + fTemp32)) + -1.581656)))) + -191.42014814814814);
		...
		double fTemp37 = ((fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp37;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp37 + fVec10[1])) - (fConst12 * fRec50[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp35 + (fRec50[0] + fTemp36)) + -1.204285)))) + -169.71433333333334);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp38 + (fRec51[0] + fTemp39)) + -0.84070199999999995)))) + -147.47536585365856);
