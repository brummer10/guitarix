...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp0 + fRec10[0] + fTemp1 + -0.84070199999999995))) + -147.47536585365856;
		...
		double fTemp5 = (fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec19[1]))) + 100000.0);
		fVec1[0] = fTemp5;
		fRec22[0] = fConst17 * (1500.0 * (fTemp5 + fVec1[1]) - fConst18 * fRec22[1]);
		fRec19[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp3 + fRec22[0] + fTemp4 + -1.204285))) + -169.71433333333334;
		...
		double fTemp33 = (fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp33;
		fRec50[0] = fConst71 * (2700.0 * (fTemp33 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(fTemp31 + fRec50[0] + fTemp32 + -1.581656))) + -191.42014814814814;
		...
		double fTemp37 = (fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp37;
		fRec53[0] = fConst17 * (1500.0 * (fTemp37 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp35 + fRec53[0] + fTemp36 + -1.204285))) + -169.71433333333334;
		...
		double fTemp40 = (fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0);
		fVec11[0] = fTemp40;
		fRec55[0] = fConst9 * (820.0 * (fTemp40 + fVec11[1]) - fConst10 * fRec55[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp38 + fRec55[0] + fTemp39 + -0.84070199999999995))) + -147.47536585365856;
