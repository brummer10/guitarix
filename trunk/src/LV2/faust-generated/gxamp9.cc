...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp35 = (fTemp33 + fTemp34) / (Ranode(TUBE_TABLE_12AX7_250k, fRec48[1]) + 1e+05);
		fVec8[0] = fTemp35;
		fRec51[0] = fConst67 * (1.5e+03 * (fTemp35 + fVec8[1]) - fConst66 * fRec51[1]);
		fRec48[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp34 + fRec51[0] + fTemp33 + -1.204285) + -169.71433333333334;
		...
		double fTemp40 = (fTemp38 + fTemp39) / (Ranode(TUBE_TABLE_12AX7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp40;
		fRec53[0] = fConst67 * (1.5e+03 * (fTemp40 + fVec10[1]) - fConst66 * fRec53[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp39 + fRec53[0] + fTemp38 + -1.204285) + -169.71433333333334;
		...
		double fTemp44 = (fTemp42 + fTemp43) / (Ranode(TUBE_TABLE_12AX7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp44;
		fRec55[0] = fConst6 * (8.2e+02 * (fTemp44 + fVec11[1]) - fConst5 * fRec55[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp43 + fRec55[0] + fTemp42 + -0.840702) + -147.47536585365856;
