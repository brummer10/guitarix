...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp35 = ((fTemp34 + fTemp33) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp35;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp35 + fVec8[1])) - (fConst72 * fRec48[1])));
		double fTemp36 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp33 + (fRec48[0] + fTemp34)) + -1.581656))));
		fRec23[0] = ((fTemp36 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp36))) + 100000.0))) + -250.0);
		...
		double fTemp40 = ((fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp40;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp40 + fVec10[1])) - (fConst12 * fRec50[1])));
		double fTemp41 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp38 + (fRec50[0] + fTemp39)) + -1.204285))));
		fRec12[0] = ((fTemp41 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp41))) + 100000.0))) + -250.0);
		...
		double fTemp44 = ((fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp44;
		fRec51[0] = (fConst8 * ((820.0 * (fTemp44 + fVec11[1])) - (fConst9 * fRec51[1])));
		double fTemp45 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp42 + (fRec51[0] + fTemp43)) + -0.84070199999999995))));
		fRec1[0] = ((fTemp45 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp45))) + 100000.0))) + -250.0);
