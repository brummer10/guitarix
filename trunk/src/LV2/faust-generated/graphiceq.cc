...
#define fVbargraph10 (*fVbargraph10_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fElse0 = std::max<double>(fRec0[1], fTemp12);
		fRec0[0] = ((iTemp0) ? fElse0 : fTemp12);
		...
		double fElse3 = std::max<double>(fRec15[1], fTemp24);
		fRec15[0] = ((iTemp13) ? fElse3 : fTemp24);
		int iElse4 = iRec16[1] + 1;
		iRec16[0] = ((iTemp13) ? iElse4 : 1);
		...
		double fElse6 = std::max<double>(fRec31[1], fTemp35);
		fRec31[0] = ((iTemp25) ? fElse6 : fTemp35);
		int iElse7 = iRec32[1] + 1;
		iRec32[0] = ((iTemp25) ? iElse7 : 1);
		...
		double fElse9 = std::max<double>(fRec46[1], fTemp45);
		fRec46[0] = ((iTemp36) ? fElse9 : fTemp45);
		int iElse10 = iRec47[1] + 1;
		iRec47[0] = ((iTemp36) ? iElse10 : 1);
		...
		double fElse12 = std::max<double>(fRec60[1], fTemp54);
		fRec60[0] = ((iTemp46) ? fElse12 : fTemp54);
		int iElse13 = iRec61[1] + 1;
		iRec61[0] = ((iTemp46) ? iElse13 : 1);
		...
		double fElse15 = std::max<double>(fRec73[1], fTemp62);
		fRec73[0] = ((iTemp55) ? fElse15 : fTemp62);
		int iElse16 = iRec74[1] + 1;
		iRec74[0] = ((iTemp55) ? iElse16 : 1);
		...
		double fElse18 = std::max<double>(fRec85[1], fTemp69);
		fRec85[0] = ((iTemp63) ? fElse18 : fTemp69);
		int iElse19 = iRec86[1] + 1;
		iRec86[0] = ((iTemp63) ? iElse19 : 1);
		...
		double fElse21 = std::max<double>(fRec96[1], fTemp75);
		fRec96[0] = ((iTemp70) ? fElse21 : fTemp75);
		int iElse22 = iRec97[1] + 1;
		iRec97[0] = ((iTemp70) ? iElse22 : 1);
		...
		double fElse24 = std::max<double>(fRec106[1], fTemp80);
		fRec106[0] = ((iTemp76) ? fElse24 : fTemp80);
		int iElse25 = iRec107[1] + 1;
		iRec107[0] = ((iTemp76) ? iElse25 : 1);
		...
		double fElse27 = std::max<double>(fRec115[1], fTemp84);
		fRec115[0] = ((iTemp81) ? fElse27 : fTemp84);
		int iElse28 = iRec116[1] + 1;
		iRec116[0] = ((iTemp81) ? iElse28 : 1);
		...
		double fElse30 = std::max<double>(fRec123[1], fTemp87);
		fRec123[0] = ((iTemp85) ? fElse30 : fTemp87);
		int iElse31 = iRec124[1] + 1;
		iRec124[0] = ((iTemp85) ? iElse31 : 1);
