...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp37 = (1.0 - fRec50[0]);
		double fTemp38 = (fRec21[0] * fTemp37);
		double fTemp39 = ((fSlow2 * fRec13[0]) + ((fTemp38 * ((fSlow9 * ((4.0 * (1.0 - std::fabs(fTemp38))) + -1.0)) + 1.0)) + (fSlow10 * fTemp25)));
		fVec11[0] = fTemp39;
		fRec12[0] = (0.0 - (fConst5 * ((fConst6 * fRec12[1]) - (fTemp39 + fVec11[1]))));
		fRec64[0] = (fSlow11 + (0.999 * fRec64[1]));
		double fTemp40 = (fRec12[0] * fRec64[0]);
		fVec12[0] = fTemp40;
		...
		fVec13[0] = fTemp44;
		fRec65[0] = (fConst5 * ((410.0 * (fTemp44 + fVec13[1])) - (fConst6 * fRec65[1])));
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp41 + (fRec65[0] + fTemp42)) + -0.65976100000000004)))) + -89.08268292682925);
		fRec8[0] = (fConst2 * ((fConst3 * fRec8[1]) + (0.025000000000000001 * (fRec9[0] - fRec9[1]))));
		double fTemp45 = (fTemp43 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec67[1]))) + 100000.0));
		fVec14[0] = fTemp45;
		fRec68[0] = (fConst5 * ((410.0 * (fTemp45 + fVec14[1])) - (fConst6 * fRec68[1])));
		fRec67[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp41 + (fRec68[0] + fTemp42)) + -0.66454100000000005)))) + -87.916829268292673);
		fRec66[0] = (fConst2 * ((fConst3 * fRec66[1]) + (0.025000000000000001 * (fRec67[0] - fRec67[1]))));
		double fTemp46 = (std::min<double>(0.69999999999999996, fRec8[0]) + std::max<double>(-0.75, fRec66[0]));
		...
		double fTemp51 = (0.92544984225177063 * (fRec97[0] + fRec97[2]));
		double fTemp52 = (1.8508996845035413 * fRec97[1]);
		double fTemp53 = ((fTemp52 + fTemp51) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec96[1]))) + 100000.0));
		fVec15[0] = fTemp53;
		fRec99[0] = (fConst28 * ((820.0 * (fTemp53 + fVec15[1])) - (fConst29 * fRec99[1])));
		fRec96[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp51 + (fRec99[0] + fTemp52)) + -1.2569619999999999)))) + -96.711951219512201);
		fRec95[0] = (fConst2 * ((fConst3 * fRec95[1]) + (0.025000000000000001 * (fRec96[0] - fRec96[1]))));
		...
		double fTemp54 = (0.92544984225177063 * (fRec108[0] + fRec108[2]));
		double fTemp55 = (1.8508996845035413 * fRec108[1]);
		double fTemp56 = ((fTemp55 + fTemp54) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec107[1]))) + 100000.0));
		fVec16[0] = fTemp56;
		fRec110[0] = (fConst31 * ((1500.0 * (fTemp56 + fVec16[1])) - (fConst32 * fRec110[1])));
		fRec107[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp54 + (fRec110[0] + fTemp55)) + -1.8873329999999999)))) + -124.17779999999999);
		fRec106[0] = (fConst2 * ((fConst3 * fRec106[1]) + (0.025000000000000001 * (fRec107[0] - fRec107[1]))));
		double fTemp57 = (double(input1[i]) * fRec46[0]);
		fVec17[0] = fTemp57;
		fRec114[0] = ((0.93028479253239138 * (fTemp57 + fVec17[1])) - (0.86056958506478287 * fRec114[1]));
		fRec113[0] = (fRec114[0] - ((1.8405051250752198 * fRec113[1]) + (0.86129424393186271 * fRec113[2])));
		double fTemp58 = (0.92544984225177063 * (fRec113[0] + fRec113[2]));
		double fTemp59 = (1.8508996845035413 * fRec113[1]);
		double fTemp60 = ((fTemp59 + fTemp58) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec112[1]))) + 100000.0));
		fVec18[0] = fTemp60;
		fRec115[0] = (fConst34 * ((2700.0 * (fTemp60 + fVec18[1])) - (fConst35 * fRec115[1])));
		fRec112[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp58 + (fRec115[0] + fTemp59)) + -2.617753)))) + -153.04618518518518);
		fRec111[0] = (fConst2 * ((fConst3 * fRec111[1]) + (0.025000000000000001 * (fRec112[0] - fRec112[1]))));
		...
		double fTemp61 = (0.92544984225177063 * (fRec102[0] + fRec102[2]));
		double fTemp62 = (1.8508996845035413 * fRec102[1]);
		double fTemp63 = ((fTemp62 + fTemp61) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec101[1]))) + 100000.0));
		fVec19[0] = fTemp63;
		fRec116[0] = (fConst31 * ((1500.0 * (fTemp63 + fVec19[1])) - (fConst32 * fRec116[1])));
		fRec101[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp61 + (fRec116[0] + fTemp62)) + -1.8873329999999999)))) + -124.17779999999999);
		fRec100[0] = (fConst2 * ((fConst3 * fRec100[1]) + (0.025000000000000001 * (fRec101[0] - fRec101[1]))));
		...
		double fTemp64 = (0.92544984225177063 * (fRec92[0] + fRec92[2]));
		double fTemp65 = (1.8508996845035413 * fRec92[1]);
		double fTemp66 = ((fTemp65 + fTemp64) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec91[1]))) + 100000.0));
		fVec20[0] = fTemp66;
		fRec117[0] = (fConst28 * ((820.0 * (fTemp66 + fVec20[1])) - (fConst29 * fRec117[1])));
		fRec91[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp64 + (fRec117[0] + fTemp65)) + -1.2569619999999999)))) + -96.711951219512201);
		fRec90[0] = (fConst2 * ((fConst3 * fRec90[1]) + (0.025000000000000001 * (fRec91[0] - fRec91[1]))));
		double fTemp67 = (fRec50[0] * fRec90[0]);
		double fTemp68 = std::fabs(fTemp67);
		fRec118[0] = ((0.99990000000000001 * fRec118[1]) + (9.9999999999988987e-05 * fTemp68));
		double fTemp69 = std::max<double>(fRec118[0], fTemp68);
		fVec21[(IOTA & 32767)] = fTemp69;
		fRec120[0] = ((fTemp69 + fRec120[1]) - fVec21[((IOTA - iConst37) & 32767)]);
		fRec119[0] = ((0.999 * fRec119[1]) + (fConst36 * fRec120[0]));
		double fTemp70 = std::max<double>(-1.0, std::min<double>(-0.01, (fTemp69 + (-1.0 - (1.02 * fRec119[0])))));
		double fTemp71 = (fTemp67 - fTemp70);
		double fTemp72 = (40.100000000000001 * fTemp71);
		double fTemp73 = std::max<double>(-600.0, fTemp72);
		double fTemp74 = (0.0 - (40.100000000000001 * fTemp70));
		double fTemp75 = std::max<double>(-600.0, fTemp74);
		double fTemp76 = (((std::fabs(fTemp72) > 0.0001) ? ((fTemp73 < -50.0) ? (0.0 - (fTemp73 * std::exp(fTemp73))) : (fTemp73 / (1.0 - std::exp((-1.0 * fTemp73))))) : ((fTemp71 * ((134.00083333333336 * fTemp71) + 20.050000000000001)) + 1.0)) - ((std::fabs(fTemp74) > 0.0001) ? ((fTemp75 < -50.0) ? (0.0 - (fTemp75 * std::exp(fTemp75))) : (fTemp75 / (1.0 - std::exp((-1.0 * fTemp75))))) : ((fTemp74 * ((0.083333333333333329 * fTemp74) + 0.5)) + 1.0)));
		fRec89[0] = ((0.024937655860349125 * fTemp76) - (fConst22 * ((fConst38 * fRec89[2]) + (fConst39 * fRec89[1]))));
		double fTemp77 = (fRec89[2] + (fRec89[0] + (2.0 * fRec89[1])));
		fVec22[0] = fTemp77;
		fRec88[0] = ((fConst22 * ((fConst26 * fTemp77) + (fConst40 * fVec22[1]))) - (fConst41 * fRec88[1]));
		fRec87[0] = (0.0 - (fConst18 * ((fConst19 * fRec87[1]) - (fRec88[0] + fRec88[1]))));
		fRec86[0] = (fRec87[0] - (fConst14 * ((fConst42 * fRec86[2]) + (fConst45 * fRec86[1]))));
		double fTemp78 = (fRec86[2] + (fRec86[0] + (2.0 * fRec86[1])));
		fVec23[0] = fTemp78;
		fRec85[0] = ((fConst14 * ((fConst16 * fTemp78) + (fConst46 * fVec23[1]))) - (fConst48 * fRec85[1]));
		fRec84[0] = (fRec85[0] - (fConst9 * ((fConst49 * fRec84[2]) + (fConst50 * fRec84[1]))));
		double fTemp79 = (fConst60 * fRec83[1]);
		fRec83[0] = ((fConst9 * (((fConst11 * fRec84[0]) + (fConst51 * fRec84[1])) + (fConst11 * fRec84[2]))) - (fConst55 * ((fConst57 * fRec83[2]) + fTemp79)));
		double fTemp80 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow3 * (fRec83[2] + (fConst55 * (fTemp79 + (fConst57 * fRec83[0])))))));
		...
		double fTemp81 = (fConst50 * fRec122[1]);
		fRec122[0] = ((fConst14 * (((fConst44 * fRec123[0]) + (fConst62 * fRec123[1])) + (fConst44 * fRec123[2]))) - (fConst63 * ((fConst64 * fRec122[2]) + fTemp81)));
		double fTemp82 = (fConst60 * fRec121[1]);
		fRec121[0] = ((fRec122[2] + (fConst63 * (fTemp81 + (fConst64 * fRec122[0])))) - (fConst55 * ((fConst57 * fRec121[2]) + fTemp82)));
		double fTemp83 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec121[2] + (fConst55 * (fTemp82 + (fConst57 * fRec121[0])))))));
		fRec128[0] = (0.0 - (fConst67 * ((fConst47 * fRec128[1]) - (fConst14 * (fTemp78 + fVec23[1])))));
		fRec127[0] = (fRec128[0] - (fConst9 * ((fConst49 * fRec127[2]) + (fConst50 * fRec127[1]))));
		double fTemp84 = (fRec127[2] + (fRec127[0] + (2.0 * fRec127[1])));
		fVec24[0] = fTemp84;
		fRec126[0] = ((fConst9 * ((fConst66 * fTemp84) + (fConst68 * fVec24[1]))) - (fConst69 * fRec126[1]));
		fRec125[0] = (fRec126[0] - (fConst65 * ((fConst70 * fRec125[2]) + (fConst60 * fRec125[1]))));
		double fTemp85 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst59 * fRec125[0]) + (fConst71 * fRec125[1])) + (fConst59 * fRec125[2])))));
		fRec130[0] = (0.0 - (fConst72 * ((fConst56 * fRec130[1]) - (fConst9 * (fTemp84 + fVec24[1])))));
		fRec129[0] = (fRec130[0] - (fConst65 * ((fConst70 * fRec129[2]) + (fConst60 * fRec129[1]))));
		double fTemp86 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec129[2] + (fRec129[0] + (2.0 * fRec129[1]))))));
		double fTemp87 = (((1.333521432 * (fTemp80 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp80))))) + (1.584893192 * ((fTemp83 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp83)))) + (fTemp85 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp85))))))) + (1.2589412 * (fTemp86 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp86))))));
		fVec25[0] = fTemp87;
		fRec82[0] = (0.0 - (fConst5 * ((fConst6 * fRec82[1]) - (fTemp87 + fVec25[1]))));
		double fTemp88 = (fRec90[0] * fTemp37);
		double fTemp89 = ((fSlow2 * fRec82[0]) + ((fTemp88 * ((fSlow9 * ((4.0 * (1.0 - std::fabs(fTemp88))) + -1.0)) + 1.0)) + (fSlow10 * fTemp76)));
		fVec26[0] = fTemp89;
		fRec81[0] = (0.0 - (fConst5 * ((fConst6 * fRec81[1]) - (fTemp89 + fVec26[1]))));
		double fTemp90 = (fRec64[0] * fRec81[0]);
		fVec27[0] = fTemp90;
		fRec80[0] = ((0.93028479253239138 * (fTemp90 + fVec27[1])) - (0.86056958506478287 * fRec80[1]));
		fRec79[0] = (fRec80[0] - ((1.8405051250752198 * fRec79[1]) + (0.86129424393186271 * fRec79[2])));
		double fTemp91 = (0.92544984225177063 * (fRec79[0] + fRec79[2]));
		double fTemp92 = (1.8508996845035413 * fRec79[1]);
		double fTemp93 = (fTemp92 + fTemp91);
		double fTemp94 = (fTemp93 / (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fRec78[1]))) + 100000.0));
		fVec28[0] = fTemp94;
		fRec131[0] = (fConst5 * ((410.0 * (fTemp94 + fVec28[1])) - (fConst6 * fRec131[1])));
		fRec78[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp91 + (fRec131[0] + fTemp92)) + -0.65976100000000004)))) + -89.08268292682925);
		fRec77[0] = (fConst2 * ((fConst3 * fRec77[1]) + (0.025000000000000001 * (fRec78[0] - fRec78[1]))));
		double fTemp95 = (fTemp93 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec133[1]))) + 100000.0));
		fVec29[0] = fTemp95;
		fRec134[0] = (fConst5 * ((410.0 * (fTemp95 + fVec29[1])) - (fConst6 * fRec134[1])));
		fRec133[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp91 + (fRec134[0] + fTemp92)) + -0.66454100000000005)))) + -87.916829268292673);
		fRec132[0] = (fConst2 * ((fConst3 * fRec132[1]) + (0.025000000000000001 * (fRec133[0] - fRec133[1]))));
		double fTemp96 = (std::min<double>(0.69999999999999996, fRec77[0]) + std::max<double>(-0.75, fRec132[0]));
		double fTemp97 = (0.5 * fRec69[1]);
		double fTemp98 = (0.40000000000000002 * fRec71[1]);
		double fTemp99 = (fTemp97 + ((0.29999999999999999 * fRec73[1]) + fTemp98));
		double fTemp100 = ((fTemp96 + (0.20000000000000001 * fRec75[1])) - fTemp99);
		fRec75[0] = fTemp100;
		double fRec76 = (0.0 - (0.20000000000000001 * fTemp100));
		fRec73[0] = (fRec76 + fRec75[1]);
		double fRec74 = (0.29999999999999999 * (fTemp96 - fTemp99));
		fRec71[0] = (fRec74 + fRec73[1]);
		double fRec72 = (0.40000000000000002 * (fTemp96 - (fTemp98 + fTemp97)));
		fRec69[0] = (fRec72 + fRec71[1]);
		double fRec70 = (0.5 * (fTemp96 - fTemp97));
