...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp60 = ((fTemp59 + fTemp58) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec96[1]))) + 100000.0));
		fVec15[0] = fTemp60;
		fRec99[0] = (fConst28 * ((820.0 * (fTemp60 + fVec15[1])) - (fConst29 * fRec99[1])));
		double fTemp61 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp58 + (fRec99[0] + fTemp59)) + -1.2569619999999999))));
		fRec96[0] = ((fTemp61 + (0.001532880487804878 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp61))) + 100000.0))) + -250.0);
		...
		double fTemp64 = ((fTemp63 + fTemp62) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec107[1]))) + 100000.0));
		fVec16[0] = fTemp64;
		fRec110[0] = (fConst31 * ((1500.0 * (fTemp64 + fVec16[1])) - (fConst32 * fRec110[1])));
		double fTemp65 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp62 + (fRec110[0] + fTemp63)) + -1.8873329999999999))));
		fRec107[0] = ((fTemp65 + (0.001258222 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp65))) + 100000.0))) + -250.0);
		...
		double fTemp69 = ((fTemp68 + fTemp67) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec112[1]))) + 100000.0));
		fVec18[0] = fTemp69;
		fRec115[0] = (fConst34 * ((2700.0 * (fTemp69 + fVec18[1])) - (fConst35 * fRec115[1])));
		double fTemp70 = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp67 + (fRec115[0] + fTemp68)) + -2.617753))));
		fRec112[0] = ((fTemp70 + (0.00096953814814814819 * (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fTemp70))) + 100000.0))) + -250.0);
		...
		double fTemp73 = ((fTemp72 + fTemp71) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec101[1]))) + 100000.0));
		fVec19[0] = fTemp73;
		fRec116[0] = (fConst31 * ((1500.0 * (fTemp73 + fVec19[1])) - (fConst32 * fRec116[1])));
		double fTemp74 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp71 + (fRec116[0] + fTemp72)) + -1.8873329999999999))));
		fRec101[0] = ((fTemp74 + (0.001258222 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp74))) + 100000.0))) + -250.0);
		...
		double fTemp77 = ((fTemp76 + fTemp75) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec91[1]))) + 100000.0));
		fVec20[0] = fTemp77;
		fRec117[0] = (fConst28 * ((820.0 * (fTemp77 + fVec20[1])) - (fConst29 * fRec117[1])));
		double fTemp78 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp75 + (fRec117[0] + fTemp76)) + -1.2569619999999999))));
		fRec91[0] = ((fTemp78 + (0.001532880487804878 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp78))) + 100000.0))) + -250.0);
