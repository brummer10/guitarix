...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp33 = (fConst36 * fRec60[1]);
		fRec62[0] = ((fConst66 * fRec62[1]) + (fConst65 * ((fConst43 * fVec13[0]) + (fConst72 * fVec13[1]))));
		fRec61[0] = (fRec62[0] - (fConst46 * ((fConst42 * fRec61[1]) + (fConst44 * fRec61[2]))));
		fRec60[0] = ((fConst46 * (((fConst41 * fRec61[0]) + (fConst73 * fRec61[1])) + (fConst41 * fRec61[2]))) - (fConst71 * ((fConst70 * fRec60[2]) + fTemp33)));
		double fTemp34 = max((double)-1, min((double)1, (fSlow8 * (fRec60[2] + (fConst71 * (fTemp33 + (fConst70 * fRec60[0])))))));
		double fTemp35 = (fConst36 * fRec63[1]);
		double fTemp36 = (fConst42 * fRec64[1]);
		...
		fRec64[0] = ((fConst53 * (((fConst48 * fRec65[0]) + (fConst77 * fRec65[1])) + (fConst48 * fRec65[2]))) - (fConst75 * ((fConst74 * fRec64[2]) + fTemp36)));
		fRec63[0] = ((fRec64[2] + (fConst75 * (fTemp36 + (fConst74 * fRec64[0])))) - (fConst71 * ((fConst70 * fRec63[2]) + fTemp35)));
		double fTemp37 = max((double)-1, min((double)1, (fSlow9 * (fRec63[2] + (fConst71 * (fTemp35 + (fConst70 * fRec63[0])))))));
		...
		double fTemp38 = max((double)-1, min((double)1, (fSlow10 * (((fConst35 * fRec67[0]) + (fConst79 * fRec67[1])) + (fConst35 * fRec67[2])))));
		...
		fVec20[0] = fTemp50;
		fRec107[0] = (fConst10 * ((fVec20[0] - fVec20[1]) + (fConst9 * fRec107[1])));
		fRec106[0] = (fConst10 * ((fRec107[0] - fRec107[1]) + (fConst9 * fRec106[1])));
		fRec105[0] = (fRec106[0] - (fConst7 * ((fConst6 * fRec105[2]) + (fConst2 * fRec105[1]))));
		fRec104[0] = ((fConst7 * (fRec105[2] + (fRec105[0] + (2 * fRec105[1])))) - (fConst5 * ((fConst4 * fRec104[2]) + (fConst2 * fRec104[1]))));
		double fTemp51 = (1e-15 + (fConst5 * (fRec37[0] * (fRec104[2] + (fRec104[0] + (2 * fRec104[1]))))));
		fVec21[0] = fTemp51;
		...
		fVec22[0] = fTemp52;
		fRec108[0] = ((fConst14 * fRec108[1]) + (fConst13 * (fVec22[0] + fVec22[1])));
		fRec101[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec108[0] + (0.9254498422517706 * (fRec102[2] + (fRec102[0] + (2.0 * fRec102[1]))))) - 2.617753)) - 153.04618518518518);
		fRec100[0] = ((fConst19 * fRec100[1]) + (fConst18 * ((fConst15 * fRec101[0]) + (fConst16 * fRec101[1]))));
		...
		fVec24[0] = fTemp54;
		fRec113[0] = ((fConst23 * fRec113[1]) + (fConst22 * (fVec24[0] + fVec24[1])));
		fRec110[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec113[0] + (0.9254498422517706 * (fRec111[2] + (fRec111[0] + (2.0 * fRec111[1]))))) - 1.887333)) - 124.17779999999999);
		fRec109[0] = ((fConst19 * fRec109[1]) + (fConst18 * ((fConst15 * fRec110[0]) + (fConst16 * fRec110[1]))));
		fRec99[0] = ((0.6 * fRec109[0]) + fRec100[0]);
		fRec98[0] = ((fConst27 * fRec98[1]) + (fConst26 * (fRec99[0] + fRec99[1])));
		...
		fVec26[0] = fTemp56;
		fRec114[0] = ((fConst23 * fRec114[1]) + (fConst22 * (fVec26[0] + fVec26[1])));
		fRec95[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec114[0] + (0.9254498422517706 * (fRec96[2] + (fRec96[0] + (2.0 * fRec96[1]))))) - 1.887333)) - 124.17779999999999);
		fRec94[0] = ((fConst19 * fRec94[1]) + (fConst18 * ((fConst15 * fRec95[0]) + (fConst16 * fRec95[1]))));
		...
		fVec28[0] = fTemp58;
		fRec119[0] = ((fConst31 * fRec119[1]) + (fConst30 * (fVec28[0] + fVec28[1])));
		fRec116[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec119[0] + (0.9254498422517706 * (fRec117[2] + (fRec117[0] + (2.0 * fRec117[1]))))) - 1.256962)) - 96.7119512195122);
		fRec115[0] = ((fConst19 * fRec115[1]) + (fConst18 * ((fConst15 * fRec116[0]) + (fConst16 * fRec116[1]))));
		...
		fVec30[0] = fTemp60;
		fRec120[0] = ((fConst31 * fRec120[1]) + (fConst30 * (fVec30[0] + fVec30[1])));
		fRec90[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec120[0] + (0.9254498422517706 * (fRec91[2] + (fRec91[0] + (2.0 * fRec91[1]))))) - 1.256962)) - 96.7119512195122);
		fRec89[0] = ((fConst19 * fRec89[1]) + (fConst18 * ((fConst15 * fRec90[0]) + (fConst16 * fRec90[1]))));
		...
		fRec87[0] = ((fVec31[IOTA&32767] + fRec87[1]) - fVec31[(IOTA-iConst32)&32767]);
		fRec86[0] = ((0.999 * fRec86[1]) + (fConst33 * fRec87[0]));
		...
		fRec129[0] = ((0.024937655860349125 * fTemp73) - (fConst59 * ((fConst57 * fRec129[2]) + (fConst55 * fRec129[1]))));
		double fTemp75 = (fRec129[2] + (fRec129[0] + (2 * fRec129[1])));
		fVec32[0] = fTemp75;
		fRec128[0] = ((fConst19 * fRec128[1]) + (fConst60 * ((fConst15 * fVec32[0]) + (fConst16 * fVec32[1]))));
		fRec127[0] = ((fConst63 * fRec127[1]) + (fConst62 * (fRec128[0] + fRec128[1])));
		fRec126[0] = (fRec127[0] - (fConst53 * ((fConst51 * fRec126[2]) + (fConst49 * fRec126[1]))));
		double fTemp76 = (fRec126[2] + (fRec126[0] + (2 * fRec126[1])));
		fVec33[0] = fTemp76;
		fRec125[0] = ((fConst66 * fRec125[1]) + (fConst65 * (fVec33[0] + fVec33[1])));
		fRec124[0] = (fRec125[0] - (fConst46 * ((fConst44 * fRec124[2]) + (fConst42 * fRec124[1]))));
		double fTemp77 = (fRec124[2] + (fRec124[0] + (2 * fRec124[1])));
		fVec34[0] = fTemp77;
		fRec123[0] = ((fConst69 * fRec123[1]) + (fConst68 * (fVec34[0] + fVec34[1])));
		fRec122[0] = (fRec123[0] - (fConst39 * ((fConst38 * fRec122[2]) + (fConst36 * fRec122[1]))));
		double fTemp78 = max((double)-1, min((double)1, (fSlow7 * (fRec122[2] + (fRec122[0] + (2 * fRec122[1]))))));
		double fTemp79 = (fConst36 * fRec130[1]);
		fRec132[0] = ((fConst66 * fRec132[1]) + (fConst65 * ((fConst43 * fVec33[0]) + (fConst72 * fVec33[1]))));
		fRec131[0] = (fRec132[0] - (fConst46 * ((fConst44 * fRec131[2]) + (fConst42 * fRec131[1]))));
		fRec130[0] = ((fConst46 * (((fConst41 * fRec131[0]) + (fConst73 * fRec131[1])) + (fConst41 * fRec131[2]))) - (fConst71 * ((fConst70 * fRec130[2]) + fTemp79)));
		double fTemp80 = max((double)-1, min((double)1, (fSlow8 * (fRec130[2] + (fConst71 * (fTemp79 + (fConst70 * fRec130[0])))))));
		double fTemp81 = (fConst36 * fRec133[1]);
		double fTemp82 = (fConst42 * fRec134[1]);
		fRec136[0] = ((fConst63 * fRec136[1]) + (fConst62 * ((fConst50 * fRec128[0]) + (fConst76 * fRec128[1]))));
		fRec135[0] = (fRec136[0] - (fConst53 * ((fConst51 * fRec135[2]) + (fConst49 * fRec135[1]))));
		fRec134[0] = ((fConst53 * (((fConst48 * fRec135[0]) + (fConst77 * fRec135[1])) + (fConst48 * fRec135[2]))) - (fConst75 * ((fConst74 * fRec134[2]) + fTemp82)));
		fRec133[0] = ((fRec134[2] + (fConst75 * (fTemp82 + (fConst74 * fRec134[0])))) - (fConst71 * ((fConst70 * fRec133[2]) + fTemp81)));
		double fTemp83 = max((double)-1, min((double)1, (fSlow9 * (fRec133[2] + (fConst71 * (fTemp81 + (fConst70 * fRec133[0])))))));
		fRec138[0] = ((fConst69 * fRec138[1]) + (fConst68 * ((fConst37 * fVec34[0]) + (fConst78 * fVec34[1]))));
		fRec137[0] = (fRec138[0] - (fConst39 * ((fConst38 * fRec137[2]) + (fConst36 * fRec137[1]))));
		double fTemp84 = max((double)-1, min((double)1, (fSlow10 * (((fConst35 * fRec137[0]) + (fConst79 * fRec137[1])) + (fConst35 * fRec137[2])))));
		...
		fVec35[0] = fTemp85;
		fRec121[0] = ((fConst27 * fRec121[1]) + (fConst26 * (fVec35[0] + fVec35[1])));
		...
		fVec38[0] = fTemp89;
		fRec139[0] = ((fConst27 * fRec139[1]) + (fConst26 * (fVec38[0] + fVec38[1])));
		...
		fVec39[0] = fTemp90;
		fRec142[0] = ((fConst27 * fRec142[1]) + (fConst26 * (fVec39[0] + fVec39[1])));
