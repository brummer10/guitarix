...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec70[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec75[0] + (fConst24 * (fRec22[0] * (fRec71[2] + (fRec71[0] + (2 * fRec71[1])))))) - 2.617753)) - 153.04618518518518);
		...
		fRec77[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec78[0] + fRec68[1]) - 1.887333)) - 124.17779999999999);
		...
		fRec66[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec79[0] + fRec67[0]) - 1.887333)) - 124.17779999999999);
		...
		fRec81[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec82[0] + fRec64[1]) - 1.256962)) - 96.7119512195122);
		...
		fRec63[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec83[0] + fRec64[0]) - 1.256962)) - 96.7119512195122);
