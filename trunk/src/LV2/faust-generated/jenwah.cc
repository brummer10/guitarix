...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst13 = 1.70525567579937e-20 * fConst0;
	double fConst14 = mydsp_faustpower3_f(fConst0);
	fConst15 = fConst14 * (1.34876470561352e-16 - fConst13);
	double fConst16 = 1.69987552074167e-20 * fConst0;
	fConst17 = fConst0 * (fConst7 * (fConst16 + -1.34944418179283e-16) + 3.41831959643481e-12);
	double fConst18 = 2.97901574832717e-20 * fConst0;
	fConst19 = fConst0 * (fConst7 * (fConst18 + -4.9178913275869e-16) + 4.18712034765452e-14);
	fConst20 = fConst7 * (fConst0 * (1.39394278118629e-17 - fConst6) + -1.21159485597039e-13);
	fConst21 = fConst0 * (fConst0 * (fConst0 * (fConst9 + -2.77707619975565e-17) + 1.05494945988648e-13) + -2.75362467265997e-12);
	fConst22 = fConst0 * (fConst0 * (fConst0 * (fConst11 + -3.2569797714609e-17) + 5.79248390117011e-13) + -1.0981649358109e-11);
	double fConst23 = 2.79868476763347e-19 * fConst0;
	fConst24 = fConst14 * (fConst23 + -2.78788556237258e-17);
	...
	fConst32 = fConst14 * (fConst23 + 2.78788556237258e-17);
	...
	fConst40 = fConst14 * (-1.34876470561352e-16 - fConst13);
	fConst41 = fConst0 * (fConst7 * (fConst16 + 1.34944418179283e-16) + -3.41831959643481e-12);
	fConst42 = fConst0 * (fConst7 * (fConst18 + 4.9178913275869e-16) + -4.18712034765452e-14);
	double fConst43 = 4.26313918949843e-21 * fConst0;
	fConst44 = fConst7 * (fConst0 * (fConst43 + 6.7438235280676e-17) + 9.21166476483994e-14);
	double fConst45 = 4.24968880185418e-21 * fConst0;
	fConst46 = fConst0 * (fConst0 * (fConst0 * (-6.74722090896416e-17 - fConst45) + -9.33056295237144e-14) + -1.7091597982174e-12);
	double fConst47 = 7.44753937081794e-21 * fConst0;
	fConst48 = fConst0 * (fConst0 * (fConst0 * (-2.45894566379345e-16 - fConst47) + -3.53469573143013e-13) + -2.09356017382726e-14);
	fConst49 = fConst7 * (fConst0 * (fConst43 + -6.7438235280676e-17) + 9.21166476483994e-14);
	fConst50 = fConst0 * (fConst0 * (fConst0 * (6.74722090896416e-17 - fConst45) + -9.33056295237144e-14) + 1.7091597982174e-12);
	fConst51 = fConst0 * (fConst0 * (fConst0 * (2.45894566379345e-16 - fConst47) + -3.53469573143013e-13) + 2.09356017382726e-14);
	fConst52 = 4.46852362249076e-20 * fConst7;
	fConst53 = 2.54981328111251e-20 * fConst7;
	fConst54 = 2.55788351369906e-20 * fConst7 + -1.84233295296799e-13;
	clear_state_f();
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = fRec8[0] - (fRec7[1] * (fConst34 + fTemp2 * (fConst33 + fConst32 * fTemp2) + 2.50329515696361e-12) + fRec7[2] * (fConst7 * (fConst31 + fTemp2 * (fConst30 + fConst29 * fTemp2)) + 3.75494273544542e-12) + fRec7[3] * (fConst28 + fTemp2 * (fConst26 + fConst24 * fTemp2) + 2.50329515696361e-12) + fRec7[4] * (fConst22 + fTemp2 * (fConst21 + fConst20 * fTemp2) + 6.25823789240903e-13)) / fTemp3;
		output0[i0] = FAUSTFLOAT(fSlow8 * fTemp0 + (fConst7 * fRec7[2] * (fTemp2 * (fConst54 * fTemp2 + 1.86611259047429e-13 - fConst53) + 7.06939146286026e-13 - fConst52) + fRec7[4] * (fConst51 + fTemp2 * (fConst50 + fConst49 * fTemp2)) + fRec7[0] * (fConst48 + fTemp2 * (fConst46 + fConst44 * fTemp2)) + fRec7[1] * (fConst42 + fTemp2 * (fConst41 + fConst40 * fTemp2)) + fRec7[3] * (fConst19 + fTemp2 * (fConst17 + fConst15 * fTemp2))) / fTemp3);
		iVec0[1] = iVec0[0];
		fRec2[1] = fRec2[0];
		fRec1[1] = fRec1[0];
		fRec0[1] = fRec0[0];
