...
#define fVslider2 (*fVslider2_)
	...
	double fSlow5 = (((fSlow0 * (((2.9448437500000007e-05 * fSlow1) + -8.7317187500000011e-06) - fSlow4)) + (0.00011998125000000002 * fSlow1)) + 1.2916875000000002e-05);
	double fSlow6 = ((2.5703125000000004e-09 * fSlow1) - (2.5703125000000003e-10 * fSlow0));
	double fSlow7 = (7.3437500000000008e-09 * fSlow1);
	double fSlow8 = (((fSlow0 * (fSlow6 + -4.7734375000000009e-10)) + fSlow7) + 7.3437500000000006e-10);
	...
	double fSlow13 = (((9.187500000000001e-07 * fSlow11) + ((fSlow0 * (3.0182812500000004e-06 - fSlow4)) + (fSlow1 * ((2.9448437500000007e-05 * fSlow0) + 2.4812500000000002e-06)))) + 2.4812500000000001e-07);
	double fSlow14 = ((fSlow0 * (fSlow6 + 2.5703125000000003e-10)) + (fSlow11 * (fSlow7 - (7.3437500000000006e-10 * (fSlow0 + -1.0)))));
