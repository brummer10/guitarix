...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst6 = 6.0569805086158998e-28 * fConst0;
	...
	double fConst8 = 9.0101081625029807e-31 * fConst0;
	...
	double fConst14 = 2.2525270406257401e-30 * fConst0;
	...
	double fConst16 = 1.5119926001133501e-27 * fConst0;
	...
	double fConst27 = 1.00949675143598e-28 * fConst0;
	...
	double fConst29 = 1.5016846937505001e-31 * fConst0;
	...
	double fConst31 = 1.00799506674223e-28 * fConst0;
...
#define fVslider2 (*fVslider2_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		output0[i0] = FAUSTFLOAT(fRec0[0] + fSlow3 * fTemp0);
		fRec13[1] = fRec13[0];
