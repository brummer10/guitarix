...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fSlow11 * ((fTemp15 * (4 - (4 * fabs(fTemp15)))) - fTemp15)) + ((fSlow10 * fTemp4) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp2)))) - 2.6177529999999978)) - 153.04618518518518);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fSlow11 * ((fTemp32 * (4 - (4 * fabs(fTemp32)))) - fTemp32)) + ((fSlow10 * fTemp21) + ((fSlow9 * fRec41[0]) + (fRec40[0] + fTemp19)))) - 2.6177529999999978)) - 153.04618518518518);
