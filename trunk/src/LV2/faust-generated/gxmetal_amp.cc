...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst11 = (3.1415926535897931 / fConst0);
	fConst12 = (1.0 / (fConst11 + 1.0));
	fConst13 = (1.0 - fConst11);
	double fConst14 = (1.0 / std::tan((20517.741620594938 / fConst0)));
	fConst15 = (1.0 / (fConst14 + 1.0));
	fConst16 = (1.0 - fConst14);
	double fConst17 = (1.0 / std::tan((270.1769682087222 / fConst0)));
	fConst18 = (1.0 / (fConst17 + 1.0));
	fConst19 = (1.0 - fConst17);
	double fConst20 = (1.0 / std::tan((414.69023027385271 / fConst0)));
	fConst21 = (1.0 / (fConst20 + 1.0));
	fConst22 = (1.0 - fConst20);
	double fConst23 = (1.0 / std::tan((609.46897479641984 / fConst0)));
	...
	double fConst29 = (1.0 / std::tan((804.24771931898704 / fConst0)));
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp6 = (fRec18[0] * fRec23[0]);
		fVec2[0] = fTemp6;
		fRec17[0] = (0.0 - (fConst15 * ((fConst16 * fRec17[1]) - (fTemp6 + fVec2[1]))));
		...
		fVec3[0] = fTemp9;
		fRec24[0] = (fConst21 * ((1500.0 * (fTemp9 + fVec3[1])) - (fConst22 * fRec24[1])));
		fRec14[0] = (double(Ftube(int(TUBE_TABLE_12AY7_250k), double(((fTemp7 + (fRec24[0] + fTemp8)) + -1.9543079999999999)))) + -119.71279999999999);
		...
		double fTemp10 = (0.92544984225177063 * (fRec10[0] + fRec10[2]));
		double fTemp11 = (1.8508996845035413 * fRec10[1]);
		double fTemp12 = ((fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_12AY7_250k), double(fRec9[1]))) + 100000.0));
		fVec4[0] = fTemp12;
		fRec25[0] = (fConst24 * ((820.0 * (fTemp12 + fVec4[1])) - (fConst25 * fRec25[1])));
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AY7_250k), double(((fTemp10 + (fRec25[0] + fTemp11)) + -1.2649159999999999)))) + -95.741951219512202);
		...
		double fTemp13 = ((((fSlow15 * fRec7[0]) + (fSlow23 * fRec7[1])) + (fSlow24 * fRec7[2])) + (fSlow25 * fRec7[3]));
		double fTemp14 = std::max<double>(1.0, std::fabs((fSlow10 * fTemp13)));
		double fTemp15 = ((fConst27 * double((fRec26[1] < fTemp14))) + (fConst28 * double((fRec26[1] >= fTemp14))));
		fRec26[0] = ((fRec26[1] * fTemp15) + (fTemp14 * (1.0 - fTemp15)));
		double fTemp16 = std::max<double>(0.0, ((20.0 * std::log10(fRec26[0])) + 50.0));
		double fTemp17 = (0.5 * std::min<double>(1.0, std::max<double>(0.0, (0.095229025807065992 * fTemp16))));
		double fTemp18 = (fSlow10 * (fTemp13 * std::pow(10.0, (0.050000000000000003 * (((fTemp16 * (0.0 - fTemp17)) / (fTemp17 + 1.0)) + 10.0)))));
		fVec5[0] = fTemp18;
		fRec6[0] = ((0.93028479253239138 * (fTemp18 + fVec5[1])) - (0.86056958506478287 * fRec6[1]));
		fRec5[0] = (fRec6[0] - ((1.8405051250752198 * fRec5[1]) + (0.86129424393186271 * fRec5[2])));
		double fTemp19 = (0.92544984225177063 * (fRec5[0] + fRec5[2]));
		fRec27[0] = (fConst30 * ((0.065714285714285711 * (fRec4[1] + fRec4[2])) - (fConst31 * fRec27[1])));
		double fTemp20 = (1.8508996845035413 * fRec5[1]);
		fRec4[0] = (double(Ftube(int(TUBE_TABLE_EL34_68k), double(((fTemp19 + (fRec27[0] + fTemp20)) + -15.743945)))) + -255.41822826086957);
		fRec29[0] = (fConst30 * ((0.065714285714285711 * (fRec28[1] + fRec28[2])) - (fConst31 * fRec29[1])));
		fRec28[0] = (double(Ftube(int(TUBE_TABLE_EL34_250k), double(((fTemp19 + (fRec29[0] + fTemp20)) + -15.743945)))) + -255.41822826086957);
