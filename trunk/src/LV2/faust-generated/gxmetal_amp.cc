...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		fRec6[0] = ((0.999 * fRec6[1]) + fSlow12);
		fRec13[0] = ((0.999 * fRec13[1]) + fSlow13);
		double fTemp0 = (double)input0[i];
		double fTemp1 = fabs(fTemp0);
		double fTemp2 = (1e-15 + (0.027 * fRec15[1]));
		fVec0[0] = fTemp2;
		fRec16[0] = ((fConst18 * fRec16[1]) + (fConst17 * (fVec0[0] + fVec0[1])));
		...
		fVec1[0] = fTemp3;
		fRec12[0] = ((fConst27 * fRec12[1]) + (fConst26 * (fVec1[0] + fVec1[1])));
		double fTemp4 = (1e-15 + (0.015 * fRec11[1]));
		fVec2[0] = fTemp4;
		fRec17[0] = ((fConst31 * fRec17[1]) + (fConst30 * (fVec2[0] + fVec2[1])));
		fRec11[0] = (Ftube(TUBE_TABLE_12AY7_250k, ((fRec17[0] + fRec12[0]) - 1.9543079999999988)) - 119.71279999999999);
		fRec10[0] = ((fConst23 * fRec10[1]) + (fConst22 * ((fConst19 * fRec11[0]) + (fConst20 * fRec11[1]))));
		fRec9[0] = ((fConst27 * fRec9[1]) + (fConst26 * (fRec10[0] + fRec10[1])));
		double fTemp5 = (1e-15 + (0.0082 * fRec8[1]));
		fVec3[0] = fTemp5;
		fRec18[0] = ((fConst35 * fRec18[1]) + (fConst34 * (fVec3[0] + fVec3[1])));
		fRec8[0] = (Ftube(TUBE_TABLE_12AY7_250k, ((fRec18[0] + fRec9[0]) - 1.2649159999999988)) - 95.7419512195122);
		fRec7[0] = ((fConst23 * fRec7[1]) + (fConst22 * ((fConst19 * fRec8[0]) + (fConst20 * fRec8[1]))));
		fRec5[0] = ((fRec7[0] * fRec6[0]) - (fSlow11 * (((fSlow10 * fRec5[1]) + (fSlow9 * fRec5[2])) + (fSlow7 * fRec5[3]))));
		double fTemp6 = ((((fSlow26 * fRec5[0]) + (fSlow25 * fRec5[1])) + (fSlow23 * fRec5[2])) + (fSlow21 * fRec5[3]));
		double fTemp7 = max((double)1, fabs((fSlow11 * fTemp6)));
		double fTemp8 = ((fConst37 * (fRec4[1] < fTemp7)) + (fConst36 * (fRec4[1] >= fTemp7)));
		fRec4[0] = ((fRec4[1] * fTemp8) + (fTemp7 * (0 - (fTemp8 - 1))));
		...
		fRec19[0] = ((fConst41 * fRec19[1]) + (fConst40 * (fRec3[1] + fRec3[2])));
		...
		fRec22[0] = ((fConst41 * fRec22[1]) + (fConst40 * (fRec21[1] + fRec21[2])));
		fRec21[0] = (Ftube(TUBE_TABLE_EL34_68k, ((fRec22[0] + fTemp11) - 15.743945)) - 255.41822826086957);
		fRec20[0] = ((fConst23 * fRec20[1]) + (fConst42 * ((fConst19 * fRec21[0]) + (fConst20 * fRec21[1]))));
		...
		fRec23[0] = ((0.999 * fRec23[1]) + fSlow27);
