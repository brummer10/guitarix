...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst6 = std::tan(125.66370614359172 / fConst0);
	fConst7 = mydsp_faustpower2_f(fConst6);
	fConst8 = 2.0 * (1.0 - 1.0 / fConst7);
	fConst9 = 1.0 / fConst6;
	fConst10 = (fConst9 + -1.414213562373095) / fConst6 + 1.0;
	fConst11 = (fConst9 + 1.414213562373095) / fConst6 + 1.0;
	fConst12 = 1.0 / fConst11;
	fConst13 = 2.0 * fConst0;
	fConst14 = mydsp_faustpower2_f(fConst13);
	fConst15 = mydsp_faustpower3_f(fConst13);
	fConst16 = std::tan(97.38937226128358 / fConst0);
	fConst17 = 1.0 / fConst16;
	fConst18 = 1.0 - fConst17;
	fConst19 = 1.0 / std::tan(270.1769682087222 / fConst0);
	fConst20 = 1.0 - fConst19;
	fConst21 = 1.0 / (fConst19 + 1.0);
	fConst22 = 0.025 / fConst16;
	fConst23 = 1.0 / (fConst17 + 1.0);
	fConst24 = 3.141592653589793 / fConst0;
	fConst25 = 1.0 - fConst24;
	fConst26 = 1.0 / (fConst24 + 1.0);
	fConst27 = 1.0 / std::tan(20517.741620594938 / fConst0);
	fConst28 = 1.0 - fConst27;
	fConst29 = 1.0 / (fConst27 + 1.0);
	fConst30 = 1.0 / std::tan(414.6902302738527 / fConst0);
	fConst31 = 1.0 - fConst30;
	fConst32 = 1.0 / (fConst30 + 1.0);
	fConst33 = 1.0 / std::tan(609.4689747964198 / fConst0);
	fConst34 = 1.0 - fConst33;
	fConst35 = 1.0 / (fConst33 + 1.0);
	fConst36 = 3.0 * fConst15;
	fConst37 = std::exp(-(0.1 / fConst0));
	fConst38 = std::exp(-(2e+02 / fConst0));
	fConst39 = 1.0 / std::tan(804.247719318987 / fConst0);
	fConst40 = 1.0 - fConst39;
	fConst41 = 1.0 / (fConst39 + 1.0);
	fConst42 = 1.0 / (fConst7 * fConst11);
	clear_state_f();
}
...
#define fVslider3 (*fVslider3_)
	...
	double fSlow17 = 6.221578000000002e-10 * fSlow1 + fSlow0 * (5.345780000000001e-09 * fSlow1 + 2.6728900000000006e-11) + 3.1107890000000005e-12;
	double fSlow18 = fConst15 * fSlow17;
	double fSlow19 = fConst14 * (4.859800000000001e-07 * fSlow0 + 8.613660000000003e-06 * fSlow1 + 9.962810000000002e-08);
	double fSlow20 = fConst13 * (fSlow4 + 0.00023500000000000002 * fSlow0 + 0.0003347);
	double fSlow21 = fSlow20 + fSlow19;
	double fSlow22 = fSlow21 + fSlow18;
	double fSlow23 = fSlow20 + fSlow18 - fSlow19;
	double fSlow24 = fConst36 * fSlow17;
	double fSlow25 = fSlow21 - fSlow24;
	double fSlow26 = fSlow19 + fSlow24 - fSlow20;
	double fSlow27 = 0.0010000000000000009 * std::pow(1e+01, -(0.02 * fSlow13));
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec1[0] = fTemp5;
		fRec21[0] = fConst21 * (2.7e+03 * (fTemp5 + fVec1[1]) - fConst20 * fRec21[1]);
		fRec18[0] = Ftube(TUBE_TABLE_12AY7_68k, fTemp4 + fRec21[0] + fTemp3 + -2.775058) + -147.2200740740741;
		double fTemp6 = fRec18[0] - fRec18[1];
		fRec17[0] = fConst23 * (fConst22 * fTemp6 - fConst18 * fRec17[1]);
		fRec22[0] = fConst26 * (fConst25 * fRec22[1] + 0.025 * fTemp6);
		fRec23[0] = fSlow15 + 0.999 * fRec23[1];
		double fTemp7 = fRec23[0] * ((iSlow12) ? fRec22[0] : fRec17[0]);
		fVec2[0] = fTemp7;
		fRec16[0] = -(fConst29 * (fConst28 * fRec16[1] - (fTemp7 + fVec2[1])));
		...
		double fTemp10 = (fTemp8 + fTemp9) / (Ranode(TUBE_TABLE_12AY7_250k, fRec13[1]) + 1e+05);
		fVec3[0] = fTemp10;
		fRec24[0] = fConst32 * (1.5e+03 * (fTemp10 + fVec3[1]) - fConst31 * fRec24[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AY7_250k, fTemp9 + fRec24[0] + fTemp8 + -1.954308) + -119.71279999999999;
		double fTemp11 = fRec13[0] - fRec13[1];
		fRec12[0] = fConst23 * (fConst22 * fTemp11 - fConst18 * fRec12[1]);
		fRec25[0] = fConst26 * (fConst25 * fRec25[1] + 0.025 * fTemp11);
		double fTemp12 = ((iSlow12) ? fRec25[0] : fRec12[0]);
		fVec4[0] = fTemp12;
		fRec11[0] = -(fConst29 * (fConst28 * fRec11[1] - (fTemp12 + fVec4[1])));
		...
		double fTemp13 = 1.8508996845035413 * fRec9[1];
		double fTemp14 = 0.9254498422517706 * (fRec9[0] + fRec9[2]);
		double fTemp15 = (fTemp13 + fTemp14) / (Ranode(TUBE_TABLE_12AY7_250k, fRec8[1]) + 1e+05);
		fVec5[0] = fTemp15;
		fRec26[0] = fConst35 * (8.2e+02 * (fTemp15 + fVec5[1]) - fConst34 * fRec26[1]);
		fRec8[0] = Ftube(TUBE_TABLE_12AY7_250k, fTemp14 + fRec26[0] + fTemp13 + -1.264916) + -95.7419512195122;
		double fTemp16 = fRec8[0] - fRec8[1];
		fRec7[0] = fConst23 * (fConst22 * fTemp16 - fConst18 * fRec7[1]);
		fRec27[0] = fConst26 * (fConst25 * fRec27[1] + 0.025 * fTemp16);
		...
		double fTemp17 = fSlow26 * fRec6[1] + fSlow25 * fRec6[2] + fSlow23 * fRec6[3] - fSlow22 * fRec6[0];
		double fTemp18 = std::max<double>(1.0, std::fabs(fSlow10 * fTemp17));
		double fTemp19 = fConst38 * double(fRec5[1] < fTemp18) + fConst37 * double(fRec5[1] >= fTemp18);
		fRec5[0] = fRec5[1] * fTemp19 + fTemp18 * (1.0 - fTemp19);
		double fTemp20 = std::max<double>(0.0, 2e+01 * std::log10(std::max<double>(2.2250738585072014e-308, fRec5[0])) + 5e+01);
		double fTemp21 = std::min<double>(1.0, std::max<double>(0.0, 0.09522902580706599 * fTemp20));
		double fTemp22 = fSlow10 * fTemp17 * std::pow(1e+01, 0.05 * (1e+01 - 0.5 * (fTemp20 * fTemp21 / (0.5 * fTemp21 + 1.0))));
		fVec6[0] = fTemp22;
		fRec4[0] = 0.9302847925323914 * (fTemp22 + fVec6[1]) - 0.8605695850647829 * fRec4[1];
		fRec3[0] = fRec4[0] - (1.8405051250752198 * fRec3[1] + 0.8612942439318627 * fRec3[2]);
		double fTemp23 = 1.8508996845035413 * fRec3[1];
		fRec29[0] = fConst41 * (0.06571428571428571 * (fRec2[1] + fRec2[2]) - fConst40 * fRec29[1]);
		double fTemp24 = 0.9254498422517706 * (fRec3[0] + fRec3[2]);
		fRec2[0] = Ftube(TUBE_TABLE_EL34_250k, fTemp24 + fRec29[0] + fTemp23 + -15.743945) + -255.41822826086957;
		fRec31[0] = fConst41 * (0.06571428571428571 * (fRec30[1] + fRec30[2]) - fConst40 * fRec31[1]);
		fRec30[0] = Ftube(TUBE_TABLE_EL34_68k, fTemp24 + fRec31[0] + fTemp23 + -15.743945) + -255.41822826086957;
		fRec1[0] = 0.1 * (fRec30[0] + fRec2[0]) - fConst12 * (fConst10 * fRec1[2] + fConst8 * fRec1[1]);
		fRec0[0] = fConst42 * (fRec1[2] + (fRec1[0] - 2.0 * fRec1[1])) - fConst5 * (fConst4 * fRec0[2] + fConst2 * fRec0[1]);
