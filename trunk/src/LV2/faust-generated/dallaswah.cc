...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst1 = 1833.7929316777988 / fConst0;
	double fConst2 = fConst1 + 1.0;
	fConst3 = 1.0 / fConst2;
	fConst4 = 1.0 - fConst1;
	fConst5 = 0.01 / fConst2;
	fConst6 = mydsp_faustpower2_f(fConst0);
	double fConst7 = 2.4203899133154399e-19 * fConst0;
	...
	double fConst14 = 1.09962424162848e-18 * fConst0;
	fConst15 = fConst6 * (-4.9081562024677497e-17 - fConst14) + 1.1209103273650301e-11;
	double fConst16 = 1.7918901081266399e-19 * fConst0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec5[0] = 0.0070000000000000062 * std::max<double>(0.02, std::min<double>(1.0, fRec6[0])) + 0.99299999999999999 * fRec5[1];
