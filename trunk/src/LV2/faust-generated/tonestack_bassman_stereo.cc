...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (1.4e-07 * fSlow15 + fSlow1 * (2.8437500000000003e-07 - fSlow2) + fSlow0 * (1.0125e-05 * fSlow1 + 1.8100000000000002e-06) + 4.525e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.9125000000000002e-11) + fSlow15 * (fSlow4 + 3.500000000000001e-11 * (1.0 - fSlow1));
