...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp27 = (1 - fRec15[0]);
		fRec11[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp12 * ((fTemp27 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp27 * fTemp12))))) - 0.024937655860349125)))) + (fSlow11 * fRec15[0]))) + ((fSlow10 * fRec17[0]) + (fRec16[0] + (0.5 * (fTemp14 * (1 - (0.3333333333333333 * faustpower<2>(fTemp14)))))))) - 2.617752999999999)) - 153.04618518518518);
