...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp33 = (fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp33;
		fRec50[0] = fConst71 * (2700.0 * (fTemp33 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(fTemp31 + fRec50[0] + fTemp32 + -2.617753))) + -153.04618518518518;
		...
		double fTemp37 = (fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp37;
		fRec53[0] = fConst17 * (1500.0 * (fTemp37 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp35 + fRec53[0] + fTemp36 + -1.887332))) + -124.17786666666666;
		...
		double fTemp40 = (fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec1[1]))) + 100000.0);
		fVec11[0] = fTemp40;
		fRec55[0] = fConst9 * (820.0 * (fTemp40 + fVec11[1]) - fConst10 * fRec55[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp38 + fRec55[0] + fTemp39 + -1.2569619999999999))) + -96.711951219512201;
