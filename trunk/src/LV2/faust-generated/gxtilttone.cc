...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst1 = 2.08313095376176e-05 * fConst0;
	fConst2 = fConst1 + 9.71421943566398e-05;
	fConst3 = (9.71421943566398e-05 - fConst1) / fConst2;
	fConst4 = 2.29741267120048e-20 * fConst0;
	...
	fConst23 = 7.30862585054866e-20 * fConst0;
	...
	fConst42 = 9.18965068480191e-20 * fConst0;
	...
	fConst45 = 1.83793013696038e-19 * fConst0;
	...
	fConst60 = 2.92345034021946e-19 * fConst0;
	...
	fConst69 = 5.57980308175106e-19 * fConst43;
	...
	fConst76 = 4.38517551032919e-19 * fConst43;
	...
	fConst95 = std::tan(270.1769682087222 / fConst0);
	fConst96 = mydsp_faustpower2_f(fConst95);
	fConst97 = 2.0 * (1.0 - 1.0 / fConst96);
	fConst98 = 1.0 / fConst95;
	fConst99 = (fConst98 + -1.0000000000000004) / fConst95 + 1.0;
	fConst100 = (fConst98 + 1.0000000000000004) / fConst95 + 1.0;
	fConst101 = 1.0 / fConst100;
	fConst102 = std::tan(659.7344572538566 / fConst0);
	fConst103 = mydsp_faustpower2_f(fConst102);
	fConst104 = 2.0 * (1.0 - 1.0 / fConst103);
	fConst105 = 1.0 / fConst102;
	fConst106 = (fConst105 + -1.0000000000000004) / fConst102 + 1.0;
	fConst107 = (fConst105 + 1.0000000000000004) / fConst102 + 1.0;
	fConst108 = 1.0 / fConst107;
	fConst109 = std::tan(3769.9111843077517 / fConst0);
	fConst110 = mydsp_faustpower2_f(fConst109);
	fConst111 = 2.0 * (1.0 - 1.0 / fConst110);
	fConst112 = 1.0 / fConst109;
	fConst113 = (fConst112 + -1.0000000000000004) / fConst109 + 1.0;
	fConst114 = (fConst112 + 1.0000000000000004) / fConst109 + 1.0;
	fConst115 = 1.0 / fConst114;
	fConst116 = std::tan(20517.741620594938 / fConst0);
	fConst117 = mydsp_faustpower2_f(fConst116);
	fConst118 = 2.0 * (1.0 - 1.0 / fConst117);
	fConst119 = 1.0 / fConst116;
	fConst120 = (fConst119 + -1.0000000000000004) / fConst116 + 1.0;
	fConst121 = (fConst119 + 1.0000000000000004) / fConst116 + 1.0;
	fConst122 = 1.0 / fConst121;
	fConst123 = 1.0 - fConst119;
	fConst124 = 1.0 / (fConst119 + 1.0);
	fConst125 = 1.0 - fConst112;
	fConst126 = fConst112 + 1.0;
	fConst127 = 1.0 / fConst126;
	fConst128 = 1.0 - fConst105;
	fConst129 = fConst105 + 1.0;
	fConst130 = 1.0 / fConst129;
	fConst131 = 1.0 - fConst98;
	fConst132 = fConst98 + 1.0;
	fConst133 = 1.0 / fConst132;
	fConst134 = 9.8607192519763e-16 * fConst0;
	fConst135 = fConst0 * (3.66844210330959e-12 - fConst134) + -5.84016130407215e-10;
	fConst136 = 4.82764380044673e-19 * fConst0;
	fConst137 = fConst0 * (fConst0 * (fConst136 + -8.0460730007444e-17) + -3.45844530442491e-12) + 5.7640755073748e-10;
	fConst138 = fConst0 * (fConst0 * (8.0460730007444e-17 - fConst136) + 3.45844530442491e-12) + -5.7640755073748e-10;
	fConst139 = fConst0 * (fConst134 + -3.66844210330959e-12) + 5.84016130407215e-10;
	fConst140 = 7.4702418575578e-15 * fConst0;
	fConst141 = fConst0 * (1.59088484003545e-12 - fConst140) + -5.76407550737481e-11;
	fConst142 = fConst0 * (fConst140 + -1.59088484003545e-12) + 5.76407550737481e-11;
	fConst143 = 3.65730590942934e-18 * fConst0;
	fConst144 = fConst0 * (fConst143 + -6.09550984904878e-16) + -9.63708565903573e-28;
	fConst145 = fConst0 * (6.09550984904878e-16 - fConst143) + 9.63708565903573e-28;
	fConst146 = 1.97214385039526e-15 * fConst43;
	fConst147 = fConst146 + -1.16803226081443e-09;
	fConst148 = 1.93105752017869e-18 * fConst0;
	fConst149 = fConst43 * (1.60921460014888e-16 - fConst148) + 1.15281510147496e-09;
	fConst150 = fConst43 * (fConst148 + -1.60921460014888e-16) + -1.15281510147496e-09;
	fConst151 = 1.16803226081443e-09 - fConst146;
	fConst152 = 1.49404837151156e-14 * fConst43;
	fConst153 = fConst152 + -1.15281510147496e-10;
	fConst154 = 1.15281510147496e-10 - fConst152;
	fConst155 = 1.46292236377174e-17 * fConst0;
	fConst156 = 1.21910196980976e-15 - fConst155;
	fConst157 = fConst155 + -1.21910196980976e-15;
	fConst158 = mydsp_faustpower3_f(fConst0);
	fConst159 = 2.89658628026804e-18 * fConst43;
	fConst160 = fConst159 + 6.91689060884983e-12;
	fConst161 = -6.91689060884983e-12 - fConst159;
	fConst162 = 2.1943835456576e-17 * fConst43;
	fConst163 = fConst162 + 1.92741713180715e-27;
	fConst164 = -1.92741713180715e-27 - fConst162;
	fConst165 = fConst43 * (-1.60921460014888e-16 - fConst148) + -1.15281510147496e-09;
	fConst166 = fConst43 * (fConst148 + 1.60921460014888e-16) + 1.15281510147496e-09;
	fConst167 = -1.21910196980976e-15 - fConst155;
	fConst168 = fConst155 + 1.21910196980976e-15;
	fConst169 = fConst0 * (fConst134 + 3.66844210330959e-12) + 5.84016130407215e-10;
	fConst170 = fConst0 * (fConst0 * (fConst136 + 8.0460730007444e-17) + -3.45844530442491e-12) + -5.7640755073748e-10;
	fConst171 = fConst0 * (fConst0 * (-8.0460730007444e-17 - fConst136) + 3.45844530442491e-12) + 5.7640755073748e-10;
	fConst172 = fConst0 * (-3.66844210330959e-12 - fConst134) + -5.84016130407215e-10;
	fConst173 = fConst0 * (fConst140 + 1.59088484003545e-12) + 5.76407550737481e-11;
	fConst174 = fConst0 * (-1.59088484003545e-12 - fConst140) + -5.76407550737481e-11;
	fConst175 = fConst0 * (fConst143 + 6.09550984904878e-16) + -9.63708565903573e-28;
	fConst176 = fConst0 * (-6.09550984904878e-16 - fConst143) + 9.63708565903573e-28;
	fConst177 = 0.000487217249496405 * (fConst0 / fConst2);
	fConst178 = 1.0 / (fConst95 * fConst107);
	fConst179 = 1.0 / (fConst96 * fConst100);
	fConst180 = 1.0 - fConst131 / fConst95;
	fConst181 = 1.0 / (fConst132 / fConst95 + 1.0);
	fConst182 = 1.0 / (fConst102 * fConst114);
	fConst183 = 1.0 / (fConst103 * fConst107);
	fConst184 = 1.0 - fConst128 / fConst102;
	fConst185 = 1.0 / (fConst129 / fConst102 + 1.0);
	fConst186 = 1.0 / (fConst109 * fConst121);
	fConst187 = 1.0 / (fConst110 * fConst114);
	fConst188 = 1.0 - fConst125 / fConst109;
	fConst189 = 1.0 / (fConst126 / fConst109 + 1.0);
	fConst190 = 1.0 / (fConst117 * fConst121);
	clear_state_f();
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp5;
		fRec12[0] = -(fConst124 * (fConst123 * fRec12[1] - (fTemp5 + fVec0[1])));
		fRec11[0] = fRec12[0] - fConst122 * (fConst120 * fRec11[2] + fConst118 * fRec11[1]);
		double fTemp6 = fRec11[2] + fRec11[0] + 2.0 * fRec11[1];
		fVec1[0] = fTemp6;
		fRec10[0] = -(fConst127 * (fConst125 * fRec10[1] - fConst122 * (fTemp6 + fVec1[1])));
		fRec9[0] = fRec10[0] - fConst115 * (fConst113 * fRec9[2] + fConst111 * fRec9[1]);
		double fTemp7 = fRec9[2] + fRec9[0] + 2.0 * fRec9[1];
		fVec2[0] = fTemp7;
		fRec8[0] = -(fConst130 * (fConst128 * fRec8[1] - fConst115 * (fTemp7 + fVec2[1])));
		fRec7[0] = fRec8[0] - fConst108 * (fConst106 * fRec7[2] + fConst104 * fRec7[1]);
		double fTemp8 = fRec7[2] + fRec7[0] + 2.0 * fRec7[1];
		fVec3[0] = fTemp8;
		fRec6[0] = -(fConst133 * (fConst131 * fRec6[1] - fConst108 * (fTemp8 + fVec3[1])));
		fRec5[0] = fRec6[0] - fConst101 * (fConst99 * fRec5[2] + fConst97 * fRec5[1]);
		fRec4[0] = fConst101 * (fRec5[2] + fRec5[0] + 2.0 * fRec5[1]) - (fTemp4 * fRec4[1] + fTemp3 * fRec4[2] + fTemp2 * fRec4[3] + fTemp1 * fRec4[4]) / fTemp0;
		double fTemp9 = fRec3[0] * (fConst43 * fRec2[0] * (fConst145 + fConst144 * fRec1[0]) + fConst0 * (fConst142 + fConst141 * fRec1[0])) + fConst0 * (fConst139 + fRec2[0] * (fConst138 + fConst137 * fRec1[0]) + fConst135 * fRec1[0]);
		double fTemp10 = fRec3[0] * (fConst158 * fRec2[0] * (fConst157 + fConst156 * fRec1[0]) + fConst0 * (fConst154 + fConst153 * fRec1[0])) + fConst0 * (fConst151 + fRec2[0] * (fConst150 + fConst149 * fRec1[0]) + fConst147 * fRec1[0]);
		double fTemp11 = fRec3[0] * (fRec2[0] * (fConst164 + fConst163 * fRec1[0]) - 3.18176968007089e-12 * fRec1[0] + 3.18176968007089e-12) - 7.33688420661919e-12 * fRec1[0] + fRec2[0] * (fConst161 + fConst160 * fRec1[0]) + 7.33688420661919e-12;
		double fTemp12 = fRec3[0] * (fConst158 * fRec2[0] * (fConst168 + fConst167 * fRec1[0]) + fConst0 * (fConst153 + fConst154 * fRec1[0])) + fConst0 * (fConst147 + fRec2[0] * (fConst166 + fConst165 * fRec1[0]) + fConst151 * fRec1[0]);
		double fTemp13 = fRec3[0] * (fConst43 * fRec2[0] * (fConst176 + fConst175 * fRec1[0]) + fConst0 * (fConst174 + fConst173 * fRec1[0])) + fConst0 * (fConst172 + fRec2[0] * (fConst171 + fConst170 * fRec1[0]) + fConst169 * fRec1[0]);
		...
		double fTemp15 = fConst177 * fRec13[0] * (fRec0[0] - fRec0[1]);
		fRec17[0] = -(fConst133 * (fConst131 * fRec17[1] - fConst178 * (fTemp8 - fVec3[1])));
		fRec16[0] = fRec17[0] - fConst101 * (fConst99 * fRec16[2] + fConst97 * fRec16[1]);
		fRec15[0] = fConst179 * (fRec16[2] + (fRec16[0] - 2.0 * fRec16[1])) - (fTemp4 * fRec15[1] + fTemp3 * fRec15[2] + fTemp2 * fRec15[3] + fTemp1 * fRec15[4]) / fTemp0;
		double fTemp16 = (fRec15[0] * fTemp13 + fTemp12 * fRec15[1] + fConst43 * fTemp11 * fRec15[2] + fTemp10 * fRec15[3] + fTemp9 * fRec15[4]) / fTemp0;
		fRec14[0] = ((signbit(fTemp16)) ? tiltdrivepro_in_negclip(fTemp16) : tiltdrivepro_inclip(fTemp16)) - fConst3 * fRec14[1];
		double fTemp17 = fConst177 * fRec13[0] * (fRec14[0] - fRec14[1]);
		double fTemp18 = fConst97 * fRec20[1];
		fRec22[0] = -(fConst130 * (fConst128 * fRec22[1] - fConst182 * (fTemp7 - fVec2[1])));
		fRec21[0] = fRec22[0] - fConst108 * (fConst106 * fRec21[2] + fConst104 * fRec21[1]);
		fRec20[0] = fConst183 * (fRec21[2] + (fRec21[0] - 2.0 * fRec21[1])) - fConst181 * (fConst180 * fRec20[2] + fTemp18);
		fRec19[0] = fRec20[2] + fConst181 * (fTemp18 + fConst180 * fRec20[0]) - (fTemp4 * fRec19[1] + fTemp3 * fRec19[2] + fTemp2 * fRec19[3] + fTemp1 * fRec19[4]) / fTemp0;
		double fTemp19 = (fRec19[0] * fTemp13 + fTemp12 * fRec19[1] + fConst43 * fTemp11 * fRec19[2] + fTemp10 * fRec19[3] + fTemp9 * fRec19[4]) / fTemp0;
		fRec18[0] = ((signbit(fTemp19)) ? tiltdrivepro_in_negclip(fTemp19) : tiltdrivepro_inclip(fTemp19)) - fConst3 * fRec18[1];
		double fTemp20 = fConst177 * fRec13[0] * (fRec18[0] - fRec18[1]);
		double fTemp21 = fConst97 * fRec25[1];
		double fTemp22 = fConst104 * fRec26[1];
		fRec28[0] = -(fConst127 * (fConst125 * fRec28[1] - fConst186 * (fTemp6 - fVec1[1])));
		fRec27[0] = fRec28[0] - fConst115 * (fConst113 * fRec27[2] + fConst111 * fRec27[1]);
		fRec26[0] = fConst187 * (fRec27[2] + (fRec27[0] - 2.0 * fRec27[1])) - fConst185 * (fConst184 * fRec26[2] + fTemp22);
		fRec25[0] = fRec26[2] + fConst185 * (fTemp22 + fConst184 * fRec26[0]) - fConst181 * (fConst180 * fRec25[2] + fTemp21);
		fRec24[0] = fRec25[2] + fConst181 * (fTemp21 + fConst180 * fRec25[0]) - (fTemp4 * fRec24[1] + fTemp3 * fRec24[2] + fTemp2 * fRec24[3] + fTemp1 * fRec24[4]) / fTemp0;
		double fTemp23 = (fRec24[0] * fTemp13 + fTemp12 * fRec24[1] + fConst43 * fTemp11 * fRec24[2] + fTemp10 * fRec24[3] + fTemp9 * fRec24[4]) / fTemp0;
		fRec23[0] = ((signbit(fTemp23)) ? tiltdrivepro_in_negclip(fTemp23) : tiltdrivepro_inclip(fTemp23)) - fConst3 * fRec23[1];
		double fTemp24 = fConst177 * fRec13[0] * (fRec23[0] - fRec23[1]);
		double fTemp25 = fConst97 * fRec31[1];
		double fTemp26 = fConst104 * fRec32[1];
		double fTemp27 = fConst111 * fRec33[1];
		fRec35[0] = -(fConst124 * (fConst123 * fRec35[1] - fConst119 * (fTemp5 - fVec0[1])));
		fRec34[0] = fRec35[0] - fConst122 * (fConst120 * fRec34[2] + fConst118 * fRec34[1]);
		fRec33[0] = fConst190 * (fRec34[2] + (fRec34[0] - 2.0 * fRec34[1])) - fConst189 * (fConst188 * fRec33[2] + fTemp27);
		fRec32[0] = fRec33[2] + fConst189 * (fTemp27 + fConst188 * fRec33[0]) - fConst185 * (fConst184 * fRec32[2] + fTemp26);
		fRec31[0] = fRec32[2] + fConst185 * (fTemp26 + fConst184 * fRec32[0]) - fConst181 * (fConst180 * fRec31[2] + fTemp25);
		fRec30[0] = fRec31[2] + fConst181 * (fTemp25 + fConst180 * fRec31[0]) - (fRec30[1] * fTemp4 + fRec30[2] * fTemp3 + fRec30[3] * fTemp2 + fRec30[4] * fTemp1) / fTemp0;
		double fTemp28 = (fRec30[0] * fTemp13 + fRec30[1] * fTemp12 + fConst43 * fRec30[2] * fTemp11 + fRec30[3] * fTemp10 + fRec30[4] * fTemp9) / fTemp0;
		fRec29[0] = ((signbit(fTemp28)) ? tiltdrivepro_in_negclip(fTemp28) : tiltdrivepro_inclip(fTemp28)) - fConst3 * fRec29[1];
		double fTemp29 = fConst177 * fRec13[0] * (fRec29[0] - fRec29[1]);
		output0[i0] = FAUSTFLOAT(((signbit(-fTemp29)) ? tiltdrivepro_out_3_negclip(-fTemp29) : tiltdrivepro_out_3clip(-fTemp29)) + ((signbit(-fTemp24)) ? tiltdrivepro_out_3_negclip(-fTemp24) : tiltdrivepro_out_3clip(-fTemp24)) + ((signbit(-fTemp20)) ? tiltdrivepro_out_3_negclip(-fTemp20) : tiltdrivepro_out_3clip(-fTemp20)) + ((signbit(-fTemp17)) ? tiltdrivepro_out_3_negclip(-fTemp17) : tiltdrivepro_out_3clip(-fTemp17)) + ((signbit(-fTemp15)) ? tiltdrivepro_out_3_negclip(-fTemp15) : tiltdrivepro_out_3clip(-fTemp15)));
		fRec1[1] = fRec1[0];
		fRec2[1] = fRec2[0];
		fRec3[1] = fRec3[0];
		fVec0[1] = fVec0[0];
