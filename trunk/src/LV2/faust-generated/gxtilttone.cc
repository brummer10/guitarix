...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst1 = (2.0831309537617601e-05 * fConst0);
	double fConst2 = (fConst1 + 9.7142194356639804e-05);
	...
	double fConst44 = (3.7198687211673802e-19 * fConst0);
	fConst45 = (fConst0 * ((fConst43 * (-8.9271744801210908e-16 - fConst44)) + 2.6848634574570702e-10));
	double fConst46 = (2.92345034021946e-19 * fConst0);
	...
	double fConst102 = (1.8271564626371601e-20 * fConst0);
	...
	double fConst134 = (9.8607192519763008e-16 * fConst0);
	fConst135 = ((fConst0 * (-3.6684421033095901e-12 - fConst134)) + -5.8401613040721496e-10);
	double fConst136 = (7.4702418575577996e-15 * fConst0);
	...
	double fConst139 = (3.6573059094293402e-18 * fConst0);
	...
	double fConst143 = (4.8276438004467295e-19 * fConst0);
	...
	double fConst146 = (1.9721438503952602e-15 * fConst43);
	fConst147 = (fConst146 + -1.1680322608144299e-09);
	double fConst148 = (1.4940483715115599e-14 * fConst43);
	fConst149 = (fConst148 + -1.15281510147496e-10);
	fConst150 = (1.15281510147496e-10 - fConst148);
	double fConst151 = (1.4629223637717401e-17 * fConst0);
	...
	double fConst155 = (1.9310575201786899e-18 * fConst0);
	...
	double fConst158 = (2.1943835456576001e-17 * fConst43);
	fConst159 = (-1.9274171318071501e-27 - fConst158);
	fConst160 = (fConst158 + 1.9274171318071501e-27);
	double fConst161 = (2.89658628026804e-18 * fConst43);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fThen0 = double(tiltdrivepro_inclip(double(fTemp14)));
		double fElse0 = double(tiltdrivepro_in_negclip(double(fTemp14)));
		fRec0[0] = ((int(signbit(double(fTemp14))) ? fElse0 : fThen0) - (fConst176 * fRec0[1]));
		...
		double fThen1 = double(tiltdrivepro_out_3clip(double(fTemp16)));
		double fElse1 = double(tiltdrivepro_out_3_negclip(double(fTemp16)));
		...
		double fThen2 = double(tiltdrivepro_inclip(double(fTemp20)));
		double fElse2 = double(tiltdrivepro_in_negclip(double(fTemp20)));
		fRec11[0] = ((int(signbit(double(fTemp20))) ? fElse2 : fThen2) - (fConst176 * fRec11[1]));
		double fTemp21 = (fConst3 * ((fRec11[0] * fTemp15) + (0.000487217249496405 * (fRec10[0] * fRec11[1]))));
		double fThen3 = double(tiltdrivepro_out_3clip(double(fTemp21)));
		double fElse3 = double(tiltdrivepro_out_3_negclip(double(fTemp21)));
		...
		double fThen4 = double(tiltdrivepro_inclip(double(fTemp24)));
		double fElse4 = double(tiltdrivepro_in_negclip(double(fTemp24)));
		fRec19[0] = ((int(signbit(double(fTemp24))) ? fElse4 : fThen4) - (fConst176 * fRec19[1]));
		double fTemp25 = (fConst3 * ((fRec19[0] * fTemp15) + (0.000487217249496405 * (fRec10[0] * fRec19[1]))));
		double fThen5 = double(tiltdrivepro_out_3clip(double(fTemp25)));
		double fElse5 = double(tiltdrivepro_out_3_negclip(double(fTemp25)));
		...
		double fThen6 = double(tiltdrivepro_inclip(double(fTemp27)));
		double fElse6 = double(tiltdrivepro_in_negclip(double(fTemp27)));
		fRec26[0] = ((int(signbit(double(fTemp27))) ? fElse6 : fThen6) - (fConst176 * fRec26[1]));
		double fTemp28 = (fConst3 * ((fRec26[0] * fTemp15) + (0.000487217249496405 * (fRec10[0] * fRec26[1]))));
		double fThen7 = double(tiltdrivepro_out_3clip(double(fTemp28)));
		double fElse7 = double(tiltdrivepro_out_3_negclip(double(fTemp28)));
		...
		double fThen8 = double(tiltdrivepro_inclip(double(fTemp29)));
		double fElse8 = double(tiltdrivepro_in_negclip(double(fTemp29)));
		fRec32[0] = ((int(signbit(double(fTemp29))) ? fElse8 : fThen8) - (fConst176 * fRec32[1]));
		double fTemp30 = (fConst3 * ((fRec32[0] * fTemp15) + (0.000487217249496405 * (fRec10[0] * fRec32[1]))));
		double fThen9 = double(tiltdrivepro_out_3clip(double(fTemp30)));
		double fElse9 = double(tiltdrivepro_out_3_negclip(double(fTemp30)));
		output0[i0] = FAUSTFLOAT((((((int(signbit(double(fTemp16))) ? fElse1 : fThen1) + (int(signbit(double(fTemp21))) ? fElse3 : fThen3)) + (int(signbit(double(fTemp25))) ? fElse5 : fThen5)) + (int(signbit(double(fTemp28))) ? fElse7 : fThen7)) + (int(signbit(double(fTemp30))) ? fElse9 : fThen9)));
		fVec0[1] = fVec0[0];
		fRec6[1] = fRec6[0];
		fRec5[2] = fRec5[1];
		fRec5[1] = fRec5[0];
