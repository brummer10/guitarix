...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (2.2000000000000004e-07 * fSlow15 + fSlow1 * (5.951000000000001e-08 - fSlow2) + fSlow0 * (4.8510000000000015e-06 * fSlow1 + 1.32e-06) + 1.32e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 2.662e-12) + fSlow15 * (fSlow4 + 2.4200000000000004e-11 * (1.0 - fSlow1));
