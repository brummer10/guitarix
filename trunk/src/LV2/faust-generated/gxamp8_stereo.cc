...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec72[0] = fConst8 * (fConst68 * fTemp56 - fConst3 * fRec72[1]);
		...
		double fTemp64 = (fTemp62 + fTemp63) / (Ranode(TUBE_TABLE_12AU7_250k, fRec98[1]) + 1e+05);
		fVec15[0] = fTemp64;
		fRec101[0] = fConst6 * (8.2e+02 * (fTemp64 + fVec15[1]) - fConst5 * fRec101[1]);
		fRec98[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp63 + fRec101[0] + fTemp62 + -0.445487) + -75.67231707317073;
		double fTemp65 = fRec98[0] - fRec98[1];
		fRec97[0] = fConst8 * (fConst7 * fTemp65 - fConst3 * fRec97[1]);
		fRec102[0] = fConst11 * (fConst10 * fRec102[1] + 0.1 * fTemp65);
		...
		double fTemp68 = (fTemp66 + fTemp67) / (Ranode(TUBE_TABLE_12AU7_250k, fRec110[1]) + 1e+05);
		fVec16[0] = fTemp68;
		fRec113[0] = fConst14 * (1.5e+03 * (fTemp68 + fVec16[1]) - fConst13 * fRec113[1]);
		fRec110[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp67 + fRec113[0] + fTemp66 + -0.776162) + -78.25586666666666;
		double fTemp69 = fRec110[0] - fRec110[1];
		fRec109[0] = fConst8 * (fConst7 * fTemp69 - fConst3 * fRec109[1]);
		fRec114[0] = fConst11 * (fConst10 * fRec114[1] + 0.1 * fTemp69);
		double fTemp70 = double(input1[i0]) * fRec44[0];
		fVec17[0] = fTemp70;
		fRec118[0] = 1.8605695850647828 * (fTemp70 + fVec17[1]) - 0.8605695850647829 * fRec118[1];
		...
		double fTemp73 = (fTemp71 + fTemp72) / (Ranode(TUBE_TABLE_12AU7_68k, fRec116[1]) + 1e+05);
		fVec18[0] = fTemp73;
		fRec119[0] = fConst17 * (2.7e+03 * (fTemp73 + fVec18[1]) - fConst16 * fRec119[1]);
		fRec116[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp72 + fRec119[0] + fTemp71 + -1.25724) + -83.43555555555557;
		double fTemp74 = fRec116[0] - fRec116[1];
		fRec115[0] = fConst8 * (fConst7 * fTemp74 - fConst3 * fRec115[1]);
		fRec120[0] = fConst11 * (fConst10 * fRec120[1] + 0.1 * fTemp74);
		...
		double fTemp77 = (fTemp75 + fTemp76) / (Ranode(TUBE_TABLE_12AU7_250k, fRec104[1]) + 1e+05);
		fVec19[0] = fTemp77;
		fRec121[0] = fConst14 * (1.5e+03 * (fTemp77 + fVec19[1]) - fConst13 * fRec121[1]);
		fRec104[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp76 + fRec121[0] + fTemp75 + -0.776162) + -78.25586666666666;
		double fTemp78 = fRec104[0] - fRec104[1];
		fRec103[0] = fConst8 * (fConst7 * fTemp78 - fConst3 * fRec103[1]);
		fRec122[0] = fConst11 * (fConst10 * fRec122[1] + 0.1 * fTemp78);
		...
		double fTemp81 = (fTemp79 + fTemp80) / (Ranode(TUBE_TABLE_12AU7_250k, fRec93[1]) + 1e+05);
		fVec20[0] = fTemp81;
		fRec123[0] = fConst6 * (8.2e+02 * (fTemp81 + fVec20[1]) - fConst5 * fRec123[1]);
		fRec93[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp80 + fRec123[0] + fTemp79 + -0.445487) + -75.67231707317073;
		double fTemp82 = fRec93[0] - fRec93[1];
		fRec92[0] = fConst8 * (fConst7 * fTemp82 - fConst3 * fRec92[1]);
		fRec124[0] = fConst11 * (fConst10 * fRec124[1] + 0.1 * fTemp82);
		...
		fRec84[0] = fConst8 * (fConst68 * fTemp112 - fConst3 * fRec84[1]);
		...
		fRec145[0] = fConst8 * (fConst68 * fTemp114 - fConst3 * fRec145[1]);
