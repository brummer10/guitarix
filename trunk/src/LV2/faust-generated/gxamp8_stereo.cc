...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst79 = (0 - ((1 - fConst66) / fConst77));
	fConst80 = (0 - fConst57);
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec8[0] = fTemp23;
		fRec41[0] = ((fConst76 * ((fConst36 * fVec8[1]) + (fConst13 * fVec8[0]))) + (fConst15 * fRec41[1]));
		fRec40[0] = ((fConst79 * fRec40[1]) + (fConst78 * (fRec41[0] + fRec41[1])));
		...
		fRec50[0] = ((fConst78 * ((fConst92 * fRec41[1]) + (fConst66 * fRec41[0]))) + (fConst79 * fRec50[1]));
		...
		fVec22[0] = fTemp58;
		fRec93[0] = ((fConst76 * ((fConst36 * fVec22[1]) + (fConst13 * fVec22[0]))) + (fConst15 * fRec93[1]));
		fRec92[0] = ((fConst78 * (fRec93[0] + fRec93[1])) + (fConst79 * fRec92[1]));
		...
		fRec102[0] = ((fConst78 * ((fConst92 * fRec93[1]) + (fConst66 * fRec93[0]))) + (fConst79 * fRec102[1]));
