...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp22 = (fConst50 * fRec36[1]);
		fRec42[0] = ((0.024937655860349125 * fTemp21) - (fConst77 * ((fConst75 * fRec42[2]) + (fConst73 * fRec42[1]))));
		...
		fRec36[0] = ((fConst60 * (((fConst55 * fRec37[0]) + (fConst82 * fRec37[1])) + (fConst55 * fRec37[2]))) - (fConst53 * ((fConst52 * fRec36[2]) + fTemp22)));
		double fTemp25 = max(-1, min(1, (fSlow7 * (fRec36[2] + (fConst53 * (fTemp22 + (fConst52 * fRec36[0])))))));
		...
		double fTemp27 = max(-1, min(1, (fSlow8 * (((fConst49 * fRec43[0]) + (fConst89 * fRec43[1])) + (fConst49 * fRec43[2])))));
		double fTemp28 = (fConst50 * fRec47[1]);
		double fTemp29 = (fConst56 * fRec48[1]);
		...
		fRec48[0] = ((fConst69 * (((fConst64 * fRec49[0]) + (fConst93 * fRec49[1])) + (fConst64 * fRec49[2]))) - (fConst91 * ((fConst90 * fRec48[2]) + fTemp29)));
		fRec47[0] = ((fRec48[2] + (fConst91 * (fTemp29 + (fConst90 * fRec48[0])))) - (fConst53 * ((fConst52 * fRec47[2]) + fTemp28)));
		double fTemp30 = max(-1, min(1, (fSlow9 * (fRec47[2] + (fConst53 * (fTemp28 + (fConst52 * fRec47[0])))))));
		...
		fVec15[0] = fTemp37;
		fRec74[0] = (fConst30 * ((fVec15[0] - fVec15[1]) + (fConst29 * fRec74[1])));
		...
		fVec16[0] = fTemp38;
		fRec75[0] = ((fConst35 * (fVec16[0] + fVec16[1])) + (fConst34 * fRec75[1]));
		...
		fVec17[0] = fTemp39;
		fRec78[0] = ((fConst41 * (fVec17[0] + fVec17[1])) + (fConst40 * fRec78[1]));
		...
		fVec18[0] = fTemp40;
		fRec79[0] = ((fConst41 * (fVec18[0] + fVec18[1])) + (fConst40 * fRec79[1]));
		...
		fVec19[0] = fTemp41;
		fRec82[0] = ((fConst45 * (fVec19[0] + fVec19[1])) + (fConst44 * fRec82[1]));
		...
		fVec20[0] = fTemp42;
		fRec83[0] = ((fConst45 * (fVec20[0] + fVec20[1])) + (fConst44 * fRec83[1]));
		...
		fRec85[0] = ((fVec21[IOTA&32767] + fRec85[1]) - fVec21[(IOTA-iConst46)&32767]);
		fRec84[0] = ((fConst47 * fRec85[0]) + (0.999 * fRec84[1]));
		...
		double fTemp57 = (fConst50 * fRec88[1]);
		fRec94[0] = ((0.024937655860349125 * fTemp56) - (fConst77 * ((fConst75 * fRec94[2]) + (fConst73 * fRec94[1]))));
		double fTemp58 = (fRec94[2] + (fRec94[0] + (2 * fRec94[1])));
		fVec22[0] = fTemp58;
		fRec93[0] = ((fConst78 * ((fConst36 * fVec22[1]) + (fConst13 * fVec22[0]))) + (fConst15 * fRec93[1]));
		fRec92[0] = ((fConst79 * (fRec93[0] + fRec93[1])) + (fConst71 * fRec92[1]));
		fRec91[0] = (fRec92[0] - (fConst69 * ((fConst67 * fRec91[2]) + (fConst65 * fRec91[1]))));
		double fTemp59 = (fRec91[2] + (fRec91[0] + (2 * fRec91[1])));
		fVec23[0] = fTemp59;
		fRec90[0] = ((fConst81 * ((fConst80 * fVec23[1]) + (fConst57 * fVec23[0]))) + (fConst62 * fRec90[1]));
		fRec89[0] = (fRec90[0] - (fConst60 * ((fConst58 * fRec89[2]) + (fConst56 * fRec89[1]))));
		fRec88[0] = ((fConst60 * (((fConst55 * fRec89[0]) + (fConst82 * fRec89[1])) + (fConst55 * fRec89[2]))) - (fConst53 * ((fConst52 * fRec88[2]) + fTemp57)));
		double fTemp60 = max(-1, min(1, (fSlow7 * (fRec88[2] + (fConst53 * (fTemp57 + (fConst52 * fRec88[0])))))));
		fRec98[0] = ((fConst81 * (fVec23[0] + fVec23[1])) + (fConst62 * fRec98[1]));
		fRec97[0] = (fRec98[0] - (fConst60 * ((fConst58 * fRec97[2]) + (fConst56 * fRec97[1]))));
		double fTemp61 = (fRec97[2] + (fRec97[0] + (2 * fRec97[1])));
		fVec24[0] = fTemp61;
		fRec96[0] = ((fConst88 * ((fConst87 * fVec24[1]) + (fConst51 * fVec24[0]))) + (fConst86 * fRec96[1]));
		fRec95[0] = (fRec96[0] - (fConst84 * ((fConst83 * fRec95[2]) + (fConst50 * fRec95[1]))));
		double fTemp62 = max(-1, min(1, (fSlow8 * (((fConst49 * fRec95[0]) + (fConst89 * fRec95[1])) + (fConst49 * fRec95[2])))));
		double fTemp63 = (fConst50 * fRec99[1]);
		double fTemp64 = (fConst56 * fRec100[1]);
		fRec102[0] = ((fConst79 * ((fConst92 * fRec93[1]) + (fConst66 * fRec93[0]))) + (fConst71 * fRec102[1]));
		fRec101[0] = (fRec102[0] - (fConst69 * ((fConst67 * fRec101[2]) + (fConst65 * fRec101[1]))));
		fRec100[0] = ((fConst69 * (((fConst64 * fRec101[0]) + (fConst93 * fRec101[1])) + (fConst64 * fRec101[2]))) - (fConst91 * ((fConst90 * fRec100[2]) + fTemp64)));
		fRec99[0] = ((fRec100[2] + (fConst91 * (fTemp64 + (fConst90 * fRec100[0])))) - (fConst53 * ((fConst52 * fRec99[2]) + fTemp63)));
		double fTemp65 = max(-1, min(1, (fSlow9 * (fRec99[2] + (fConst53 * (fTemp63 + (fConst52 * fRec99[0])))))));
		fRec104[0] = ((fConst88 * (fVec24[0] + fVec24[1])) + (fConst86 * fRec104[1]));
		fRec103[0] = (fRec104[0] - (fConst84 * ((fConst83 * fRec103[2]) + (fConst50 * fRec103[1]))));
		...
		fRec59[0] = ((fConst94 * ((fConst36 * fRec60[1]) + (fConst13 * fRec60[0]))) + (fConst15 * fRec59[1]));
		...
		fRec106[0] = ((fConst94 * ((fConst36 * fRec107[1]) + (fConst13 * fRec107[0]))) + (fConst15 * fRec106[1]));
		double fTemp72 = (min(0.7, fRec106[0]) + max(-0.75, fRec59[0]));
		fVec29[0] = fTemp72;
		fRec58[0] = (fConst96 * ((fVec29[2] + (fVec29[0] + (fConst95 * fVec29[1]))) + ((fConst12 * fRec58[2]) + (fConst10 * fRec58[1]))));
		fRec57[0] = (fConst98 * ((fRec58[2] + (fRec58[0] + (fConst97 * fRec58[1]))) + ((fConst8 * fRec57[2]) + (fConst6 * fRec57[1]))));
		fRec56[0] = (fConst100 * ((fRec57[2] + (fRec57[0] + (fConst99 * fRec57[1]))) + ((fConst4 * fRec56[2]) + (fConst2 * fRec56[1]))));
