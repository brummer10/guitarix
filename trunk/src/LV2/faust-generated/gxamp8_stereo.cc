...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp54 = (fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec103[1]))) + 100000.0);
		fVec15[0] = fTemp54;
		fRec106[0] = fConst25 * (820.0 * (fTemp54 + fVec15[1]) - fConst26 * fRec106[1]);
		fRec103[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp52 + fRec106[0] + fTemp53 + -0.44548700000000002))) + -75.672317073170731;
		fRec102[0] = 0.10000000000000001 * (fConst4 * fRec103[0] + fConst27 * fRec103[1]) - fConst28 * fRec102[1];
		fRec107[0] = fConst30 * (fConst31 * fRec107[1] + 0.10000000000000001 * (fRec103[0] - fRec103[1]));
		...
		double fTemp57 = (fTemp56 + fTemp55) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec115[1]))) + 100000.0);
		fVec16[0] = fTemp57;
		fRec118[0] = fConst33 * (1500.0 * (fTemp57 + fVec16[1]) - fConst34 * fRec118[1]);
		fRec115[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp55 + fRec118[0] + fTemp56 + -0.77616200000000002))) + -78.255866666666662;
		fRec114[0] = 0.10000000000000001 * (fConst4 * fRec115[0] + fConst27 * fRec115[1]) - fConst28 * fRec114[1];
		fRec119[0] = fConst30 * (fConst31 * fRec119[1] + 0.10000000000000001 * (fRec115[0] - fRec115[1]));
		double fTemp58 = double(input1[i0]) * fRec48[0];
		fVec17[0] = fTemp58;
		fRec123[0] = 1.8605695850647828 * (fTemp58 + fVec17[1]) - 0.86056958506478287 * fRec123[1];
		...
		double fTemp61 = (fTemp60 + fTemp59) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec121[1]))) + 100000.0);
		fVec18[0] = fTemp61;
		fRec124[0] = fConst36 * (2700.0 * (fTemp61 + fVec18[1]) - fConst37 * fRec124[1]);
		fRec121[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp59 + fRec124[0] + fTemp60 + -1.2572399999999999))) + -83.435555555555567;
		fRec120[0] = 0.10000000000000001 * (fConst4 * fRec121[0] + fConst27 * fRec121[1]) - fConst28 * fRec120[1];
		fRec125[0] = fConst30 * (fConst31 * fRec125[1] + 0.10000000000000001 * (fRec121[0] - fRec121[1]));
		...
		double fTemp64 = (fTemp63 + fTemp62) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec109[1]))) + 100000.0);
		fVec19[0] = fTemp64;
		fRec126[0] = fConst33 * (1500.0 * (fTemp64 + fVec19[1]) - fConst34 * fRec126[1]);
		fRec109[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp62 + fRec126[0] + fTemp63 + -0.77616200000000002))) + -78.255866666666662;
		fRec108[0] = 0.10000000000000001 * (fConst4 * fRec109[0] + fConst27 * fRec109[1]) - fConst28 * fRec108[1];
		fRec127[0] = fConst30 * (fConst31 * fRec127[1] + 0.10000000000000001 * (fRec109[0] - fRec109[1]));
		...
		double fTemp67 = (fTemp66 + fTemp65) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec98[1]))) + 100000.0);
		fVec20[0] = fTemp67;
		fRec128[0] = fConst25 * (820.0 * (fTemp67 + fVec20[1]) - fConst26 * fRec128[1]);
		fRec98[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp65 + fRec128[0] + fTemp66 + -0.44548700000000002))) + -75.672317073170731;
		fRec97[0] = 0.10000000000000001 * (fConst4 * fRec98[0] + fConst27 * fRec98[1]) - fConst28 * fRec97[1];
		fRec129[0] = fConst30 * (fConst31 * fRec129[1] + 0.10000000000000001 * (fRec98[0] - fRec98[1]));
		...
		fVec21[IOTA0 & 32767] = fTemp71;
		fRec132[0] = (fTemp71 + fRec132[1]) - fVec21[(IOTA0 - iConst39) & 32767];
		...
		double fThen16 = fTemp75 / (1.0 - std::exp(-1.0 * fTemp75));
		double fElse16 = 0.0 - fTemp75 * std::exp(fTemp75);
		double fThen17 = fTemp73 * (134.00083333333336 * fTemp73 + 20.050000000000001) + 1.0;
		double fElse17 = ((fTemp75 < -50.0) ? fElse16 : fThen16);
		double fTemp76 = 0.0 - 40.100000000000001 * fTemp72;
		double fTemp77 = std::max<double>(-600.0, fTemp76);
		double fThen18 = fTemp77 / (1.0 - std::exp(-1.0 * fTemp77));
		double fElse18 = 0.0 - fTemp77 * std::exp(fTemp77);
		double fThen19 = fTemp76 * (0.083333333333333329 * fTemp76 + 0.5) + 1.0;
		double fElse19 = ((fTemp77 < -50.0) ? fElse18 : fThen18);
		double fTemp78 = ((std::fabs(fTemp74) > 0.0001) ? fElse17 : fThen17) - ((std::fabs(fTemp76) > 0.0001) ? fElse19 : fThen19);
