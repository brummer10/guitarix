...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp53 = ((fTemp52 + fTemp51) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec96[1]))) + 100000.0));
		fVec15[0] = fTemp53;
		fRec99[0] = (fConst28 * ((820.0 * (fTemp53 + fVec15[1])) - (fConst29 * fRec99[1])));
		fRec96[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp51 + (fRec99[0] + fTemp52)) + -0.44548700000000002)))) + -75.672317073170731);
		fRec95[0] = (fConst2 * ((fConst3 * fRec95[1]) + (0.10000000000000001 * (fRec96[0] - fRec96[1]))));
		...
		double fTemp56 = ((fTemp55 + fTemp54) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec107[1]))) + 100000.0));
		fVec16[0] = fTemp56;
		fRec110[0] = (fConst31 * ((1500.0 * (fTemp56 + fVec16[1])) - (fConst32 * fRec110[1])));
		fRec107[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp54 + (fRec110[0] + fTemp55)) + -0.77616200000000002)))) + -78.255866666666662);
		fRec106[0] = (fConst2 * ((fConst3 * fRec106[1]) + (0.10000000000000001 * (fRec107[0] - fRec107[1]))));
		double fTemp57 = (double(input1[i0]) * fRec46[0]);
		fVec17[0] = fTemp57;
		fRec114[0] = ((1.8605695850647828 * (fTemp57 + fVec17[1])) - (0.86056958506478287 * fRec114[1]));
		...
		double fTemp60 = ((fTemp59 + fTemp58) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec112[1]))) + 100000.0));
		fVec18[0] = fTemp60;
		fRec115[0] = (fConst34 * ((2700.0 * (fTemp60 + fVec18[1])) - (fConst35 * fRec115[1])));
		fRec112[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp58 + (fRec115[0] + fTemp59)) + -1.2572399999999999)))) + -83.435555555555567);
		fRec111[0] = (fConst2 * ((fConst3 * fRec111[1]) + (0.10000000000000001 * (fRec112[0] - fRec112[1]))));
		...
		double fTemp63 = ((fTemp62 + fTemp61) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec101[1]))) + 100000.0));
		fVec19[0] = fTemp63;
		fRec116[0] = (fConst31 * ((1500.0 * (fTemp63 + fVec19[1])) - (fConst32 * fRec116[1])));
		fRec101[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp61 + (fRec116[0] + fTemp62)) + -0.77616200000000002)))) + -78.255866666666662);
		fRec100[0] = (fConst2 * ((fConst3 * fRec100[1]) + (0.10000000000000001 * (fRec101[0] - fRec101[1]))));
		...
		double fTemp66 = ((fTemp65 + fTemp64) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec91[1]))) + 100000.0));
		fVec20[0] = fTemp66;
		fRec117[0] = (fConst28 * ((820.0 * (fTemp66 + fVec20[1])) - (fConst29 * fRec117[1])));
		fRec91[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp64 + (fRec117[0] + fTemp65)) + -0.44548700000000002)))) + -75.672317073170731);
		fRec90[0] = (fConst2 * ((fConst3 * fRec90[1]) + (0.10000000000000001 * (fRec91[0] - fRec91[1]))));
