...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec0[0] = fTemp3;
		fRec10[0] = ((fConst7 * fRec10[1]) + (fConst6 * (fVec0[0] + fVec0[1])));
		...
		fRec19[0] = ((fConst6 * (fRec20[0] + fRec20[1])) + (fConst7 * fRec19[1]));
		...
		double fTemp25 = (fConst38 * fRec41[1]);
		fRec47[0] = ((0.024937655860349125 * fTemp24) - (fConst65 * ((fConst63 * fRec47[2]) + (fConst61 * fRec47[1]))));
		...
		fRec41[0] = ((fConst48 * (((fConst43 * fRec42[0]) + (fConst70 * fRec42[1])) + (fConst43 * fRec42[2]))) - (fConst41 * ((fConst40 * fRec41[2]) + fTemp25)));
		double fTemp28 = max((double)-1, min((double)1, (fSlow7 * (fRec41[2] + (fConst41 * (fTemp25 + (fConst40 * fRec41[0])))))));
		...
		double fTemp30 = max((double)-1, min((double)1, (fSlow8 * (((fConst37 * fRec48[0]) + (fConst77 * fRec48[1])) + (fConst37 * fRec48[2])))));
		...
		fRec53[0] = ((fConst57 * (((fConst52 * fRec54[0]) + (fConst81 * fRec54[1])) + (fConst52 * fRec54[2]))) - (fConst79 * ((fConst78 * fRec53[2]) + fTemp32)));
		fRec52[0] = ((fRec53[2] + (fConst79 * (fTemp32 + (fConst78 * fRec53[0])))) - (fConst41 * ((fConst40 * fRec52[2]) + fTemp31)));
		double fTemp33 = max((double)-1, min((double)1, (fSlow9 * (fRec52[2] + (fConst41 * (fTemp31 + (fConst40 * fRec52[0])))))));
		...
		fVec11[0] = fTemp35;
		fRec40[0] = ((fConst6 * (fVec11[0] + fVec11[1])) + (fConst7 * fRec40[1]));
		double fTemp36 = (((fSlow11 * fRec40[0]) + (fSlow6 * fTemp24)) + (fTemp11 * (1 + (fSlow4 * ((4 - (4 * fabs(fTemp11))) - 1)))));
		fVec12[0] = fTemp36;
		fRec12[0] = ((fConst6 * (fVec12[0] + fVec12[1])) + (fConst7 * fRec12[1]));
		...
		fVec13[0] = fTemp38;
		fRec60[0] = ((fConst6 * (fVec13[0] + fVec13[1])) + (fConst7 * fRec60[1]));
		...
		fVec14[0] = fTemp44;
		fRec84[0] = (fConst18 * ((fVec14[0] - fVec14[1]) + (fConst17 * fRec84[1])));
		fRec83[0] = (fConst18 * ((fRec84[0] - fRec84[1]) + (fConst17 * fRec83[1])));
		fRec82[0] = (fRec83[0] - (fConst15 * ((fConst14 * fRec82[2]) + (fConst9 * fRec82[1]))));
		fRec81[0] = ((fConst15 * (fRec82[2] + (fRec82[0] + (2 * fRec82[1])))) - (fConst13 * ((fConst11 * fRec81[2]) + (fConst9 * fRec81[1]))));
		double fTemp45 = (1e-15 + (0.027 * fRec80[1]));
		fVec15[0] = fTemp45;
		fRec85[0] = ((fConst23 * (fVec15[0] + fVec15[1])) + (fConst22 * fRec85[1]));
		fRec80[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec85[0] + (fConst19 * (fRec27[0] * (fRec81[2] + (fRec81[0] + (2 * fRec81[1])))))) - 1.2572399999999988)) - 83.43555555555557);
		fRec79[0] = ((fConst25 * ((fConst24 * fRec80[1]) + (fConst1 * fRec80[0]))) + (fConst3 * fRec79[1]));
		double fTemp46 = (1e-15 + (0.015 * fRec87[1]));
		fVec16[0] = fTemp46;
		fRec88[0] = ((fConst29 * (fVec16[0] + fVec16[1])) + (fConst28 * fRec88[1]));
		fRec87[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec88[0] + fRec78[1]) - 0.776161999999999)) - 78.25586666666666);
		fRec86[0] = ((fConst25 * ((fConst24 * fRec87[1]) + (fConst1 * fRec87[0]))) + (fConst3 * fRec86[1]));
		fRec78[0] = ((0.6 * fRec86[0]) + fRec79[0]);
		fRec77[0] = ((fConst6 * (fRec78[0] + fRec78[1])) + (fConst7 * fRec77[1]));
		double fTemp47 = (1e-15 + (0.015 * fRec76[1]));
		fVec17[0] = fTemp47;
		fRec89[0] = ((fConst29 * (fVec17[0] + fVec17[1])) + (fConst28 * fRec89[1]));
		fRec76[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec89[0] + fRec77[0]) - 0.776161999999999)) - 78.25586666666666);
		fRec75[0] = ((fConst25 * ((fConst24 * fRec76[1]) + (fConst1 * fRec76[0]))) + (fConst3 * fRec75[1]));
		double fTemp48 = (1e-15 + (0.0082 * fRec91[1]));
		fVec18[0] = fTemp48;
		fRec92[0] = ((fConst33 * (fVec18[0] + fVec18[1])) + (fConst32 * fRec92[1]));
		fRec91[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec92[0] + fRec74[1]) - 0.445486999999999)) - 75.67231707317073);
		fRec90[0] = ((fConst25 * ((fConst24 * fRec91[1]) + (fConst1 * fRec91[0]))) + (fConst3 * fRec90[1]));
		fRec74[0] = ((0.6 * fRec90[0]) + fRec75[0]);
		double fTemp49 = (1e-15 + (0.0082 * fRec73[1]));
		fVec19[0] = fTemp49;
		fRec93[0] = ((fConst33 * (fVec19[0] + fVec19[1])) + (fConst32 * fRec93[1]));
		fRec73[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec93[0] + fRec74[0]) - 0.445486999999999)) - 75.67231707317073);
		fRec72[0] = ((fConst25 * ((fConst24 * fRec73[1]) + (fConst1 * fRec73[0]))) + (fConst3 * fRec72[1]));
		...
		fRec95[0] = ((fVec20[IOTA&32767] + fRec95[1]) - fVec20[(IOTA-iConst34)&32767]);
		fRec94[0] = ((fConst35 * fRec95[0]) + (0.999 * fRec94[1]));
		...
		double fTemp64 = (fConst38 * fRec98[1]);
		fRec104[0] = ((0.024937655860349125 * fTemp63) - (fConst65 * ((fConst63 * fRec104[2]) + (fConst61 * fRec104[1]))));
		double fTemp65 = (fRec104[2] + (fRec104[0] + (2 * fRec104[1])));
		fVec21[0] = fTemp65;
		fRec103[0] = ((fConst66 * ((fConst24 * fVec21[1]) + (fConst1 * fVec21[0]))) + (fConst3 * fRec103[1]));
		fRec102[0] = ((fConst67 * (fRec103[0] + fRec103[1])) + (fConst59 * fRec102[1]));
		fRec101[0] = (fRec102[0] - (fConst57 * ((fConst55 * fRec101[2]) + (fConst53 * fRec101[1]))));
		double fTemp66 = (fRec101[2] + (fRec101[0] + (2 * fRec101[1])));
		fVec22[0] = fTemp66;
		fRec100[0] = ((fConst69 * ((fConst68 * fVec22[1]) + (fConst45 * fVec22[0]))) + (fConst50 * fRec100[1]));
		fRec99[0] = (fRec100[0] - (fConst48 * ((fConst46 * fRec99[2]) + (fConst44 * fRec99[1]))));
		fRec98[0] = ((fConst48 * (((fConst43 * fRec99[0]) + (fConst70 * fRec99[1])) + (fConst43 * fRec99[2]))) - (fConst41 * ((fConst40 * fRec98[2]) + fTemp64)));
		double fTemp67 = max((double)-1, min((double)1, (fSlow7 * (fRec98[2] + (fConst41 * (fTemp64 + (fConst40 * fRec98[0])))))));
		fRec108[0] = ((fConst69 * (fVec22[0] + fVec22[1])) + (fConst50 * fRec108[1]));
		fRec107[0] = (fRec108[0] - (fConst48 * ((fConst46 * fRec107[2]) + (fConst44 * fRec107[1]))));
		double fTemp68 = (fRec107[2] + (fRec107[0] + (2 * fRec107[1])));
		fVec23[0] = fTemp68;
		fRec106[0] = ((fConst76 * ((fConst75 * fVec23[1]) + (fConst39 * fVec23[0]))) + (fConst74 * fRec106[1]));
		fRec105[0] = (fRec106[0] - (fConst72 * ((fConst71 * fRec105[2]) + (fConst38 * fRec105[1]))));
		double fTemp69 = max((double)-1, min((double)1, (fSlow8 * (((fConst37 * fRec105[0]) + (fConst77 * fRec105[1])) + (fConst37 * fRec105[2])))));
		double fTemp70 = (fConst38 * fRec109[1]);
		double fTemp71 = (fConst44 * fRec110[1]);
		fRec112[0] = ((fConst67 * ((fConst80 * fRec103[1]) + (fConst54 * fRec103[0]))) + (fConst59 * fRec112[1]));
		fRec111[0] = (fRec112[0] - (fConst57 * ((fConst55 * fRec111[2]) + (fConst53 * fRec111[1]))));
		fRec110[0] = ((fConst57 * (((fConst52 * fRec111[0]) + (fConst81 * fRec111[1])) + (fConst52 * fRec111[2]))) - (fConst79 * ((fConst78 * fRec110[2]) + fTemp71)));
		fRec109[0] = ((fRec110[2] + (fConst79 * (fTemp71 + (fConst78 * fRec110[0])))) - (fConst41 * ((fConst40 * fRec109[2]) + fTemp70)));
		double fTemp72 = max((double)-1, min((double)1, (fSlow9 * (fRec109[2] + (fConst41 * (fTemp70 + (fConst40 * fRec109[0])))))));
		fRec114[0] = ((fConst76 * (fVec23[0] + fVec23[1])) + (fConst74 * fRec114[1]));
		fRec113[0] = (fRec114[0] - (fConst72 * ((fConst71 * fRec113[2]) + (fConst38 * fRec113[1]))));
