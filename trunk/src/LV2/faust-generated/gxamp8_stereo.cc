...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp33 = ((fSlow2 * fRec12[0]) + ((fTemp32 * ((fSlow9 * ((0.40000000000000002 * (1.0 - std::fabs((0.10000000000000001 * fTemp32)))) + -0.10000000000000001)) + 0.10000000000000001)) + (fSlow10 * fTemp19)));
		fVec15[0] = fTemp33;
		...
		fRec86[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec87[0] + fRec87[2])) + (fRec89[0] + (1.8508996845035413 * fRec87[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		...
		fRec95[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec96[0] + fRec96[2])) + (fRec98[0] + (1.8508996845035413 * fRec96[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		double fTemp50 = ((2.0 * (double(input1[i]) * fRec40[0])) + 1.0000000000000001e-15);
		fVec23[0] = fTemp50;
		...
		fRec99[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec100[0] + fRec100[2])) + (fRec102[0] + (1.8508996845035413 * fRec100[1]))) + -1.2572399999999999)))) + -83.435555555555567);
		fRec94[0] = ((0.059999999999999998 * fRec95[0]) + (0.10000000000000001 * fRec99[0]));
		...
		fRec90[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec91[0] + fRec91[2])) + (fRec103[0] + (1.8508996845035413 * fRec91[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		fRec85[0] = ((0.059999999999999998 * fRec86[0]) + (0.10000000000000001 * fRec90[0]));
		...
		fRec82[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec83[0] + fRec83[2])) + (fRec104[0] + (1.8508996845035413 * fRec83[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		double fTemp56 = (0.10000000000000001 * (fRec44[0] * fRec82[0]));
		...
		double fTemp78 = ((fSlow2 * fRec74[0]) + ((fTemp77 * ((fSlow9 * ((0.40000000000000002 * (1.0 - std::fabs((0.10000000000000001 * fTemp77)))) + -0.10000000000000001)) + 0.10000000000000001)) + (fSlow10 * fTemp65)));
		fVec34[0] = fTemp78;
