...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp15 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp12 + (fRec39[0] + fTemp13)) + -1.581656))));
		fRec17[0] = ((fTemp15 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp15))) + 100000.0))) + -250.0);
		fRec16[0] = (fConst8 * ((fConst9 * fRec16[1]) + (0.025000000000000001 * (fRec17[0] - fRec17[1]))));
		fRec40[0] = (fSlow10 + (0.999 * fRec40[1]));
		double fTemp16 = (fRec16[0] * fRec40[0]);
		fVec6[0] = fTemp16;
		fRec15[0] = (0.0 - (fConst2 * ((fConst10 * fRec15[1]) - (fTemp16 + fVec6[1]))));
		...
		double fTemp19 = ((fTemp18 + fTemp17) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec12[1]))) + 100000.0));
		fVec7[0] = fTemp19;
		fRec41[0] = (fConst65 * ((1500.0 * (fTemp19 + fVec7[1])) - (fConst66 * fRec41[1])));
		double fTemp20 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp17 + (fRec41[0] + fTemp18)) + -1.204285))));
		fRec12[0] = ((fTemp20 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp20))) + 100000.0))) + -250.0);
		...
		double fTemp23 = ((fTemp22 + fTemp21) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec7[1]))) + 100000.0));
		fVec8[0] = fTemp23;
		fRec42[0] = (fConst68 * ((820.0 * (fTemp23 + fVec8[1])) - (fConst69 * fRec42[1])));
		double fTemp24 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp21 + (fRec42[0] + fTemp22)) + -0.84070299999999998))));
		fRec7[0] = ((fTemp24 + (0.0010252475609756097 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp24))) + 100000.0))) + -250.0);
		...
		double fTemp25 = (fRec1[0] * ((fSlow1 * fRec5[0]) + (fSlow11 * fRec43[0])));
		fVec9[0] = fTemp25;
		fRec4[0] = ((0.93028479253239138 * (fTemp25 + fVec9[1])) - (0.86056958506478287 * fRec4[1]));
		fRec3[0] = (fRec4[0] - ((1.8405051250752198 * fRec3[1]) + (0.86129424393186271 * fRec3[2])));
		double fTemp26 = (0.92544984225177063 * (fRec3[0] + fRec3[2]));
		fRec44[0] = (fConst76 * ((0.098000000000000004 * (fRec2[1] + fRec2[2])) - (fConst77 * fRec44[1])));
		double fTemp27 = (1.8508996845035413 * fRec3[1]);
		fRec2[0] = (double(Ftube(int(TUBE_TABLE_6L6CG_68k), double(((fTemp26 + (fRec44[0] + fTemp27)) + -20.063656999999999)))) + -245.26880612244898);
		fRec46[0] = (fConst76 * ((0.098000000000000004 * (fRec45[1] + fRec45[2])) - (fConst77 * fRec46[1])));
		fRec45[0] = (double(Ftube(int(TUBE_TABLE_6L6CG_250k), double(((fTemp26 + (fRec46[0] + fTemp27)) + -20.063656999999999)))) + -245.26880612244898);
		double fTemp28 = (fRec1[0] * (fRec2[0] + fRec45[0]));
		fVec10[0] = fTemp28;
		fRec0[0] = (fConst2 * ((0.025000000000000001 * (fTemp28 + fVec10[1])) - (fConst10 * fRec0[1])));
