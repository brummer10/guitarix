...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst27 = 1.0 / (fConst1 + 1.0);
	fConst28 = 1.0 / std::tan(376.99111843077515 / fConst0);
	fConst29 = 1.0 - fConst28;
	fConst30 = 1.0 / (fConst28 + 1.0);
	fConst31 = 1.0 - fConst23;
	fConst32 = 1.0 / (fConst23 + 1.0);
	fConst33 = 1.0 - fConst16;
	double fConst34 = fConst16 + 1.0;
	fConst35 = 1.0 / fConst34;
	fConst36 = 1.0 - fConst9;
	double fConst37 = fConst9 + 1.0;
	fConst38 = 1.0 / fConst37;
	fConst39 = 1.0 / (fConst6 * fConst18);
	fConst40 = 1.0 / (fConst7 * fConst11);
	fConst41 = 1.0 - fConst36 / fConst6;
	fConst42 = 1.0 / (fConst37 / fConst6 + 1.0);
	fConst43 = 1.0 - fConst33 / fConst13;
	fConst44 = 1.0 / (fConst34 / fConst13 + 1.0);
	fConst45 = 1.0 / (fConst21 * fConst25);
	fConst46 = 1.0 / (fConst13 * fConst25);
	fConst47 = 1.0 / (fConst14 * fConst18);
	double fConst48 = 1.0 / std::tan(270.1769682087222 / fConst0);
	fConst49 = 1.0 - fConst48;
	fConst50 = 1.0 / (fConst48 + 1.0);
	fConst51 = 0.025 / fConst3;
	fConst52 = 1.0 / (fConst4 + 1.0);
	double fConst53 = 3.141592653589793 / fConst0;
	fConst54 = 1.0 - fConst53;
	fConst55 = 1.0 / (fConst53 + 1.0);
	double fConst56 = 1.0 / std::tan(414.6902302738527 / fConst0);
	fConst57 = 1.0 - fConst56;
	fConst58 = 1.0 / (fConst56 + 1.0);
	double fConst59 = 1.0 / std::tan(609.4689747964198 / fConst0);
	fConst60 = 1.0 - fConst59;
	fConst61 = 1.0 / (fConst59 + 1.0);
	double fConst62 = 1.0 / std::tan(1281.7698026646356 / fConst0);
	fConst63 = 1.0 - fConst62;
	fConst64 = 1.0 / (fConst62 + 1.0);
	fConst65 = 1.0 / std::tan(5830.795965062656 / fConst0);
	fConst66 = 1.0 - fConst65;
	fConst67 = 1.0 / (fConst65 + 1.0);
	double fConst68 = 1.0 / std::tan(804.247719318987 / fConst0);
...
#define fVslider3 (*fVslider3_)
	...
	double fSlow1 = 0.0010000000000000009 * std::pow(1e+01, -(0.6 * fSlow0));
	int iSlow2 = int(double(fCheckbox0));
	int iSlow3 = int(double(fCheckbox1));
	double fSlow4 = fConst12 * std::pow(1e+01, 0.8 * fSlow0);
	...
	double fSlow9 = 1.0 - std::max<double>(0.0, -fSlow8);
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp0;
		fRec29[0] = -(fConst27 * (fConst2 * fRec29[1] - (fTemp0 + fVec0[1])));
		fRec28[0] = -(fConst30 * (fConst29 * fRec28[1] - fConst28 * (fRec29[0] - fRec29[1])));
		fRec27[0] = -(fConst32 * (fConst31 * fRec27[1] - (fRec28[0] + fRec28[1])));
		fRec26[0] = fRec27[0] - fConst26 * (fConst24 * fRec26[2] + fConst22 * fRec26[1]);
		double fTemp1 = fRec26[2] + fRec26[0] + 2.0 * fRec26[1];
		fVec1[0] = fTemp1;
		fRec25[0] = -(fConst35 * (fConst33 * fRec25[1] - fConst26 * (fTemp1 + fVec1[1])));
		fRec24[0] = fRec25[0] - fConst19 * (fConst17 * fRec24[2] + fConst15 * fRec24[1]);
		double fTemp2 = fRec24[2] + fRec24[0] + 2.0 * fRec24[1];
		fVec2[0] = fTemp2;
		fRec23[0] = -(fConst38 * (fConst36 * fRec23[1] - fConst19 * (fTemp2 + fVec2[1])));
		fRec22[0] = fRec23[0] - fConst12 * (fConst10 * fRec22[2] + fConst8 * fRec22[1]);
		double fTemp3 = std::max<double>(-1.0, std::min<double>(1.0, fSlow4 * (fRec22[2] + fRec22[0] + 2.0 * fRec22[1])));
		fRec31[0] = -(fConst38 * (fConst36 * fRec31[1] - fConst39 * (fTemp2 - fVec2[1])));
		fRec30[0] = fRec31[0] - fConst12 * (fConst10 * fRec30[2] + fConst8 * fRec30[1]);
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, fSlow6 * (fRec30[2] + (fRec30[0] - 2.0 * fRec30[1]))));
		double fTemp5 = fConst8 * fRec32[1];
		double fTemp6 = fConst15 * fRec33[1];
		fRec35[0] = -(fConst32 * (fConst31 * fRec35[1] - fConst23 * (fRec28[0] - fRec28[1])));
		fRec34[0] = fRec35[0] - fConst26 * (fConst24 * fRec34[2] + fConst22 * fRec34[1]);
		fRec33[0] = fConst45 * (fRec34[2] + (fRec34[0] - 2.0 * fRec34[1])) - fConst44 * (fConst43 * fRec33[2] + fTemp6);
		fRec32[0] = fRec33[2] + fConst44 * (fTemp6 + fConst43 * fRec33[0]) - fConst42 * (fConst41 * fRec32[2] + fTemp5);
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, fSlow5 * (fRec32[2] + fConst42 * (fTemp5 + fConst41 * fRec32[0]))));
		double fTemp8 = fConst8 * fRec36[1];
		fRec38[0] = -(fConst35 * (fConst33 * fRec38[1] - fConst46 * (fTemp1 - fVec1[1])));
		fRec37[0] = fRec38[0] - fConst19 * (fConst17 * fRec37[2] + fConst15 * fRec37[1]);
		fRec36[0] = fConst47 * (fRec37[2] + (fRec37[0] - 2.0 * fRec37[1])) - fConst42 * (fConst41 * fRec36[2] + fTemp8);
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * (fRec36[2] + fConst42 * (fTemp8 + fConst41 * fRec36[0]))));
		...
		fVec3[0] = fTemp10;
		fRec21[0] = -(fConst27 * (fConst2 * fRec21[1] - (fTemp10 + fVec3[1])));
		fRec20[0] = -(fConst30 * (fConst29 * fRec20[1] - fConst28 * (fRec21[0] - fRec21[1])));
		...
		fVec5[0] = fTemp14;
		fRec39[0] = fConst50 * (2.7e+03 * (fTemp14 + fVec5[1]) - fConst49 * fRec39[1]);
		fRec17[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp13 + fRec39[0] + fTemp12 + -1.581656) + -191.42014814814814;
		double fTemp15 = fRec17[0] - fRec17[1];
		fRec16[0] = fConst52 * (fConst51 * fTemp15 - fConst5 * fRec16[1]);
		fRec40[0] = fConst55 * (fConst54 * fRec40[1] + 0.025 * fTemp15);
		fRec41[0] = fSlow11 + 0.999 * fRec41[1];
		double fTemp16 = fRec41[0] * ((iSlow3) ? fRec40[0] : fRec16[0]);
		fVec6[0] = fTemp16;
		fRec15[0] = -(fConst27 * (fConst2 * fRec15[1] - (fTemp16 + fVec6[1])));
		...
		double fTemp18 = 0.9254498422517706 * (fRec13[0] + fRec13[2]);
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AX7_250k, fRec12[1]) + 1e+05);
		fVec7[0] = fTemp19;
		fRec42[0] = fConst58 * (1.5e+03 * (fTemp19 + fVec7[1]) - fConst57 * fRec42[1]);
		fRec12[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp18 + fRec42[0] + fTemp17 + -1.204285) + -169.71433333333334;
		double fTemp20 = fRec12[0] - fRec12[1];
		fRec11[0] = fConst52 * (fConst51 * fTemp20 - fConst5 * fRec11[1]);
		fRec43[0] = fConst55 * (fConst54 * fRec43[1] + 0.025 * fTemp20);
		double fTemp21 = ((iSlow3) ? fRec43[0] : fRec11[0]);
		fVec8[0] = fTemp21;
		fRec10[0] = -(fConst27 * (fConst2 * fRec10[1] - (fTemp21 + fVec8[1])));
		...
		double fTemp23 = 0.9254498422517706 * (fRec8[0] + fRec8[2]);
		double fTemp24 = (fTemp22 + fTemp23) / (Ranode(TUBE_TABLE_12AX7_250k, fRec7[1]) + 1e+05);
		fVec9[0] = fTemp24;
		fRec44[0] = fConst61 * (8.2e+02 * (fTemp24 + fVec9[1]) - fConst60 * fRec44[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp23 + fRec44[0] + fTemp22 + -0.840703) + -147.47524390243905;
		double fTemp25 = fRec7[0] - fRec7[1];
		fRec6[0] = fConst52 * (fConst51 * fTemp25 - fConst5 * fRec6[1]);
		fRec45[0] = fConst55 * (fConst54 * fRec45[1] + 0.025 * fTemp25);
		double fTemp26 = ((iSlow2) ? fRec45[0] : fRec6[0]);
		fVec10[0] = fTemp26;
		fRec5[0] = -(fConst64 * (fConst63 * fRec5[1] - (fTemp26 + fVec10[1])));
		fRec46[0] = -(fConst67 * (fConst66 * fRec46[1] - fConst65 * (fTemp26 - fVec10[1])));
		fRec47[0] = fSlow14 + 0.999 * fRec47[1];
		double fTemp27 = fRec47[0] * (fSlow12 * fRec46[0] + fSlow13 * fRec5[0]);
		fVec11[0] = fTemp27;
		fRec4[0] = 0.9302847925323914 * (fTemp27 + fVec11[1]) - 0.8605695850647829 * fRec4[1];
		fRec3[0] = fRec4[0] - (1.8405051250752198 * fRec3[1] + 0.8612942439318627 * fRec3[2]);
		double fTemp28 = 1.8508996845035413 * fRec3[1];
		fRec48[0] = fConst70 * (0.098 * (fRec2[1] + fRec2[2]) - fConst69 * fRec48[1]);
		double fTemp29 = 0.9254498422517706 * (fRec3[0] + fRec3[2]);
		fRec2[0] = Ftube(TUBE_TABLE_6L6CG_250k, fTemp29 + fRec48[0] + fTemp28 + -20.063657) + -245.26880612244898;
		fRec50[0] = fConst70 * (0.098 * (fRec49[1] + fRec49[2]) - fConst69 * fRec50[1]);
		fRec49[0] = Ftube(TUBE_TABLE_6L6CG_68k, fTemp29 + fRec50[0] + fTemp28 + -20.063657) + -245.26880612244898;
		double fTemp30 = fRec47[0] * (fRec49[0] + fRec2[0]);
		fVec12[0] = fTemp30;
		fRec1[0] = fConst27 * (0.025 * (fTemp30 + fVec12[1]) - fConst2 * fRec1[1]);
