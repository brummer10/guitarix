...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst7 = (3.1415926535897931 / fConst0);
	fConst8 = (1.0 / (fConst7 + 1.0));
	fConst9 = (1.0 - fConst7);
	fConst10 = (1.0 - fConst1);
	double fConst11 = std::tan((376.99111843077515 / fConst0));
	...
	double fConst31 = mydsp_faustpower2_f(fConst20);
	...
	double fConst40 = std::tan((942.47779607693792 / fConst0));
	...
	double fConst64 = (1.0 / std::tan((414.69023027385271 / fConst0)));
	fConst65 = (1.0 / (fConst64 + 1.0));
	fConst66 = (1.0 - fConst64);
	double fConst67 = (1.0 / std::tan((609.46897479641984 / fConst0)));
	...
	double fConst75 = (1.0 / std::tan((804.24771931898704 / fConst0)));
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		output0[i0] = FAUSTFLOAT((fRec0[0] * fRec47[0]));
		fRec1[1] = fRec1[0];
		fVec0[1] = fVec0[0];
		fRec28[1] = fRec28[0];
		fRec27[1] = fRec27[0];
