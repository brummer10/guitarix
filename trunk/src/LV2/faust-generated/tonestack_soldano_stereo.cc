...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (2.2090000000000003e-07 * fSlow15 + fSlow1 * (3.146250000000001e-07 - fSlow2) + fSlow0 * (1.0235000000000001e-05 * fSlow1 + 3.2336000000000007e-06) + 8.084000000000001e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 3.48975e-11) + fSlow15 * (fSlow4 + 5.522500000000001e-11 * (1.0 - fSlow1));
