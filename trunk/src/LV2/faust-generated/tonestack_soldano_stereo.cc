...
#define fVslider2 (*fVslider2_)
	...
	double fSlow1 = 2.2033600000000005e-05 * fSlow0;
	double fSlow2 = double(fVslider1);
	double fSlow3 = 2.5587500000000006e-07 * fSlow2;
	double fSlow4 = 1.0235000000000001e-05 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -1.5537499999999997e-07 - fSlow3) + fSlow1 + 7.717400000000001e-07);
	double fSlow6 = 2.2090000000000005e-09 * fSlow0;
	double fSlow7 = 3.48975e-11 * fSlow2;
	double fSlow8 = 1.3959000000000001e-09 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -2.0327500000000007e-11) + fSlow6 + 5.522500000000001e-11);
	double fSlow10 = 0.020470000000000002 * fSlow0;
	double fSlow11 = 0.0005 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.0025092499999999998);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 5.522500000000001e-11 * fSlow18) + fSlow2 * (fSlow8 + 3.48975e-11 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (2.2090000000000003e-07 * fSlow19 + fSlow2 * (3.146250000000001e-07 - fSlow3) + fSlow0 * (1.0235000000000001e-05 * fSlow2 + 3.2336000000000007e-06) + 8.084000000000001e-08);
	double fSlow23 = fConst0 * (fSlow10 + fSlow11 + 0.00011750000000000001 * fSlow19 + 0.00051175);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-1.5537499999999997e-07 - fSlow3)) + 7.717400000000001e-07) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-2.0327500000000007e-11 - fSlow7)) + 5.522500000000001e-11)));
