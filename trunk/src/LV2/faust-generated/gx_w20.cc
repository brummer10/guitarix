...
#define fVslider1 (*fVslider1_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		output0[i0] = FAUSTFLOAT((((((int(signbit(double(fTemp14))) ? double(w20_2a_negclip(double(fTemp14))) : double(w20_2aclip(double(fTemp14)))) + (int(signbit(double(fTemp19))) ? double(w20_2a_negclip(double(fTemp19))) : double(w20_2aclip(double(fTemp19))))) + (int(signbit(double(fTemp23))) ? double(w20_2a_negclip(double(fTemp23))) : double(w20_2aclip(double(fTemp23))))) + (int(signbit(double(fTemp26))) ? double(w20_2a_negclip(double(fTemp26))) : double(w20_2aclip(double(fTemp26))))) + (int(signbit(double(fTemp28))) ? double(w20_2a_negclip(double(fTemp28))) : double(w20_2aclip(double(fTemp28))))));
		fRec1[1] = fRec1[0];
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
