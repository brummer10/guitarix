...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp18 = ((fTemp17 + fTemp16) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp18;
		fRec34[0] = (fConst63 * ((2700.0 * (fTemp18 + fVec5[1])) - (fConst64 * fRec34[1])));
		double fTemp19 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -1.8639460000000001))));
		fRec12[0] = ((fTemp19 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp19))) + 100000.0))) + -130.0);
		...
		double fTemp24 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -1.271609))));
		fRec7[0] = ((fTemp24 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp24))) + 100000.0))) + -130.0);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.050000000000000003 * (fRec7[0] - fRec7[1]))));
		double fTemp25 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp25;
		...
		double fTemp29 = (fTemp28 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp29;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp29 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp30 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp26 + (fRec36[0] + fTemp27)) + -0.79903100000000005))));
		fRec1[0] = ((fTemp30 + (0.00097442804878048784 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp30))) + 100000.0))) + -130.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp31 = (fTemp28 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec38[1]))) + 100000.0));
		fVec10[0] = fTemp31;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp31 + fVec10[1])) - (fConst70 * fRec39[1])));
		double fTemp32 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp26 + (fRec39[0] + fTemp27)) + -0.79704299999999995))));
		fRec38[0] = ((fTemp32 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp32))) + 100000.0))) + -130.0);
