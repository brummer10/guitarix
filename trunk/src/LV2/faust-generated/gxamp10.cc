...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp13 = (fTemp0 * (1.0 - fRec21[0]));
		double fTemp14 = (fTemp13 + 1.0000000000000001e-15);
		double fTemp15 = (((fSlow4 * fRec13[0]) + ((fTemp13 + (fSlow10 * ((4.0 * (fTemp14 * (1.0 - std::fabs(fTemp14)))) + (-1.0000000000000001e-15 - fTemp13)))) + (fSlow11 * (fTemp1 + 1.0000000000000001e-15)))) + 2.0000000000000002e-15);
		fVec4[0] = fTemp15;
		fRec12[0] = ((0.93028479253239138 * (fTemp15 + fVec4[1])) - (0.86056958506478287 * fRec12[1]));
		fRec11[0] = (fRec12[0] - ((1.8405051250752198 * fRec11[1]) + (0.86129424393186271 * fRec11[2])));
		double fTemp16 = ((0.027 * fRec10[1]) + 1.0000000000000001e-15);
		fVec5[0] = fTemp16;
		fRec32[0] = (0.0 - (fConst60 * ((fConst61 * fRec32[1]) - (fTemp16 + fVec5[1]))));
		...
		double fTemp17 = (fRec10[0] * fRec5[0]);
		fVec6[0] = fTemp17;
		fRec9[0] = (fConst2 * ((0.050000000000000003 * (fTemp17 + fVec6[1])) - (fConst3 * fRec9[1])));
		double fTemp18 = (fRec9[0] + 1.0000000000000001e-15);
		fVec7[0] = fTemp18;
		fRec8[0] = ((0.93028479253239138 * (fTemp18 + fVec7[1])) - (0.86056958506478287 * fRec8[1]));
		fRec7[0] = (fRec8[0] - ((1.8405051250752198 * fRec7[1]) + (0.86129424393186271 * fRec7[2])));
		double fTemp19 = ((0.014999999999999999 * fRec6[1]) + 1.0000000000000001e-15);
		fVec8[0] = fTemp19;
		fRec33[0] = (0.0 - (fConst63 * ((fConst64 * fRec33[1]) - (fTemp19 + fVec8[1]))));
		...
		fVec9[0] = fTemp20;
		fRec4[0] = (fConst2 * ((0.050000000000000003 * (fTemp20 + fVec9[1])) - (fConst3 * fRec4[1])));
		...
		fVec11[0] = fTemp23;
		fRec34[0] = (0.0 - (fConst66 * ((fConst67 * fRec34[1]) - (fTemp23 + fVec11[1]))));
		double fTemp24 = (1.8508996845035413 * fRec2[1]);
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp22 + (fRec34[0] + fTemp24)) + -0.79903100000000005)))) + -32.55719512195121);
		double fTemp25 = ((0.0082000000000000007 * fRec35[1]) + 1.0000000000000001e-15);
		fVec12[0] = fTemp25;
		fRec36[0] = (0.0 - (fConst66 * ((fConst67 * fRec36[1]) - (fTemp25 + fVec12[1]))));
		fRec35[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp22 + (fRec36[0] + fTemp24)) + -0.79704299999999995)))) + -32.799634146341475);
