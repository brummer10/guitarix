...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp20 + (fRec35[0] + fTemp21)) + -1.271609)))) + -45.226066666666668);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp24 + (fRec36[0] + fTemp25)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp28 = (fTemp26 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec38[1]))) + 100000.0));
		fVec10[0] = fTemp28;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp28 + fVec10[1])) - (fConst70 * fRec39[1])));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp24 + (fRec39[0] + fTemp25)) + -0.79704299999999995)))) + -32.799634146341475);
