...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (fTemp0 * (1 - fRec11[0]));
		fRec12[0] = ((fConst14 * (fRec10[1] + fRec10[2])) + (fConst13 * fRec12[1]));
		double fTemp2 = (fConst17 * fRec14[1]);
		double fTemp3 = (1e-15 + (fTemp0 * fRec11[0]));
		fRec20[0] = (fTemp3 - (fConst44 * ((fConst42 * fRec20[2]) + (fConst40 * fRec20[1]))));
		...
		fRec14[0] = ((fConst27 * (((fConst22 * fRec15[0]) + (fConst50 * fRec15[1])) + (fConst22 * fRec15[2]))) - (fConst20 * ((fConst19 * fRec14[2]) + fTemp2)));
		double fTemp6 = max(-1, min(1, (fSlow4 * (fRec14[2] + (fConst20 * (fTemp2 + (fConst19 * fRec14[0])))))));
		...
		double fTemp8 = max(-1, min(1, (fSlow5 * (((fConst16 * fRec21[0]) + (fConst57 * fRec21[1])) + (fConst16 * fRec21[2])))));
		double fTemp9 = (fConst17 * fRec25[1]);
		double fTemp10 = (fConst23 * fRec26[1]);
		...
		fRec26[0] = ((fConst36 * (((fConst31 * fRec27[0]) + (fConst61 * fRec27[1])) + (fConst31 * fRec27[2]))) - (fConst59 * ((fConst58 * fRec26[2]) + fTemp10)));
		fRec25[0] = ((fRec26[2] + (fConst59 * (fTemp10 + (fConst58 * fRec26[0])))) - (fConst20 * ((fConst19 * fRec25[2]) + fTemp9)));
		double fTemp11 = max(-1, min(1, (fSlow6 * (fRec25[2] + (fConst20 * (fTemp9 + (fConst19 * fRec25[0])))))));
		fRec30[0] = ((fConst56 * (fVec2[0] + fVec2[1])) + (fConst54 * fRec30[1]));
		fRec29[0] = (fRec30[0] - (fConst52 * ((fConst51 * fRec29[2]) + (fConst17 * fRec29[1]))));
		double fTemp12 = max(-1, min(1, (fSlow7 * (fRec29[2] + (fRec29[0] + (2 * fRec29[1]))))));
		...
		fRec10[0] = (Ftube(TUBE_TABLE_6DJ8_68k, (((fSlow11 * ((fTemp14 * (4 - (4 * fabs(fTemp14)))) - fTemp14)) + ((fSlow10 * fTemp3) + ((fSlow9 * fRec13[0]) + (fRec12[0] + fTemp1)))) - 1.863945999999998)) - 60.96496296296296);
