...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (1e-15 + (fTemp0 * fRec25[0]));
		fRec24[0] = (fTemp1 - (fConst26 * ((fConst24 * fRec24[2]) + (fConst22 * fRec24[1]))));
		double fTemp2 = (fRec24[2] + (fRec24[0] + (2 * fRec24[1])));
		fVec0[0] = fTemp2;
		fRec23[0] = ((fConst31 * fRec23[1]) + (fConst30 * ((fConst27 * fVec0[0]) + (fConst28 * fVec0[1]))));
		fRec22[0] = ((fConst34 * fRec22[1]) + (fConst33 * (fRec23[0] + fRec23[1])));
		...
		fRec19[0] = (fRec20[0] - (fConst13 * ((fConst11 * fRec19[2]) + (fConst9 * fRec19[1]))));
		...
		double fTemp5 = max((double)-1, min((double)1, (fSlow4 * (fRec17[2] + (fRec17[0] + (2 * fRec17[1]))))));
		...
		double fTemp7 = max((double)-1, min((double)1, (fSlow5 * (fRec26[2] + (fConst42 * (fTemp6 + (fConst41 * fRec26[0])))))));
		double fTemp8 = (fConst3 * fRec29[1]);
		double fTemp9 = (fConst9 * fRec30[1]);
		fRec32[0] = ((fConst34 * fRec32[1]) + (fConst33 * ((fConst17 * fRec23[0]) + (fConst47 * fRec23[1]))));
		...
		double fTemp10 = max((double)-1, min((double)1, (fSlow6 * (fRec29[2] + (fConst42 * (fTemp8 + (fConst41 * fRec29[0])))))));
		...
		double fTemp11 = max((double)-1, min((double)1, (fSlow7 * (((fConst2 * fRec33[0]) + (fConst50 * fRec33[1])) + (fConst2 * fRec33[2])))));
		...
		double fTemp13 = (fTemp0 * (1 - fRec25[0]));
		double fTemp14 = (1e-15 + fTemp13);
		double fTemp15 = (((fSlow11 * fTemp1) + ((fSlow10 * ((fTemp14 * (4 - (4 * fabs(fTemp14)))) - fTemp14)) + (fTemp13 + (fSlow9 * fRec16[0])))) + 2e-15);
		fVec4[0] = fTemp15;
