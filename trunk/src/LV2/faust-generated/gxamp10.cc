...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec12[0] = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(fTemp16 + fRec34[0] + fTemp17 + -1.8639460000000001))) + -60.964962962962957;
		...
		fRec7[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp20 + fRec36[0] + fTemp21 + -1.271609))) + -45.226066666666668;
		...
		double fTemp27 = fTemp26 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec1[1]))) + 100000.0);
		fVec9[0] = fTemp27;
		fRec38[0] = fConst69 * (820.0 * (fTemp27 + fVec9[1]) - fConst70 * fRec38[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(fTemp24 + fRec38[0] + fTemp25 + -0.79903100000000005))) + -32.55719512195121;
		...
		double fTemp28 = fTemp26 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec41[1]))) + 100000.0);
		fVec10[0] = fTemp28;
		fRec42[0] = fConst69 * (820.0 * (fTemp28 + fVec10[1]) - fConst70 * fRec42[1]);
		fRec41[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp24 + fRec42[0] + fTemp25 + -0.79704299999999995))) + -32.799634146341475;
