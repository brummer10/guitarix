...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp4;
		fRec22[0] = fConst30 * (fConst31 * fTemp4 + fConst32 * fVec0[1]) - fConst4 * fRec22[1];
		...
		fVec1[0] = fTemp5;
		fRec19[0] = 0.0 - fConst38 * (fConst36 * fRec19[1] - fConst25 * (fTemp5 + fVec1[1]));
		fRec18[0] = fRec19[0] - fConst18 * (fConst17 * fRec18[2] + fConst15 * fRec18[1]);
		double fTemp6 = fRec18[2] + fRec18[0] + 2.0 * fRec18[1];
		fVec2[0] = fTemp6;
		fRec17[0] = 0.0 - fConst41 * (fConst39 * fRec17[1] - fConst18 * (fTemp6 + fVec2[1]));
		...
		fRec25[0] = fConst18 * (fConst43 * fTemp6 + fConst44 * fVec2[1]) - fConst42 * fRec25[1];
		fRec24[0] = fRec25[0] - fConst11 * (fConst10 * fRec24[2] + fConst8 * fRec24[1]);
		double fTemp8 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fConst7 * fRec24[0] + fConst45 * fRec24[1] + fConst7 * fRec24[2])));
		...
		fRec27[0] = fConst25 * (fConst21 * fRec28[0] + fConst51 * fRec28[1] + fConst21 * fRec28[2]) - fConst49 * (fConst48 * fRec27[2] + fTemp10);
		fRec26[0] = fRec27[2] + fConst49 * (fTemp10 + fConst48 * fRec27[0]) - fConst47 * (fConst46 * fRec26[2] + fTemp9);
		double fTemp11 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec26[2] + fConst47 * (fTemp9 + fConst46 * fRec26[0]))));
		double fTemp12 = fConst8 * fRec30[1];
		fRec32[0] = fConst25 * (fConst53 * fTemp5 + fConst54 * fVec1[1]) - fConst52 * fRec32[1];
		fRec31[0] = fRec32[0] - fConst18 * (fConst17 * fRec31[2] + fConst15 * fRec31[1]);
		fRec30[0] = fConst18 * (fConst14 * fRec31[0] + fConst55 * fRec31[1] + fConst14 * fRec31[2]) - fConst47 * (fConst46 * fRec30[2] + fTemp12);
		double fTemp13 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec30[2] + fConst47 * (fTemp12 + fConst46 * fRec30[0]))));
		...
		fVec3[0] = fTemp14;
		fRec15[0] = 0.0 - fConst58 * (fConst57 * fRec15[1] - (fTemp14 + fVec3[1]));
		...
		double fTemp18 = (fTemp16 + fTemp17) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp18;
		fRec33[0] = fConst61 * (2.7e+03 * (fTemp18 + fVec5[1]) - fConst60 * fRec33[1]);
		fRec11[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp17 + fRec33[0] + fTemp16 + -1.863946) + -60.96496296296296;
		...
		fVec6[0] = fTemp19;
		fRec9[0] = 0.0 - fConst58 * (fConst57 * fRec9[1] - (fTemp19 + fVec6[1]));
		...
		fRec6[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp21 + fRec36[0] + fTemp20 + -1.271609) + -45.22606666666667;
		...
		fVec8[0] = fTemp23;
		fRec4[0] = 0.0 - fConst58 * (fConst57 * fRec4[1] - (fTemp23 + fVec8[1]));
		...
		double fTemp26 = fTemp24 + fTemp25;
		double fTemp27 = fTemp26 / (Ranode(TUBE_TABLE_6DJ8_68k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp27;
		fRec38[0] = fConst70 * (8.2e+02 * (fTemp27 + fVec9[1]) - fConst69 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp25 + fRec38[0] + fTemp24 + -0.799031) + -32.55719512195121;
		fRec0[0] = 0.05 * (fConst31 * fRec1[0] + fConst32 * fRec1[1]) - fConst4 * fRec0[1];
		fRec39[0] = fConst64 * (fConst63 * fRec39[1] + 0.05 * (fRec1[0] - fRec1[1]));
		double fTemp28 = fTemp26 / (Ranode(TUBE_TABLE_6DJ8_250k, fRec41[1]) + 1e+05);
		fVec10[0] = fTemp28;
		fRec42[0] = fConst70 * (8.2e+02 * (fTemp28 + fVec10[1]) - fConst69 * fRec42[1]);
		fRec41[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp25 + fRec42[0] + fTemp24 + -0.797043) + -32.799634146341475;
