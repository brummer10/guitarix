...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp20 = (0.9254498422517706 * (fRec3[0] + (fRec3[2] + (2.0 * fRec3[1]))));
		double fTemp21 = (0.0082 * fRec2[1]);
		fVec11[0] = (1e-15 + fTemp21);
		fRec37[0] = ((fConst67 * fRec37[1]) + (fConst66 * (1e-15 + (fTemp21 + fVec11[1]))));
		fRec2[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec37[0] + fTemp20) - 0.797043)) - 32.799634146341475);
		fRec1[0] = ((fConst31 * fRec1[1]) + (fConst59 * ((fConst27 * fRec2[0]) + (fConst28 * fRec2[1]))));
		double fTemp22 = (0.0082 * fRec39[1]);
		fVec12[0] = (1e-15 + fTemp22);
		fRec40[0] = ((fConst67 * fRec40[1]) + (fConst66 * (1e-15 + (fTemp22 + fVec12[1]))));
		fRec39[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec40[0] + fTemp20) - 0.799031)) - 32.55719512195121);
