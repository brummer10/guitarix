...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp4;
		fRec22[0] = -(fConst32 * (fConst3 * fRec22[1] - fConst31 * (fTemp4 - fVec0[1])));
		...
		fVec1[0] = fTemp5;
		fRec19[0] = -(fConst37 * (fConst35 * fRec19[1] - fConst24 * (fTemp5 + fVec1[1])));
		fRec18[0] = fRec19[0] - fConst17 * (fConst15 * fRec18[2] + fConst13 * fRec18[1]);
		double fTemp6 = fRec18[2] + fRec18[0] + 2.0 * fRec18[1];
		fVec2[0] = fTemp6;
		fRec17[0] = -(fConst40 * (fConst38 * fRec17[1] - fConst17 * (fTemp6 + fVec2[1])));
		...
		fRec25[0] = -(fConst40 * (fConst38 * fRec25[1] - fConst41 * (fTemp6 - fVec2[1])));
		...
		double fTemp9 = fConst6 * fRec26[1];
		double fTemp10 = fConst13 * fRec27[1];
		...
		fRec27[0] = fConst47 * (fRec28[2] + (fRec28[0] - 2.0 * fRec28[1])) - fConst46 * (fConst45 * fRec27[2] + fTemp10);
		fRec26[0] = fRec27[2] + fConst46 * (fTemp10 + fConst45 * fRec27[0]) - fConst44 * (fConst43 * fRec26[2] + fTemp9);
		double fTemp11 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec26[2] + fConst44 * (fTemp9 + fConst43 * fRec26[0]))));
		double fTemp12 = fConst6 * fRec30[1];
		fRec32[0] = -(fConst37 * (fConst35 * fRec32[1] - fConst48 * (fTemp5 - fVec1[1])));
		fRec31[0] = fRec32[0] - fConst17 * (fConst15 * fRec31[2] + fConst13 * fRec31[1]);
		fRec30[0] = fConst49 * (fRec31[2] + (fRec31[0] - 2.0 * fRec31[1])) - fConst44 * (fConst43 * fRec30[2] + fTemp12);
		double fTemp13 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec30[2] + fConst44 * (fTemp12 + fConst43 * fRec30[0]))));
		...
		fVec3[0] = fTemp14;
		fRec15[0] = -(fConst52 * (fConst51 * fRec15[1] - (fTemp14 + fVec3[1])));
		...
		fRec10[0] = fConst32 * (fConst56 * fTemp19 - fConst3 * fRec10[1]);
		fRec34[0] = fConst59 * (fConst58 * fRec34[1] + 0.05 * fTemp19);
		fRec35[0] = fSlow12 + 0.999 * fRec35[1];
		double fTemp20 = fRec35[0] * ((iSlow1) ? fRec34[0] : fRec10[0]);
		fVec6[0] = fTemp20;
		fRec9[0] = -(fConst52 * (fConst51 * fRec9[1] - (fTemp20 + fVec6[1])));
		...
		fRec5[0] = fConst32 * (fConst56 * fTemp24 - fConst3 * fRec5[1]);
		fRec37[0] = fConst59 * (fConst58 * fRec37[1] + 0.05 * fTemp24);
		double fTemp25 = fRec35[0] * ((iSlow1) ? fRec37[0] : fRec5[0]);
		fVec8[0] = fTemp25;
		fRec4[0] = -(fConst52 * (fConst51 * fRec4[1] - (fTemp25 + fVec8[1])));
		...
		double fTemp29 = fTemp28 / (Ranode(TUBE_TABLE_6DJ8_68k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp29;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp29 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp27 + fRec38[0] + fTemp26 + -0.799031) + -32.55719512195121;
		double fTemp30 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst32 * (fConst56 * fTemp30 - fConst3 * fRec0[1]);
		fRec39[0] = fConst59 * (fConst58 * fRec39[1] + 0.05 * fTemp30);
		double fTemp31 = fTemp28 / (Ranode(TUBE_TABLE_6DJ8_250k, fRec41[1]) + 1e+05);
		fVec10[0] = fTemp31;
		fRec42[0] = fConst65 * (8.2e+02 * (fTemp31 + fVec10[1]) - fConst64 * fRec42[1]);
		fRec41[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp27 + fRec42[0] + fTemp26 + -0.797043) + -32.799634146341475;
		double fTemp32 = fRec41[0] - fRec41[1];
		fRec40[0] = fConst32 * (fConst56 * fTemp32 - fConst3 * fRec40[1]);
		fRec43[0] = fConst59 * (fConst58 * fRec43[1] + 0.05 * fTemp32);
