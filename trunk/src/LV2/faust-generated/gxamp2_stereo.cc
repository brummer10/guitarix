...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst68 = std::log((7539.8223686155034 / fConst0));
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp20 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp17 + (fRec35[0] + fTemp18)) + -2.2961499999999999))));
		fRec13[0] = ((fTemp20 + (0.00085042592592592592 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp20))) + 100000.0))) + -250.0);
		...
		fVec6[0] = fTemp21;
		fRec9[0] = ((0.93028479253239138 * (fTemp21 + fVec6[1])) - (0.86056958506478287 * fRec9[1]));
		...
		fVec7[0] = fTemp24;
		fRec36[0] = (fConst66 * ((1500.0 * (fTemp24 + fVec7[1])) - (fConst67 * fRec36[1])));
		double fTemp25 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp22 + (fRec36[0] + fTemp23)) + -1.6755869999999999))));
		fRec7[0] = ((fTemp25 + (0.001117058 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp25))) + 100000.0))) + -250.0);
		...
		fVec8[0] = fTemp26;
		fRec3[0] = ((0.93028479253239138 * (fTemp26 + fVec8[1])) - (0.86056958506478287 * fRec3[1]));
		...
		fVec9[0] = fTemp29;
		fRec38[0] = (fConst71 * ((820.0 * (fTemp29 + fVec9[1])) - (fConst72 * fRec38[1])));
		double fTemp30 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp27 + (fRec38[0] + fTemp28)) + -1.1304620000000001))));
		fRec1[0] = ((fTemp30 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp30))) + 100000.0))) + -250.0);
		...
		double fTemp32 = (fTemp31 * fRec24[0]);
		fRec61[0] = (fTemp32 + (1.0000000000000001e-15 - (fConst22 * ((fConst27 * fRec61[2]) + (fConst28 * fRec61[1])))));
		double fTemp33 = (fRec61[2] + (fRec61[0] + (2.0 * fRec61[1])));
		fVec10[0] = fTemp33;
		fRec60[0] = ((fConst22 * ((fConst26 * fTemp33) + (fConst29 * fVec10[1]))) - (fConst30 * fRec60[1]));
		...
		fVec11[0] = fTemp34;
		fRec57[0] = ((fConst14 * ((fConst16 * fTemp34) + (fConst35 * fVec11[1]))) - (fConst37 * fRec57[1]));
		fRec56[0] = (fRec57[0] - (fConst9 * ((fConst38 * fRec56[2]) + (fConst39 * fRec56[1]))));
		double fTemp35 = (fConst49 * fRec55[1]);
		fRec55[0] = ((fConst9 * (((fConst11 * fRec56[0]) + (fConst40 * fRec56[1])) + (fConst11 * fRec56[2]))) - (fConst44 * ((fConst46 * fRec55[2]) + fTemp35)));
		double fTemp36 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec55[2] + (fConst44 * (fTemp35 + (fConst46 * fRec55[0])))))));
		...
		double fTemp37 = (fConst39 * fRec63[1]);
		fRec63[0] = ((fConst14 * (((fConst33 * fRec64[0]) + (fConst51 * fRec64[1])) + (fConst33 * fRec64[2]))) - (fConst52 * ((fConst53 * fRec63[2]) + fTemp37)));
		double fTemp38 = (fConst49 * fRec62[1]);
		fRec62[0] = ((fRec63[2] + (fConst52 * (fTemp37 + (fConst53 * fRec63[0])))) - (fConst44 * ((fConst46 * fRec62[2]) + fTemp38)));
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec62[2] + (fConst44 * (fTemp38 + (fConst46 * fRec62[0])))))));
		fRec69[0] = (0.0 - (fConst56 * ((fConst36 * fRec69[1]) - (fConst14 * (fTemp34 + fVec11[1])))));
		fRec68[0] = (fRec69[0] - (fConst9 * ((fConst38 * fRec68[2]) + (fConst39 * fRec68[1]))));
		double fTemp40 = (fRec68[2] + (fRec68[0] + (2.0 * fRec68[1])));
		fVec12[0] = fTemp40;
		fRec67[0] = ((fConst9 * ((fConst55 * fTemp40) + (fConst57 * fVec12[1]))) - (fConst58 * fRec67[1]));
		fRec66[0] = (fRec67[0] - (fConst54 * ((fConst59 * fRec66[2]) + (fConst49 * fRec66[1]))));
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst48 * fRec66[0]) + (fConst60 * fRec66[1])) + (fConst48 * fRec66[2])))));
		fRec71[0] = (0.0 - (fConst61 * ((fConst45 * fRec71[1]) - (fConst9 * (fTemp40 + fVec12[1])))));
		fRec70[0] = (fRec71[0] - (fConst54 * ((fConst59 * fRec70[2]) + (fConst49 * fRec70[1]))));
		double fTemp42 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec70[2] + (fRec70[0] + (2.0 * fRec70[1]))))));
		double fTemp43 = (((1.333521432 * (fTemp36 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp36))))) + (1.584893192 * ((fTemp39 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp39)))) + (fTemp41 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp41))))))) + (1.2589412 * (fTemp42 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp42))))));
		fVec13[0] = fTemp43;
		fRec54[0] = (0.0 - (fConst5 * ((fConst6 * fRec54[1]) - (fTemp43 + fVec13[1]))));
		double fTemp44 = (fTemp31 * fTemp13);
		double fTemp45 = (fTemp44 + 1.0000000000000001e-15);
		double fTemp46 = (fRec10[0] * (((fSlow3 * fRec54[0]) + ((fTemp44 + (fSlow9 * ((4.0 * (fTemp45 * (1.0 - std::fabs(fTemp45)))) + (-1.0000000000000001e-15 - fTemp44)))) + (fSlow10 * (fTemp32 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15));
		fVec14[0] = fTemp46;
		fRec53[0] = ((0.93028479253239138 * (fTemp46 + fVec14[1])) - (0.86056958506478287 * fRec53[1]));
		fRec52[0] = (fRec53[0] - ((1.8405051250752198 * fRec52[1]) + (0.86129424393186271 * fRec52[2])));
		double fTemp47 = (0.92544984225177063 * (fRec52[0] + fRec52[2]));
		double fTemp48 = (1.8508996845035413 * fRec52[1]);
		double fTemp49 = ((fTemp48 + fTemp47) / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec51[1]))) + 100000.0));
		fVec15[0] = fTemp49;
		fRec72[0] = (fConst63 * ((2700.0 * (fTemp49 + fVec15[1])) - (fConst64 * fRec72[1])));
		double fTemp50 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp47 + (fRec72[0] + fTemp48)) + -2.2961499999999999))));
		fRec51[0] = ((fTemp50 + (0.00085042592592592592 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp50))) + 100000.0))) + -250.0);
		...
		double fTemp51 = (fRec10[0] * fRec49[0]);
		fVec16[0] = fTemp51;
		fRec48[0] = ((0.93028479253239138 * (fTemp51 + fVec16[1])) - (0.86056958506478287 * fRec48[1]));
		fRec47[0] = (fRec48[0] - ((1.8405051250752198 * fRec47[1]) + (0.86129424393186271 * fRec47[2])));
		double fTemp52 = (0.92544984225177063 * (fRec47[0] + fRec47[2]));
		double fTemp53 = (1.8508996845035413 * fRec47[1]);
		double fTemp54 = ((fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fRec46[1]))) + 100000.0));
		fVec17[0] = fTemp54;
		fRec73[0] = (fConst66 * ((1500.0 * (fTemp54 + fVec17[1])) - (fConst67 * fRec73[1])));
		double fTemp55 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp52 + (fRec73[0] + fTemp53)) + -1.6755869999999999))));
		fRec46[0] = ((fTemp55 + (0.001117058 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp55))) + 100000.0))) + -250.0);
		...
		double fTemp56 = (fRec43[0] - (1.0589999999999999 * fRec43[1]));
		fVec18[0] = fTemp56;
		fRec42[0] = ((0.93028479253239138 * (fTemp56 + fVec18[1])) - (0.86056958506478287 * fRec42[1]));
		fRec41[0] = (fRec42[0] - ((1.8405051250752198 * fRec41[1]) + (0.86129424393186271 * fRec41[2])));
		double fTemp57 = (0.92544984225177063 * (fRec41[0] + fRec41[2]));
		double fTemp58 = (1.8508996845035413 * fRec41[1]);
		double fTemp59 = ((fTemp58 + fTemp57) / (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fRec40[1]))) + 100000.0));
		fVec19[0] = fTemp59;
		fRec74[0] = (fConst71 * ((820.0 * (fTemp59 + fVec19[1])) - (fConst72 * fRec74[1])));
		double fTemp60 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp57 + (fRec74[0] + fTemp58)) + -1.1304620000000001))));
		fRec40[0] = ((fTemp60 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp60))) + 100000.0))) + -250.0);
