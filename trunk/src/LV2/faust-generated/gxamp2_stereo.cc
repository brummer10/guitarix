...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp16 = (fConst11 * fRec43[1]);
		double fTemp17 = (double)input1[i];
		double fTemp18 = (1e-15 + (fTemp17 * fRec18[0]));
		fRec49[0] = (fTemp18 - (fConst38 * ((fConst36 * fRec49[2]) + (fConst34 * fRec49[1]))));
		double fTemp19 = (fRec49[2] + (fRec49[0] + (2 * fRec49[1])));
		fVec4[0] = fTemp19;
		...
		double fTemp20 = (fRec46[2] + (fRec46[0] + (2 * fRec46[1])));
		fVec5[0] = fTemp20;
		...
		fRec43[0] = ((fConst21 * (((fConst16 * fRec44[0]) + (fConst44 * fRec44[1])) + (fConst16 * fRec44[2]))) - (fConst14 * ((fConst13 * fRec43[2]) + fTemp16)));
		double fTemp21 = max(-1, min(1, (fSlow3 * (fRec43[2] + (fConst14 * (fTemp16 + (fConst13 * fRec43[0])))))));
		...
		double fTemp23 = max(-1, min(1, (fSlow4 * (((fConst10 * fRec50[0]) + (fConst51 * fRec50[1])) + (fConst10 * fRec50[2])))));
		double fTemp24 = (fConst11 * fRec54[1]);
		double fTemp25 = (fConst17 * fRec55[1]);
		...
		fRec55[0] = ((fConst30 * (((fConst25 * fRec56[0]) + (fConst55 * fRec56[1])) + (fConst25 * fRec56[2]))) - (fConst53 * ((fConst52 * fRec55[2]) + fTemp25)));
		fRec54[0] = ((fRec55[2] + (fConst53 * (fTemp25 + (fConst52 * fRec55[0])))) - (fConst14 * ((fConst13 * fRec54[2]) + fTemp24)));
		double fTemp26 = max(-1, min(1, (fSlow5 * (fRec54[2] + (fConst14 * (fTemp24 + (fConst13 * fRec54[0])))))));
		fRec59[0] = ((fConst50 * (fVec6[0] + fVec6[1])) + (fConst48 * fRec59[1]));
		fRec58[0] = (fRec59[0] - (fConst46 * ((fConst45 * fRec58[2]) + (fConst11 * fRec58[1]))));
		double fTemp27 = max(-1, min(1, (fSlow6 * (fRec58[2] + (fRec58[0] + (2 * fRec58[1]))))));
		...
		double fTemp29 = (fTemp17 * fTemp13);
		double fTemp30 = (1e-15 + fTemp29);
		fRec60[0] = ((fConst60 * (fRec41[1] + fRec41[2])) + (fConst59 * fRec60[1]));
		fRec41[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec60[0] + (fRec29[0] * (1e-15 + ((fSlow10 * ((fTemp30 * (4 - (4 * fabs(fTemp30)))) - fTemp30)) + ((fSlow9 * fTemp18) + (fTemp29 + (fSlow8 * fRec42[0]))))))) - 2.296149999999999)) - 164.9574074074074);
