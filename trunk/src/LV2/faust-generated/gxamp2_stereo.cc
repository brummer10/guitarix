...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (fSlow5 * fRec10[0]);
		double fTemp3 = (fConst11 * fRec12[1]);
		fRec18[0] = ((fTemp1 * fRec10[0]) - (fConst38 * ((fConst36 * fRec18[2]) + (fConst34 * fRec18[1]))));
		double fTemp4 = (fRec18[2] + (fRec18[0] + (2 * fRec18[1])));
		fVec0[0] = fTemp4;
		...
		double fTemp5 = (fRec15[2] + (fRec15[0] + (2 * fRec15[1])));
		fVec1[0] = fTemp5;
		...
		fRec12[0] = ((fConst21 * (((fConst16 * fRec13[0]) + (fConst44 * fRec13[1])) + (fConst16 * fRec13[2]))) - (fConst14 * ((fConst13 * fRec12[2]) + fTemp3)));
		double fTemp6 = max(-1, min(1, (fSlow6 * (fRec12[2] + (fConst14 * (fTemp3 + (fConst13 * fRec12[0])))))));
		...
		double fTemp8 = max(-1, min(1, (fSlow7 * (((fConst10 * fRec19[0]) + (fConst51 * fRec19[1])) + (fConst10 * fRec19[2])))));
		double fTemp9 = (fConst11 * fRec23[1]);
		double fTemp10 = (fConst17 * fRec24[1]);
		...
		fRec24[0] = ((fConst30 * (((fConst25 * fRec25[0]) + (fConst55 * fRec25[1])) + (fConst25 * fRec25[2]))) - (fConst53 * ((fConst52 * fRec24[2]) + fTemp10)));
		fRec23[0] = ((fRec24[2] + (fConst53 * (fTemp10 + (fConst52 * fRec24[0])))) - (fConst14 * ((fConst13 * fRec23[2]) + fTemp9)));
		double fTemp11 = max(-1, min(1, (fSlow8 * (fRec23[2] + (fConst14 * (fTemp9 + (fConst13 * fRec23[0])))))));
		fRec28[0] = ((fConst50 * (fVec2[0] + fVec2[1])) + (fConst48 * fRec28[1]));
		fRec27[0] = (fRec28[0] - (fConst46 * ((fConst45 * fRec27[2]) + (fConst11 * fRec27[1]))));
		double fTemp12 = max(-1, min(1, (fSlow9 * (fRec27[2] + (fRec27[0] + (2 * fRec27[1]))))));
		double fTemp13 = ((1.2589412 * (fTemp12 * (1 - (0.3333333333333333 * faustpower<2>(fTemp12))))) + (1.584893192 * ((fTemp11 * (1 - (0.3333333333333333 * faustpower<2>(fTemp11)))) + ((fTemp8 * (1 - (0.3333333333333333 * faustpower<2>(fTemp8)))) + (0.8413951417869425 * (fTemp6 * (1 - (0.3333333333333333 * faustpower<2>(fTemp6)))))))));
		fVec3[0] = fTemp13;
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec30[0] + (fRec29[0] * ((fSlow10 * fRec11[0]) + (fTemp1 * (fTemp2 + (fTemp0 * (1 + (fSlow3 * ((4 - (4 * fabs((fTemp1 * fTemp0)))) - 1))))))))) - 2.29615)) - 164.9574074074074);
		...
		double fTemp15 = (fConst11 * fRec43[1]);
		fRec49[0] = ((fTemp14 * fRec10[0]) - (fConst38 * ((fConst36 * fRec49[2]) + (fConst34 * fRec49[1]))));
		double fTemp16 = (fRec49[2] + (fRec49[0] + (2 * fRec49[1])));
		fVec4[0] = fTemp16;
		fRec48[0] = ((fConst40 * ((fConst39 * fVec4[1]) + (fConst1 * fVec4[0]))) + (fConst3 * fRec48[1]));
		fRec47[0] = ((fConst41 * (fRec48[0] + fRec48[1])) + (fConst32 * fRec47[1]));
		fRec46[0] = (fRec47[0] - (fConst30 * ((fConst28 * fRec46[2]) + (fConst26 * fRec46[1]))));
		double fTemp17 = (fRec46[2] + (fRec46[0] + (2 * fRec46[1])));
		fVec5[0] = fTemp17;
		fRec45[0] = ((fConst43 * ((fConst42 * fVec5[1]) + (fConst18 * fVec5[0]))) + (fConst23 * fRec45[1]));
		fRec44[0] = (fRec45[0] - (fConst21 * ((fConst19 * fRec44[2]) + (fConst17 * fRec44[1]))));
		fRec43[0] = ((fConst21 * (((fConst16 * fRec44[0]) + (fConst44 * fRec44[1])) + (fConst16 * fRec44[2]))) - (fConst14 * ((fConst13 * fRec43[2]) + fTemp15)));
		double fTemp18 = max(-1, min(1, (fSlow6 * (fRec43[2] + (fConst14 * (fTemp15 + (fConst13 * fRec43[0])))))));
		fRec53[0] = ((fConst43 * (fVec5[0] + fVec5[1])) + (fConst23 * fRec53[1]));
		fRec52[0] = (fRec53[0] - (fConst21 * ((fConst19 * fRec52[2]) + (fConst17 * fRec52[1]))));
		double fTemp19 = (fRec52[2] + (fRec52[0] + (2 * fRec52[1])));
		fVec6[0] = fTemp19;
		fRec51[0] = ((fConst50 * ((fConst49 * fVec6[1]) + (fConst12 * fVec6[0]))) + (fConst48 * fRec51[1]));
		fRec50[0] = (fRec51[0] - (fConst46 * ((fConst45 * fRec50[2]) + (fConst11 * fRec50[1]))));
		double fTemp20 = max(-1, min(1, (fSlow7 * (((fConst10 * fRec50[0]) + (fConst51 * fRec50[1])) + (fConst10 * fRec50[2])))));
		double fTemp21 = (fConst11 * fRec54[1]);
		double fTemp22 = (fConst17 * fRec55[1]);
		...
		fRec55[0] = ((fConst30 * (((fConst25 * fRec56[0]) + (fConst55 * fRec56[1])) + (fConst25 * fRec56[2]))) - (fConst53 * ((fConst52 * fRec55[2]) + fTemp22)));
		fRec54[0] = ((fRec55[2] + (fConst53 * (fTemp22 + (fConst52 * fRec55[0])))) - (fConst14 * ((fConst13 * fRec54[2]) + fTemp21)));
		double fTemp23 = max(-1, min(1, (fSlow8 * (fRec54[2] + (fConst14 * (fTemp21 + (fConst13 * fRec54[0])))))));
		fRec59[0] = ((fConst50 * (fVec6[0] + fVec6[1])) + (fConst48 * fRec59[1]));
		fRec58[0] = (fRec59[0] - (fConst46 * ((fConst45 * fRec58[2]) + (fConst11 * fRec58[1]))));
		double fTemp24 = max(-1, min(1, (fSlow9 * (fRec58[2] + (fRec58[0] + (2 * fRec58[1]))))));
		...
		fVec7[0] = fTemp25;
		fRec42[0] = ((fConst56 * (fVec7[0] + fVec7[1])) + (fConst8 * fRec42[1]));
		fRec60[0] = ((fConst60 * (fRec41[1] + fRec41[2])) + (fConst59 * fRec60[1]));
		fRec41[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec60[0] + (fRec29[0] * ((fSlow10 * fRec42[0]) + (fTemp14 * (fTemp2 + (fTemp0 * (1 + (fSlow3 * ((4 - (4 * fabs((fTemp14 * fTemp0)))) - 1))))))))) - 2.29615)) - 164.9574074074074);
		...
		fRec61[0] = ((fConst66 * (fRec38[1] + fRec38[2])) + (fConst65 * fRec61[1]));
		fRec38[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec61[0] + (fRec29[0] * fRec39[0])) - 1.675587)) - 138.2942);
		...
		fRec62[0] = ((fConst70 * (fRec34[1] + fRec34[2])) + (fConst69 * fRec62[1]));
		fRec34[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec62[0] + fRec35[0]) - (1.130462 + (1.059 * fRec35[1])))) - 112.13878048780487);
