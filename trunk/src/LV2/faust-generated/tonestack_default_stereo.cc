...
#define fVslider2 (*fVslider2_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec1[0] = fTemp1;
		fRec7[0] = fSlow12 * (fSlow11 * fRec7[1] - fSlow10 * fRec7[2] + fSlow2 * (fSlow8 * fTemp1 + fSlow7 * fVec1[1] + fSlow5 * fVec1[2]));
		fRec6[0] = fSlow26 * (fSlow25 * fRec6[1] - fSlow24 * fRec6[2] + fSlow13 * (fSlow22 * fRec7[0] + fSlow21 * fRec7[1] + fSlow18 * fRec7[2]));
		fRec5[0] = -(fSlow36 * (fSlow35 * fRec5[2] + fSlow34 * fRec5[1] - fSlow13 * (fSlow33 * fRec6[0] - fSlow32 * fRec6[1] + fSlow30 * fRec6[2])));
		fRec4[0] = -(fSlow47 * (fSlow46 * fRec4[2] + fSlow45 * fRec4[1] - fSlow37 * (fSlow44 * fRec5[0] - fSlow43 * fRec5[1] + fSlow41 * fRec5[2])));
