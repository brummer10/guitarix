...
#define fslider2 (*fslider2_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec1[0] = fTemp1;
		fRec7[0] = (fSlow23 * ((fSlow12 * (((fSlow22 * fVec1[0]) + (fSlow21 * fVec1[1])) + (fSlow20 * fVec1[2]))) - ((fSlow19 * fRec7[1]) + (fSlow16 * fRec7[2]))));
		fRec6[0] = (fSlow27 * ((fSlow1 * (((fSlow26 * fRec7[0]) + (fSlow25 * fRec7[1])) + (fSlow24 * fRec7[2]))) - ((fSlow10 * fRec6[1]) + (fSlow7 * fRec6[2]))));
		fRec5[0] = (fSlow37 * ((0 - ((fSlow36 * fRec5[2]) + (fSlow35 * fRec5[1]))) + (((fSlow34 * fRec6[0]) + (fSlow33 * fRec6[1])) + (fSlow31 * fRec6[2]))));
		fRec4[0] = (fSlow49 * ((0 - ((fSlow48 * fRec4[2]) + (fSlow47 * fRec4[1]))) + (((fSlow46 * fRec5[0]) + (fSlow45 * fRec5[1])) + (fSlow42 * fRec5[2]))));
