...
#define fHslider1 (*fHslider1_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp7 = fVec0[(IOTA0 - int(std::min<double>(65536.0, std::max<double>(0.0, fRec3[0])))) & 131071];
		output0[i0] = FAUSTFLOAT(fRec0[0] * (fTemp7 + fRec2[0] * (fVec0[(IOTA0 - int(std::min<double>(65536.0, std::max<double>(0.0, fRec4[0])))) & 131071] - fTemp7)) + fSlow3 * fTemp0);
		fRec0[1] = fRec0[0];
		IOTA0 = IOTA0 + 1;
		fRec5[1] = fRec5[0];
		fRec1[1] = fRec1[0];
