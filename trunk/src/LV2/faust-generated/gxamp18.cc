...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * fRec12[0]) + ((fSlow6 * fTemp4) + ((fSlow4 * ((fTemp3 * (4 - (4 * fabs(fTemp3)))) - fTemp3)) + (fRec11[0] + fTemp1)))) - 2.921805999999998)) - 141.78496296296294);
