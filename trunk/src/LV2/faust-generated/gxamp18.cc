...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (fConst13 * fRec13[1]);
		double fTemp3 = (1e-15 + (fTemp0 * fRec10[0]));
		fRec19[0] = (fTemp3 - (fConst40 * ((fConst38 * fRec19[2]) + (fConst36 * fRec19[1]))));
		...
		fRec13[0] = ((fConst23 * (((fConst18 * fRec14[0]) + (fConst46 * fRec14[1])) + (fConst18 * fRec14[2]))) - (fConst16 * ((fConst15 * fRec13[2]) + fTemp2)));
		double fTemp6 = max(-1, min(1, (fSlow4 * (fRec13[2] + (fConst16 * (fTemp2 + (fConst15 * fRec13[0])))))));
		fRec23[0] = ((fConst45 * (fVec1[0] + fVec1[1])) + (fConst25 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst23 * ((fConst21 * fRec22[2]) + (fConst19 * fRec22[1]))));
		double fTemp7 = (fRec22[2] + (fRec22[0] + (2 * fRec22[1])));
		fVec2[0] = fTemp7;
		...
		double fTemp8 = max(-1, min(1, (fSlow5 * (((fConst12 * fRec20[0]) + (fConst53 * fRec20[1])) + (fConst12 * fRec20[2])))));
		double fTemp9 = (fConst13 * fRec24[1]);
		double fTemp10 = (fConst19 * fRec25[1]);
		...
		fRec25[0] = ((fConst32 * (((fConst27 * fRec26[0]) + (fConst57 * fRec26[1])) + (fConst27 * fRec26[2]))) - (fConst55 * ((fConst54 * fRec25[2]) + fTemp10)));
		fRec24[0] = ((fRec25[2] + (fConst55 * (fTemp10 + (fConst54 * fRec25[0])))) - (fConst16 * ((fConst15 * fRec24[2]) + fTemp9)));
		double fTemp11 = max(-1, min(1, (fSlow6 * (fRec24[2] + (fConst16 * (fTemp9 + (fConst15 * fRec24[0])))))));
		fRec29[0] = ((fConst52 * (fVec2[0] + fVec2[1])) + (fConst50 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst48 * ((fConst47 * fRec28[2]) + (fConst13 * fRec28[1]))));
		double fTemp12 = max(-1, min(1, (fSlow7 * (fRec28[2] + (fRec28[0] + (2 * fRec28[1]))))));
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * ((fTemp14 * (4 - (4 * fabs(fTemp14)))) - fTemp14)) + ((fSlow10 * fTemp3) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp1)))) - 2.921805999999998)) - 141.78496296296294);
		fRec8[0] = ((fConst59 * ((fConst41 * fRec9[1]) + (fConst1 * fRec9[0]))) + (fConst3 * fRec8[1]));
		double fTemp15 = (fRec8[0] * fRec7[0]);
		fVec4[0] = fTemp15;
		...
		double fTemp16 = (fRec7[0] * fRec4[0]);
		fVec5[0] = fTemp16;
