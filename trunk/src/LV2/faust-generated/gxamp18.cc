...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = double(Ftube(int(TUBE_TABLE_6C16_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -2.9218060000000001))));
		fRec12[0] = ((fTemp19 + (0.0010821503703703705 * (double(Ranode(int(TUBE_TABLE_6C16_68k), double(fTemp19))) + 100000.0))) + -250.0);
		...
		double fTemp24 = double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -2.0977429999999999))));
		fRec7[0] = ((fTemp24 + (0.0013984953333333332 * (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fTemp24))) + 100000.0))) + -250.0);
		...
		double fTemp28 = ((fTemp27 + fTemp26) / (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp28;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp29 = double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp26 + (fRec36[0] + fTemp27)) + -1.3787419999999999))));
		fRec1[0] = ((fTemp29 + (0.0016813926829268291 * (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fTemp29))) + 100000.0))) + -250.0);
