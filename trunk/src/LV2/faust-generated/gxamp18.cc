...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp23 = (fTemp21 + fTemp22) / (Ranode(TUBE_TABLE_6C16_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp23;
		fRec36[0] = fConst62 * (1.5e+03 * (fTemp23 + fVec7[1]) - fConst61 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp22 + fRec36[0] + fTemp21 + -2.097743) + -110.15046666666666;
		...
		double fTemp28 = (fTemp26 + fTemp27) / (Ranode(TUBE_TABLE_6C16_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp28;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp28 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp27 + fRec38[0] + fTemp26 + -1.378742) + -81.86073170731709;
