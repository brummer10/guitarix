...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6C16_68k, ((fRec35[0] + (0.9254498422517706 * (fRec14[2] + (fRec14[0] + (2.0 * fRec14[1]))))) - 2.921806)) - 141.78496296296294);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec36[0] + (0.9254498422517706 * (fRec8[2] + (fRec8[0] + (2.0 * fRec8[1]))))) - 2.097743)) - 110.15046666666666);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec37[0] + (0.9254498422517706 * (fRec3[2] + (fRec3[0] + (2.0 * fRec3[1]))))) - 1.378742)) - 81.86073170731709);
