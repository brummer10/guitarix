...
#define fVbargraph4 (*fVbargraph4_)
	...
	double fSlow39 = double(fVslider0);
	double fSlow40 = 1.0 - 0.01 * fSlow39;
	double fSlow41 = 0.01 * fSlow40 + 0.00015;
	double fSlow42 = (fSlow40 + fSlow39 * fSlow41) / fSlow5;
	double fSlow43 = double(fVslider1);
	double fSlow44 = 1.0 - fSlow43;
	double fSlow45 = 0.28 * double(fVslider2) + 0.7;
	double fSlow46 = 0.00015 * (fSlow39 / fSlow5);
	double fSlow47 = (fSlow39 * (fSlow41 + -0.01) + 1.0) / fSlow5;
	double fSlow48 = fSlow1 * fSlow5;
	double fSlow49 = double(fVslider3);
	double fSlow50 = 1.0 - 0.01 * fSlow49;
	double fSlow51 = 0.01 * fSlow50 + 0.00015;
	double fSlow52 = (fSlow50 + fSlow49 * fSlow51) / fSlow48;
	double fSlow53 = double(fVslider4);
	double fSlow54 = 1.0 - fSlow53;
	double fSlow55 = 0.28 * double(fVslider5) + 0.7;
	double fSlow56 = 0.00015 * (fSlow49 / fSlow48);
	double fSlow57 = (fSlow49 * (fSlow51 + -0.01) + 1.0) / fSlow48;
	double fSlow58 = 1.0 - fSlow36 / fSlow0;
	double fSlow59 = 1.0 / (fSlow37 / fSlow0 + 1.0);
	double fSlow60 = 1.0 / (fSlow8 * fSlow12);
	double fSlow61 = double(fVslider6);
	double fSlow62 = 1.0 - 0.01 * fSlow61;
	double fSlow63 = 0.01 * fSlow62 + 0.00015;
	double fSlow64 = fSlow62 + fSlow61 * fSlow63;
	double fSlow65 = double(fVslider7);
	double fSlow66 = 1.0 - fSlow65;
	double fSlow67 = 0.28 * double(fVslider8) + 0.7;
	double fSlow68 = 0.00015 * fSlow61;
	double fSlow69 = fSlow61 * (fSlow63 + -0.01) + 1.0;
	double fSlow70 = 1.0 - fSlow33 / fSlow7;
	double fSlow71 = 1.0 / (fSlow34 / fSlow7 + 1.0);
	double fSlow72 = 1.0 / (fSlow15 * fSlow19);
	double fSlow73 = double(fVslider9);
	double fSlow74 = 1.0 - 0.01 * fSlow73;
	double fSlow75 = 0.01 * fSlow74 + 0.00015;
	double fSlow76 = fSlow74 + fSlow73 * fSlow75;
	double fSlow77 = double(fVslider10);
	double fSlow78 = 1.0 - fSlow77;
	double fSlow79 = 0.28 * double(fVslider11) + 0.7;
	double fSlow80 = 0.00015 * fSlow73;
	double fSlow81 = fSlow73 * (fSlow75 + -0.01) + 1.0;
	double fSlow82 = 1.0 - fSlow30 / fSlow14;
	double fSlow83 = 1.0 / (fSlow31 / fSlow14 + 1.0);
	double fSlow84 = 1.0 / (fSlow22 * fSlow26);
	double fSlow85 = double(fVslider12);
	double fSlow86 = 1.0 - 0.01 * fSlow85;
	double fSlow87 = 0.01 * fSlow86 + 0.00015;
	double fSlow88 = fSlow86 + fSlow85 * fSlow87;
	double fSlow89 = double(fVslider13);
	double fSlow90 = 1.0 - fSlow89;
	double fSlow91 = 0.28 * double(fVslider14) + 0.7;
	double fSlow92 = 0.00015 * fSlow85;
	double fSlow93 = fSlow85 * (fSlow87 + -0.01) + 1.0;
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec20[0] = fSlow43 * fRec20[1] + fSlow44 * fRec19[1];
		double fTemp6 = fSlow46 * fTemp5;
		fVec4[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec20[0];
		fRec19[0] = fVec4[(IOTA0 - 1640) & 2047];
		fRec22[0] = fSlow43 * fRec22[1] + fSlow44 * fRec21[1];
		fVec5[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec22[0];
		fRec21[0] = fVec5[(IOTA0 - 1580) & 2047];
		fRec24[0] = fSlow43 * fRec24[1] + fSlow44 * fRec23[1];
		fVec6[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec24[0];
		fRec23[0] = fVec6[(IOTA0 - 1514) & 2047];
		fRec26[0] = fSlow43 * fRec26[1] + fSlow44 * fRec25[1];
		fVec7[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec26[0];
		fRec25[0] = fVec7[(IOTA0 - 1445) & 2047];
		fRec28[0] = fSlow43 * fRec28[1] + fSlow44 * fRec27[1];
		fVec8[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec28[0];
		fRec27[0] = fVec8[(IOTA0 - 1379) & 2047];
		fRec30[0] = fSlow43 * fRec30[1] + fSlow44 * fRec29[1];
		fVec9[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec30[0];
		fRec29[0] = fVec9[(IOTA0 - 1300) & 2047];
		fRec32[0] = fSlow43 * fRec32[1] + fSlow44 * fRec31[1];
		fVec10[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec32[0];
		fRec31[0] = fVec10[(IOTA0 - 1211) & 2047];
		fRec34[0] = fSlow43 * fRec34[1] + fSlow44 * fRec33[1];
		fVec11[IOTA0 & 2047] = fTemp6 + fSlow45 * fRec34[0];
		...
		double fTemp14 = std::max<double>(fConst1, std::fabs(fRec41 + fSlow52 * fTemp11));
		fRec35[0] = ((iTemp9) ? std::max<double>(fRec35[1], fTemp14) : fTemp14);
		iRec36[0] = ((iTemp9) ? iRec36[1] + 1 : 1);
		fRec37[0] = ((iTemp9) ? fRec37[1] : fRec35[1]);
		fVbargraph1 = FAUSTFLOAT(fRec37[0]);
		int iTemp15 = iRec65[1] < 4096;
		double fTemp16 = fSlow2 * fRec67[1];
		fRec69[0] = -(fSlow35 * (fSlow33 * fRec69[1] - fSlow10 * (fTemp3 - fVec2[1])));
		fRec68[0] = fRec69[0] - fSlow13 * (fSlow11 * fRec68[2] + fSlow9 * fRec68[1]);
		fRec67[0] = fSlow60 * (fRec68[2] + (fRec68[0] - 2.0 * fRec68[1])) - fSlow59 * (fSlow58 * fRec67[2] + fTemp16);
		double fTemp17 = fRec67[2] + fSlow59 * (fTemp16 + fSlow58 * fRec67[0]);
		fRec79[0] = fSlow65 * fRec79[1] + fSlow66 * fRec78[1];
		double fTemp18 = fSlow68 * fTemp17;
		fVec28[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec79[0];
		fRec78[0] = fVec28[(IOTA0 - 1640) & 2047];
		fRec81[0] = fSlow65 * fRec81[1] + fSlow66 * fRec80[1];
		fVec29[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec81[0];
		fRec80[0] = fVec29[(IOTA0 - 1580) & 2047];
		fRec83[0] = fSlow65 * fRec83[1] + fSlow66 * fRec82[1];
		fVec30[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec83[0];
		fRec82[0] = fVec30[(IOTA0 - 1514) & 2047];
		fRec85[0] = fSlow65 * fRec85[1] + fSlow66 * fRec84[1];
		fVec31[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec85[0];
		fRec84[0] = fVec31[(IOTA0 - 1445) & 2047];
		fRec87[0] = fSlow65 * fRec87[1] + fSlow66 * fRec86[1];
		fVec32[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec87[0];
		fRec86[0] = fVec32[(IOTA0 - 1379) & 2047];
		fRec89[0] = fSlow65 * fRec89[1] + fSlow66 * fRec88[1];
		fVec33[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec89[0];
		fRec88[0] = fVec33[(IOTA0 - 1300) & 2047];
		fRec91[0] = fSlow65 * fRec91[1] + fSlow66 * fRec90[1];
		fVec34[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec91[0];
		fRec90[0] = fVec34[(IOTA0 - 1211) & 2047];
		fRec93[0] = fSlow65 * fRec93[1] + fSlow66 * fRec92[1];
		fVec35[IOTA0 & 2047] = fTemp18 + fSlow67 * fRec93[0];
		fRec92[0] = fVec35[(IOTA0 - 1139) & 2047];
		double fTemp19 = fRec92[0] + fRec90[0] + fRec88[0] + fRec86[0] + fRec84[0] + fRec82[0] + fRec80[0] + fRec78[0];
		fVec36[IOTA0 & 1023] = fTemp19 + 0.5 * fRec76[1];
		fRec76[0] = fVec36[(IOTA0 - 579) & 1023];
		double fRec77 = fRec76[1] - fTemp19;
		...
		double fTemp20 = std::max<double>(fConst1, std::fabs(fRec71 + fSlow64 * fTemp17));
		fRec64[0] = ((iTemp15) ? std::max<double>(fRec64[1], fTemp20) : fTemp20);
		iRec65[0] = ((iTemp15) ? iRec65[1] + 1 : 1);
		fRec66[0] = ((iTemp15) ? fRec66[1] : fRec64[1]);
		fVbargraph2 = FAUSTFLOAT(fRec66[0]);
		int iTemp21 = iRec95[1] < 4096;
		double fTemp22 = fSlow2 * fRec97[1];
		double fTemp23 = fSlow9 * fRec98[1];
		fRec100[0] = -(fSlow32 * (fSlow30 * fRec100[1] - fSlow17 * (fTemp2 - fVec1[1])));
		fRec99[0] = fRec100[0] - fSlow20 * (fSlow18 * fRec99[2] + fSlow16 * fRec99[1]);
		fRec98[0] = fSlow72 * (fRec99[2] + (fRec99[0] - 2.0 * fRec99[1])) - fSlow71 * (fSlow70 * fRec98[2] + fTemp23);
		fRec97[0] = fRec98[2] + fSlow71 * (fTemp23 + fSlow70 * fRec98[0]) - fSlow59 * (fSlow58 * fRec97[2] + fTemp22);
		double fTemp24 = fRec97[2] + fSlow59 * (fTemp22 + fSlow58 * fRec97[0]);
		fRec110[0] = fSlow77 * fRec110[1] + fSlow78 * fRec109[1];
		double fTemp25 = fSlow80 * fTemp24;
		fVec40[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec110[0];
		fRec109[0] = fVec40[(IOTA0 - 1640) & 2047];
		fRec112[0] = fSlow77 * fRec112[1] + fSlow78 * fRec111[1];
		fVec41[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec112[0];
		fRec111[0] = fVec41[(IOTA0 - 1580) & 2047];
		fRec114[0] = fSlow77 * fRec114[1] + fSlow78 * fRec113[1];
		fVec42[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec114[0];
		fRec113[0] = fVec42[(IOTA0 - 1514) & 2047];
		fRec116[0] = fSlow77 * fRec116[1] + fSlow78 * fRec115[1];
		fVec43[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec116[0];
		fRec115[0] = fVec43[(IOTA0 - 1445) & 2047];
		fRec118[0] = fSlow77 * fRec118[1] + fSlow78 * fRec117[1];
		fVec44[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec118[0];
		fRec117[0] = fVec44[(IOTA0 - 1379) & 2047];
		fRec120[0] = fSlow77 * fRec120[1] + fSlow78 * fRec119[1];
		fVec45[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec120[0];
		fRec119[0] = fVec45[(IOTA0 - 1300) & 2047];
		fRec122[0] = fSlow77 * fRec122[1] + fSlow78 * fRec121[1];
		fVec46[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec122[0];
		fRec121[0] = fVec46[(IOTA0 - 1211) & 2047];
		fRec124[0] = fSlow77 * fRec124[1] + fSlow78 * fRec123[1];
		fVec47[IOTA0 & 2047] = fTemp25 + fSlow79 * fRec124[0];
		fRec123[0] = fVec47[(IOTA0 - 1139) & 2047];
		double fTemp26 = fRec123[0] + fRec121[0] + fRec119[0] + fRec117[0] + fRec115[0] + fRec113[0] + fRec111[0] + fRec109[0];
		fVec48[IOTA0 & 1023] = fTemp26 + 0.5 * fRec107[1];
		fRec107[0] = fVec48[(IOTA0 - 579) & 1023];
		double fRec108 = fRec107[1] - fTemp26;
		...
		double fTemp27 = std::max<double>(fConst1, std::fabs(fRec102 + fSlow76 * fTemp24));
		fRec94[0] = ((iTemp21) ? std::max<double>(fRec94[1], fTemp27) : fTemp27);
		iRec95[0] = ((iTemp21) ? iRec95[1] + 1 : 1);
		fRec96[0] = ((iTemp21) ? fRec96[1] : fRec94[1]);
		fVbargraph3 = FAUSTFLOAT(fRec96[0]);
		int iTemp28 = iRec126[1] < 4096;
		double fTemp29 = fSlow2 * fRec128[1];
		double fTemp30 = fSlow9 * fRec129[1];
		double fTemp31 = fSlow16 * fRec130[1];
		...
		fRec130[0] = fSlow84 * (fRec131[2] + (fRec131[0] - 2.0 * fRec131[1])) - fSlow83 * (fSlow82 * fRec130[2] + fTemp31);
		fRec129[0] = fRec130[2] + fSlow83 * (fTemp31 + fSlow82 * fRec130[0]) - fSlow71 * (fSlow70 * fRec129[2] + fTemp30);
		fRec128[0] = fRec129[2] + fSlow71 * (fTemp30 + fSlow70 * fRec129[0]) - fSlow59 * (fSlow58 * fRec128[2] + fTemp29);
		double fTemp32 = fRec128[2] + fSlow59 * (fTemp29 + fSlow58 * fRec128[0]);
		fRec142[0] = fSlow89 * fRec142[1] + fSlow90 * fRec141[1];
		double fTemp33 = fSlow92 * fTemp32;
		fVec52[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec142[0];
		fRec141[0] = fVec52[(IOTA0 - 1640) & 2047];
		fRec144[0] = fSlow89 * fRec144[1] + fSlow90 * fRec143[1];
		fVec53[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec144[0];
		fRec143[0] = fVec53[(IOTA0 - 1580) & 2047];
		fRec146[0] = fSlow89 * fRec146[1] + fSlow90 * fRec145[1];
		fVec54[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec146[0];
		fRec145[0] = fVec54[(IOTA0 - 1514) & 2047];
		fRec148[0] = fSlow89 * fRec148[1] + fSlow90 * fRec147[1];
		fVec55[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec148[0];
		fRec147[0] = fVec55[(IOTA0 - 1445) & 2047];
		fRec150[0] = fSlow89 * fRec150[1] + fSlow90 * fRec149[1];
		fVec56[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec150[0];
		fRec149[0] = fVec56[(IOTA0 - 1379) & 2047];
		fRec152[0] = fSlow89 * fRec152[1] + fSlow90 * fRec151[1];
		fVec57[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec152[0];
		fRec151[0] = fVec57[(IOTA0 - 1300) & 2047];
		fRec154[0] = fSlow89 * fRec154[1] + fSlow90 * fRec153[1];
		fVec58[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec154[0];
		fRec153[0] = fVec58[(IOTA0 - 1211) & 2047];
		fRec156[0] = fSlow89 * fRec156[1] + fSlow90 * fRec155[1];
		fVec59[IOTA0 & 2047] = fTemp33 + fSlow91 * fRec156[0];
		fRec155[0] = fVec59[(IOTA0 - 1139) & 2047];
		double fTemp34 = fRec155[0] + fRec153[0] + fRec151[0] + fRec149[0] + fRec147[0] + fRec145[0] + fRec143[0] + fRec141[0];
		fVec60[IOTA0 & 1023] = fTemp34 + 0.5 * fRec139[1];
		fRec139[0] = fVec60[(IOTA0 - 579) & 1023];
		double fRec140 = fRec139[1] - fTemp34;
		...
		double fTemp35 = std::max<double>(fConst1, std::fabs(fRec134 + fSlow88 * fTemp32));
		fRec125[0] = ((iTemp28) ? std::max<double>(fRec125[1], fTemp35) : fTemp35);
		iRec126[0] = ((iTemp28) ? iRec126[1] + 1 : 1);
		fRec127[0] = ((iTemp28) ? fRec127[1] : fRec125[1]);
		fVbargraph4 = FAUSTFLOAT(fRec127[0]);
		output0[i0] = FAUSTFLOAT(fRec134 + fSlow93 * fTemp32 + fRec102 + fSlow81 * fTemp24 + fRec71 + fSlow69 * fTemp17 + fRec41 + fSlow57 * (fRec38[0] + fRec38[2] - fTemp10) + fRec12 + fSlow47 * fTemp5);
		fVec0[1] = fVec0[0];
		fRec10[1] = fRec10[0];
		fRec9[2] = fRec9[1];
		fRec9[1] = fRec9[0];
