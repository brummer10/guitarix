...
#define fVbargraph4 (*fVbargraph4_)
	...
	double fSlow42 = double(fVslider1);
	double fSlow43 = 1.0 - fSlow42;
	double fSlow44 = 0.28 * double(fVslider2) + 0.7;
	...
	double fSlow50 = double(fVslider4);
	double fSlow51 = 1.0 - fSlow50;
	double fSlow52 = 0.28 * double(fVslider5) + 0.7;
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		iRec126[0] = ((iTemp31) ? iRec126[1] + 1 : 1);
		fRec127[0] = ((iTemp31) ? fRec127[1] : fRec125[1]);
		fVbargraph4 = FAUSTFLOAT(fRec127[0]);
		output0[i0] = FAUSTFLOAT(fTemp38 + fTemp29 + fTemp21 + fTemp14 + fTemp8);
		fVec0[1] = fVec0[0];
		fRec10[1] = fRec10[0];
		fRec9[2] = fRec9[1];
		fRec9[1] = fRec9[0];
