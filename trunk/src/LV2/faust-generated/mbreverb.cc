...
#define fVbargraph4 (*fVbargraph4_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec1[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec17[0];
		fRec11[0] = fVec1[(IOTA0 - 1139) & 2047];
		fRec19[0] = fSlow43 * fRec19[1] + fSlow44 * fRec18[1];
		fVec2[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec19[0];
		fRec18[0] = fVec2[(IOTA0 - 1211) & 2047];
		fRec21[0] = fSlow43 * fRec21[1] + fSlow44 * fRec20[1];
		fVec3[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec21[0];
		fRec20[0] = fVec3[(IOTA0 - 1300) & 2047];
		fRec23[0] = fSlow43 * fRec23[1] + fSlow44 * fRec22[1];
		fVec4[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec23[0];
		fRec22[0] = fVec4[(IOTA0 - 1379) & 2047];
		fRec25[0] = fSlow43 * fRec25[1] + fSlow44 * fRec24[1];
		fVec5[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec25[0];
		fRec24[0] = fVec5[(IOTA0 - 1445) & 2047];
		fRec27[0] = fSlow43 * fRec27[1] + fSlow44 * fRec26[1];
		fVec6[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec27[0];
		fRec26[0] = fVec6[(IOTA0 - 1514) & 2047];
		fRec29[0] = fSlow43 * fRec29[1] + fSlow44 * fRec28[1];
		fVec7[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec29[0];
		fRec28[0] = fVec7[(IOTA0 - 1580) & 2047];
		fRec31[0] = fSlow43 * fRec31[1] + fSlow44 * fRec30[1];
		fVec8[IOTA0 & 2047] = fTemp6 + fSlow42 * fRec31[0];
		fRec30[0] = fVec8[(IOTA0 - 1640) & 2047];
		double fTemp7 = fRec11[0] + fRec18[0] + fRec20[0] + fRec22[0] + fRec24[0] + fRec26[0] + fRec28[0] + fRec30[0];
		fVec9[IOTA0 & 1023] = fTemp7 + 0.5 * fRec9[1];
		fRec9[0] = fVec9[(IOTA0 - 579) & 1023];
		double fRec10 = fRec9[1] - fTemp7;
		fVec10[IOTA0 & 511] = fRec10 + 0.5 * fRec7[1];
		fRec7[0] = fVec10[(IOTA0 - 464) & 511];
		double fRec8 = fRec7[1] - fRec10;
		fVec11[IOTA0 & 511] = fRec8 + 0.5 * fRec5[1];
		fRec5[0] = fVec11[(IOTA0 - 364) & 511];
		double fRec6 = fRec5[1] - fRec8;
		fVec12[IOTA0 & 255] = fRec6 + 0.5 * fRec3[1];
		fRec3[0] = fVec12[(IOTA0 - 248) & 255];
		double fRec4 = fRec3[1] - fRec6;
		double fTemp8 = fRec4 + fSlow46 * fTemp5;
		double fTemp9 = std::max<double>(fConst1, std::fabs(fTemp8));
		double fElse0 = std::max<double>(fRec0[1], fTemp9);
		fRec0[0] = ((iTemp0) ? fElse0 : fTemp9);
		...
		fVec14[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec50[0];
		fRec43[0] = fVec14[(IOTA0 - 1139) & 2047];
		fRec52[0] = fSlow57 * fRec52[1] + fSlow58 * fRec51[1];
		fVec15[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec52[0];
		fRec51[0] = fVec15[(IOTA0 - 1211) & 2047];
		fRec54[0] = fSlow57 * fRec54[1] + fSlow58 * fRec53[1];
		fVec16[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec54[0];
		fRec53[0] = fVec16[(IOTA0 - 1300) & 2047];
		fRec56[0] = fSlow57 * fRec56[1] + fSlow58 * fRec55[1];
		fVec17[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec56[0];
		fRec55[0] = fVec17[(IOTA0 - 1379) & 2047];
		fRec58[0] = fSlow57 * fRec58[1] + fSlow58 * fRec57[1];
		fVec18[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec58[0];
		fRec57[0] = fVec18[(IOTA0 - 1445) & 2047];
		fRec60[0] = fSlow57 * fRec60[1] + fSlow58 * fRec59[1];
		fVec19[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec60[0];
		fRec59[0] = fVec19[(IOTA0 - 1514) & 2047];
		fRec62[0] = fSlow57 * fRec62[1] + fSlow58 * fRec61[1];
		fVec20[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec62[0];
		fRec61[0] = fVec20[(IOTA0 - 1580) & 2047];
		fRec64[0] = fSlow57 * fRec64[1] + fSlow58 * fRec63[1];
		fVec21[IOTA0 & 2047] = fTemp16 + fSlow56 * fRec64[0];
		fRec63[0] = fVec21[(IOTA0 - 1640) & 2047];
		double fTemp17 = fRec43[0] + fRec51[0] + fRec53[0] + fRec55[0] + fRec57[0] + fRec59[0] + fRec61[0] + fRec63[0];
		fVec22[IOTA0 & 1023] = fTemp17 + 0.5 * fRec41[1];
		fRec41[0] = fVec22[(IOTA0 - 579) & 1023];
		double fRec42 = fRec41[1] - fTemp17;
		fVec23[IOTA0 & 511] = fRec42 + 0.5 * fRec39[1];
		fRec39[0] = fVec23[(IOTA0 - 464) & 511];
		double fRec40 = fRec39[1] - fRec42;
		fVec24[IOTA0 & 511] = fRec40 + 0.5 * fRec37[1];
		fRec37[0] = fVec24[(IOTA0 - 364) & 511];
		double fRec38 = fRec37[1] - fRec40;
		fVec25[IOTA0 & 255] = fRec38 + 0.5 * fRec35[1];
		fRec35[0] = fVec25[(IOTA0 - 248) & 255];
		double fRec36 = fRec35[1] - fRec38;
		double fTemp18 = fRec36 + fSlow60 * fTemp15;
		double fTemp19 = std::max<double>(fConst1, std::fabs(fTemp18));
		double fElse3 = std::max<double>(fRec32[1], fTemp19);
		fRec32[0] = ((iTemp10) ? fElse3 : fTemp19);
		int iElse4 = iRec33[1] + 1;
		iRec33[0] = ((iTemp10) ? iElse4 : 1);
		...
		fVec27[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec82[0];
		fRec76[0] = fVec27[(IOTA0 - 1139) & 2047];
		fRec84[0] = fSlow71 * fRec84[1] + fSlow72 * fRec83[1];
		fVec28[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec84[0];
		fRec83[0] = fVec28[(IOTA0 - 1211) & 2047];
		fRec86[0] = fSlow71 * fRec86[1] + fSlow72 * fRec85[1];
		fVec29[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec86[0];
		fRec85[0] = fVec29[(IOTA0 - 1300) & 2047];
		fRec88[0] = fSlow71 * fRec88[1] + fSlow72 * fRec87[1];
		fVec30[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec88[0];
		fRec87[0] = fVec30[(IOTA0 - 1379) & 2047];
		fRec90[0] = fSlow71 * fRec90[1] + fSlow72 * fRec89[1];
		fVec31[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec90[0];
		fRec89[0] = fVec31[(IOTA0 - 1445) & 2047];
		fRec92[0] = fSlow71 * fRec92[1] + fSlow72 * fRec91[1];
		fVec32[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec92[0];
		fRec91[0] = fVec32[(IOTA0 - 1514) & 2047];
		fRec94[0] = fSlow71 * fRec94[1] + fSlow72 * fRec93[1];
		fVec33[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec94[0];
		fRec93[0] = fVec33[(IOTA0 - 1580) & 2047];
		fRec96[0] = fSlow71 * fRec96[1] + fSlow72 * fRec95[1];
		fVec34[IOTA0 & 2047] = fTemp25 + fSlow70 * fRec96[0];
		fRec95[0] = fVec34[(IOTA0 - 1640) & 2047];
		double fTemp26 = fRec76[0] + fRec83[0] + fRec85[0] + fRec87[0] + fRec89[0] + fRec91[0] + fRec93[0] + fRec95[0];
		fVec35[IOTA0 & 1023] = fTemp26 + 0.5 * fRec74[1];
		fRec74[0] = fVec35[(IOTA0 - 579) & 1023];
		double fRec75 = fRec74[1] - fTemp26;
		fVec36[IOTA0 & 511] = fRec75 + 0.5 * fRec72[1];
		fRec72[0] = fVec36[(IOTA0 - 464) & 511];
		double fRec73 = fRec72[1] - fRec75;
		fVec37[IOTA0 & 511] = fRec73 + 0.5 * fRec70[1];
		fRec70[0] = fVec37[(IOTA0 - 364) & 511];
		double fRec71 = fRec70[1] - fRec73;
		fVec38[IOTA0 & 255] = fRec71 + 0.5 * fRec68[1];
		fRec68[0] = fVec38[(IOTA0 - 248) & 255];
		double fRec69 = fRec68[1] - fRec71;
		double fTemp27 = fRec69 + fSlow74 * fTemp24;
		double fTemp28 = std::max<double>(fConst1, std::fabs(fTemp27));
		double fElse6 = std::max<double>(fRec65[1], fTemp28);
		fRec65[0] = ((iTemp20) ? fElse6 : fTemp28);
		int iElse7 = iRec66[1] + 1;
		iRec66[0] = ((iTemp20) ? iElse7 : 1);
		...
		fVec40[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec113[0];
		fRec108[0] = fVec40[(IOTA0 - 1139) & 2047];
		fRec115[0] = fSlow85 * fRec115[1] + fSlow86 * fRec114[1];
		fVec41[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec115[0];
		fRec114[0] = fVec41[(IOTA0 - 1211) & 2047];
		fRec117[0] = fSlow85 * fRec117[1] + fSlow86 * fRec116[1];
		fVec42[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec117[0];
		fRec116[0] = fVec42[(IOTA0 - 1300) & 2047];
		fRec119[0] = fSlow85 * fRec119[1] + fSlow86 * fRec118[1];
		fVec43[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec119[0];
		fRec118[0] = fVec43[(IOTA0 - 1379) & 2047];
		fRec121[0] = fSlow85 * fRec121[1] + fSlow86 * fRec120[1];
		fVec44[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec121[0];
		fRec120[0] = fVec44[(IOTA0 - 1445) & 2047];
		fRec123[0] = fSlow85 * fRec123[1] + fSlow86 * fRec122[1];
		fVec45[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec123[0];
		fRec122[0] = fVec45[(IOTA0 - 1514) & 2047];
		fRec125[0] = fSlow85 * fRec125[1] + fSlow86 * fRec124[1];
		fVec46[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec125[0];
		fRec124[0] = fVec46[(IOTA0 - 1580) & 2047];
		fRec127[0] = fSlow85 * fRec127[1] + fSlow86 * fRec126[1];
		fVec47[IOTA0 & 2047] = fTemp33 + fSlow84 * fRec127[0];
		fRec126[0] = fVec47[(IOTA0 - 1640) & 2047];
		double fTemp34 = fRec108[0] + fRec114[0] + fRec116[0] + fRec118[0] + fRec120[0] + fRec122[0] + fRec124[0] + fRec126[0];
		fVec48[IOTA0 & 1023] = fTemp34 + 0.5 * fRec106[1];
		fRec106[0] = fVec48[(IOTA0 - 579) & 1023];
		double fRec107 = fRec106[1] - fTemp34;
		fVec49[IOTA0 & 511] = fRec107 + 0.5 * fRec104[1];
		fRec104[0] = fVec49[(IOTA0 - 464) & 511];
		double fRec105 = fRec104[1] - fRec107;
		fVec50[IOTA0 & 511] = fRec105 + 0.5 * fRec102[1];
		fRec102[0] = fVec50[(IOTA0 - 364) & 511];
		double fRec103 = fRec102[1] - fRec105;
		fVec51[IOTA0 & 255] = fRec103 + 0.5 * fRec100[1];
		fRec100[0] = fVec51[(IOTA0 - 248) & 255];
		...
		double fElse9 = std::max<double>(fRec97[1], fTemp36);
		fRec97[0] = ((iTemp29) ? fElse9 : fTemp36);
		int iElse10 = iRec98[1] + 1;
		iRec98[0] = ((iTemp29) ? iElse10 : 1);
		...
		fVec52[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec142[0];
		fRec139[0] = fVec52[(IOTA0 - 1139) & 2047];
		fRec144[0] = fSlow92 * fRec144[1] + fSlow93 * fRec143[1];
		fVec53[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec144[0];
		fRec143[0] = fVec53[(IOTA0 - 1211) & 2047];
		fRec146[0] = fSlow92 * fRec146[1] + fSlow93 * fRec145[1];
		fVec54[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec146[0];
		fRec145[0] = fVec54[(IOTA0 - 1300) & 2047];
		fRec148[0] = fSlow92 * fRec148[1] + fSlow93 * fRec147[1];
		fVec55[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec148[0];
		fRec147[0] = fVec55[(IOTA0 - 1379) & 2047];
		fRec150[0] = fSlow92 * fRec150[1] + fSlow93 * fRec149[1];
		fVec56[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec150[0];
		fRec149[0] = fVec56[(IOTA0 - 1445) & 2047];
		fRec152[0] = fSlow92 * fRec152[1] + fSlow93 * fRec151[1];
		fVec57[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec152[0];
		fRec151[0] = fVec57[(IOTA0 - 1514) & 2047];
		fRec154[0] = fSlow92 * fRec154[1] + fSlow93 * fRec153[1];
		fVec58[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec154[0];
		fRec153[0] = fVec58[(IOTA0 - 1580) & 2047];
		fRec156[0] = fSlow92 * fRec156[1] + fSlow93 * fRec155[1];
		fVec59[IOTA0 & 2047] = fTemp39 + fSlow91 * fRec156[0];
		fRec155[0] = fVec59[(IOTA0 - 1640) & 2047];
		double fTemp40 = fRec139[0] + fRec143[0] + fRec145[0] + fRec147[0] + fRec149[0] + fRec151[0] + fRec153[0] + fRec155[0];
		fVec60[IOTA0 & 1023] = fTemp40 + 0.5 * fRec137[1];
		fRec137[0] = fVec60[(IOTA0 - 579) & 1023];
		double fRec138 = fRec137[1] - fTemp40;
		fVec61[IOTA0 & 511] = fRec138 + 0.5 * fRec135[1];
		fRec135[0] = fVec61[(IOTA0 - 464) & 511];
		double fRec136 = fRec135[1] - fRec138;
		fVec62[IOTA0 & 511] = fRec136 + 0.5 * fRec133[1];
		fRec133[0] = fVec62[(IOTA0 - 364) & 511];
		double fRec134 = fRec133[1] - fRec136;
		fVec63[IOTA0 & 255] = fRec134 + 0.5 * fRec131[1];
		fRec131[0] = fVec63[(IOTA0 - 248) & 255];
		...
		double fElse12 = std::max<double>(fRec128[1], fTemp42);
		fRec128[0] = ((iTemp37) ? fElse12 : fTemp42);
		int iElse13 = iRec129[1] + 1;
		iRec129[0] = ((iTemp37) ? iElse13 : 1);
