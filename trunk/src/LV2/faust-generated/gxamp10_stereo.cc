...
inline void Dsp::clear_state_f()
{
	...
	for (int l48 = 0; (l48 < 2); l48 = (l48 + 1)) fRec39[l48] = 0.0;
	for (int l49 = 0; (l49 < 2); l49 = (l49 + 1)) fRec38[l49] = 0.0;
	for (int l50 = 0; (l50 < 2); l50 = (l50 + 1)) fRec37[l50] = 0.0;
	for (int l51 = 0; (l51 < 2); l51 = (l51 + 1)) fRec40[l51] = 0.0;
	for (int l52 = 0; (l52 < 3); l52 = (l52 + 1)) fRec62[l52] = 0.0;
	...
	for (int l57 = 0; (l57 < 2); l57 = (l57 + 1)) fVec12[l57] = 0.0;
	...
	for (int l64 = 0; (l64 < 3); l64 = (l64 + 1)) fRec63[l64] = 0.0;
	for (int l65 = 0; (l65 < 2); l65 = (l65 + 1)) fRec70[l65] = 0.0;
	for (int l66 = 0; (l66 < 3); l66 = (l66 + 1)) fRec69[l66] = 0.0;
	for (int l67 = 0; (l67 < 2); l67 = (l67 + 1)) fVec13[l67] = 0.0;
	for (int l68 = 0; (l68 < 2); l68 = (l68 + 1)) fRec68[l68] = 0.0;
	for (int l69 = 0; (l69 < 3); l69 = (l69 + 1)) fRec67[l69] = 0.0;
	...
	for (int l73 = 0; (l73 < 2); l73 = (l73 + 1)) fRec55[l73] = 0.0;
	for (int l74 = 0; (l74 < 2); l74 = (l74 + 1)) fVec15[l74] = 0.0;
	for (int l75 = 0; (l75 < 2); l75 = (l75 + 1)) fRec54[l75] = 0.0;
	for (int l76 = 0; (l76 < 3); l76 = (l76 + 1)) fRec53[l76] = 0.0;
	for (int l77 = 0; (l77 < 2); l77 = (l77 + 1)) fVec16[l77] = 0.0;
	for (int l78 = 0; (l78 < 2); l78 = (l78 + 1)) fRec73[l78] = 0.0;
	for (int l79 = 0; (l79 < 2); l79 = (l79 + 1)) fRec52[l79] = 0.0;
	for (int l80 = 0; (l80 < 2); l80 = (l80 + 1)) fRec51[l80] = 0.0;
	...
	for (int l86 = 0; (l86 < 2); l86 = (l86 + 1)) fRec74[l86] = 0.0;
	...
	for (int l90 = 0; (l90 < 2); l90 = (l90 + 1)) fRec45[l90] = 0.0;
	for (int l91 = 0; (l91 < 2); l91 = (l91 + 1)) fRec44[l91] = 0.0;
	for (int l92 = 0; (l92 < 3); l92 = (l92 + 1)) fRec43[l92] = 0.0;
	for (int l93 = 0; (l93 < 2); l93 = (l93 + 1)) fVec20[l93] = 0.0;
	for (int l94 = 0; (l94 < 2); l94 = (l94 + 1)) fRec75[l94] = 0.0;
	for (int l95 = 0; (l95 < 2); l95 = (l95 + 1)) fRec42[l95] = 0.0;
	for (int l96 = 0; (l96 < 2); l96 = (l96 + 1)) fRec41[l96] = 0.0;
	for (int l97 = 0; (l97 < 2); l97 = (l97 + 1)) fVec21[l97] = 0.0;
	for (int l98 = 0; (l98 < 2); l98 = (l98 + 1)) fRec78[l98] = 0.0;
	for (int l99 = 0; (l99 < 2); l99 = (l99 + 1)) fRec77[l99] = 0.0;
	for (int l100 = 0; (l100 < 2); l100 = (l100 + 1)) fRec76[l100] = 0.0;
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = ((fTemp18 + fTemp17) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp19;
		fRec34[0] = (fConst63 * ((2700.0 * (fTemp19 + fVec5[1])) - (fConst64 * fRec34[1])));
		double fTemp20 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp17 + (fRec34[0] + fTemp18)) + -1.8639460000000001))));
		fRec12[0] = ((fTemp20 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp20))) + 100000.0))) + -130.0);
		fRec11[0] = (fConst2 * ((fConst3 * fRec11[1]) + (0.050000000000000003 * (fRec12[0] - fRec12[1]))));
		double fTemp21 = (fRec11[0] * fRec5[0]);
		fVec6[0] = fTemp21;
		fRec10[0] = (0.0 - (fConst5 * ((fConst6 * fRec10[1]) - (fTemp21 + fVec6[1]))));
		...
		double fTemp22 = (0.92544984225177063 * (fRec8[0] + fRec8[2]));
		double fTemp23 = (1.8508996845035413 * fRec8[1]);
		double fTemp24 = ((fTemp23 + fTemp22) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp24;
		fRec35[0] = (fConst66 * ((1500.0 * (fTemp24 + fVec7[1])) - (fConst67 * fRec35[1])));
		double fTemp25 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp22 + (fRec35[0] + fTemp23)) + -1.271609))));
		fRec7[0] = ((fTemp25 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp25))) + 100000.0))) + -130.0);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.050000000000000003 * (fRec7[0] - fRec7[1]))));
		double fTemp26 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp26;
		fRec4[0] = (0.0 - (fConst5 * ((fConst6 * fRec4[1]) - (fTemp26 + fVec8[1]))));
		...
		double fTemp30 = (fTemp29 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp30;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp30 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp31 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp27 + (fRec36[0] + fTemp28)) + -0.79903100000000005))));
		fRec1[0] = ((fTemp31 + (0.00097442804878048784 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp31))) + 100000.0))) + -130.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp32 = (fTemp29 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec38[1]))) + 100000.0));
		fVec10[0] = fTemp32;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp32 + fVec10[1])) - (fConst70 * fRec39[1])));
		double fTemp33 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp27 + (fRec39[0] + fTemp28)) + -0.79704299999999995))));
		fRec38[0] = ((fTemp33 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp33))) + 100000.0))) + -130.0);
		...
		double fTemp35 = (fTemp34 * fRec23[0]);
		fRec62[0] = (fTemp35 + (1.0000000000000001e-15 - (fConst22 * ((fConst27 * fRec62[2]) + (fConst28 * fRec62[1])))));
		double fTemp36 = (fRec62[2] + (fRec62[0] + (2.0 * fRec62[1])));
		fVec11[0] = fTemp36;
		fRec61[0] = ((fConst22 * ((fConst26 * fTemp36) + (fConst29 * fVec11[1]))) - (fConst30 * fRec61[1]));
		fRec60[0] = (0.0 - (fConst18 * ((fConst19 * fRec60[1]) - (fRec61[0] + fRec61[1]))));
		fRec59[0] = (fRec60[0] - (fConst14 * ((fConst31 * fRec59[2]) + (fConst34 * fRec59[1]))));
		double fTemp37 = (fRec59[2] + (fRec59[0] + (2.0 * fRec59[1])));
		fVec12[0] = fTemp37;
		fRec58[0] = ((fConst14 * ((fConst16 * fTemp37) + (fConst35 * fVec12[1]))) - (fConst37 * fRec58[1]));
		fRec57[0] = (fRec58[0] - (fConst9 * ((fConst38 * fRec57[2]) + (fConst39 * fRec57[1]))));
		double fTemp38 = (fConst49 * fRec56[1]);
		fRec56[0] = ((fConst9 * (((fConst11 * fRec57[0]) + (fConst40 * fRec57[1])) + (fConst11 * fRec57[2]))) - (fConst44 * ((fConst46 * fRec56[2]) + fTemp38)));
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec56[2] + (fConst44 * (fTemp38 + (fConst46 * fRec56[0])))))));
		fRec66[0] = ((fConst50 * fRec61[1]) - (fConst18 * ((fConst19 * fRec66[1]) - (fConst13 * fRec61[0]))));
		fRec65[0] = (fRec66[0] - (fConst14 * ((fConst31 * fRec65[2]) + (fConst34 * fRec65[1]))));
		double fTemp40 = (fConst39 * fRec64[1]);
		fRec64[0] = ((fConst14 * (((fConst33 * fRec65[0]) + (fConst51 * fRec65[1])) + (fConst33 * fRec65[2]))) - (fConst52 * ((fConst53 * fRec64[2]) + fTemp40)));
		double fTemp41 = (fConst49 * fRec63[1]);
		fRec63[0] = ((fRec64[2] + (fConst52 * (fTemp40 + (fConst53 * fRec64[0])))) - (fConst44 * ((fConst46 * fRec63[2]) + fTemp41)));
		double fTemp42 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec63[2] + (fConst44 * (fTemp41 + (fConst46 * fRec63[0])))))));
		fRec70[0] = (0.0 - (fConst56 * ((fConst36 * fRec70[1]) - (fConst14 * (fTemp37 + fVec12[1])))));
		fRec69[0] = (fRec70[0] - (fConst9 * ((fConst38 * fRec69[2]) + (fConst39 * fRec69[1]))));
		double fTemp43 = (fRec69[2] + (fRec69[0] + (2.0 * fRec69[1])));
		fVec13[0] = fTemp43;
		fRec68[0] = ((fConst9 * ((fConst55 * fTemp43) + (fConst57 * fVec13[1]))) - (fConst58 * fRec68[1]));
		fRec67[0] = (fRec68[0] - (fConst54 * ((fConst59 * fRec67[2]) + (fConst49 * fRec67[1]))));
		double fTemp44 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst48 * fRec67[0]) + (fConst60 * fRec67[1])) + (fConst48 * fRec67[2])))));
		fRec72[0] = (0.0 - (fConst61 * ((fConst45 * fRec72[1]) - (fConst9 * (fTemp43 + fVec13[1])))));
		fRec71[0] = (fRec72[0] - (fConst54 * ((fConst59 * fRec71[2]) + (fConst49 * fRec71[1]))));
		double fTemp45 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec71[2] + (fRec71[0] + (2.0 * fRec71[1]))))));
		double fTemp46 = (((1.333521432 * (fTemp39 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp39))))) + (1.584893192 * ((fTemp42 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp42)))) + (fTemp44 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp44))))))) + (1.2589412 * (fTemp45 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp45))))));
		fVec14[0] = fTemp46;
		fRec55[0] = (0.0 - (fConst5 * ((fConst6 * fRec55[1]) - (fTemp46 + fVec14[1]))));
		double fTemp47 = (fTemp34 * fTemp13);
		double fTemp48 = (fTemp47 + 1.0000000000000001e-15);
		double fTemp49 = (((fSlow3 * fRec55[0]) + ((fTemp47 + (fSlow9 * ((4.0 * (fTemp48 * (1.0 - std::fabs(fTemp48)))) + (-1.0000000000000001e-15 - fTemp47)))) + (fSlow10 * (fTemp35 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15);
		fVec15[0] = fTemp49;
		fRec54[0] = ((0.93028479253239138 * (fTemp49 + fVec15[1])) - (0.86056958506478287 * fRec54[1]));
		fRec53[0] = (fRec54[0] - ((1.8405051250752198 * fRec53[1]) + (0.86129424393186271 * fRec53[2])));
		double fTemp50 = (0.92544984225177063 * (fRec53[0] + fRec53[2]));
		double fTemp51 = (1.8508996845035413 * fRec53[1]);
		double fTemp52 = ((fTemp51 + fTemp50) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec52[1]))) + 100000.0));
		fVec16[0] = fTemp52;
		fRec73[0] = (fConst63 * ((2700.0 * (fTemp52 + fVec16[1])) - (fConst64 * fRec73[1])));
		double fTemp53 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp50 + (fRec73[0] + fTemp51)) + -1.8639460000000001))));
		fRec52[0] = ((fTemp53 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp53))) + 100000.0))) + -130.0);
		fRec51[0] = (fConst2 * ((fConst3 * fRec51[1]) + (0.050000000000000003 * (fRec52[0] - fRec52[1]))));
		double fTemp54 = (fRec5[0] * fRec51[0]);
		fVec17[0] = fTemp54;
		fRec50[0] = (0.0 - (fConst5 * ((fConst6 * fRec50[1]) - (fTemp54 + fVec17[1]))));
		...
		double fTemp55 = (0.92544984225177063 * (fRec48[0] + fRec48[2]));
		double fTemp56 = (1.8508996845035413 * fRec48[1]);
		double fTemp57 = ((fTemp56 + fTemp55) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec47[1]))) + 100000.0));
		fVec18[0] = fTemp57;
		fRec74[0] = (fConst66 * ((1500.0 * (fTemp57 + fVec18[1])) - (fConst67 * fRec74[1])));
		double fTemp58 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp55 + (fRec74[0] + fTemp56)) + -1.271609))));
		fRec47[0] = ((fTemp58 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp58))) + 100000.0))) + -130.0);
		fRec46[0] = (fConst2 * ((fConst3 * fRec46[1]) + (0.050000000000000003 * (fRec47[0] - fRec47[1]))));
		double fTemp59 = (fRec5[0] * fRec46[0]);
		fVec19[0] = fTemp59;
		fRec45[0] = (0.0 - (fConst5 * ((fConst6 * fRec45[1]) - (fTemp59 + fVec19[1]))));
		...
		double fTemp60 = (0.92544984225177063 * (fRec43[0] + fRec43[2]));
		double fTemp61 = (1.8508996845035413 * fRec43[1]);
		double fTemp62 = (fTemp61 + fTemp60);
		double fTemp63 = (fTemp62 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec42[1]))) + 100000.0));
		fVec20[0] = fTemp63;
		fRec75[0] = (fConst69 * ((820.0 * (fTemp63 + fVec20[1])) - (fConst70 * fRec75[1])));
		double fTemp64 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp60 + (fRec75[0] + fTemp61)) + -0.79903100000000005))));
		fRec42[0] = ((fTemp64 + (0.00097442804878048784 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp64))) + 100000.0))) + -130.0);
		fRec41[0] = (fConst2 * ((fConst3 * fRec41[1]) + (0.050000000000000003 * (fRec42[0] - fRec42[1]))));
		double fTemp65 = (fTemp62 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec77[1]))) + 100000.0));
		fVec21[0] = fTemp65;
		fRec78[0] = (fConst69 * ((820.0 * (fTemp65 + fVec21[1])) - (fConst70 * fRec78[1])));
		double fTemp66 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp60 + (fRec78[0] + fTemp61)) + -0.79704299999999995))));
		fRec77[0] = ((fTemp66 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp66))) + 100000.0))) + -130.0);
		fRec76[0] = (fConst2 * ((fConst3 * fRec76[1]) + (0.050000000000000003 * (fRec77[0] - fRec77[1]))));
