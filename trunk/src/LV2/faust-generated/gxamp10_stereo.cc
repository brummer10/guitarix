...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp17 + (fRec34[0] + fTemp18)) + -1.8639460000000001)))) + -60.964962962962957);
		...
		double fTemp23 = ((fTemp22 + fTemp21) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp23;
		fRec35[0] = (fConst66 * ((1500.0 * (fTemp23 + fVec7[1])) - (fConst67 * fRec35[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -1.271609)))) + -45.226066666666668);
		...
		double fTemp28 = (fTemp27 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp28;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec36[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp25 + (fRec36[0] + fTemp26)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp29 = (fTemp27 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec38[1]))) + 100000.0));
		fVec10[0] = fTemp29;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp29 + fVec10[1])) - (fConst70 * fRec39[1])));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp25 + (fRec39[0] + fTemp26)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec37[0] = (fConst2 * ((fConst3 * fRec37[1]) + (0.050000000000000003 * (fRec38[0] - fRec38[1]))));
		fRec40[0] = (fSlow11 + (0.999 * fRec40[1]));
		output0[i0] = FAUSTFLOAT(((fRec0[0] + fRec37[0]) * fRec40[0]));
		double fTemp30 = double(input1[i0]);
		double fTemp31 = (fTemp30 * fRec23[0]);
		fRec62[0] = (fTemp31 + (1.0000000000000001e-15 - (fConst22 * ((fConst27 * fRec62[2]) + (fConst28 * fRec62[1])))));
		double fTemp32 = (fRec62[2] + (fRec62[0] + (2.0 * fRec62[1])));
		fVec11[0] = fTemp32;
		fRec61[0] = ((fConst22 * ((fConst26 * fTemp32) + (fConst29 * fVec11[1]))) - (fConst30 * fRec61[1]));
		fRec60[0] = (0.0 - (fConst18 * ((fConst19 * fRec60[1]) - (fRec61[0] + fRec61[1]))));
		fRec59[0] = (fRec60[0] - (fConst14 * ((fConst31 * fRec59[2]) + (fConst34 * fRec59[1]))));
		double fTemp33 = (fRec59[2] + (fRec59[0] + (2.0 * fRec59[1])));
		fVec12[0] = fTemp33;
		fRec58[0] = ((fConst14 * ((fConst16 * fTemp33) + (fConst35 * fVec12[1]))) - (fConst37 * fRec58[1]));
		fRec57[0] = (fRec58[0] - (fConst9 * ((fConst38 * fRec57[2]) + (fConst39 * fRec57[1]))));
		double fTemp34 = (fConst49 * fRec56[1]);
		fRec56[0] = ((fConst9 * (((fConst11 * fRec57[0]) + (fConst40 * fRec57[1])) + (fConst11 * fRec57[2]))) - (fConst44 * ((fConst46 * fRec56[2]) + fTemp34)));
		double fTemp35 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec56[2] + (fConst44 * (fTemp34 + (fConst46 * fRec56[0])))))));
		...
		double fTemp36 = (fConst39 * fRec64[1]);
		fRec64[0] = ((fConst14 * (((fConst33 * fRec65[0]) + (fConst51 * fRec65[1])) + (fConst33 * fRec65[2]))) - (fConst52 * ((fConst53 * fRec64[2]) + fTemp36)));
		double fTemp37 = (fConst49 * fRec63[1]);
		fRec63[0] = ((fRec64[2] + (fConst52 * (fTemp36 + (fConst53 * fRec64[0])))) - (fConst44 * ((fConst46 * fRec63[2]) + fTemp37)));
		double fTemp38 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec63[2] + (fConst44 * (fTemp37 + (fConst46 * fRec63[0])))))));
		fRec70[0] = (0.0 - (fConst56 * ((fConst36 * fRec70[1]) - (fConst14 * (fTemp33 + fVec12[1])))));
		fRec69[0] = (fRec70[0] - (fConst9 * ((fConst38 * fRec69[2]) + (fConst39 * fRec69[1]))));
		double fTemp39 = (fRec69[2] + (fRec69[0] + (2.0 * fRec69[1])));
		fVec13[0] = fTemp39;
		fRec68[0] = ((fConst9 * ((fConst55 * fTemp39) + (fConst57 * fVec13[1]))) - (fConst58 * fRec68[1]));
		fRec67[0] = (fRec68[0] - (fConst54 * ((fConst59 * fRec67[2]) + (fConst49 * fRec67[1]))));
		double fTemp40 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst48 * fRec67[0]) + (fConst60 * fRec67[1])) + (fConst48 * fRec67[2])))));
		fRec72[0] = (0.0 - (fConst61 * ((fConst45 * fRec72[1]) - (fConst9 * (fTemp39 + fVec13[1])))));
		fRec71[0] = (fRec72[0] - (fConst54 * ((fConst59 * fRec71[2]) + (fConst49 * fRec71[1]))));
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec71[2] + (fRec71[0] + (2.0 * fRec71[1]))))));
		double fTemp42 = (((1.333521432 * (fTemp35 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp35))))) + (1.584893192 * ((fTemp38 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp38)))) + (fTemp40 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp40))))))) + (1.2589412 * (fTemp41 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp41))))));
		fVec14[0] = fTemp42;
		fRec55[0] = (0.0 - (fConst5 * ((fConst6 * fRec55[1]) - (fTemp42 + fVec14[1]))));
		double fTemp43 = (fTemp30 * fTemp13);
		double fTemp44 = (fTemp43 + 1.0000000000000001e-15);
		double fTemp45 = (((fSlow3 * fRec55[0]) + ((fTemp43 + (fSlow9 * ((4.0 * (fTemp44 * (1.0 - std::fabs(fTemp44)))) + (-1.0000000000000001e-15 - fTemp43)))) + (fSlow10 * (fTemp31 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15);
		fVec15[0] = fTemp45;
		fRec54[0] = ((0.93028479253239138 * (fTemp45 + fVec15[1])) - (0.86056958506478287 * fRec54[1]));
		fRec53[0] = (fRec54[0] - ((1.8405051250752198 * fRec53[1]) + (0.86129424393186271 * fRec53[2])));
		double fTemp46 = (0.92544984225177063 * (fRec53[0] + fRec53[2]));
		double fTemp47 = (1.8508996845035413 * fRec53[1]);
		double fTemp48 = ((fTemp47 + fTemp46) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec52[1]))) + 100000.0));
		fVec16[0] = fTemp48;
		fRec73[0] = (fConst63 * ((2700.0 * (fTemp48 + fVec16[1])) - (fConst64 * fRec73[1])));
		fRec52[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp46 + (fRec73[0] + fTemp47)) + -1.8639460000000001)))) + -60.964962962962957);
		fRec51[0] = (fConst2 * ((fConst3 * fRec51[1]) + (0.050000000000000003 * (fRec52[0] - fRec52[1]))));
		double fTemp49 = (fRec5[0] * fRec51[0]);
		fVec17[0] = fTemp49;
		fRec50[0] = (0.0 - (fConst5 * ((fConst6 * fRec50[1]) - (fTemp49 + fVec17[1]))));
		...
		double fTemp50 = (0.92544984225177063 * (fRec48[0] + fRec48[2]));
		double fTemp51 = (1.8508996845035413 * fRec48[1]);
		double fTemp52 = ((fTemp51 + fTemp50) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec47[1]))) + 100000.0));
		fVec18[0] = fTemp52;
		fRec74[0] = (fConst66 * ((1500.0 * (fTemp52 + fVec18[1])) - (fConst67 * fRec74[1])));
		fRec47[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp50 + (fRec74[0] + fTemp51)) + -1.271609)))) + -45.226066666666668);
		fRec46[0] = (fConst2 * ((fConst3 * fRec46[1]) + (0.050000000000000003 * (fRec47[0] - fRec47[1]))));
		double fTemp53 = (fRec5[0] * fRec46[0]);
		fVec19[0] = fTemp53;
		fRec45[0] = (0.0 - (fConst5 * ((fConst6 * fRec45[1]) - (fTemp53 + fVec19[1]))));
		...
		double fTemp54 = (0.92544984225177063 * (fRec43[0] + fRec43[2]));
		double fTemp55 = (1.8508996845035413 * fRec43[1]);
		double fTemp56 = (fTemp55 + fTemp54);
		double fTemp57 = (fTemp56 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec42[1]))) + 100000.0));
		fVec20[0] = fTemp57;
		fRec75[0] = (fConst69 * ((820.0 * (fTemp57 + fVec20[1])) - (fConst70 * fRec75[1])));
		fRec42[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp54 + (fRec75[0] + fTemp55)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec41[0] = (fConst2 * ((fConst3 * fRec41[1]) + (0.050000000000000003 * (fRec42[0] - fRec42[1]))));
		double fTemp58 = (fTemp56 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec77[1]))) + 100000.0));
		fVec21[0] = fTemp58;
		fRec78[0] = (fConst69 * ((820.0 * (fTemp58 + fVec21[1])) - (fConst70 * fRec78[1])));
		fRec77[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp54 + (fRec78[0] + fTemp55)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec76[0] = (fConst2 * ((fConst3 * fRec76[1]) + (0.050000000000000003 * (fRec77[0] - fRec77[1]))));
		output1[i0] = FAUSTFLOAT((fRec40[0] * (fRec41[0] + fRec76[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
