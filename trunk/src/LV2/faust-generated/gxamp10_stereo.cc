...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec10[0] = 0.05 * (fConst31 * fRec11[0] + fConst32 * fRec11[1]) - fConst4 * fRec10[1];
		fRec34[0] = fConst64 * (fConst63 * fRec34[1] + 0.05 * (fRec11[0] - fRec11[1]));
		...
		double fTemp23 = (fTemp21 + fTemp22) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp23;
		fRec36[0] = fConst67 * (1.5e+03 * (fTemp23 + fVec7[1]) - fConst66 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp22 + fRec36[0] + fTemp21 + -1.271609) + -45.22606666666667;
		fRec5[0] = 0.05 * (fConst31 * fRec6[0] + fConst32 * fRec6[1]) - fConst4 * fRec5[1];
		fRec37[0] = fConst64 * (fConst63 * fRec37[1] + 0.05 * (fRec6[0] - fRec6[1]));
		...
		fVec9[0] = fTemp28;
		fRec38[0] = fConst70 * (8.2e+02 * (fTemp28 + fVec9[1]) - fConst69 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp26 + fRec38[0] + fTemp25 + -0.799031) + -32.55719512195121;
		fRec0[0] = 0.05 * (fConst31 * fRec1[0] + fConst32 * fRec1[1]) - fConst4 * fRec0[1];
		fRec39[0] = fConst64 * (fConst63 * fRec39[1] + 0.05 * (fRec1[0] - fRec1[1]));
		double fTemp29 = fTemp27 / (Ranode(TUBE_TABLE_6DJ8_250k, fRec41[1]) + 1e+05);
		fVec10[0] = fTemp29;
		fRec42[0] = fConst70 * (8.2e+02 * (fTemp29 + fVec10[1]) - fConst69 * fRec42[1]);
		fRec41[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp26 + fRec42[0] + fTemp25 + -0.797043) + -32.799634146341475;
		fRec40[0] = 0.05 * (fConst31 * fRec41[0] + fConst32 * fRec41[1]) - fConst4 * fRec40[1];
		fRec43[0] = fConst64 * (fConst63 * fRec43[1] + 0.05 * (fRec41[0] - fRec41[1]));
		...
		double fTemp31 = fTemp30 * fRec14[0];
		double fTemp32 = fTemp30 * fTemp2;
		double fTemp33 = fTemp32 + 1e-15;
		fRec67[0] = fTemp31 + (1e-15 - fConst30 * (fConst29 * fRec67[2] + fConst27 * fRec67[1]));
		double fTemp34 = fRec67[2] + fRec67[0] + 2.0 * fRec67[1];
		fVec11[0] = fTemp34;
		fRec66[0] = fConst30 * (fConst31 * fTemp34 + fConst32 * fVec11[1]) - fConst4 * fRec66[1];
		fRec65[0] = 0.0 - fConst35 * (fConst33 * fRec65[1] - (fRec66[0] + fRec66[1]));
		fRec64[0] = fRec65[0] - fConst25 * (fConst24 * fRec64[2] + fConst22 * fRec64[1]);
		double fTemp35 = fRec64[2] + fRec64[0] + 2.0 * fRec64[1];
		fVec12[0] = fTemp35;
		fRec63[0] = 0.0 - fConst38 * (fConst36 * fRec63[1] - fConst25 * (fTemp35 + fVec12[1]));
		fRec62[0] = fRec63[0] - fConst18 * (fConst17 * fRec62[2] + fConst15 * fRec62[1]);
		double fTemp36 = fRec62[2] + fRec62[0] + 2.0 * fRec62[1];
		fVec13[0] = fTemp36;
		fRec61[0] = 0.0 - fConst41 * (fConst39 * fRec61[1] - fConst18 * (fTemp36 + fVec13[1]));
		fRec60[0] = fRec61[0] - fConst11 * (fConst10 * fRec60[2] + fConst8 * fRec60[1]);
		double fTemp37 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * (fRec60[2] + fRec60[0] + 2.0 * fRec60[1])));
		fRec69[0] = fConst18 * (fConst43 * fTemp36 + fConst44 * fVec13[1]) - fConst42 * fRec69[1];
		fRec68[0] = fRec69[0] - fConst11 * (fConst10 * fRec68[2] + fConst8 * fRec68[1]);
		double fTemp38 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fConst7 * fRec68[0] + fConst45 * fRec68[1] + fConst7 * fRec68[2])));
		double fTemp39 = fConst8 * fRec70[1];
		double fTemp40 = fConst15 * fRec71[1];
		fRec73[0] = fConst50 * fRec66[1] - fConst35 * (fConst33 * fRec73[1] - fConst23 * fRec66[0]);
		fRec72[0] = fRec73[0] - fConst25 * (fConst24 * fRec72[2] + fConst22 * fRec72[1]);
		fRec71[0] = fConst25 * (fConst21 * fRec72[0] + fConst51 * fRec72[1] + fConst21 * fRec72[2]) - fConst49 * (fConst48 * fRec71[2] + fTemp40);
		fRec70[0] = fRec71[2] + fConst49 * (fTemp40 + fConst48 * fRec71[0]) - fConst47 * (fConst46 * fRec70[2] + fTemp39);
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec70[2] + fConst47 * (fTemp39 + fConst46 * fRec70[0]))));
		double fTemp42 = fConst8 * fRec74[1];
		fRec76[0] = fConst25 * (fConst53 * fTemp35 + fConst54 * fVec12[1]) - fConst52 * fRec76[1];
		fRec75[0] = fRec76[0] - fConst18 * (fConst17 * fRec75[2] + fConst15 * fRec75[1]);
		fRec74[0] = fConst18 * (fConst14 * fRec75[0] + fConst55 * fRec75[1] + fConst14 * fRec75[2]) - fConst47 * (fConst46 * fRec74[2] + fTemp42);
		double fTemp43 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec74[2] + fConst47 * (fTemp42 + fConst46 * fRec74[0]))));
		...
		fVec14[0] = fTemp44;
		fRec59[0] = 0.0 - fConst58 * (fConst57 * fRec59[1] - (fTemp44 + fVec14[1]));
		double fTemp45 = fSlow11 * fRec59[0] + fTemp32 + fSlow6 * (4.0 * fTemp33 * (1.0 - std::fabs(fTemp33)) + (-1e-15 - fTemp32)) + fSlow5 * (fTemp31 + 1e-15) + 1e-15;
		fVec15[0] = fTemp45;
		fRec58[0] = 0.9302847925323914 * (fTemp45 + fVec15[1]) - 0.8605695850647829 * fRec58[1];
		fRec57[0] = fRec58[0] - (1.8405051250752198 * fRec57[1] + 0.8612942439318627 * fRec57[2]);
		double fTemp46 = 1.8508996845035413 * fRec57[1];
		double fTemp47 = 0.9254498422517706 * (fRec57[0] + fRec57[2]);
		double fTemp48 = (fTemp46 + fTemp47) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec56[1]) + 1e+05);
		fVec16[0] = fTemp48;
		fRec77[0] = fConst61 * (2.7e+03 * (fTemp48 + fVec16[1]) - fConst60 * fRec77[1]);
		fRec56[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp47 + fRec77[0] + fTemp46 + -1.863946) + -60.96496296296296;
		fRec55[0] = 0.05 * (fConst31 * fRec56[0] + fConst32 * fRec56[1]) - fConst4 * fRec55[1];
		fRec78[0] = fConst64 * (fConst63 * fRec78[1] + 0.05 * (fRec56[0] - fRec56[1]));
		double fTemp49 = fRec35[0] * ((iSlow1) ? fRec78[0] : fRec55[0]);
		fVec17[0] = fTemp49;
		fRec54[0] = 0.0 - fConst58 * (fConst57 * fRec54[1] - (fTemp49 + fVec17[1]));
		...
		double fTemp50 = 1.8508996845035413 * fRec52[1];
		double fTemp51 = 0.9254498422517706 * (fRec52[0] + fRec52[2]);
		double fTemp52 = (fTemp50 + fTemp51) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec51[1]) + 1e+05);
		fVec18[0] = fTemp52;
		fRec79[0] = fConst67 * (1.5e+03 * (fTemp52 + fVec18[1]) - fConst66 * fRec79[1]);
		fRec51[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp51 + fRec79[0] + fTemp50 + -1.271609) + -45.22606666666667;
		fRec50[0] = 0.05 * (fConst31 * fRec51[0] + fConst32 * fRec51[1]) - fConst4 * fRec50[1];
		fRec80[0] = fConst64 * (fConst63 * fRec80[1] + 0.05 * (fRec51[0] - fRec51[1]));
		double fTemp53 = fRec35[0] * ((iSlow1) ? fRec80[0] : fRec50[0]);
		fVec19[0] = fTemp53;
		fRec49[0] = 0.0 - fConst58 * (fConst57 * fRec49[1] - (fTemp53 + fVec19[1]));
		...
		double fTemp54 = 1.8508996845035413 * fRec47[1];
		double fTemp55 = 0.9254498422517706 * (fRec47[0] + fRec47[2]);
		double fTemp56 = fTemp54 + fTemp55;
		double fTemp57 = fTemp56 / (Ranode(TUBE_TABLE_6DJ8_68k, fRec46[1]) + 1e+05);
		fVec20[0] = fTemp57;
		fRec81[0] = fConst70 * (8.2e+02 * (fTemp57 + fVec20[1]) - fConst69 * fRec81[1]);
		fRec46[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp55 + fRec81[0] + fTemp54 + -0.799031) + -32.55719512195121;
		fRec45[0] = 0.05 * (fConst31 * fRec46[0] + fConst32 * fRec46[1]) - fConst4 * fRec45[1];
		fRec82[0] = fConst64 * (fConst63 * fRec82[1] + 0.05 * (fRec46[0] - fRec46[1]));
		double fTemp58 = fTemp56 / (Ranode(TUBE_TABLE_6DJ8_250k, fRec84[1]) + 1e+05);
		fVec21[0] = fTemp58;
		fRec85[0] = fConst70 * (8.2e+02 * (fTemp58 + fVec21[1]) - fConst69 * fRec85[1]);
		fRec84[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp55 + fRec85[0] + fTemp54 + -0.797043) + -32.799634146341475;
		fRec83[0] = 0.05 * (fConst31 * fRec84[0] + fConst32 * fRec84[1]) - fConst4 * fRec83[1];
		fRec86[0] = fConst64 * (fConst63 * fRec86[1] + 0.05 * (fRec84[0] - fRec84[1]));
