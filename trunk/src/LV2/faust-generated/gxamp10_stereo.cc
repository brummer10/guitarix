...
inline void Dsp::clear_state_f()
{
	...
	for (int l56 = 0; (l56 < 3); l56 = (l56 + 1)) fRec66[l56] = 0.0;
	...
	for (int l64 = 0; (l64 < 3); l64 = (l64 + 1)) fRec60[l64] = 0.0;
	...
	for (int l69 = 0; (l69 < 2); l69 = (l69 + 1)) fRec74[l69] = 0.0;
	for (int l70 = 0; (l70 < 3); l70 = (l70 + 1)) fRec73[l70] = 0.0;
	...
	for (int l74 = 0; (l74 < 2); l74 = (l74 + 1)) fRec76[l74] = 0.0;
	for (int l75 = 0; (l75 < 3); l75 = (l75 + 1)) fRec75[l75] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec35[0] = (fConst63 * ((fConst64 * fRec35[1]) + (0.050000000000000003 * (fRec12[0] - fRec12[1]))));
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp21 + (fRec36[0] + fTemp22)) + -1.271609)))) + -45.226066666666668);
		fRec6[0] = ((0.050000000000000003 * ((fConst4 * fRec7[0]) + (fConst26 * fRec7[1]))) - (fConst27 * fRec6[1]));
		fRec37[0] = (fConst63 * ((fConst64 * fRec37[1]) + (0.050000000000000003 * (fRec7[0] - fRec7[1]))));
		...
		fVec9[0] = fTemp28;
		fRec38[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec38[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp25 + (fRec38[0] + fTemp26)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = ((0.050000000000000003 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec39[0] = (fConst63 * ((fConst64 * fRec39[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp29 = (fTemp27 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec41[1]))) + 100000.0));
		fVec10[0] = fTemp29;
		fRec42[0] = (fConst69 * ((820.0 * (fTemp29 + fVec10[1])) - (fConst70 * fRec42[1])));
		fRec41[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp25 + (fRec42[0] + fTemp26)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec40[0] = ((0.050000000000000003 * ((fConst4 * fRec41[0]) + (fConst26 * fRec41[1]))) - (fConst27 * fRec40[1]));
		fRec43[0] = (fConst63 * ((fConst64 * fRec43[1]) + (0.050000000000000003 * (fRec41[0] - fRec41[1]))));
		fRec44[0] = (fSlow13 + (0.999 * fRec44[1]));
		output0[i0] = FAUSTFLOAT((((iSlow0 ? fRec39[0] : fRec0[0]) + (iSlow0 ? fRec43[0] : fRec40[0])) * fRec44[0]));
		double fTemp30 = double(input1[i0]);
		double fTemp31 = (fTemp30 * fRec23[0]);
		fRec66[0] = (fTemp31 + (1.0000000000000001e-15 - (fConst23 * ((fConst24 * fRec66[2]) + (fConst25 * fRec66[1])))));
		double fTemp32 = (fRec66[2] + (fRec66[0] + (2.0 * fRec66[1])));
		fVec11[0] = fTemp32;
		fRec65[0] = ((fConst23 * ((fConst4 * fTemp32) + (fConst26 * fVec11[1]))) - (fConst27 * fRec65[1]));
		fRec64[0] = (0.0 - (fConst19 * ((fConst20 * fRec64[1]) - (fRec65[0] + fRec65[1]))));
		fRec63[0] = (fRec64[0] - (fConst15 * ((fConst28 * fRec63[2]) + (fConst31 * fRec63[1]))));
		double fTemp33 = (fRec63[2] + (fRec63[0] + (2.0 * fRec63[1])));
		fVec12[0] = fTemp33;
		fRec62[0] = ((fConst15 * ((fConst17 * fTemp33) + (fConst32 * fVec12[1]))) - (fConst34 * fRec62[1]));
		fRec61[0] = (fRec62[0] - (fConst10 * ((fConst35 * fRec61[2]) + (fConst36 * fRec61[1]))));
		double fTemp34 = (fConst46 * fRec60[1]);
		fRec60[0] = ((fConst10 * (((fConst12 * fRec61[0]) + (fConst37 * fRec61[1])) + (fConst12 * fRec61[2]))) - (fConst41 * ((fConst43 * fRec60[2]) + fTemp34)));
		double fTemp35 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec60[2] + (fConst41 * (fTemp34 + (fConst43 * fRec60[0])))))));
		fRec70[0] = ((fConst47 * fRec65[1]) - (fConst19 * ((fConst20 * fRec70[1]) - (fConst14 * fRec65[0]))));
		fRec69[0] = (fRec70[0] - (fConst15 * ((fConst28 * fRec69[2]) + (fConst31 * fRec69[1]))));
		double fTemp36 = (fConst36 * fRec68[1]);
		fRec68[0] = ((fConst15 * (((fConst30 * fRec69[0]) + (fConst48 * fRec69[1])) + (fConst30 * fRec69[2]))) - (fConst49 * ((fConst50 * fRec68[2]) + fTemp36)));
		double fTemp37 = (fConst46 * fRec67[1]);
		fRec67[0] = ((fRec68[2] + (fConst49 * (fTemp36 + (fConst50 * fRec68[0])))) - (fConst41 * ((fConst43 * fRec67[2]) + fTemp37)));
		double fTemp38 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec67[2] + (fConst41 * (fTemp37 + (fConst43 * fRec67[0])))))));
		fRec74[0] = (0.0 - (fConst53 * ((fConst33 * fRec74[1]) - (fConst15 * (fTemp33 + fVec12[1])))));
		fRec73[0] = (fRec74[0] - (fConst10 * ((fConst35 * fRec73[2]) + (fConst36 * fRec73[1]))));
		double fTemp39 = (fRec73[2] + (fRec73[0] + (2.0 * fRec73[1])));
		fVec13[0] = fTemp39;
		fRec72[0] = ((fConst10 * ((fConst52 * fTemp39) + (fConst54 * fVec13[1]))) - (fConst55 * fRec72[1]));
		fRec71[0] = (fRec72[0] - (fConst51 * ((fConst56 * fRec71[2]) + (fConst46 * fRec71[1]))));
		double fTemp40 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow9 * (((fConst45 * fRec71[0]) + (fConst57 * fRec71[1])) + (fConst45 * fRec71[2])))));
		fRec76[0] = (0.0 - (fConst58 * ((fConst42 * fRec76[1]) - (fConst10 * (fTemp39 + fVec13[1])))));
		fRec75[0] = (fRec76[0] - (fConst51 * ((fConst56 * fRec75[2]) + (fConst46 * fRec75[1]))));
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow10 * (fRec75[2] + (fRec75[0] + (2.0 * fRec75[1]))))));
		...
		fVec14[0] = fTemp42;
		fRec59[0] = (0.0 - (fConst6 * ((fConst7 * fRec59[1]) - (fTemp42 + fVec14[1]))));
		double fTemp43 = (fTemp30 * fTemp13);
		double fTemp44 = (fTemp43 + 1.0000000000000001e-15);
		double fTemp45 = (((fSlow5 * fRec59[0]) + ((fTemp43 + (fSlow11 * ((4.0 * (fTemp44 * (1.0 - std::fabs(fTemp44)))) + (-1.0000000000000001e-15 - fTemp43)))) + (fSlow12 * (fTemp31 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15);
		fVec15[0] = fTemp45;
		fRec58[0] = ((0.93028479253239138 * (fTemp45 + fVec15[1])) - (0.86056958506478287 * fRec58[1]));
		fRec57[0] = (fRec58[0] - ((1.8405051250752198 * fRec57[1]) + (0.86129424393186271 * fRec57[2])));
		double fTemp46 = (0.92544984225177063 * (fRec57[0] + fRec57[2]));
		double fTemp47 = (1.8508996845035413 * fRec57[1]);
		double fTemp48 = ((fTemp47 + fTemp46) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec56[1]))) + 100000.0));
		fVec16[0] = fTemp48;
		fRec77[0] = (fConst60 * ((2700.0 * (fTemp48 + fVec16[1])) - (fConst61 * fRec77[1])));
		fRec56[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp46 + (fRec77[0] + fTemp47)) + -1.8639460000000001)))) + -60.964962962962957);
		fRec55[0] = ((0.050000000000000003 * ((fConst4 * fRec56[0]) + (fConst26 * fRec56[1]))) - (fConst27 * fRec55[1]));
		fRec78[0] = (fConst63 * ((fConst64 * fRec78[1]) + (0.050000000000000003 * (fRec56[0] - fRec56[1]))));
		double fTemp49 = (fRec5[0] * (iSlow2 ? fRec78[0] : fRec55[0]));
		fVec17[0] = fTemp49;
		fRec54[0] = (0.0 - (fConst6 * ((fConst7 * fRec54[1]) - (fTemp49 + fVec17[1]))));
		fRec53[0] = ((0.93028479253239138 * (fRec54[0] + fRec54[1])) - (0.86056958506478287 * fRec53[1]));
		fRec52[0] = (fRec53[0] - ((1.8405051250752198 * fRec52[1]) + (0.86129424393186271 * fRec52[2])));
		double fTemp50 = (0.92544984225177063 * (fRec52[0] + fRec52[2]));
		double fTemp51 = (1.8508996845035413 * fRec52[1]);
		double fTemp52 = ((fTemp51 + fTemp50) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec51[1]))) + 100000.0));
		fVec18[0] = fTemp52;
		fRec79[0] = (fConst66 * ((1500.0 * (fTemp52 + fVec18[1])) - (fConst67 * fRec79[1])));
		fRec51[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp50 + (fRec79[0] + fTemp51)) + -1.271609)))) + -45.226066666666668);
		fRec50[0] = ((0.050000000000000003 * ((fConst4 * fRec51[0]) + (fConst26 * fRec51[1]))) - (fConst27 * fRec50[1]));
		fRec80[0] = (fConst63 * ((fConst64 * fRec80[1]) + (0.050000000000000003 * (fRec51[0] - fRec51[1]))));
		double fTemp53 = (fRec5[0] * (iSlow2 ? fRec80[0] : fRec50[0]));
		fVec19[0] = fTemp53;
		fRec49[0] = (0.0 - (fConst6 * ((fConst7 * fRec49[1]) - (fTemp53 + fVec19[1]))));
		fRec48[0] = ((0.93028479253239138 * (fRec49[0] + fRec49[1])) - (0.86056958506478287 * fRec48[1]));
		fRec47[0] = (fRec48[0] - ((1.8405051250752198 * fRec47[1]) + (0.86129424393186271 * fRec47[2])));
		double fTemp54 = (0.92544984225177063 * (fRec47[0] + fRec47[2]));
		double fTemp55 = (1.8508996845035413 * fRec47[1]);
		double fTemp56 = (fTemp55 + fTemp54);
		double fTemp57 = (fTemp56 / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec46[1]))) + 100000.0));
		fVec20[0] = fTemp57;
		fRec81[0] = (fConst69 * ((820.0 * (fTemp57 + fVec20[1])) - (fConst70 * fRec81[1])));
		fRec46[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp54 + (fRec81[0] + fTemp55)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec45[0] = ((0.050000000000000003 * ((fConst4 * fRec46[0]) + (fConst26 * fRec46[1]))) - (fConst27 * fRec45[1]));
		fRec82[0] = (fConst63 * ((fConst64 * fRec82[1]) + (0.050000000000000003 * (fRec46[0] - fRec46[1]))));
		double fTemp58 = (fTemp56 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec84[1]))) + 100000.0));
		fVec21[0] = fTemp58;
		fRec85[0] = (fConst69 * ((820.0 * (fTemp58 + fVec21[1])) - (fConst70 * fRec85[1])));
		fRec84[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp54 + (fRec85[0] + fTemp55)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec83[0] = ((0.050000000000000003 * ((fConst4 * fRec84[0]) + (fConst26 * fRec84[1]))) - (fConst27 * fRec83[1]));
		fRec86[0] = (fConst63 * ((fConst64 * fRec86[1]) + (0.050000000000000003 * (fRec84[0] - fRec84[1]))));
		output1[i0] = FAUSTFLOAT((fRec44[0] * ((iSlow0 ? fRec82[0] : fRec45[0]) + (iSlow0 ? fRec86[0] : fRec83[0]))));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
