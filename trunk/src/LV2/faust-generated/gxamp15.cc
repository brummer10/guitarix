...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp0 = ((double)input0[i] * fRec20[0]);
		fVec0[0] = (1e-15 + fTemp0);
		fRec19[0] = ((0.9302847925323914 * (1e-15 + (fTemp0 + fVec0[1]))) - (0.8605695850647829 * fRec19[1]));
		fRec18[0] = (fRec19[0] - ((1.8405051250752198 * fRec18[1]) + (0.8612942439318627 * fRec18[2])));
		double fTemp1 = (0.027 * fRec17[1]);
		fVec1[0] = (1e-15 + fTemp1);
		fRec21[0] = ((fConst4 * fRec21[1]) + (fConst3 * (1e-15 + (fTemp1 + fVec1[1]))));
		fRec17[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec21[0] + (0.9254498422517706 * (fRec18[0] + (fRec18[2] + (2.0 * fRec18[1]))))) - 2.617753)) - 153.04618518518518);
		...
		double fTemp2 = (0.015 * fRec12[1]);
		fVec3[0] = (1e-15 + fTemp2);
		fRec22[0] = ((fConst17 * fRec22[1]) + (fConst16 * (1e-15 + (fTemp2 + fVec3[1]))));
		fRec12[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec22[0] + (0.9254498422517706 * (fRec13[0] + (fRec13[2] + (2.0 * fRec13[1]))))) - 1.887332)) - 124.17786666666666);
		...
		double fTemp3 = (0.0082 * fRec8[1]);
		fVec5[0] = (1e-15 + fTemp3);
		fRec23[0] = ((fConst21 * fRec23[1]) + (fConst20 * (1e-15 + (fTemp3 + fVec5[1]))));
		fRec8[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec23[0] + (0.9254498422517706 * (fRec9[0] + (fRec9[2] + (2.0 * fRec9[1]))))) - 1.256962)) - 96.7119512195122);
		fRec7[0] = ((fConst9 * fRec7[1]) + (fConst8 * ((fConst5 * fRec8[0]) + (fConst6 * fRec8[1]))));
		double fTemp4 = (fRec7[0] * (1 - fRec6[0]));
		double fTemp5 = (1e-15 + (fRec6[0] * fRec7[0]));
		fRec32[0] = (fTemp5 - (fConst47 * ((fConst45 * fRec32[2]) + (fConst43 * fRec32[1]))));
		double fTemp6 = (fRec32[0] + (fRec32[2] + (2 * fRec32[1])));
		fVec6[0] = fTemp6;
		...
		fRec34[0] = ((fConst41 * ((fConst63 * fRec35[1]) + (fConst36 * (fRec35[2] + fRec35[0])))) - (fConst61 * ((fConst60 * fRec34[2]) + fTemp11)));
		fRec33[0] = ((fRec34[2] + (fConst61 * (fTemp11 + (fConst60 * fRec34[0])))) - (fConst59 * ((fConst58 * fRec33[2]) + fTemp10)));
		double fTemp12 = max((double)-1, min((double)1, (fSlow5 * (fRec33[2] + (fConst59 * (fTemp10 + (fConst58 * fRec33[0])))))));
		...
		double fTemp13 = max((double)-1, min((double)1, (fSlow6 * ((fConst65 * fRec37[1]) + (fConst25 * (fRec37[2] + fRec37[0]))))));
		double fTemp14 = (fConst26 * fRec39[1]);
		...
		fRec39[0] = ((fConst34 * ((fConst67 * fRec40[1]) + (fConst31 * (fRec40[2] + fRec40[0])))) - (fConst59 * ((fConst58 * fRec39[2]) + fTemp14)));
		double fTemp15 = max((double)-1, min((double)1, (fSlow7 * (fRec39[2] + (fConst59 * (fTemp14 + (fConst58 * fRec39[0])))))));
		double fTemp16 = ((1.584893192 * ((0.8413951417869425 * (fTemp15 * (1 - (0.3333333333333333 * faustpower<2>(fTemp15))))) + ((fTemp13 * (1 - (0.3333333333333333 * faustpower<2>(fTemp13)))) + (fTemp12 * (1 - (0.3333333333333333 * faustpower<2>(fTemp12))))))) + (1.2589412 * (fTemp9 * (1 - (0.3333333333333333 * faustpower<2>(fTemp9))))));
		fVec9[0] = fTemp16;
		fRec24[0] = ((fConst13 * fRec24[1]) + (fConst12 * (fVec9[0] + fVec9[1])));
		double fTemp17 = (1e-15 + fTemp4);
		double fTemp18 = ((fSlow11 * ((fTemp17 * (4 - (4 * fabs(fTemp17)))) - fTemp17)) + ((fSlow10 * fTemp5) + ((fSlow9 * fRec24[0]) + fTemp4)));
		fVec10[0] = (1e-15 + fTemp18);
		fRec5[0] = ((fConst13 * fRec5[1]) + (fConst12 * (1e-15 + (fTemp18 + fVec10[1]))));
		double fTemp19 = (fRec5[0] * fRec4[0]);
		fVec11[0] = (1e-15 + fTemp19);
		fRec3[0] = ((0.9302847925323914 * (1e-15 + (fTemp19 + fVec11[1]))) - (0.8605695850647829 * fRec3[1]));
		fRec2[0] = (fRec3[0] - ((1.8405051250752198 * fRec2[1]) + (0.8612942439318627 * fRec2[2])));
		double fTemp20 = (0.9254498422517706 * (fRec2[0] + (fRec2[2] + (2.0 * fRec2[1]))));
		double fTemp21 = (0.0082 * fRec1[1]);
		fVec12[0] = (1e-15 + fTemp21);
		fRec42[0] = ((fConst13 * fRec42[1]) + (fConst12 * (1e-15 + (fTemp21 + fVec12[1]))));
		fRec1[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec42[0] + fTemp20) - 1.13074)) - 112.10487804878048);
		fRec0[0] = ((fConst9 * fRec0[1]) + (fConst8 * ((fConst5 * fRec1[0]) + (fConst6 * fRec1[1]))));
		double fTemp22 = (0.0082 * fRec44[1]);
		fVec13[0] = (1e-15 + fTemp22);
		fRec45[0] = ((fConst13 * fRec45[1]) + (fConst12 * (1e-15 + (fTemp22 + fVec13[1]))));
		fRec44[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec45[0] + fTemp20) - 1.130462)) - 112.13878048780487);
