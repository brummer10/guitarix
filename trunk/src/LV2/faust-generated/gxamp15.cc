...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp25 = (fRec13[0] * (1.0 - fRec30[0]));
		double fTemp26 = (fTemp25 + 1.0000000000000001e-15);
		double fTemp27 = (((fSlow2 * fRec5[0]) + ((fTemp25 + (fSlow9 * ((4.0 * (fTemp26 * (1.0 - std::fabs(fTemp26)))) + (-1.0000000000000001e-15 - fTemp25)))) + (fSlow10 * (fTemp13 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15);
		fVec8[0] = fTemp27;
		fRec4[0] = (0.0 - (fConst5 * ((fConst6 * fRec4[1]) - (fTemp27 + fVec8[1]))));
		fRec41[0] = (fSlow11 + (0.999 * fRec41[1]));
		double fTemp28 = (fRec4[0] * fRec41[0]);
		fVec9[0] = fTemp28;
		fRec3[0] = ((0.93028479253239138 * (fTemp28 + fVec9[1])) - (0.86056958506478287 * fRec3[1]));
		...
		fVec10[0] = fTemp32;
		fRec42[0] = (fConst5 * ((820.0 * (fTemp32 + fVec10[1])) - (fConst6 * fRec42[1])));
		double fTemp33 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp29 + (fRec42[0] + fTemp30)) + -1.1304620000000001))));
		fRec1[0] = ((fTemp33 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp33))) + 100000.0))) + -250.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.025000000000000001 * (fRec1[0] - fRec1[1]))));
		double fTemp34 = (fTemp31 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec44[1]))) + 100000.0));
		fVec11[0] = fTemp34;
		fRec45[0] = (fConst5 * ((820.0 * (fTemp34 + fVec11[1])) - (fConst6 * fRec45[1])));
		double fTemp35 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp29 + (fRec45[0] + fTemp30)) + -1.1307400000000001))));
		fRec44[0] = ((fTemp35 + (0.0013789512195121953 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp35))) + 100000.0))) + -250.0);
