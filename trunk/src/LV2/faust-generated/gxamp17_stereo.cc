...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec36[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec37[0] + fRec9[1]) - 1.887331999999999)) - 124.17786666666666);
		fRec35[0] = ((fConst3 * fRec35[1]) + (fConst61 * ((fConst39 * fRec36[1]) + (fConst1 * fRec36[0]))));
		...
		fRec6[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec38[0] + fRec7[0]) - 1.887331999999999)) - 124.17786666666666);
		...
		fRec40[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec41[0] + fRec4[1]) - 1.2569619999999988)) - 96.7119512195122);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec42[0] + fRec3[0]) - 1.2569619999999988)) - 96.7119512195122);
		...
		double fTemp51 = max(-1, min(1, (fSlow4 * (fRec54[2] + (fConst12 * (fTemp34 + (fConst11 * fRec54[0])))))));
		...
		double fTemp53 = max(-1, min(1, (fSlow6 * (((fConst8 * fRec64[0]) + (fConst51 * fRec64[1])) + (fConst8 * fRec64[2])))));
		...
		double fTemp56 = max(-1, min(1, (fSlow7 * (fRec68[2] + (fConst12 * (fTemp54 + (fConst11 * fRec68[0])))))));
		fRec73[0] = ((fConst50 * (fVec14[0] + fVec14[1])) + (fConst48 * fRec73[1]));
		fRec72[0] = (fRec73[0] - (fConst46 * ((fConst45 * fRec72[2]) + (fConst9 * fRec72[1]))));
		double fTemp57 = max(-1, min(1, (fSlow8 * (fRec72[2] + (fRec72[0] + (2 * fRec72[1]))))));
		...
		fRec76[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec77[0] + fRec50[1]) - 1.887331999999999)) - 124.17786666666666);
		...
		fRec48[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec78[0] + fRec49[0]) - 1.887331999999999)) - 124.17786666666666);
		...
		fRec80[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec81[0] + fRec46[1]) - 1.2569619999999988)) - 96.7119512195122);
		...
		fRec44[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec82[0] + fRec45[0]) - 1.2569619999999988)) - 96.7119512195122);
