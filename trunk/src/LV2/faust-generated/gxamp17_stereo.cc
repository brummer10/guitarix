...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp12 * ((fTemp28 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp28 * fTemp12))))) - 0.024937655860349125)))) + fTemp27)) + ((fSlow10 * fRec17[0]) + (fRec16[0] + (0.5 * (fTemp14 * (1 - (0.3333333333333333 * faustpower<2>(fTemp14)))))))) - 2.617752999999999)) - 153.04618518518518);
		...
		fRec52[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp46 * (fTemp27 + (fTemp28 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp28 * fTemp46))))) - 0.024937655860349125)))))) + ((fSlow10 * fRec57[0]) + (fRec56[0] + (0.5 * (fTemp48 * (1 - (0.3333333333333333 * faustpower<2>(fTemp48)))))))) - 2.617752999999999)) - 153.04618518518518);
		...
		fRec75[0] = ((fConst37 * fRec75[1]) + (fConst61 * ((fConst34 * fRec76[1]) + (fConst33 * fRec76[0]))));
