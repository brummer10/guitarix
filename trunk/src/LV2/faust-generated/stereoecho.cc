...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		float fTemp2 = fRec0[(IOTA0 - (std::min<int>(131072, std::max<int>(0, iRec5[0])) + 1)) & 262143];
		fRec0[IOTA0 & 262143] = float(input0[i0]) + fSlow5 * (fTemp2 + fRec4[0] * (fRec0[(IOTA0 - (std::min<int>(131072, std::max<int>(0, iRec6[0])) + 1)) & 262143] - fTemp2)) * (1.0f - fTemp0);
		...
		float fTemp4 = fRec7[(IOTA0 - (std::min<int>(131072, std::max<int>(0, iRec10[0])) + 1)) & 262143];
		fRec7[IOTA0 & 262143] = float(input1[i0]) + fSlow7 * (fTemp4 + fRec9[0] * (fRec7[(IOTA0 - (std::min<int>(131072, std::max<int>(0, iRec11[0])) + 1)) & 262143] - fTemp4)) * (fTemp0 + 1.0f);
