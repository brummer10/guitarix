...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec24[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec25[0] + fRec25[2])) + (fRec27[0] + (1.8508996845035413 * fRec25[1]))) + -0.84070299999999998)))) + -147.47524390243905);
		...
		fRec33[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec34[0] + fRec34[2])) + (fRec36[0] + (1.8508996845035413 * fRec34[1]))) + -1.204285)))) + -169.71433333333334);
		...
		fRec37[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec38[0] + fRec38[2])) + (fRec41[0] + (1.8508996845035413 * fRec38[1]))) + -1.581656)))) + -191.42014814814814);
		...
		fRec28[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec29[0] + fRec29[2])) + (fRec42[0] + (1.8508996845035413 * fRec29[1]))) + -1.204285)))) + -169.71433333333334);
		...
		fRec20[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec21[0] + fRec21[2])) + (fRec43[0] + (1.8508996845035413 * fRec21[1]))) + -0.84070299999999998)))) + -147.47524390243905);
		fRec44[0] = (fSlow5 + (0.999 * fRec44[1]));
		double fTemp10 = (0.025000000000000001 * (fRec20[0] * fRec44[0]));
		...
		double fTemp32 = ((fSlow2 * fRec12[0]) + ((fTemp31 * ((fSlow9 * ((0.10000000000000001 * (1.0 - std::fabs((0.025000000000000001 * fTemp31)))) + -0.025000000000000001)) + 0.025000000000000001)) + (fSlow10 * fTemp19)));
		fVec15[0] = fTemp32;
