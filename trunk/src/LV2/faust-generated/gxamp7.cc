...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp24 = (fConst36 * fRec41[1]);
		fRec47[0] = ((0.024937655860349125 * fTemp23) - (fConst63 * ((fConst61 * fRec47[2]) + (fConst59 * fRec47[1]))));
		...
		fRec41[0] = ((fConst46 * (((fConst41 * fRec42[0]) + (fConst68 * fRec42[1])) + (fConst41 * fRec42[2]))) - (fConst39 * ((fConst38 * fRec41[2]) + fTemp24)));
		double fTemp27 = max((double)-1, min((double)1, (fSlow7 * (fRec41[2] + (fConst39 * (fTemp24 + (fConst38 * fRec41[0])))))));
		...
		double fTemp29 = max((double)-1, min((double)1, (fSlow8 * (((fConst35 * fRec48[0]) + (fConst75 * fRec48[1])) + (fConst35 * fRec48[2])))));
		...
		fRec52[0] = ((fRec53[2] + (fConst77 * (fTemp31 + (fConst76 * fRec53[0])))) - (fConst39 * ((fConst38 * fRec52[2]) + fTemp30)));
		double fTemp32 = max((double)-1, min((double)1, (fSlow9 * (fRec52[2] + (fConst39 * (fTemp30 + (fConst38 * fRec52[0])))))));
