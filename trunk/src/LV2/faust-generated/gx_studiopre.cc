...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst5 = 1.0 / ((fConst1 + 7.81664517527894e-09) * fConst0 + 2.68307231780644e-08);
	...
	fConst56 = 7.98748251116771e-24 * fConst0;
	fConst57 = fConst7 * (fConst0 * (2.75154408026486e-20 - fConst56) + -1.17096473699268e-19);
	fConst58 = 2.99785513823401e-22 * fConst0;
	fConst59 = fConst3 * (fConst0 * (fConst58 + -5.73269784908691e-19) + -7.31891791891218e-18);
	fConst60 = 8.46469177787849e-23 * fConst0;
	fConst61 = fConst3 * (fConst0 * (fConst0 * (3.77720639872226e-19 - fConst60) + -1.62857548261884e-17) + -1.83118953550983e-16);
	fConst62 = 3.17696091408035e-21 * fConst0;
	fConst63 = fConst0 * (fConst0 * (fConst0 * (fConst62 + -7.77799604390716e-18) + -6.02464692946613e-16) + 1.8433980870469e-14);
	fConst64 = 7.20266241709961e-22 * fConst0;
	fConst65 = fConst3 * (fConst0 * (1.8779602481101e-20 - fConst64) + 1.91826477713424e-19);
	fConst66 = 6.46292254899834e-22 * fConst0;
	fConst67 = fConst0 * (fConst0 * (fConst0 * (fConst66 + 1.90693980601459e-18) + 1.50232520281226e-16) + -4.60849521761724e-15);
	fConst68 = 5.35331274684644e-23 * fConst0;
	fConst69 = fConst7 * (2.28327872258084e-22 - fConst68);
	fConst70 = 7.49463784558502e-23 * fConst0;
	fConst71 = fConst3 * (fConst0 * (fConst70 + 1.42192566937971e-19) + 1.82351647640129e-18);
	fConst72 = 1.42633616270852e-24 * fConst0;
	fConst73 = fConst24 * (fConst72 + -1.09504183633979e-23);
	fConst74 = 1.99687062779193e-24 * fConst0;
	fConst75 = fConst7 * (fConst0 * (-6.81396696133963e-21 - fConst74) + 2.91281128466384e-20);
	fConst76 = 7.71154779846327e-24 * fConst0;
	fConst77 = fConst3 * (fConst0 * (fConst0 * (fConst76 + -1.69540313347742e-20) + -2.30032611736055e-20) + -1.1695046812109e-18);
	fConst78 = 2.89429155669983e-22 * fConst0;
	fConst79 = fConst0 * (fConst0 * (fConst0 * (3.53068929659391e-19 - fConst78) + -5.29245486955245e-19) + 1.8433980870469e-16);
	fConst80 = 1.91907672110931e-23 * fConst0;
	fConst81 = fConst7 * (fConst0 * (fConst80 + -1.51999272980726e-21) + 5.70819680645209e-21);
	fConst82 = 1.72198049774899e-23 * fConst0;
	fConst83 = fConst3 * (fConst0 * (fConst0 * (-9.02012542250564e-20 - fConst82) + 4.03664924154006e-18) + 4.55514105154877e-17);
	fConst84 = 8.26759555451817e-23 * fConst0;
	fConst85 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst84 + -2.85205152688842e-19) + 1.02988983768651e-17) + -1.30486302011578e-17) + 4.60849521761724e-15);
	fConst86 = 3.10298692727022e-21 * fConst0;
	fConst87 = fConst0 * (fConst0 * (fConst0 * (5.85227663541147e-18 - fConst86) + 4.52040346187673e-16) + -1.38254856528517e-14);
	fConst88 = fConst0 * (fConst0 * (fConst64 + -1.01914938263382e-18) + -7.84401701489674e-17) + 2.3978309714178e-15;
	fConst89 = fConst0 * (fConst0 * (-1.00931167420926e-18 - fConst66) + -8.09581504534201e-15) + 1.88251499873295e-12;
	fConst90 = fConst3 * (fConst0 * (fConst68 + -7.45798938006809e-20) + -9.51366134408682e-19);
	fConst91 = fConst0 * (fConst0 * (fConst0 * (-3.81003746381788e-20 - fConst70) + -5.94292545384613e-16) + 2.27939559550162e-14);
	fConst92 = fConst7 * (fConst0 * (3.5767908251347e-21 - fConst72) + -1.52089143936082e-20);
	fConst93 = fConst3 * (fConst0 * (fConst0 * (fConst74 + 1.82179039185982e-21) + -9.49297111470724e-18) + -1.21367136860993e-16);
	fConst94 = 2.75934712704441e-25 * fConst0;
	fConst95 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst94 + -3.12199525275548e-20) + 5.30246139994882e-17) + 1.0728203737318e-15) + -1.46188085151362e-14);
	fConst96 = 1.03563581534178e-23 * fConst0;
	fConst97 = fConst0 * (fConst0 * (fConst0 * (6.50953455217104e-19 - fConst96) + 3.31397583073083e-15) + -1.8977285636845e-13);
	fConst98 = fConst3 * (fConst0 * (fConst0 * (4.94969107575399e-20 - fConst80) + -2.11680921042765e-18) + -2.37841533602171e-17);
	fConst99 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst82 + 4.71517417813316e-20) + -1.29316168998563e-16) + -1.68649232502658e-14) + 5.69392631443596e-13);
	fConst100 = 1.97096223360315e-24 * fConst0;
	fConst101 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst100 + -3.09060187214354e-19) + 6.59092588471003e-16) + 9.2998714565051e-14) + -4.74569021150667e-12);
	fConst102 = 7.39739868101268e-23 * fConst0;
	fConst103 = fConst0 * (fConst0 * (fConst0 * (6.44090677084358e-18 - fConst102) + 4.05825720651041e-14) + -9.41572149153703e-12);
	fConst104 = 1.59749650223354e-23 * fConst0;
	fConst105 = fConst7 * (fConst0 * (fConst104 + -1.83436272017657e-20) + -2.34192947398536e-19);
	fConst106 = 1.998570092156e-22 * fConst0;
	fConst107 = fConst3 * (fConst0 * (-1.14653956981738e-18 - fConst106) + 1.46378358378244e-17);
	fConst108 = 1.6929383555757e-22 * fConst0;
	fConst109 = fConst3 * (fConst0 * (fConst0 * (fConst108 + -2.51813759914817e-19) + -3.25715096523769e-17) + 3.66237907101966e-16);
	fConst110 = 2.11797394272023e-21 * fConst0;
	fConst111 = fConst0 * (fConst0 * (fConst0 * (-1.55559920878143e-17 - fConst110) + 1.20492938589323e-15) + 1.22893205803126e-14);
	fConst112 = 4.80177494473307e-22 * fConst0;
	fConst113 = fConst3 * (fConst0 * (fConst112 + 3.75592049622019e-20) + -3.83652955426848e-19);
	fConst114 = 4.30861503266556e-22 * fConst0;
	fConst115 = fConst0 * (fConst0 * (fConst0 * (3.81387961202917e-18 - fConst114) + -3.00465040562453e-16) + -3.07233014507816e-15);
	fConst116 = 3.56887516456429e-23 * fConst0;
	fConst117 = fConst7 * (fConst116 + 4.56655744516168e-22);
	fConst118 = 4.99642523039001e-23 * fConst0;
	fConst119 = fConst3 * (fConst0 * (2.84385133875941e-19 - fConst118) + -3.64703295280259e-18);
	fConst120 = 2.85267232541704e-24 * fConst0;
	fConst121 = fConst24 * (7.30027890893193e-24 - fConst120);
	fConst122 = 3.99374125558385e-24 * fConst0;
	fConst123 = fConst7 * (fConst0 * (fConst122 + 4.54264464089309e-21) + 5.82562256932768e-20);
	fConst124 = 1.54230955969265e-23 * fConst0;
	fConst125 = fConst3 * (fConst0 * (fConst0 * (1.13026875565161e-20 - fConst124) + -4.60065223472111e-20) + 2.33900936242179e-18);
	fConst126 = 1.92952770446655e-22 * fConst0;
	fConst127 = fConst0 * (fConst0 * (fConst0 * (fConst126 + 7.06137859318782e-19) + 1.05849097391049e-18) + 1.22893205803126e-16);
	fConst128 = 3.83815344221861e-23 * fConst0;
	fConst129 = fConst7 * (fConst0 * (1.01332848653817e-21 - fConst128) + 1.14163936129042e-20);
	fConst130 = 3.44396099549798e-23 * fConst0;
	fConst131 = fConst3 * (fConst0 * (fConst0 * (fConst130 + 6.01341694833709e-20) + 8.07329848308013e-18) + -9.11028210309754e-17);
	fConst132 = 1.65351911090363e-22 * fConst0;
	fConst133 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.90136768459228e-19 - fConst132) + 2.05977967537302e-17) + 2.60972604023156e-17) + 3.07233014507816e-15);
	fConst134 = 2.06865795151348e-21 * fConst0;
	fConst135 = fConst0 * (fConst0 * (fConst0 * (fConst134 + 1.17045532708229e-17) + -9.04080692375347e-16) + -9.21699043523448e-15);
	fConst136 = fConst0 * (fConst0 * (-2.03829876526765e-18 - fConst112) + 1.56880340297935e-16) + 1.5985539809452e-15;
	fConst137 = fConst0 * (fConst0 * (fConst114 + -2.01862334841852e-18) + 1.6191630090684e-14) + 1.2550099991553e-12;
	fConst138 = fConst3 * (fConst0 * (-1.49159787601362e-19 - fConst116) + 1.90273226881736e-18);
	fConst139 = fConst0 * (fConst0 * (fConst0 * (fConst118 + -7.62007492763576e-20) + 1.18858509076923e-15) + 1.51959706366775e-14);
	fConst140 = fConst7 * (fConst0 * (fConst120 + -2.38452721675646e-21) + -3.04178287872164e-20);
	fConst141 = fConst3 * (fConst0 * (fConst0 * (-1.21452692790654e-21 - fConst122) + -1.89859422294145e-17) + 2.42734273721987e-16);
	fConst142 = 5.51869425408882e-25 * fConst0;
	fConst143 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (2.08133016850365e-20 - fConst142) + 1.06049227998976e-16) + -2.1456407474636e-15) + -9.74587234342413e-15);
	fConst144 = 6.90423876894517e-24 * fConst0;
	fConst145 = fConst0 * (fConst0 * (fConst0 * (fConst144 + 1.30190691043421e-18) + -6.62795166146167e-15) + -1.26515237578967e-13);
	fConst146 = fConst3 * (fConst0 * (fConst0 * (fConst128 + -3.29979405050266e-20) + -4.23361842085529e-18) + 4.75683067204341e-17);
	fConst147 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-3.14344945208878e-20 - fConst130) + -2.58632337997126e-16) + 3.37298465005315e-14) + 3.79595087629064e-13);
	fConst148 = 3.9419244672063e-24 * fConst0;
	fConst149 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (2.06040124809569e-19 - fConst148) + 1.31818517694201e-15) + -1.85997429130102e-13) + -3.16379347433778e-12);
	fConst150 = 4.93159912067512e-23 * fConst0;
	fConst151 = fConst0 * (fConst0 * (fConst0 * (fConst150 + 1.28818135416872e-17) + -8.11651441302083e-14) + -6.27714766102469e-12);
	fConst152 = fConst7 * (fConst0 * (-1.83436272017657e-20 - fConst104) + 2.34192947398536e-19);
	fConst153 = fConst3 * (fConst0 * (1.14653956981738e-18 - fConst106) + 1.46378358378244e-17);
	fConst154 = fConst3 * (fConst0 * (fConst0 * (-2.51813759914817e-19 - fConst108) + 3.25715096523769e-17) + 3.66237907101966e-16);
	fConst155 = fConst0 * (fConst0 * (fConst0 * (1.55559920878143e-17 - fConst110) + 1.20492938589323e-15) + -1.22893205803126e-14);
	fConst156 = fConst3 * (fConst0 * (fConst112 + -3.75592049622019e-20) + -3.83652955426848e-19);
	fConst157 = fConst0 * (fConst0 * (fConst0 * (-3.81387961202917e-18 - fConst114) + -3.00465040562453e-16) + 3.07233014507816e-15);
	fConst158 = fConst7 * (fConst116 + -4.56655744516168e-22);
	fConst159 = fConst3 * (fConst0 * (-2.84385133875941e-19 - fConst118) + -3.64703295280259e-18);
	fConst160 = fConst24 * (fConst120 + 7.30027890893193e-24);
	fConst161 = fConst7 * (fConst0 * (4.54264464089309e-21 - fConst122) + -5.82562256932768e-20);
	fConst162 = fConst3 * (fConst0 * (fConst0 * (fConst124 + 1.13026875565161e-20) + 4.60065223472111e-20) + 2.33900936242179e-18);
	fConst163 = fConst0 * (fConst0 * (fConst0 * (fConst126 + -7.06137859318782e-19) + 1.05849097391049e-18) + -1.22893205803126e-16);
	fConst164 = fConst7 * (fConst0 * (fConst128 + 1.01332848653817e-21) + -1.14163936129042e-20);
	fConst165 = fConst3 * (fConst0 * (fConst0 * (6.01341694833709e-20 - fConst130) + -8.07329848308013e-18) + -9.11028210309754e-17);
	fConst166 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst132 + 1.90136768459228e-19) + -2.05977967537302e-17) + 2.60972604023156e-17) + -3.07233014507816e-15);
	fConst167 = fConst0 * (fConst0 * (fConst0 * (fConst134 + -1.17045532708229e-17) + -9.04080692375347e-16) + 9.21699043523448e-15);
	fConst168 = fConst0 * (fConst0 * (2.03829876526765e-18 - fConst112) + 1.56880340297935e-16) + -1.5985539809452e-15;
	fConst169 = fConst0 * (fConst0 * (fConst114 + 2.01862334841852e-18) + 1.6191630090684e-14) + -1.2550099991553e-12;
	fConst170 = fConst3 * (fConst0 * (1.49159787601362e-19 - fConst116) + 1.90273226881736e-18);
	fConst171 = fConst0 * (fConst0 * (fConst0 * (fConst118 + 7.62007492763576e-20) + 1.18858509076923e-15) + -1.51959706366775e-14);
	fConst172 = fConst7 * (fConst0 * (-2.38452721675646e-21 - fConst120) + 3.04178287872164e-20);
	fConst173 = fConst3 * (fConst0 * (fConst0 * (fConst122 + -1.21452692790654e-21) + 1.89859422294145e-17) + 2.42734273721987e-16);
	fConst174 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst142 + 2.08133016850365e-20) + -1.06049227998976e-16) + -2.1456407474636e-15) + 9.74587234342413e-15);
	fConst175 = fConst0 * (fConst0 * (fConst0 * (fConst144 + -1.30190691043421e-18) + -6.62795166146167e-15) + 1.26515237578967e-13);
	fConst176 = fConst3 * (fConst0 * (fConst0 * (-3.29979405050266e-20 - fConst128) + 4.23361842085529e-18) + 4.75683067204341e-17);
	fConst177 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst130 + -3.14344945208878e-20) + 2.58632337997126e-16) + 3.37298465005315e-14) + -3.79595087629064e-13);
	fConst178 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst148 + 2.06040124809569e-19) + -1.31818517694201e-15) + -1.85997429130102e-13) + 3.16379347433778e-12);
	fConst179 = fConst0 * (fConst0 * (fConst0 * (fConst150 + -1.28818135416872e-17) + -8.11651441302083e-14) + 6.27714766102469e-12);
	fConst180 = fConst7 * (fConst0 * (fConst56 + 2.75154408026486e-20) + 1.17096473699268e-19);
	fConst181 = fConst3 * (fConst0 * (fConst58 + 5.73269784908691e-19) + -7.31891791891218e-18);
	fConst182 = fConst3 * (fConst0 * (fConst0 * (fConst60 + 3.77720639872226e-19) + 1.62857548261884e-17) + -1.83118953550983e-16);
	fConst183 = fConst0 * (fConst0 * (fConst0 * (fConst62 + 7.77799604390716e-18) + -6.02464692946613e-16) + -1.8433980870469e-14);
	fConst184 = fConst3 * (fConst0 * (-1.8779602481101e-20 - fConst64) + 1.91826477713424e-19);
	fConst185 = fConst0 * (fConst0 * (fConst0 * (fConst66 + -1.90693980601459e-18) + 1.50232520281226e-16) + 4.60849521761724e-15);
	fConst186 = fConst7 * (-2.28327872258084e-22 - fConst68);
	fConst187 = fConst3 * (fConst0 * (fConst70 + -1.42192566937971e-19) + 1.82351647640129e-18);
	fConst188 = fConst24 * (-1.09504183633979e-23 - fConst72);
	fConst189 = fConst7 * (fConst0 * (fConst74 + -6.81396696133963e-21) + -2.91281128466384e-20);
	fConst190 = fConst3 * (fConst0 * (fConst0 * (-1.69540313347742e-20 - fConst76) + 2.30032611736055e-20) + -1.1695046812109e-18);
	fConst191 = fConst0 * (fConst0 * (fConst0 * (-3.53068929659391e-19 - fConst78) + -5.29245486955245e-19) + -1.8433980870469e-16);
	fConst192 = fConst7 * (fConst0 * (-1.51999272980726e-21 - fConst80) + -5.70819680645209e-21);
	fConst193 = fConst3 * (fConst0 * (fConst0 * (fConst82 + -9.02012542250564e-20) + -4.03664924154006e-18) + 4.55514105154877e-17);
	fConst194 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-2.85205152688842e-19 - fConst84) + -1.02988983768651e-17) + -1.30486302011578e-17) + -4.60849521761724e-15);
	fConst195 = fConst0 * (fConst0 * (fConst0 * (-5.85227663541147e-18 - fConst86) + 4.52040346187673e-16) + 1.38254856528517e-14);
	fConst196 = fConst0 * (fConst0 * (fConst64 + 1.01914938263382e-18) + -7.84401701489674e-17) + -2.3978309714178e-15;
	fConst197 = fConst0 * (fConst0 * (1.00931167420926e-18 - fConst66) + -8.09581504534201e-15) + -1.88251499873295e-12;
	fConst198 = fConst3 * (fConst0 * (fConst68 + 7.45798938006809e-20) + -9.51366134408682e-19);
	fConst199 = fConst0 * (fConst0 * (fConst0 * (3.81003746381788e-20 - fConst70) + -5.94292545384613e-16) + -2.27939559550162e-14);
	fConst200 = fConst7 * (fConst0 * (fConst72 + 3.5767908251347e-21) + 1.52089143936082e-20);
	fConst201 = fConst3 * (fConst0 * (fConst0 * (1.82179039185982e-21 - fConst74) + 9.49297111470724e-18) + -1.21367136860993e-16);
	fConst202 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-3.12199525275548e-20 - fConst94) + -5.30246139994882e-17) + 1.0728203737318e-15) + 1.46188085151362e-14);
	fConst203 = fConst0 * (fConst0 * (fConst0 * (-6.50953455217104e-19 - fConst96) + 3.31397583073083e-15) + 1.8977285636845e-13);
	fConst204 = fConst3 * (fConst0 * (fConst0 * (fConst80 + 4.94969107575399e-20) + 2.11680921042765e-18) + -2.37841533602171e-17);
	fConst205 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (4.71517417813316e-20 - fConst82) + 1.29316168998563e-16) + -1.68649232502658e-14) + -5.69392631443596e-13);
	fConst206 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-3.09060187214354e-19 - fConst100) + -6.59092588471003e-16) + 9.2998714565051e-14) + 4.74569021150667e-12);
	fConst207 = fConst0 * (fConst0 * (fConst0 * (-6.44090677084358e-18 - fConst102) + 4.05825720651041e-14) + 9.41572149153703e-12);
	fConst208 = fConst7 * (fConst0 * (fConst6 + -9.17181360088287e-21) + 1.17096473699268e-19);
	fConst209 = fConst3 * (fConst0 * (5.73269784908691e-19 - fConst9) + -7.31891791891218e-18);
	fConst210 = fConst3 * (fConst0 * (fConst0 * (fConst11 + -1.25906879957409e-19) + 1.62857548261884e-17) + -1.83118953550983e-16);
	fConst211 = fConst0 * (fConst0 * (fConst0 * (7.77799604390716e-18 - fConst13) + -6.02464692946613e-16) + 6.14466029015632e-15);
	fConst212 = fConst3 * (fConst0 * (fConst15 + -1.8779602481101e-20) + 1.91826477713424e-19);
	fConst213 = fConst0 * (fConst0 * (fConst0 * (-1.90693980601459e-18 - fConst17) + 1.50232520281226e-16) + -1.53616507253908e-15);
	fConst214 = fConst7 * (fConst19 + -2.28327872258084e-22);
	fConst215 = fConst3 * (fConst0 * (-1.42192566937971e-19 - fConst21) + 1.82351647640129e-18);
	fConst216 = fConst24 * (3.65013945446597e-24 - fConst23);
	fConst217 = fConst7 * (fConst0 * (fConst26 + 2.27132232044654e-21) + -2.91281128466384e-20);
	fConst218 = fConst3 * (fConst0 * (fConst0 * (5.65134377825805e-21 - fConst28) + 2.30032611736055e-20) + -1.1695046812109e-18);
	fConst219 = fConst0 * (fConst0 * (fConst0 * (fConst30 + -3.53068929659391e-19) + -5.29245486955245e-19) + 6.14466029015632e-17);
	fConst220 = fConst7 * (fConst0 * (5.06664243269087e-22 - fConst32) + -5.70819680645209e-21);
	fConst221 = fConst3 * (fConst0 * (fConst0 * (fConst34 + 3.00670847416855e-20) + -4.03664924154006e-18) + 4.55514105154877e-17);
	fConst222 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (9.5068384229614e-20 - fConst36) + -1.02988983768651e-17) + -1.30486302011578e-17) + 1.53616507253908e-15);
	fConst223 = fConst0 * (fConst0 * (fConst0 * (fConst38 + -5.85227663541147e-18) + 4.52040346187673e-16) + -4.60849521761724e-15);
	fConst224 = fConst0 * (fConst0 * (1.01914938263382e-18 - fConst15) + -7.84401701489674e-17) + 7.99276990472601e-16;
	fConst225 = fConst0 * (fConst0 * (fConst17 + 1.00931167420926e-18) + -8.09581504534201e-15) + 6.27504999577649e-13;
	fConst226 = fConst3 * (fConst0 * (7.45798938006809e-20 - fConst19) + -9.51366134408682e-19);
	fConst227 = fConst0 * (fConst0 * (fConst0 * (fConst21 + 3.81003746381788e-20) + -5.94292545384613e-16) + 7.59798531833873e-15);
	fConst228 = fConst7 * (fConst0 * (fConst23 + -1.19226360837823e-21) + 1.52089143936082e-20);
	fConst229 = fConst3 * (fConst0 * (fConst0 * (-6.07263463953272e-22 - fConst26) + 9.49297111470724e-18) + -1.21367136860993e-16);
	fConst230 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.04066508425183e-20 - fConst46) + -5.30246139994882e-17) + 1.0728203737318e-15) + -4.87293617171206e-15);
	fConst231 = fConst0 * (fConst0 * (fConst0 * (fConst48 + -6.50953455217104e-19) + 3.31397583073083e-15) + -6.32576187894833e-14);
	fConst232 = fConst3 * (fConst0 * (fConst0 * (fConst32 + -1.64989702525133e-20) + 2.11680921042765e-18) + -2.37841533602171e-17);
	fConst233 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-1.57172472604439e-20 - fConst34) + 1.29316168998563e-16) + -1.68649232502658e-14) + 1.89797543814532e-13);
	fConst234 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.03020062404785e-19 - fConst52) + -6.59092588471003e-16) + 9.2998714565051e-14) + -1.58189673716889e-12);
	fConst235 = fConst0 * (fConst0 * (fConst0 * (fConst54 + -6.44090677084358e-18) + 4.05825720651041e-14) + -3.13857383051234e-12);
...
#define fVslider4 (*fVslider4_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp1 = fConst103 + fRec1[0] * (fConst101 + fRec4[0] * (fConst99 + fConst98 * fRec4[0]) + 3.20034390112309e-11) + fRec2[0] * (fConst97 + fRec1[0] * (fConst95 + fRec4[0] * (fConst93 + fConst92 * fRec4[0])) + fRec4[0] * (fConst91 + fConst90 * fRec4[0]) + 1.28013756044923e-12) + fRec4[0] * (fConst0 * (fConst89 + fConst88 * fRec4[0]) + -3.20034390112309e-11) + fRec3[0] * (fConst87 + fRec1[0] * (fConst85 + fRec4[0] * (fConst83 + fConst81 * fRec4[0])) + fRec2[0] * (fConst79 + fRec1[0] * (fConst77 + fRec4[0] * (fConst75 + fConst73 * fRec4[0])) + fRec4[0] * (fConst71 + fConst69 * fRec4[0])) + fRec4[0] * (fConst67 + fConst65 * fRec4[0]) + fRec3[0] * (fConst63 + fConst61 * fRec1[0] + fRec2[0] * (fConst59 + fConst57 * fRec1[0]))) + 1.60017195056154e-10;
		double fTemp2 = fConst151 + fRec1[0] * (fConst149 + fRec4[0] * (fConst147 + fConst146 * fRec4[0]) + 6.40068780224617e-11) + fRec2[0] * (fConst145 + fRec1[0] * (fConst143 + fRec4[0] * (fConst141 + fConst140 * fRec4[0])) + fRec4[0] * (fConst139 + fConst138 * fRec4[0]) + 2.56027512089847e-12) + fRec4[0] * (fConst0 * (fConst137 + fConst136 * fRec4[0]) + -6.40068780224617e-11) + fRec3[0] * (fConst135 + fRec1[0] * (fConst133 + fRec4[0] * (fConst131 + fConst129 * fRec4[0])) + fRec2[0] * (fConst127 + fRec1[0] * (fConst125 + fRec4[0] * (fConst123 + fConst121 * fRec4[0])) + fRec4[0] * (fConst119 + fConst117 * fRec4[0])) + fRec4[0] * (fConst115 + fConst113 * fRec4[0]) + fRec3[0] * (fConst111 + fConst109 * fRec1[0] + fRec2[0] * (fConst107 + fConst105 * fRec1[0]))) + 3.20034390112308e-10;
		double fTemp3 = fConst179 + fRec1[0] * (fConst178 + fRec4[0] * (fConst177 + fConst176 * fRec4[0]) + 6.40068780224617e-11) + fRec2[0] * (fConst175 + fRec1[0] * (fConst174 + fRec4[0] * (fConst173 + fConst172 * fRec4[0])) + fRec4[0] * (fConst171 + fConst170 * fRec4[0]) + 2.56027512089847e-12) + fRec4[0] * (fConst0 * (fConst169 + fConst168 * fRec4[0]) + -6.40068780224617e-11) + fRec3[0] * (fConst167 + fRec1[0] * (fConst166 + fRec4[0] * (fConst165 + fConst164 * fRec4[0])) + fRec2[0] * (fConst163 + fRec1[0] * (fConst162 + fRec4[0] * (fConst161 + fConst160 * fRec4[0])) + fRec4[0] * (fConst159 + fConst158 * fRec4[0])) + fRec4[0] * (fConst157 + fConst156 * fRec4[0]) + fRec3[0] * (fConst155 + fConst154 * fRec1[0] + fRec2[0] * (fConst153 + fConst152 * fRec1[0]))) + 3.20034390112308e-10;
		double fTemp4 = fConst207 + fRec1[0] * (fConst206 + fRec4[0] * (fConst205 + fConst204 * fRec4[0]) + 3.20034390112309e-11) + fRec2[0] * (fConst203 + fRec1[0] * (fConst202 + fRec4[0] * (fConst201 + fConst200 * fRec4[0])) + fRec4[0] * (fConst199 + fConst198 * fRec4[0]) + 1.28013756044923e-12) + fRec4[0] * (fConst0 * (fConst197 + fConst196 * fRec4[0]) + -3.20034390112309e-11) + fRec3[0] * (fConst195 + fRec1[0] * (fConst194 + fRec4[0] * (fConst193 + fConst192 * fRec4[0])) + fRec2[0] * (fConst191 + fRec1[0] * (fConst190 + fRec4[0] * (fConst189 + fConst188 * fRec4[0])) + fRec4[0] * (fConst187 + fConst186 * fRec4[0])) + fRec4[0] * (fConst185 + fConst184 * fRec4[0]) + fRec3[0] * (fConst183 + fConst182 * fRec1[0] + fRec2[0] * (fConst181 + fConst180 * fRec1[0]))) + 1.60017195056154e-10;
		double fTemp5 = fConst235 + fRec1[0] * (fConst234 + fRec4[0] * (fConst233 + fConst232 * fRec4[0]) + 6.40068780224617e-12) + fRec2[0] * (fConst231 + fRec1[0] * (fConst230 + fRec4[0] * (fConst229 + fConst228 * fRec4[0])) + fRec4[0] * (fConst227 + fConst226 * fRec4[0]) + 2.56027512089847e-13) + fRec4[0] * (fConst0 * (fConst225 + fConst224 * fRec4[0]) + -6.40068780224617e-12) + fRec3[0] * (fConst223 + fRec1[0] * (fConst222 + fRec4[0] * (fConst221 + fConst220 * fRec4[0])) + fRec2[0] * (fConst219 + fRec1[0] * (fConst218 + fRec4[0] * (fConst217 + fConst216 * fRec4[0])) + fRec4[0] * (fConst215 + fConst214 * fRec4[0])) + fRec4[0] * (fConst213 + fConst212 * fRec4[0]) + fRec3[0] * (fConst211 + fConst210 * fRec1[0] + fRec2[0] * (fConst209 + fConst208 * fRec1[0]))) + 3.20034390112309e-11;
		...
		fRec5[0] = fTemp10 - (fTemp5 * fRec5[5] + fTemp4 * fRec5[1] + fTemp3 * fRec5[2] + fTemp2 * fRec5[3] + fTemp1 * fRec5[4]) / fTemp0;
		...
		fRec17[0] = fTemp31 - (fTemp2 * fRec17[3] + fTemp4 * fRec17[1] + fTemp3 * fRec17[2] + fTemp1 * fRec17[4] + fTemp5 * fRec17[5]) / fTemp0;
		...
		fRec22[0] = fTemp36 - (fTemp4 * fRec22[1] + fTemp3 * fRec22[2] + fTemp2 * fRec22[3] + fTemp1 * fRec22[4] + fTemp5 * fRec22[5]) / fTemp0;
		...
		fRec26[0] = fTemp36 - (fTemp21 * fRec26[3] + fTemp23 * fRec26[1] + fTemp22 * fRec26[2] + fTemp19 * fRec26[4]) / fTemp18;
		...
		fRec28[0] = fTemp42 - (fTemp4 * fRec28[1] + fTemp3 * fRec28[2] + fTemp2 * fRec28[3] + fTemp1 * fRec28[4] + fTemp5 * fRec28[5]) / fTemp0;
		...
		fRec35[0] = fTemp49 - (fRec35[1] * fTemp4 + fRec35[2] * fTemp3 + fRec35[3] * fTemp2 + fRec35[4] * fTemp1 + fRec35[5] * fTemp5) / fTemp0;
