...
#define fVslider2 (*fVslider2_)
	...
	double fSlow1 = 0.00032604000000000004 * fSlow0;
	double fSlow2 = double(fVslider1);
	double fSlow3 = 1.0607618000000002e-05 * fSlow2;
	double fSlow4 = 0.00011284700000000001 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -1.9801382e-05 - fSlow3) + fSlow1 + 3.1187760000000004e-05);
	double fSlow6 = 8.100000000000003e-09 * fSlow0;
	double fSlow7 = 3.3665160000000007e-10 * fSlow2;
	double fSlow8 = 3.5814000000000013e-09 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -4.247484000000001e-10) + fSlow6 + 7.614000000000002e-10);
	double fSlow10 = 0.060025 * fSlow0;
	double fSlow11 = 0.00188 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.027267350000000003);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 7.614000000000002e-10 * fSlow18) + fSlow2 * (fSlow8 + 3.3665160000000007e-10 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (5.400000000000001e-07 * fSlow19 + fSlow2 * (1.0654618000000002e-05 - fSlow3) + fSlow0 * (0.00011284700000000001 * fSlow2 + 2.0400000000000004e-06) + 1.9176000000000002e-07);
	double fSlow23 = fConst0 * (fSlow10 + fSlow11 + 2.5e-05 * fSlow19 + 0.005642350000000001);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-1.9801382e-05 - fSlow3)) + 3.1187760000000004e-05) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-4.247484000000001e-10 - fSlow7)) + 7.614000000000002e-10)));
