...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec49[0] = (Ftube(TUBE_TABLE_6C16_68k, ((fRec70[0] + (0.9254498422517706 * (fRec50[0] + (fRec50[2] + (2.0 * fRec50[1]))))) - 2.921806)) - 141.78496296296294);
		...
		fRec44[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec71[0] + (0.9254498422517706 * (fRec45[0] + (fRec45[2] + (2.0 * fRec45[1]))))) - 2.097743)) - 110.15046666666666);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec72[0] + (0.9254498422517706 * (fRec40[0] + (fRec40[2] + (2.0 * fRec40[1]))))) - 1.378742)) - 81.86073170731709);
