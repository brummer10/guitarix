...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec0[0] = fTemp5;
		fRec18[0] = ((fConst42 * ((fConst41 * fVec0[1]) + (fConst1 * fVec0[0]))) + (fConst3 * fRec18[1]));
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * ((fTemp15 * (4 - (4 * fabs(fTemp15)))) - fTemp15)) + ((fSlow10 * fTemp4) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp2)))) - 2.921805999999998)) - 141.78496296296294);
		fRec8[0] = ((fConst59 * ((fConst41 * fRec9[1]) + (fConst1 * fRec9[0]))) + (fConst3 * fRec8[1]));
		double fTemp16 = (fRec8[0] * fRec7[0]);
		fVec4[0] = fTemp16;
		fRec6[0] = ((fConst58 * (fVec4[0] + fVec4[1])) + (fConst6 * fRec6[1]));
		fRec30[0] = ((fConst63 * (fRec5[1] + fRec5[2])) + (fConst62 * fRec30[1]));
		fRec5[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec30[0] + fRec6[0]) - 2.097742999999999)) - 110.15046666666666);
		fRec4[0] = ((fConst59 * ((fConst41 * fRec5[1]) + (fConst1 * fRec5[0]))) + (fConst3 * fRec4[1]));
		double fTemp17 = (fRec7[0] * fRec4[0]);
		fVec5[0] = fTemp17;
		fRec3[0] = ((fConst58 * (fVec5[0] + fVec5[1])) + (fConst6 * fRec3[1]));
		fRec31[0] = ((fConst67 * (fRec2[1] + fRec2[2])) + (fConst66 * fRec31[1]));
		fRec2[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec31[0] + fRec3[0]) - 1.3787419999999988)) - 81.86073170731709);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * ((fTemp32 * (4 - (4 * fabs(fTemp32)))) - fTemp32)) + ((fSlow10 * fTemp21) + ((fSlow9 * fRec41[0]) + (fRec40[0] + fTemp19)))) - 2.921805999999998)) - 141.78496296296294);
		fRec38[0] = ((fConst59 * ((fConst41 * fRec39[1]) + (fConst1 * fRec39[0]))) + (fConst3 * fRec38[1]));
		double fTemp33 = (fRec7[0] * fRec38[0]);
		fVec10[0] = fTemp33;
		fRec37[0] = ((fConst58 * (fVec10[0] + fVec10[1])) + (fConst6 * fRec37[1]));
		fRec59[0] = ((fConst63 * (fRec36[1] + fRec36[2])) + (fConst62 * fRec59[1]));
		fRec36[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec59[0] + fRec37[0]) - 2.097742999999999)) - 110.15046666666666);
		fRec35[0] = ((fConst59 * ((fConst41 * fRec36[1]) + (fConst1 * fRec36[0]))) + (fConst3 * fRec35[1]));
		double fTemp34 = (fRec7[0] * fRec35[0]);
		fVec11[0] = fTemp34;
		fRec34[0] = ((fConst58 * (fVec11[0] + fVec11[1])) + (fConst6 * fRec34[1]));
		fRec60[0] = ((fConst67 * (fRec33[1] + fRec33[2])) + (fConst66 * fRec60[1]));
		fRec33[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec60[0] + fRec34[0]) - 1.3787419999999988)) - 81.86073170731709);
