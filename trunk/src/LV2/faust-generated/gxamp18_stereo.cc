...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * fRec12[0]) + ((fSlow6 * fTemp5) + ((fSlow4 * ((fTemp4 * (4 - (4 * fabs(fTemp4)))) - fTemp4)) + (fRec11[0] + fTemp2)))) - 2.921805999999998)) - 141.78496296296294);
		...
		fRec52[0] = ((fConst41 * fRec52[1]) + (fConst40 * ((fConst47 * fVec11[1]) + (fConst14 * fVec11[0]))));
		...
		fRec39[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * fRec41[0]) + ((fSlow6 * fTemp25) + ((fSlow4 * ((fTemp24 * (4 - (4 * fabs(fTemp24)))) - fTemp24)) + (fRec40[0] + fTemp22)))) - 2.921805999999998)) - 141.78496296296294);
