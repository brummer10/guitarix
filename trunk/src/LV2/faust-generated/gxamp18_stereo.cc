...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp14 = max((double)-1, min((double)1, (fSlow10 * (((fConst50 * fRec33[1]) + (fConst2 * fRec33[0])) + (fConst2 * fRec33[2])))));
		...
		fRec49[0] = (Ftube(TUBE_TABLE_6C16_68k, ((fRec70[0] + (0.9254498422517706 * (fRec50[2] + (fRec50[0] + (2.0 * fRec50[1]))))) - 2.921806)) - 141.78496296296294);
		...
		fVec20[0] = fTemp43;
		fRec71[0] = ((fConst63 * fRec71[1]) + (fConst62 * (fVec20[0] + fVec20[1])));
		fRec44[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec71[0] + (0.9254498422517706 * (fRec45[2] + (fRec45[0] + (2.0 * fRec45[1]))))) - 2.097743)) - 110.15046666666666);
		...
		fVec23[0] = fTemp46;
		fRec72[0] = ((fConst67 * fRec72[1]) + (fConst66 * (fVec23[0] + fVec23[1])));
		fRec39[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec72[0] + (0.9254498422517706 * (fRec40[2] + (fRec40[0] + (2.0 * fRec40[1]))))) - 1.378742)) - 81.86073170731709);
