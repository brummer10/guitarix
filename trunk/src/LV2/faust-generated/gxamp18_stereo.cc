...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_6C16_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec33[0] = fConst55 * (2.7e+03 * (fTemp19 + fVec5[1]) - fConst54 * fRec33[1]);
		fRec11[0] = Ftube(TUBE_TABLE_6C16_68k, fTemp18 + fRec33[0] + fTemp17 + -2.921806) + -141.78496296296294;
		...
		double fTemp24 = (fTemp22 + fTemp23) / (Ranode(TUBE_TABLE_6C16_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp24;
		fRec36[0] = fConst62 * (1.5e+03 * (fTemp24 + fVec7[1]) - fConst61 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp23 + fRec36[0] + fTemp22 + -2.097743) + -110.15046666666666;
		...
		double fTemp29 = (fTemp27 + fTemp28) / (Ranode(TUBE_TABLE_6C16_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp29;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp29 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp28 + fRec38[0] + fTemp27 + -1.378742) + -81.86073170731709;
		...
		double fTemp49 = (fTemp47 + fTemp48) / (Ranode(TUBE_TABLE_6C16_68k, fRec52[1]) + 1e+05);
		fVec15[0] = fTemp49;
		fRec73[0] = fConst55 * (2.7e+03 * (fTemp49 + fVec15[1]) - fConst54 * fRec73[1]);
		fRec52[0] = Ftube(TUBE_TABLE_6C16_68k, fTemp48 + fRec73[0] + fTemp47 + -2.921806) + -141.78496296296294;
		...
		double fTemp54 = (fTemp52 + fTemp53) / (Ranode(TUBE_TABLE_6C16_250k, fRec47[1]) + 1e+05);
		fVec17[0] = fTemp54;
		fRec75[0] = fConst62 * (1.5e+03 * (fTemp54 + fVec17[1]) - fConst61 * fRec75[1]);
		fRec47[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp53 + fRec75[0] + fTemp52 + -2.097743) + -110.15046666666666;
		...
		double fTemp59 = (fTemp57 + fTemp58) / (Ranode(TUBE_TABLE_6C16_250k, fRec42[1]) + 1e+05);
		fVec19[0] = fTemp59;
		fRec77[0] = fConst65 * (8.2e+02 * (fTemp59 + fVec19[1]) - fConst64 * fRec77[1]);
		fRec42[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp58 + fRec77[0] + fTemp57 + -1.378742) + -81.86073170731709;
