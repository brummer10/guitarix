...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp27 = (fTemp25 + fTemp26) / (Ranode(TUBE_TABLE_6C16_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp27;
		fRec38[0] = fConst70 * (8.2e+02 * (fTemp27 + fVec9[1]) - fConst69 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp26 + fRec38[0] + fTemp25 + -1.378742) + -81.86073170731709;
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_6C16_68k, fRec52[1]) + 1e+05);
		fVec15[0] = fTemp46;
		fRec73[0] = fConst61 * (2.7e+03 * (fTemp46 + fVec15[1]) - fConst60 * fRec73[1]);
		fRec52[0] = Ftube(TUBE_TABLE_6C16_68k, fTemp45 + fRec73[0] + fTemp44 + -2.921806) + -141.78496296296294;
		...
		double fTemp50 = (fTemp48 + fTemp49) / (Ranode(TUBE_TABLE_6C16_250k, fRec47[1]) + 1e+05);
		fVec17[0] = fTemp50;
		fRec75[0] = fConst67 * (1.5e+03 * (fTemp50 + fVec17[1]) - fConst66 * fRec75[1]);
		fRec47[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp49 + fRec75[0] + fTemp48 + -2.097743) + -110.15046666666666;
		...
		double fTemp54 = (fTemp52 + fTemp53) / (Ranode(TUBE_TABLE_6C16_250k, fRec42[1]) + 1e+05);
		fVec19[0] = fTemp54;
		fRec77[0] = fConst70 * (8.2e+02 * (fTemp54 + fVec19[1]) - fConst69 * fRec77[1]);
		fRec42[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp53 + fRec77[0] + fTemp52 + -1.378742) + -81.86073170731709;
