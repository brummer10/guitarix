...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * ((fTemp16 * (4 - (4 * fabs(fTemp16)))) - fTemp16)) + ((fSlow10 * fTemp5) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp2)))) - 2.921805999999998)) - 141.78496296296294);
		...
		fVec7[0] = fTemp19;
		fRec3[0] = ((fConst6 * fRec3[1]) + (fConst58 * (fVec7[0] + fVec7[1])));
		...
		fRec39[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fSlow11 * ((fTemp36 * (4 - (4 * fabs(fTemp36)))) - fTemp36)) + ((fSlow10 * fTemp25) + ((fSlow9 * fRec41[0]) + (fRec40[0] + fTemp22)))) - 2.921805999999998)) - 141.78496296296294);
