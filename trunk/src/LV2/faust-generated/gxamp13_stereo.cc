...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec43[0] + (1.8508996845035413 * fRec19[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec45[0] + (1.8508996845035413 * fRec10[1]))) + -1.271609)))) + -45.226066666666668);
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec46[0] + (1.8508996845035413 * fRec1[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		fRec47[0] = (fSlow12 + (0.999 * fRec47[1]));
		output0[i] = FAUSTFLOAT((0.050000000000000003 * (fRec0[0] * fRec47[0])));
		...
		fRec53[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec54[0] + fRec54[2])) + (fRec56[0] + (1.8508996845035413 * fRec54[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		...
		fRec62[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec63[0] + fRec63[2])) + (fRec65[0] + (1.8508996845035413 * fRec63[1]))) + -1.271609)))) + -45.226066666666668);
		...
		fRec66[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec67[0] + fRec67[2])) + (fRec90[0] + (1.8508996845035413 * fRec67[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		fRec61[0] = ((0.029999999999999999 * fRec62[0]) - (0.050000000000000003 * fRec66[0]));
		...
		fRec57[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec58[0] + fRec58[2])) + (fRec91[0] + (1.8508996845035413 * fRec58[1]))) + -1.271609)))) + -45.226066666666668);
		fRec52[0] = ((0.029999999999999999 * fRec53[0]) + (0.050000000000000003 * fRec57[0]));
		...
		fRec48[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec49[0] + fRec49[2])) + (fRec92[0] + (1.8508996845035413 * fRec49[1]))) + -0.79704299999999995)))) + -32.799634146341475);
		output1[i] = FAUSTFLOAT((0.050000000000000003 * (fRec47[0] * fRec48[0])));
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
		fRec6[1] = fRec6[0];
