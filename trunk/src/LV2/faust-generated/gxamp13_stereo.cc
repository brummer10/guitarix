...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec11[0] = fConst11 * (fConst10 * fRec11[1] + 0.05 * fTemp3);
		...
		double fTemp32 = (fTemp30 + fTemp31) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec20[1]) + 1e+05);
		fVec7[0] = fTemp32;
		fRec45[0] = fConst64 * (2.7e+03 * (fTemp32 + fVec7[1]) - fConst63 * fRec45[1]);
		fRec20[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp31 + fRec45[0] + fTemp30 + -1.863946) + -60.96496296296296;
		double fTemp33 = fRec20[0] - fRec20[1];
		fRec19[0] = fConst8 * (fConst7 * fTemp33 - fConst3 * fRec19[1]);
		fRec46[0] = fConst11 * (fConst10 * fRec46[1] + 0.05 * fTemp33);
		...
		double fTemp36 = (fTemp34 + fTemp35) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec48[1]) + 1e+05);
		fVec8[0] = fTemp36;
		fRec51[0] = fConst67 * (1.5e+03 * (fTemp36 + fVec8[1]) - fConst66 * fRec51[1]);
		fRec48[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp35 + fRec51[0] + fTemp34 + -1.271609) + -45.22606666666667;
		double fTemp37 = fRec48[0] - fRec48[1];
		fRec47[0] = fConst8 * (fConst7 * fTemp37 - fConst3 * fRec47[1]);
		fRec52[0] = fConst11 * (fConst10 * fRec52[1] + 0.05 * fTemp37);
		...
		double fTemp41 = (fTemp39 + fTemp40) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp41;
		fRec53[0] = fConst67 * (1.5e+03 * (fTemp41 + fVec10[1]) - fConst66 * fRec53[1]);
		fRec13[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp40 + fRec53[0] + fTemp39 + -1.271609) + -45.22606666666667;
		double fTemp42 = fRec13[0] - fRec13[1];
		fRec12[0] = fConst8 * (fConst7 * fTemp42 - fConst3 * fRec12[1]);
		fRec54[0] = fConst11 * (fConst10 * fRec54[1] + 0.05 * fTemp42);
		...
		double fTemp45 = (fTemp43 + fTemp44) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp45;
		fRec55[0] = fConst6 * (8.2e+02 * (fTemp45 + fVec11[1]) - fConst5 * fRec55[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp44 + fRec55[0] + fTemp43 + -0.797043) + -32.799634146341475;
		double fTemp46 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst8 * (fConst7 * fTemp46 - fConst3 * fRec0[1]);
		fRec56[0] = fConst11 * (fConst10 * fRec56[1] + 0.05 * fTemp46);
		...
		double fTemp49 = (fTemp47 + fTemp48) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec65[1]) + 1e+05);
		fVec12[0] = fTemp49;
		fRec68[0] = fConst6 * (8.2e+02 * (fTemp49 + fVec12[1]) - fConst5 * fRec68[1]);
		fRec65[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp48 + fRec68[0] + fTemp47 + -0.797043) + -32.799634146341475;
		double fTemp50 = fRec65[0] - fRec65[1];
		fRec64[0] = fConst8 * (fConst7 * fTemp50 - fConst3 * fRec64[1]);
		fRec69[0] = fConst11 * (fConst10 * fRec69[1] + 0.05 * fTemp50);
		...
		double fTemp77 = (fTemp75 + fTemp76) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec77[1]) + 1e+05);
		fVec19[0] = fTemp77;
		fRec101[0] = fConst64 * (2.7e+03 * (fTemp77 + fVec19[1]) - fConst63 * fRec101[1]);
		fRec77[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp76 + fRec101[0] + fTemp75 + -1.863946) + -60.96496296296296;
		double fTemp78 = fRec77[0] - fRec77[1];
		fRec76[0] = fConst8 * (fConst7 * fTemp78 - fConst3 * fRec76[1]);
		fRec102[0] = fConst11 * (fConst10 * fRec102[1] + 0.05 * fTemp78);
		...
		double fTemp81 = (fTemp79 + fTemp80) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec104[1]) + 1e+05);
		fVec20[0] = fTemp81;
		fRec107[0] = fConst67 * (1.5e+03 * (fTemp81 + fVec20[1]) - fConst66 * fRec107[1]);
		fRec104[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp80 + fRec107[0] + fTemp79 + -1.271609) + -45.22606666666667;
		double fTemp82 = fRec104[0] - fRec104[1];
		fRec103[0] = fConst8 * (fConst7 * fTemp82 - fConst3 * fRec103[1]);
		fRec108[0] = fConst11 * (fConst10 * fRec108[1] + 0.05 * fTemp82);
		...
		double fTemp86 = (fTemp84 + fTemp85) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec71[1]) + 1e+05);
		fVec22[0] = fTemp86;
		fRec109[0] = fConst67 * (1.5e+03 * (fTemp86 + fVec22[1]) - fConst66 * fRec109[1]);
		fRec71[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp85 + fRec109[0] + fTemp84 + -1.271609) + -45.22606666666667;
		double fTemp87 = fRec71[0] - fRec71[1];
		fRec70[0] = fConst8 * (fConst7 * fTemp87 - fConst3 * fRec70[1]);
		fRec110[0] = fConst11 * (fConst10 * fRec110[1] + 0.05 * fTemp87);
		...
		double fTemp90 = (fTemp88 + fTemp89) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec59[1]) + 1e+05);
		fVec23[0] = fTemp90;
		fRec111[0] = fConst6 * (8.2e+02 * (fTemp90 + fVec23[1]) - fConst5 * fRec111[1]);
		fRec59[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp89 + fRec111[0] + fTemp88 + -0.797043) + -32.799634146341475;
		double fTemp91 = fRec59[0] - fRec59[1];
		fRec58[0] = fConst8 * (fConst7 * fTemp91 - fConst3 * fRec58[1]);
		fRec112[0] = fConst11 * (fConst10 * fRec112[1] + 0.05 * fTemp91);
