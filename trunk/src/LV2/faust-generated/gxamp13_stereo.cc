...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec66[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec90[0] + (0.9254498422517706 * (fRec67[2] + (fRec67[0] + (2.0 * fRec67[1]))))) - 1.863946)) - 60.96496296296296);
		fRec65[0] = ((fConst33 * fRec65[1]) + (fConst61 * ((fConst30 * fRec66[1]) + (fConst29 * fRec66[0]))));
		...
		fRec92[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec95[0] + (0.9254498422517706 * (fRec93[2] + (fRec93[0] + (2.0 * fRec93[1]))))) - 1.271609)) - 45.22606666666667);
		...
		fRec60[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec96[0] + (0.9254498422517706 * (fRec61[2] + (fRec61[0] + (2.0 * fRec61[1]))))) - 1.271609)) - 45.22606666666667);
		...
		fRec98[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec101[0] + (0.9254498422517706 * (fRec99[2] + (fRec99[0] + (2.0 * fRec99[1]))))) - 0.797043)) - 32.799634146341475);
		...
		fRec54[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec102[0] + (0.9254498422517706 * (fRec55[2] + (fRec55[0] + (2.0 * fRec55[1]))))) - 0.797043)) - 32.799634146341475);
