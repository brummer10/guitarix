...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp3 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp0 + (fRec10[0] + fTemp1)) + -0.79704299999999995))));
		fRec7[0] = ((fTemp3 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp3))) + 100000.0))) + -130.0);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.050000000000000003 * (fRec7[0] - fRec7[1]))));
		...
		double fTemp6 = ((fTemp5 + fTemp4) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec18[1]))) + 100000.0));
		fVec1[0] = fTemp6;
		fRec21[0] = (fConst11 * ((1500.0 * (fTemp6 + fVec1[1])) - (fConst12 * fRec21[1])));
		double fTemp7 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp4 + (fRec21[0] + fTemp5)) + -1.271609))));
		fRec18[0] = ((fTemp7 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp7))) + 100000.0))) + -130.0);
		fRec17[0] = (fConst2 * ((fConst3 * fRec17[1]) + (0.050000000000000003 * (fRec18[0] - fRec18[1]))));
		...
		double fTemp19 = (fSlow4 * fRec29[0]);
		double fTemp20 = (0.024937655860349125 * (fRec29[0] * fTemp17));
		double fTemp21 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow5 * std::max<double>(-0.69999999999999996, std::min<double>(0.69999999999999996, fTemp20)))));
		fRec37[0] = (fTemp20 - (fConst30 * ((fConst35 * fRec37[2]) + (fConst36 * fRec37[1]))));
		double fTemp22 = (fRec37[2] + (fRec37[0] + (2.0 * fRec37[1])));
		fVec3[0] = fTemp22;
		fRec36[0] = ((fConst30 * ((fConst34 * fTemp22) + (fConst37 * fVec3[1]))) - (fConst38 * fRec36[1]));
		fRec35[0] = (0.0 - (fConst26 * ((fConst27 * fRec35[1]) - (fRec36[0] + fRec36[1]))));
		fRec34[0] = (fRec35[0] - (fConst22 * ((fConst39 * fRec34[2]) + (fConst42 * fRec34[1]))));
		double fTemp23 = (fRec34[2] + (fRec34[0] + (2.0 * fRec34[1])));
		fVec4[0] = fTemp23;
		fRec33[0] = ((fConst22 * ((fConst24 * fTemp23) + (fConst43 * fVec4[1]))) - (fConst45 * fRec33[1]));
		fRec32[0] = (fRec33[0] - (fConst17 * ((fConst46 * fRec32[2]) + (fConst47 * fRec32[1]))));
		double fTemp24 = (fConst57 * fRec31[1]);
		fRec31[0] = ((fConst17 * (((fConst19 * fRec32[0]) + (fConst48 * fRec32[1])) + (fConst19 * fRec32[2]))) - (fConst52 * ((fConst54 * fRec31[2]) + fTemp24)));
		double fTemp25 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (fRec31[2] + (fConst52 * (fTemp24 + (fConst54 * fRec31[0])))))));
		...
		double fTemp26 = (fConst47 * fRec39[1]);
		fRec39[0] = ((fConst22 * (((fConst41 * fRec40[0]) + (fConst59 * fRec40[1])) + (fConst41 * fRec40[2]))) - (fConst60 * ((fConst61 * fRec39[2]) + fTemp26)));
		double fTemp27 = (fConst57 * fRec38[1]);
		fRec38[0] = ((fRec39[2] + (fConst60 * (fTemp26 + (fConst61 * fRec39[0])))) - (fConst52 * ((fConst54 * fRec38[2]) + fTemp27)));
		double fTemp28 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec38[2] + (fConst52 * (fTemp27 + (fConst54 * fRec38[0])))))));
		fRec45[0] = (0.0 - (fConst64 * ((fConst44 * fRec45[1]) - (fConst22 * (fTemp23 + fVec4[1])))));
		fRec44[0] = (fRec45[0] - (fConst17 * ((fConst46 * fRec44[2]) + (fConst47 * fRec44[1]))));
		double fTemp29 = (fRec44[2] + (fRec44[0] + (2.0 * fRec44[1])));
		fVec5[0] = fTemp29;
		fRec43[0] = ((fConst17 * ((fConst63 * fTemp29) + (fConst65 * fVec5[1]))) - (fConst66 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst62 * ((fConst67 * fRec42[2]) + (fConst57 * fRec42[1]))));
		double fTemp30 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow9 * (((fConst56 * fRec42[0]) + (fConst68 * fRec42[1])) + (fConst56 * fRec42[2])))));
		fRec47[0] = (0.0 - (fConst69 * ((fConst53 * fRec47[1]) - (fConst17 * (fTemp29 + fVec5[1])))));
		fRec46[0] = (fRec47[0] - (fConst62 * ((fConst67 * fRec46[2]) + (fConst57 * fRec46[1]))));
		double fTemp31 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow10 * (fRec46[2] + (fRec46[0] + (2.0 * fRec46[1]))))));
		double fTemp32 = (((1.333521432 * (fTemp25 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp25))))) + (1.584893192 * ((fTemp28 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp28)))) + (fTemp30 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp30))))))) + (1.2589412 * (fTemp31 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp31))))));
		fVec6[0] = fTemp32;
		fRec30[0] = (0.0 - (fConst5 * ((fConst6 * fRec30[1]) - (fTemp32 + fVec6[1]))));
		double fTemp33 = ((fTemp17 * ((fTemp18 * ((fSlow2 * ((0.099750623441396499 * (1.0 - std::fabs((0.024937655860349125 * (fTemp18 * fTemp17))))) + -0.024937655860349125)) + 0.024937655860349125)) + fTemp19)) + ((0.5 * (fTemp21 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp21))))) + (fSlow6 * fRec30[0])));
		fVec7[0] = fTemp33;
		fRec25[0] = ((0.93028479253239138 * (fTemp33 + fVec7[1])) - (0.86056958506478287 * fRec25[1]));
		fRec24[0] = (fRec25[0] - ((1.8405051250752198 * fRec24[1]) + (0.86129424393186271 * fRec24[2])));
		double fTemp34 = (0.92544984225177063 * (fRec24[0] + fRec24[2]));
		double fTemp35 = (1.8508996845035413 * fRec24[1]);
		double fTemp36 = ((fTemp35 + fTemp34) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp36;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp36 + fVec8[1])) - (fConst72 * fRec48[1])));
		double fTemp37 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp34 + (fRec48[0] + fTemp35)) + -1.8639460000000001))));
		fRec23[0] = ((fTemp37 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp37))) + 100000.0))) + -130.0);
		fRec22[0] = (fConst2 * ((fConst3 * fRec22[1]) + (0.050000000000000003 * (fRec23[0] - fRec23[1]))));
		fRec16[0] = ((0.59999999999999998 * fRec17[0]) - fRec22[0]);
		fRec49[0] = (fSlow11 + (0.999 * fRec49[1]));
		double fTemp38 = (fRec16[0] * fRec49[0]);
		fVec9[0] = fTemp38;
		fRec15[0] = (0.0 - (fConst5 * ((fConst6 * fRec15[1]) - (fTemp38 + fVec9[1]))));
		...
		double fTemp39 = (0.92544984225177063 * (fRec13[0] + fRec13[2]));
		double fTemp40 = (1.8508996845035413 * fRec13[1]);
		double fTemp41 = ((fTemp40 + fTemp39) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp41;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp41 + fVec10[1])) - (fConst12 * fRec50[1])));
		double fTemp42 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp39 + (fRec50[0] + fTemp40)) + -1.271609))));
		fRec12[0] = ((fTemp42 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp42))) + 100000.0))) + -130.0);
		fRec11[0] = (fConst2 * ((fConst3 * fRec11[1]) + (0.050000000000000003 * (fRec12[0] - fRec12[1]))));
		...
		double fTemp43 = (0.92544984225177063 * (fRec2[0] + fRec2[2]));
		double fTemp44 = (1.8508996845035413 * fRec2[1]);
		double fTemp45 = ((fTemp44 + fTemp43) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp45;
		fRec51[0] = (fConst8 * ((820.0 * (fTemp45 + fVec11[1])) - (fConst9 * fRec51[1])));
		double fTemp46 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp43 + (fRec51[0] + fTemp44)) + -0.79704299999999995))));
		fRec1[0] = ((fTemp46 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp46))) + 100000.0))) + -130.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		...
		double fTemp47 = (0.92544984225177063 * (fRec61[0] + fRec61[2]));
		double fTemp48 = (1.8508996845035413 * fRec61[1]);
		double fTemp49 = ((fTemp48 + fTemp47) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec60[1]))) + 100000.0));
		fVec12[0] = fTemp49;
		fRec63[0] = (fConst8 * ((820.0 * (fTemp49 + fVec12[1])) - (fConst9 * fRec63[1])));
		double fTemp50 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp47 + (fRec63[0] + fTemp48)) + -0.79704299999999995))));
		fRec60[0] = ((fTemp50 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp50))) + 100000.0))) + -130.0);
		fRec59[0] = (fConst2 * ((fConst3 * fRec59[1]) + (0.050000000000000003 * (fRec60[0] - fRec60[1]))));
		...
		double fTemp51 = (0.92544984225177063 * (fRec72[0] + fRec72[2]));
		double fTemp52 = (1.8508996845035413 * fRec72[1]);
		double fTemp53 = ((fTemp52 + fTemp51) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec71[1]))) + 100000.0));
		fVec13[0] = fTemp53;
		fRec74[0] = (fConst11 * ((1500.0 * (fTemp53 + fVec13[1])) - (fConst12 * fRec74[1])));
		double fTemp54 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp51 + (fRec74[0] + fTemp52)) + -1.271609))));
		fRec71[0] = ((fTemp54 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp54))) + 100000.0))) + -130.0);
		fRec70[0] = (fConst2 * ((fConst3 * fRec70[1]) + (0.050000000000000003 * (fRec71[0] - fRec71[1]))));
		double fTemp55 = double(input1[i]);
		double fTemp56 = std::fabs(fTemp55);
		fRec79[0] = ((0.99990000000000001 * fRec79[1]) + (9.9999999999988987e-05 * fTemp56));
		double fTemp57 = std::max<double>(fRec79[0], fTemp56);
		fVec14[(IOTA & 32767)] = fTemp57;
		fRec81[0] = ((fTemp57 + fRec81[1]) - fVec14[((IOTA - iConst14) & 32767)]);
		fRec80[0] = ((0.999 * fRec80[1]) + (fConst13 * fRec81[0]));
		double fTemp58 = std::max<double>(-1.0, std::min<double>(-0.01, (fTemp57 + (-1.0 - (1.02 * fRec80[0])))));
		double fTemp59 = (fTemp55 - fTemp58);
		double fTemp60 = (40.100000000000001 * fTemp59);
		double fTemp61 = std::max<double>(-600.0, fTemp60);
		double fTemp62 = (0.0 - (40.100000000000001 * fTemp58));
		double fTemp63 = std::max<double>(-600.0, fTemp62);
		double fTemp64 = (((std::fabs(fTemp60) > 0.0001) ? ((fTemp61 < -50.0) ? (0.0 - (fTemp61 * std::exp(fTemp61))) : (fTemp61 / (1.0 - std::exp((-1.0 * fTemp61))))) : ((fTemp59 * ((134.00083333333336 * fTemp59) + 20.050000000000001)) + 1.0)) - ((std::fabs(fTemp62) > 0.0001) ? ((fTemp63 < -50.0) ? (0.0 - (fTemp63 * std::exp(fTemp63))) : (fTemp63 / (1.0 - std::exp((-1.0 * fTemp63))))) : ((fTemp62 * ((0.083333333333333329 * fTemp62) + 0.5)) + 1.0)));
		double fTemp65 = (0.024937655860349125 * (fRec29[0] * fTemp64));
		double fTemp66 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow5 * std::max<double>(-0.69999999999999996, std::min<double>(0.69999999999999996, fTemp65)))));
		fRec89[0] = (fTemp65 - (fConst30 * ((fConst35 * fRec89[2]) + (fConst36 * fRec89[1]))));
		double fTemp67 = (fRec89[2] + (fRec89[0] + (2.0 * fRec89[1])));
		fVec15[0] = fTemp67;
		fRec88[0] = ((fConst30 * ((fConst34 * fTemp67) + (fConst37 * fVec15[1]))) - (fConst38 * fRec88[1]));
		fRec87[0] = (0.0 - (fConst26 * ((fConst27 * fRec87[1]) - (fRec88[0] + fRec88[1]))));
		fRec86[0] = (fRec87[0] - (fConst22 * ((fConst39 * fRec86[2]) + (fConst42 * fRec86[1]))));
		double fTemp68 = (fRec86[2] + (fRec86[0] + (2.0 * fRec86[1])));
		fVec16[0] = fTemp68;
		fRec85[0] = ((fConst22 * ((fConst24 * fTemp68) + (fConst43 * fVec16[1]))) - (fConst45 * fRec85[1]));
		fRec84[0] = (fRec85[0] - (fConst17 * ((fConst46 * fRec84[2]) + (fConst47 * fRec84[1]))));
		double fTemp69 = (fConst57 * fRec83[1]);
		fRec83[0] = ((fConst17 * (((fConst19 * fRec84[0]) + (fConst48 * fRec84[1])) + (fConst19 * fRec84[2]))) - (fConst52 * ((fConst54 * fRec83[2]) + fTemp69)));
		double fTemp70 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (fRec83[2] + (fConst52 * (fTemp69 + (fConst54 * fRec83[0])))))));
		...
		double fTemp71 = (fConst47 * fRec91[1]);
		fRec91[0] = ((fConst22 * (((fConst41 * fRec92[0]) + (fConst59 * fRec92[1])) + (fConst41 * fRec92[2]))) - (fConst60 * ((fConst61 * fRec91[2]) + fTemp71)));
		double fTemp72 = (fConst57 * fRec90[1]);
		fRec90[0] = ((fRec91[2] + (fConst60 * (fTemp71 + (fConst61 * fRec91[0])))) - (fConst52 * ((fConst54 * fRec90[2]) + fTemp72)));
		double fTemp73 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec90[2] + (fConst52 * (fTemp72 + (fConst54 * fRec90[0])))))));
		fRec97[0] = (0.0 - (fConst64 * ((fConst44 * fRec97[1]) - (fConst22 * (fTemp68 + fVec16[1])))));
		fRec96[0] = (fRec97[0] - (fConst17 * ((fConst46 * fRec96[2]) + (fConst47 * fRec96[1]))));
		double fTemp74 = (fRec96[2] + (fRec96[0] + (2.0 * fRec96[1])));
		fVec17[0] = fTemp74;
		fRec95[0] = ((fConst17 * ((fConst63 * fTemp74) + (fConst65 * fVec17[1]))) - (fConst66 * fRec95[1]));
		fRec94[0] = (fRec95[0] - (fConst62 * ((fConst67 * fRec94[2]) + (fConst57 * fRec94[1]))));
		double fTemp75 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow9 * (((fConst56 * fRec94[0]) + (fConst68 * fRec94[1])) + (fConst56 * fRec94[2])))));
		fRec99[0] = (0.0 - (fConst69 * ((fConst53 * fRec99[1]) - (fConst17 * (fTemp74 + fVec17[1])))));
		fRec98[0] = (fRec99[0] - (fConst62 * ((fConst67 * fRec98[2]) + (fConst57 * fRec98[1]))));
		double fTemp76 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow10 * (fRec98[2] + (fRec98[0] + (2.0 * fRec98[1]))))));
		double fTemp77 = (((1.333521432 * (fTemp70 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp70))))) + (1.584893192 * ((fTemp73 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp73)))) + (fTemp75 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp75))))))) + (1.2589412 * (fTemp76 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp76))))));
		fVec18[0] = fTemp77;
		fRec82[0] = (0.0 - (fConst5 * ((fConst6 * fRec82[1]) - (fTemp77 + fVec18[1]))));
		double fTemp78 = ((fTemp64 * (fTemp19 + (fTemp18 * ((fSlow2 * ((0.099750623441396499 * (1.0 - std::fabs((0.024937655860349125 * (fTemp18 * fTemp64))))) + -0.024937655860349125)) + 0.024937655860349125)))) + ((0.5 * (fTemp66 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp66))))) + (fSlow6 * fRec82[0])));
		fVec19[0] = fTemp78;
		fRec78[0] = ((0.93028479253239138 * (fTemp78 + fVec19[1])) - (0.86056958506478287 * fRec78[1]));
		fRec77[0] = (fRec78[0] - ((1.8405051250752198 * fRec77[1]) + (0.86129424393186271 * fRec77[2])));
		double fTemp79 = (0.92544984225177063 * (fRec77[0] + fRec77[2]));
		double fTemp80 = (1.8508996845035413 * fRec77[1]);
		double fTemp81 = ((fTemp80 + fTemp79) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec76[1]))) + 100000.0));
		fVec20[0] = fTemp81;
		fRec100[0] = (fConst71 * ((2700.0 * (fTemp81 + fVec20[1])) - (fConst72 * fRec100[1])));
		double fTemp82 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp79 + (fRec100[0] + fTemp80)) + -1.8639460000000001))));
		fRec76[0] = ((fTemp82 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp82))) + 100000.0))) + -130.0);
		fRec75[0] = (fConst2 * ((fConst3 * fRec75[1]) + (0.050000000000000003 * (fRec76[0] - fRec76[1]))));
		fRec69[0] = ((0.59999999999999998 * fRec70[0]) - fRec75[0]);
		double fTemp83 = (fRec49[0] * fRec69[0]);
		fVec21[0] = fTemp83;
		fRec68[0] = (0.0 - (fConst5 * ((fConst6 * fRec68[1]) - (fTemp83 + fVec21[1]))));
		...
		double fTemp84 = (0.92544984225177063 * (fRec66[0] + fRec66[2]));
		double fTemp85 = (1.8508996845035413 * fRec66[1]);
		double fTemp86 = ((fTemp85 + fTemp84) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec65[1]))) + 100000.0));
		fVec22[0] = fTemp86;
		fRec101[0] = (fConst11 * ((1500.0 * (fTemp86 + fVec22[1])) - (fConst12 * fRec101[1])));
		double fTemp87 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp84 + (fRec101[0] + fTemp85)) + -1.271609))));
		fRec65[0] = ((fTemp87 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp87))) + 100000.0))) + -130.0);
		fRec64[0] = (fConst2 * ((fConst3 * fRec64[1]) + (0.050000000000000003 * (fRec65[0] - fRec65[1]))));
		...
		double fTemp88 = (0.92544984225177063 * (fRec55[0] + fRec55[2]));
		double fTemp89 = (1.8508996845035413 * fRec55[1]);
		double fTemp90 = ((fTemp89 + fTemp88) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec54[1]))) + 100000.0));
		fVec23[0] = fTemp90;
		fRec102[0] = (fConst8 * ((820.0 * (fTemp90 + fVec23[1])) - (fConst9 * fRec102[1])));
		double fTemp91 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp88 + (fRec102[0] + fTemp89)) + -0.79704299999999995))));
		fRec54[0] = ((fTemp91 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp91))) + 100000.0))) + -130.0);
		fRec53[0] = (fConst2 * ((fConst3 * fRec53[1]) + (0.050000000000000003 * (fRec54[0] - fRec54[1]))));
