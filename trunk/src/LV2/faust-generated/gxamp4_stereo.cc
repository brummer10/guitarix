...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec48[0] + ((double)input1[i] * fRec13[0])) - 1.2572399999999988)) - 83.43555555555557);
		...
		fVec17[0] = fTemp39;
		fRec40[0] = ((fConst4 * fRec40[1]) + (fConst3 * (fVec17[1] + fVec17[0])));
