...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp4 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp1 + (fRec27[0] + fTemp2)) + -1.2572399999999999))));
		fRec23[0] = ((fTemp4 + (0.00046564444444444444 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp4))) + 100000.0))) + -130.0);
		...
		double fTemp8 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp5 + (fRec28[0] + fTemp6)) + -0.77616200000000002))));
		fRec18[0] = ((fTemp8 + (0.00051744133333333337 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp8))) + 100000.0))) + -130.0);
		...
		double fTemp12 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp9 + (fRec29[0] + fTemp10)) + -0.44548700000000002))));
		fRec14[0] = ((fTemp12 + (0.00054327682926829269 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp12))) + 100000.0))) + -130.0);
		...
		double fTemp40 = ((fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec69[1]))) + 100000.0));
		fVec13[0] = fTemp40;
		fRec72[0] = (fConst28 * ((2700.0 * (fTemp40 + fVec13[1])) - (fConst29 * fRec72[1])));
		double fTemp41 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp38 + (fRec72[0] + fTemp39)) + -1.2572399999999999))));
		fRec69[0] = ((fTemp41 + (0.00046564444444444444 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp41))) + 100000.0))) + -130.0);
		fRec68[0] = (fConst2 * ((fConst3 * fRec68[1]) + (0.10000000000000001 * (fRec69[0] - fRec69[1]))));
		...
		double fTemp44 = ((fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec64[1]))) + 100000.0));
		fVec14[0] = fTemp44;
		fRec73[0] = (fConst31 * ((1500.0 * (fTemp44 + fVec14[1])) - (fConst32 * fRec73[1])));
		double fTemp45 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp42 + (fRec73[0] + fTemp43)) + -0.77616200000000002))));
		fRec64[0] = ((fTemp45 + (0.00051744133333333337 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp45))) + 100000.0))) + -130.0);
		fRec63[0] = (fConst2 * ((fConst3 * fRec63[1]) + (0.10000000000000001 * (fRec64[0] - fRec64[1]))));
		...
		double fTemp48 = ((fTemp47 + fTemp46) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec60[1]))) + 100000.0));
		fVec15[0] = fTemp48;
		fRec74[0] = (fConst34 * ((820.0 * (fTemp48 + fVec15[1])) - (fConst35 * fRec74[1])));
		double fTemp49 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp46 + (fRec74[0] + fTemp47)) + -0.44548700000000002))));
		fRec60[0] = ((fTemp49 + (0.00054327682926829269 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp49))) + 100000.0))) + -130.0);
