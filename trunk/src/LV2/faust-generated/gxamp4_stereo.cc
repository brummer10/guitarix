...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec21[0] = fConst11 * (fConst10 * fRec21[1] + 0.1 * fTemp4);
		...
		double fTemp8 = (fTemp6 + fTemp7) / (Ranode(TUBE_TABLE_12AU7_250k, fRec11[1]) + 1e+05);
		fVec3[0] = fTemp8;
		fRec22[0] = fConst17 * (1.5e+03 * (fTemp8 + fVec3[1]) - fConst16 * fRec22[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp7 + fRec22[0] + fTemp6 + -0.776162) + -78.25586666666666;
		double fTemp9 = fRec11[0] - fRec11[1];
		fRec10[0] = fConst8 * (fConst7 * fTemp9 - fConst3 * fRec10[1]);
		fRec23[0] = fConst11 * (fConst10 * fRec23[1] + 0.1 * fTemp9);
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_12AU7_250k, fRec7[1]) + 1e+05);
		fVec5[0] = fTemp13;
		fRec24[0] = fConst20 * (8.2e+02 * (fTemp13 + fVec5[1]) - fConst19 * fRec24[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp12 + fRec24[0] + fTemp11 + -0.445487) + -75.67231707317073;
		double fTemp14 = fRec7[0] - fRec7[1];
		fRec6[0] = fConst8 * (fConst7 * fTemp14 - fConst3 * fRec6[1]);
		fRec25[0] = fConst11 * (fConst10 * fRec25[1] + 0.1 * fTemp14);
		...
		double fTemp43 = (fTemp41 + fTemp42) / (Ranode(TUBE_TABLE_12AU7_68k, fRec66[1]) + 1e+05);
		fVec15[0] = fTemp43;
		fRec69[0] = fConst6 * (2.7e+03 * (fTemp43 + fVec15[1]) - fConst5 * fRec69[1]);
		fRec66[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp42 + fRec69[0] + fTemp41 + -1.25724) + -83.43555555555557;
		double fTemp44 = fRec66[0] - fRec66[1];
		fRec65[0] = fConst8 * (fConst7 * fTemp44 - fConst3 * fRec65[1]);
		fRec70[0] = fConst11 * (fConst10 * fRec70[1] + 0.1 * fTemp44);
		...
		double fTemp48 = (fTemp46 + fTemp47) / (Ranode(TUBE_TABLE_12AU7_250k, fRec61[1]) + 1e+05);
		fVec17[0] = fTemp48;
		fRec71[0] = fConst17 * (1.5e+03 * (fTemp48 + fVec17[1]) - fConst16 * fRec71[1]);
		fRec61[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp47 + fRec71[0] + fTemp46 + -0.776162) + -78.25586666666666;
		double fTemp49 = fRec61[0] - fRec61[1];
		fRec60[0] = fConst8 * (fConst7 * fTemp49 - fConst3 * fRec60[1]);
		fRec72[0] = fConst11 * (fConst10 * fRec72[1] + 0.1 * fTemp49);
		...
		double fTemp53 = (fTemp51 + fTemp52) / (Ranode(TUBE_TABLE_12AU7_250k, fRec57[1]) + 1e+05);
		fVec19[0] = fTemp53;
		fRec73[0] = fConst20 * (8.2e+02 * (fTemp53 + fVec19[1]) - fConst19 * fRec73[1]);
		fRec57[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp52 + fRec73[0] + fTemp51 + -0.445487) + -75.67231707317073;
		double fTemp54 = fRec57[0] - fRec57[1];
		fRec56[0] = fConst8 * (fConst7 * fTemp54 - fConst3 * fRec56[1]);
		fRec74[0] = fConst11 * (fConst10 * fRec74[1] + 0.1 * fTemp54);
