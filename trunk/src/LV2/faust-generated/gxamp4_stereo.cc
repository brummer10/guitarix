...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp35 = ((fTemp34 + fTemp33) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec69[1]))) + 100000.0));
		fVec13[0] = fTemp35;
		fRec72[0] = (fConst28 * ((2700.0 * (fTemp35 + fVec13[1])) - (fConst29 * fRec72[1])));
		fRec69[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp33 + (fRec72[0] + fTemp34)) + -1.2572399999999999)))) + -83.435555555555567);
		...
		double fTemp38 = ((fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec64[1]))) + 100000.0));
		fVec14[0] = fTemp38;
		fRec73[0] = (fConst31 * ((1500.0 * (fTemp38 + fVec14[1])) - (fConst32 * fRec73[1])));
		fRec64[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp36 + (fRec73[0] + fTemp37)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		double fTemp41 = ((fTemp40 + fTemp39) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec60[1]))) + 100000.0));
		fVec15[0] = fTemp41;
		fRec74[0] = (fConst34 * ((820.0 * (fTemp41 + fVec15[1])) - (fConst35 * fRec74[1])));
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp39 + (fRec74[0] + fTemp40)) + -0.44548700000000002)))) + -75.672317073170731);
