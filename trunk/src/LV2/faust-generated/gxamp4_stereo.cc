...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec48[0] + ((double)input1[i] * fRec13[0])) - 1.25724)) - 83.43555555555557);
		...
		fRec44[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec49[0] + fRec45[0]) - 0.776162)) - 78.25586666666666);
		...
		fRec42[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec50[0] + fRec43[0]) - 0.445487)) - 75.67231707317073);
		...
		fRec38[0] = ((fConst69 * ((fConst12 * fRec39[1]) + (fConst1 * fRec39[0]))) + (fConst3 * fRec38[1]));
		...
		fRec70[0] = ((fConst69 * ((fConst12 * fRec71[1]) + (fConst1 * fRec71[0]))) + (fConst3 * fRec70[1]));
