...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp38 = (fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec74[1]))) + 100000.0);
		fVec15[0] = fTemp38;
		fRec77[0] = fConst25 * (2700.0 * (fTemp38 + fVec15[1]) - fConst26 * fRec77[1]);
		fRec74[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp36 + fRec77[0] + fTemp37 + -1.2572399999999999))) + -83.435555555555567;
		fRec73[0] = 0.10000000000000001 * (fConst4 * fRec74[0] + fConst27 * fRec74[1]) - fConst28 * fRec73[1];
		fRec78[0] = fConst30 * (fConst31 * fRec78[1] + 0.10000000000000001 * (fRec74[0] - fRec74[1]));
		...
		double fTemp42 = (fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec69[1]))) + 100000.0);
		fVec17[0] = fTemp42;
		fRec79[0] = fConst33 * (1500.0 * (fTemp42 + fVec17[1]) - fConst34 * fRec79[1]);
		fRec69[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp40 + fRec79[0] + fTemp41 + -0.77616200000000002))) + -78.255866666666662;
		fRec68[0] = 0.10000000000000001 * (fConst4 * fRec69[0] + fConst27 * fRec69[1]) - fConst28 * fRec68[1];
		fRec80[0] = fConst30 * (fConst31 * fRec80[1] + 0.10000000000000001 * (fRec69[0] - fRec69[1]));
		...
		double fTemp46 = (fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec65[1]))) + 100000.0);
		fVec19[0] = fTemp46;
		fRec81[0] = fConst36 * (820.0 * (fTemp46 + fVec19[1]) - fConst37 * fRec81[1]);
		fRec65[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp44 + fRec81[0] + fTemp45 + -0.44548700000000002))) + -75.672317073170731;
		fRec64[0] = 0.10000000000000001 * (fConst4 * fRec65[0] + fConst27 * fRec65[1]) - fConst28 * fRec64[1];
		fRec82[0] = fConst30 * (fConst31 * fRec82[1] + 0.10000000000000001 * (fRec65[0] - fRec65[1]));
