...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp1 * (fTemp13 + (fTemp12 * (1 + (fSlow10 * ((4 - (4 * fabs((fTemp1 * fTemp12)))) - 1)))))) + (fRec29[0] + (fSlow9 * fRec10[0]))) - 3.718962)) - 112.26066666666668);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp17 * (fTemp13 + (fTemp12 * (1 + (fSlow10 * ((4 - (4 * fabs((fTemp17 * fTemp12)))) - 1)))))) + (fRec58[0] + (fSlow9 * fRec40[0]))) - 3.718962)) - 112.26066666666668);
		...
		fRec36[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec59[0] + fRec37[0]) - 2.314844)) - 95.67706666666666);
		...
		fRec33[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec60[0] + fRec34[0]) - 1.356567)) - 84.565);
