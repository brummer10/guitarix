...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = ((fConst10 * (fRec9[1] + fRec9[2])) + (fConst9 * fRec11[1]));
		double fTemp3 = (fConst13 * fRec13[1]);
		double fTemp4 = (1e-15 + (fTemp1 * fRec10[0]));
		fRec19[0] = (fTemp4 - (fConst40 * ((fConst38 * fRec19[2]) + (fConst36 * fRec19[1]))));
		double fTemp5 = (fRec19[2] + (fRec19[0] + (2 * fRec19[1])));
		fVec0[0] = fTemp5;
		fRec18[0] = ((fConst42 * ((fConst1 * fVec0[0]) + (fConst41 * fVec0[1]))) + (fConst3 * fRec18[1]));
		...
		fVec1[0] = fTemp6;
		fRec15[0] = ((fConst45 * ((fConst44 * fVec1[1]) + (fConst20 * fVec1[0]))) + (fConst25 * fRec15[1]));
		...
		double fTemp7 = max(-1, min(1, (fSlow4 * (fRec13[2] + (fConst16 * (fTemp3 + (fConst15 * fRec13[0])))))));
		...
		double fTemp9 = max(-1, min(1, (fSlow5 * (((fConst12 * fRec20[0]) + (fConst53 * fRec20[1])) + (fConst12 * fRec20[2])))));
		...
		double fTemp12 = max(-1, min(1, (fSlow6 * (fRec24[2] + (fConst16 * (fTemp10 + (fConst15 * fRec24[0])))))));
		fRec29[0] = ((fConst52 * (fVec2[0] + fVec2[1])) + (fConst50 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst48 * ((fConst47 * fRec28[2]) + (fConst13 * fRec28[1]))));
		double fTemp13 = max(-1, min(1, (fSlow7 * (fRec28[2] + (fRec28[0] + (2 * fRec28[1]))))));
		...
		fVec3[0] = fTemp14;
		fRec12[0] = ((fConst58 * (fVec3[0] + fVec3[1])) + (fConst6 * fRec12[1]));
		double fTemp15 = (1e-15 + fTemp2);
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * ((fTemp15 * (4 - (4 * fabs(fTemp15)))) - fTemp15)) + ((fSlow10 * fTemp4) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp2)))) - 3.7189619999999977)) - 112.26066666666668);
		...
		fRec5[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec30[0] + fRec6[0]) - 2.314843999999999)) - 95.67706666666666);
		fRec4[0] = ((fConst59 * ((fConst41 * fRec5[1]) + (fConst1 * fRec5[0]))) + (fConst3 * fRec4[1]));
		double fTemp17 = (fRec7[0] * fRec4[0]);
		fVec5[0] = fTemp17;
		fRec3[0] = ((fConst60 * (fVec5[0] + fVec5[1])) + (fConst6 * fRec3[1]));
		fRec31[0] = ((fConst68 * (fRec2[1] + fRec2[2])) + (fConst67 * fRec31[1]));
		fRec2[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec31[0] + fRec3[0]) - 1.356566999999999)) - 84.565);
		...
		fRec40[0] = ((fConst10 * (fRec39[1] + fRec39[2])) + (fConst9 * fRec40[1]));
		double fTemp20 = (fConst13 * fRec42[1]);
		double fTemp21 = (1e-15 + (fTemp18 * fRec10[0]));
		fRec48[0] = (fTemp21 - (fConst40 * ((fConst38 * fRec48[2]) + (fConst36 * fRec48[1]))));
		double fTemp22 = (fRec48[2] + (fRec48[0] + (2 * fRec48[1])));
		fVec6[0] = fTemp22;
		fRec47[0] = ((fConst42 * ((fConst41 * fVec6[1]) + (fConst1 * fVec6[0]))) + (fConst3 * fRec47[1]));
		fRec46[0] = ((fConst43 * (fRec47[0] + fRec47[1])) + (fConst34 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst32 * ((fConst30 * fRec45[2]) + (fConst28 * fRec45[1]))));
		double fTemp23 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec7[0] = fTemp23;
		fRec44[0] = ((fConst45 * ((fConst44 * fVec7[1]) + (fConst20 * fVec7[0]))) + (fConst25 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst23 * ((fConst21 * fRec43[2]) + (fConst19 * fRec43[1]))));
		fRec42[0] = ((fConst23 * (((fConst18 * fRec43[0]) + (fConst46 * fRec43[1])) + (fConst18 * fRec43[2]))) - (fConst16 * ((fConst15 * fRec42[2]) + fTemp20)));
		double fTemp24 = max(-1, min(1, (fSlow4 * (fRec42[2] + (fConst16 * (fTemp20 + (fConst15 * fRec42[0])))))));
		fRec52[0] = ((fConst45 * (fVec7[0] + fVec7[1])) + (fConst25 * fRec52[1]));
		fRec51[0] = (fRec52[0] - (fConst23 * ((fConst21 * fRec51[2]) + (fConst19 * fRec51[1]))));
		double fTemp25 = (fRec51[2] + (fRec51[0] + (2 * fRec51[1])));
		fVec8[0] = fTemp25;
		fRec50[0] = ((fConst52 * ((fConst51 * fVec8[1]) + (fConst14 * fVec8[0]))) + (fConst50 * fRec50[1]));
		fRec49[0] = (fRec50[0] - (fConst48 * ((fConst47 * fRec49[2]) + (fConst13 * fRec49[1]))));
		double fTemp26 = max(-1, min(1, (fSlow5 * (((fConst12 * fRec49[0]) + (fConst53 * fRec49[1])) + (fConst12 * fRec49[2])))));
		double fTemp27 = (fConst13 * fRec53[1]);
		double fTemp28 = (fConst19 * fRec54[1]);
		...
		fRec54[0] = ((fConst32 * (((fConst27 * fRec55[0]) + (fConst57 * fRec55[1])) + (fConst27 * fRec55[2]))) - (fConst55 * ((fConst54 * fRec54[2]) + fTemp28)));
		fRec53[0] = ((fRec54[2] + (fConst55 * (fTemp28 + (fConst54 * fRec54[0])))) - (fConst16 * ((fConst15 * fRec53[2]) + fTemp27)));
		double fTemp29 = max(-1, min(1, (fSlow6 * (fRec53[2] + (fConst16 * (fTemp27 + (fConst15 * fRec53[0])))))));
		fRec58[0] = ((fConst52 * (fVec8[0] + fVec8[1])) + (fConst50 * fRec58[1]));
		fRec57[0] = (fRec58[0] - (fConst48 * ((fConst47 * fRec57[2]) + (fConst13 * fRec57[1]))));
		double fTemp30 = max(-1, min(1, (fSlow7 * (fRec57[2] + (fRec57[0] + (2 * fRec57[1]))))));
		...
		fVec9[0] = fTemp31;
		fRec41[0] = ((fConst58 * (fVec9[0] + fVec9[1])) + (fConst6 * fRec41[1]));
		double fTemp32 = (1e-15 + fTemp19);
		fRec39[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * ((fTemp32 * (4 - (4 * fabs(fTemp32)))) - fTemp32)) + ((fSlow10 * fTemp21) + ((fSlow9 * fRec41[0]) + (fRec40[0] + fTemp19)))) - 3.7189619999999977)) - 112.26066666666668);
		fRec38[0] = ((fConst59 * ((fConst41 * fRec39[1]) + (fConst1 * fRec39[0]))) + (fConst3 * fRec38[1]));
		double fTemp33 = (fRec7[0] * fRec38[0]);
		fVec10[0] = fTemp33;
		fRec37[0] = ((fConst60 * (fVec10[0] + fVec10[1])) + (fConst6 * fRec37[1]));
		fRec59[0] = ((fConst64 * (fRec36[1] + fRec36[2])) + (fConst63 * fRec59[1]));
		fRec36[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec59[0] + fRec37[0]) - 2.314843999999999)) - 95.67706666666666);
		fRec35[0] = ((fConst59 * ((fConst41 * fRec36[1]) + (fConst1 * fRec36[0]))) + (fConst3 * fRec35[1]));
		double fTemp34 = (fRec7[0] * fRec35[0]);
		fVec11[0] = fTemp34;
		fRec34[0] = ((fConst60 * (fVec11[0] + fVec11[1])) + (fConst6 * fRec34[1]));
		fRec60[0] = ((fConst68 * (fRec33[1] + fRec33[2])) + (fConst67 * fRec60[1]));
		fRec33[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec60[0] + fRec34[0]) - 1.356566999999999)) - 84.565);
		fRec32[0] = ((fConst59 * ((fConst41 * fRec33[1]) + (fConst1 * fRec33[0]))) + (fConst3 * fRec32[1]));
		output1[i] = (FAUSTFLOAT)(2.0 * (fRec0[0] * fRec32[0]));
		// post processing
		fRec32[1] = fRec32[0];
