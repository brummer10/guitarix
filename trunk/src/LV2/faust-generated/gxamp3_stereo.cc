...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp5;
		fRec22[0] = fConst32 * (fConst33 * fTemp5 + fConst34 * fVec0[1]) - fConst4 * fRec22[1];
		...
		fVec1[0] = fTemp6;
		fRec19[0] = 0.0 - fConst40 * (fConst38 * fRec19[1] - fConst27 * (fTemp6 + fVec1[1]));
		fRec18[0] = fRec19[0] - fConst20 * (fConst19 * fRec18[2] + fConst17 * fRec18[1]);
		double fTemp7 = fRec18[2] + fRec18[0] + 2.0 * fRec18[1];
		fVec2[0] = fTemp7;
		fRec17[0] = 0.0 - fConst43 * (fConst41 * fRec17[1] - fConst20 * (fTemp7 + fVec2[1]));
		...
		fRec25[0] = fConst20 * (fConst45 * fTemp7 + fConst46 * fVec2[1]) - fConst44 * fRec25[1];
		fRec24[0] = fRec25[0] - fConst13 * (fConst12 * fRec24[2] + fConst10 * fRec24[1]);
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fConst9 * fRec24[0] + fConst47 * fRec24[1] + fConst9 * fRec24[2])));
		double fTemp10 = fConst10 * fRec26[1];
		double fTemp11 = fConst17 * fRec27[1];
		...
		fRec27[0] = fConst27 * (fConst23 * fRec28[0] + fConst53 * fRec28[1] + fConst23 * fRec28[2]) - fConst51 * (fConst50 * fRec27[2] + fTemp11);
		fRec26[0] = fRec27[2] + fConst51 * (fTemp11 + fConst50 * fRec27[0]) - fConst49 * (fConst48 * fRec26[2] + fTemp10);
		double fTemp12 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec26[2] + fConst49 * (fTemp10 + fConst48 * fRec26[0]))));
		double fTemp13 = fConst10 * fRec30[1];
		fRec32[0] = fConst27 * (fConst55 * fTemp6 + fConst56 * fVec1[1]) - fConst54 * fRec32[1];
		fRec31[0] = fRec32[0] - fConst20 * (fConst19 * fRec31[2] + fConst17 * fRec31[1]);
		fRec30[0] = fConst20 * (fConst16 * fRec31[0] + fConst57 * fRec31[1] + fConst16 * fRec31[2]) - fConst49 * (fConst48 * fRec30[2] + fTemp13);
		double fTemp14 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec30[2] + fConst49 * (fTemp13 + fConst48 * fRec30[0]))));
		...
		fVec3[0] = fTemp15;
		fRec15[0] = 0.0 - fConst58 * (fConst6 * fRec15[1] - (fTemp15 + fVec3[1]));
		...
		fVec6[0] = fTemp20;
		fRec9[0] = fConst58 * (2.0 * (fTemp20 + fVec6[1]) - fConst6 * fRec9[1]);
		...
		fVec8[0] = fTemp24;
		fRec4[0] = fConst58 * (2.0 * (fTemp24 + fVec8[1]) - fConst6 * fRec4[1]);
		...
		double fTemp27 = (fTemp25 + fTemp26) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp27;
		fRec38[0] = fConst70 * (8.2e+02 * (fTemp27 + fVec9[1]) - fConst69 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp26 + fRec38[0] + fTemp25 + -1.356567) + -84.565;
		...
		fRec63[0] = fTemp29 + (1e-15 - fConst32 * (fConst31 * fRec63[2] + fConst29 * fRec63[1]));
		double fTemp32 = fRec63[2] + fRec63[0] + 2.0 * fRec63[1];
		fVec10[0] = fTemp32;
		fRec62[0] = fConst32 * (fConst33 * fTemp32 + fConst34 * fVec10[1]) - fConst4 * fRec62[1];
		fRec61[0] = 0.0 - fConst37 * (fConst35 * fRec61[1] - (fRec62[0] + fRec62[1]));
		fRec60[0] = fRec61[0] - fConst27 * (fConst26 * fRec60[2] + fConst24 * fRec60[1]);
		double fTemp33 = fRec60[2] + fRec60[0] + 2.0 * fRec60[1];
		fVec11[0] = fTemp33;
		fRec59[0] = 0.0 - fConst40 * (fConst38 * fRec59[1] - fConst27 * (fTemp33 + fVec11[1]));
		fRec58[0] = fRec59[0] - fConst20 * (fConst19 * fRec58[2] + fConst17 * fRec58[1]);
		double fTemp34 = fRec58[2] + fRec58[0] + 2.0 * fRec58[1];
		fVec12[0] = fTemp34;
		fRec57[0] = 0.0 - fConst43 * (fConst41 * fRec57[1] - fConst20 * (fTemp34 + fVec12[1]));
		fRec56[0] = fRec57[0] - fConst13 * (fConst12 * fRec56[2] + fConst10 * fRec56[1]);
		double fTemp35 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * (fRec56[2] + fRec56[0] + 2.0 * fRec56[1])));
		fRec65[0] = fConst20 * (fConst45 * fTemp34 + fConst46 * fVec12[1]) - fConst44 * fRec65[1];
		fRec64[0] = fRec65[0] - fConst13 * (fConst12 * fRec64[2] + fConst10 * fRec64[1]);
		double fTemp36 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fConst9 * fRec64[0] + fConst47 * fRec64[1] + fConst9 * fRec64[2])));
		double fTemp37 = fConst10 * fRec66[1];
		double fTemp38 = fConst17 * fRec67[1];
		fRec69[0] = fConst52 * fRec62[1] - fConst37 * (fConst35 * fRec69[1] - fConst25 * fRec62[0]);
		fRec68[0] = fRec69[0] - fConst27 * (fConst26 * fRec68[2] + fConst24 * fRec68[1]);
		fRec67[0] = fConst27 * (fConst23 * fRec68[0] + fConst53 * fRec68[1] + fConst23 * fRec68[2]) - fConst51 * (fConst50 * fRec67[2] + fTemp38);
		fRec66[0] = fRec67[2] + fConst51 * (fTemp38 + fConst50 * fRec67[0]) - fConst49 * (fConst48 * fRec66[2] + fTemp37);
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec66[2] + fConst49 * (fTemp37 + fConst48 * fRec66[0]))));
		double fTemp40 = fConst10 * fRec70[1];
		fRec72[0] = fConst27 * (fConst55 * fTemp33 + fConst56 * fVec11[1]) - fConst54 * fRec72[1];
		fRec71[0] = fRec72[0] - fConst20 * (fConst19 * fRec71[2] + fConst17 * fRec71[1]);
		fRec70[0] = fConst20 * (fConst16 * fRec71[0] + fConst57 * fRec71[1] + fConst16 * fRec71[2]) - fConst49 * (fConst48 * fRec70[2] + fTemp40);
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec70[2] + fConst49 * (fTemp40 + fConst48 * fRec70[0]))));
		...
		fVec13[0] = fTemp42;
		fRec55[0] = 0.0 - fConst58 * (fConst6 * fRec55[1] - (fTemp42 + fVec13[1]));
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_12AU7_68k, fRec52[1]) + 1e+05);
		fVec15[0] = fTemp46;
		fRec73[0] = fConst61 * (2.7e+03 * (fTemp46 + fVec15[1]) - fConst60 * fRec73[1]);
		fRec52[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp45 + fRec73[0] + fTemp44 + -3.718962) + -112.26066666666668;
		fRec51[0] = 0.025 * (fConst33 * fRec52[0] + fConst34 * fRec52[1]) - fConst4 * fRec51[1];
		fRec74[0] = fConst64 * (fConst63 * fRec74[1] + 0.025 * (fRec52[0] - fRec52[1]));
		double fTemp47 = fRec35[0] * ((iSlow1) ? fRec74[0] : fRec51[0]);
		fVec16[0] = fTemp47;
		fRec50[0] = fConst58 * (2.0 * (fTemp47 + fVec16[1]) - fConst6 * fRec50[1]);
		...
		double fTemp50 = (fTemp48 + fTemp49) / (Ranode(TUBE_TABLE_12AU7_250k, fRec47[1]) + 1e+05);
		fVec17[0] = fTemp50;
		fRec75[0] = fConst67 * (1.5e+03 * (fTemp50 + fVec17[1]) - fConst66 * fRec75[1]);
		fRec47[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp49 + fRec75[0] + fTemp48 + -2.314844) + -95.67706666666666;
		fRec46[0] = 0.025 * (fConst33 * fRec47[0] + fConst34 * fRec47[1]) - fConst4 * fRec46[1];
		fRec76[0] = fConst64 * (fConst63 * fRec76[1] + 0.025 * (fRec47[0] - fRec47[1]));
		double fTemp51 = fRec35[0] * ((iSlow1) ? fRec76[0] : fRec46[0]);
		fVec18[0] = fTemp51;
		fRec45[0] = fConst58 * (2.0 * (fTemp51 + fVec18[1]) - fConst6 * fRec45[1]);
		...
		double fTemp54 = (fTemp52 + fTemp53) / (Ranode(TUBE_TABLE_12AU7_250k, fRec42[1]) + 1e+05);
		fVec19[0] = fTemp54;
		fRec77[0] = fConst70 * (8.2e+02 * (fTemp54 + fVec19[1]) - fConst69 * fRec77[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp53 + fRec77[0] + fTemp52 + -1.356567) + -84.565;
		fRec41[0] = 0.025 * (fConst33 * fRec42[0] + fConst34 * fRec42[1]) - fConst4 * fRec41[1];
