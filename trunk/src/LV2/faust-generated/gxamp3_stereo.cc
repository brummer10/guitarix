...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fVec6[0] = fTemp20;
		fRec10[0] = (fConst5 * ((2.0 * (fTemp20 + fVec6[1])) - (fConst6 * fRec10[1])));
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -2.3148439999999999)))) + -95.677066666666661);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.025000000000000001 * (fRec7[0] - fRec7[1]))));
		double fTemp24 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp24;
		fRec4[0] = (fConst5 * ((2.0 * (fTemp24 + fVec8[1])) - (fConst6 * fRec4[1])));
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp25 + (fRec36[0] + fTemp26)) + -1.3565670000000001)))) + -84.564999999999998);
		...
		double fTemp46 = ((fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec49[1]))) + 100000.0));
		fVec15[0] = fTemp46;
		fRec70[0] = (fConst63 * ((2700.0 * (fTemp46 + fVec15[1])) - (fConst64 * fRec70[1])));
		fRec49[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp44 + (fRec70[0] + fTemp45)) + -3.7189619999999999)))) + -112.26066666666668);
		fRec48[0] = (fConst2 * ((fConst3 * fRec48[1]) + (0.025000000000000001 * (fRec49[0] - fRec49[1]))));
		double fTemp47 = (fRec5[0] * fRec48[0]);
		fVec16[0] = fTemp47;
		fRec47[0] = (fConst5 * ((2.0 * (fTemp47 + fVec16[1])) - (fConst6 * fRec47[1])));
		...
		double fTemp50 = ((fTemp49 + fTemp48) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec44[1]))) + 100000.0));
		fVec17[0] = fTemp50;
		fRec71[0] = (fConst66 * ((1500.0 * (fTemp50 + fVec17[1])) - (fConst67 * fRec71[1])));
		fRec44[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp48 + (fRec71[0] + fTemp49)) + -2.3148439999999999)))) + -95.677066666666661);
		fRec43[0] = (fConst2 * ((fConst3 * fRec43[1]) + (0.025000000000000001 * (fRec44[0] - fRec44[1]))));
		double fTemp51 = (fRec5[0] * fRec43[0]);
		fVec18[0] = fTemp51;
		fRec42[0] = (fConst5 * ((2.0 * (fTemp51 + fVec18[1])) - (fConst6 * fRec42[1])));
		...
		double fTemp54 = ((fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec39[1]))) + 100000.0));
		fVec19[0] = fTemp54;
		fRec72[0] = (fConst69 * ((820.0 * (fTemp54 + fVec19[1])) - (fConst70 * fRec72[1])));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp52 + (fRec72[0] + fTemp53)) + -1.3565670000000001)))) + -84.564999999999998);
		fRec38[0] = (fConst2 * ((fConst3 * fRec38[1]) + (0.025000000000000001 * (fRec39[0] - fRec39[1]))));
		output1[i0] = FAUSTFLOAT((2.0 * (fRec37[0] * fRec38[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
