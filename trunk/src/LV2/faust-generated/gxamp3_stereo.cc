...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst5 = 1.0 - fConst4;
	double fConst6 = std::tan(942.4777960769379 / fConst0);
	double fConst7 = mydsp_faustpower2_f(fConst6);
	fConst8 = 2.0 * (1.0 - 1.0 / fConst7);
	double fConst9 = 1.0 / fConst6;
	fConst10 = (fConst9 + -1.0000000000000004) / fConst6 + 1.0;
	double fConst11 = (fConst9 + 1.0000000000000004) / fConst6 + 1.0;
	fConst12 = 1.0 / fConst11;
	double fConst13 = std::tan(3769.9111843077517 / fConst0);
	double fConst14 = mydsp_faustpower2_f(fConst13);
	fConst15 = 2.0 * (1.0 - 1.0 / fConst14);
	double fConst16 = 1.0 / fConst13;
	fConst17 = (fConst16 + -1.0000000000000004) / fConst13 + 1.0;
	double fConst18 = (fConst16 + 1.0000000000000004) / fConst13 + 1.0;
	fConst19 = 1.0 / fConst18;
	double fConst20 = std::tan(10053.096491487338 / fConst0);
	...
	double fConst38 = fConst16 + 1.0;
	fConst39 = 1.0 / fConst38;
	fConst40 = 1.0 - fConst9;
	double fConst41 = fConst9 + 1.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp5;
		fRec22[0] = -(fConst34 * (fConst3 * fRec22[1] - fConst33 * (fTemp5 - fVec0[1])));
		...
		fVec1[0] = fTemp6;
		fRec19[0] = -(fConst39 * (fConst37 * fRec19[1] - fConst26 * (fTemp6 + fVec1[1])));
		fRec18[0] = fRec19[0] - fConst19 * (fConst17 * fRec18[2] + fConst15 * fRec18[1]);
		double fTemp7 = fRec18[2] + fRec18[0] + 2.0 * fRec18[1];
		fVec2[0] = fTemp7;
		fRec17[0] = -(fConst42 * (fConst40 * fRec17[1] - fConst19 * (fTemp7 + fVec2[1])));
		...
		fRec25[0] = -(fConst42 * (fConst40 * fRec25[1] - fConst43 * (fTemp7 - fVec2[1])));
		...
		fRec27[0] = fConst49 * (fRec28[2] + (fRec28[0] - 2.0 * fRec28[1])) - fConst48 * (fConst47 * fRec27[2] + fTemp11);
		fRec26[0] = fRec27[2] + fConst48 * (fTemp11 + fConst47 * fRec27[0]) - fConst46 * (fConst45 * fRec26[2] + fTemp10);
		double fTemp12 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec26[2] + fConst46 * (fTemp10 + fConst45 * fRec26[0]))));
		double fTemp13 = fConst8 * fRec30[1];
		fRec32[0] = -(fConst39 * (fConst37 * fRec32[1] - fConst50 * (fTemp6 - fVec1[1])));
		fRec31[0] = fRec32[0] - fConst19 * (fConst17 * fRec31[2] + fConst15 * fRec31[1]);
		fRec30[0] = fConst51 * (fRec31[2] + (fRec31[0] - 2.0 * fRec31[1])) - fConst46 * (fConst45 * fRec30[2] + fTemp13);
		double fTemp14 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec30[2] + fConst46 * (fTemp13 + fConst45 * fRec30[0]))));
		...
		fVec3[0] = fTemp15;
		fRec15[0] = -(fConst52 * (fConst5 * fRec15[1] - (fTemp15 + fVec3[1])));
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AU7_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec33[0] = fConst55 * (2.7e+03 * (fTemp19 + fVec5[1]) - fConst54 * fRec33[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp18 + fRec33[0] + fTemp17 + -3.718962) + -112.26066666666668;
		double fTemp20 = fRec11[0] - fRec11[1];
		fRec10[0] = fConst34 * (fConst56 * fTemp20 - fConst3 * fRec10[1]);
		fRec34[0] = fConst59 * (fConst58 * fRec34[1] + 0.025 * fTemp20);
		fRec35[0] = fSlow12 + 0.999 * fRec35[1];
		double fTemp21 = fRec35[0] * ((iSlow1) ? fRec34[0] : fRec10[0]);
		fVec6[0] = fTemp21;
		fRec9[0] = fConst52 * (2.0 * (fTemp21 + fVec6[1]) - fConst5 * fRec9[1]);
		...
		double fTemp24 = (fTemp22 + fTemp23) / (Ranode(TUBE_TABLE_12AU7_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp24;
		fRec36[0] = fConst62 * (1.5e+03 * (fTemp24 + fVec7[1]) - fConst61 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp23 + fRec36[0] + fTemp22 + -2.314844) + -95.67706666666666;
		double fTemp25 = fRec6[0] - fRec6[1];
		fRec5[0] = fConst34 * (fConst56 * fTemp25 - fConst3 * fRec5[1]);
		fRec37[0] = fConst59 * (fConst58 * fRec37[1] + 0.025 * fTemp25);
		double fTemp26 = fRec35[0] * ((iSlow1) ? fRec37[0] : fRec5[0]);
		fVec8[0] = fTemp26;
		fRec4[0] = fConst52 * (2.0 * (fTemp26 + fVec8[1]) - fConst5 * fRec4[1]);
		...
		double fTemp29 = (fTemp27 + fTemp28) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp29;
		fRec38[0] = fConst65 * (8.2e+02 * (fTemp29 + fVec9[1]) - fConst64 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp28 + fRec38[0] + fTemp27 + -1.356567) + -84.565;
		double fTemp30 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst34 * (fConst56 * fTemp30 - fConst3 * fRec0[1]);
		fRec39[0] = fConst59 * (fConst58 * fRec39[1] + 0.025 * fTemp30);
		fRec40[0] = fSlow13 + 0.999 * fRec40[1];
		output0[i0] = FAUSTFLOAT(2.0 * fRec40[0] * ((iSlow0) ? fRec39[0] : fRec0[0]));
		double fTemp31 = double(input1[i0]);
		double fTemp32 = fTemp31 * fRec14[0];
		double fTemp33 = fTemp31 * fTemp2;
		double fTemp34 = fTemp33 + 1e-15;
		fRec63[0] = fTemp32 + (1e-15 - fConst32 * (fConst30 * fRec63[2] + fConst28 * fRec63[1]));
		double fTemp35 = fRec63[2] + fRec63[0] + 2.0 * fRec63[1];
		fVec10[0] = fTemp35;
		fRec62[0] = -(fConst34 * (fConst3 * fRec62[1] - fConst33 * (fTemp35 - fVec10[1])));
		fRec61[0] = -(fConst36 * (fConst35 * fRec61[1] - (fRec62[0] + fRec62[1])));
		fRec60[0] = fRec61[0] - fConst26 * (fConst24 * fRec60[2] + fConst22 * fRec60[1]);
		double fTemp36 = fRec60[2] + fRec60[0] + 2.0 * fRec60[1];
		fVec11[0] = fTemp36;
		fRec59[0] = -(fConst39 * (fConst37 * fRec59[1] - fConst26 * (fTemp36 + fVec11[1])));
		fRec58[0] = fRec59[0] - fConst19 * (fConst17 * fRec58[2] + fConst15 * fRec58[1]);
		double fTemp37 = fRec58[2] + fRec58[0] + 2.0 * fRec58[1];
		fVec12[0] = fTemp37;
		fRec57[0] = -(fConst42 * (fConst40 * fRec57[1] - fConst19 * (fTemp37 + fVec12[1])));
		fRec56[0] = fRec57[0] - fConst12 * (fConst10 * fRec56[2] + fConst8 * fRec56[1]);
		double fTemp38 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * (fRec56[2] + fRec56[0] + 2.0 * fRec56[1])));
		fRec65[0] = -(fConst42 * (fConst40 * fRec65[1] - fConst43 * (fTemp37 - fVec12[1])));
		fRec64[0] = fRec65[0] - fConst12 * (fConst10 * fRec64[2] + fConst8 * fRec64[1]);
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, fSlow8 * (fRec64[2] + (fRec64[0] - 2.0 * fRec64[1]))));
		double fTemp40 = fConst8 * fRec66[1];
		double fTemp41 = fConst15 * fRec67[1];
		fRec69[0] = -(fConst36 * (fConst35 * fRec69[1] - fConst23 * (fRec62[0] - fRec62[1])));
		fRec68[0] = fRec69[0] - fConst26 * (fConst24 * fRec68[2] + fConst22 * fRec68[1]);
		fRec67[0] = fConst49 * (fRec68[2] + (fRec68[0] - 2.0 * fRec68[1])) - fConst48 * (fConst47 * fRec67[2] + fTemp41);
		fRec66[0] = fRec67[2] + fConst48 * (fTemp41 + fConst47 * fRec67[0]) - fConst46 * (fConst45 * fRec66[2] + fTemp40);
		double fTemp42 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec66[2] + fConst46 * (fTemp40 + fConst45 * fRec66[0]))));
		double fTemp43 = fConst8 * fRec70[1];
		fRec72[0] = -(fConst39 * (fConst37 * fRec72[1] - fConst50 * (fTemp36 - fVec11[1])));
		fRec71[0] = fRec72[0] - fConst19 * (fConst17 * fRec71[2] + fConst15 * fRec71[1]);
		fRec70[0] = fConst51 * (fRec71[2] + (fRec71[0] - 2.0 * fRec71[1])) - fConst46 * (fConst45 * fRec70[2] + fTemp43);
		double fTemp44 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec70[2] + fConst46 * (fTemp43 + fConst45 * fRec70[0]))));
		double fTemp45 = 1.333521432 * fTemp44 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp44)) + 1.584893192 * (fTemp42 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp42)) + fTemp39 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp39))) + 1.2589412 * fTemp38 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp38));
		fVec13[0] = fTemp45;
		fRec55[0] = -(fConst52 * (fConst5 * fRec55[1] - (fTemp45 + fVec13[1])));
		double fTemp46 = fSlow11 * fRec55[0] + fTemp33 + fSlow6 * (4.0 * fTemp34 * (1.0 - std::fabs(fTemp34)) + (-1e-15 - fTemp33)) + fSlow5 * (fTemp32 + 1e-15) + 1e-15;
		fVec14[0] = fTemp46;
		fRec54[0] = 0.9302847925323914 * (fTemp46 + fVec14[1]) - 0.8605695850647829 * fRec54[1];
		fRec53[0] = fRec54[0] - (1.8405051250752198 * fRec53[1] + 0.8612942439318627 * fRec53[2]);
		double fTemp47 = 1.8508996845035413 * fRec53[1];
		double fTemp48 = 0.9254498422517706 * (fRec53[0] + fRec53[2]);
		double fTemp49 = (fTemp47 + fTemp48) / (Ranode(TUBE_TABLE_12AU7_68k, fRec52[1]) + 1e+05);
		fVec15[0] = fTemp49;
		fRec73[0] = fConst55 * (2.7e+03 * (fTemp49 + fVec15[1]) - fConst54 * fRec73[1]);
		fRec52[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp48 + fRec73[0] + fTemp47 + -3.718962) + -112.26066666666668;
		double fTemp50 = fRec52[0] - fRec52[1];
		fRec51[0] = fConst34 * (fConst56 * fTemp50 - fConst3 * fRec51[1]);
		fRec74[0] = fConst59 * (fConst58 * fRec74[1] + 0.025 * fTemp50);
		double fTemp51 = fRec35[0] * ((iSlow1) ? fRec74[0] : fRec51[0]);
		fVec16[0] = fTemp51;
		fRec50[0] = fConst52 * (2.0 * (fTemp51 + fVec16[1]) - fConst5 * fRec50[1]);
		...
		double fTemp52 = 1.8508996845035413 * fRec48[1];
		double fTemp53 = 0.9254498422517706 * (fRec48[0] + fRec48[2]);
		double fTemp54 = (fTemp52 + fTemp53) / (Ranode(TUBE_TABLE_12AU7_250k, fRec47[1]) + 1e+05);
		fVec17[0] = fTemp54;
		fRec75[0] = fConst62 * (1.5e+03 * (fTemp54 + fVec17[1]) - fConst61 * fRec75[1]);
		fRec47[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp53 + fRec75[0] + fTemp52 + -2.314844) + -95.67706666666666;
		double fTemp55 = fRec47[0] - fRec47[1];
		fRec46[0] = fConst34 * (fConst56 * fTemp55 - fConst3 * fRec46[1]);
		fRec76[0] = fConst59 * (fConst58 * fRec76[1] + 0.025 * fTemp55);
		double fTemp56 = fRec35[0] * ((iSlow1) ? fRec76[0] : fRec46[0]);
		fVec18[0] = fTemp56;
		fRec45[0] = fConst52 * (2.0 * (fTemp56 + fVec18[1]) - fConst5 * fRec45[1]);
		...
		double fTemp57 = 1.8508996845035413 * fRec43[1];
		double fTemp58 = 0.9254498422517706 * (fRec43[0] + fRec43[2]);
		double fTemp59 = (fTemp57 + fTemp58) / (Ranode(TUBE_TABLE_12AU7_250k, fRec42[1]) + 1e+05);
		fVec19[0] = fTemp59;
		fRec77[0] = fConst65 * (8.2e+02 * (fTemp59 + fVec19[1]) - fConst64 * fRec77[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp58 + fRec77[0] + fTemp57 + -1.356567) + -84.565;
		double fTemp60 = fRec42[0] - fRec42[1];
		fRec41[0] = fConst34 * (fConst56 * fTemp60 - fConst3 * fRec41[1]);
		fRec78[0] = fConst59 * (fConst58 * fRec78[1] + 0.025 * fTemp60);
		output1[i0] = FAUSTFLOAT(2.0 * fRec40[0] * ((iSlow0) ? fRec78[0] : fRec41[0]));
		fRec14[1] = fRec14[0];
		fRec23[2] = fRec23[1];
		fRec23[1] = fRec23[0];
		fVec0[1] = fVec0[0];
