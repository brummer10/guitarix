...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = ((fTemp18 + fTemp17) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp19;
		fRec34[0] = (fConst63 * ((2700.0 * (fTemp19 + fVec5[1])) - (fConst64 * fRec34[1])));
		double fTemp20 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp17 + (fRec34[0] + fTemp18)) + -3.7189619999999999))));
		fRec12[0] = ((fTemp20 + (0.0013773933333333334 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp20))) + 100000.0))) + -250.0);
		fRec11[0] = (fConst2 * ((fConst3 * fRec11[1]) + (0.025000000000000001 * (fRec12[0] - fRec12[1]))));
		double fTemp21 = (fRec11[0] * fRec5[0]);
		fVec6[0] = fTemp21;
		fRec10[0] = (fConst5 * ((2.0 * (fTemp21 + fVec6[1])) - (fConst6 * fRec10[1])));
		...
		double fTemp24 = ((fTemp23 + fTemp22) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp24;
		fRec35[0] = (fConst66 * ((1500.0 * (fTemp24 + fVec7[1])) - (fConst67 * fRec35[1])));
		double fTemp25 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp22 + (fRec35[0] + fTemp23)) + -2.3148439999999999))));
		fRec7[0] = ((fTemp25 + (0.0015432293333333333 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp25))) + 100000.0))) + -250.0);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.025000000000000001 * (fRec7[0] - fRec7[1]))));
		double fTemp26 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp26;
		fRec4[0] = (fConst5 * ((2.0 * (fTemp26 + fVec8[1])) - (fConst6 * fRec4[1])));
		...
		double fTemp29 = ((fTemp28 + fTemp27) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp29;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp29 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp30 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp27 + (fRec36[0] + fTemp28)) + -1.3565670000000001))));
		fRec1[0] = ((fTemp30 + (0.0016543500000000002 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp30))) + 100000.0))) + -250.0);
		...
		double fTemp32 = (fTemp31 * fRec23[0]);
		fRec59[0] = (fTemp32 + (1.0000000000000001e-15 - (fConst22 * ((fConst27 * fRec59[2]) + (fConst28 * fRec59[1])))));
		double fTemp33 = (fRec59[2] + (fRec59[0] + (2.0 * fRec59[1])));
		fVec10[0] = fTemp33;
		fRec58[0] = ((fConst22 * ((fConst26 * fTemp33) + (fConst29 * fVec10[1]))) - (fConst30 * fRec58[1]));
		...
		fVec11[0] = fTemp34;
		fRec55[0] = ((fConst14 * ((fConst16 * fTemp34) + (fConst35 * fVec11[1]))) - (fConst37 * fRec55[1]));
		fRec54[0] = (fRec55[0] - (fConst9 * ((fConst38 * fRec54[2]) + (fConst39 * fRec54[1]))));
		double fTemp35 = (fConst49 * fRec53[1]);
		fRec53[0] = ((fConst9 * (((fConst11 * fRec54[0]) + (fConst40 * fRec54[1])) + (fConst11 * fRec54[2]))) - (fConst44 * ((fConst46 * fRec53[2]) + fTemp35)));
		double fTemp36 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec53[2] + (fConst44 * (fTemp35 + (fConst46 * fRec53[0])))))));
		...
		double fTemp37 = (fConst39 * fRec61[1]);
		fRec61[0] = ((fConst14 * (((fConst33 * fRec62[0]) + (fConst51 * fRec62[1])) + (fConst33 * fRec62[2]))) - (fConst52 * ((fConst53 * fRec61[2]) + fTemp37)));
		double fTemp38 = (fConst49 * fRec60[1]);
		fRec60[0] = ((fRec61[2] + (fConst52 * (fTemp37 + (fConst53 * fRec61[0])))) - (fConst44 * ((fConst46 * fRec60[2]) + fTemp38)));
		double fTemp39 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec60[2] + (fConst44 * (fTemp38 + (fConst46 * fRec60[0])))))));
		fRec67[0] = (0.0 - (fConst56 * ((fConst36 * fRec67[1]) - (fConst14 * (fTemp34 + fVec11[1])))));
		fRec66[0] = (fRec67[0] - (fConst9 * ((fConst38 * fRec66[2]) + (fConst39 * fRec66[1]))));
		double fTemp40 = (fRec66[2] + (fRec66[0] + (2.0 * fRec66[1])));
		fVec12[0] = fTemp40;
		fRec65[0] = ((fConst9 * ((fConst55 * fTemp40) + (fConst57 * fVec12[1]))) - (fConst58 * fRec65[1]));
		fRec64[0] = (fRec65[0] - (fConst54 * ((fConst59 * fRec64[2]) + (fConst49 * fRec64[1]))));
		double fTemp41 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst48 * fRec64[0]) + (fConst60 * fRec64[1])) + (fConst48 * fRec64[2])))));
		fRec69[0] = (0.0 - (fConst61 * ((fConst45 * fRec69[1]) - (fConst9 * (fTemp40 + fVec12[1])))));
		...
		fVec13[0] = fTemp43;
		fRec52[0] = (0.0 - (fConst5 * ((fConst6 * fRec52[1]) - (fTemp43 + fVec13[1]))));
		double fTemp44 = (fTemp31 * fTemp13);
		double fTemp45 = (fTemp44 + 1.0000000000000001e-15);
		double fTemp46 = (((fSlow3 * fRec52[0]) + ((fTemp44 + (fSlow9 * ((4.0 * (fTemp45 * (1.0 - std::fabs(fTemp45)))) + (-1.0000000000000001e-15 - fTemp44)))) + (fSlow10 * (fTemp32 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15);
		fVec14[0] = fTemp46;
		fRec51[0] = ((0.93028479253239138 * (fTemp46 + fVec14[1])) - (0.86056958506478287 * fRec51[1]));
		fRec50[0] = (fRec51[0] - ((1.8405051250752198 * fRec50[1]) + (0.86129424393186271 * fRec50[2])));
		double fTemp47 = (0.92544984225177063 * (fRec50[0] + fRec50[2]));
		double fTemp48 = (1.8508996845035413 * fRec50[1]);
		double fTemp49 = ((fTemp48 + fTemp47) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec49[1]))) + 100000.0));
		fVec15[0] = fTemp49;
		fRec70[0] = (fConst63 * ((2700.0 * (fTemp49 + fVec15[1])) - (fConst64 * fRec70[1])));
		double fTemp50 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp47 + (fRec70[0] + fTemp48)) + -3.7189619999999999))));
		fRec49[0] = ((fTemp50 + (0.0013773933333333334 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp50))) + 100000.0))) + -250.0);
		fRec48[0] = (fConst2 * ((fConst3 * fRec48[1]) + (0.025000000000000001 * (fRec49[0] - fRec49[1]))));
		double fTemp51 = (fRec5[0] * fRec48[0]);
		fVec16[0] = fTemp51;
		fRec47[0] = (fConst5 * ((2.0 * (fTemp51 + fVec16[1])) - (fConst6 * fRec47[1])));
		...
		double fTemp52 = (0.92544984225177063 * (fRec45[0] + fRec45[2]));
		double fTemp53 = (1.8508996845035413 * fRec45[1]);
		double fTemp54 = ((fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec44[1]))) + 100000.0));
		fVec17[0] = fTemp54;
		fRec71[0] = (fConst66 * ((1500.0 * (fTemp54 + fVec17[1])) - (fConst67 * fRec71[1])));
		double fTemp55 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp52 + (fRec71[0] + fTemp53)) + -2.3148439999999999))));
		fRec44[0] = ((fTemp55 + (0.0015432293333333333 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp55))) + 100000.0))) + -250.0);
		fRec43[0] = (fConst2 * ((fConst3 * fRec43[1]) + (0.025000000000000001 * (fRec44[0] - fRec44[1]))));
		double fTemp56 = (fRec5[0] * fRec43[0]);
		fVec18[0] = fTemp56;
		fRec42[0] = (fConst5 * ((2.0 * (fTemp56 + fVec18[1])) - (fConst6 * fRec42[1])));
		...
		double fTemp57 = (0.92544984225177063 * (fRec40[0] + fRec40[2]));
		double fTemp58 = (1.8508996845035413 * fRec40[1]);
		double fTemp59 = ((fTemp58 + fTemp57) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec39[1]))) + 100000.0));
		fVec19[0] = fTemp59;
		fRec72[0] = (fConst69 * ((820.0 * (fTemp59 + fVec19[1])) - (fConst70 * fRec72[1])));
		double fTemp60 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp57 + (fRec72[0] + fTemp58)) + -1.3565670000000001))));
		fRec39[0] = ((fTemp60 + (0.0016543500000000002 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp60))) + 100000.0))) + -250.0);
