...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec12[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp17 + fRec34[0] + fTemp18 + -3.7189619999999999))) + -112.26066666666668;
		...
		fVec6[0] = fTemp20;
		fRec10[0] = fConst6 * (2.0 * (fTemp20 + fVec6[1]) - fConst7 * fRec10[1]);
		...
		double fTemp23 = (fTemp22 + fTemp21) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec7[1]))) + 100000.0);
		fVec7[0] = fTemp23;
		fRec36[0] = fConst66 * (1500.0 * (fTemp23 + fVec7[1]) - fConst67 * fRec36[1]);
		fRec7[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp21 + fRec36[0] + fTemp22 + -2.3148439999999999))) + -95.677066666666661;
		...
		fVec8[0] = fTemp24;
		fRec4[0] = fConst6 * (2.0 * (fTemp24 + fVec8[1]) - fConst7 * fRec4[1]);
		...
		double fTemp27 = (fTemp26 + fTemp25) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0);
		fVec9[0] = fTemp27;
		fRec38[0] = fConst69 * (820.0 * (fTemp27 + fVec9[1]) - fConst70 * fRec38[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp25 + fRec38[0] + fTemp26 + -1.3565670000000001))) + -84.564999999999998;
		...
		output0[i0] = FAUSTFLOAT(2.0 * ((iSlow0) ? fRec39[0] : fRec0[0]) * fRec40[0]);
		...
		double fTemp46 = (fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec52[1]))) + 100000.0);
		fVec15[0] = fTemp46;
		fRec73[0] = fConst60 * (2700.0 * (fTemp46 + fVec15[1]) - fConst61 * fRec73[1]);
		fRec52[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp44 + fRec73[0] + fTemp45 + -3.7189619999999999))) + -112.26066666666668;
		...
		fVec16[0] = fTemp47;
		fRec50[0] = fConst6 * (2.0 * (fTemp47 + fVec16[1]) - fConst7 * fRec50[1]);
		...
		double fTemp50 = (fTemp49 + fTemp48) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec47[1]))) + 100000.0);
		fVec17[0] = fTemp50;
		fRec75[0] = fConst66 * (1500.0 * (fTemp50 + fVec17[1]) - fConst67 * fRec75[1]);
		fRec47[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp48 + fRec75[0] + fTemp49 + -2.3148439999999999))) + -95.677066666666661;
		...
		fVec18[0] = fTemp51;
		fRec45[0] = fConst6 * (2.0 * (fTemp51 + fVec18[1]) - fConst7 * fRec45[1]);
		...
		double fTemp54 = (fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec42[1]))) + 100000.0);
		fVec19[0] = fTemp54;
		fRec77[0] = fConst69 * (820.0 * (fTemp54 + fVec19[1]) - fConst70 * fRec77[1]);
		fRec42[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp52 + fRec77[0] + fTemp53 + -1.3565670000000001))) + -84.564999999999998;
