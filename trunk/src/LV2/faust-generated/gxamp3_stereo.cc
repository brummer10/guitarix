...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec29[0] = ((fConst44 * fRec29[1]) + (fConst43 * ((fConst53 * fVec3[1]) + (fConst8 * fVec3[0]))));
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * fRec12[0]) + ((fSlow6 * fTemp5) + ((fSlow4 * ((fTemp4 * (4 - (4 * fabs(fTemp4)))) - fTemp4)) + (fRec11[0] + fTemp2)))) - 3.7189619999999977)) - 112.26066666666668);
		fRec8[0] = ((fConst35 * fRec8[1]) + (fConst59 * ((fConst31 * fRec9[0]) + (fConst32 * fRec9[1]))));
		double fTemp17 = (fRec8[0] * fRec7[0]);
		fVec5[0] = fTemp17;
		fRec6[0] = ((fConst58 * fRec6[1]) + (fConst60 * (fVec5[0] + fVec5[1])));
		double fTemp18 = (1e-15 + (0.015 * fRec5[1]));
		fVec6[0] = fTemp18;
		fRec30[0] = ((fConst64 * fRec30[1]) + (fConst63 * (fVec6[0] + fVec6[1])));
		...
		fVec7[0] = fTemp19;
		fRec3[0] = ((fConst58 * fRec3[1]) + (fConst60 * (fVec7[0] + fVec7[1])));
		double fTemp20 = (1e-15 + (0.0082 * fRec2[1]));
		fVec8[0] = fTemp20;
		fRec31[0] = ((fConst68 * fRec31[1]) + (fConst67 * (fVec8[0] + fVec8[1])));
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * fRec41[0]) + ((fSlow6 * fTemp25) + ((fSlow4 * ((fTemp24 * (4 - (4 * fabs(fTemp24)))) - fTemp24)) + (fRec40[0] + fTemp22)))) - 3.7189619999999977)) - 112.26066666666668);
		fRec38[0] = ((fConst35 * fRec38[1]) + (fConst59 * ((fConst31 * fRec39[0]) + (fConst32 * fRec39[1]))));
		double fTemp37 = (fRec7[0] * fRec38[0]);
		fVec14[0] = fTemp37;
		fRec37[0] = ((fConst58 * fRec37[1]) + (fConst60 * (fVec14[0] + fVec14[1])));
		double fTemp38 = (1e-15 + (0.015 * fRec36[1]));
		fVec15[0] = fTemp38;
		fRec59[0] = ((fConst64 * fRec59[1]) + (fConst63 * (fVec15[0] + fVec15[1])));
		...
		fVec16[0] = fTemp39;
		fRec34[0] = ((fConst58 * fRec34[1]) + (fConst60 * (fVec16[0] + fVec16[1])));
		double fTemp40 = (1e-15 + (0.0082 * fRec33[1]));
		fVec17[0] = fTemp40;
		fRec60[0] = ((fConst68 * fRec60[1]) + (fConst67 * (fVec17[0] + fVec17[1])));
