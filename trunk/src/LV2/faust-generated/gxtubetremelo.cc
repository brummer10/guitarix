...
#define fslider2 (*fslider2_)
	...
	for (int i=0; i<count; i++) {
		iVec0[0] = 1;
		double fTemp0 = (fRec2[1] * (1 - (fConst1 / (fConst1 + (0.06 * exp((0 - (2.4849066497880004 * fRec2[1]))))))));
		iRec4[0] = ((int((iRec4[1] > 0)))?((2 * (iRec3[1] < iSlow1)) - 1):(1 - (2 * (iRec3[1] > 0))));
		iRec3[0] = (iRec4[0] + iRec3[1]);
		fRec7[0] = (fRec7[1] + (fSlow3 * (0 - fRec5[1])));
		fRec6[0] = ((1 + (fRec6[1] + (fSlow3 * fRec7[0]))) - iVec0[1]);
		fRec5[0] = fRec6[0];
		fRec2[0] = (fTemp0 + (fConst1 * (pow((1 + (fSlow5 * (((iSlow4)?max((double)0, (0.5 * (1 + fRec5[0]))):(fSlow2 * iRec3[0])) - 1))),1.9) / (fConst1 + (0.06 * exp((0 - (2.4849066497880004 * fTemp0))))))));
		fRec8[0] = ((0.999 * fRec8[1]) + fSlow6);
		double fTemp1 = (1e-15 + (0.015 * fRec10[1]));
		fVec1[0] = fTemp1;
		fRec11[0] = ((fConst7 * fRec11[1]) + (fConst6 * (fVec1[0] + fVec1[1])));
		...
		fVec2[0] = fTemp2;
		fRec12[0] = ((fConst7 * fRec12[1]) + (fConst6 * (fVec2[0] + fVec2[1])));
