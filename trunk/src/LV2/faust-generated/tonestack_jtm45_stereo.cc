...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = ((1.784904e-05 * fSlow2) + (fSlow0 * ((1.2248500000000003e-05 * fSlow2) - (5.596250000000005e-08 + fSlow1))));
	double 	fSlow4 = (5.442360000000002e-07 + fSlow3);
	double 	fSlow5 = (2.3114025000000008e-11 * fSlow0);
	double 	fSlow6 = (9.245610000000004e-10 * fSlow2);
	double 	fSlow7 = (1.0781100000000005e-09 * fSlow2);
	double 	fSlow8 = (2.695275000000001e-11 + (fSlow7 + (fSlow0 * (fSlow6 - (fSlow5 + 3.8387250000000005e-12)))));
	double 	fSlow9 = (fConst1 * fSlow8);
	double 	fSlow10 = (0.02227 * fSlow2);
	double 	fSlow11 = (0.00055 * fSlow0);
	double 	fSlow12 = (fConst1 * (0.00207625 + (fSlow11 + fSlow10)));
	...
	double 	fSlow16 = ((fConst2 * (5.442360000000002e-07 + (fSlow3 + fSlow14))) - (3 + fSlow12));
	double 	fSlow17 = (1.0 / (0 - (1 + (fSlow12 + (fConst2 * (5.442360000000002e-07 + (fSlow3 + fSlow9)))))));
	double 	fSlow18 = double(fslider2);
	double 	fSlow19 = ((fSlow0 * ((2.3114025000000008e-11 + fSlow6) - fSlow5)) + (fSlow18 * ((2.695275000000001e-11 + fSlow7) - (2.695275000000001e-11 * fSlow0))));
	double 	fSlow20 = (fConst1 * fSlow19);
	double 	fSlow21 = (((9.801000000000002e-08 * fSlow18) + (fSlow0 * (3.433375000000001e-07 - fSlow1))) + (fSlow2 * (1.8770400000000002e-06 + (1.2248500000000003e-05 * fSlow0))));
	double 	fSlow22 = (fSlow21 + 4.6926e-08);
	double 	fSlow23 = ((fSlow10 + (fSlow11 + (6.75e-05 * fSlow18))) + 0.0005567500000000001);
	...
	double 	fSlow29 = (fSlow28 + (fConst2 * (4.6926e-08 + (fSlow21 + fSlow26))));
	double 	fSlow30 = (fSlow28 - (fConst2 * (4.6926e-08 + (fSlow21 + fSlow20))));
