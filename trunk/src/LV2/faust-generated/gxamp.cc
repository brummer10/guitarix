...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp20 + fRec36[0] + fTemp21 + -1.204285))) + -169.71433333333334;
		...
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp24 + fRec38[0] + fTemp25 + -0.84070299999999998))) + -147.47524390243905;
