...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp18 = (fTemp16 + fTemp17) / (Ranode(TUBE_TABLE_12AX7_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp18;
		fRec33[0] = fConst61 * (2.7e+03 * (fTemp18 + fVec5[1]) - fConst60 * fRec33[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp17 + fRec33[0] + fTemp16 + -1.581656) + -191.42014814814814;
		...
		double fTemp22 = (fTemp20 + fTemp21) / (Ranode(TUBE_TABLE_12AX7_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp22;
		fRec36[0] = fConst67 * (1.5e+03 * (fTemp22 + fVec7[1]) - fConst66 * fRec36[1]);
		fRec6[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp21 + fRec36[0] + fTemp20 + -1.204285) + -169.71433333333334;
		...
		double fTemp26 = (fTemp24 + fTemp25) / (Ranode(TUBE_TABLE_12AX7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp26;
		fRec38[0] = fConst70 * (8.2e+02 * (fTemp26 + fVec9[1]) - fConst69 * fRec38[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp25 + fRec38[0] + fTemp24 + -0.840703) + -147.47524390243905;
