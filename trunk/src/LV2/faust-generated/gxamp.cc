...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = ((double)input0[i] + (4.656612875245797e-14 * iRec18[0]));
		fRec19[0] = (fSlow2 + (0.999 * fRec19[1]));
		double fTemp2 = (1e-15 + (fRec19[0] * fTemp1));
		fRec17[0] = (fTemp2 - (fConst36 * ((fConst34 * fRec17[2]) + (fConst32 * fRec17[1]))));
		...
		double fTemp5 = max(-1, min(1, (fSlow4 * (fRec11[2] + (fConst12 * (fTemp0 + (fConst11 * fRec11[0])))))));
		fRec23[0] = ((fConst41 * (fVec1[0] + fVec1[1])) + (fConst21 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst19 * ((fConst17 * fRec22[2]) + (fConst15 * fRec22[1]))));
		double fTemp6 = (fRec22[2] + (fRec22[0] + (2 * fRec22[1])));
		fVec2[0] = fTemp6;
		fRec21[0] = ((fConst48 * ((fConst47 * fVec2[1]) + (fConst10 * fVec2[0]))) + (fConst46 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fConst44 * ((fConst43 * fRec20[2]) + (fConst9 * fRec20[1]))));
		double fTemp7 = max(-1, min(1, (fSlow5 * (((fConst8 * fRec20[0]) + (fConst49 * fRec20[1])) + (fConst8 * fRec20[2])))));
		double fTemp8 = (fConst9 * fRec24[1]);
		double fTemp9 = (fConst15 * fRec25[1]);
		fRec27[0] = ((fConst39 * ((fConst52 * fRec16[1]) + (fConst25 * fRec16[0]))) + (fConst30 * fRec27[1]));
		fRec26[0] = (fRec27[0] - (fConst28 * ((fConst26 * fRec26[2]) + (fConst24 * fRec26[1]))));
		fRec25[0] = ((fConst28 * (((fConst23 * fRec26[0]) + (fConst53 * fRec26[1])) + (fConst23 * fRec26[2]))) - (fConst51 * ((fConst50 * fRec25[2]) + fTemp9)));
		fRec24[0] = ((fRec25[2] + (fConst51 * (fTemp9 + (fConst50 * fRec25[0])))) - (fConst12 * ((fConst11 * fRec24[2]) + fTemp8)));
		double fTemp10 = max(-1, min(1, (fSlow6 * (fRec24[2] + (fConst12 * (fTemp8 + (fConst11 * fRec24[0])))))));
		fRec29[0] = ((fConst48 * (fVec2[0] + fVec2[1])) + (fConst46 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst44 * ((fConst43 * fRec28[2]) + (fConst9 * fRec28[1]))));
		double fTemp11 = max(-1, min(1, (fSlow7 * (fRec28[2] + (fRec28[0] + (2 * fRec28[1]))))));
		...
		double fTemp13 = (1e-15 + (0.027 * fRec9[1]));
		fVec4[0] = fTemp13;
		fRec30[0] = ((fConst58 * (fVec4[0] + fVec4[1])) + (fConst57 * fRec30[1]));
		double fTemp14 = ((1 - fRec19[0]) * fTemp1);
		double fTemp15 = (1e-15 + fTemp14);
		fRec9[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fSlow11 * ((fTemp15 * (4 - (4 * fabs(fTemp15)))) - fTemp15)) + (fTemp14 + ((fSlow10 * fTemp2) + (fRec30[0] + (fSlow9 * fRec10[0]))))) - 1.581655999999998)) - 191.42014814814814);
		fRec8[0] = ((fConst59 * ((fConst37 * fRec9[1]) + (fConst1 * fRec9[0]))) + (fConst3 * fRec8[1]));
		double fTemp16 = (fRec8[0] * fRec7[0]);
		fVec5[0] = fTemp16;
		fRec6[0] = ((fConst54 * (fVec5[0] + fVec5[1])) + (fConst6 * fRec6[1]));
		double fTemp17 = (1e-15 + (0.015 * fRec5[1]));
		fVec6[0] = fTemp17;
		fRec31[0] = ((fConst63 * (fVec6[0] + fVec6[1])) + (fConst62 * fRec31[1]));
		fRec5[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec31[0] + fRec6[0]) - 1.204284999999999)) - 169.71433333333334);
		fRec4[0] = ((fConst59 * ((fConst37 * fRec5[1]) + (fConst1 * fRec5[0]))) + (fConst3 * fRec4[1]));
		double fTemp18 = (fRec7[0] * fRec4[0]);
		fVec7[0] = fTemp18;
		fRec3[0] = ((fConst54 * (fVec7[0] + fVec7[1])) + (fConst6 * fRec3[1]));
		double fTemp19 = (1e-15 + (0.0082 * fRec2[1]));
		fVec8[0] = fTemp19;
		fRec32[0] = ((fConst67 * (fVec8[0] + fVec8[1])) + (fConst66 * fRec32[1]));
		fRec2[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec32[0] + fRec3[0]) - 0.840702999999999)) - 147.47524390243905);
