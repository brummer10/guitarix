...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (fTemp0 * (1 - fRec16[0]));
		...
		double fTemp7 = max((double)-1, min((double)1, (fSlow7 * (fRec18[2] + (fRec18[0] + (2 * fRec18[1]))))));
		double fTemp8 = (fConst3 * fRec26[1]);
		...
		fRec26[0] = ((fConst13 * (((fConst8 * fRec27[0]) + (fConst44 * fRec27[1])) + (fConst8 * fRec27[2]))) - (fConst42 * ((fConst41 * fRec26[2]) + fTemp8)));
		double fTemp9 = max((double)-1, min((double)1, (fSlow8 * (fRec26[2] + (fConst42 * (fTemp8 + (fConst41 * fRec26[0])))))));
		double fTemp10 = (fConst3 * fRec29[1]);
		double fTemp11 = (fConst9 * fRec30[1]);
		...
		fRec30[0] = ((fConst20 * (((fConst15 * fRec31[0]) + (fConst48 * fRec31[1])) + (fConst15 * fRec31[2]))) - (fConst46 * ((fConst45 * fRec30[2]) + fTemp11)));
		fRec29[0] = ((fRec30[2] + (fConst46 * (fTemp11 + (fConst45 * fRec30[0])))) - (fConst42 * ((fConst41 * fRec29[2]) + fTemp10)));
		double fTemp12 = max((double)-1, min((double)1, (fSlow9 * (fRec29[2] + (fConst42 * (fTemp10 + (fConst41 * fRec29[0])))))));
		...
		double fTemp13 = max((double)-1, min((double)1, (fSlow10 * (((fConst2 * fRec33[0]) + (fConst50 * fRec33[1])) + (fConst2 * fRec33[2])))));
		...
		double fTemp15 = (((fSlow11 * fRec17[0]) + ((fTemp2 + (fSlow6 * ((fTemp3 * (4 - (4 * fabs(fTemp3)))) - fTemp3))) + (fSlow5 * fTemp1))) + 2e-15);
		fVec4[0] = fTemp15;
		...
		double fTemp16 = (1e-15 + (0.027 * fRec13[1]));
		fVec5[0] = fTemp16;
		fRec35[0] = ((fConst58 * fRec35[1]) + (fConst57 * (fVec5[0] + fVec5[1])));
		fRec13[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec35[0] + (0.9254498422517706 * (fRec14[2] + (fRec14[0] + (2.0 * fRec14[1]))))) - 1.581656)) - 191.42014814814814);
		fRec12[0] = ((fConst31 * fRec12[1]) + (fConst59 * ((fConst27 * fRec13[0]) + (fConst28 * fRec13[1]))));
		double fTemp17 = (fRec12[0] * fRec11[0]);
		fVec6[0] = fTemp17;
		fRec10[0] = ((fConst54 * fRec10[1]) + (fConst53 * (fVec6[0] + fVec6[1])));
		double fTemp18 = (1e-15 + fRec10[0]);
		fVec7[0] = fTemp18;
		...
		double fTemp19 = (1e-15 + (0.015 * fRec7[1]));
		fVec8[0] = fTemp19;
		fRec36[0] = ((fConst63 * fRec36[1]) + (fConst62 * (fVec8[0] + fVec8[1])));
		fRec7[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec36[0] + (0.9254498422517706 * (fRec8[2] + (fRec8[0] + (2.0 * fRec8[1]))))) - 1.204285)) - 169.71433333333334);
		fRec6[0] = ((fConst31 * fRec6[1]) + (fConst59 * ((fConst27 * fRec7[0]) + (fConst28 * fRec7[1]))));
		double fTemp20 = (fRec11[0] * fRec6[0]);
		fVec9[0] = fTemp20;
		fRec5[0] = ((fConst54 * fRec5[1]) + (fConst53 * (fVec9[0] + fVec9[1])));
		double fTemp21 = (1e-15 + fRec5[0]);
		fVec10[0] = fTemp21;
		...
		double fTemp22 = (1e-15 + (0.0082 * fRec2[1]));
		fVec11[0] = fTemp22;
		fRec37[0] = ((fConst67 * fRec37[1]) + (fConst66 * (fVec11[0] + fVec11[1])));
		fRec2[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec37[0] + (0.9254498422517706 * (fRec3[2] + (fRec3[0] + (2.0 * fRec3[1]))))) - 0.840703)) - 147.47524390243905);
