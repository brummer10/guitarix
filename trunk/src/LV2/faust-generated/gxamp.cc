...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -1.581656)))) + -191.42014814814814);
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp20 + (fRec35[0] + fTemp21)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp26 = ((fTemp25 + fTemp24) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp26;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp26 + fVec9[1])) - (fConst70 * fRec36[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp24 + (fRec36[0] + fTemp25)) + -0.84070299999999998)))) + -147.47524390243905);
