...
#define fcheckbox0 (*fcheckbox0_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = ((fSlow3 * fRec0[1]) + (fConst20 * ((fRec10[0] * ((fRec8[0] * ((fRec9[1] * ((fConst1 * (fRec7[0] * ((8.60518628073643e-12 * fRec7[0]) - 2.04803433481527e-11))) - 7.37587395491694e-09)) + (fRec9[3] * (7.37587395491694e-09 + (fConst1 * (fRec7[0] * ((2.86839542691214e-12 * fRec7[0]) - 6.82678111605089e-12))))))) + ((fRec9[0] * (fTemp1 + (fConst1 * (fRec7[0] * ((fRec7[0] * (0 - (2.86839542691214e-12 * fRec8[0]))) + (6.82678111605089e-12 * fRec8[0])))))) + (fRec9[2] * ((fConst1 * (fRec7[0] * ((2.04803433481527e-11 * fRec8[0]) + (fRec7[0] * (0 - (8.60518628073643e-12 * fRec8[0])))))) - fTemp1))))) / fTemp0)));
		double fTemp3 = (fTemp2 * (fTemp2 <= 0.0));
		fVec0[0] = (1e-15 + fTemp3);
		fRec6[0] = ((0.9302847925323914 * (1e-15 + (fTemp3 + fVec0[1]))) - (0.8605695850647829 * fRec6[1]));
		fRec5[0] = (fRec6[0] - ((1.8405051250752198 * fRec5[1]) + (0.8612942439318627 * fRec5[2])));
		double fTemp4 = (0.00818 * fRec4[1]);
		fVec1[0] = (1e-15 + fTemp4);
		fRec11[0] = ((fConst24 * fRec11[1]) + (fConst23 * (1e-15 + (fTemp4 + fVec1[1]))));
		fRec4[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec11[0] + (0.9254498422517706 * (fRec5[0] + (fRec5[2] + (2.0 * fRec5[1]))))) - 1.130462)) - 111.80171149144252);
		fRec3[0] = ((fConst29 * fRec3[1]) + (fConst28 * ((fConst25 * fRec4[0]) + (fConst26 * fRec4[1]))));
		fRec2[0] = ((fConst33 * fRec2[1]) + (fConst32 * (fRec3[1] + fRec3[0])));
		fRec1[0] = ((fConst38 * fRec1[1]) + (fConst37 * ((fConst34 * fRec2[0]) + (fConst35 * fRec2[1]))));
		double fTemp5 = (fTemp2 * (fTemp2 >= 0.0));
		fVec2[0] = (1e-15 + fTemp5);
		fRec17[0] = ((0.9302847925323914 * (1e-15 + (fTemp5 + fVec2[1]))) - (0.8605695850647829 * fRec17[1]));
		fRec16[0] = (fRec17[0] - ((1.8405051250752198 * fRec16[1]) + (0.8612942439318627 * fRec16[2])));
		double fTemp6 = (0.00822 * fRec15[1]);
		fVec3[0] = (1e-15 + fTemp6);
		fRec18[0] = ((fConst24 * fRec18[1]) + (fConst23 * (1e-15 + (fTemp6 + fVec3[1]))));
		fRec15[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec18[0] + (0.9254498422517706 * (fRec16[0] + (fRec16[2] + (2.0 * fRec16[1]))))) - 1.130462)) - 112.47420924574209);
		fRec14[0] = ((fConst29 * fRec14[1]) + (fConst28 * ((fConst25 * fRec15[0]) + (fConst26 * fRec15[1]))));
		fRec13[0] = ((fConst42 * fRec13[1]) + (fConst41 * (fRec14[1] + fRec14[0])));
		fRec12[0] = ((fConst47 * fRec12[1]) + (fConst46 * ((fConst43 * fRec13[0]) + (fConst44 * fRec13[1]))));
		fRec0[0] = ((0.98 * fRec12[0]) + fRec1[0]);
