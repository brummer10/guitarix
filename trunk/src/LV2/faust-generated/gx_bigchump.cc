...
#define fslider2 (*fslider2_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec10[0] = ((fConst9 * fRec10[1]) + (fConst8 * ((fConst5 * fRec11[0]) + (fConst6 * fRec11[1]))));
		fRec9[0] = ((fConst13 * fRec9[1]) + (fConst12 * (fRec10[0] + fRec10[1])));
		fRec13[0] = ((fConst18 * fRec13[1]) + (fConst17 * ((fConst14 * fRec10[0]) + (fConst15 * fRec10[1]))));
		fRec14[0] = ((0.999 * fRec14[1]) + fSlow4);
		double fTemp1 = (fRec14[0] * ((fSlow2 * fRec13[0]) + (fSlow3 * fRec9[0])));
		fVec1[0] = fTemp1;
		fRec8[0] = ((fConst22 * fRec8[1]) + (fConst21 * (fVec1[0] + fVec1[1])));
		double fTemp2 = (1e-15 + (0.027 * fRec7[1]));
		fVec2[0] = fTemp2;
		fRec15[0] = ((fConst4 * fRec15[1]) + (fConst3 * (fVec2[0] + fVec2[1])));
		fRec7[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec15[0] + fRec8[0]) - 1.829999999999999)) - 182.22222222222223);
		fRec6[0] = ((fConst9 * fRec6[1]) + (fConst8 * ((fConst5 * fRec7[0]) + (fConst6 * fRec7[1]))));
		double fTemp3 = ((fRec6[0] * fRec5[0]) + (fSlow0 * fRec0[1]));
		double fTemp4 = (1e-15 + (0.00822 * fRec4[1]));
		fVec3[0] = fTemp4;
		fRec16[0] = ((fConst26 * fRec16[1]) + (fConst25 * (fVec3[0] + fVec3[1])));
		...
		fVec4[0] = fTemp5;
		fRec21[0] = ((fConst26 * fRec21[1]) + (fConst25 * (fVec4[0] + fVec4[1])));
		fRec20[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec21[0] + (fTemp3 * (fTemp3 <= 0.0))) - 1.130461999999999)) - 111.80171149144252);
		fRec19[0] = ((fConst9 * fRec19[1]) + (fConst8 * ((fConst5 * fRec20[0]) + (fConst6 * fRec20[1]))));
		fRec18[0] = ((fConst39 * fRec18[1]) + (fConst38 * (fRec19[0] + fRec19[1])));
		fRec17[0] = ((fConst44 * fRec17[1]) + (fConst43 * ((fConst40 * fRec18[0]) + (fConst41 * fRec18[1]))));
