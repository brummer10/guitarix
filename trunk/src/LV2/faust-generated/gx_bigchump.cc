...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst6 = fConst0 * (fConst0 * (fConst1 + 6.49177592127948e-12) + 2.51006655911645e-10) + 2.46970447360129e-09;
	fConst7 = 1.0 / fConst6;
	fConst8 = 4.33590667160332e-10 * fConst0;
	...
	fConst35 = std::tan(270.1769682087222 / fConst0);
	...
	fConst42 = std::tan(659.7344572538566 / fConst0);
	fConst43 = mydsp_faustpower2_f(fConst42);
	fConst44 = 2.0 * (1.0 - 1.0 / fConst43);
	fConst45 = 1.0 / fConst42;
	fConst46 = (fConst45 + -1.0000000000000004) / fConst42 + 1.0;
	fConst47 = (fConst45 + 1.0000000000000004) / fConst42 + 1.0;
	fConst48 = 1.0 / fConst47;
	fConst49 = std::tan(3769.9111843077517 / fConst0);
	fConst50 = mydsp_faustpower2_f(fConst49);
	fConst51 = 2.0 * (1.0 - 1.0 / fConst50);
	fConst52 = 1.0 / fConst49;
	fConst53 = (fConst52 + -1.0000000000000004) / fConst49 + 1.0;
	fConst54 = (fConst52 + 1.0000000000000004) / fConst49 + 1.0;
	fConst55 = 1.0 / fConst54;
	fConst56 = std::tan(20517.741620594938 / fConst0);
	fConst57 = mydsp_faustpower2_f(fConst56);
	fConst58 = 2.0 * (1.0 - 1.0 / fConst57);
	fConst59 = 1.0 / fConst56;
	fConst60 = (fConst59 + -1.0000000000000004) / fConst56 + 1.0;
	fConst61 = (fConst59 + 1.0000000000000004) / fConst56 + 1.0;
	fConst62 = 1.0 / fConst61;
	fConst63 = 1.0 - fConst59;
	fConst64 = 1.0 / (fConst59 + 1.0);
	fConst65 = 1.0 - fConst52;
	fConst66 = fConst52 + 1.0;
	fConst67 = 1.0 / fConst66;
	fConst68 = 1.0 - fConst45;
	fConst69 = fConst45 + 1.0;
	fConst70 = 1.0 / fConst69;
	fConst71 = 1.0 - fConst38;
	fConst72 = fConst38 + 1.0;
	fConst73 = 1.0 / fConst72;
	fConst74 = 1.42098357291903e-14 * fConst0;
	fConst75 = fConst10 * (fConst74 + -1.89464476389205e-13);
	fConst76 = 2.84196714583805e-18 * fConst0;
	fConst77 = fConst0 * (fConst0 * (fConst0 * (2.87986004111589e-15 - fConst76) + -7.14281075987297e-12) + 9.47322381946023e-11);
	fConst78 = 2.84196714583805e-14 * fConst23;
	fConst79 = 1.13678685833522e-17 * fConst0;
	...
	fConst82 = fConst0 * (fConst10 * (fConst79 + 5.75972008223179e-15) + -1.89464476389205e-10);
	fConst83 = fConst10 * (-1.89464476389205e-13 - fConst74);
	fConst84 = fConst0 * (fConst0 * (fConst0 * (-2.87986004111589e-15 - fConst76) + -7.14281075987297e-12) + -9.47322381946023e-11);
	fConst85 = 2.54860494326417e-08 * fConst0;
	fConst86 = fConst0 * (3.39813992435224e-07 - fConst85);
	fConst87 = 5.09720988652833e-08 * fConst10;
	fConst88 = fConst0 * (-3.39813992435224e-07 - fConst85);
	fConst89 = 9.01384801641856e-13 * fConst0;
	fConst90 = 1.62986313669617e-11 - fConst89;
	fConst91 = 2.70415440492557e-12 * fConst0;
	fConst92 = fConst91 + -1.62986313669617e-11;
	fConst93 = -1.62986313669617e-11 - fConst91;
	fConst94 = fConst89 + 1.62986313669617e-11;
	fConst95 = fConst10 / fConst6;
	fConst96 = 1.0 / (fConst35 * fConst47);
	fConst97 = 1.0 / (fConst36 * fConst40);
	fConst98 = 1.0 - fConst71 / fConst35;
	fConst99 = 1.0 / (fConst72 / fConst35 + 1.0);
	fConst100 = 1.0 / (fConst42 * fConst54);
	fConst101 = 1.0 / (fConst43 * fConst47);
	fConst102 = 1.0 - fConst68 / fConst42;
	fConst103 = 1.0 / (fConst69 / fConst42 + 1.0);
	fConst104 = 1.0 / (fConst49 * fConst61);
	fConst105 = 1.0 / (fConst50 * fConst54);
	fConst106 = 1.0 - fConst65 / fConst49;
	fConst107 = 1.0 / (fConst66 / fConst49 + 1.0);
	fConst108 = 1.0 / (fConst57 * fConst61);
	clear_state_f();
}
...
#define fVslider2 (*fVslider2_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp5;
		fRec11[0] = -(fConst64 * (fConst63 * fRec11[1] - (fTemp5 + fVec0[1])));
		fRec10[0] = fRec11[0] - fConst62 * (fConst60 * fRec10[2] + fConst58 * fRec10[1]);
		double fTemp6 = fRec10[2] + fRec10[0] + 2.0 * fRec10[1];
		fVec1[0] = fTemp6;
		fRec9[0] = -(fConst67 * (fConst65 * fRec9[1] - fConst62 * (fTemp6 + fVec1[1])));
		fRec8[0] = fRec9[0] - fConst55 * (fConst53 * fRec8[2] + fConst51 * fRec8[1]);
		double fTemp7 = fRec8[2] + fRec8[0] + 2.0 * fRec8[1];
		fVec2[0] = fTemp7;
		fRec7[0] = -(fConst70 * (fConst68 * fRec7[1] - fConst55 * (fTemp7 + fVec2[1])));
		fRec6[0] = fRec7[0] - fConst48 * (fConst46 * fRec6[2] + fConst44 * fRec6[1]);
		double fTemp8 = fRec6[2] + fRec6[0] + 2.0 * fRec6[1];
		fVec3[0] = fTemp8;
		fRec5[0] = -(fConst73 * (fConst71 * fRec5[1] - fConst48 * (fTemp8 + fVec3[1])));
		fRec4[0] = fRec5[0] - fConst41 * (fConst39 * fRec4[2] + fConst37 * fRec4[1]);
		...
		double fTemp9 = fConst77 + fConst75 * fRec12[0];
		double fTemp10 = fConst78 * fRec12[0];
		double fTemp11 = fConst80 - fTemp10;
		double fTemp12 = fConst81 + 3.78928952778409e-13 * fRec12[0];
		double fTemp13 = fConst82 + fTemp10;
		double fTemp14 = fConst84 + fConst83 * fRec12[0];
		double fTemp15 = fRec2[0] * (fRec3[0] * fTemp14 + fTemp13 * fRec3[1] + fConst10 * fTemp12 * fRec3[2] + fTemp11 * fRec3[3] + fTemp9 * fRec3[4]) / fTemp0;
		fRec1[0] = ((signbit(fTemp15)) ? bigchumppre_negclip(fTemp15) : bigchumppreclip(fTemp15)) - fConst12 * (fConst11 * fRec1[1] + fConst9 * fRec1[2]);
		double fTemp16 = fConst12 * (fConst88 * fRec1[0] + fConst87 * fRec1[1] + fConst86 * fRec1[2]);
		...
		double fTemp17 = fConst95 * (fConst94 * fRec0[0] + fConst93 * fRec0[1] + fConst92 * fRec0[2] + fConst90 * fRec0[3]);
		fRec17[0] = -(fConst73 * (fConst71 * fRec17[1] - fConst96 * (fTemp8 - fVec3[1])));
		fRec16[0] = fRec17[0] - fConst41 * (fConst39 * fRec16[2] + fConst37 * fRec16[1]);
		fRec15[0] = fConst97 * (fRec16[2] + (fRec16[0] - 2.0 * fRec16[1])) - (fTemp4 * fRec15[1] + fTemp3 * fRec15[2] + fTemp2 * fRec15[3] + fTemp1 * fRec15[4]) / fTemp0;
		double fTemp18 = fRec2[0] * (fRec15[0] * fTemp14 + fTemp13 * fRec15[1] + fConst10 * fTemp12 * fRec15[2] + fTemp11 * fRec15[3] + fTemp9 * fRec15[4]) / fTemp0;
		fRec14[0] = ((signbit(fTemp18)) ? bigchumppre_negclip(fTemp18) : bigchumppreclip(fTemp18)) - fConst12 * (fConst11 * fRec14[1] + fConst9 * fRec14[2]);
		double fTemp19 = fConst12 * (fConst88 * fRec14[0] + fConst87 * fRec14[1] + fConst86 * fRec14[2]);
		...
		double fTemp20 = fConst95 * (fConst94 * fRec13[0] + fConst93 * fRec13[1] + fConst92 * fRec13[2] + fConst90 * fRec13[3]);
		double fTemp21 = fConst37 * fRec21[1];
		fRec23[0] = -(fConst70 * (fConst68 * fRec23[1] - fConst100 * (fTemp7 - fVec2[1])));
		fRec22[0] = fRec23[0] - fConst48 * (fConst46 * fRec22[2] + fConst44 * fRec22[1]);
		fRec21[0] = fConst101 * (fRec22[2] + (fRec22[0] - 2.0 * fRec22[1])) - fConst99 * (fConst98 * fRec21[2] + fTemp21);
		fRec20[0] = fRec21[2] + fConst99 * (fTemp21 + fConst98 * fRec21[0]) - (fTemp4 * fRec20[1] + fTemp3 * fRec20[2] + fTemp2 * fRec20[3] + fTemp1 * fRec20[4]) / fTemp0;
		double fTemp22 = fRec2[0] * (fRec20[0] * fTemp14 + fTemp13 * fRec20[1] + fConst10 * fTemp12 * fRec20[2] + fTemp11 * fRec20[3] + fTemp9 * fRec20[4]) / fTemp0;
		fRec19[0] = ((signbit(fTemp22)) ? bigchumppre_negclip(fTemp22) : bigchumppreclip(fTemp22)) - fConst12 * (fConst11 * fRec19[1] + fConst9 * fRec19[2]);
		double fTemp23 = fConst12 * (fConst88 * fRec19[0] + fConst87 * fRec19[1] + fConst86 * fRec19[2]);
		...
		double fTemp24 = fConst95 * (fConst94 * fRec18[0] + fConst93 * fRec18[1] + fConst92 * fRec18[2] + fConst90 * fRec18[3]);
		double fTemp25 = fConst37 * fRec27[1];
		double fTemp26 = fConst44 * fRec28[1];
		fRec30[0] = -(fConst67 * (fConst65 * fRec30[1] - fConst104 * (fTemp6 - fVec1[1])));
		fRec29[0] = fRec30[0] - fConst55 * (fConst53 * fRec29[2] + fConst51 * fRec29[1]);
		fRec28[0] = fConst105 * (fRec29[2] + (fRec29[0] - 2.0 * fRec29[1])) - fConst103 * (fConst102 * fRec28[2] + fTemp26);
		fRec27[0] = fRec28[2] + fConst103 * (fTemp26 + fConst102 * fRec28[0]) - fConst99 * (fConst98 * fRec27[2] + fTemp25);
		fRec26[0] = fRec27[2] + fConst99 * (fTemp25 + fConst98 * fRec27[0]) - (fTemp4 * fRec26[1] + fTemp3 * fRec26[2] + fTemp2 * fRec26[3] + fTemp1 * fRec26[4]) / fTemp0;
		double fTemp27 = fRec2[0] * (fRec26[0] * fTemp14 + fTemp13 * fRec26[1] + fConst10 * fTemp12 * fRec26[2] + fTemp11 * fRec26[3] + fTemp9 * fRec26[4]) / fTemp0;
		fRec25[0] = ((signbit(fTemp27)) ? bigchumppre_negclip(fTemp27) : bigchumppreclip(fTemp27)) - fConst12 * (fConst11 * fRec25[1] + fConst9 * fRec25[2]);
		double fTemp28 = fConst12 * (fConst88 * fRec25[0] + fConst87 * fRec25[1] + fConst86 * fRec25[2]);
		...
		double fTemp29 = fConst95 * (fConst94 * fRec24[0] + fConst93 * fRec24[1] + fConst92 * fRec24[2] + fConst90 * fRec24[3]);
		double fTemp30 = fConst37 * fRec34[1];
		double fTemp31 = fConst44 * fRec35[1];
		double fTemp32 = fConst51 * fRec36[1];
		fRec38[0] = -(fConst64 * (fConst63 * fRec38[1] - fConst59 * (fTemp5 - fVec0[1])));
		fRec37[0] = fRec38[0] - fConst62 * (fConst60 * fRec37[2] + fConst58 * fRec37[1]);
		fRec36[0] = fConst108 * (fRec37[2] + (fRec37[0] - 2.0 * fRec37[1])) - fConst107 * (fConst106 * fRec36[2] + fTemp32);
		fRec35[0] = fRec36[2] + fConst107 * (fTemp32 + fConst106 * fRec36[0]) - fConst103 * (fConst102 * fRec35[2] + fTemp31);
		fRec34[0] = fRec35[2] + fConst103 * (fTemp31 + fConst102 * fRec35[0]) - fConst99 * (fConst98 * fRec34[2] + fTemp30);
		fRec33[0] = fRec34[2] + fConst99 * (fTemp30 + fConst98 * fRec34[0]) - (fRec33[1] * fTemp4 + fRec33[2] * fTemp3 + fRec33[3] * fTemp2 + fRec33[4] * fTemp1) / fTemp0;
		double fTemp33 = fRec2[0] * (fRec33[0] * fTemp14 + fRec33[1] * fTemp13 + fConst10 * fRec33[2] * fTemp12 + fRec33[3] * fTemp11 + fRec33[4] * fTemp9) / fTemp0;
		fRec32[0] = ((signbit(fTemp33)) ? bigchumppre_negclip(fTemp33) : bigchumppreclip(fTemp33)) - fConst12 * (fConst11 * fRec32[1] + fConst9 * fRec32[2]);
		double fTemp34 = fConst12 * (fConst88 * fRec32[0] + fConst87 * fRec32[1] + fConst86 * fRec32[2]);
		...
		double fTemp35 = fConst95 * (fConst94 * fRec31[0] + fConst93 * fRec31[1] + fConst92 * fRec31[2] + fConst90 * fRec31[3]);
