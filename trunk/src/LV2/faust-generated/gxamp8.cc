...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp3 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp0 + (fRec30[0] + fTemp1)) + -0.44548700000000002))));
		fRec27[0] = ((fTemp3 + (0.00054327682926829269 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp3))) + 100000.0))) + -130.0);
		fRec26[0] = (fConst2 * ((fConst3 * fRec26[1]) + (0.10000000000000001 * (fRec27[0] - fRec27[1]))));
		...
		double fTemp6 = ((fTemp5 + fTemp4) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec38[1]))) + 100000.0));
		fVec1[0] = fTemp6;
		fRec41[0] = (fConst31 * ((1500.0 * (fTemp6 + fVec1[1])) - (fConst32 * fRec41[1])));
		double fTemp7 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp4 + (fRec41[0] + fTemp5)) + -0.77616200000000002))));
		fRec38[0] = ((fTemp7 + (0.00051744133333333337 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp7))) + 100000.0))) + -130.0);
		fRec37[0] = (fConst2 * ((fConst3 * fRec37[1]) + (0.10000000000000001 * (fRec38[0] - fRec38[1]))));
		fRec46[0] = (fSlow4 + (0.999 * fRec46[1]));
		double fTemp8 = (double(input0[i]) * fRec46[0]);
		fVec2[0] = fTemp8;
		fRec45[0] = ((1.8605695850647828 * (fTemp8 + fVec2[1])) - (0.86056958506478287 * fRec45[1]));
		...
		double fTemp11 = ((fTemp10 + fTemp9) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec43[1]))) + 100000.0));
		fVec3[0] = fTemp11;
		fRec47[0] = (fConst34 * ((2700.0 * (fTemp11 + fVec3[1])) - (fConst35 * fRec47[1])));
		double fTemp12 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp9 + (fRec47[0] + fTemp10)) + -1.2572399999999999))));
		fRec43[0] = ((fTemp12 + (0.00046564444444444444 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp12))) + 100000.0))) + -130.0);
		fRec42[0] = (fConst2 * ((fConst3 * fRec42[1]) + (0.10000000000000001 * (fRec43[0] - fRec43[1]))));
		...
		double fTemp15 = ((fTemp14 + fTemp13) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec32[1]))) + 100000.0));
		fVec4[0] = fTemp15;
		fRec48[0] = (fConst31 * ((1500.0 * (fTemp15 + fVec4[1])) - (fConst32 * fRec48[1])));
		double fTemp16 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp13 + (fRec48[0] + fTemp14)) + -0.77616200000000002))));
		fRec32[0] = ((fTemp16 + (0.00051744133333333337 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp16))) + 100000.0))) + -130.0);
		fRec31[0] = (fConst2 * ((fConst3 * fRec31[1]) + (0.10000000000000001 * (fRec32[0] - fRec32[1]))));
		...
		double fTemp19 = ((fTemp18 + fTemp17) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec22[1]))) + 100000.0));
		fVec5[0] = fTemp19;
		fRec49[0] = (fConst28 * ((820.0 * (fTemp19 + fVec5[1])) - (fConst29 * fRec49[1])));
		double fTemp20 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp17 + (fRec49[0] + fTemp18)) + -0.44548700000000002))));
		fRec22[0] = ((fTemp20 + (0.00054327682926829269 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp20))) + 100000.0))) + -130.0);
		fRec21[0] = (fConst2 * ((fConst3 * fRec21[1]) + (0.10000000000000001 * (fRec22[0] - fRec22[1]))));
		...
		double fTemp42 = (fRec21[0] * (1.0 - fRec50[0]));
		double fTemp43 = ((fSlow2 * fRec13[0]) + ((fTemp42 * ((fSlow9 * ((4.0 * (1.0 - std::fabs(fTemp42))) + -1.0)) + 1.0)) + (fSlow10 * fTemp30)));
		fVec11[0] = fTemp43;
		fRec12[0] = (0.0 - (fConst5 * ((fConst6 * fRec12[1]) - (fTemp43 + fVec11[1]))));
		fRec64[0] = (fSlow11 + (0.999 * fRec64[1]));
		double fTemp44 = (fRec12[0] * fRec64[0]);
		fVec12[0] = fTemp44;
		fRec11[0] = ((0.93028479253239138 * (fTemp44 + fVec12[1])) - (0.86056958506478287 * fRec11[1]));
		fRec10[0] = (fRec11[0] - ((1.8405051250752198 * fRec10[1]) + (0.86129424393186271 * fRec10[2])));
		double fTemp45 = (0.92544984225177063 * (fRec10[0] + fRec10[2]));
		double fTemp46 = (1.8508996845035413 * fRec10[1]);
		double fTemp47 = (fTemp46 + fTemp45);
		double fTemp48 = (fTemp47 / (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fRec9[1]))) + 100000.0));
		fVec13[0] = fTemp48;
		fRec65[0] = (fConst5 * ((410.0 * (fTemp48 + fVec13[1])) - (fConst6 * fRec65[1])));
		double fTemp49 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp45 + (fRec65[0] + fTemp46)) + -0.65976100000000004))));
		fRec9[0] = ((fTemp49 + (0.0016091731707317074 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp49))) + 100000.0))) + -250.0);
		fRec8[0] = (fConst2 * ((fConst3 * fRec8[1]) + (0.025000000000000001 * (fRec9[0] - fRec9[1]))));
		double fTemp50 = (fTemp47 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec67[1]))) + 100000.0));
		fVec14[0] = fTemp50;
		fRec68[0] = (fConst5 * ((410.0 * (fTemp50 + fVec14[1])) - (fConst6 * fRec68[1])));
		double fTemp51 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp45 + (fRec68[0] + fTemp46)) + -0.66454100000000005))));
		fRec67[0] = ((fTemp51 + (0.0016208317073170733 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp51))) + 100000.0))) + -250.0);
		fRec66[0] = (fConst2 * ((fConst3 * fRec66[1]) + (0.025000000000000001 * (fRec67[0] - fRec67[1]))));
		double fTemp52 = (std::min<double>(0.69999999999999996, fRec8[0]) + std::max<double>(-0.75, fRec66[0]));
		double fTemp53 = (0.5 * fRec0[1]);
		double fTemp54 = (0.40000000000000002 * fRec2[1]);
		double fTemp55 = (fTemp53 + ((0.29999999999999999 * fRec4[1]) + fTemp54));
		double fTemp56 = ((fTemp52 + (0.20000000000000001 * fRec6[1])) - fTemp55);
		fRec6[0] = fTemp56;
		double fRec7 = (0.0 - (0.20000000000000001 * fTemp56));
		fRec4[0] = (fRec7 + fRec6[1]);
		double fRec5 = (0.29999999999999999 * (fTemp52 - fTemp55));
		fRec2[0] = (fRec5 + fRec4[1]);
		double fRec3 = (0.40000000000000002 * (fTemp52 - (fTemp54 + fTemp53)));
		fRec0[0] = (fRec3 + fRec2[1]);
		double fRec1 = (0.5 * (fTemp52 - fTemp53));
