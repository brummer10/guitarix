...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp4 = (fConst12 * (fRec34[0] * (fRec30[0] + (fRec30[2] + (2 * fRec30[1])))));
		...
		fRec35[0] = ((fConst16 * fRec35[1]) + (fConst15 * (1e-15 + (fTemp5 + fVec2[1]))));
		fRec27[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec35[0] + (0.9254498422517706 * (fRec28[0] + (fRec28[2] + (2.0 * fRec28[1]))))) - 1.25724)) - 83.43555555555557);
		...
		fRec40[0] = ((fConst25 * fRec40[1]) + (fConst24 * (1e-15 + (fTemp6 + fVec4[1]))));
		fRec37[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec40[0] + (0.9254498422517706 * (fRec38[0] + (fRec38[2] + (2.0 * fRec38[1]))))) - 0.776162)) - 78.25586666666666);
		...
		fRec41[0] = ((fConst25 * fRec41[1]) + (fConst24 * (1e-15 + (fTemp7 + fVec6[1]))));
		fRec21[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec41[0] + (0.9254498422517706 * (fRec22[0] + (fRec22[2] + (2.0 * fRec22[1]))))) - 0.776162)) - 78.25586666666666);
		...
		fRec46[0] = ((fConst33 * fRec46[1]) + (fConst32 * (1e-15 + (fTemp8 + fVec8[1]))));
		fRec43[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec46[0] + (0.9254498422517706 * (fRec44[0] + (fRec44[2] + (2.0 * fRec44[1]))))) - 0.445487)) - 75.67231707317073);
		...
		fRec47[0] = ((fConst33 * fRec47[1]) + (fConst32 * (1e-15 + (fTemp9 + fVec10[1]))));
		fRec16[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec47[0] + (0.9254498422517706 * (fRec17[0] + (fRec17[2] + (2.0 * fRec17[1]))))) - 0.445487)) - 75.67231707317073);
		...
		fRec58[0] = ((fVec11[IOTA&32767] + fRec58[1]) - fVec11[(IOTA-iConst60)&32767]);
		...
		fRec56[0] = ((0.024937655860349125 * fTemp23) - (fConst59 * ((fConst57 * fRec56[2]) + (fConst55 * fRec56[1]))));
		double fTemp24 = (fRec56[0] + (fRec56[2] + (2 * fRec56[1])));
		fVec12[0] = fTemp24;
		fRec55[0] = ((fConst21 * fRec55[1]) + (fConst62 * ((fConst17 * fVec12[0]) + (fConst18 * fVec12[1]))));
		...
		fVec13[0] = fTemp25;
		fRec52[0] = ((fConst68 * fRec52[1]) + (fConst67 * (fVec13[0] + fVec13[1])));
		fRec51[0] = (fRec52[0] - (fConst46 * ((fConst44 * fRec51[1]) + (fConst42 * fRec51[2]))));
		double fTemp26 = (fRec51[0] + (fRec51[2] + (2 * fRec51[1])));
		fVec14[0] = fTemp26;
		fRec50[0] = ((fConst71 * fRec50[1]) + (fConst70 * (fVec14[0] + fVec14[1])));
		...
		double fTemp28 = (fConst38 * fRec60[1]);
		double fTemp29 = (fConst44 * fRec61[1]);
		...
		fRec61[0] = ((fConst53 * ((fConst77 * fRec62[1]) + (fConst48 * (fRec62[2] + fRec62[0])))) - (fConst75 * ((fConst74 * fRec61[2]) + fTemp29)));
		fRec60[0] = ((fRec61[2] + (fConst75 * (fTemp29 + (fConst74 * fRec61[0])))) - (fConst73 * ((fConst72 * fRec60[2]) + fTemp28)));
		double fTemp30 = max((double)-1, min((double)1, (fSlow6 * (fRec60[2] + (fConst73 * (fTemp28 + (fConst72 * fRec60[0])))))));
		fRec65[0] = ((fConst71 * fRec65[1]) + (fConst70 * ((fConst35 * fVec14[0]) + (fConst78 * fVec14[1]))));
		fRec64[0] = (fRec65[0] - (fConst39 * ((fConst38 * fRec64[1]) + (fConst36 * fRec64[2]))));
		double fTemp31 = max((double)-1, min((double)1, (fSlow7 * ((fConst79 * fRec64[1]) + (fConst37 * (fRec64[2] + fRec64[0]))))));
		double fTemp32 = (fConst38 * fRec66[1]);
		fRec68[0] = ((fConst68 * fRec68[1]) + (fConst67 * ((fConst41 * fVec13[0]) + (fConst80 * fVec13[1]))));
		fRec67[0] = (fRec68[0] - (fConst46 * ((fConst44 * fRec67[1]) + (fConst42 * fRec67[2]))));
		fRec66[0] = ((fConst46 * ((fConst81 * fRec67[1]) + (fConst43 * (fRec67[2] + fRec67[0])))) - (fConst73 * ((fConst72 * fRec66[2]) + fTemp32)));
		double fTemp33 = max((double)-1, min((double)1, (fSlow8 * (fRec66[2] + (fConst73 * (fTemp32 + (fConst72 * fRec66[0])))))));
		...
		fVec15[0] = fTemp34;
		fRec48[0] = ((fConst29 * fRec48[1]) + (fConst28 * (fVec15[0] + fVec15[1])));
		...
		fRec69[0] = ((fConst29 * fRec69[1]) + (fConst28 * (1e-15 + (fTemp38 + fVec18[1]))));
		...
		fRec72[0] = ((fConst29 * fRec72[1]) + (fConst28 * (1e-15 + (fTemp40 + fVec19[1]))));
