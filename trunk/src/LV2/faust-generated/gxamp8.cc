...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst42 = (1.0 / tan((609.4689747964198 / iConst0)));
	fConst43 = (1 + fConst42);
	fConst44 = (0 - ((1 - fConst42) / fConst43));
	fConst45 = (1.0 / fConst43);
	IOTA = 0;
	iConst46 = int((int((0.1111111111111111 * iConst0)) & 65535));
	fConst47 = (0.009000000000000008 / iConst0);
	fConst48 = tan((942.4777960769379 / iConst0));
	...
	fConst54 = tan((3769.9111843077517 / iConst0));
	...
	fConst63 = tan((10053.096491487338 / iConst0));
	...
	fConst72 = tan((47123.8898038469 / iConst0));
	...
	fConst78 = (1.0 / (fConst14 * fConst76));
	...
	fConst94 = (0.025 / fConst14);
	fConst95 = (0 - fConst10);
	fConst96 = (1.0 / (1 + fConst11));
	fConst97 = (0 - fConst6);
	fConst98 = (1.0 / (1 + fConst7));
	fConst99 = (0 - fConst2);
	fConst100 = (1.0 / (1 + fConst3));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec1[0] = fTemp1;
		fRec21[0] = (fConst30 * ((fVec1[0] - fVec1[1]) + (fConst29 * fRec21[1])));
		...
		fVec2[0] = fTemp2;
		fRec23[0] = ((fConst35 * (fVec2[0] + fVec2[1])) + (fConst34 * fRec23[1]));
		...
		fVec3[0] = fTemp3;
		fRec26[0] = ((fConst41 * (fVec3[0] + fVec3[1])) + (fConst40 * fRec26[1]));
		...
		fVec4[0] = fTemp4;
		fRec27[0] = ((fConst41 * (fVec4[0] + fVec4[1])) + (fConst40 * fRec27[1]));
		...
		fRec33[0] = ((fVec7[IOTA&32767] + fRec33[1]) - fVec7[(IOTA-iConst46)&32767]);
		...
		double fTemp21 = (fConst50 * fRec36[1]);
		fRec42[0] = ((0.024937655860349125 * fTemp20) - (fConst77 * ((fConst75 * fRec42[2]) + (fConst73 * fRec42[1]))));
		double fTemp22 = (fRec42[2] + (fRec42[0] + (2 * fRec42[1])));
		fVec8[0] = fTemp22;
		fRec41[0] = ((fConst78 * ((fConst36 * fVec8[1]) + (fConst13 * fVec8[0]))) + (fConst15 * fRec41[1]));
		...
		fVec9[0] = fTemp23;
		fRec38[0] = ((fConst81 * ((fConst80 * fVec9[1]) + (fConst57 * fVec9[0]))) + (fConst62 * fRec38[1]));
		fRec37[0] = (fRec38[0] - (fConst60 * ((fConst58 * fRec37[2]) + (fConst56 * fRec37[1]))));
		fRec36[0] = ((fConst60 * (((fConst55 * fRec37[0]) + (fConst82 * fRec37[1])) + (fConst55 * fRec37[2]))) - (fConst53 * ((fConst52 * fRec36[2]) + fTemp21)));
		double fTemp24 = max(-1, min(1, (fSlow7 * (fRec36[2] + (fConst53 * (fTemp21 + (fConst52 * fRec36[0])))))));
		fRec46[0] = ((fConst81 * (fVec9[0] + fVec9[1])) + (fConst62 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst60 * ((fConst58 * fRec45[2]) + (fConst56 * fRec45[1]))));
		double fTemp25 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec10[0] = fTemp25;
		fRec44[0] = ((fConst88 * ((fConst87 * fVec10[1]) + (fConst51 * fVec10[0]))) + (fConst86 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst84 * ((fConst83 * fRec43[2]) + (fConst50 * fRec43[1]))));
		double fTemp26 = max(-1, min(1, (fSlow8 * (((fConst49 * fRec43[0]) + (fConst89 * fRec43[1])) + (fConst49 * fRec43[2])))));
		double fTemp27 = (fConst50 * fRec47[1]);
		double fTemp28 = (fConst56 * fRec48[1]);
		...
		fRec48[0] = ((fConst69 * (((fConst64 * fRec49[0]) + (fConst93 * fRec49[1])) + (fConst64 * fRec49[2]))) - (fConst91 * ((fConst90 * fRec48[2]) + fTemp28)));
		fRec47[0] = ((fRec48[2] + (fConst91 * (fTemp28 + (fConst90 * fRec48[0])))) - (fConst53 * ((fConst52 * fRec47[2]) + fTemp27)));
		double fTemp29 = max(-1, min(1, (fSlow9 * (fRec47[2] + (fConst53 * (fTemp27 + (fConst52 * fRec47[0])))))));
		fRec52[0] = ((fConst88 * (fVec10[0] + fVec10[1])) + (fConst86 * fRec52[1]));
		...
		fRec3[0] = ((fConst94 * ((fConst36 * fRec4[1]) + (fConst13 * fRec4[0]))) + (fConst15 * fRec3[1]));
		...
		fRec53[0] = ((fConst94 * ((fConst36 * fRec54[1]) + (fConst13 * fRec54[0]))) + (fConst15 * fRec53[1]));
		double fTemp35 = (min(0.7, fRec53[0]) + max(-0.75, fRec3[0]));
		fVec14[0] = fTemp35;
		fRec2[0] = (fConst96 * ((fVec14[2] + (fVec14[0] + (fConst95 * fVec14[1]))) + ((fConst12 * fRec2[2]) + (fConst10 * fRec2[1]))));
		fRec1[0] = (fConst98 * ((fRec2[2] + (fRec2[0] + (fConst97 * fRec2[1]))) + ((fConst8 * fRec1[2]) + (fConst6 * fRec1[1]))));
		fRec0[0] = (fConst100 * ((fRec1[2] + (fRec1[0] + (fConst99 * fRec1[1]))) + ((fConst4 * fRec0[2]) + (fConst2 * fRec0[1]))));
