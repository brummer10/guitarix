...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp5 = (fTemp3 + fTemp4) / (Ranode(TUBE_TABLE_12AU7_250k, fRec23[1]) + 1e+05);
		fVec0[0] = fTemp5;
		fRec26[0] = fConst6 * (8.2e+02 * (fTemp5 + fVec0[1]) - fConst5 * fRec26[1]);
		fRec23[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp4 + fRec26[0] + fTemp3 + -0.445487) + -75.67231707317073;
		double fTemp6 = fRec23[0] - fRec23[1];
		fRec22[0] = fConst8 * (fConst7 * fTemp6 - fConst3 * fRec22[1]);
		fRec27[0] = fConst11 * (fConst10 * fRec27[1] + 0.1 * fTemp6);
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AU7_250k, fRec35[1]) + 1e+05);
		fVec1[0] = fTemp9;
		fRec38[0] = fConst14 * (1.5e+03 * (fTemp9 + fVec1[1]) - fConst13 * fRec38[1]);
		fRec35[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp8 + fRec38[0] + fTemp7 + -0.776162) + -78.25586666666666;
		double fTemp10 = fRec35[0] - fRec35[1];
		fRec34[0] = fConst8 * (fConst7 * fTemp10 - fConst3 * fRec34[1]);
		fRec39[0] = fConst11 * (fConst10 * fRec39[1] + 0.1 * fTemp10);
		fRec44[0] = fSlow3 + 0.999 * fRec44[1];
		double fTemp11 = double(input0[i0]) * fRec44[0];
		fVec2[0] = fTemp11;
		fRec43[0] = 1.8605695850647828 * (fTemp11 + fVec2[1]) - 0.8605695850647829 * fRec43[1];
		...
		double fTemp14 = (fTemp12 + fTemp13) / (Ranode(TUBE_TABLE_12AU7_68k, fRec41[1]) + 1e+05);
		fVec3[0] = fTemp14;
		fRec45[0] = fConst17 * (2.7e+03 * (fTemp14 + fVec3[1]) - fConst16 * fRec45[1]);
		fRec41[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp13 + fRec45[0] + fTemp12 + -1.25724) + -83.43555555555557;
		double fTemp15 = fRec41[0] - fRec41[1];
		fRec40[0] = fConst8 * (fConst7 * fTemp15 - fConst3 * fRec40[1]);
		fRec46[0] = fConst11 * (fConst10 * fRec46[1] + 0.1 * fTemp15);
		...
		double fTemp18 = (fTemp16 + fTemp17) / (Ranode(TUBE_TABLE_12AU7_250k, fRec29[1]) + 1e+05);
		fVec4[0] = fTemp18;
		fRec47[0] = fConst14 * (1.5e+03 * (fTemp18 + fVec4[1]) - fConst13 * fRec47[1]);
		fRec29[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp17 + fRec47[0] + fTemp16 + -0.776162) + -78.25586666666666;
		double fTemp19 = fRec29[0] - fRec29[1];
		fRec28[0] = fConst8 * (fConst7 * fTemp19 - fConst3 * fRec28[1]);
		fRec48[0] = fConst11 * (fConst10 * fRec48[1] + 0.1 * fTemp19);
		...
		double fTemp22 = (fTemp20 + fTemp21) / (Ranode(TUBE_TABLE_12AU7_250k, fRec18[1]) + 1e+05);
		fVec5[0] = fTemp22;
		fRec49[0] = fConst6 * (8.2e+02 * (fTemp22 + fVec5[1]) - fConst5 * fRec49[1]);
		fRec18[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp21 + fRec49[0] + fTemp20 + -0.445487) + -75.67231707317073;
		double fTemp23 = fRec18[0] - fRec18[1];
		fRec17[0] = fConst8 * (fConst7 * fTemp23 - fConst3 * fRec17[1]);
		fRec50[0] = fConst11 * (fConst10 * fRec50[1] + 0.1 * fTemp23);
		...
		fRec8[0] = fConst8 * (fConst68 * fTemp53 - fConst3 * fRec8[1]);
		...
		fRec72[0] = fConst8 * (fConst68 * fTemp55 - fConst3 * fRec72[1]);
