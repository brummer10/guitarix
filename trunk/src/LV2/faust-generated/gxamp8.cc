...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec22[0] = 0.1 * (fConst8 * fRec23[0] + fConst9 * fRec23[1]) - fConst4 * fRec22[1];
		fRec27[0] = fConst12 * (fConst11 * fRec27[1] + 0.1 * (fRec23[0] - fRec23[1]));
		...
		double fTemp8 = (fTemp6 + fTemp7) / (Ranode(TUBE_TABLE_12AU7_250k, fRec35[1]) + 1e+05);
		fVec1[0] = fTemp8;
		fRec38[0] = fConst15 * (1.5e+03 * (fTemp8 + fVec1[1]) - fConst14 * fRec38[1]);
		fRec35[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp7 + fRec38[0] + fTemp6 + -0.776162) + -78.25586666666666;
		fRec34[0] = 0.1 * (fConst8 * fRec35[0] + fConst9 * fRec35[1]) - fConst4 * fRec34[1];
		fRec39[0] = fConst12 * (fConst11 * fRec39[1] + 0.1 * (fRec35[0] - fRec35[1]));
		fRec44[0] = fSlow3 + 0.999 * fRec44[1];
		double fTemp9 = double(input0[i0]) * fRec44[0];
		fVec2[0] = fTemp9;
		fRec43[0] = 1.8605695850647828 * (fTemp9 + fVec2[1]) - 0.8605695850647829 * fRec43[1];
		...
		double fTemp12 = (fTemp10 + fTemp11) / (Ranode(TUBE_TABLE_12AU7_68k, fRec41[1]) + 1e+05);
		fVec3[0] = fTemp12;
		fRec45[0] = fConst18 * (2.7e+03 * (fTemp12 + fVec3[1]) - fConst17 * fRec45[1]);
		fRec41[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp11 + fRec45[0] + fTemp10 + -1.25724) + -83.43555555555557;
		fRec40[0] = 0.1 * (fConst8 * fRec41[0] + fConst9 * fRec41[1]) - fConst4 * fRec40[1];
		fRec46[0] = fConst12 * (fConst11 * fRec46[1] + 0.1 * (fRec41[0] - fRec41[1]));
		...
		double fTemp15 = (fTemp13 + fTemp14) / (Ranode(TUBE_TABLE_12AU7_250k, fRec29[1]) + 1e+05);
		fVec4[0] = fTemp15;
		fRec47[0] = fConst15 * (1.5e+03 * (fTemp15 + fVec4[1]) - fConst14 * fRec47[1]);
		fRec29[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp14 + fRec47[0] + fTemp13 + -0.776162) + -78.25586666666666;
		fRec28[0] = 0.1 * (fConst8 * fRec29[0] + fConst9 * fRec29[1]) - fConst4 * fRec28[1];
		fRec48[0] = fConst12 * (fConst11 * fRec48[1] + 0.1 * (fRec29[0] - fRec29[1]));
		...
		double fTemp18 = (fTemp16 + fTemp17) / (Ranode(TUBE_TABLE_12AU7_250k, fRec18[1]) + 1e+05);
		fVec5[0] = fTemp18;
		fRec49[0] = fConst7 * (8.2e+02 * (fTemp18 + fVec5[1]) - fConst6 * fRec49[1]);
		fRec18[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp17 + fRec49[0] + fTemp16 + -0.445487) + -75.67231707317073;
		fRec17[0] = 0.1 * (fConst8 * fRec18[0] + fConst9 * fRec18[1]) - fConst4 * fRec17[1];
		fRec50[0] = fConst12 * (fConst11 * fRec50[1] + 0.1 * (fRec18[0] - fRec18[1]));
