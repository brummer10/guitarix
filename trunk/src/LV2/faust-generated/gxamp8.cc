...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst52 = (1.0 / tan((609.4689747964198 / double(iConst0))));
	fConst53 = (1 + fConst52);
	fConst54 = (0 - ((1 - fConst52) / fConst53));
	fConst55 = (1.0 / fConst53);
	IOTA = 0;
	iConst56 = int((int((0.1111111111111111 * iConst0)) & 65535));
	fConst57 = (0.009000000000000008 / double(iConst0));
	fConst58 = tan((942.4777960769379 / double(iConst0)));
	fConst59 = (1.0 / faustpower<2>(fConst58));
	fConst60 = (2 * (1 - fConst59));
	fConst61 = (1.0 / fConst58);
	fConst62 = (1 + ((fConst61 - 1.0) / fConst58));
	fConst63 = (1.0 / (1 + ((1.0 + fConst61) / fConst58)));
	fConst64 = tan((3769.9111843077517 / double(iConst0)));
	...
	fConst69 = (1 + ((fConst67 + 1.0000000000000004) / fConst64));
	fConst70 = (1.0 / fConst69);
	fConst71 = (1 + fConst67);
	fConst72 = (0 - ((1 - fConst67) / fConst71));
	fConst73 = tan((10053.096491487338 / double(iConst0)));
	fConst74 = (1.0 / faustpower<2>(fConst73));
	fConst75 = (2 * (1 - fConst74));
	fConst76 = (1.0 / fConst73);
	fConst77 = (1 + ((fConst76 - 1.0000000000000004) / fConst73));
	fConst78 = (1 + ((1.0000000000000004 + fConst76) / fConst73));
	fConst79 = (1.0 / fConst78);
	fConst80 = (1 + fConst76);
	fConst81 = (0 - ((1 - fConst76) / fConst80));
	fConst82 = tan((47123.8898038469 / double(iConst0)));
	fConst83 = (2 * (1 - (1.0 / faustpower<2>(fConst82))));
	fConst84 = (1.0 / fConst82);
	fConst85 = (1 + ((fConst84 - 1.414213562373095) / fConst82));
	fConst86 = (1 + ((1.414213562373095 + fConst84) / fConst82));
	fConst87 = (1.0 / fConst86);
	fConst88 = (1.0 / (fConst24 * fConst86));
	fConst89 = (1.0 / fConst80);
	fConst90 = (0 - fConst67);
	fConst91 = (1.0 / (fConst71 * fConst78));
	fConst92 = (2 * (0 - fConst65));
	fConst93 = (1 + ((fConst61 - 1.0000000000000004) / fConst58));
	fConst94 = (1.0 / (1 + ((fConst61 + 1.0000000000000004) / fConst58)));
	fConst95 = (1 + fConst61);
	fConst96 = (0 - ((1 - fConst61) / fConst95));
	fConst97 = (0 - fConst61);
	fConst98 = (1.0 / (fConst95 * fConst69));
	fConst99 = (2 * (0 - fConst59));
	fConst100 = (1 + ((fConst67 - 1.0) / fConst64));
	fConst101 = (1.0 / (1 + ((1.0 + fConst67) / fConst64)));
	fConst102 = (0 - fConst76);
	fConst103 = (2 * (0 - fConst74));
	fConst104 = (0.025 / fConst24);
	fConst105 = (2148.983059849188 * fConst18);
	fConst106 = (1 + ((fConst20 - fConst105) / fConst16));
	fConst107 = (1 + ((fConst105 + fConst20) / fConst16));
	fConst108 = (3491.150146031474 * fConst11);
	fConst109 = (1 + ((fConst13 - fConst108) / fConst9));
	fConst110 = (1 + ((fConst108 + fConst13) / fConst9));
	fConst111 = (829.9725931944553 * fConst4);
	fConst112 = (1 + ((fConst6 - fConst111) / fConst1));
	fConst113 = (1 + ((fConst111 + fConst6) / fConst1));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	double 	fSlow8 = (fConst94 * pow(1e+01,(2 * fSlow3)));
	double 	fSlow9 = pow(1e+01,(0.8 * fSlow3));
	double 	fSlow10 = (fConst94 * pow(1e+01,(0.9 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		fVec1[0] = fTemp4;
		fRec21[0] = (fConst40 * ((fVec1[0] - fVec1[1]) + (fConst39 * fRec21[1])));
		...
		fVec2[0] = fTemp5;
		fRec23[0] = ((fConst45 * (fVec2[0] + fVec2[1])) + (fConst44 * fRec23[1]));
		fRec17[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec23[0] + (fConst41 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.2572399999999988)) - 83.43555555555557);
		fRec16[0] = ((fConst47 * ((fConst46 * fRec17[1]) + (fConst23 * fRec17[0]))) + (fConst25 * fRec16[1]));
		double fTemp6 = (1e-15 + (0.015 * fRec25[1]));
		fVec3[0] = fTemp6;
		fRec26[0] = ((fConst51 * (fVec3[0] + fVec3[1])) + (fConst50 * fRec26[1]));
		...
		fVec4[0] = fTemp7;
		fRec27[0] = ((fConst51 * (fVec4[0] + fVec4[1])) + (fConst50 * fRec27[1]));
		...
		fVec5[0] = fTemp8;
		fRec30[0] = ((fConst55 * (fVec5[0] + fVec5[1])) + (fConst54 * fRec30[1]));
		...
		fVec6[0] = fTemp9;
		fRec31[0] = ((fConst55 * (fVec6[0] + fVec6[1])) + (fConst54 * fRec31[1]));
		...
		fRec33[0] = ((fVec7[IOTA&32767] + fRec33[1]) - fVec7[(IOTA-iConst56)&32767]);
		fRec32[0] = ((fConst57 * fRec33[0]) + (0.999 * fRec32[1]));
		...
		double fTemp24 = (fConst60 * fRec36[1]);
		fRec42[0] = ((0.024937655860349125 * fTemp23) - (fConst87 * ((fConst85 * fRec42[2]) + (fConst83 * fRec42[1]))));
		double fTemp25 = (fRec42[2] + (fRec42[0] + (2 * fRec42[1])));
		fVec8[0] = fTemp25;
		fRec41[0] = ((fConst88 * ((fConst46 * fVec8[1]) + (fConst23 * fVec8[0]))) + (fConst25 * fRec41[1]));
		fRec40[0] = ((fConst89 * (fRec41[0] + fRec41[1])) + (fConst81 * fRec40[1]));
		fRec39[0] = (fRec40[0] - (fConst79 * ((fConst77 * fRec39[2]) + (fConst75 * fRec39[1]))));
		double fTemp26 = (fRec39[2] + (fRec39[0] + (2 * fRec39[1])));
		fVec9[0] = fTemp26;
		fRec38[0] = ((fConst91 * ((fConst90 * fVec9[1]) + (fConst67 * fVec9[0]))) + (fConst72 * fRec38[1]));
		fRec37[0] = (fRec38[0] - (fConst70 * ((fConst68 * fRec37[2]) + (fConst66 * fRec37[1]))));
		fRec36[0] = ((fConst70 * (((fConst65 * fRec37[0]) + (fConst92 * fRec37[1])) + (fConst65 * fRec37[2]))) - (fConst63 * ((fConst62 * fRec36[2]) + fTemp24)));
		double fTemp27 = max((double)-1, min((double)1, (fSlow7 * (fRec36[2] + (fConst63 * (fTemp24 + (fConst62 * fRec36[0])))))));
		fRec46[0] = ((fConst91 * (fVec9[0] + fVec9[1])) + (fConst72 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst70 * ((fConst68 * fRec45[2]) + (fConst66 * fRec45[1]))));
		double fTemp28 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec10[0] = fTemp28;
		fRec44[0] = ((fConst98 * ((fConst97 * fVec10[1]) + (fConst61 * fVec10[0]))) + (fConst96 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst94 * ((fConst93 * fRec43[2]) + (fConst60 * fRec43[1]))));
		double fTemp29 = max((double)-1, min((double)1, (fSlow8 * (((fConst59 * fRec43[0]) + (fConst99 * fRec43[1])) + (fConst59 * fRec43[2])))));
		double fTemp30 = (fConst60 * fRec47[1]);
		double fTemp31 = (fConst66 * fRec48[1]);
		fRec50[0] = ((fConst89 * ((fConst102 * fRec41[1]) + (fConst76 * fRec41[0]))) + (fConst81 * fRec50[1]));
		fRec49[0] = (fRec50[0] - (fConst79 * ((fConst77 * fRec49[2]) + (fConst75 * fRec49[1]))));
		fRec48[0] = ((fConst79 * (((fConst74 * fRec49[0]) + (fConst103 * fRec49[1])) + (fConst74 * fRec49[2]))) - (fConst101 * ((fConst100 * fRec48[2]) + fTemp31)));
		fRec47[0] = ((fRec48[2] + (fConst101 * (fTemp31 + (fConst100 * fRec48[0])))) - (fConst63 * ((fConst62 * fRec47[2]) + fTemp30)));
		double fTemp32 = max((double)-1, min((double)1, (fSlow9 * (fRec47[2] + (fConst63 * (fTemp30 + (fConst62 * fRec47[0])))))));
		fRec52[0] = ((fConst98 * (fVec10[0] + fVec10[1])) + (fConst96 * fRec52[1]));
		fRec51[0] = (fRec52[0] - (fConst94 * ((fConst93 * fRec51[2]) + (fConst60 * fRec51[1]))));
		...
		fRec3[0] = ((fConst104 * ((fConst46 * fRec4[1]) + (fConst23 * fRec4[0]))) + (fConst25 * fRec3[1]));
		...
		fRec53[0] = ((fConst104 * ((fConst46 * fRec54[1]) + (fConst23 * fRec54[0]))) + (fConst25 * fRec53[1]));
		fRec2[0] = ((min(0.7, fRec53[0]) + max(-0.75, fRec3[0])) - (fConst22 * ((fConst21 * fRec2[2]) + fTemp2)));
		fRec1[0] = ((fConst22 * ((fTemp2 + (fConst107 * fRec2[0])) + (fConst106 * fRec2[2]))) - (fConst15 * ((fConst14 * fRec1[2]) + fTemp1)));
		fRec0[0] = ((fConst15 * ((fTemp1 + (fConst110 * fRec1[0])) + (fConst109 * fRec1[2]))) - (fConst8 * ((fConst7 * fRec0[2]) + fTemp0)));
		output0[i] = (FAUSTFLOAT)(fConst8 * ((fTemp0 + (fConst113 * fRec0[0])) + (fConst112 * fRec0[2])));
		// post processing
