...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec31[0] = (fConst30 * ((fConst31 * fRec31[1]) + (0.10000000000000001 * (fRec27[0] - fRec27[1]))));
		...
		double fTemp5 = ((fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec39[1]))) + 100000.0));
		fVec1[0] = fTemp5;
		fRec42[0] = (fConst33 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst34 * fRec42[1])));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp3 + (fRec42[0] + fTemp4)) + -0.77616200000000002)))) + -78.255866666666662);
		fRec38[0] = ((0.10000000000000001 * ((fConst4 * fRec39[0]) + (fConst27 * fRec39[1]))) - (fConst28 * fRec38[1]));
		fRec43[0] = (fConst30 * ((fConst31 * fRec43[1]) + (0.10000000000000001 * (fRec39[0] - fRec39[1]))));
		fRec48[0] = (fSlow6 + (0.999 * fRec48[1]));
		double fTemp6 = (double(input0[i0]) * fRec48[0]);
		fVec2[0] = fTemp6;
		fRec47[0] = ((1.8605695850647828 * (fTemp6 + fVec2[1])) - (0.86056958506478287 * fRec47[1]));
		...
		double fTemp9 = ((fTemp8 + fTemp7) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec45[1]))) + 100000.0));
		fVec3[0] = fTemp9;
		fRec49[0] = (fConst36 * ((2700.0 * (fTemp9 + fVec3[1])) - (fConst37 * fRec49[1])));
		fRec45[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp7 + (fRec49[0] + fTemp8)) + -1.2572399999999999)))) + -83.435555555555567);
		fRec44[0] = ((0.10000000000000001 * ((fConst4 * fRec45[0]) + (fConst27 * fRec45[1]))) - (fConst28 * fRec44[1]));
		fRec50[0] = (fConst30 * ((fConst31 * fRec50[1]) + (0.10000000000000001 * (fRec45[0] - fRec45[1]))));
		...
		double fTemp12 = ((fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec33[1]))) + 100000.0));
		fVec4[0] = fTemp12;
		fRec51[0] = (fConst33 * ((1500.0 * (fTemp12 + fVec4[1])) - (fConst34 * fRec51[1])));
		fRec33[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp10 + (fRec51[0] + fTemp11)) + -0.77616200000000002)))) + -78.255866666666662);
		fRec32[0] = ((0.10000000000000001 * ((fConst4 * fRec33[0]) + (fConst27 * fRec33[1]))) - (fConst28 * fRec32[1]));
		fRec52[0] = (fConst30 * ((fConst31 * fRec52[1]) + (0.10000000000000001 * (fRec33[0] - fRec33[1]))));
		...
		fRec22[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp13 + (fRec53[0] + fTemp14)) + -0.44548700000000002)))) + -75.672317073170731);
		fRec21[0] = ((0.10000000000000001 * ((fConst4 * fRec22[0]) + (fConst27 * fRec22[1]))) - (fConst28 * fRec21[1]));
		fRec54[0] = (fConst30 * ((fConst31 * fRec54[1]) + (0.10000000000000001 * (fRec22[0] - fRec22[1]))));
		...
		double fTemp38 = (fTemp16 * (1.0 - fRec55[0]));
		double fTemp39 = ((fSlow3 * fRec13[0]) + ((fTemp38 * ((fSlow11 * ((4.0 * (1.0 - std::fabs(fTemp38))) + -1.0)) + 1.0)) + (fSlow12 * fTemp26)));
		fVec11[0] = fTemp39;
		fRec12[0] = (0.0 - (fConst6 * ((fConst7 * fRec12[1]) - (fTemp39 + fVec11[1]))));
		fRec69[0] = (fSlow13 + (0.999 * fRec69[1]));
		double fTemp40 = (fRec12[0] * fRec69[0]);
		fVec12[0] = fTemp40;
		...
		fVec13[0] = fTemp44;
		fRec70[0] = (fConst6 * ((410.0 * (fTemp44 + fVec13[1])) - (fConst7 * fRec70[1])));
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp41 + (fRec70[0] + fTemp42)) + -0.65976100000000004)))) + -89.08268292682925);
		...
		double fTemp45 = (fTemp43 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec73[1]))) + 100000.0));
		fVec14[0] = fTemp45;
		fRec74[0] = (fConst6 * ((410.0 * (fTemp45 + fVec14[1])) - (fConst7 * fRec74[1])));
		fRec73[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp41 + (fRec74[0] + fTemp42)) + -0.66454100000000005)))) + -87.916829268292673);
		...
		double fTemp46 = (std::min<double>(0.69999999999999996, (iSlow0 ? fRec71[0] : fRec8[0])) + std::max<double>(-0.75, (iSlow0 ? fRec75[0] : fRec72[0])));
