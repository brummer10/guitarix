...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp15 = ((fRec8[0] * (((fSlow3 * fRec13[0]) + ((fTemp13 + (fSlow9 * ((4.0 * (fTemp14 * (1.0 - std::fabs(fTemp14)))) + (-1.0000000000000001e-15 - fTemp13)))) + (fSlow10 * (fTemp1 + 1.0000000000000001e-15)))) + 1.0000000000000001e-15)) + 1.0000000000000001e-15);
		fVec4[0] = fTemp15;
		...
		double fTemp17 = ((fRec8[0] * fRec9[0]) + 1.0000000000000001e-15);
		fVec6[0] = fTemp17;
		fRec7[0] = ((0.93028479253239138 * (fTemp17 + fVec6[1])) - (0.86056958506478287 * fRec7[1]));
		fRec6[0] = (fRec7[0] - ((1.8405051250752198 * fRec6[1]) + (0.86129424393186271 * fRec6[2])));
		double fTemp18 = ((0.014999999999999999 * fRec5[1]) + 1.0000000000000001e-15);
		fVec7[0] = fTemp18;
		fRec33[0] = (0.0 - (fConst63 * ((fConst64 * fRec33[1]) - (fTemp18 + fVec7[1]))));
		...
		double fTemp19 = (fRec3[0] + (1.0000000000000001e-15 - (1.0589999999999999 * fRec3[1])));
		fVec8[0] = fTemp19;
		fRec2[0] = ((0.93028479253239138 * (fTemp19 + fVec8[1])) - (0.86056958506478287 * fRec2[1]));
		fRec1[0] = (fRec2[0] - ((1.8405051250752198 * fRec1[1]) + (0.86129424393186271 * fRec1[2])));
		double fTemp20 = ((0.0082000000000000007 * fRec0[1]) + 1.0000000000000001e-15);
		fVec9[0] = fTemp20;
		fRec35[0] = (0.0 - (fConst68 * ((fConst69 * fRec35[1]) - (fTemp20 + fVec9[1]))));
