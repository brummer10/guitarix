...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp16 + (fRec35[0] + fTemp17)) + -2.2961499999999999))));
		fRec13[0] = ((fTemp19 + (0.00085042592592592592 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp19))) + 100000.0))) + -250.0);
		...
		double fTemp24 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp21 + (fRec36[0] + fTemp22)) + -1.6755869999999999))));
		fRec7[0] = ((fTemp24 + (0.001117058 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp24))) + 100000.0))) + -250.0);
		...
		fVec8[0] = fTemp25;
		fRec3[0] = ((0.93028479253239138 * (fTemp25 + fVec8[1])) - (0.86056958506478287 * fRec3[1]));
		...
		fVec9[0] = fTemp28;
		fRec38[0] = (fConst71 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst72 * fRec38[1])));
		double fTemp29 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp26 + (fRec38[0] + fTemp27)) + -1.1304620000000001))));
		fRec1[0] = ((fTemp29 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp29))) + 100000.0))) + -250.0);
