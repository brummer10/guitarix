...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec0[0] = fTemp4;
		fRec24[0] = -(fConst36 * (fConst3 * fRec24[1] - fConst35 * (fTemp4 - fVec0[1])));
		...
		fVec1[0] = fTemp5;
		fRec21[0] = -(fConst41 * (fConst39 * fRec21[1] - fConst28 * (fTemp5 + fVec1[1])));
		fRec20[0] = fRec21[0] - fConst21 * (fConst19 * fRec20[2] + fConst17 * fRec20[1]);
		double fTemp6 = fRec20[2] + fRec20[0] + 2.0 * fRec20[1];
		fVec2[0] = fTemp6;
		fRec19[0] = -(fConst44 * (fConst42 * fRec19[1] - fConst21 * (fTemp6 + fVec2[1])));
		...
		fRec27[0] = -(fConst44 * (fConst42 * fRec27[1] - fConst45 * (fTemp6 - fVec2[1])));
		fRec26[0] = fRec27[0] - fConst14 * (fConst12 * fRec26[2] + fConst10 * fRec26[1]);
		double fTemp8 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec26[2] + (fRec26[0] - 2.0 * fRec26[1]))));
		double fTemp9 = fConst10 * fRec28[1];
		double fTemp10 = fConst17 * fRec29[1];
		...
		fRec29[0] = fConst51 * (fRec30[2] + (fRec30[0] - 2.0 * fRec30[1])) - fConst50 * (fConst49 * fRec29[2] + fTemp10);
		fRec28[0] = fRec29[2] + fConst50 * (fTemp10 + fConst49 * fRec29[0]) - fConst48 * (fConst47 * fRec28[2] + fTemp9);
		double fTemp11 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec28[2] + fConst48 * (fTemp9 + fConst47 * fRec28[0]))));
		double fTemp12 = fConst10 * fRec32[1];
		fRec34[0] = -(fConst41 * (fConst39 * fRec34[1] - fConst52 * (fTemp5 - fVec1[1])));
		fRec33[0] = fRec34[0] - fConst21 * (fConst19 * fRec33[2] + fConst17 * fRec33[1]);
		fRec32[0] = fConst53 * (fRec33[2] + (fRec33[0] - 2.0 * fRec33[1])) - fConst48 * (fConst47 * fRec32[2] + fTemp12);
		double fTemp13 = std::max<double>(-1.0, std::min<double>(1.0, fSlow11 * (fRec32[2] + fConst48 * (fTemp12 + fConst47 * fRec32[0]))));
		...
		fVec3[0] = fTemp14;
		fRec17[0] = -(fConst54 * (fConst7 * fRec17[1] - (fTemp14 + fVec3[1])));
		...
		fVec5[0] = fTemp18;
		fRec36[0] = fConst57 * (2.7e+03 * (fTemp18 + fVec5[1]) - fConst56 * fRec36[1]);
		fRec13[0] = Ftube(TUBE_TABLE_6V6_68k, fTemp17 + fRec36[0] + fTemp16 + -2.29615) + -164.9574074074074;
		double fTemp19 = fRec13[0] - fRec13[1];
		fRec12[0] = fConst36 * (fConst58 * fTemp19 - fConst3 * fRec12[1]);
		fRec37[0] = fConst61 * (fConst60 * fRec37[1] + 0.025 * fTemp19);
		double fTemp20 = ((iSlow2) ? fRec37[0] : fRec12[0]);
		fVec6[0] = fTemp20;
		fRec11[0] = fConst54 * (0.77 * (fTemp20 + fVec6[1]) - fConst7 * fRec11[1]);
		...
		fVec8[0] = fTemp24;
		fRec38[0] = fConst64 * (1.5e+03 * (fTemp24 + fVec8[1]) - fConst63 * fRec38[1]);
		fRec8[0] = Ftube(TUBE_TABLE_6V6_250k, fTemp23 + fRec38[0] + fTemp22 + -1.675587) + -138.2942;
		double fTemp25 = fRec8[0] - fRec8[1];
		fRec7[0] = fConst36 * (fConst58 * fTemp25 - fConst3 * fRec7[1]);
		fRec39[0] = fConst61 * (fConst60 * fRec39[1] + 0.025 * fTemp25);
		double fTemp26 = ((iSlow2) ? fRec39[0] : fRec7[0]);
		fVec9[0] = fTemp26;
		fRec6[0] = fConst54 * (0.77 * (fTemp26 + fVec9[1]) - fConst7 * fRec6[1]);
		fRec4[0] = fRec6[0] * fRec5[0] + fConst5 * fRec4[1] - 0.8502684100000001 * fRec4[2];
		double fTemp27 = fRec4[0] - 1.059 * fRec4[1];
		fVec10[0] = fTemp27;
		fRec3[0] = 0.9302847925323914 * (fTemp27 + fVec10[1]) - 0.8605695850647829 * fRec3[1];
		fRec2[0] = fRec3[0] - (1.8405051250752198 * fRec2[1] + 0.8612942439318627 * fRec2[2]);
		double fTemp28 = 1.8508996845035413 * fRec2[1];
		double fTemp29 = 0.9254498422517706 * (fRec2[0] + fRec2[2]);
		double fTemp30 = (fTemp28 + fTemp29) / (Ranode(TUBE_TABLE_6V6_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp30;
		fRec40[0] = fConst67 * (8.2e+02 * (fTemp30 + fVec11[1]) - fConst66 * fRec40[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6V6_250k, fTemp29 + fRec40[0] + fTemp28 + -1.130462) + -112.13878048780487;
		double fTemp31 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst36 * (fConst58 * fTemp31 - fConst3 * fRec0[1]);
		fRec41[0] = fConst61 * (fConst60 * fRec41[1] + 0.025 * fTemp31);
