...
inline void Dsp::init(uint32_t RsamplingFreq)
{
	...
	fConst7 = 1.0 / fConst6;
	double fConst8 = 2.08332871602678e-05 * fConst0;
	...
	double fConst17 = 0.00044179999999999995 * fConst0;
...
#define fHslider1 (*fHslider1_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec1[0] = asymhardclip2(fConst21 * (0.75 * fRec6[0] + 0.5) * (1.85360131346578e-09 * fRec2[1] - 9.26800656732889e-10 * fRec2[0] - 9.26800656732889e-10 * fRec2[2])) - fRec1[1] * (0.0593824228028504 - fTemp0) / fTemp1;
