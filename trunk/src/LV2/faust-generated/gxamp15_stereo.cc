...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp1 + (fRec27[0] + fTemp2)) + -2.617753)))) + -153.04618518518518);
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp5 + (fRec29[0] + fTemp6)) + -1.887332)))) + -124.17786666666666);
		...
		fRec14[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp9 + (fRec31[0] + fTemp10)) + -1.2569619999999999)))) + -96.711951219512201);
		...
		double fTemp38 = ((fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec74[1]))) + 100000.0));
		fVec15[0] = fTemp38;
		fRec77[0] = (fConst25 * ((2700.0 * (fTemp38 + fVec15[1])) - (fConst26 * fRec77[1])));
		fRec74[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp36 + (fRec77[0] + fTemp37)) + -2.617753)))) + -153.04618518518518);
		fRec73[0] = ((0.025000000000000001 * ((fConst4 * fRec74[0]) + (fConst27 * fRec74[1]))) - (fConst28 * fRec73[1]));
		fRec78[0] = (fConst30 * ((fConst31 * fRec78[1]) + (0.025000000000000001 * (fRec74[0] - fRec74[1]))));
		...
		double fTemp42 = ((fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec69[1]))) + 100000.0));
		fVec17[0] = fTemp42;
		fRec79[0] = (fConst33 * ((1500.0 * (fTemp42 + fVec17[1])) - (fConst34 * fRec79[1])));
		fRec69[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp40 + (fRec79[0] + fTemp41)) + -1.887332)))) + -124.17786666666666);
		fRec68[0] = ((0.025000000000000001 * ((fConst4 * fRec69[0]) + (fConst27 * fRec69[1]))) - (fConst28 * fRec68[1]));
		fRec80[0] = (fConst30 * ((fConst31 * fRec80[1]) + (0.025000000000000001 * (fRec69[0] - fRec69[1]))));
		...
		double fTemp46 = ((fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec65[1]))) + 100000.0));
		fVec19[0] = fTemp46;
		fRec81[0] = (fConst36 * ((820.0 * (fTemp46 + fVec19[1])) - (fConst37 * fRec81[1])));
		fRec65[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp44 + (fRec81[0] + fTemp45)) + -1.2569619999999999)))) + -96.711951219512201);
		fRec64[0] = ((0.025000000000000001 * ((fConst4 * fRec65[0]) + (fConst27 * fRec65[1]))) - (fConst28 * fRec64[1]));
		fRec82[0] = (fConst30 * ((fConst31 * fRec82[1]) + (0.025000000000000001 * (fRec65[0] - fRec65[1]))));
