...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec12[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec14[0] + ((double)input0[i] * fRec13[0])) - 2.617752999999999)) - 153.04618518518518);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec15[0] + fRec10[0]) - 1.887331999999999)) - 124.17786666666666);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec16[0] + fRec8[0]) - 1.2569619999999988)) - 96.7119512195122);
		...
		double fTemp12 = (fConst24 * fRec26[1]);
		...
		fRec26[0] = ((fConst34 * (((fConst29 * fRec27[0]) + (fConst61 * fRec27[1])) + (fConst29 * fRec27[2]))) - (fConst59 * ((fConst58 * fRec26[2]) + fTemp12)));
		double fTemp13 = max((double)-1, min((double)1, (fSlow8 * (fRec26[2] + (fConst59 * (fTemp12 + (fConst58 * fRec26[0])))))));
		double fTemp14 = (fConst24 * fRec29[1]);
		double fTemp15 = (fConst30 * fRec30[1]);
		...
		fRec30[0] = ((fConst41 * (((fConst36 * fRec31[0]) + (fConst65 * fRec31[1])) + (fConst36 * fRec31[2]))) - (fConst63 * ((fConst62 * fRec30[2]) + fTemp15)));
		fRec29[0] = ((fRec30[2] + (fConst63 * (fTemp15 + (fConst62 * fRec30[0])))) - (fConst59 * ((fConst58 * fRec29[2]) + fTemp14)));
		double fTemp16 = max((double)-1, min((double)1, (fSlow9 * (fRec29[2] + (fConst59 * (fTemp14 + (fConst58 * fRec29[0])))))));
		...
		double fTemp17 = max((double)-1, min((double)1, (fSlow10 * (((fConst23 * fRec33[0]) + (fConst67 * fRec33[1])) + (fConst23 * fRec33[2])))));
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec48[0] + ((double)input1[i] * fRec13[0])) - 2.617752999999999)) - 153.04618518518518);
		...
		fRec44[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec49[0] + fRec45[0]) - 1.887331999999999)) - 124.17786666666666);
		...
		fRec42[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec50[0] + fRec43[0]) - 1.2569619999999988)) - 96.7119512195122);
		...
		fRec62[0] = ((fConst54 * fRec62[1]) + (fConst53 * ((fConst31 * fVec14[0]) + (fConst60 * fVec14[1]))));
		fRec61[0] = (fRec62[0] - (fConst34 * ((fConst32 * fRec61[2]) + (fConst30 * fRec61[1]))));
		fRec60[0] = ((fConst34 * (((fConst29 * fRec61[0]) + (fConst61 * fRec61[1])) + (fConst29 * fRec61[2]))) - (fConst59 * ((fConst58 * fRec60[2]) + fTemp32)));
		double fTemp33 = max((double)-1, min((double)1, (fSlow8 * (fRec60[2] + (fConst59 * (fTemp32 + (fConst58 * fRec60[0])))))));
		double fTemp34 = (fConst24 * fRec63[1]);
		double fTemp35 = (fConst30 * fRec64[1]);
		fRec66[0] = ((fConst51 * fRec66[1]) + (fConst50 * ((fConst38 * fRec58[0]) + (fConst64 * fRec58[1]))));
		fRec65[0] = (fRec66[0] - (fConst41 * ((fConst39 * fRec65[2]) + (fConst37 * fRec65[1]))));
		fRec64[0] = ((fConst41 * (((fConst36 * fRec65[0]) + (fConst65 * fRec65[1])) + (fConst36 * fRec65[2]))) - (fConst63 * ((fConst62 * fRec64[2]) + fTemp35)));
		fRec63[0] = ((fRec64[2] + (fConst63 * (fTemp35 + (fConst62 * fRec64[0])))) - (fConst59 * ((fConst58 * fRec63[2]) + fTemp34)));
		double fTemp36 = max((double)-1, min((double)1, (fSlow9 * (fRec63[2] + (fConst59 * (fTemp34 + (fConst58 * fRec63[0])))))));
		fRec68[0] = ((fConst57 * fRec68[1]) + (fConst56 * ((fConst25 * fVec15[0]) + (fConst66 * fVec15[1]))));
		fRec67[0] = (fRec68[0] - (fConst27 * ((fConst26 * fRec67[2]) + (fConst24 * fRec67[1]))));
		double fTemp37 = max((double)-1, min((double)1, (fSlow10 * (((fConst23 * fRec67[0]) + (fConst67 * fRec67[1])) + (fConst23 * fRec67[2])))));
		...
		fRec38[0] = ((fConst13 * fRec38[1]) + (fConst12 * ((fConst9 * fRec39[0]) + (fConst10 * fRec39[1]))));
		...
		fRec70[0] = ((fConst13 * fRec70[1]) + (fConst12 * ((fConst9 * fRec71[0]) + (fConst10 * fRec71[1]))));
