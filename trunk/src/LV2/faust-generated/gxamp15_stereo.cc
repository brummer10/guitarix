...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp3 = (fTemp1 + fTemp2) / (Ranode(TUBE_TABLE_12AT7_68k, fRec16[1]) + 1e+05);
		fVec1[0] = fTemp3;
		fRec20[0] = fConst6 * (2.7e+03 * (fTemp3 + fVec1[1]) - fConst5 * fRec20[1]);
		fRec16[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp2 + fRec20[0] + fTemp1 + -2.617753) + -153.04618518518518;
		...
		double fTemp8 = (fTemp6 + fTemp7) / (Ranode(TUBE_TABLE_12AT7_250k, fRec11[1]) + 1e+05);
		fVec3[0] = fTemp8;
		fRec22[0] = fConst17 * (1.5e+03 * (fTemp8 + fVec3[1]) - fConst16 * fRec22[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp7 + fRec22[0] + fTemp6 + -1.887332) + -124.17786666666666;
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_12AT7_250k, fRec7[1]) + 1e+05);
		fVec5[0] = fTemp13;
		fRec24[0] = fConst20 * (8.2e+02 * (fTemp13 + fVec5[1]) - fConst19 * fRec24[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp12 + fRec24[0] + fTemp11 + -1.256962) + -96.7119512195122;
		...
		double fTemp43 = (fTemp41 + fTemp42) / (Ranode(TUBE_TABLE_12AT7_68k, fRec66[1]) + 1e+05);
		fVec15[0] = fTemp43;
		fRec69[0] = fConst6 * (2.7e+03 * (fTemp43 + fVec15[1]) - fConst5 * fRec69[1]);
		fRec66[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp42 + fRec69[0] + fTemp41 + -2.617753) + -153.04618518518518;
		...
		double fTemp48 = (fTemp46 + fTemp47) / (Ranode(TUBE_TABLE_12AT7_250k, fRec61[1]) + 1e+05);
		fVec17[0] = fTemp48;
		fRec71[0] = fConst17 * (1.5e+03 * (fTemp48 + fVec17[1]) - fConst16 * fRec71[1]);
		fRec61[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp47 + fRec71[0] + fTemp46 + -1.887332) + -124.17786666666666;
		...
		double fTemp53 = (fTemp51 + fTemp52) / (Ranode(TUBE_TABLE_12AT7_250k, fRec57[1]) + 1e+05);
		fVec19[0] = fTemp53;
		fRec73[0] = fConst20 * (8.2e+02 * (fTemp53 + fVec19[1]) - fConst19 * fRec73[1]);
		fRec57[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp52 + fRec73[0] + fTemp51 + -1.256962) + -96.7119512195122;
