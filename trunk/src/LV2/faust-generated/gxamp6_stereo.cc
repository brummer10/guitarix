...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec101[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec108[0] + (0.9254498422517706 * (fRec102[2] + (fRec102[0] + (2.0 * fRec102[1]))))) - 1.863946)) - 60.96496296296296);
		...
		fRec110[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec113[0] + (0.9254498422517706 * (fRec111[2] + (fRec111[0] + (2.0 * fRec111[1]))))) - 1.271609)) - 45.22606666666667);
		...
		fRec95[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec114[0] + (0.9254498422517706 * (fRec96[2] + (fRec96[0] + (2.0 * fRec96[1]))))) - 1.271609)) - 45.22606666666667);
		...
		fRec116[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec119[0] + (0.9254498422517706 * (fRec117[2] + (fRec117[0] + (2.0 * fRec117[1]))))) - 0.797043)) - 32.799634146341475);
		...
		fRec90[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec120[0] + (0.9254498422517706 * (fRec91[2] + (fRec91[0] + (2.0 * fRec91[1]))))) - 0.797043)) - 32.799634146341475);
