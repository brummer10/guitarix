...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec70[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec75[0] + (fConst24 * (fRec22[0] * (fRec71[2] + (fRec71[0] + (2 * fRec71[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fRec77[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec78[0] + fRec68[1]) - 1.271609)) - 45.22606666666667);
		...
		fRec66[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec79[0] + fRec67[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec81[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec82[0] + fRec64[1]) - 0.797043)) - 32.799634146341475);
		...
		fRec63[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec83[0] + fRec64[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec59[0] = ((fConst93 * ((fConst34 * fRec60[1]) + (fConst13 * fRec60[0]))) + (fConst15 * fRec59[1]));
		...
		fRec106[0] = ((fConst93 * ((fConst34 * fRec107[1]) + (fConst13 * fRec107[0]))) + (fConst15 * fRec106[1]));
		double fTemp58 = (min(0.7, fRec106[0]) + max(-0.75, fRec59[0]));
		fVec15[0] = fTemp58;
		fRec58[0] = (fConst95 * ((fVec15[2] + (fVec15[0] + (fConst94 * fVec15[1]))) + ((fConst12 * fRec58[2]) + (fConst10 * fRec58[1]))));
		fRec57[0] = (fConst97 * ((fRec58[2] + (fRec58[0] + (fConst96 * fRec58[1]))) + ((fConst8 * fRec57[2]) + (fConst6 * fRec57[1]))));
		fRec56[0] = (fConst99 * ((fRec57[2] + (fRec57[0] + (fConst98 * fRec57[1]))) + ((fConst4 * fRec56[2]) + (fConst2 * fRec56[1]))));
