...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	IOTA = 0;
	iConst67 = int((int((0.1111111111111111 * iConst0)) & 65535));
	fConst68 = (0.009000000000000008 / double(iConst0));
	fConst69 = (1.0 / (fConst7 * fConst65));
	fConst70 = (1.0 / fConst59);
	fConst71 = (0 - fConst46);
	fConst72 = (1.0 / (fConst50 * fConst57));
	fConst73 = (2 * (0 - fConst44));
	fConst74 = (1 + ((fConst40 - 1.0000000000000004) / fConst37));
	fConst75 = (1.0 / (1 + ((fConst40 + 1.0000000000000004) / fConst37)));
	fConst76 = (1 + fConst40);
	fConst77 = (0 - ((1 - fConst40) / fConst76));
	fConst78 = (0 - fConst40);
	fConst79 = (1.0 / (fConst76 * fConst48));
	fConst80 = (2 * (0 - fConst38));
	fConst81 = (1 + ((fConst46 - 1.0) / fConst43));
	fConst82 = (1.0 / (1 + ((1.0 + fConst46) / fConst43)));
	fConst83 = (0 - fConst55);
	fConst84 = (2 * (0 - fConst53));
...
#define fslider3 (*fslider3_)
	...
	double 	fSlow6 = (fConst75 * pow(1e+01,(2 * fSlow3)));
	double 	fSlow7 = pow(1e+01,(0.8 * fSlow3));
	double 	fSlow8 = (fConst75 * pow(1e+01,(0.9 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp11 = (fConst39 * fRec31[1]);
		double fTemp12 = (fRec7[0] * fRec6[0]);
		double fTemp13 = fabs(fTemp12);
		fRec40[0] = ((9.999999999998899e-05 * fTemp13) + (0.9999 * fRec40[1]));
		double fTemp14 = max(fRec40[0], fTemp13);
		fVec7[IOTA&32767] = fTemp14;
		fRec39[0] = ((fVec7[IOTA&32767] + fRec39[1]) - fVec7[(IOTA-iConst67)&32767]);
		fRec38[0] = ((fConst68 * fRec39[0]) + (0.999 * fRec38[1]));
		double fTemp15 = max(-1.0, min(-0.01, (fVec7[IOTA&32767] - (1.0 + (1.02 * fRec38[0])))));
		...
		fRec37[0] = ((0.024937655860349125 * fTemp24) - (fConst66 * ((fConst64 * fRec37[2]) + (fConst62 * fRec37[1]))));
		double fTemp25 = (fRec37[2] + (fRec37[0] + (2 * fRec37[1])));
		fVec8[0] = fTemp25;
		fRec36[0] = ((fConst69 * ((fConst27 * fVec8[1]) + (fConst6 * fVec8[0]))) + (fConst8 * fRec36[1]));
		fRec35[0] = ((fConst70 * (fRec36[0] + fRec36[1])) + (fConst60 * fRec35[1]));
		fRec34[0] = (fRec35[0] - (fConst58 * ((fConst56 * fRec34[2]) + (fConst54 * fRec34[1]))));
		double fTemp26 = (fRec34[2] + (fRec34[0] + (2 * fRec34[1])));
		fVec9[0] = fTemp26;
		fRec33[0] = ((fConst72 * ((fConst71 * fVec9[1]) + (fConst46 * fVec9[0]))) + (fConst51 * fRec33[1]));
		fRec32[0] = (fRec33[0] - (fConst49 * ((fConst47 * fRec32[2]) + (fConst45 * fRec32[1]))));
		fRec31[0] = ((fConst49 * (((fConst44 * fRec32[0]) + (fConst73 * fRec32[1])) + (fConst44 * fRec32[2]))) - (fConst42 * ((fConst41 * fRec31[2]) + fTemp11)));
		double fTemp27 = max((double)-1, min((double)1, (fSlow5 * (fRec31[2] + (fConst42 * (fTemp11 + (fConst41 * fRec31[0])))))));
		fRec44[0] = ((fConst72 * (fVec9[0] + fVec9[1])) + (fConst51 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst49 * ((fConst47 * fRec43[2]) + (fConst45 * fRec43[1]))));
		double fTemp28 = (fRec43[2] + (fRec43[0] + (2 * fRec43[1])));
		fVec10[0] = fTemp28;
		fRec42[0] = ((fConst79 * ((fConst78 * fVec10[1]) + (fConst40 * fVec10[0]))) + (fConst77 * fRec42[1]));
		fRec41[0] = (fRec42[0] - (fConst75 * ((fConst74 * fRec41[2]) + (fConst39 * fRec41[1]))));
		double fTemp29 = max((double)-1, min((double)1, (fSlow6 * (((fConst38 * fRec41[0]) + (fConst80 * fRec41[1])) + (fConst38 * fRec41[2])))));
		double fTemp30 = (fConst39 * fRec45[1]);
		double fTemp31 = (fConst45 * fRec46[1]);
		fRec48[0] = ((fConst70 * ((fConst83 * fRec36[1]) + (fConst55 * fRec36[0]))) + (fConst60 * fRec48[1]));
		fRec47[0] = (fRec48[0] - (fConst58 * ((fConst56 * fRec47[2]) + (fConst54 * fRec47[1]))));
		fRec46[0] = ((fConst58 * (((fConst53 * fRec47[0]) + (fConst84 * fRec47[1])) + (fConst53 * fRec47[2]))) - (fConst82 * ((fConst81 * fRec46[2]) + fTemp31)));
		fRec45[0] = ((fRec46[2] + (fConst82 * (fTemp31 + (fConst81 * fRec46[0])))) - (fConst42 * ((fConst41 * fRec45[2]) + fTemp30)));
		double fTemp32 = max((double)-1, min((double)1, (fSlow7 * (fRec45[2] + (fConst42 * (fTemp30 + (fConst41 * fRec45[0])))))));
		fRec50[0] = ((fConst79 * (fVec10[0] + fVec10[1])) + (fConst77 * fRec50[1]));
		fRec49[0] = (fRec50[0] - (fConst75 * ((fConst74 * fRec49[2]) + (fConst39 * fRec49[1]))));
		double fTemp33 = max((double)-1, min((double)1, (fSlow8 * (fRec49[2] + (fRec49[0] + (2 * fRec49[1]))))));
		...
		fVec11[0] = fTemp34;
		fRec30[0] = ((fConst12 * (fVec11[0] + fVec11[1])) + (fConst11 * fRec30[1]));
		double fTemp35 = (((fSlow11 * fTemp24) + (fSlow10 * fRec30[0])) + (fTemp10 * (1 + (fSlow4 * ((4 - (4 * fabs(fTemp10))) - 1)))));
		fVec12[0] = fTemp35;
		...
		double fTemp38 = (fRec54[1] + (fConst87 * fRec54[2]));
		fRec54[0] = (fConst90 * (fConst89 - fTemp38));
		double fTemp39 = (fConst90 * fTemp38);
		double fTemp40 = (fRec55[1] + (fConst92 * fRec55[2]));
		fRec55[0] = (fConst95 * (fConst94 - fTemp40));
		double fTemp41 = (fConst95 * fTemp40);
		...
		fRec67[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec72[0] + (fConst17 * (fRec20[0] * (fRec68[2] + (fRec68[0] + (2 * fRec68[1])))))) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec74[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec75[0] + fRec65[1]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec63[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec76[0] + fRec64[0]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec78[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec79[0] + fRec61[1]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec60[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec80[0] + fRec61[0]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec82[0] = ((fVec20[IOTA&32767] + fRec82[1]) - fVec20[(IOTA-iConst67)&32767]);
		fRec81[0] = ((fConst68 * fRec82[0]) + (0.999 * fRec81[1]));
		...
		double fTemp62 = (fConst39 * fRec85[1]);
		fRec91[0] = ((0.024937655860349125 * fTemp61) - (fConst66 * ((fConst64 * fRec91[2]) + (fConst62 * fRec91[1]))));
		double fTemp63 = (fRec91[2] + (fRec91[0] + (2 * fRec91[1])));
		fVec21[0] = fTemp63;
		fRec90[0] = ((fConst69 * ((fConst27 * fVec21[1]) + (fConst6 * fVec21[0]))) + (fConst8 * fRec90[1]));
		fRec89[0] = ((fConst70 * (fRec90[0] + fRec90[1])) + (fConst60 * fRec89[1]));
		fRec88[0] = (fRec89[0] - (fConst58 * ((fConst56 * fRec88[2]) + (fConst54 * fRec88[1]))));
		double fTemp64 = (fRec88[2] + (fRec88[0] + (2 * fRec88[1])));
		fVec22[0] = fTemp64;
		fRec87[0] = ((fConst72 * ((fConst71 * fVec22[1]) + (fConst46 * fVec22[0]))) + (fConst51 * fRec87[1]));
		fRec86[0] = (fRec87[0] - (fConst49 * ((fConst47 * fRec86[2]) + (fConst45 * fRec86[1]))));
		fRec85[0] = ((fConst49 * (((fConst44 * fRec86[0]) + (fConst73 * fRec86[1])) + (fConst44 * fRec86[2]))) - (fConst42 * ((fConst41 * fRec85[2]) + fTemp62)));
		double fTemp65 = max((double)-1, min((double)1, (fSlow5 * (fRec85[2] + (fConst42 * (fTemp62 + (fConst41 * fRec85[0])))))));
		fRec95[0] = ((fConst72 * (fVec22[0] + fVec22[1])) + (fConst51 * fRec95[1]));
		fRec94[0] = (fRec95[0] - (fConst49 * ((fConst47 * fRec94[2]) + (fConst45 * fRec94[1]))));
		double fTemp66 = (fRec94[2] + (fRec94[0] + (2 * fRec94[1])));
		fVec23[0] = fTemp66;
		fRec93[0] = ((fConst79 * ((fConst78 * fVec23[1]) + (fConst40 * fVec23[0]))) + (fConst77 * fRec93[1]));
		fRec92[0] = (fRec93[0] - (fConst75 * ((fConst74 * fRec92[2]) + (fConst39 * fRec92[1]))));
		double fTemp67 = max((double)-1, min((double)1, (fSlow6 * (((fConst38 * fRec92[0]) + (fConst80 * fRec92[1])) + (fConst38 * fRec92[2])))));
		double fTemp68 = (fConst39 * fRec96[1]);
		double fTemp69 = (fConst45 * fRec97[1]);
		fRec99[0] = ((fConst70 * ((fConst83 * fRec90[1]) + (fConst55 * fRec90[0]))) + (fConst60 * fRec99[1]));
		fRec98[0] = (fRec99[0] - (fConst58 * ((fConst56 * fRec98[2]) + (fConst54 * fRec98[1]))));
		fRec97[0] = ((fConst58 * (((fConst53 * fRec98[0]) + (fConst84 * fRec98[1])) + (fConst53 * fRec98[2]))) - (fConst82 * ((fConst81 * fRec97[2]) + fTemp69)));
		fRec96[0] = ((fRec97[2] + (fConst82 * (fTemp69 + (fConst81 * fRec97[0])))) - (fConst42 * ((fConst41 * fRec96[2]) + fTemp68)));
		double fTemp70 = max((double)-1, min((double)1, (fSlow7 * (fRec96[2] + (fConst42 * (fTemp68 + (fConst41 * fRec96[0])))))));
		fRec101[0] = ((fConst79 * (fVec23[0] + fVec23[1])) + (fConst77 * fRec101[1]));
		fRec100[0] = (fRec101[0] - (fConst75 * ((fConst74 * fRec100[2]) + (fConst39 * fRec100[1]))));
		double fTemp71 = max((double)-1, min((double)1, (fSlow8 * (fRec100[2] + (fRec100[0] + (2 * fRec100[1]))))));
		...
		double fTemp73 = (((fSlow10 * fRec84[0]) + (fSlow11 * fTemp61)) + (fTemp48 * (1 + (fSlow4 * ((4 - (4 * fabs(fTemp48))) - 1)))));
		fVec25[0] = fTemp73;
		...
		fRec56[0] = ((fConst85 * ((fConst27 * fRec57[1]) + (fConst6 * fRec57[0]))) + (fConst8 * fRec56[1]));
		...
		fRec103[0] = ((fConst85 * ((fConst27 * fRec104[1]) + (fConst6 * fRec104[0]))) + (fConst8 * fRec103[1]));
