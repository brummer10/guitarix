...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst45 = (1 + ((fConst41 + 1.0000000000000004) / fConst40));
	...
	fConst66 = (0 - ((1 - fConst41) / fConst64));
	fConst67 = (1 + fConst37);
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec43[0] = (fRec44[0] - (fConst46 * ((fConst44 * fRec43[1]) + (fConst42 * fRec43[2]))));
		...
		fRec51[0] = ((fConst66 * fRec51[1]) + (fConst65 * ((fConst41 * fVec9[0]) + (fConst72 * fVec9[1]))));
		fRec50[0] = (fRec51[0] - (fConst46 * ((fConst42 * fRec50[2]) + (fConst44 * fRec50[1]))));
		fRec49[0] = ((fConst46 * (((fConst43 * fRec50[0]) + (fConst73 * fRec50[1])) + (fConst43 * fRec50[2]))) - (fConst71 * ((fConst70 * fRec49[2]) + fTemp29)));
		...
		fRec83[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec88[0] + (fConst9 * (fRec30[0] * (fRec84[2] + (fRec84[0] + (2 * fRec84[1])))))) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec90[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec91[0] + fRec81[1]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec79[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec92[0] + fRec80[0]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec94[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec95[0] + fRec77[1]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec76[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec96[0] + fRec77[0]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec100[0] = (fRec101[0] - (fConst46 * ((fConst42 * fRec100[2]) + (fConst44 * fRec100[1]))));
		...
		fRec108[0] = ((fConst66 * fRec108[1]) + (fConst65 * ((fConst41 * fVec22[0]) + (fConst72 * fVec22[1]))));
		fRec107[0] = (fRec108[0] - (fConst46 * ((fConst42 * fRec107[2]) + (fConst44 * fRec107[1]))));
		fRec106[0] = ((fConst46 * (((fConst43 * fRec107[0]) + (fConst73 * fRec107[1])) + (fConst43 * fRec107[2]))) - (fConst71 * ((fConst70 * fRec106[2]) + fTemp68)));
		double fTemp69 = max((double)-1, min((double)1, (fSlow8 * (fRec106[2] + (fConst71 * ((fConst70 * fRec106[0]) + fTemp68))))));
		...
		fRec69[0] = ((fConst23 * fRec69[1]) + (fConst80 * ((fConst19 * fRec70[0]) + (fConst20 * fRec70[1]))));
		...
		fRec116[0] = ((fConst23 * fRec116[1]) + (fConst80 * ((fConst19 * fRec117[0]) + (fConst20 * fRec117[1]))));
