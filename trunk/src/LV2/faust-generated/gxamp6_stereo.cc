...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp54 = (fTemp53 + fTemp52) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec103[1]))) + 100000.0);
		fVec15[0] = fTemp54;
		fRec106[0] = fConst25 * (820.0 * (fTemp54 + fVec15[1]) - fConst26 * fRec106[1]);
		fRec103[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp52 + fRec106[0] + fTemp53 + -0.79704299999999995))) + -32.799634146341475;
		fRec102[0] = 0.050000000000000003 * (fConst4 * fRec103[0] + fConst27 * fRec103[1]) - fConst28 * fRec102[1];
		fRec107[0] = fConst30 * (fConst31 * fRec107[1] + 0.050000000000000003 * (fRec103[0] - fRec103[1]));
		...
		double fTemp57 = (fTemp56 + fTemp55) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec115[1]))) + 100000.0);
		fVec16[0] = fTemp57;
		fRec118[0] = fConst33 * (1500.0 * (fTemp57 + fVec16[1]) - fConst34 * fRec118[1]);
		fRec115[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp55 + fRec118[0] + fTemp56 + -1.271609))) + -45.226066666666668;
		fRec114[0] = 0.050000000000000003 * (fConst4 * fRec115[0] + fConst27 * fRec115[1]) - fConst28 * fRec114[1];
		fRec119[0] = fConst30 * (fConst31 * fRec119[1] + 0.050000000000000003 * (fRec115[0] - fRec115[1]));
		...
		double fTemp61 = (fTemp60 + fTemp59) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec121[1]))) + 100000.0);
		fVec18[0] = fTemp61;
		fRec124[0] = fConst36 * (2700.0 * (fTemp61 + fVec18[1]) - fConst37 * fRec124[1]);
		fRec121[0] = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(fTemp59 + fRec124[0] + fTemp60 + -1.8639460000000001))) + -60.964962962962957;
		fRec120[0] = 0.050000000000000003 * (fConst4 * fRec121[0] + fConst27 * fRec121[1]) - fConst28 * fRec120[1];
		fRec125[0] = fConst30 * (fConst31 * fRec125[1] + 0.050000000000000003 * (fRec121[0] - fRec121[1]));
		...
		double fTemp64 = (fTemp63 + fTemp62) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec109[1]))) + 100000.0);
		fVec19[0] = fTemp64;
		fRec126[0] = fConst33 * (1500.0 * (fTemp64 + fVec19[1]) - fConst34 * fRec126[1]);
		fRec109[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp62 + fRec126[0] + fTemp63 + -1.271609))) + -45.226066666666668;
		fRec108[0] = 0.050000000000000003 * (fConst4 * fRec109[0] + fConst27 * fRec109[1]) - fConst28 * fRec108[1];
		fRec127[0] = fConst30 * (fConst31 * fRec127[1] + 0.050000000000000003 * (fRec109[0] - fRec109[1]));
		...
		double fTemp67 = (fTemp66 + fTemp65) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec98[1]))) + 100000.0);
		fVec20[0] = fTemp67;
		fRec128[0] = fConst25 * (820.0 * (fTemp67 + fVec20[1]) - fConst26 * fRec128[1]);
		fRec98[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp65 + fRec128[0] + fTemp66 + -0.79704299999999995))) + -32.799634146341475;
		fRec97[0] = 0.050000000000000003 * (fConst4 * fRec98[0] + fConst27 * fRec98[1]) - fConst28 * fRec97[1];
		fRec129[0] = fConst30 * (fConst31 * fRec129[1] + 0.050000000000000003 * (fRec98[0] - fRec98[1]));
