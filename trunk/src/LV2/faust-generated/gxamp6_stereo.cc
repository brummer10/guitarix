...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec70[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec75[0] + (fConst34 * (fRec22[0] * (fRec71[2] + (fRec71[0] + (2 * fRec71[1])))))) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec65[0] = ((fConst45 * ((fConst44 * fRec66[1]) + (fConst23 * fRec66[0]))) + (fConst25 * fRec65[1]));
		...
		fRec59[0] = ((fConst102 * ((fConst44 * fRec60[1]) + (fConst23 * fRec60[0]))) + (fConst25 * fRec59[1]));
		...
		fRec106[0] = ((fConst102 * ((fConst44 * fRec107[1]) + (fConst23 * fRec107[0]))) + (fConst25 * fRec106[1]));
		fRec58[0] = ((min(0.7, fRec106[0]) + max(-0.75, fRec59[0])) - (fConst22 * ((fConst21 * fRec58[2]) + fTemp41)));
		fRec57[0] = ((fConst22 * ((fTemp41 + (fConst105 * fRec58[0])) + (fConst104 * fRec58[2]))) - (fConst15 * ((fConst14 * fRec57[2]) + fTemp40)));
		fRec56[0] = ((fConst15 * ((fTemp40 + (fConst108 * fRec57[0])) + (fConst107 * fRec57[2]))) - (fConst8 * ((fConst7 * fRec56[2]) + fTemp39)));
		output1[i] = (FAUSTFLOAT)(fConst8 * ((fTemp39 + (fConst111 * fRec56[0])) + (fConst110 * fRec56[2])));
		// post processing
