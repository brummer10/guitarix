...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec23[0] + (fConst34 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec3[0] = ((fConst102 * ((fConst44 * fRec4[1]) + (fConst23 * fRec4[0]))) + (fConst25 * fRec3[1]));
		...
		fRec53[0] = ((fConst102 * ((fConst44 * fRec54[1]) + (fConst23 * fRec54[0]))) + (fConst25 * fRec53[1]));
