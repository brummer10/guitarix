...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec31[0] = fConst30 * (fConst31 * fRec31[1] + 0.050000000000000003 * (fRec27[0] - fRec27[1]));
		...
		double fTemp5 = (fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec39[1]))) + 100000.0);
		fVec1[0] = fTemp5;
		fRec42[0] = fConst33 * (1500.0 * (fTemp5 + fVec1[1]) - fConst34 * fRec42[1]);
		fRec39[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp3 + fRec42[0] + fTemp4 + -1.271609))) + -45.226066666666668;
		fRec38[0] = 0.050000000000000003 * (fConst4 * fRec39[0] + fConst27 * fRec39[1]) - fConst28 * fRec38[1];
		fRec43[0] = fConst30 * (fConst31 * fRec43[1] + 0.050000000000000003 * (fRec39[0] - fRec39[1]));
		...
		double fTemp9 = (fTemp8 + fTemp7) / (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fRec45[1]))) + 100000.0);
		fVec3[0] = fTemp9;
		fRec49[0] = fConst36 * (2700.0 * (fTemp9 + fVec3[1]) - fConst37 * fRec49[1]);
		fRec45[0] = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(fTemp7 + fRec49[0] + fTemp8 + -1.8639460000000001))) + -60.964962962962957;
		fRec44[0] = 0.050000000000000003 * (fConst4 * fRec45[0] + fConst27 * fRec45[1]) - fConst28 * fRec44[1];
		fRec50[0] = fConst30 * (fConst31 * fRec50[1] + 0.050000000000000003 * (fRec45[0] - fRec45[1]));
		...
		double fTemp12 = (fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec33[1]))) + 100000.0);
		fVec4[0] = fTemp12;
		fRec51[0] = fConst33 * (1500.0 * (fTemp12 + fVec4[1]) - fConst34 * fRec51[1]);
		fRec33[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp10 + fRec51[0] + fTemp11 + -1.271609))) + -45.226066666666668;
		fRec32[0] = 0.050000000000000003 * (fConst4 * fRec33[0] + fConst27 * fRec33[1]) - fConst28 * fRec32[1];
		fRec52[0] = fConst30 * (fConst31 * fRec52[1] + 0.050000000000000003 * (fRec33[0] - fRec33[1]));
		...
		fRec22[0] = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(fTemp13 + fRec53[0] + fTemp14 + -0.79704299999999995))) + -32.799634146341475;
		fRec21[0] = 0.050000000000000003 * (fConst4 * fRec22[0] + fConst27 * fRec22[1]) - fConst28 * fRec21[1];
		fRec54[0] = fConst30 * (fConst31 * fRec54[1] + 0.050000000000000003 * (fRec22[0] - fRec22[1]));
