...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst85 = (0.025 / fConst7);
	fConst86 = (49574.33207364693 / double(iConst0));
	fConst87 = (0 - (2 * cos(fConst86)));
	fConst88 = (0.07042253521126761 * sin(fConst86));
	fConst89 = (1 - fConst88);
	fConst90 = (1.0 / (1 + fConst88));
	fConst91 = (31704.95306002819 / double(iConst0));
	fConst92 = (0 - (2 * cos(fConst91)));
	fConst93 = (0.026178010471204185 * sin(fConst91));
	fConst94 = (1 - fConst93);
	fConst95 = (1.0 / (1 + fConst93));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec15[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec21[0] + (fConst17 * (fRec20[0] * (fRec16[2] + (fRec16[0] + (2 * fRec16[1])))))) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec23[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec24[0] + fRec13[1]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec25[0] + fRec12[0]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec27[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec28[0] + fRec9[1]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec29[0] + fRec9[0]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec1[0] = ((fConst85 * ((fConst27 * fRec2[1]) + (fConst6 * fRec2[0]))) + (fConst8 * fRec1[1]));
		...
		fRec51[0] = ((fConst85 * ((fConst27 * fRec52[1]) + (fConst6 * fRec52[0]))) + (fConst8 * fRec51[1]));
		double fTemp36 = (fRec54[1] + (fConst87 * fRec54[2]));
		fRec54[0] = (fConst90 * (fConst89 - fTemp36));
		double fTemp37 = (fRec55[1] + (fConst92 * fRec55[2]));
		fRec55[0] = (fConst95 * (fConst94 - fTemp37));
		output0[i] = (FAUSTFLOAT)((fConst95 * fTemp37) + (fRec55[0] * ((fConst90 * fTemp36) + (fRec54[0] * (((min(0.7, fRec51[0]) + max(-0.75, fRec1[0])) * fRec0[0]) + (fConst5 * fTemp0))))));
		// post processing
