...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp32 = ((fSlow2 * fRec12[0]) + ((fTemp31 * ((fSlow9 * ((0.20000000000000001 * (1.0 - std::fabs((0.050000000000000003 * fTemp31)))) + -0.050000000000000003)) + 0.050000000000000003)) + (fSlow10 * fTemp19)));
		fVec15[0] = fTemp32;
