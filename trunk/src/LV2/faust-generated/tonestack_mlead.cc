...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (1.815e-07 * fSlow15 + fSlow1 * (3.781250000000001e-07 - fSlow2) + fSlow0 * (1.2375000000000003e-05 * fSlow1 + 3.4760000000000007e-06) + 8.690000000000002e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 4.2803750000000003e-11) + fSlow15 * (fSlow4 + 4.991250000000001e-11 * (1.0 - fSlow1));
