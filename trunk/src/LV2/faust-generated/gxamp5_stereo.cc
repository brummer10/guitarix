...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec19[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec20[0] + fRec20[2])) + (fRec23[0] + (1.8508996845035413 * fRec20[1]))) + -1.581656)))) + -191.42014814814814);
		...
		fRec15[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec16[0] + fRec16[2])) + (fRec24[0] + (1.8508996845035413 * fRec16[1]))) + -1.204285)))) + -169.71433333333334);
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec13[0] + fRec13[2])) + (fRec25[0] + (1.8508996845035413 * fRec13[1]))) + -0.84070299999999998)))) + -147.47524390243905);
		...
		double fTemp19 = (0.025000000000000001 * (fRec12[0] * fTemp18));
		...
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec61[0] + fRec61[2])) + (fRec63[0] + (1.8508996845035413 * fRec61[1]))) + -1.581656)))) + -191.42014814814814);
		fRec59[0] = (fConst2 * ((0.025000000000000001 * (fRec60[0] + fRec60[1])) - (fConst3 * fRec59[1])));
		...
		fRec56[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec57[0] + fRec57[2])) + (fRec64[0] + (1.8508996845035413 * fRec57[1]))) + -1.204285)))) + -169.71433333333334);
		double fTemp31 = ((0.025000000000000001 * fRec56[0]) + 1.0000000000000001e-15);
		fVec18[0] = fTemp31;
		...
		fRec53[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec54[0] + fRec54[2])) + (fRec65[0] + (1.8508996845035413 * fRec54[1]))) + -0.84070299999999998)))) + -147.47524390243905);
		double fTemp33 = (0.025000000000000001 * (fRec26[0] * fRec53[0]));
		...
		double fTemp45 = (0.025000000000000001 * (fRec53[0] * fTemp18));
