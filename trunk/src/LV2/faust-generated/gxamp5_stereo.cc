...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec12[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec14[0] + ((double)input0[i] * fRec13[0])) - 1.5816559999999988)) - 191.42014814814814);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec15[0] + fRec10[0]) - 1.204284999999999)) - 169.71433333333334);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec16[0] + fRec8[0]) - 0.840702999999999)) - 147.47524390243905);
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec48[0] + ((double)input1[i] * fRec13[0])) - 1.5816559999999988)) - 191.42014814814814);
		fRec46[0] = ((fConst13 * fRec46[1]) + (fConst12 * ((fConst10 * fRec47[1]) + (fConst9 * fRec47[0]))));
