...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp38 = (fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec74[1]))) + 100000.0);
		fVec15[0] = fTemp38;
		fRec77[0] = fConst25 * (2700.0 * (fTemp38 + fVec15[1]) - fConst26 * fRec77[1]);
		fRec74[0] = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(fTemp36 + fRec77[0] + fTemp37 + -1.581656))) + -191.42014814814814;
		...
		double fTemp42 = (fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec69[1]))) + 100000.0);
		fVec17[0] = fTemp42;
		fRec79[0] = fConst33 * (1500.0 * (fTemp42 + fVec17[1]) - fConst34 * fRec79[1]);
		fRec69[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp40 + fRec79[0] + fTemp41 + -1.204285))) + -169.71433333333334;
		...
		double fTemp46 = (fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec65[1]))) + 100000.0);
		fVec19[0] = fTemp46;
		fRec81[0] = fConst36 * (820.0 * (fTemp46 + fVec19[1]) - fConst37 * fRec81[1]);
		fRec65[0] = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(fTemp44 + fRec81[0] + fTemp45 + -0.84070299999999998))) + -147.47524390243905;
