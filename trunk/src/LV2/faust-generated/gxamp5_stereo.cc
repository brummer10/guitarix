...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp38 = (fTemp36 + fTemp37) / (Ranode(TUBE_TABLE_12AX7_68k, fRec66[1]) + 1e+05);
		fVec15[0] = fTemp38;
		fRec69[0] = fConst7 * (2.7e+03 * (fTemp38 + fVec15[1]) - fConst6 * fRec69[1]);
		fRec66[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp37 + fRec69[0] + fTemp36 + -1.581656) + -191.42014814814814;
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_12AX7_250k, fRec61[1]) + 1e+05);
		fVec17[0] = fTemp42;
		fRec71[0] = fConst18 * (1.5e+03 * (fTemp42 + fVec17[1]) - fConst17 * fRec71[1]);
		fRec61[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp41 + fRec71[0] + fTemp40 + -1.204285) + -169.71433333333334;
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_12AX7_250k, fRec57[1]) + 1e+05);
		fVec19[0] = fTemp46;
		fRec73[0] = fConst21 * (8.2e+02 * (fTemp46 + fVec19[1]) - fConst20 * fRec73[1]);
		fRec57[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp45 + fRec73[0] + fTemp44 + -0.840703) + -147.47524390243905;
