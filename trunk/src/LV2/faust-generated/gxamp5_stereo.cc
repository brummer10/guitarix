...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec43[0] = ((fConst9 * fRec43[1]) + (fConst8 * ((fConst6 * fRec44[1]) + (fConst5 * fRec44[0]))));
		...
		fRec61[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec64[0] + (0.9254498422517706 * (fRec62[2] + (fRec62[0] + (2.0 * fRec62[1]))))) - 1.581656)) - 191.42014814814814);
		...
		fRec56[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec65[0] + (0.9254498422517706 * (fRec57[2] + (fRec57[0] + (2.0 * fRec57[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec52[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec66[0] + (0.9254498422517706 * (fRec53[2] + (fRec53[0] + (2.0 * fRec53[1]))))) - 0.840703)) - 147.47524390243905);
		...
		fRec46[0] = ((fConst9 * fRec46[1]) + (fConst8 * ((fConst5 * fRec47[0]) + (fConst6 * fRec47[1]))));
		...
		fRec86[0] = ((fConst9 * fRec86[1]) + (fConst8 * ((fConst5 * fRec87[0]) + (fConst6 * fRec87[1]))));
