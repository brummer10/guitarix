...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec8[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp7 + (fRec20[0] + fTemp8)) + -1.6755869999999999)))) + -138.29419999999999);
		...
		fRec3[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp12 + (fRec23[0] + fTemp13)) + -1.1304620000000001)))) + -112.13878048780487);
		...
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp17 + (fRec41[0] + fTemp18)) + -2.2961499999999999)))) + -164.9574074074074);
		...
		fRec33[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp22 + (fRec43[0] + fTemp23)) + -1.6755869999999999)))) + -138.29419999999999);
		...
		fRec28[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp27 + (fRec45[0] + fTemp28)) + -1.1304620000000001)))) + -112.13878048780487);
		...
		output1[i0] = FAUSTFLOAT(((fSlow1 * fRec25[0]) + (fSlow3 * fRec26[0])));
