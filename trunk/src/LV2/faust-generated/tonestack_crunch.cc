...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (4.5496e-07 * fSlow15 + fSlow1 * (2.4468200000000005e-07 - fSlow2) + fSlow0 * (4.882548000000001e-06 * fSlow1 + 9.55416e-07) + 4.3428e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.5551360000000004e-11) + fSlow15 * (fSlow4 + 1.0691560000000001e-10 * (1.0 - fSlow1));
