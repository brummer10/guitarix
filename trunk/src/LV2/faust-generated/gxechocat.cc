...
inline void Dsp::clear_state_f()
{
	...
	for (int l16 = 0; (l16 < 2); l16 = (l16 + 1)) fRec20[l16] = 0.0;
	for (int l17 = 0; (l17 < 4); l17 = (l17 + 1)) fRec19[l17] = 0.0;
	for (int l18 = 0; (l18 < 3); l18 = (l18 + 1)) fRec18[l18] = 0.0;
	for (int l19 = 0; (l19 < 3); l19 = (l19 + 1)) fRec17[l19] = 0.0;
	for (int l20 = 0; (l20 < 1048576); l20 = (l20 + 1)) fVec2[l20] = 0.0;
...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst55 = (4.3361242466424001e-10 * fConst0);
	fConst56 = ((fConst0 * (fConst55 + 1.9932993616135301e-08)) + 1.8988001703518899e-07);
	fConst57 = (fConst0 / fConst56);
	fConst58 = (1.02325156488485e-09 * fConst0);
	fConst59 = (-1.0570780628975901e-08 - fConst58);
	fConst60 = (4.3378578048241502e-10 * fConst0);
	fConst61 = ((fConst0 * (fConst60 + 1.16144315716444e-08)) + 6.9053076645513103e-08);
	...
	fConst78 = (1.0 / ((fConst0 * ((fConst0 * (fConst77 + 1.10493997854221e-10)) + 2.3018384314765601e-08)) + 6.0159525272688304e-07));
	fConst79 = (1.23938408071082e-08 * fConst0);
	fConst80 = ((fConst0 * (-7.13052376187718e-07 - fConst79)) + -9.9879581159544601e-06);
	...
	fConst88 = (0.0 - fConst84);
	fConst89 = ((1.0 - fConst82) / fConst83);
	fConst90 = (2.0190873071330101e-14 * fConst0);
	fConst91 = ((fConst0 * ((fConst0 * (-1.10493997854221e-10 - fConst90)) + 2.3018384314765601e-08)) + 1.80478575818065e-06);
	fConst92 = ((fConst0 * ((fConst0 * (fConst90 + -1.10493997854221e-10)) + -2.3018384314765601e-08)) + 1.80478575818065e-06);
	fConst93 = ((fConst0 * ((fConst0 * (1.10493997854221e-10 - fConst77)) + -2.3018384314765601e-08)) + 6.0159525272688304e-07);
	fConst94 = ((fConst0 * (fConst79 + -7.13052376187718e-07)) + -2.9963874347863399e-05);
	fConst95 = ((fConst0 * (fConst79 + 7.13052376187718e-07)) + -2.9963874347863399e-05);
	fConst96 = ((fConst0 * (7.13052376187718e-07 - fConst79)) + -9.9879581159544601e-06);
	fConst97 = (((fConst69 + -1.8477590650225735) / fConst68) + 1.0);
	fConst98 = (2.0 * (1.0 - fConst75));
	fConst99 = (0.0 - (2.0 / fConst74));
	fConst100 = (((fConst69 + -0.76536686473017945) / fConst68) + 1.0);
...
#define fVslider4 (*fVslider4_)
	...
	double fSlow4 = (fConst71 / fSlow3);
	double fSlow5 = (0.004073836948085289 * (std::exp(double(fVslider3)) + -1.0));
	double fSlow6 = double(fCheckbox1);
	double fSlow7 = (fConst101 / fSlow3);
	double fSlow8 = double(fCheckbox2);
	double fSlow9 = (fConst102 / fSlow3);
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp9 = ((fRec13[1] != 0.0) ? (((fRec14[1] > 0.0) & (fRec14[1] < 1.0)) ? fRec13[1] : 0.0) : (((fRec14[1] == 0.0) & (fSlow4 != fRec15[1])) ? fConst72 : (((fRec14[1] == 1.0) & (fSlow4 != fRec16[1])) ? fConst73 : 0.0)));
		fRec13[0] = fTemp9;
		...
		fRec22[0] = (fSlow5 + (0.99299999999999999 * fRec22[1]));
		double fTemp11 = (fRec21[0] * fRec22[0]);
		fVec1[0] = fTemp11;
		fRec20[0] = ((0.25 * ((fConst84 * fTemp11) + (fConst88 * fVec1[1]))) - (fConst89 * fRec20[1]));
		fRec19[0] = ((fRec20[0] + fTemp8) - (fConst78 * (((fConst91 * fRec19[1]) + (fConst92 * fRec19[2])) + (fConst93 * fRec19[3]))));
		double fTemp12 = (fConst78 * ((((fConst80 * fRec19[0]) + (fConst94 * fRec19[1])) + (fConst95 * fRec19[2])) + (fConst96 * fRec19[3])));
		fRec18[0] = ((int(signbit(double(fTemp12))) ? double(copicatrecord_2_negclip(double(fTemp12))) : double(copicatrecord_2clip(double(fTemp12)))) - (fConst76 * ((fConst97 * fRec18[2]) + (fConst98 * fRec18[1]))));
		fRec17[0] = ((fConst76 * (((fConst75 * fRec18[0]) + (fConst99 * fRec18[1])) + (fConst75 * fRec18[2]))) - (fConst70 * ((fConst100 * fRec17[2]) + (fConst98 * fRec17[1]))));
		double fTemp13 = (((fConst75 * fRec17[0]) + (fConst99 * fRec17[1])) + (fConst75 * fRec17[2]));
		fVec2[(IOTA & 1048575)] = fTemp13;
		int iTemp14 = int(std::min<double>(524288.0, std::max<double>(0.0, fRec15[0])));
		int iTemp15 = int(std::min<double>(524288.0, std::max<double>(0.0, fRec16[0])));
		double fTemp16 = ((fRec23[1] != 0.0) ? (((fRec24[1] > 0.0) & (fRec24[1] < 1.0)) ? fRec23[1] : 0.0) : (((fRec24[1] == 0.0) & (fSlow7 != fRec25[1])) ? fConst72 : (((fRec24[1] == 1.0) & (fSlow7 != fRec26[1])) ? fConst73 : 0.0)));
		fRec23[0] = fTemp16;
		...
		double fTemp20 = ((fRec27[1] != 0.0) ? (((fRec28[1] > 0.0) & (fRec28[1] < 1.0)) ? fRec27[1] : 0.0) : (((fRec28[1] == 0.0) & (fSlow9 != fRec29[1])) ? fConst72 : (((fRec28[1] == 1.0) & (fSlow9 != fRec30[1])) ? fConst73 : 0.0)));
		fRec27[0] = fTemp20;
		...
		double fTemp24 = (((fSlow2 * ((fTemp10 * fVec2[((IOTA - iTemp14) & 1048575)]) + (fRec14[0] * fVec2[((IOTA - iTemp15) & 1048575)]))) + (fSlow6 * ((fTemp17 * fVec2[((IOTA - iTemp18) & 1048575)]) + (fRec24[0] * fVec2[((IOTA - iTemp19) & 1048575)])))) + (fSlow8 * ((fTemp21 * fVec2[((IOTA - iTemp22) & 1048575)]) + (fRec28[0] * fVec2[((IOTA - iTemp23) & 1048575)]))));
		fVec3[0] = fTemp24;
		fRec12[0] = (0.0 - (fConst66 * ((fConst67 * fRec12[1]) - (fConst70 * (fTemp24 + fVec3[1])))));
		...
		fRec48[0] = (0.0 - (fConst86 * ((fConst87 * fRec48[1]) - (fRec39[1] + fRec39[2]))));
		double fTemp32 = (fRec22[0] * fRec48[0]);
		fVec5[0] = fTemp32;
		fRec47[0] = ((0.25 * ((fConst84 * fTemp32) + (fConst88 * fVec5[1]))) - (fConst89 * fRec47[1]));
		fRec46[0] = ((fRec47[0] + fTemp31) - (fConst78 * (((fConst91 * fRec46[1]) + (fConst92 * fRec46[2])) + (fConst93 * fRec46[3]))));
		double fTemp33 = (fConst78 * ((((fConst80 * fRec46[0]) + (fConst94 * fRec46[1])) + (fConst95 * fRec46[2])) + (fConst96 * fRec46[3])));
		fRec45[0] = ((int(signbit(double(fTemp33))) ? double(copicatrecord_2_negclip(double(fTemp33))) : double(copicatrecord_2clip(double(fTemp33)))) - (fConst76 * ((fConst97 * fRec45[2]) + (fConst98 * fRec45[1]))));
		fRec44[0] = ((fConst76 * (((fConst75 * fRec45[0]) + (fConst99 * fRec45[1])) + (fConst75 * fRec45[2]))) - (fConst70 * ((fConst100 * fRec44[2]) + (fConst98 * fRec44[1]))));
		double fTemp34 = (((fConst75 * fRec44[0]) + (fConst99 * fRec44[1])) + (fConst75 * fRec44[2]));
		fVec6[(IOTA & 1048575)] = fTemp34;
		double fTemp35 = (((fSlow2 * ((fTemp10 * fVec6[((IOTA - iTemp14) & 1048575)]) + (fRec14[0] * fVec6[((IOTA - iTemp15) & 1048575)]))) + (fSlow6 * ((fTemp17 * fVec6[((IOTA - iTemp18) & 1048575)]) + (fRec24[0] * fVec6[((IOTA - iTemp19) & 1048575)])))) + (fSlow8 * ((fTemp21 * fVec6[((IOTA - iTemp22) & 1048575)]) + (fRec28[0] * fVec6[((IOTA - iTemp23) & 1048575)]))));
		fVec7[0] = fTemp35;
		fRec43[0] = (0.0 - (fConst66 * ((fConst67 * fRec43[1]) - (fConst70 * (fTemp35 + fVec7[1])))));
		fRec42[0] = ((fRec43[0] + (0.995 * fRec42[1])) - fRec43[1]);
		fRec41[0] = (fRec42[0] - (fConst103 * ((fConst104 * fRec41[1]) + (fConst105 * fRec41[2]))));
		double fTemp36 = (fConst62 * (((fConst64 * fRec41[0]) + (fConst106 * fRec41[1])) + (fConst107 * fRec41[2])));
		fRec40[0] = ((int(signbit(double(fTemp36))) ? double(copicatreplay1_negclip(double(fTemp36))) : double(copicatreplay1clip(double(fTemp36)))) - (fConst108 * ((fConst109 * fRec40[1]) + (fConst110 * fRec40[2]))));
		double fTemp37 = (fConst57 * (((fConst59 * fRec40[0]) + (fConst111 * fRec40[1])) + (fConst112 * fRec40[2])));
		fRec39[0] = (int(signbit(double(fTemp37))) ? double(copicatreplay2_negclip(double(fTemp37))) : double(copicatreplay2clip(double(fTemp37))));
		...
		double fTemp38 = (fRec53[2] + (fRec53[0] + (2.0 * fRec53[1])));
		fVec8[0] = fTemp38;
		fRec52[0] = ((fConst113 * ((fConst120 * fTemp38) + (fConst122 * fVec8[1]))) - (fConst123 * fRec52[1]));
		fRec51[0] = (fRec52[0] - (fConst119 * ((fConst124 * fRec51[2]) + (fConst32 * fRec51[1]))));
		double fTemp39 = (fConst41 * fRec50[1]);
		fRec50[0] = ((fConst119 * (((fConst31 * fRec51[0]) + (fConst125 * fRec51[1])) + (fConst31 * fRec51[2]))) - (fConst36 * ((fConst38 * fRec50[2]) + fTemp39)));
		fRec49[0] = ((fRec50[2] + (fConst36 * (fTemp39 + (fConst38 * fRec50[0])))) - (((fTemp4 * fRec49[1]) + (fTemp5 * fRec49[2])) / fTemp6));
		double fTemp40 = (fConst0 * ((fRec1[0] * (((fConst2 * fRec49[0]) + (fConst53 * fRec49[1])) + (fConst54 * fRec49[2]))) / fTemp6));
		double fTemp41 = (int(signbit(double(fTemp40))) ? double(copicat1_negclip(double(fTemp40))) : double(copicat1clip(double(fTemp40))));
		fRec64[0] = (0.0 - (fConst86 * ((fConst87 * fRec64[1]) - (fRec55[1] + fRec55[2]))));
		double fTemp42 = (fRec22[0] * fRec64[0]);
		fVec9[0] = fTemp42;
		fRec63[0] = ((0.25 * ((fConst84 * fTemp42) + (fConst88 * fVec9[1]))) - (fConst89 * fRec63[1]));
		fRec62[0] = ((fRec63[0] + fTemp41) - (fConst78 * (((fConst91 * fRec62[1]) + (fConst92 * fRec62[2])) + (fConst93 * fRec62[3]))));
		double fTemp43 = (fConst78 * ((((fConst80 * fRec62[0]) + (fConst94 * fRec62[1])) + (fConst95 * fRec62[2])) + (fConst96 * fRec62[3])));
		fRec61[0] = ((int(signbit(double(fTemp43))) ? double(copicatrecord_2_negclip(double(fTemp43))) : double(copicatrecord_2clip(double(fTemp43)))) - (fConst76 * ((fConst97 * fRec61[2]) + (fConst98 * fRec61[1]))));
		fRec60[0] = ((fConst76 * (((fConst75 * fRec61[0]) + (fConst99 * fRec61[1])) + (fConst75 * fRec61[2]))) - (fConst70 * ((fConst100 * fRec60[2]) + (fConst98 * fRec60[1]))));
		double fTemp44 = (((fConst75 * fRec60[0]) + (fConst99 * fRec60[1])) + (fConst75 * fRec60[2]));
		fVec10[(IOTA & 1048575)] = fTemp44;
		double fTemp45 = (((fSlow2 * ((fTemp10 * fVec10[((IOTA - iTemp14) & 1048575)]) + (fRec14[0] * fVec10[((IOTA - iTemp15) & 1048575)]))) + (fSlow6 * ((fTemp17 * fVec10[((IOTA - iTemp18) & 1048575)]) + (fRec24[0] * fVec10[((IOTA - iTemp19) & 1048575)])))) + (fSlow8 * ((fTemp21 * fVec10[((IOTA - iTemp22) & 1048575)]) + (fRec28[0] * fVec10[((IOTA - iTemp23) & 1048575)]))));
		fVec11[0] = fTemp45;
		fRec59[0] = (0.0 - (fConst66 * ((fConst67 * fRec59[1]) - (fConst70 * (fTemp45 + fVec11[1])))));
		fRec58[0] = ((fRec59[0] + (0.995 * fRec58[1])) - fRec59[1]);
		fRec57[0] = (fRec58[0] - (fConst103 * ((fConst104 * fRec57[1]) + (fConst105 * fRec57[2]))));
		double fTemp46 = (fConst62 * (((fConst64 * fRec57[0]) + (fConst106 * fRec57[1])) + (fConst107 * fRec57[2])));
		fRec56[0] = ((int(signbit(double(fTemp46))) ? double(copicatreplay1_negclip(double(fTemp46))) : double(copicatreplay1clip(double(fTemp46)))) - (fConst108 * ((fConst109 * fRec56[1]) + (fConst110 * fRec56[2]))));
		double fTemp47 = (fConst57 * (((fConst59 * fRec56[0]) + (fConst111 * fRec56[1])) + (fConst112 * fRec56[2])));
		fRec55[0] = (int(signbit(double(fTemp47))) ? double(copicatreplay2_negclip(double(fTemp47))) : double(copicatreplay2clip(double(fTemp47))));
		fRec69[0] = (0.0 - (fConst128 * ((fConst28 * fRec69[1]) - (fConst113 * (fTemp38 + fVec8[1])))));
		fRec68[0] = (fRec69[0] - (fConst119 * ((fConst124 * fRec68[2]) + (fConst32 * fRec68[1]))));
		double fTemp48 = (fRec68[2] + (fRec68[0] + (2.0 * fRec68[1])));
		fVec12[0] = fTemp48;
		fRec67[0] = ((fConst119 * ((fConst127 * fTemp48) + (fConst129 * fVec12[1]))) - (fConst130 * fRec67[1]));
		...
		double fTemp49 = (fConst0 * ((fRec1[0] * (((fConst2 * fRec65[0]) + (fConst53 * fRec65[1])) + (fConst54 * fRec65[2]))) / fTemp6));
		double fTemp50 = (int(signbit(double(fTemp49))) ? double(copicat1_negclip(double(fTemp49))) : double(copicat1clip(double(fTemp49))));
		fRec79[0] = (0.0 - (fConst86 * ((fConst87 * fRec79[1]) - (fRec70[1] + fRec70[2]))));
		double fTemp51 = (fRec22[0] * fRec79[0]);
		fVec13[0] = fTemp51;
		fRec78[0] = ((0.25 * ((fConst84 * fTemp51) + (fConst88 * fVec13[1]))) - (fConst89 * fRec78[1]));
		fRec77[0] = ((fRec78[0] + fTemp50) - (fConst78 * (((fConst91 * fRec77[1]) + (fConst92 * fRec77[2])) + (fConst93 * fRec77[3]))));
		double fTemp52 = (fConst78 * ((((fConst80 * fRec77[0]) + (fConst94 * fRec77[1])) + (fConst95 * fRec77[2])) + (fConst96 * fRec77[3])));
		fRec76[0] = ((int(signbit(double(fTemp52))) ? double(copicatrecord_2_negclip(double(fTemp52))) : double(copicatrecord_2clip(double(fTemp52)))) - (fConst76 * ((fConst97 * fRec76[2]) + (fConst98 * fRec76[1]))));
		fRec75[0] = ((fConst76 * (((fConst75 * fRec76[0]) + (fConst99 * fRec76[1])) + (fConst75 * fRec76[2]))) - (fConst70 * ((fConst100 * fRec75[2]) + (fConst98 * fRec75[1]))));
		double fTemp53 = (((fConst75 * fRec75[0]) + (fConst99 * fRec75[1])) + (fConst75 * fRec75[2]));
		fVec14[(IOTA & 1048575)] = fTemp53;
		double fTemp54 = (((fSlow2 * ((fTemp10 * fVec14[((IOTA - iTemp14) & 1048575)]) + (fRec14[0] * fVec14[((IOTA - iTemp15) & 1048575)]))) + (fSlow6 * ((fTemp17 * fVec14[((IOTA - iTemp18) & 1048575)]) + (fRec24[0] * fVec14[((IOTA - iTemp19) & 1048575)])))) + (fSlow8 * ((fTemp21 * fVec14[((IOTA - iTemp22) & 1048575)]) + (fRec28[0] * fVec14[((IOTA - iTemp23) & 1048575)]))));
		fVec15[0] = fTemp54;
		fRec74[0] = (0.0 - (fConst66 * ((fConst67 * fRec74[1]) - (fConst70 * (fTemp54 + fVec15[1])))));
		fRec73[0] = ((fRec74[0] + (0.995 * fRec73[1])) - fRec74[1]);
		fRec72[0] = (fRec73[0] - (fConst103 * ((fConst104 * fRec72[1]) + (fConst105 * fRec72[2]))));
		double fTemp55 = (fConst62 * (((fConst64 * fRec72[0]) + (fConst106 * fRec72[1])) + (fConst107 * fRec72[2])));
		fRec71[0] = ((int(signbit(double(fTemp55))) ? double(copicatreplay1_negclip(double(fTemp55))) : double(copicatreplay1clip(double(fTemp55)))) - (fConst108 * ((fConst109 * fRec71[1]) + (fConst110 * fRec71[2]))));
		double fTemp56 = (fConst57 * (((fConst59 * fRec71[0]) + (fConst111 * fRec71[1])) + (fConst112 * fRec71[2])));
		fRec70[0] = (int(signbit(double(fTemp56))) ? double(copicatreplay2_negclip(double(fTemp56))) : double(copicatreplay2clip(double(fTemp56))));
		fRec82[0] = (0.0 - (fConst133 * ((fConst37 * fRec82[1]) - (fConst119 * (fTemp48 + fVec12[1])))));
		...
		double fTemp57 = (fConst0 * ((fRec1[0] * (((fConst2 * fRec80[0]) + (fConst53 * fRec80[1])) + (fConst54 * fRec80[2]))) / fTemp6));
		double fTemp58 = (int(signbit(double(fTemp57))) ? double(copicat1_negclip(double(fTemp57))) : double(copicat1clip(double(fTemp57))));
		fRec92[0] = (0.0 - (fConst86 * ((fConst87 * fRec92[1]) - (fRec83[1] + fRec83[2]))));
		double fTemp59 = (fRec22[0] * fRec92[0]);
		fVec16[0] = fTemp59;
		fRec91[0] = ((0.25 * ((fConst84 * fTemp59) + (fConst88 * fVec16[1]))) - (fConst89 * fRec91[1]));
		fRec90[0] = ((fRec91[0] + fTemp58) - (fConst78 * (((fConst91 * fRec90[1]) + (fConst92 * fRec90[2])) + (fConst93 * fRec90[3]))));
		double fTemp60 = (fConst78 * ((((fConst80 * fRec90[0]) + (fConst94 * fRec90[1])) + (fConst95 * fRec90[2])) + (fConst96 * fRec90[3])));
		fRec89[0] = ((int(signbit(double(fTemp60))) ? double(copicatrecord_2_negclip(double(fTemp60))) : double(copicatrecord_2clip(double(fTemp60)))) - (fConst76 * ((fConst97 * fRec89[2]) + (fConst98 * fRec89[1]))));
		fRec88[0] = ((fConst76 * (((fConst75 * fRec89[0]) + (fConst99 * fRec89[1])) + (fConst75 * fRec89[2]))) - (fConst70 * ((fConst100 * fRec88[2]) + (fConst98 * fRec88[1]))));
		double fTemp61 = (((fConst75 * fRec88[0]) + (fConst99 * fRec88[1])) + (fConst75 * fRec88[2]));
		fVec17[(IOTA & 1048575)] = fTemp61;
		double fTemp62 = (((fSlow2 * ((fTemp10 * fVec17[((IOTA - iTemp14) & 1048575)]) + (fRec14[0] * fVec17[((IOTA - iTemp15) & 1048575)]))) + (fSlow6 * ((fTemp17 * fVec17[((IOTA - iTemp18) & 1048575)]) + (fRec24[0] * fVec17[((IOTA - iTemp19) & 1048575)])))) + (fSlow8 * ((fTemp21 * fVec17[((IOTA - iTemp22) & 1048575)]) + (fRec28[0] * fVec17[((IOTA - iTemp23) & 1048575)]))));
		fVec18[0] = fTemp62;
		fRec87[0] = (0.0 - (fConst66 * ((fConst67 * fRec87[1]) - (fConst70 * (fTemp62 + fVec18[1])))));
		fRec86[0] = ((fRec87[0] + (0.995 * fRec86[1])) - fRec87[1]);
		fRec85[0] = (fRec86[0] - (fConst103 * ((fConst104 * fRec85[1]) + (fConst105 * fRec85[2]))));
		double fTemp63 = (fConst62 * (((fConst64 * fRec85[0]) + (fConst106 * fRec85[1])) + (fConst107 * fRec85[2])));
		fRec84[0] = ((int(signbit(double(fTemp63))) ? double(copicatreplay1_negclip(double(fTemp63))) : double(copicatreplay1clip(double(fTemp63)))) - (fConst108 * ((fConst109 * fRec84[1]) + (fConst110 * fRec84[2]))));
		double fTemp64 = (fConst57 * (((fConst59 * fRec84[0]) + (fConst111 * fRec84[1])) + (fConst112 * fRec84[2])));
		fRec83[0] = (int(signbit(double(fTemp64))) ? double(copicatreplay2_negclip(double(fTemp64))) : double(copicatreplay2clip(double(fTemp64))));
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((fTemp8 + (0.25 * (fRec8[0] * fRec31[0]))) + (fTemp31 + (0.25 * (fRec31[0] * fRec39[0])))) + (fTemp41 + (0.25 * (fRec31[0] * fRec55[0])))) + (fTemp50 + (0.25 * (fRec31[0] * fRec70[0])))) + (fTemp58 + (0.25 * (fRec31[0] * fRec83[0]))))));
		fRec0[1] = fRec0[0];
		fRec1[1] = fRec1[0];
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
...
void Dsp::connect(uint32_t port,void* data)
{
	...
	case OUTPUT: 
		...
		break;
	case BPM: 
		fVslider2_ = (float*)data; // , 120.0, 24.0, 360.0, 0.10000000000000001 
		break;
	case HEAD1: 
