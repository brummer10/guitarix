...
#define fVslider4 (*fVslider4_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((fTemp8 + (0.25 * (fRec8[0] * fRec31[0]))) + (fTemp31 + (0.25 * (fRec31[0] * fRec39[0])))) + (fTemp44 + (0.25 * (fRec31[0] * fRec55[0])))) + (fTemp56 + (0.25 * (fRec31[0] * fRec70[0])))) + (fTemp67 + (0.25 * (fRec31[0] * fRec83[0]))))));
		fRec0[1] = fRec0[0];
		fRec1[1] = fRec1[0];
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
