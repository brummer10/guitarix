...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst13 = 1.0 / fConst10;
	fConst14 = (fConst13 + -0.7653668647301795) / fConst10 + 1.0;
	double fConst15 = (fConst13 + 0.7653668647301795) / fConst10 + 1.0;
	fConst16 = 1.0 / fConst15;
	fConst17 = (fConst13 + -1.8477590650225735) / fConst10 + 1.0;
	double fConst18 = (fConst13 + 1.8477590650225735) / fConst10 + 1.0;
	fConst19 = 1.0 / fConst18;
	double fConst20 = 6.73029102377671e-15 * fConst0;
	fConst21 = fConst0 * (fConst0 * (1.10493997854221e-10 - fConst20) + -2.30183843147656e-08) + 6.01595252726883e-07;
	double fConst22 = 2.01908730713301e-14 * fConst0;
	...
	double fConst39 = 1.0 / fConst36;
	fConst40 = 1.0 - fConst39;
	fConst41 = 1.0 - fConst40 / fConst36;
	double fConst42 = fConst39 + 1.0;
	fConst43 = 1.0 / (fConst42 / fConst36 + 1.0);
	double fConst44 = std::tan(659.7344572538566 / fConst0);
	...
	double fConst82 = 1.0 / std::tan(23561.94490192345 / fConst0);
	fConst83 = 1.0 - fConst82;
	fConst84 = 1.0 / (fConst82 + 1.0);
	fConst85 = 0.25 / fConst79;
	fConst86 = 1.0 / (fConst80 + 1.0);
	double fConst87 = 1.23938408071082e-08 * fConst0;
	...
	double fConst98 = 1.0 / std::tan(20420.352248333656 / fConst0);
	fConst99 = 1.0 - fConst98;
	fConst100 = 1.0 / (fConst98 + 1.0);
	double fConst101 = 2.16461324600193e-08 * fConst0;
	...
	double fConst105 = 1.02325156488485e-09 * fConst0;
	...
	double fConst113 = (fConst47 + 1.0000000000000004) / fConst44 + 1.0;
	...
	double fConst119 = (fConst39 + 1.0000000000000004) / fConst36 + 1.0;
