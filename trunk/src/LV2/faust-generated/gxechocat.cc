...
#define fVslider4 (*fVslider4_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fThen0 = double(copicat1clip(double(fTemp7)));
		double fElse0 = double(copicat1_negclip(double(fTemp7)));
		double fTemp8 = ((int(signbit(double(fTemp7)))) ? fElse0 : fThen0);
		...
		double fThen1 = double(copicatrecord_2clip(double(fTemp10)));
		double fElse1 = double(copicatrecord_2_negclip(double(fTemp10)));
		fRec14[0] = ((int(signbit(double(fTemp10)))) ? fElse1 : fThen1) - fConst73 * (fConst94 * fRec14[2] + fConst95 * fRec14[1]);
		...
		fVec2[IOTA0 & 1048575] = fTemp11;
		double fThen3 = (((fRec20[1] == 1.0) & (fSlow5 != fRec22[1])) ? fConst100 : 0.0);
		double fThen5 = (((fRec20[1] == 0.0) & (fSlow5 != fRec21[1])) ? fConst99 : fThen3);
		double fElse5 = (((fRec20[1] > 0.0) & (fRec20[1] < 1.0)) ? fRec19[1] : 0.0);
		double fTemp12 = ((fRec19[1] != 0.0) ? fElse5 : fThen5);
		fRec19[0] = fTemp12;
		...
		double fTemp14 = fVec2[(IOTA0 - iTemp13) & 1048575];
		int iTemp15 = int(std::min<double>(524288.0, std::max<double>(0.0, fRec22[0])));
		double fThen9 = (((fRec24[1] == 1.0) & (fSlow7 != fRec26[1])) ? fConst100 : 0.0);
		double fThen11 = (((fRec24[1] == 0.0) & (fSlow7 != fRec25[1])) ? fConst99 : fThen9);
		double fElse11 = (((fRec24[1] > 0.0) & (fRec24[1] < 1.0)) ? fRec23[1] : 0.0);
		double fTemp16 = ((fRec23[1] != 0.0) ? fElse11 : fThen11);
		fRec23[0] = fTemp16;
		...
		double fTemp18 = fVec2[(IOTA0 - iTemp17) & 1048575];
		int iTemp19 = int(std::min<double>(524288.0, std::max<double>(0.0, fRec26[0])));
		double fThen15 = (((fRec28[1] == 1.0) & (fSlow9 != fRec30[1])) ? fConst100 : 0.0);
		double fThen17 = (((fRec28[1] == 0.0) & (fSlow9 != fRec29[1])) ? fConst99 : fThen15);
		double fElse17 = (((fRec28[1] > 0.0) & (fRec28[1] < 1.0)) ? fRec27[1] : 0.0);
		double fTemp20 = ((fRec27[1] != 0.0) ? fElse17 : fThen17);
		fRec27[0] = fTemp20;
		...
		double fTemp22 = fVec2[(IOTA0 - iTemp21) & 1048575];
		int iTemp23 = int(std::min<double>(524288.0, std::max<double>(0.0, fRec30[0])));
		double fTemp24 = fSlow2 * (fConst70 * fTemp14 + fRec20[0] * (0.0 - fConst70 * (fTemp14 - fVec2[(IOTA0 - iTemp15) & 1048575]))) + fSlow6 * (fConst70 * fTemp18 + fRec24[0] * (0.0 - fConst70 * (fTemp18 - fVec2[(IOTA0 - iTemp19) & 1048575]))) + fSlow8 * (fConst70 * fTemp22 + fRec28[0] * (0.0 - fConst70 * (fTemp22 - fVec2[(IOTA0 - iTemp23) & 1048575])));
		fVec3[0] = fTemp24;
		...
		double fThen20 = double(copicatreplay1clip(double(fTemp25)));
		double fElse20 = double(copicatreplay1_negclip(double(fTemp25)));
		fRec9[0] = ((int(signbit(double(fTemp25)))) ? fElse20 : fThen20) - fConst108 * (fConst109 * fRec9[1] + fConst110 * fRec9[2]);
		double fTemp26 = fConst57 * (fConst59 * fRec9[0] + fConst111 * fRec9[1] + fConst112 * fRec9[2]);
		double fThen21 = double(copicatreplay2clip(double(fTemp26)));
		double fElse21 = double(copicatreplay2_negclip(double(fTemp26)));
		fRec8[0] = ((int(signbit(double(fTemp26)))) ? fElse21 : fThen21);
		...
		double fThen22 = double(copicat1clip(double(fTemp30)));
		double fElse22 = double(copicat1_negclip(double(fTemp30)));
		double fTemp31 = ((int(signbit(double(fTemp30)))) ? fElse22 : fThen22);
		...
		double fThen23 = double(copicatrecord_2clip(double(fTemp33)));
		double fElse23 = double(copicatrecord_2_negclip(double(fTemp33)));
		fRec45[0] = ((int(signbit(double(fTemp33)))) ? fElse23 : fThen23) - fConst73 * (fConst94 * fRec45[2] + fConst95 * fRec45[1]);
		...
		fVec6[IOTA0 & 1048575] = fTemp34;
		double fTemp35 = fVec6[(IOTA0 - iTemp13) & 1048575];
		double fTemp36 = fVec6[(IOTA0 - iTemp17) & 1048575];
		double fTemp37 = fVec6[(IOTA0 - iTemp21) & 1048575];
		double fTemp38 = fSlow2 * (fConst70 * fTemp35 + fRec20[0] * (0.0 - fConst70 * (fTemp35 - fVec6[(IOTA0 - iTemp15) & 1048575]))) + fSlow6 * (fConst70 * fTemp36 + fRec24[0] * (0.0 - fConst70 * (fTemp36 - fVec6[(IOTA0 - iTemp19) & 1048575]))) + fSlow8 * (fConst70 * fTemp37 + fRec28[0] * (0.0 - fConst70 * (fTemp37 - fVec6[(IOTA0 - iTemp23) & 1048575])));
		fVec7[0] = fTemp38;
		...
		double fThen24 = double(copicatreplay1clip(double(fTemp39)));
		double fElse24 = double(copicatreplay1_negclip(double(fTemp39)));
		fRec40[0] = ((int(signbit(double(fTemp39)))) ? fElse24 : fThen24) - fConst108 * (fConst109 * fRec40[1] + fConst110 * fRec40[2]);
		double fTemp40 = fConst57 * (fConst59 * fRec40[0] + fConst111 * fRec40[1] + fConst112 * fRec40[2]);
		double fThen25 = double(copicatreplay2clip(double(fTemp40)));
		double fElse25 = double(copicatreplay2_negclip(double(fTemp40)));
		fRec39[0] = ((int(signbit(double(fTemp40)))) ? fElse25 : fThen25);
		...
		double fThen26 = double(copicat1clip(double(fTemp43)));
		double fElse26 = double(copicat1_negclip(double(fTemp43)));
		double fTemp44 = ((int(signbit(double(fTemp43)))) ? fElse26 : fThen26);
		...
		double fThen27 = double(copicatrecord_2clip(double(fTemp46)));
		double fElse27 = double(copicatrecord_2_negclip(double(fTemp46)));
		fRec61[0] = ((int(signbit(double(fTemp46)))) ? fElse27 : fThen27) - fConst73 * (fConst94 * fRec61[2] + fConst95 * fRec61[1]);
		...
		fVec10[IOTA0 & 1048575] = fTemp47;
		double fTemp48 = fVec10[(IOTA0 - iTemp13) & 1048575];
		double fTemp49 = fVec10[(IOTA0 - iTemp17) & 1048575];
		double fTemp50 = fVec10[(IOTA0 - iTemp21) & 1048575];
		double fTemp51 = fSlow2 * (fConst70 * fTemp48 + fRec20[0] * (0.0 - fConst70 * (fTemp48 - fVec10[(IOTA0 - iTemp15) & 1048575]))) + fSlow6 * (fConst70 * fTemp49 + fRec24[0] * (0.0 - fConst70 * (fTemp49 - fVec10[(IOTA0 - iTemp19) & 1048575]))) + fSlow8 * (fConst70 * fTemp50 + fRec28[0] * (0.0 - fConst70 * (fTemp50 - fVec10[(IOTA0 - iTemp23) & 1048575])));
		fVec11[0] = fTemp51;
		...
		double fThen28 = double(copicatreplay1clip(double(fTemp52)));
		double fElse28 = double(copicatreplay1_negclip(double(fTemp52)));
		fRec56[0] = ((int(signbit(double(fTemp52)))) ? fElse28 : fThen28) - fConst108 * (fConst109 * fRec56[1] + fConst110 * fRec56[2]);
		double fTemp53 = fConst57 * (fConst59 * fRec56[0] + fConst111 * fRec56[1] + fConst112 * fRec56[2]);
		double fThen29 = double(copicatreplay2clip(double(fTemp53)));
		double fElse29 = double(copicatreplay2_negclip(double(fTemp53)));
		fRec55[0] = ((int(signbit(double(fTemp53)))) ? fElse29 : fThen29);
		...
		double fThen30 = double(copicat1clip(double(fTemp55)));
		double fElse30 = double(copicat1_negclip(double(fTemp55)));
		double fTemp56 = ((int(signbit(double(fTemp55)))) ? fElse30 : fThen30);
		...
		double fThen31 = double(copicatrecord_2clip(double(fTemp58)));
		double fElse31 = double(copicatrecord_2_negclip(double(fTemp58)));
		fRec76[0] = ((int(signbit(double(fTemp58)))) ? fElse31 : fThen31) - fConst73 * (fConst94 * fRec76[2] + fConst95 * fRec76[1]);
		...
		fVec14[IOTA0 & 1048575] = fTemp59;
		double fTemp60 = fVec14[(IOTA0 - iTemp13) & 1048575];
		double fTemp61 = fVec14[(IOTA0 - iTemp17) & 1048575];
		double fTemp62 = fVec14[(IOTA0 - iTemp21) & 1048575];
		double fTemp63 = fSlow2 * (fConst70 * fTemp60 + fRec20[0] * (0.0 - fConst70 * (fTemp60 - fVec14[(IOTA0 - iTemp15) & 1048575]))) + fSlow6 * (fConst70 * fTemp61 + fRec24[0] * (0.0 - fConst70 * (fTemp61 - fVec14[(IOTA0 - iTemp19) & 1048575]))) + fSlow8 * (fConst70 * fTemp62 + fRec28[0] * (0.0 - fConst70 * (fTemp62 - fVec14[(IOTA0 - iTemp23) & 1048575])));
		fVec15[0] = fTemp63;
		...
		double fThen32 = double(copicatreplay1clip(double(fTemp64)));
		double fElse32 = double(copicatreplay1_negclip(double(fTemp64)));
		fRec71[0] = ((int(signbit(double(fTemp64)))) ? fElse32 : fThen32) - fConst108 * (fConst109 * fRec71[1] + fConst110 * fRec71[2]);
		double fTemp65 = fConst57 * (fConst59 * fRec71[0] + fConst111 * fRec71[1] + fConst112 * fRec71[2]);
		double fThen33 = double(copicatreplay2clip(double(fTemp65)));
		double fElse33 = double(copicatreplay2_negclip(double(fTemp65)));
		fRec70[0] = ((int(signbit(double(fTemp65)))) ? fElse33 : fThen33);
		...
		double fThen34 = double(copicat1clip(double(fTemp66)));
		double fElse34 = double(copicat1_negclip(double(fTemp66)));
		double fTemp67 = ((int(signbit(double(fTemp66)))) ? fElse34 : fThen34);
		...
		double fThen35 = double(copicatrecord_2clip(double(fTemp69)));
		double fElse35 = double(copicatrecord_2_negclip(double(fTemp69)));
		fRec89[0] = ((int(signbit(double(fTemp69)))) ? fElse35 : fThen35) - fConst73 * (fConst94 * fRec89[2] + fConst95 * fRec89[1]);
		...
		double fTemp71 = fVec17[(IOTA0 - iTemp13) & 1048575];
		double fTemp72 = fVec17[(IOTA0 - iTemp17) & 1048575];
		double fTemp73 = fVec17[(IOTA0 - iTemp21) & 1048575];
		double fTemp74 = fSlow2 * (fConst70 * fTemp71 + fRec20[0] * (0.0 - fConst70 * (fTemp71 - fVec17[(IOTA0 - iTemp15) & 1048575]))) + fSlow6 * (fConst70 * fTemp72 + fRec24[0] * (0.0 - fConst70 * (fTemp72 - fVec17[(IOTA0 - iTemp19) & 1048575]))) + fSlow8 * (fConst70 * fTemp73 + fRec28[0] * (0.0 - fConst70 * (fTemp73 - fVec17[(IOTA0 - iTemp23) & 1048575])));
		fVec18[0] = fTemp74;
		...
		double fThen36 = double(copicatreplay1clip(double(fTemp75)));
		double fElse36 = double(copicatreplay1_negclip(double(fTemp75)));
		fRec84[0] = ((int(signbit(double(fTemp75)))) ? fElse36 : fThen36) - fConst108 * (fConst109 * fRec84[1] + fConst110 * fRec84[2]);
		double fTemp76 = fConst57 * (fConst59 * fRec84[0] + fConst111 * fRec84[1] + fConst112 * fRec84[2]);
		double fThen37 = double(copicatreplay2clip(double(fTemp76)));
		double fElse37 = double(copicatreplay2_negclip(double(fTemp76)));
		fRec83[0] = ((int(signbit(double(fTemp76)))) ? fElse37 : fThen37);
