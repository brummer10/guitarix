...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst3 = ((fConst0 * ((fConst0 * (fConst2 + 6.4917759212794798e-12)) + 2.5100665591164499e-10)) + 2.4697044736012902e-09);
	...
	fConst8 = ((fConst0 * (fConst7 + 2.0976223579538801e-08)) + 2.44130776766847e-07);
