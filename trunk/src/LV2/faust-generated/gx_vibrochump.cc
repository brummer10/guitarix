...
#define fVslider4 (*fVslider4_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		int iThen1 = 1 - 2 * (iRec12[1] > 0);
		int iElse1 = 2 * (iRec12[1] < iSlow7) + -1;
		iRec13[0] = ((iRec13[1] > 0) ? iElse1 : iThen1);
		iRec12[0] = iRec13[0] + iRec12[1];
		fRec16[0] = fRec16[1] + fSlow9 * (0.0 - fRec14[1]);
		fRec15[0] = fSlow9 * fRec16[0] + double(1 - iVec0[1]) + fRec15[1];
		fRec14[0] = fRec15[0];
		double fThen2 = fSlow8 * double(iRec12[0]);
		double fElse2 = std::max<double>(0.0, 0.5 * (fRec14[0] + 1.0));
		fRec11[0] = fTemp15 + fConst83 * std::pow(fSlow4 * (((iSlow5) ? fElse2 : fThen2) + -1.0) + 1.0, 1.8999999999999999) / (fConst83 + 0.059999999999999998 * std::exp(0.0 - 2.4849066497880004 * fTemp15));
		double fThen3 = 2700.0 / (std::exp(13.815510557964274 / std::log(8.5519675079294171 * fRec11[0] + 2.7182818284590451)) + 2700.0);
		double fTemp16 = ((iSlow3) ? 1.0 : fThen3);
		fRec2[0] = ((int(signbit(double(fTemp14)))) ? fElse0 : fThen0) * fTemp16 - fConst86 * (fConst87 * fRec2[1] + fConst88 * fRec2[2]);
		double fTemp17 = fConst9 * (fConst11 * fRec2[0] + fConst89 * fRec2[1] + fConst90 * fRec2[2]);
		double fThen4 = double(bigchumppre2clip(double(fTemp17)));
		double fElse4 = double(bigchumppre2_negclip(double(fTemp17)));
		fRec1[0] = ((int(signbit(double(fTemp17)))) ? fElse4 : fThen4) - fConst91 * (fConst93 * fRec1[1] + fConst94 * fRec1[2] + fConst95 * fRec1[3]);
		double fTemp18 = fConst4 * (fConst6 * fRec1[0] + fConst97 * fRec1[1] + fConst98 * fRec1[2] + fConst99 * fRec1[3]);
		double fThen5 = double(bigchumppowerclip(double(fTemp18)));
		double fElse5 = double(bigchumppower_negclip(double(fTemp18)));
		...
		double fThen6 = double(bigchumppreclip(double(fTemp23)));
		double fElse6 = double(bigchumppre_negclip(double(fTemp23)));
		fRec18[0] = fTemp16 * ((int(signbit(double(fTemp23)))) ? fElse6 : fThen6) - fConst86 * (fConst87 * fRec18[1] + fConst88 * fRec18[2]);
		double fTemp24 = fConst9 * (fConst11 * fRec18[0] + fConst89 * fRec18[1] + fConst90 * fRec18[2]);
		double fThen7 = double(bigchumppre2clip(double(fTemp24)));
		double fElse7 = double(bigchumppre2_negclip(double(fTemp24)));
		fRec17[0] = ((int(signbit(double(fTemp24)))) ? fElse7 : fThen7) - fConst91 * (fConst93 * fRec17[1] + fConst94 * fRec17[2] + fConst95 * fRec17[3]);
		double fTemp25 = fConst4 * (fConst6 * fRec17[0] + fConst97 * fRec17[1] + fConst98 * fRec17[2] + fConst99 * fRec17[3]);
		double fThen8 = double(bigchumppowerclip(double(fTemp25)));
		double fElse8 = double(bigchumppower_negclip(double(fTemp25)));
		...
		double fThen9 = double(bigchumppreclip(double(fTemp28)));
		double fElse9 = double(bigchumppre_negclip(double(fTemp28)));
		fRec27[0] = fTemp16 * ((int(signbit(double(fTemp28)))) ? fElse9 : fThen9) - fConst86 * (fConst87 * fRec27[1] + fConst88 * fRec27[2]);
		double fTemp29 = fConst9 * (fConst11 * fRec27[0] + fConst89 * fRec27[1] + fConst90 * fRec27[2]);
		double fThen10 = double(bigchumppre2clip(double(fTemp29)));
		double fElse10 = double(bigchumppre2_negclip(double(fTemp29)));
		fRec26[0] = ((int(signbit(double(fTemp29)))) ? fElse10 : fThen10) - fConst91 * (fConst93 * fRec26[1] + fConst94 * fRec26[2] + fConst95 * fRec26[3]);
		double fTemp30 = fConst4 * (fConst6 * fRec26[0] + fConst97 * fRec26[1] + fConst98 * fRec26[2] + fConst99 * fRec26[3]);
		double fThen11 = double(bigchumppowerclip(double(fTemp30)));
		double fElse11 = double(bigchumppower_negclip(double(fTemp30)));
		...
		double fThen12 = double(bigchumppreclip(double(fTemp32)));
		double fElse12 = double(bigchumppre_negclip(double(fTemp32)));
		fRec35[0] = fTemp16 * ((int(signbit(double(fTemp32)))) ? fElse12 : fThen12) - fConst86 * (fConst87 * fRec35[1] + fConst88 * fRec35[2]);
		double fTemp33 = fConst9 * (fConst11 * fRec35[0] + fConst89 * fRec35[1] + fConst90 * fRec35[2]);
		double fThen13 = double(bigchumppre2clip(double(fTemp33)));
		double fElse13 = double(bigchumppre2_negclip(double(fTemp33)));
		fRec34[0] = ((int(signbit(double(fTemp33)))) ? fElse13 : fThen13) - fConst91 * (fConst93 * fRec34[1] + fConst94 * fRec34[2] + fConst95 * fRec34[3]);
		double fTemp34 = fConst4 * (fConst6 * fRec34[0] + fConst97 * fRec34[1] + fConst98 * fRec34[2] + fConst99 * fRec34[3]);
		double fThen14 = double(bigchumppowerclip(double(fTemp34)));
		double fElse14 = double(bigchumppower_negclip(double(fTemp34)));
		...
		double fThen15 = double(bigchumppreclip(double(fTemp35)));
		double fElse15 = double(bigchumppre_negclip(double(fTemp35)));
		fRec42[0] = fTemp16 * ((int(signbit(double(fTemp35)))) ? fElse15 : fThen15) - fConst86 * (fConst87 * fRec42[1] + fConst88 * fRec42[2]);
		double fTemp36 = fConst9 * (fConst11 * fRec42[0] + fConst89 * fRec42[1] + fConst90 * fRec42[2]);
		double fThen16 = double(bigchumppre2clip(double(fTemp36)));
		double fElse16 = double(bigchumppre2_negclip(double(fTemp36)));
		fRec41[0] = ((int(signbit(double(fTemp36)))) ? fElse16 : fThen16) - fConst91 * (fConst93 * fRec41[1] + fConst94 * fRec41[2] + fConst95 * fRec41[3]);
		double fTemp37 = fConst4 * (fConst6 * fRec41[0] + fConst97 * fRec41[1] + fConst98 * fRec41[2] + fConst99 * fRec41[3]);
		double fThen17 = double(bigchumppowerclip(double(fTemp37)));
		double fElse17 = double(bigchumppower_negclip(double(fTemp37)));
		output0[i0] = FAUSTFLOAT(fRec0[0] * (((int(signbit(double(fTemp18)))) ? fElse5 : fThen5) + ((int(signbit(double(fTemp25)))) ? fElse8 : fThen8) + ((int(signbit(double(fTemp30)))) ? fElse11 : fThen11) + ((int(signbit(double(fTemp34)))) ? fElse14 : fThen14) + ((int(signbit(double(fTemp37)))) ? fElse17 : fThen17)));
		iVec0[1] = iVec0[0];
		fRec0[1] = fRec0[0];
		fRec3[1] = fRec3[0];
		fVec1[1] = fVec1[0];
