...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec0[0] = ((fConst69 * ((fConst42 * fRec1[1]) + (fConst1 * fRec1[0]))) + (fConst3 * fRec0[1]));
		...
		fRec35[0] = ((fConst69 * ((fConst42 * fRec36[1]) + (fConst1 * fRec36[0]))) + (fConst3 * fRec35[1]));
		...
		fRec38[0] = ((fConst69 * ((fConst42 * fRec39[1]) + (fConst1 * fRec39[0]))) + (fConst3 * fRec38[1]));
		...
		fRec70[0] = ((fConst69 * ((fConst42 * fRec71[1]) + (fConst1 * fRec71[0]))) + (fConst3 * fRec70[1]));
