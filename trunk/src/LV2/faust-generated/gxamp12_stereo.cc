...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec15[0] = 0.05 * (fConst8 * fRec16[0] + fConst9 * fRec16[1]) - fConst4 * fRec15[1];
		fRec21[0] = fConst12 * (fConst11 * fRec21[1] + 0.05 * (fRec16[0] - fRec16[1]));
		...
		double fTemp7 = (fTemp5 + fTemp6) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec11[1]) + 1e+05);
		fVec3[0] = fTemp7;
		fRec22[0] = fConst18 * (1.5e+03 * (fTemp7 + fVec3[1]) - fConst17 * fRec22[1]);
		fRec11[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp6 + fRec22[0] + fTemp5 + -1.271609) + -45.22606666666667;
		fRec10[0] = 0.05 * (fConst8 * fRec11[0] + fConst9 * fRec11[1]) - fConst4 * fRec10[1];
		fRec23[0] = fConst12 * (fConst11 * fRec23[1] + 0.05 * (fRec11[0] - fRec11[1]));
		...
		double fTemp11 = (fTemp9 + fTemp10) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec7[1]) + 1e+05);
		fVec5[0] = fTemp11;
		fRec24[0] = fConst21 * (8.2e+02 * (fTemp11 + fVec5[1]) - fConst20 * fRec24[1]);
		fRec7[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp10 + fRec24[0] + fTemp9 + -0.797043) + -32.799634146341475;
		fRec6[0] = 0.05 * (fConst8 * fRec7[0] + fConst9 * fRec7[1]) - fConst4 * fRec6[1];
		fRec25[0] = fConst12 * (fConst11 * fRec25[1] + 0.05 * (fRec7[0] - fRec7[1]));
		...
		double fTemp38 = (fTemp36 + fTemp37) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec66[1]) + 1e+05);
		fVec15[0] = fTemp38;
		fRec69[0] = fConst7 * (2.7e+03 * (fTemp38 + fVec15[1]) - fConst6 * fRec69[1]);
		fRec66[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp37 + fRec69[0] + fTemp36 + -1.863946) + -60.96496296296296;
		fRec65[0] = 0.05 * (fConst8 * fRec66[0] + fConst9 * fRec66[1]) - fConst4 * fRec65[1];
		fRec70[0] = fConst12 * (fConst11 * fRec70[1] + 0.05 * (fRec66[0] - fRec66[1]));
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec61[1]) + 1e+05);
		fVec17[0] = fTemp42;
		fRec71[0] = fConst18 * (1.5e+03 * (fTemp42 + fVec17[1]) - fConst17 * fRec71[1]);
		fRec61[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp41 + fRec71[0] + fTemp40 + -1.271609) + -45.22606666666667;
		fRec60[0] = 0.05 * (fConst8 * fRec61[0] + fConst9 * fRec61[1]) - fConst4 * fRec60[1];
		fRec72[0] = fConst12 * (fConst11 * fRec72[1] + 0.05 * (fRec61[0] - fRec61[1]));
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec57[1]) + 1e+05);
		fVec19[0] = fTemp46;
		fRec73[0] = fConst21 * (8.2e+02 * (fTemp46 + fVec19[1]) - fConst20 * fRec73[1]);
		fRec57[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp45 + fRec73[0] + fTemp44 + -0.797043) + -32.799634146341475;
		fRec56[0] = 0.05 * (fConst8 * fRec57[0] + fConst9 * fRec57[1]) - fConst4 * fRec56[1];
		fRec74[0] = fConst12 * (fConst11 * fRec74[1] + 0.05 * (fRec57[0] - fRec57[1]));
