...
inline void Dsp::init(uint32_t samplingFreq)
{
	...
	fConst58 = (0 - fConst25);
	fConst59 = (2 * (0 - fConst23));
	fConst60 = (1 + ((fConst25 - 1.0) / fConst22));
	fConst61 = (1.0 / (1 + ((1.0 + fConst25) / fConst22)));
	fConst62 = (0 - fConst31);
	fConst63 = (2 * (0 - fConst29));
	fConst64 = (1 + ((fConst31 - 1.0) / fConst28));
	fConst65 = (1.0 / (1 + ((1.0 + fConst31) / fConst28)));
	fConst66 = (0 - fConst38);
	fConst67 = (2 * (0 - fConst36));
...
#define fslider3 (*fslider3_)
	...
	double 	fSlow8 = (fConst27 * pow(1e+01,(2 * fSlow3)));
	double 	fSlow9 = pow(1e+01,(1.2 * fSlow3));
	double 	fSlow10 = pow(1e+01,(0.8 * fSlow3));
	...
	for (int i=0; i<count; i++) {
		...
		fRec12[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec14[0] + ((double)input0[i] * fRec13[0])) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec15[0] + fRec10[0]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec16[0] + fRec8[0]) - 0.797042999999999)) - 32.799634146341475);
		fRec6[0] = ((fConst13 * fRec6[1]) + (fConst12 * ((fConst9 * fRec7[0]) + (fConst10 * fRec7[1]))));
		double fTemp4 = (1e-15 + (fRec6[0] * fRec5[0]));
		double fTemp5 = (1 - fRec5[0]);
		double fTemp6 = (fRec6[0] * fTemp5);
		double fTemp7 = (1e-15 + fTemp6);
		fRec25[0] = (fTemp4 - (fConst47 * ((fConst45 * fRec25[2]) + (fConst43 * fRec25[1]))));
		double fTemp8 = (fRec25[2] + (fRec25[0] + (2 * fRec25[1])));
		fVec4[0] = fTemp8;
		...
		double fTemp10 = (fRec20[2] + (fRec20[0] + (2 * fRec20[1])));
		fVec6[0] = fTemp10;
		fRec19[0] = ((fConst57 * fRec19[1]) + (fConst56 * (fVec6[0] + fVec6[1])));
		fRec18[0] = (fRec19[0] - (fConst27 * ((fConst26 * fRec18[2]) + (fConst24 * fRec18[1]))));
		double fTemp11 = max((double)-1, min((double)1, (fSlow7 * (fRec18[2] + (fRec18[0] + (2 * fRec18[1]))))));
		fRec27[0] = ((fConst57 * fRec27[1]) + (fConst56 * ((fConst25 * fVec6[0]) + (fConst58 * fVec6[1]))));
		fRec26[0] = (fRec27[0] - (fConst27 * ((fConst26 * fRec26[2]) + (fConst24 * fRec26[1]))));
		double fTemp12 = max((double)-1, min((double)1, (fSlow8 * (((fConst23 * fRec26[0]) + (fConst59 * fRec26[1])) + (fConst23 * fRec26[2])))));
		double fTemp13 = (fConst24 * fRec28[1]);
		fRec30[0] = ((fConst54 * fRec30[1]) + (fConst53 * ((fConst31 * fVec5[0]) + (fConst62 * fVec5[1]))));
		fRec29[0] = (fRec30[0] - (fConst34 * ((fConst32 * fRec29[2]) + (fConst30 * fRec29[1]))));
		fRec28[0] = ((fConst34 * (((fConst29 * fRec29[0]) + (fConst63 * fRec29[1])) + (fConst29 * fRec29[2]))) - (fConst61 * ((fConst60 * fRec28[2]) + fTemp13)));
		double fTemp14 = max((double)-1, min((double)1, (fSlow9 * (fRec28[2] + (fConst61 * (fTemp13 + (fConst60 * fRec28[0])))))));
		double fTemp15 = (fConst24 * fRec31[1]);
		double fTemp16 = (fConst30 * fRec32[1]);
		fRec34[0] = ((fConst51 * fRec34[1]) + (fConst50 * ((fConst38 * fRec24[0]) + (fConst66 * fRec24[1]))));
		fRec33[0] = (fRec34[0] - (fConst41 * ((fConst39 * fRec33[2]) + (fConst37 * fRec33[1]))));
		fRec32[0] = ((fConst41 * (((fConst36 * fRec33[0]) + (fConst67 * fRec33[1])) + (fConst36 * fRec33[2]))) - (fConst65 * ((fConst64 * fRec32[2]) + fTemp16)));
		fRec31[0] = ((fRec32[2] + (fConst65 * (fTemp16 + (fConst64 * fRec32[0])))) - (fConst61 * ((fConst60 * fRec31[2]) + fTemp15)));
		double fTemp17 = max((double)-1, min((double)1, (fSlow10 * (fRec31[2] + (fConst61 * (fTemp15 + (fConst60 * fRec31[0])))))));
		double fTemp18 = ((1.584893192 * (((fTemp17 * (1 - (0.3333333333333333 * faustpower<2>(fTemp17)))) + (0.8413951417869425 * (fTemp14 * (1 - (0.3333333333333333 * faustpower<2>(fTemp14)))))) + (fTemp12 * (1 - (0.3333333333333333 * faustpower<2>(fTemp12)))))) + (1.2589412 * (fTemp11 * (1 - (0.3333333333333333 * faustpower<2>(fTemp11))))));
		fVec7[0] = fTemp18;
		fRec17[0] = ((fConst4 * fRec17[1]) + (fConst3 * (fVec7[0] + fVec7[1])));
		double fTemp19 = (1e-15 + ((fSlow11 * fRec17[0]) + ((fTemp6 + (fSlow6 * ((fTemp7 * (4 - (4 * fabs(fTemp7)))) - fTemp7))) + (fSlow5 * fTemp4))));
		fVec8[0] = fTemp19;
		...
		fVec10[0] = fTemp22;
		fRec48[0] = ((fConst8 * fRec48[1]) + (fConst7 * (fVec10[0] + fVec10[1])));
		fRec47[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec48[0] + ((double)input1[i] * fRec13[0])) - 1.863945999999999)) - 60.96496296296296);
		fRec46[0] = ((fConst13 * fRec46[1]) + (fConst12 * ((fConst9 * fRec47[0]) + (fConst10 * fRec47[1]))));
		fRec45[0] = ((fConst4 * fRec45[1]) + (fConst3 * (fRec46[0] + fRec46[1])));
		double fTemp23 = (1e-15 + (0.015 * fRec44[1]));
		fVec11[0] = fTemp23;
		fRec49[0] = ((fConst17 * fRec49[1]) + (fConst16 * (fVec11[0] + fVec11[1])));
		fRec44[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec49[0] + fRec45[0]) - 1.2716089999999989)) - 45.22606666666667);
		fRec43[0] = ((fConst13 * fRec43[1]) + (fConst12 * ((fConst9 * fRec44[0]) + (fConst10 * fRec44[1]))));
		double fTemp24 = (1e-15 + (0.0082 * fRec42[1]));
		fVec12[0] = fTemp24;
		fRec50[0] = ((fConst21 * fRec50[1]) + (fConst20 * (fVec12[0] + fVec12[1])));
		fRec42[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec50[0] + fRec43[0]) - 0.797042999999999)) - 32.799634146341475);
		fRec41[0] = ((fConst13 * fRec41[1]) + (fConst12 * ((fConst9 * fRec42[0]) + (fConst10 * fRec42[1]))));
		double fTemp25 = (1e-15 + (fRec5[0] * fRec41[0]));
		double fTemp26 = (fTemp5 * fRec41[0]);
		double fTemp27 = (1e-15 + fTemp26);
		fRec59[0] = (fTemp25 - (fConst47 * ((fConst45 * fRec59[2]) + (fConst43 * fRec59[1]))));
		double fTemp28 = (fRec59[2] + (fRec59[0] + (2 * fRec59[1])));
		fVec13[0] = fTemp28;
		fRec58[0] = ((fConst13 * fRec58[1]) + (fConst48 * ((fConst9 * fVec13[0]) + (fConst10 * fVec13[1]))));
		fRec57[0] = ((fConst51 * fRec57[1]) + (fConst50 * (fRec58[0] + fRec58[1])));
		fRec56[0] = (fRec57[0] - (fConst41 * ((fConst39 * fRec56[2]) + (fConst37 * fRec56[1]))));
		double fTemp29 = (fRec56[2] + (fRec56[0] + (2 * fRec56[1])));
		fVec14[0] = fTemp29;
		fRec55[0] = ((fConst54 * fRec55[1]) + (fConst53 * (fVec14[0] + fVec14[1])));
		fRec54[0] = (fRec55[0] - (fConst34 * ((fConst32 * fRec54[2]) + (fConst30 * fRec54[1]))));
		double fTemp30 = (fRec54[2] + (fRec54[0] + (2 * fRec54[1])));
		fVec15[0] = fTemp30;
		fRec53[0] = ((fConst57 * fRec53[1]) + (fConst56 * (fVec15[0] + fVec15[1])));
		fRec52[0] = (fRec53[0] - (fConst27 * ((fConst26 * fRec52[2]) + (fConst24 * fRec52[1]))));
		double fTemp31 = max((double)-1, min((double)1, (fSlow7 * (fRec52[2] + (fRec52[0] + (2 * fRec52[1]))))));
		double fTemp32 = (fConst24 * fRec60[1]);
		fRec62[0] = ((fConst54 * fRec62[1]) + (fConst53 * ((fConst31 * fVec14[0]) + (fConst62 * fVec14[1]))));
		fRec61[0] = (fRec62[0] - (fConst34 * ((fConst32 * fRec61[2]) + (fConst30 * fRec61[1]))));
		fRec60[0] = ((fConst34 * (((fConst29 * fRec61[0]) + (fConst63 * fRec61[1])) + (fConst29 * fRec61[2]))) - (fConst61 * ((fConst60 * fRec60[2]) + fTemp32)));
		double fTemp33 = max((double)-1, min((double)1, (fSlow9 * (fRec60[2] + (fConst61 * (fTemp32 + (fConst60 * fRec60[0])))))));
		double fTemp34 = (fConst24 * fRec63[1]);
		double fTemp35 = (fConst30 * fRec64[1]);
		fRec66[0] = ((fConst51 * fRec66[1]) + (fConst50 * ((fConst38 * fRec58[0]) + (fConst66 * fRec58[1]))));
		fRec65[0] = (fRec66[0] - (fConst41 * ((fConst39 * fRec65[2]) + (fConst37 * fRec65[1]))));
		fRec64[0] = ((fConst41 * (((fConst36 * fRec65[0]) + (fConst67 * fRec65[1])) + (fConst36 * fRec65[2]))) - (fConst65 * ((fConst64 * fRec64[2]) + fTemp35)));
		fRec63[0] = ((fRec64[2] + (fConst65 * (fTemp35 + (fConst64 * fRec64[0])))) - (fConst61 * ((fConst60 * fRec63[2]) + fTemp34)));
		double fTemp36 = max((double)-1, min((double)1, (fSlow10 * (fRec63[2] + (fConst61 * (fTemp34 + (fConst60 * fRec63[0])))))));
		fRec68[0] = ((fConst57 * fRec68[1]) + (fConst56 * ((fConst25 * fVec15[0]) + (fConst58 * fVec15[1]))));
		fRec67[0] = (fRec68[0] - (fConst27 * ((fConst26 * fRec67[2]) + (fConst24 * fRec67[1]))));
		double fTemp37 = max((double)-1, min((double)1, (fSlow8 * (((fConst23 * fRec67[0]) + (fConst59 * fRec67[1])) + (fConst23 * fRec67[2])))));
		...
		fVec16[0] = fTemp38;
		fRec51[0] = ((fConst4 * fRec51[1]) + (fConst3 * (fVec16[0] + fVec16[1])));
		double fTemp39 = (1e-15 + ((fSlow11 * fRec51[0]) + ((fTemp26 + (fSlow6 * ((fTemp27 * (4 - (4 * fabs(fTemp27)))) - fTemp27))) + (fSlow5 * fTemp25))));
		fVec17[0] = fTemp39;
		fRec40[0] = ((fConst4 * fRec40[1]) + (fConst3 * (fVec17[0] + fVec17[1])));
		double fTemp40 = (fRec3[0] * fRec40[0]);
		double fTemp41 = (1e-15 + (0.0082 * fRec39[1]));
		fVec18[0] = fTemp41;
		fRec69[0] = ((fConst4 * fRec69[1]) + (fConst3 * (fVec18[0] + fVec18[1])));
		fRec39[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec69[0] + fTemp40) - 1.130739999999999)) - 112.10487804878048);
		fRec38[0] = ((fConst13 * fRec38[1]) + (fConst68 * ((fConst9 * fRec39[0]) + (fConst10 * fRec39[1]))));
		double fTemp42 = (1e-15 + (0.0082 * fRec71[1]));
		fVec19[0] = fTemp42;
		fRec72[0] = ((fConst4 * fRec72[1]) + (fConst3 * (fVec19[0] + fVec19[1])));
		fRec71[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec72[0] + fTemp40) - 1.130461999999999)) - 112.13878048780487);
		fRec70[0] = ((fConst13 * fRec70[1]) + (fConst68 * ((fConst9 * fRec71[0]) + (fConst10 * fRec71[1]))));
