...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec20[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec22[0] + ((double)input0[i] * fRec21[0])) - 1.863945999999999)) - 60.96496296296296);
		...
		fRec17[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec23[0] + fRec18[0]) - 1.2716089999999989)) - 45.22606666666667);
		...
		fRec15[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec24[0] + fRec16[0]) - 0.797042999999999)) - 32.799634146341475);
		...
		fRec47[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec48[0] + ((double)input1[i] * fRec21[0])) - 1.863945999999999)) - 60.96496296296296);
