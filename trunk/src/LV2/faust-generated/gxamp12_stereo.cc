...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec61[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec64[0] + (0.9254498422517706 * (fRec62[2] + (fRec62[0] + (2.0 * fRec62[1]))))) - 1.863946)) - 60.96496296296296);
		...
		fRec56[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec65[0] + (0.9254498422517706 * (fRec57[2] + (fRec57[0] + (2.0 * fRec57[1]))))) - 1.271609)) - 45.22606666666667);
		...
		fRec52[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec66[0] + (0.9254498422517706 * (fRec53[2] + (fRec53[0] + (2.0 * fRec53[1]))))) - 0.797043)) - 32.799634146341475);
		...
		double fTemp44 = max((double)-1, min((double)1, (fSlow10 * ((fConst23 * fRec83[2]) + ((fConst23 * fRec83[0]) + (fConst67 * fRec83[1]))))));
