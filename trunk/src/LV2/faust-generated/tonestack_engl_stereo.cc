// generated from file '../src/LV2/faust/tonestack_engl_stereo.dsp' by dsp2cc:
// Code generated with Faust (https://faust.grame.fr)


namespace tonestack_engl_stereo {
...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (1.41e-06 * fSlow15 + fSlow1 * (1.0358800000000002e-06 - fSlow2) + fSlow0 * (4.4744000000000004e-05 * fSlow1 + 1.269e-05) + 2.538e-07);
	double fSlow17 = fSlow1 * (fSlow5 + 1.8555600000000002e-10) + fSlow15 * (fSlow4 + 6.627000000000001e-10 * (1.0 - fSlow1));
...
} // end namespace tonestack_engl_stereo
