...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec0[0] = fTemp3;
		fRec10[0] = ((fConst4 * (fVec0[0] + fVec0[1])) + (fConst3 * fRec10[1]));
		...
		fRec21[0] = ((fConst23 * ((fConst22 * fRec22[1]) + (fConst5 * fRec22[0]))) + (fConst7 * fRec21[1]));
		...
		fRec29[0] = ((fConst23 * ((fConst22 * fRec30[1]) + (fConst5 * fRec30[0]))) + (fConst7 * fRec29[1]));
		fRec20[0] = ((0.6 * fRec29[0]) + fRec21[0]);
		fRec19[0] = ((fConst4 * (fRec20[0] + fRec20[1])) + (fConst3 * fRec19[1]));
		...
		fRec17[0] = ((fConst23 * ((fConst22 * fRec18[1]) + (fConst5 * fRec18[0]))) + (fConst7 * fRec17[1]));
		...
		fRec33[0] = ((fConst23 * ((fConst22 * fRec34[1]) + (fConst5 * fRec34[0]))) + (fConst7 * fRec33[1]));
		...
		fRec14[0] = ((fConst23 * ((fConst22 * fRec15[1]) + (fConst5 * fRec15[0]))) + (fConst7 * fRec14[1]));
		...
		fVec8[0] = fTemp26;
		fRec46[0] = ((fConst64 * ((fConst22 * fVec8[1]) + (fConst5 * fVec8[0]))) + (fConst7 * fRec46[1]));
		...
		fRec79[0] = ((fConst23 * ((fConst22 * fRec80[1]) + (fConst5 * fRec80[0]))) + (fConst7 * fRec79[1]));
		...
		fRec86[0] = ((fConst23 * ((fConst22 * fRec87[1]) + (fConst5 * fRec87[0]))) + (fConst7 * fRec86[1]));
		fRec78[0] = ((0.6 * fRec86[0]) + fRec79[0]);
		fRec77[0] = ((fConst4 * (fRec78[0] + fRec78[1])) + (fConst3 * fRec77[1]));
		...
		fRec75[0] = ((fConst23 * ((fConst22 * fRec76[1]) + (fConst5 * fRec76[0]))) + (fConst7 * fRec75[1]));
		...
		fRec90[0] = ((fConst23 * ((fConst22 * fRec91[1]) + (fConst5 * fRec91[0]))) + (fConst7 * fRec90[1]));
		...
		fRec72[0] = ((fConst23 * ((fConst22 * fRec73[1]) + (fConst5 * fRec73[0]))) + (fConst7 * fRec72[1]));
		...
		fVec21[0] = fTemp65;
		fRec103[0] = ((fConst64 * ((fConst22 * fVec21[1]) + (fConst5 * fVec21[0]))) + (fConst7 * fRec103[1]));
