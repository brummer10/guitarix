...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp57 = (fTemp55 + fTemp56) / (Ranode(TUBE_TABLE_12AX7_250k, fRec98[1]) + 1e+05);
		fVec15[0] = fTemp57;
		fRec101[0] = fConst7 * (8.2e+02 * (fTemp57 + fVec15[1]) - fConst6 * fRec101[1]);
		fRec98[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp56 + fRec101[0] + fTemp55 + -0.840703) + -147.47524390243905;
		...
		double fTemp60 = (fTemp58 + fTemp59) / (Ranode(TUBE_TABLE_12AX7_250k, fRec110[1]) + 1e+05);
		fVec16[0] = fTemp60;
		fRec113[0] = fConst15 * (1.5e+03 * (fTemp60 + fVec16[1]) - fConst14 * fRec113[1]);
		fRec110[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp59 + fRec113[0] + fTemp58 + -1.204285) + -169.71433333333334;
		...
		double fTemp64 = (fTemp62 + fTemp63) / (Ranode(TUBE_TABLE_12AX7_68k, fRec116[1]) + 1e+05);
		fVec18[0] = fTemp64;
		fRec119[0] = fConst18 * (2.7e+03 * (fTemp64 + fVec18[1]) - fConst17 * fRec119[1]);
		fRec116[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp63 + fRec119[0] + fTemp62 + -1.581656) + -191.42014814814814;
		...
		double fTemp67 = (fTemp65 + fTemp66) / (Ranode(TUBE_TABLE_12AX7_250k, fRec104[1]) + 1e+05);
		fVec19[0] = fTemp67;
		fRec121[0] = fConst15 * (1.5e+03 * (fTemp67 + fVec19[1]) - fConst14 * fRec121[1]);
		fRec104[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp66 + fRec121[0] + fTemp65 + -1.204285) + -169.71433333333334;
		...
		double fTemp70 = (fTemp68 + fTemp69) / (Ranode(TUBE_TABLE_12AX7_250k, fRec93[1]) + 1e+05);
		fVec20[0] = fTemp70;
		fRec123[0] = fConst7 * (8.2e+02 * (fTemp70 + fVec20[1]) - fConst6 * fRec123[1]);
		fRec93[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp69 + fRec123[0] + fTemp68 + -0.840703) + -147.47524390243905;
