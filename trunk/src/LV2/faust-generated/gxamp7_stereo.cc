...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec29[0] = fTemp72;
		fRec58[0] = (fConst93 * ((fVec29[2] + (fVec29[0] + (fConst92 * fVec29[1]))) + ((fConst12 * fRec58[2]) + (fConst10 * fRec58[1]))));
		fRec57[0] = (fConst95 * ((fRec58[2] + (fRec58[0] + (fConst94 * fRec58[1]))) + ((fConst8 * fRec57[2]) + (fConst6 * fRec57[1]))));
		fRec56[0] = (fConst97 * ((fRec57[2] + (fRec57[0] + (fConst96 * fRec57[1]))) + ((fConst4 * fRec56[2]) + (fConst2 * fRec56[1]))));
