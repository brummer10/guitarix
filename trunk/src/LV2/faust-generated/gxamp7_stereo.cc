...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp53 = ((fTemp52 + fTemp51) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec96[1]))) + 100000.0));
		fVec15[0] = fTemp53;
		fRec99[0] = (fConst28 * ((820.0 * (fTemp53 + fVec15[1])) - (fConst29 * fRec99[1])));
		fRec96[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp51 + (fRec99[0] + fTemp52)) + -0.84070299999999998)))) + -147.47524390243905);
		...
		double fTemp56 = ((fTemp55 + fTemp54) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec107[1]))) + 100000.0));
		fVec16[0] = fTemp56;
		fRec110[0] = (fConst31 * ((1500.0 * (fTemp56 + fVec16[1])) - (fConst32 * fRec110[1])));
		fRec107[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp54 + (fRec110[0] + fTemp55)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp60 = ((fTemp59 + fTemp58) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec112[1]))) + 100000.0));
		fVec18[0] = fTemp60;
		fRec115[0] = (fConst34 * ((2700.0 * (fTemp60 + fVec18[1])) - (fConst35 * fRec115[1])));
		fRec112[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp58 + (fRec115[0] + fTemp59)) + -1.581656)))) + -191.42014814814814);
		...
		double fTemp63 = ((fTemp62 + fTemp61) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec101[1]))) + 100000.0));
		fVec19[0] = fTemp63;
		fRec116[0] = (fConst31 * ((1500.0 * (fTemp63 + fVec19[1])) - (fConst32 * fRec116[1])));
		fRec101[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp61 + (fRec116[0] + fTemp62)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp66 = ((fTemp65 + fTemp64) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec91[1]))) + 100000.0));
		fVec20[0] = fTemp66;
		fRec117[0] = (fConst28 * ((820.0 * (fTemp66 + fVec20[1])) - (fConst29 * fRec117[1])));
		fRec91[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp64 + (fRec117[0] + fTemp65)) + -0.84070299999999998)))) + -147.47524390243905);
