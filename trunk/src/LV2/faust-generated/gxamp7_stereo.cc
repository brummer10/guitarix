...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp29 = (fConst36 * fRec49[1]);
		...
		fRec49[0] = ((fConst46 * (((fConst41 * fRec50[0]) + (fConst73 * fRec50[1])) + (fConst41 * fRec50[2]))) - (fConst71 * ((fConst70 * fRec49[2]) + fTemp29)));
		double fTemp30 = max((double)-1, min((double)1, (fSlow8 * (fRec49[2] + (fConst71 * (fTemp29 + (fConst70 * fRec49[0])))))));
		...
		fRec53[0] = ((fConst53 * (((fConst48 * fRec54[0]) + (fConst77 * fRec54[1])) + (fConst48 * fRec54[2]))) - (fConst75 * ((fConst74 * fRec53[2]) + fTemp32)));
		fRec52[0] = ((fRec53[2] + (fConst75 * (fTemp32 + (fConst74 * fRec53[0])))) - (fConst71 * ((fConst70 * fRec52[2]) + fTemp31)));
		double fTemp33 = max((double)-1, min((double)1, (fSlow9 * (fRec52[2] + (fConst71 * (fTemp31 + (fConst70 * fRec52[0])))))));
		...
		double fTemp34 = max((double)-1, min((double)1, (fSlow10 * (((fConst35 * fRec56[0]) + (fConst79 * fRec56[1])) + (fConst35 * fRec56[2])))));
		...
		fVec14[0] = fTemp44;
		fRec87[0] = (fConst14 * ((fVec14[0] - fVec14[1]) + (fConst13 * fRec87[1])));
		fRec86[0] = (fConst14 * ((fRec87[0] - fRec87[1]) + (fConst13 * fRec86[1])));
		fRec85[0] = (fRec86[0] - (fConst11 * ((fConst10 * fRec85[2]) + (fConst6 * fRec85[1]))));
		fRec84[0] = ((fConst11 * (fRec85[2] + (fRec85[0] + (2 * fRec85[1])))) - (fConst9 * ((fConst8 * fRec84[2]) + (fConst6 * fRec84[1]))));
		double fTemp45 = (1e-15 + (0.027 * fRec83[1]));
		fVec15[0] = fTemp45;
		fRec88[0] = ((fConst18 * fRec88[1]) + (fConst17 * (fVec15[0] + fVec15[1])));
		fRec83[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec88[0] + (fConst9 * (fRec30[0] * (fRec84[2] + (fRec84[0] + (2 * fRec84[1])))))) - 1.5816559999999988)) - 191.42014814814814);
		fRec82[0] = ((fConst23 * fRec82[1]) + (fConst22 * ((fConst19 * fRec83[0]) + (fConst20 * fRec83[1]))));
		double fTemp46 = (1e-15 + (0.015 * fRec90[1]));
		fVec16[0] = fTemp46;
		fRec91[0] = ((fConst27 * fRec91[1]) + (fConst26 * (fVec16[0] + fVec16[1])));
		fRec90[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec91[0] + fRec81[1]) - 1.204284999999999)) - 169.71433333333334);
		fRec89[0] = ((fConst23 * fRec89[1]) + (fConst22 * ((fConst19 * fRec90[0]) + (fConst20 * fRec90[1]))));
		fRec81[0] = ((0.6 * fRec89[0]) + fRec82[0]);
		fRec80[0] = ((fConst4 * fRec80[1]) + (fConst3 * (fRec81[0] + fRec81[1])));
		double fTemp47 = (1e-15 + (0.015 * fRec79[1]));
		fVec17[0] = fTemp47;
		fRec92[0] = ((fConst27 * fRec92[1]) + (fConst26 * (fVec17[0] + fVec17[1])));
		fRec79[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec92[0] + fRec80[0]) - 1.204284999999999)) - 169.71433333333334);
		fRec78[0] = ((fConst23 * fRec78[1]) + (fConst22 * ((fConst19 * fRec79[0]) + (fConst20 * fRec79[1]))));
		double fTemp48 = (1e-15 + (0.0082 * fRec94[1]));
		fVec18[0] = fTemp48;
		fRec95[0] = ((fConst31 * fRec95[1]) + (fConst30 * (fVec18[0] + fVec18[1])));
		fRec94[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec95[0] + fRec77[1]) - 0.840702999999999)) - 147.47524390243905);
		fRec93[0] = ((fConst23 * fRec93[1]) + (fConst22 * ((fConst19 * fRec94[0]) + (fConst20 * fRec94[1]))));
		fRec77[0] = ((0.6 * fRec93[0]) + fRec78[0]);
		double fTemp49 = (1e-15 + (0.0082 * fRec76[1]));
		fVec19[0] = fTemp49;
		fRec96[0] = ((fConst31 * fRec96[1]) + (fConst30 * (fVec19[0] + fVec19[1])));
		fRec76[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec96[0] + fRec77[0]) - 0.840702999999999)) - 147.47524390243905);
		fRec75[0] = ((fConst23 * fRec75[1]) + (fConst22 * ((fConst19 * fRec76[0]) + (fConst20 * fRec76[1]))));
		...
		fRec73[0] = ((fVec20[IOTA&32767] + fRec73[1]) - fVec20[(IOTA-iConst32)&32767]);
		fRec72[0] = ((0.999 * fRec72[1]) + (fConst33 * fRec73[0]));
		...
		fRec105[0] = ((0.024937655860349125 * fTemp62) - (fConst59 * ((fConst57 * fRec105[2]) + (fConst55 * fRec105[1]))));
		double fTemp64 = (fRec105[2] + (fRec105[0] + (2 * fRec105[1])));
		fVec21[0] = fTemp64;
		fRec104[0] = ((fConst23 * fRec104[1]) + (fConst60 * ((fConst19 * fVec21[0]) + (fConst20 * fVec21[1]))));
		fRec103[0] = ((fConst63 * fRec103[1]) + (fConst62 * (fRec104[0] + fRec104[1])));
		fRec102[0] = (fRec103[0] - (fConst53 * ((fConst51 * fRec102[2]) + (fConst49 * fRec102[1]))));
		double fTemp65 = (fRec102[2] + (fRec102[0] + (2 * fRec102[1])));
		fVec22[0] = fTemp65;
		fRec101[0] = ((fConst66 * fRec101[1]) + (fConst65 * (fVec22[0] + fVec22[1])));
		fRec100[0] = (fRec101[0] - (fConst46 * ((fConst44 * fRec100[2]) + (fConst42 * fRec100[1]))));
		double fTemp66 = (fRec100[2] + (fRec100[0] + (2 * fRec100[1])));
		fVec23[0] = fTemp66;
		fRec99[0] = ((fConst69 * fRec99[1]) + (fConst68 * (fVec23[0] + fVec23[1])));
		fRec98[0] = (fRec99[0] - (fConst39 * ((fConst38 * fRec98[2]) + (fConst36 * fRec98[1]))));
		double fTemp67 = max((double)-1, min((double)1, (fSlow7 * (fRec98[2] + (fRec98[0] + (2 * fRec98[1]))))));
		double fTemp68 = (fConst36 * fRec106[1]);
		fRec108[0] = ((fConst66 * fRec108[1]) + (fConst65 * ((fConst43 * fVec22[0]) + (fConst72 * fVec22[1]))));
		fRec107[0] = (fRec108[0] - (fConst46 * ((fConst44 * fRec107[2]) + (fConst42 * fRec107[1]))));
		fRec106[0] = ((fConst46 * (((fConst41 * fRec107[0]) + (fConst73 * fRec107[1])) + (fConst41 * fRec107[2]))) - (fConst71 * ((fConst70 * fRec106[2]) + fTemp68)));
		double fTemp69 = max((double)-1, min((double)1, (fSlow8 * (fRec106[2] + (fConst71 * (fTemp68 + (fConst70 * fRec106[0])))))));
		double fTemp70 = (fConst36 * fRec109[1]);
		double fTemp71 = (fConst42 * fRec110[1]);
		fRec112[0] = ((fConst63 * fRec112[1]) + (fConst62 * ((fConst50 * fRec104[0]) + (fConst76 * fRec104[1]))));
		fRec111[0] = (fRec112[0] - (fConst53 * ((fConst51 * fRec111[2]) + (fConst49 * fRec111[1]))));
		fRec110[0] = ((fConst53 * (((fConst48 * fRec111[0]) + (fConst77 * fRec111[1])) + (fConst48 * fRec111[2]))) - (fConst75 * ((fConst74 * fRec110[2]) + fTemp71)));
		fRec109[0] = ((fRec110[2] + (fConst75 * (fTemp71 + (fConst74 * fRec110[0])))) - (fConst71 * ((fConst70 * fRec109[2]) + fTemp70)));
		double fTemp72 = max((double)-1, min((double)1, (fSlow9 * (fRec109[2] + (fConst71 * (fTemp70 + (fConst70 * fRec109[0])))))));
		fRec114[0] = ((fConst69 * fRec114[1]) + (fConst68 * ((fConst37 * fVec23[0]) + (fConst78 * fVec23[1]))));
		fRec113[0] = (fRec114[0] - (fConst39 * ((fConst38 * fRec113[2]) + (fConst36 * fRec113[1]))));
		double fTemp73 = max((double)-1, min((double)1, (fSlow10 * (((fConst35 * fRec113[0]) + (fConst79 * fRec113[1])) + (fConst35 * fRec113[2])))));
		...
		fRec69[0] = ((fConst23 * fRec69[1]) + (fConst22 * ((fConst19 * fRec70[0]) + (fConst20 * fRec70[1]))));
		...
		fRec116[0] = ((fConst23 * fRec116[1]) + (fConst22 * ((fConst19 * fRec117[0]) + (fConst20 * fRec117[1]))));
