...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst50 = std::tan((47123.889803846898 / fConst0));
	fConst51 = (1.0 / fConst50);
	fConst52 = (1.0 / (((fConst51 + 1.4142135623730949) / fConst50) + 1.0));
	fConst53 = std::tan((39269.908169872411 / fConst0));
	fConst54 = (1.0 / fConst53);
	fConst55 = (1.0 / (fConst54 + 1.0));
	fConst56 = (1.0 - fConst54);
	fConst57 = std::tan((157.07963267948966 / fConst0));
	fConst58 = (1.0 / fConst57);
	fConst59 = (fConst0 * std::sin((314.15926535897933 / fConst0)));
	fConst60 = (392.69908169872411 / fConst59);
	fConst61 = (1.0 / (((fConst58 + fConst60) / fConst57) + 1.0));
	fConst62 = (2.0 * (1.0 - (1.0 / mydsp_faustpower2_f(fConst57))));
	fConst63 = std::tan((78.539816339744831 / fConst0));
	fConst64 = (1.0 / fConst63);
	fConst65 = (fConst64 + 1.0);
	...
	fConst78 = (554.7021966383262 / fConst59);
	...
	fConst118 = (1.0 / std::tan((785.39816339744823 / fConst0)));
	fConst119 = (1.0 / (fConst118 + 1.0));
	fConst120 = (1.0 - fConst118);
	fConst121 = std::tan((9424.7779607693792 / fConst0));
	fConst122 = (1.0 / fConst121);
	fConst123 = (fConst122 + 1.0);
