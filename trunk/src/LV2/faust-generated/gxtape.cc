...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	double fConst35 = std::tan(20517.741620594938 / fConst0);
	...
	double fConst51 = std::tan(47123.8898038469 / fConst0);
	fConst52 = 2.0 * (1.0 - 1.0 / mydsp_faustpower2_f(fConst51));
	double fConst53 = 1.0 / fConst51;
	fConst54 = (fConst53 + -1.414213562373095) / fConst51 + 1.0;
	fConst55 = 1.0 / ((fConst53 + 1.414213562373095) / fConst51 + 1.0);
	double fConst56 = std::tan(157.07963267948966 / fConst0);
	fConst57 = 2.0 * (1.0 - 1.0 / mydsp_faustpower2_f(fConst56));
	double fConst58 = fConst0 * std::sin(314.1592653589793 / fConst0);
	double fConst59 = 392.6990816987241 / fConst58;
	double fConst60 = 1.0 / fConst56;
	...
	double fConst91 = 1.0 / std::tan(14284.82179587279 / fConst0);
	fConst92 = 1.0 - fConst91;
	fConst93 = 1.0 / (fConst91 + 1.0);
	double fConst94 = std::tan(235.61944901923448 / fConst0);
	fConst95 = 2.0 * (1.0 - 1.0 / mydsp_faustpower2_f(fConst94));
	double fConst96 = fConst0 * std::sin(471.23889803846896 / fConst0);
	double fConst97 = 589.0486225480862 / fConst96;
	double fConst98 = 1.0 / fConst94;
	...
	double fConst104 = 1175.3065182545242 / fConst96;
	...
	double fConst113 = std::tan(9424.77796076938 / fConst0);
	double fConst114 = 1.0 / fConst113;
	fConst115 = 1.0 - fConst114;
	fConst116 = 4.656612875245797e-10 / fConst113;
	fConst117 = 1.0 / (fConst114 + 1.0);
	double fConst118 = 1.0 / std::tan(785.3981633974482 / fConst0);
	...
	double fConst129 = (fConst23 + 1.0000000000000004) / fConst20 + 1.0;
	...
	double fConst135 = (fConst15 + 1.0000000000000004) / fConst12 + 1.0;
