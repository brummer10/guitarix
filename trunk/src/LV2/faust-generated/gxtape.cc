...
#define fcheckbox1 (*fcheckbox1_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = ((fRec4[0] * (0 - (0.000275923691873229 * fRec3[0]))) + (0.000275923691873229 * (fRec4[1] * fRec3[0])));
		fVec1[0] = fTemp1;
		...
		double fTemp4 = (fRec17[0] + (fRec17[2] + (2 * fRec17[1])));
		fVec3[0] = fTemp4;
		...
		double fTemp8 = (((iSlow10)?((iSlow9)?(fConst92 * (fRec30[0] + (fRec30[2] + (2 * fRec30[1])))):(fConst72 * (fRec24[0] + (fRec24[2] + (2 * fRec24[1]))))):((iSlow9)?(fConst65 * (fRec22[0] + (fRec22[2] + (2 * fRec22[1])))):(fConst32 * (fRec12[0] + (fRec12[2] + (2 * fRec12[1])))))) + (fSlow7 * (fRec7[0] + (fRec7[2] + (2 * fRec7[1])))));
		...
		fRec0[0] = ((fConst99 * ((fRec2[0] * (fTemp0 - 0.000257077328090757)) + (fRec2[1] * (0.000257077328090757 - fTemp0)))) - (fConst5 * ((fConst4 * fRec0[2]) + (fConst2 * fRec0[1]))));
