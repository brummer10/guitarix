...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst61 = std::tan((157.07963267948966 / fConst0));
	fConst62 = (1.0 / fConst61);
	fConst63 = (fConst0 * std::sin((314.15926535897933 / fConst0)));
	fConst64 = (392.69908169872411 / fConst63);
	fConst65 = (1.0 / (((fConst62 + fConst64) / fConst61) + 1.0));
	fConst66 = (2.0 * (1.0 - (1.0 / mydsp_faustpower2_f(fConst61))));
	...
	fConst81 = (((fConst62 - fConst64) / fConst61) + 1.0);
	fConst82 = (554.7021966383262 / fConst63);
	fConst83 = (((fConst62 + fConst82) / fConst61) + 1.0);
	fConst84 = (((fConst62 - fConst82) / fConst61) + 1.0);
	...
	fConst95 = std::tan((235.61944901923448 / fConst0));
	fConst96 = (1.0 / fConst95);
	fConst97 = (fConst0 * std::sin((471.23889803846896 / fConst0)));
	fConst98 = (589.0486225480862 / fConst97);
	fConst99 = (1.0 / (((fConst96 + fConst98) / fConst95) + 1.0));
	fConst100 = (2.0 * (1.0 - (1.0 / mydsp_faustpower2_f(fConst95))));
	fConst101 = std::tan((109.95574287564276 / fConst0));
	fConst102 = (1.0 / fConst101);
	fConst103 = (fConst102 + 1.0);
	fConst104 = (0.0 - (1.0 / (fConst101 * fConst103)));
	fConst105 = (1.0 / fConst103);
	fConst106 = (1.0 - fConst102);
	fConst107 = (((fConst96 - fConst98) / fConst95) + 1.0);
	fConst108 = (1175.3065182545242 / fConst97);
	fConst109 = (((fConst96 + fConst108) / fConst95) + 1.0);
	fConst110 = (((fConst96 - fConst108) / fConst95) + 1.0);
	...
	fConst128 = (1.0 / (fConst125 * fConst127));
