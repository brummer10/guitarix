...
#define fVslider7 (*fVslider7_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fThen0 = double(input12au7clip(double(fTemp5)));
		double fElse0 = double(input12au7_negclip(double(fTemp5)));
		double fTemp6 = ((int(signbit(double(fTemp5)))) ? fElse0 : fThen0);
		fVec2[0] = fTemp6;
		...
		double fThen2 = fConst52 * (fRec10[2] + fRec10[0] + 2.0 * fRec10[1]);
		double fElse2 = fConst82 * (fRec20[2] + fRec20[0] + 2.0 * fRec20[1]);
		...
		double fThen3 = fConst89 * (fRec22[2] + fRec22[0] + 2.0 * fRec22[1]);
		double fElse3 = fConst112 * (fRec28[2] + fRec28[0] + 2.0 * fRec28[1]);
		double fThen4 = ((iSlow4) ? fElse2 : fThen2);
		double fElse4 = ((iSlow4) ? fElse3 : fThen3);
		...
		double fTemp14 = ((iSlow2) ? fElse4 : fThen4) + fTemp13;
		fVec6[IOTA0 & 8191] = fTemp14;
		...
		double fThen6 = (((fRec39[1] == 1.0) & (fTemp16 != fRec41[1])) ? fConst130 : 0.0);
		double fThen8 = (((fRec39[1] == 0.0) & (fTemp16 != fRec40[1])) ? fConst129 : fThen6);
		double fElse8 = (((fRec39[1] > 0.0) & (fRec39[1] < 1.0)) ? fRec38[1] : 0.0);
		double fTemp17 = ((fRec38[1] != 0.0) ? fElse8 : fThen8);
		fRec38[0] = fTemp17;
		...
		double fTemp19 = fVec6[(IOTA0 - iTemp18) & 8191];
		int iTemp20 = int(std::min<double>(4096.0, std::max<double>(0.0, fRec41[0])));
		double fTemp21 = fTemp19 + fRec39[0] * (fVec6[(IOTA0 - iTemp20) & 8191] - fTemp19);
		fVec7[IOTA0 & 8191] = fTemp21;
		...
		double fThen12 = (((fRec46[1] == 1.0) & (fTemp22 != fRec48[1])) ? fConst130 : 0.0);
		double fThen14 = (((fRec46[1] == 0.0) & (fTemp22 != fRec47[1])) ? fConst129 : fThen12);
		double fElse14 = (((fRec46[1] > 0.0) & (fRec46[1] < 1.0)) ? fRec45[1] : 0.0);
		double fTemp23 = ((fRec45[1] != 0.0) ? fElse14 : fThen14);
		fRec45[0] = fTemp23;
		...
		double fThen18 = double(output12au7clip(double(fTemp29)));
		double fElse18 = double(output12au7_negclip(double(fTemp29)));
		fRec0[0] = ((int(signbit(double(fTemp29)))) ? fElse18 : fThen18) - fConst3 * (fConst132 * fRec0[2] + fConst133 * fRec0[1]);
		...
		double fThen19 = double(input12au7clip(double(fTemp33)));
		double fElse19 = double(input12au7_negclip(double(fTemp33)));
		double fTemp34 = ((int(signbit(double(fTemp33)))) ? fElse19 : fThen19);
		fVec9[0] = fTemp34;
		...
		double fThen20 = fConst52 * (fRec64[2] + fRec64[0] + 2.0 * fRec64[1]);
		double fElse20 = fConst82 * (fRec74[2] + fRec74[0] + 2.0 * fRec74[1]);
		...
		double fThen21 = fConst89 * (fRec76[2] + fRec76[0] + 2.0 * fRec76[1]);
		double fElse21 = fConst112 * (fRec82[2] + fRec82[0] + 2.0 * fRec82[1]);
		double fThen22 = ((iSlow4) ? fElse20 : fThen20);
		double fElse22 = ((iSlow4) ? fElse21 : fThen21);
		double fTemp40 = fTemp13 + ((iSlow2) ? fElse22 : fThen22);
		fVec12[IOTA0 & 8191] = fTemp40;
		double fTemp41 = fVec12[(IOTA0 - iTemp18) & 8191];
		double fTemp42 = fTemp41 + fRec39[0] * (fVec12[(IOTA0 - iTemp20) & 8191] - fTemp41);
		fVec13[IOTA0 & 8191] = fTemp42;
		double fTemp43 = fVec13[(IOTA0 - iTemp24) & 8191];
		fRec87[0] = 0.0 - (fSlow6 * fRec87[1] - (fRec63[1] + fRec63[2])) / fSlow7;
		fRec63[0] = (fTemp43 + fRec46[0] * (fVec13[(IOTA0 - iTemp26) & 8191] - fTemp43)) - fRec87[0];
		...
		double fThen24 = double(output12au7clip(double(fTemp44)));
		double fElse24 = double(output12au7_negclip(double(fTemp44)));
		fRec54[0] = ((int(signbit(double(fTemp44)))) ? fElse24 : fThen24) - fConst3 * (fConst132 * fRec54[2] + fConst133 * fRec54[1]);
		...
		double fThen25 = double(input12au7clip(double(fTemp47)));
		double fElse25 = double(input12au7_negclip(double(fTemp47)));
		double fTemp48 = ((int(signbit(double(fTemp47)))) ? fElse25 : fThen25);
		fVec15[0] = fTemp48;
		...
		double fThen26 = fConst52 * (fRec97[2] + fRec97[0] + 2.0 * fRec97[1]);
		double fElse26 = fConst82 * (fRec107[2] + fRec107[0] + 2.0 * fRec107[1]);
		...
		double fThen27 = fConst89 * (fRec109[2] + fRec109[0] + 2.0 * fRec109[1]);
		double fElse27 = fConst112 * (fRec115[2] + fRec115[0] + 2.0 * fRec115[1]);
		double fThen28 = ((iSlow4) ? fElse26 : fThen26);
		double fElse28 = ((iSlow4) ? fElse27 : fThen27);
		double fTemp54 = fTemp13 + ((iSlow2) ? fElse28 : fThen28);
		fVec18[IOTA0 & 8191] = fTemp54;
		double fTemp55 = fVec18[(IOTA0 - iTemp18) & 8191];
		double fTemp56 = fTemp55 + fRec39[0] * (fVec18[(IOTA0 - iTemp20) & 8191] - fTemp55);
		fVec19[IOTA0 & 8191] = fTemp56;
		double fTemp57 = fVec19[(IOTA0 - iTemp24) & 8191];
		fRec120[0] = 0.0 - (fSlow6 * fRec120[1] - (fRec96[1] + fRec96[2])) / fSlow7;
		fRec96[0] = (fTemp57 + fRec46[0] * (fVec19[(IOTA0 - iTemp26) & 8191] - fTemp57)) - fRec120[0];
		...
		double fThen30 = double(output12au7clip(double(fTemp58)));
		double fElse30 = double(output12au7_negclip(double(fTemp58)));
		fRec88[0] = ((int(signbit(double(fTemp58)))) ? fElse30 : fThen30) - fConst3 * (fConst132 * fRec88[2] + fConst133 * fRec88[1]);
		...
		double fThen31 = double(input12au7clip(double(fTemp60)));
		double fElse31 = double(input12au7_negclip(double(fTemp60)));
		double fTemp61 = ((int(signbit(double(fTemp60)))) ? fElse31 : fThen31);
		fVec21[0] = fTemp61;
		...
		double fThen32 = fConst52 * (fRec129[2] + fRec129[0] + 2.0 * fRec129[1]);
		double fElse32 = fConst82 * (fRec139[2] + fRec139[0] + 2.0 * fRec139[1]);
		...
		double fThen33 = fConst89 * (fRec141[2] + fRec141[0] + 2.0 * fRec141[1]);
		double fElse33 = fConst112 * (fRec147[2] + fRec147[0] + 2.0 * fRec147[1]);
		double fThen34 = ((iSlow4) ? fElse32 : fThen32);
		double fElse34 = ((iSlow4) ? fElse33 : fThen33);
		double fTemp67 = fTemp13 + ((iSlow2) ? fElse34 : fThen34);
		fVec24[IOTA0 & 8191] = fTemp67;
		double fTemp68 = fVec24[(IOTA0 - iTemp18) & 8191];
		double fTemp69 = fTemp68 + fRec39[0] * (fVec24[(IOTA0 - iTemp20) & 8191] - fTemp68);
		fVec25[IOTA0 & 8191] = fTemp69;
		double fTemp70 = fVec25[(IOTA0 - iTemp24) & 8191];
		fRec152[0] = 0.0 - (fSlow6 * fRec152[1] - (fRec128[1] + fRec128[2])) / fSlow7;
		fRec128[0] = (fTemp70 + fRec46[0] * (fVec25[(IOTA0 - iTemp26) & 8191] - fTemp70)) - fRec152[0];
		...
		double fThen36 = double(output12au7clip(double(fTemp71)));
		double fElse36 = double(output12au7_negclip(double(fTemp71)));
		fRec121[0] = ((int(signbit(double(fTemp71)))) ? fElse36 : fThen36) - fConst3 * (fConst132 * fRec121[2] + fConst133 * fRec121[1]);
		...
		double fThen37 = double(input12au7clip(double(fTemp72)));
		double fElse37 = double(input12au7_negclip(double(fTemp72)));
		double fTemp73 = ((int(signbit(double(fTemp72)))) ? fElse37 : fThen37);
		fVec26[0] = fTemp73;
		...
		double fThen38 = fConst52 * (fRec159[2] + fRec159[0] + 2.0 * fRec159[1]);
		double fElse38 = fConst82 * (fRec169[2] + fRec169[0] + 2.0 * fRec169[1]);
		...
		double fThen39 = fConst89 * (fRec171[2] + fRec171[0] + 2.0 * fRec171[1]);
		double fElse39 = fConst112 * (fRec177[2] + fRec177[0] + 2.0 * fRec177[1]);
		double fThen40 = ((iSlow4) ? fElse38 : fThen38);
		double fElse40 = ((iSlow4) ? fElse39 : fThen39);
		double fTemp79 = fTemp13 + ((iSlow2) ? fElse40 : fThen40);
		fVec29[IOTA0 & 8191] = fTemp79;
		double fTemp80 = fVec29[(IOTA0 - iTemp18) & 8191];
		double fTemp81 = fTemp80 + fRec39[0] * (fVec29[(IOTA0 - iTemp20) & 8191] - fTemp80);
		...
		fRec158[0] = (fTemp82 + fRec46[0] * (fVec30[(IOTA0 - iTemp26) & 8191] - fTemp82)) - fRec182[0];
		...
		double fThen42 = double(output12au7clip(double(fTemp83)));
		double fElse42 = double(output12au7_negclip(double(fTemp83)));
		fRec153[0] = ((int(signbit(double(fTemp83)))) ? fElse42 : fThen42) - fConst3 * (fConst132 * fRec153[2] + fConst133 * fRec153[1]);
