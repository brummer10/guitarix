...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp2 = ((fTemp1 + fTemp0) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec27[1]))) + 100000.0));
		fVec0[0] = fTemp2;
		fRec30[0] = (fConst28 * ((820.0 * (fTemp2 + fVec0[1])) - (fConst29 * fRec30[1])));
		double fTemp3 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp0 + (fRec30[0] + fTemp1)) + -1.2569619999999999))));
		fRec27[0] = ((fTemp3 + (0.001532880487804878 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp3))) + 100000.0))) + -250.0);
		...
		double fTemp6 = ((fTemp5 + fTemp4) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec38[1]))) + 100000.0));
		fVec1[0] = fTemp6;
		fRec41[0] = (fConst31 * ((1500.0 * (fTemp6 + fVec1[1])) - (fConst32 * fRec41[1])));
		double fTemp7 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp4 + (fRec41[0] + fTemp5)) + -1.8873329999999999))));
		fRec38[0] = ((fTemp7 + (0.001258222 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp7))) + 100000.0))) + -250.0);
		...
		double fTemp11 = ((fTemp10 + fTemp9) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec43[1]))) + 100000.0));
		fVec3[0] = fTemp11;
		fRec47[0] = (fConst34 * ((2700.0 * (fTemp11 + fVec3[1])) - (fConst35 * fRec47[1])));
		double fTemp12 = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp9 + (fRec47[0] + fTemp10)) + -2.617753))));
		fRec43[0] = ((fTemp12 + (0.00096953814814814819 * (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fTemp12))) + 100000.0))) + -250.0);
		...
		double fTemp15 = ((fTemp14 + fTemp13) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec32[1]))) + 100000.0));
		fVec4[0] = fTemp15;
		fRec48[0] = (fConst31 * ((1500.0 * (fTemp15 + fVec4[1])) - (fConst32 * fRec48[1])));
		double fTemp16 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp13 + (fRec48[0] + fTemp14)) + -1.8873329999999999))));
		fRec32[0] = ((fTemp16 + (0.001258222 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp16))) + 100000.0))) + -250.0);
		...
		double fTemp19 = ((fTemp18 + fTemp17) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec22[1]))) + 100000.0));
		fVec5[0] = fTemp19;
		fRec49[0] = (fConst28 * ((820.0 * (fTemp19 + fVec5[1])) - (fConst29 * fRec49[1])));
		double fTemp20 = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp17 + (fRec49[0] + fTemp18)) + -1.2569619999999999))));
		fRec22[0] = ((fTemp20 + (0.001532880487804878 * (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fTemp20))) + 100000.0))) + -250.0);
