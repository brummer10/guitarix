...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec31[0] = (fRec32[0] - ((0.8612942439318627 * fRec31[2]) + (1.8405051250752198 * fRec31[1])));
		double fTemp5 = (1e-15 + (0.027 * fRec30[1]));
		fVec2[0] = fTemp5;
		fRec38[0] = ((fConst14 * fRec38[1]) + (fConst13 * (fVec2[0] + fVec2[1])));
		fRec30[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec38[0] + (0.9254498422517706 * (fRec31[2] + (fRec31[0] + (2.0 * fRec31[1]))))) - 2.617753)) - 153.04618518518518);
		...
		fRec40[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec43[0] + (0.9254498422517706 * (fRec41[2] + (fRec41[0] + (2.0 * fRec41[1]))))) - 1.887333)) - 124.17779999999999);
		...
		fRec24[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec44[0] + (0.9254498422517706 * (fRec25[2] + (fRec25[0] + (2.0 * fRec25[1]))))) - 1.887333)) - 124.17779999999999);
		...
		fRec46[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec49[0] + (0.9254498422517706 * (fRec47[2] + (fRec47[0] + (2.0 * fRec47[1]))))) - 1.256962)) - 96.7119512195122);
		...
		fRec19[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec50[0] + (0.9254498422517706 * (fRec20[2] + (fRec20[0] + (2.0 * fRec20[1]))))) - 1.256962)) - 96.7119512195122);
		...
		fRec8[0] = ((fConst19 * fRec8[1]) + (fConst18 * ((fConst15 * fRec9[0]) + (fConst16 * fRec9[1]))));
		...
		fRec70[0] = ((fConst19 * fRec70[1]) + (fConst18 * ((fConst15 * fRec71[0]) + (fConst16 * fRec71[1]))));
