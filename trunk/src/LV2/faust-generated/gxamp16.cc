...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp5 = (fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec39[1]))) + 100000.0);
		fVec1[0] = fTemp5;
		fRec42[0] = fConst33 * (1500.0 * (fTemp5 + fVec1[1]) - fConst34 * fRec42[1]);
		fRec39[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp3 + fRec42[0] + fTemp4 + -1.8873329999999999))) + -124.17779999999999;
		...
		double fTemp9 = (fTemp8 + fTemp7) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec45[1]))) + 100000.0);
		fVec3[0] = fTemp9;
		fRec49[0] = fConst36 * (2700.0 * (fTemp9 + fVec3[1]) - fConst37 * fRec49[1]);
		fRec45[0] = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(fTemp7 + fRec49[0] + fTemp8 + -2.617753))) + -153.04618518518518;
		...
		double fTemp12 = (fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec33[1]))) + 100000.0);
		fVec4[0] = fTemp12;
		fRec51[0] = fConst33 * (1500.0 * (fTemp12 + fVec4[1]) - fConst34 * fRec51[1]);
		fRec33[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp10 + fRec51[0] + fTemp11 + -1.8873329999999999))) + -124.17779999999999;
		...
		fRec22[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp13 + fRec53[0] + fTemp14 + -1.2569619999999999))) + -96.711951219512201;
