...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AT7_250k, fRec35[1]) + 1e+05);
		fVec1[0] = fTemp9;
		fRec38[0] = fConst14 * (1.5e+03 * (fTemp9 + fVec1[1]) - fConst13 * fRec38[1]);
		fRec35[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp8 + fRec38[0] + fTemp7 + -1.887333) + -124.17779999999999;
		...
		double fTemp14 = (fTemp12 + fTemp13) / (Ranode(TUBE_TABLE_12AT7_68k, fRec41[1]) + 1e+05);
		fVec3[0] = fTemp14;
		fRec45[0] = fConst17 * (2.7e+03 * (fTemp14 + fVec3[1]) - fConst16 * fRec45[1]);
		fRec41[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp13 + fRec45[0] + fTemp12 + -2.617753) + -153.04618518518518;
		...
		double fTemp18 = (fTemp16 + fTemp17) / (Ranode(TUBE_TABLE_12AT7_250k, fRec29[1]) + 1e+05);
		fVec4[0] = fTemp18;
		fRec47[0] = fConst14 * (1.5e+03 * (fTemp18 + fVec4[1]) - fConst13 * fRec47[1]);
		fRec29[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp17 + fRec47[0] + fTemp16 + -1.887333) + -124.17779999999999;
		...
		double fTemp22 = (fTemp20 + fTemp21) / (Ranode(TUBE_TABLE_12AT7_250k, fRec18[1]) + 1e+05);
		fVec5[0] = fTemp22;
		fRec49[0] = fConst6 * (8.2e+02 * (fTemp22 + fVec5[1]) - fConst5 * fRec49[1]);
		fRec18[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp21 + fRec49[0] + fTemp20 + -1.256962) + -96.7119512195122;
