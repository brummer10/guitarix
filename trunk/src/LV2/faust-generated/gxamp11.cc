...
inline void Dsp::init(uint32_t sample_rate)
{
	...
	fConst6 = (1.0 - fConst4);
	double fConst7 = (1.0 / std::tan((609.46897479641984 / fConst0)));
	...
	double fConst18 = mydsp_faustpower2_f(fConst15);
	...
	double fConst23 = (fConst16 + 1.0);
	fConst24 = (1.0 / (fConst15 * fConst23));
	double fConst25 = (fConst21 + 1.0);
	fConst26 = (1.0 / fConst25);
	fConst27 = (1.0 - fConst21);
	double fConst28 = std::tan((47123.889803846898 / fConst0));
	double fConst29 = (1.0 / fConst28);
	fConst30 = (1.0 / (((fConst29 + 1.4142135623730949) / fConst28) + 1.0));
	double fConst31 = std::tan((97.389372261283583 / fConst0));
	...
	double fConst40 = mydsp_faustpower2_f(fConst20);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp5 = ((fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec18[1]))) + 100000.0));
		fVec1[0] = fTemp5;
		fRec21[0] = (fConst11 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst12 * fRec21[1])));
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp3 + (fRec21[0] + fTemp4)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		double fTemp17 = (0.024937655860349125 * (fRec29[0] * fTemp15));
		double fTemp18 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow5 * std::max<double>(-0.69999999999999996, std::min<double>(0.69999999999999996, fTemp17)))));
		fRec37[0] = (fTemp17 - (fConst30 * ((fConst35 * fRec37[2]) + (fConst36 * fRec37[1]))));
		double fTemp19 = (fRec37[2] + (fRec37[0] + (2.0 * fRec37[1])));
		fVec3[0] = fTemp19;
		fRec36[0] = ((fConst30 * ((fConst34 * fTemp19) + (fConst37 * fVec3[1]))) - (fConst38 * fRec36[1]));
		fRec35[0] = (0.0 - (fConst26 * ((fConst27 * fRec35[1]) - (fRec36[0] + fRec36[1]))));
		fRec34[0] = (fRec35[0] - (fConst22 * ((fConst39 * fRec34[2]) + (fConst42 * fRec34[1]))));
		double fTemp20 = (fRec34[2] + (fRec34[0] + (2.0 * fRec34[1])));
		fVec4[0] = fTemp20;
		fRec33[0] = ((fConst22 * ((fConst24 * fTemp20) + (fConst43 * fVec4[1]))) - (fConst45 * fRec33[1]));
		fRec32[0] = (fRec33[0] - (fConst17 * ((fConst46 * fRec32[2]) + (fConst47 * fRec32[1]))));
		double fTemp21 = (fConst57 * fRec31[1]);
		fRec31[0] = ((fConst17 * (((fConst19 * fRec32[0]) + (fConst48 * fRec32[1])) + (fConst19 * fRec32[2]))) - (fConst52 * ((fConst54 * fRec31[2]) + fTemp21)));
		double fTemp22 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (fRec31[2] + (fConst52 * (fTemp21 + (fConst54 * fRec31[0])))))));
		...
		double fTemp23 = (fConst47 * fRec39[1]);
		fRec39[0] = ((fConst22 * (((fConst41 * fRec40[0]) + (fConst59 * fRec40[1])) + (fConst41 * fRec40[2]))) - (fConst60 * ((fConst61 * fRec39[2]) + fTemp23)));
		double fTemp24 = (fConst57 * fRec38[1]);
		fRec38[0] = ((fRec39[2] + (fConst60 * (fTemp23 + (fConst61 * fRec39[0])))) - (fConst52 * ((fConst54 * fRec38[2]) + fTemp24)));
		double fTemp25 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec38[2] + (fConst52 * (fTemp24 + (fConst54 * fRec38[0])))))));
		fRec45[0] = (0.0 - (fConst64 * ((fConst44 * fRec45[1]) - (fConst22 * (fTemp20 + fVec4[1])))));
		fRec44[0] = (fRec45[0] - (fConst17 * ((fConst46 * fRec44[2]) + (fConst47 * fRec44[1]))));
		double fTemp26 = (fRec44[2] + (fRec44[0] + (2.0 * fRec44[1])));
		fVec5[0] = fTemp26;
		fRec43[0] = ((fConst17 * ((fConst63 * fTemp26) + (fConst65 * fVec5[1]))) - (fConst66 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst62 * ((fConst67 * fRec42[2]) + (fConst57 * fRec42[1]))));
		double fTemp27 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow9 * (((fConst56 * fRec42[0]) + (fConst68 * fRec42[1])) + (fConst56 * fRec42[2])))));
		fRec47[0] = (0.0 - (fConst69 * ((fConst53 * fRec47[1]) - (fConst17 * (fTemp26 + fVec5[1])))));
		fRec46[0] = (fRec47[0] - (fConst62 * ((fConst67 * fRec46[2]) + (fConst57 * fRec46[1]))));
		double fTemp28 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow10 * (fRec46[2] + (fRec46[0] + (2.0 * fRec46[1]))))));
		...
		fVec6[0] = fTemp29;
		fRec30[0] = (0.0 - (fConst5 * ((fConst6 * fRec30[1]) - (fTemp29 + fVec6[1]))));
		double fTemp30 = ((fTemp15 * ((fTemp16 * ((fSlow2 * ((0.099750623441396499 * (1.0 - std::fabs((0.024937655860349125 * (fTemp16 * fTemp15))))) + -0.024937655860349125)) + 0.024937655860349125)) + (fSlow4 * fRec29[0]))) + ((0.5 * (fTemp18 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp18))))) + (fSlow6 * fRec30[0])));
		fVec7[0] = fTemp30;
		fRec25[0] = ((0.93028479253239138 * (fTemp30 + fVec7[1])) - (0.86056958506478287 * fRec25[1]));
		fRec24[0] = (fRec25[0] - ((1.8405051250752198 * fRec24[1]) + (0.86129424393186271 * fRec24[2])));
		double fTemp31 = (0.92544984225177063 * (fRec24[0] + fRec24[2]));
		double fTemp32 = (1.8508996845035413 * fRec24[1]);
		double fTemp33 = ((fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp33;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp33 + fVec8[1])) - (fConst72 * fRec48[1])));
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp31 + (fRec48[0] + fTemp32)) + -1.2572399999999999)))) + -83.435555555555567);
		...
		double fTemp34 = (fRec16[0] * fRec49[0]);
		fVec9[0] = fTemp34;
		fRec15[0] = (0.0 - (fConst5 * ((fConst6 * fRec15[1]) - (fTemp34 + fVec9[1]))));
		...
		double fTemp35 = (0.92544984225177063 * (fRec13[0] + fRec13[2]));
		double fTemp36 = (1.8508996845035413 * fRec13[1]);
		double fTemp37 = ((fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp37;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp37 + fVec10[1])) - (fConst12 * fRec50[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp35 + (fRec50[0] + fTemp36)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		fVec11[0] = fTemp40;
		fRec51[0] = (fConst8 * ((820.0 * (fTemp40 + fVec11[1])) - (fConst9 * fRec51[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp38 + (fRec51[0] + fTemp39)) + -0.44548700000000002)))) + -75.672317073170731);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.10000000000000001 * (fRec1[0] - fRec1[1]))));
		fRec52[0] = (fSlow12 + (0.999 * fRec52[1]));
		output0[i0] = FAUSTFLOAT((fRec0[0] * fRec52[0]));
		fRec9[1] = fRec9[0];
		fRec8[2] = fRec8[1];
		fRec8[1] = fRec8[0];
		fVec0[1] = fVec0[0];
