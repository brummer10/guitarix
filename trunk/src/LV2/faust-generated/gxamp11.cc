...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp0 + fRec10[0] + fTemp1 + -0.44548700000000002))) + -75.672317073170731;
		fRec6[0] = 0.10000000000000001 * (fConst4 * fRec7[0] + fConst11 * fRec7[1]) - fConst12 * fRec6[1];
		fRec11[0] = fConst14 * (fConst15 * fRec11[1] + 0.10000000000000001 * (fRec7[0] - fRec7[1]));
		...
		double fTemp5 = (fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec19[1]))) + 100000.0);
		fVec1[0] = fTemp5;
		fRec22[0] = fConst17 * (1500.0 * (fTemp5 + fVec1[1]) - fConst18 * fRec22[1]);
		fRec19[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp3 + fRec22[0] + fTemp4 + -0.77616200000000002))) + -78.255866666666662;
		fRec18[0] = 0.10000000000000001 * (fConst4 * fRec19[0] + fConst11 * fRec19[1]) - fConst12 * fRec18[1];
		fRec23[0] = fConst14 * (fConst15 * fRec23[1] + 0.10000000000000001 * (fRec19[0] - fRec19[1]));
		...
		fVec2[IOTA0 & 32767] = fTemp8;
		fRec30[0] = (fTemp8 + fRec30[1]) - fVec2[(IOTA0 - iConst20) & 32767];
		...
		double fThen2 = fTemp12 / (1.0 - std::exp(-1.0 * fTemp12));
		double fElse2 = 0.0 - fTemp12 * std::exp(fTemp12);
		double fThen3 = fTemp10 * (134.00083333333336 * fTemp10 + 20.050000000000001) + 1.0;
		double fElse3 = ((fTemp12 < -50.0) ? fElse2 : fThen2);
		double fTemp13 = 0.0 - 40.100000000000001 * fTemp9;
		double fTemp14 = std::max<double>(-600.0, fTemp13);
		double fThen4 = fTemp14 / (1.0 - std::exp(-1.0 * fTemp14));
		double fElse4 = 0.0 - fTemp14 * std::exp(fTemp14);
		double fThen5 = fTemp13 * (0.083333333333333329 * fTemp13 + 0.5) + 1.0;
		double fElse5 = ((fTemp14 < -50.0) ? fElse4 : fThen4);
		double fTemp15 = ((std::fabs(fTemp11) > 0.0001) ? fElse3 : fThen3) - ((std::fabs(fTemp13) > 0.0001) ? fElse5 : fThen5);
		fRec31[0] = fSlow2 + 0.999 * fRec31[1];
		double fTemp16 = 1.0 - fRec31[0];
		double fTemp17 = 0.024937655860349125 * fRec31[0] * fTemp15;
		double fTemp18 = std::max<double>(-1.0, std::min<double>(1.0, fSlow7 * std::max<double>(-0.69999999999999996, std::min<double>(0.69999999999999996, fTemp17))));
		fRec39[0] = fTemp17 - fConst36 * (fConst37 * fRec39[2] + fConst38 * fRec39[1]);
		double fTemp19 = fRec39[2] + fRec39[0] + 2.0 * fRec39[1];
		fVec3[0] = fTemp19;
		fRec38[0] = fConst36 * (fConst4 * fTemp19 + fConst11 * fVec3[1]) - fConst12 * fRec38[1];
		...
		fVec4[0] = fTemp20;
		fRec35[0] = fConst28 * (fConst30 * fTemp20 + fConst43 * fVec4[1]) - fConst45 * fRec35[1];
		fRec34[0] = fRec35[0] - fConst23 * (fConst46 * fRec34[2] + fConst47 * fRec34[1]);
		double fTemp21 = fConst57 * fRec33[1];
		fRec33[0] = fConst23 * (fConst25 * fRec34[0] + fConst48 * fRec34[1] + fConst25 * fRec34[2]) - fConst52 * (fConst54 * fRec33[2] + fTemp21);
		double fTemp22 = std::max<double>(-1.0, std::min<double>(1.0, fSlow9 * (fRec33[2] + fConst52 * (fTemp21 + fConst54 * fRec33[0]))));
		...
		double fTemp23 = fConst47 * fRec41[1];
		fRec41[0] = fConst28 * (fConst41 * fRec42[0] + fConst59 * fRec42[1] + fConst41 * fRec42[2]) - fConst60 * (fConst61 * fRec41[2] + fTemp23);
		double fTemp24 = fConst57 * fRec40[1];
		fRec40[0] = (fRec41[2] + fConst60 * (fTemp23 + fConst61 * fRec41[0])) - fConst52 * (fConst54 * fRec40[2] + fTemp24);
		double fTemp25 = std::max<double>(-1.0, std::min<double>(1.0, fSlow10 * (fRec40[2] + fConst52 * (fTemp24 + fConst54 * fRec40[0]))));
		fRec47[0] = 0.0 - fConst64 * (fConst44 * fRec47[1] - fConst28 * (fTemp20 + fVec4[1]));
		fRec46[0] = fRec47[0] - fConst23 * (fConst46 * fRec46[2] + fConst47 * fRec46[1]);
		double fTemp26 = fRec46[2] + fRec46[0] + 2.0 * fRec46[1];
		fVec5[0] = fTemp26;
		fRec45[0] = fConst23 * (fConst63 * fTemp26 + fConst65 * fVec5[1]) - fConst66 * fRec45[1];
		fRec44[0] = fRec45[0] - fConst62 * (fConst67 * fRec44[2] + fConst57 * fRec44[1]);
		double fTemp27 = std::max<double>(-1.0, std::min<double>(1.0, fSlow11 * (fConst56 * fRec44[0] + fConst68 * fRec44[1] + fConst56 * fRec44[2])));
		fRec49[0] = 0.0 - fConst69 * (fConst53 * fRec49[1] - fConst23 * (fTemp26 + fVec5[1]));
		fRec48[0] = fRec49[0] - fConst62 * (fConst67 * fRec48[2] + fConst57 * fRec48[1]);
		double fTemp28 = std::max<double>(-1.0, std::min<double>(1.0, fSlow12 * (fRec48[2] + fRec48[0] + 2.0 * fRec48[1])));
		double fTemp29 = 1.333521432 * fTemp22 * (1.0 - 0.33333333333333331 * mydsp_faustpower2_f(fTemp22)) + 1.584893192 * (fTemp25 * (1.0 - 0.33333333333333331 * mydsp_faustpower2_f(fTemp25)) + fTemp27 * (1.0 - 0.33333333333333331 * mydsp_faustpower2_f(fTemp27))) + 1.2589412 * fTemp28 * (1.0 - 0.33333333333333331 * mydsp_faustpower2_f(fTemp28));
		fVec6[0] = fTemp29;
		fRec32[0] = 0.0 - fConst6 * (fConst7 * fRec32[1] - (fTemp29 + fVec6[1]));
		double fTemp30 = fTemp15 * (fTemp16 * (fSlow4 * (0.099750623441396499 * (1.0 - std::fabs(0.024937655860349125 * fTemp16 * fTemp15)) + -0.024937655860349125) + 0.024937655860349125) + fSlow6 * fRec31[0]) + 0.5 * fTemp18 * (1.0 - 0.33333333333333331 * mydsp_faustpower2_f(fTemp18)) + fSlow8 * fRec32[0];
		fVec7[0] = fTemp30;
		fRec27[0] = 0.93028479253239138 * (fTemp30 + fVec7[1]) - 0.86056958506478287 * fRec27[1];
		fRec26[0] = fRec27[0] - (1.8405051250752198 * fRec26[1] + 0.86129424393186271 * fRec26[2]);
		double fTemp31 = 0.92544984225177063 * (fRec26[0] + fRec26[2]);
		double fTemp32 = 1.8508996845035413 * fRec26[1];
		double fTemp33 = (fTemp32 + fTemp31) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp33;
		fRec50[0] = fConst71 * (2700.0 * (fTemp33 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp31 + fRec50[0] + fTemp32 + -1.2572399999999999))) + -83.435555555555567;
		fRec24[0] = 0.10000000000000001 * (fConst4 * fRec25[0] + fConst11 * fRec25[1]) - fConst12 * fRec24[1];
		fRec51[0] = fConst14 * (fConst15 * fRec51[1] + 0.10000000000000001 * (fRec25[0] - fRec25[1]));
		fRec17[0] = ((iSlow1) ? fRec23[0] : fRec18[0]) - ((iSlow1) ? fRec51[0] : fRec24[0]);
		fRec52[0] = fSlow13 + 0.999 * fRec52[1];
		double fTemp34 = fRec17[0] * fRec52[0];
		fVec9[0] = fTemp34;
		fRec16[0] = 0.0 - fConst6 * (fConst7 * fRec16[1] - (fTemp34 + fVec9[1]));
		...
		double fTemp35 = 0.92544984225177063 * (fRec14[0] + fRec14[2]);
		double fTemp36 = 1.8508996845035413 * fRec14[1];
		double fTemp37 = (fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp37;
		fRec53[0] = fConst17 * (1500.0 * (fTemp37 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp35 + fRec53[0] + fTemp36 + -0.77616200000000002))) + -78.255866666666662;
		fRec12[0] = 0.10000000000000001 * (fConst4 * fRec13[0] + fConst11 * fRec13[1]) - fConst12 * fRec12[1];
		fRec54[0] = fConst14 * (fConst15 * fRec54[1] + 0.10000000000000001 * (fRec13[0] - fRec13[1]));
		fRec5[0] = ((iSlow1) ? fRec11[0] : fRec6[0]) + ((iSlow1) ? fRec54[0] : fRec12[0]);
		...
		double fTemp38 = 0.92544984225177063 * (fRec2[0] + fRec2[2]);
		double fTemp39 = 1.8508996845035413 * fRec2[1];
		double fTemp40 = (fTemp39 + fTemp38) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0);
		fVec11[0] = fTemp40;
		fRec55[0] = fConst9 * (820.0 * (fTemp40 + fVec11[1]) - fConst10 * fRec55[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp38 + fRec55[0] + fTemp39 + -0.44548700000000002))) + -75.672317073170731;
		fRec0[0] = 0.10000000000000001 * (fConst4 * fRec1[0] + fConst11 * fRec1[1]) - fConst12 * fRec0[1];
		fRec56[0] = fConst14 * (fConst15 * fRec56[1] + 0.10000000000000001 * (fRec1[0] - fRec1[1]));
