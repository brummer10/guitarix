...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (9.45e-07 * fSlow15 + fSlow1 * (4.2808000000000006e-07 - fSlow2) + fSlow0 * (1.0027e-05 * fSlow1 + 2.6324999999999998e-06) + 1.0530000000000001e-07);
	double fSlow17 = fSlow1 * (fSlow5 + 3.78e-11) + fSlow15 * (fSlow4 + 2.7e-10 * (1.0 - fSlow1));
