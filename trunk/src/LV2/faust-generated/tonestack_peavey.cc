...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (2.0196000000000004e-07 * fSlow15 + fSlow1 * (2.2567600000000002e-07 - fSlow2) + fSlow0 * (2.4497000000000004e-06 * fSlow1 + 5.732100000000001e-07) + 4.585680000000001e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.6622496000000003e-11) + fSlow15 * (fSlow4 + 4.4431200000000016e-11 * (1.0 - fSlow1));
