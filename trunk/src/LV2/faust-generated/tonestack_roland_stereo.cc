...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (2.829e-07 * fSlow15 + fSlow1 * (3.2176800000000005e-07 - fSlow2) + fSlow0 * (6.8142000000000025e-06 * fSlow1 + 7.779000000000002e-07) + 3.1116000000000005e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.8898704000000002e-11) + fSlow15 * (fSlow4 + 6.656760000000001e-11 * (1.0 - fSlow1));
