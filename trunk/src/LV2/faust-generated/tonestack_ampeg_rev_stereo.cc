...
#define fVslider2 (*fVslider2_)
	...
	double fSlow1 = 0.00011849250000000002 * fSlow0;
	double fSlow2 = double(fVslider1);
	double fSlow3 = 4.7047000000000006e-07 * fSlow2;
	double fSlow4 = 1.1761750000000001e-05 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -4.217780000000001e-06 - fSlow3) + fSlow1 + 5.107200000000001e-06);
	double fSlow6 = 2.9375000000000002e-09 * fSlow0;
	double fSlow7 = 1.645e-11 * fSlow2;
	double fSlow8 = 4.1125e-10 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -1.0105e-10) + fSlow6 + 1.175e-10);
	double fSlow10 = 0.025025000000000002 * fSlow0;
	double fSlow11 = 0.00047000000000000004 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.015726);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 1.175e-10 * fSlow18) + fSlow2 * (fSlow8 + 1.645e-11 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (3.675000000000001e-07 * fSlow19 + fSlow2 * (4.8222e-07 - fSlow3) + fSlow0 * (1.1761750000000001e-05 * fSlow2 + 9.925e-07) + 3.9700000000000005e-08);
	double fSlow23 = fConst0 * (fSlow10 + fSlow11 + 2.5e-05 * fSlow19 + 0.001001);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-4.217780000000001e-06 - fSlow3)) + 5.107200000000001e-06) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-1.0105e-10 - fSlow7)) + 1.175e-10)));
