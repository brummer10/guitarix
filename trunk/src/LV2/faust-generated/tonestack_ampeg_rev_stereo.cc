...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (3.675000000000001e-07 * fSlow15 + fSlow1 * (4.8222e-07 - fSlow2) + fSlow0 * (1.1761750000000001e-05 * fSlow1 + 9.925e-07) + 3.9700000000000005e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.645e-11) + fSlow15 * (fSlow4 + 1.175e-10 * (1.0 - fSlow1));
