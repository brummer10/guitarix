...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp34 = ((fTemp33 + fTemp32) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp34;
		fRec48[0] = (fConst71 * ((2700.0 * (fTemp34 + fVec8[1])) - (fConst72 * fRec48[1])));
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp32 + (fRec48[0] + fTemp33)) + -1.2572399999999999)))) + -83.435555555555567);
		...
		double fTemp38 = ((fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp38;
		fRec50[0] = (fConst11 * ((1500.0 * (fTemp38 + fVec10[1])) - (fConst12 * fRec50[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp36 + (fRec50[0] + fTemp37)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp39 + (fRec51[0] + fTemp40)) + -0.44548700000000002)))) + -75.672317073170731);
		...
		double fTemp44 = ((fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec60[1]))) + 100000.0));
		fVec12[0] = fTemp44;
		fRec63[0] = (fConst8 * ((820.0 * (fTemp44 + fVec12[1])) - (fConst9 * fRec63[1])));
		fRec60[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp42 + (fRec63[0] + fTemp43)) + -0.44548700000000002)))) + -75.672317073170731);
		...
		double fTemp47 = ((fTemp46 + fTemp45) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec71[1]))) + 100000.0));
		fVec13[0] = fTemp47;
		fRec74[0] = (fConst11 * ((1500.0 * (fTemp47 + fVec13[1])) - (fConst12 * fRec74[1])));
		fRec71[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp45 + (fRec74[0] + fTemp46)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		double fTemp74 = ((fTemp73 + fTemp72) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec76[1]))) + 100000.0));
		fVec20[0] = fTemp74;
		fRec100[0] = (fConst71 * ((2700.0 * (fTemp74 + fVec20[1])) - (fConst72 * fRec100[1])));
		fRec76[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp72 + (fRec100[0] + fTemp73)) + -1.2572399999999999)))) + -83.435555555555567);
		...
		double fTemp78 = ((fTemp77 + fTemp76) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec65[1]))) + 100000.0));
		fVec22[0] = fTemp78;
		fRec101[0] = (fConst11 * ((1500.0 * (fTemp78 + fVec22[1])) - (fConst12 * fRec101[1])));
		fRec65[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp76 + (fRec101[0] + fTemp77)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		double fTemp81 = ((fTemp80 + fTemp79) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec54[1]))) + 100000.0));
		fVec23[0] = fTemp81;
		fRec102[0] = (fConst8 * ((820.0 * (fTemp81 + fVec23[1])) - (fConst9 * fRec102[1])));
		fRec54[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp79 + (fRec102[0] + fTemp80)) + -0.44548700000000002)))) + -75.672317073170731);
		fRec53[0] = (fConst2 * ((fConst3 * fRec53[1]) + (0.10000000000000001 * (fRec54[0] - fRec54[1]))));
		output1[i0] = FAUSTFLOAT((fRec52[0] * fRec53[0]));
		fRec9[1] = fRec9[0];
		fRec8[2] = fRec8[1];
		fRec8[1] = fRec8[0];
		fVec0[1] = fVec0[0];
