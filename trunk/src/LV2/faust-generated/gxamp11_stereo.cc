...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec5[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec6[0] + fRec6[2])) + (fRec8[0] + (1.8508996845035413 * fRec6[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		...
		fRec14[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec15[0] + fRec15[2])) + (fRec17[0] + (1.8508996845035413 * fRec15[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec43[0] + (1.8508996845035413 * fRec19[1]))) + -1.2572399999999999)))) + -83.435555555555567);
		fRec13[0] = (0.10000000000000001 * (fRec14[0] - fRec18[0]));
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec45[0] + (1.8508996845035413 * fRec10[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		fRec4[0] = (0.10000000000000001 * (fRec5[0] + fRec9[0]));
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec46[0] + (1.8508996845035413 * fRec1[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		fRec47[0] = (fSlow12 + (0.999 * fRec47[1]));
		output0[i] = FAUSTFLOAT((0.10000000000000001 * (fRec0[0] * fRec47[0])));
		...
		fRec53[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec54[0] + fRec54[2])) + (fRec56[0] + (1.8508996845035413 * fRec54[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		...
		fRec62[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec63[0] + fRec63[2])) + (fRec65[0] + (1.8508996845035413 * fRec63[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		...
		fRec66[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec67[0] + fRec67[2])) + (fRec90[0] + (1.8508996845035413 * fRec67[1]))) + -1.2572399999999999)))) + -83.435555555555567);
		fRec61[0] = (0.10000000000000001 * (fRec62[0] - fRec66[0]));
		...
		fRec57[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec58[0] + fRec58[2])) + (fRec91[0] + (1.8508996845035413 * fRec58[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		fRec52[0] = (0.10000000000000001 * (fRec53[0] + fRec57[0]));
		...
		fRec48[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec49[0] + fRec49[2])) + (fRec92[0] + (1.8508996845035413 * fRec49[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		output1[i] = FAUSTFLOAT((0.10000000000000001 * (fRec47[0] * fRec48[0])));
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
		fRec6[1] = fRec6[0];
