...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec23[0] = ((0.9999 * fRec23[1]) + (9.999999999998899e-05 * fTemp1));
		double fTemp2 = max(fRec23[0], fTemp1);
		fVec0[IOTA&32767] = fTemp2;
		fRec22[0] = ((fVec0[IOTA&32767] + fRec22[1]) - fVec0[(IOTA-iConst27)&32767]);
		fRec21[0] = ((0.999 * fRec21[1]) + (fConst28 * fRec22[0]));
		double fTemp3 = max((double)-1, min(-0.01, (fVec0[IOTA&32767] - (1.0 + (1.02 * fRec21[0])))));
		...
		double fTemp13 = (0.024937655860349125 * (fRec24[0] * fTemp12));
		fRec20[0] = (fTemp13 - (fConst26 * ((fConst24 * fRec20[2]) + (fConst22 * fRec20[1]))));
		double fTemp14 = (fRec20[2] + (fRec20[0] + (2 * fRec20[1])));
		fVec1[0] = fTemp14;
		fRec19[0] = ((fConst33 * fRec19[1]) + (fConst32 * ((fConst29 * fVec1[0]) + (fConst30 * fVec1[1]))));
		fRec18[0] = ((fConst36 * fRec18[1]) + (fConst35 * (fRec19[0] + fRec19[1])));
		fRec17[0] = (fRec18[0] - (fConst20 * ((fConst18 * fRec17[2]) + (fConst16 * fRec17[1]))));
		double fTemp15 = (fRec17[2] + (fRec17[0] + (2 * fRec17[1])));
		fVec2[0] = fTemp15;
		fRec16[0] = ((fConst39 * fRec16[1]) + (fConst38 * (fVec2[0] + fVec2[1])));
		fRec15[0] = (fRec16[0] - (fConst13 * ((fConst11 * fRec15[2]) + (fConst9 * fRec15[1]))));
		double fTemp16 = (fRec15[2] + (fRec15[0] + (2 * fRec15[1])));
		fVec3[0] = fTemp16;
		fRec14[0] = ((fConst42 * fRec14[1]) + (fConst41 * (fVec3[0] + fVec3[1])));
		fRec13[0] = (fRec14[0] - (fConst6 * ((fConst5 * fRec13[2]) + (fConst3 * fRec13[1]))));
		double fTemp17 = max((double)-1, min((double)1, (fSlow4 * (fRec13[2] + (fRec13[0] + (2 * fRec13[1]))))));
		double fTemp18 = (fConst3 * fRec25[1]);
		fRec27[0] = ((fConst39 * fRec27[1]) + (fConst38 * ((fConst10 * fVec2[0]) + (fConst45 * fVec2[1]))));
		fRec26[0] = (fRec27[0] - (fConst13 * ((fConst11 * fRec26[2]) + (fConst9 * fRec26[1]))));
		fRec25[0] = ((fConst13 * (((fConst8 * fRec26[0]) + (fConst46 * fRec26[1])) + (fConst8 * fRec26[2]))) - (fConst44 * ((fConst43 * fRec25[2]) + fTemp18)));
		double fTemp19 = max((double)-1, min((double)1, (fSlow5 * (fRec25[2] + (fConst44 * (fTemp18 + (fConst43 * fRec25[0])))))));
		double fTemp20 = (fConst3 * fRec28[1]);
		double fTemp21 = (fConst9 * fRec29[1]);
		fRec31[0] = ((fConst36 * fRec31[1]) + (fConst35 * ((fConst17 * fRec19[0]) + (fConst49 * fRec19[1]))));
		fRec30[0] = (fRec31[0] - (fConst20 * ((fConst18 * fRec30[2]) + (fConst16 * fRec30[1]))));
		fRec29[0] = ((fConst20 * (((fConst15 * fRec30[0]) + (fConst50 * fRec30[1])) + (fConst15 * fRec30[2]))) - (fConst48 * ((fConst47 * fRec29[2]) + fTemp21)));
		fRec28[0] = ((fRec29[2] + (fConst48 * (fTemp21 + (fConst47 * fRec29[0])))) - (fConst44 * ((fConst43 * fRec28[2]) + fTemp20)));
		double fTemp22 = max((double)-1, min((double)1, (fSlow6 * (fRec28[2] + (fConst44 * (fTemp20 + (fConst43 * fRec28[0])))))));
		fRec33[0] = ((fConst42 * fRec33[1]) + (fConst41 * ((fConst4 * fVec3[0]) + (fConst51 * fVec3[1]))));
		fRec32[0] = (fRec33[0] - (fConst6 * ((fConst5 * fRec32[2]) + (fConst3 * fRec32[1]))));
		double fTemp23 = max((double)-1, min((double)1, (fSlow8 * (((fConst2 * fRec32[0]) + (fConst52 * fRec32[1])) + (fConst2 * fRec32[2])))));
		...
		fVec4[0] = fTemp24;
		fRec12[0] = ((fConst56 * fRec12[1]) + (fConst55 * (fVec4[0] + fVec4[1])));
		double fTemp25 = (1e-15 + (0.027 * fRec11[1]));
		fVec5[0] = fTemp25;
		fRec34[0] = ((fConst60 * fRec34[1]) + (fConst59 * (fVec5[0] + fVec5[1])));
		double fTemp26 = max((double)-1, min((double)1, (fSlow7 * max(-0.7, min(0.7, fTemp13)))));
		double fTemp27 = (fSlow11 * fRec24[0]);
		double fTemp28 = (1 - fRec24[0]);
		fRec11[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp12 * ((fTemp28 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp28 * fTemp12))))) - 0.024937655860349125)))) + fTemp27)) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec34[0] + (fSlow10 * fRec12[0])))) - 1.2572399999999988)) - 83.43555555555557);
		fRec10[0] = ((fConst33 * fRec10[1]) + (fConst61 * ((fConst29 * fRec11[0]) + (fConst30 * fRec11[1]))));
		double fTemp29 = (1e-15 + (0.015 * fRec36[1]));
		fVec6[0] = fTemp29;
		fRec37[0] = ((fConst65 * fRec37[1]) + (fConst64 * (fVec6[0] + fVec6[1])));
		fRec36[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec37[0] + fRec9[1]) - 0.776161999999999)) - 78.25586666666666);
		fRec35[0] = ((fConst33 * fRec35[1]) + (fConst61 * ((fConst29 * fRec36[0]) + (fConst30 * fRec36[1]))));
		fRec9[0] = (fRec35[0] - fRec10[0]);
		double fTemp30 = (fRec9[0] * fRec8[0]);
		fVec7[0] = fTemp30;
		fRec7[0] = ((fConst56 * fRec7[1]) + (fConst55 * (fVec7[0] + fVec7[1])));
		double fTemp31 = (1e-15 + (0.015 * fRec6[1]));
		fVec8[0] = fTemp31;
		fRec38[0] = ((fConst65 * fRec38[1]) + (fConst64 * (fVec8[0] + fVec8[1])));
		fRec6[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec38[0] + fRec7[0]) - 0.776161999999999)) - 78.25586666666666);
		...
		fRec40[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec41[0] + fRec4[1]) - 0.445486999999999)) - 75.67231707317073);
		fRec39[0] = ((fConst33 * fRec39[1]) + (fConst61 * ((fConst29 * fRec40[0]) + (fConst30 * fRec40[1]))));
		fRec4[0] = (fRec39[0] + fRec5[0]);
		fRec3[0] = ((fConst56 * fRec3[1]) + (fConst55 * (fRec4[0] + fRec4[1])));
		double fTemp33 = (1e-15 + (0.0082 * fRec2[1]));
		fVec10[0] = fTemp33;
		fRec42[0] = ((fConst69 * fRec42[1]) + (fConst68 * (fVec10[0] + fVec10[1])));
		fRec2[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec42[0] + fRec3[0]) - 0.445486999999999)) - 75.67231707317073);
		...
		fRec54[0] = ((fVec11[IOTA&32767] + fRec54[1]) - fVec11[(IOTA-iConst27)&32767]);
		fRec53[0] = ((0.999 * fRec53[1]) + (fConst28 * fRec54[0]));
		...
		double fTemp47 = (0.024937655860349125 * (fRec24[0] * fTemp46));
		double fTemp48 = max((double)-1, min((double)1, (fSlow7 * max(-0.7, min(0.7, fTemp47)))));
		double fTemp49 = (1e-15 + (0.027 * fRec52[1]));
		fVec12[0] = fTemp49;
		fRec56[0] = ((fConst60 * fRec56[1]) + (fConst59 * (fVec12[0] + fVec12[1])));
		fRec65[0] = (fTemp47 - (fConst26 * ((fConst24 * fRec65[2]) + (fConst22 * fRec65[1]))));
		double fTemp50 = (fRec65[2] + (fRec65[0] + (2 * fRec65[1])));
		fVec13[0] = fTemp50;
		fRec64[0] = ((fConst33 * fRec64[1]) + (fConst32 * ((fConst29 * fVec13[0]) + (fConst30 * fVec13[1]))));
		fRec63[0] = ((fConst36 * fRec63[1]) + (fConst35 * (fRec64[0] + fRec64[1])));
		fRec62[0] = (fRec63[0] - (fConst20 * ((fConst18 * fRec62[2]) + (fConst16 * fRec62[1]))));
		double fTemp51 = (fRec62[2] + (fRec62[0] + (2 * fRec62[1])));
		fVec14[0] = fTemp51;
		fRec61[0] = ((fConst39 * fRec61[1]) + (fConst38 * (fVec14[0] + fVec14[1])));
		fRec60[0] = (fRec61[0] - (fConst13 * ((fConst11 * fRec60[2]) + (fConst9 * fRec60[1]))));
		double fTemp52 = (fRec60[2] + (fRec60[0] + (2 * fRec60[1])));
		fVec15[0] = fTemp52;
		fRec59[0] = ((fConst42 * fRec59[1]) + (fConst41 * (fVec15[0] + fVec15[1])));
		fRec58[0] = (fRec59[0] - (fConst6 * ((fConst5 * fRec58[2]) + (fConst3 * fRec58[1]))));
		double fTemp53 = max((double)-1, min((double)1, (fSlow4 * (fRec58[2] + (fRec58[0] + (2 * fRec58[1]))))));
		double fTemp54 = (fConst3 * fRec66[1]);
		fRec68[0] = ((fConst39 * fRec68[1]) + (fConst38 * ((fConst10 * fVec14[0]) + (fConst45 * fVec14[1]))));
		fRec67[0] = (fRec68[0] - (fConst13 * ((fConst11 * fRec67[2]) + (fConst9 * fRec67[1]))));
		fRec66[0] = ((fConst13 * (((fConst8 * fRec67[0]) + (fConst46 * fRec67[1])) + (fConst8 * fRec67[2]))) - (fConst44 * ((fConst43 * fRec66[2]) + fTemp54)));
		double fTemp55 = max((double)-1, min((double)1, (fSlow5 * (fRec66[2] + (fConst44 * (fTemp54 + (fConst43 * fRec66[0])))))));
		double fTemp56 = (fConst3 * fRec69[1]);
		double fTemp57 = (fConst9 * fRec70[1]);
		fRec72[0] = ((fConst36 * fRec72[1]) + (fConst35 * ((fConst17 * fRec64[0]) + (fConst49 * fRec64[1]))));
		fRec71[0] = (fRec72[0] - (fConst20 * ((fConst18 * fRec71[2]) + (fConst16 * fRec71[1]))));
		fRec70[0] = ((fConst20 * (((fConst15 * fRec71[0]) + (fConst50 * fRec71[1])) + (fConst15 * fRec71[2]))) - (fConst48 * ((fConst47 * fRec70[2]) + fTemp57)));
		fRec69[0] = ((fRec70[2] + (fConst48 * (fTemp57 + (fConst47 * fRec70[0])))) - (fConst44 * ((fConst43 * fRec69[2]) + fTemp56)));
		double fTemp58 = max((double)-1, min((double)1, (fSlow6 * (fRec69[2] + (fConst44 * (fTemp56 + (fConst43 * fRec69[0])))))));
		fRec74[0] = ((fConst42 * fRec74[1]) + (fConst41 * ((fConst4 * fVec15[0]) + (fConst51 * fVec15[1]))));
		fRec73[0] = (fRec74[0] - (fConst6 * ((fConst5 * fRec73[2]) + (fConst3 * fRec73[1]))));
		double fTemp59 = max((double)-1, min((double)1, (fSlow8 * (((fConst2 * fRec73[0]) + (fConst52 * fRec73[1])) + (fConst2 * fRec73[2])))));
		...
		fVec16[0] = fTemp60;
		fRec57[0] = ((fConst56 * fRec57[1]) + (fConst55 * (fVec16[0] + fVec16[1])));
		fRec52[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp46 * (fTemp27 + (fTemp28 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp28 * fTemp46))))) - 0.024937655860349125)))))) + ((fSlow10 * fRec57[0]) + (fRec56[0] + (0.5 * (fTemp48 * (1 - (0.3333333333333333 * faustpower<2>(fTemp48)))))))) - 1.2572399999999988)) - 83.43555555555557);
		fRec51[0] = ((fConst33 * fRec51[1]) + (fConst61 * ((fConst29 * fRec52[0]) + (fConst30 * fRec52[1]))));
		double fTemp61 = (1e-15 + (0.015 * fRec76[1]));
		fVec17[0] = fTemp61;
		fRec77[0] = ((fConst65 * fRec77[1]) + (fConst64 * (fVec17[0] + fVec17[1])));
		fRec76[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec77[0] + fRec50[1]) - 0.776161999999999)) - 78.25586666666666);
		fRec75[0] = ((fConst33 * fRec75[1]) + (fConst61 * ((fConst29 * fRec76[0]) + (fConst30 * fRec76[1]))));
		fRec50[0] = (fRec75[0] - fRec51[0]);
		double fTemp62 = (fRec8[0] * fRec50[0]);
		fVec18[0] = fTemp62;
		fRec49[0] = ((fConst56 * fRec49[1]) + (fConst55 * (fVec18[0] + fVec18[1])));
		double fTemp63 = (1e-15 + (0.015 * fRec48[1]));
		fVec19[0] = fTemp63;
		fRec78[0] = ((fConst65 * fRec78[1]) + (fConst64 * (fVec19[0] + fVec19[1])));
		fRec48[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec78[0] + fRec49[0]) - 0.776161999999999)) - 78.25586666666666);
		...
		fRec80[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec81[0] + fRec46[1]) - 0.445486999999999)) - 75.67231707317073);
		fRec79[0] = ((fConst33 * fRec79[1]) + (fConst61 * ((fConst29 * fRec80[0]) + (fConst30 * fRec80[1]))));
		fRec46[0] = (fRec79[0] + fRec47[0]);
		fRec45[0] = ((fConst56 * fRec45[1]) + (fConst55 * (fRec46[0] + fRec46[1])));
		double fTemp65 = (1e-15 + (0.0082 * fRec44[1]));
		fVec21[0] = fTemp65;
		fRec82[0] = ((fConst69 * fRec82[1]) + (fConst68 * (fVec21[0] + fVec21[1])));
		fRec44[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec82[0] + fRec45[0]) - 0.445486999999999)) - 75.67231707317073);
		fRec43[0] = ((fConst33 * fRec43[1]) + (fConst61 * ((fConst29 * fRec44[0]) + (fConst30 * fRec44[1]))));
