...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp2 = (fTemp0 + fTemp1) / (Ranode(TUBE_TABLE_12AU7_250k, fRec7[1]) + 1e+05);
		fVec0[0] = fTemp2;
		fRec10[0] = fConst7 * (8.2e+02 * (fTemp2 + fVec0[1]) - fConst6 * fRec10[1]);
		fRec7[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp1 + fRec10[0] + fTemp0 + -0.445487) + -75.67231707317073;
		fRec6[0] = 0.1 * (fConst8 * fRec7[0] + fConst9 * fRec7[1]) - fConst4 * fRec6[1];
		fRec11[0] = fConst12 * (fConst11 * fRec11[1] + 0.1 * (fRec7[0] - fRec7[1]));
		...
		double fTemp31 = (fTemp29 + fTemp30) / (Ranode(TUBE_TABLE_12AU7_68k, fRec20[1]) + 1e+05);
		fVec7[0] = fTemp31;
		fRec45[0] = fConst69 * (2.7e+03 * (fTemp31 + fVec7[1]) - fConst68 * fRec45[1]);
		fRec20[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp30 + fRec45[0] + fTemp29 + -1.25724) + -83.43555555555557;
		fRec19[0] = 0.1 * (fConst8 * fRec20[0] + fConst9 * fRec20[1]) - fConst4 * fRec19[1];
		fRec46[0] = fConst12 * (fConst11 * fRec46[1] + 0.1 * (fRec20[0] - fRec20[1]));
		...
		double fTemp34 = (fTemp32 + fTemp33) / (Ranode(TUBE_TABLE_12AU7_250k, fRec48[1]) + 1e+05);
		fVec8[0] = fTemp34;
		fRec51[0] = fConst72 * (1.5e+03 * (fTemp34 + fVec8[1]) - fConst71 * fRec51[1]);
		fRec48[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp33 + fRec51[0] + fTemp32 + -0.776162) + -78.25586666666666;
		fRec47[0] = 0.1 * (fConst8 * fRec48[0] + fConst9 * fRec48[1]) - fConst4 * fRec47[1];
		fRec52[0] = fConst12 * (fConst11 * fRec52[1] + 0.1 * (fRec48[0] - fRec48[1]));
		fRec18[0] = ((iSlow1) ? fRec52[0] : fRec47[0]) - ((iSlow1) ? fRec46[0] : fRec19[0]);
		...
		double fTemp38 = (fTemp36 + fTemp37) / (Ranode(TUBE_TABLE_12AU7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp38;
		fRec53[0] = fConst72 * (1.5e+03 * (fTemp38 + fVec10[1]) - fConst71 * fRec53[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp37 + fRec53[0] + fTemp36 + -0.776162) + -78.25586666666666;
		fRec12[0] = 0.1 * (fConst8 * fRec13[0] + fConst9 * fRec13[1]) - fConst4 * fRec12[1];
		fRec54[0] = fConst12 * (fConst11 * fRec54[1] + 0.1 * (fRec13[0] - fRec13[1]));
		fRec5[0] = ((iSlow1) ? fRec54[0] : fRec12[0]) + ((iSlow1) ? fRec11[0] : fRec6[0]);
		...
		double fTemp41 = (fTemp39 + fTemp40) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp41;
		fRec55[0] = fConst7 * (8.2e+02 * (fTemp41 + fVec11[1]) - fConst6 * fRec55[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp40 + fRec55[0] + fTemp39 + -0.445487) + -75.67231707317073;
		fRec0[0] = 0.1 * (fConst8 * fRec1[0] + fConst9 * fRec1[1]) - fConst4 * fRec0[1];
		fRec56[0] = fConst12 * (fConst11 * fRec56[1] + 0.1 * (fRec1[0] - fRec1[1]));
		...
		double fTemp44 = (fTemp42 + fTemp43) / (Ranode(TUBE_TABLE_12AU7_250k, fRec65[1]) + 1e+05);
		fVec12[0] = fTemp44;
		fRec68[0] = fConst7 * (8.2e+02 * (fTemp44 + fVec12[1]) - fConst6 * fRec68[1]);
		fRec65[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp43 + fRec68[0] + fTemp42 + -0.445487) + -75.67231707317073;
		fRec64[0] = 0.1 * (fConst8 * fRec65[0] + fConst9 * fRec65[1]) - fConst4 * fRec64[1];
		fRec69[0] = fConst12 * (fConst11 * fRec69[1] + 0.1 * (fRec65[0] - fRec65[1]));
		...
		double fTemp71 = (fTemp69 + fTemp70) / (Ranode(TUBE_TABLE_12AU7_68k, fRec77[1]) + 1e+05);
		fVec19[0] = fTemp71;
		fRec101[0] = fConst69 * (2.7e+03 * (fTemp71 + fVec19[1]) - fConst68 * fRec101[1]);
		fRec77[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp70 + fRec101[0] + fTemp69 + -1.25724) + -83.43555555555557;
		fRec76[0] = 0.1 * (fConst8 * fRec77[0] + fConst9 * fRec77[1]) - fConst4 * fRec76[1];
		fRec102[0] = fConst12 * (fConst11 * fRec102[1] + 0.1 * (fRec77[0] - fRec77[1]));
		...
		double fTemp74 = (fTemp72 + fTemp73) / (Ranode(TUBE_TABLE_12AU7_250k, fRec104[1]) + 1e+05);
		fVec20[0] = fTemp74;
		fRec107[0] = fConst72 * (1.5e+03 * (fTemp74 + fVec20[1]) - fConst71 * fRec107[1]);
		fRec104[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp73 + fRec107[0] + fTemp72 + -0.776162) + -78.25586666666666;
		fRec103[0] = 0.1 * (fConst8 * fRec104[0] + fConst9 * fRec104[1]) - fConst4 * fRec103[1];
		fRec108[0] = fConst12 * (fConst11 * fRec108[1] + 0.1 * (fRec104[0] - fRec104[1]));
		fRec75[0] = ((iSlow1) ? fRec108[0] : fRec103[0]) - ((iSlow1) ? fRec102[0] : fRec76[0]);
		...
		double fTemp78 = (fTemp76 + fTemp77) / (Ranode(TUBE_TABLE_12AU7_250k, fRec71[1]) + 1e+05);
		fVec22[0] = fTemp78;
		fRec109[0] = fConst72 * (1.5e+03 * (fTemp78 + fVec22[1]) - fConst71 * fRec109[1]);
		fRec71[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp77 + fRec109[0] + fTemp76 + -0.776162) + -78.25586666666666;
		fRec70[0] = 0.1 * (fConst8 * fRec71[0] + fConst9 * fRec71[1]) - fConst4 * fRec70[1];
		fRec110[0] = fConst12 * (fConst11 * fRec110[1] + 0.1 * (fRec71[0] - fRec71[1]));
		fRec63[0] = ((iSlow1) ? fRec110[0] : fRec70[0]) + ((iSlow1) ? fRec69[0] : fRec64[0]);
		...
		double fTemp81 = (fTemp79 + fTemp80) / (Ranode(TUBE_TABLE_12AU7_250k, fRec59[1]) + 1e+05);
		fVec23[0] = fTemp81;
		fRec111[0] = fConst7 * (8.2e+02 * (fTemp81 + fVec23[1]) - fConst6 * fRec111[1]);
		fRec59[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp80 + fRec111[0] + fTemp79 + -0.445487) + -75.67231707317073;
		fRec58[0] = 0.1 * (fConst8 * fRec59[0] + fConst9 * fRec59[1]) - fConst4 * fRec58[1];
		fRec112[0] = fConst12 * (fConst11 * fRec112[1] + 0.1 * (fRec59[0] - fRec59[1]));
