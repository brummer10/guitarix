...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec66[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec90[0] + (0.9254498422517706 * (fRec67[0] + (fRec67[2] + (2.0 * fRec67[1]))))) - 1.25724)) - 83.43555555555557);
		...
		fRec92[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec95[0] + (0.9254498422517706 * (fRec93[0] + (fRec93[2] + (2.0 * fRec93[1]))))) - 0.776162)) - 78.25586666666666);
		...
		fRec60[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec96[0] + (0.9254498422517706 * (fRec61[0] + (fRec61[2] + (2.0 * fRec61[1]))))) - 0.776162)) - 78.25586666666666);
		...
		fRec98[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec101[0] + (0.9254498422517706 * (fRec99[0] + (fRec99[2] + (2.0 * fRec99[1]))))) - 0.445487)) - 75.67231707317073);
		...
		fRec54[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec102[0] + (0.9254498422517706 * (fRec55[0] + (fRec55[2] + (2.0 * fRec55[1]))))) - 0.445487)) - 75.67231707317073);
