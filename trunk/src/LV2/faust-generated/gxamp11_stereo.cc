...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp34 = (fTemp33 + fTemp32) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp34;
		fRec50[0] = fConst71 * (2700.0 * (fTemp34 + fVec8[1]) - fConst72 * fRec50[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp32 + fRec50[0] + fTemp33 + -1.2572399999999999))) + -83.435555555555567;
		...
		double fTemp38 = (fTemp37 + fTemp36) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp38;
		fRec53[0] = fConst17 * (1500.0 * (fTemp38 + fVec10[1]) - fConst18 * fRec53[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp36 + fRec53[0] + fTemp37 + -0.77616200000000002))) + -78.255866666666662;
		...
		double fTemp41 = (fTemp40 + fTemp39) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0);
		fVec11[0] = fTemp41;
		fRec55[0] = fConst9 * (820.0 * (fTemp41 + fVec11[1]) - fConst10 * fRec55[1]);
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp39 + fRec55[0] + fTemp40 + -0.44548700000000002))) + -75.672317073170731;
		...
		double fTemp44 = (fTemp43 + fTemp42) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec65[1]))) + 100000.0);
		fVec12[0] = fTemp44;
		fRec68[0] = fConst9 * (820.0 * (fTemp44 + fVec12[1]) - fConst10 * fRec68[1]);
		fRec65[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp42 + fRec68[0] + fTemp43 + -0.44548700000000002))) + -75.672317073170731;
		fRec64[0] = 0.10000000000000001 * (fConst4 * fRec65[0] + fConst11 * fRec65[1]) - fConst12 * fRec64[1];
		fRec69[0] = fConst14 * (fConst15 * fRec69[1] + 0.10000000000000001 * (fRec65[0] - fRec65[1]));
		...
		double fTemp47 = (fTemp46 + fTemp45) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec77[1]))) + 100000.0);
		fVec13[0] = fTemp47;
		fRec80[0] = fConst17 * (1500.0 * (fTemp47 + fVec13[1]) - fConst18 * fRec80[1]);
		fRec77[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp45 + fRec80[0] + fTemp46 + -0.77616200000000002))) + -78.255866666666662;
		fRec76[0] = 0.10000000000000001 * (fConst4 * fRec77[0] + fConst11 * fRec77[1]) - fConst12 * fRec76[1];
		fRec81[0] = fConst14 * (fConst15 * fRec81[1] + 0.10000000000000001 * (fRec77[0] - fRec77[1]));
		...
		fVec14[IOTA0 & 32767] = fTemp50;
		fRec88[0] = (fTemp50 + fRec88[1]) - fVec14[(IOTA0 - iConst20) & 32767];
		...
		double fThen11 = fTemp54 / (1.0 - std::exp(-1.0 * fTemp54));
		double fElse11 = 0.0 - fTemp54 * std::exp(fTemp54);
		double fThen12 = fTemp52 * (134.00083333333336 * fTemp52 + 20.050000000000001) + 1.0;
		double fElse12 = ((fTemp54 < -50.0) ? fElse11 : fThen11);
		double fTemp55 = 0.0 - 40.100000000000001 * fTemp51;
		double fTemp56 = std::max<double>(-600.0, fTemp55);
		double fThen13 = fTemp56 / (1.0 - std::exp(-1.0 * fTemp56));
		double fElse13 = 0.0 - fTemp56 * std::exp(fTemp56);
		double fThen14 = fTemp55 * (0.083333333333333329 * fTemp55 + 0.5) + 1.0;
		double fElse14 = ((fTemp56 < -50.0) ? fElse13 : fThen13);
		double fTemp57 = ((std::fabs(fTemp53) > 0.0001) ? fElse12 : fThen12) - ((std::fabs(fTemp55) > 0.0001) ? fElse14 : fThen14);
		...
		double fTemp74 = (fTemp73 + fTemp72) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec83[1]))) + 100000.0);
		fVec20[0] = fTemp74;
		fRec107[0] = fConst71 * (2700.0 * (fTemp74 + fVec20[1]) - fConst72 * fRec107[1]);
		fRec83[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp72 + fRec107[0] + fTemp73 + -1.2572399999999999))) + -83.435555555555567;
		fRec82[0] = 0.10000000000000001 * (fConst4 * fRec83[0] + fConst11 * fRec83[1]) - fConst12 * fRec82[1];
		fRec108[0] = fConst14 * (fConst15 * fRec108[1] + 0.10000000000000001 * (fRec83[0] - fRec83[1]));
		fRec75[0] = ((iSlow1) ? fRec81[0] : fRec76[0]) - ((iSlow1) ? fRec108[0] : fRec82[0]);
		...
		double fTemp78 = (fTemp77 + fTemp76) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec71[1]))) + 100000.0);
		fVec22[0] = fTemp78;
		fRec109[0] = fConst17 * (1500.0 * (fTemp78 + fVec22[1]) - fConst18 * fRec109[1]);
		fRec71[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp76 + fRec109[0] + fTemp77 + -0.77616200000000002))) + -78.255866666666662;
		fRec70[0] = 0.10000000000000001 * (fConst4 * fRec71[0] + fConst11 * fRec71[1]) - fConst12 * fRec70[1];
		fRec110[0] = fConst14 * (fConst15 * fRec110[1] + 0.10000000000000001 * (fRec71[0] - fRec71[1]));
		fRec63[0] = ((iSlow1) ? fRec69[0] : fRec64[0]) + ((iSlow1) ? fRec110[0] : fRec70[0]);
		...
		double fTemp81 = (fTemp80 + fTemp79) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec59[1]))) + 100000.0);
		fVec23[0] = fTemp81;
		fRec111[0] = fConst9 * (820.0 * (fTemp81 + fVec23[1]) - fConst10 * fRec111[1]);
		fRec59[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp79 + fRec111[0] + fTemp80 + -0.44548700000000002))) + -75.672317073170731;
		fRec58[0] = 0.10000000000000001 * (fConst4 * fRec59[0] + fConst11 * fRec59[1]) - fConst12 * fRec58[1];
		fRec112[0] = fConst14 * (fConst15 * fRec112[1] + 0.10000000000000001 * (fRec59[0] - fRec59[1]));
