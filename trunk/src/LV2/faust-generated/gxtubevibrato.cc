...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		output0[i] = FAUSTFLOAT((fRec0[0] * (((((int(signbit(double(fTemp12))) ? double(output12ax7_negclip(double(fTemp12))) : double(output12ax7clip(double(fTemp12)))) + (int(signbit(double(fTemp19))) ? double(output12ax7_negclip(double(fTemp19))) : double(output12ax7clip(double(fTemp19))))) + (int(signbit(double(fTemp25))) ? double(output12ax7_negclip(double(fTemp25))) : double(output12ax7clip(double(fTemp25))))) + (int(signbit(double(fTemp30))) ? double(output12ax7_negclip(double(fTemp30))) : double(output12ax7clip(double(fTemp30))))) + (int(signbit(double(fTemp34))) ? double(output12ax7_negclip(double(fTemp34))) : double(output12ax7clip(double(fTemp34)))))));
		iVec0[1] = iVec0[0];
		fRec0[1] = fRec0[0];
		fVec1[1] = fVec1[0];
		fRec7[1] = fRec7[0];
