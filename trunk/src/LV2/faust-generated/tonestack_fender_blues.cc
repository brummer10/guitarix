...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (2.75e-07 * fSlow15 + fSlow1 * (3.403125000000001e-07 - fSlow2) + fSlow0 * (3.0593750000000007e-06 * fSlow1 + 6.1875e-07) + 6.1875e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 2.6468750000000002e-11) + fSlow15 * (fSlow4 + 7.562500000000001e-11 * (1.0 - fSlow1));
