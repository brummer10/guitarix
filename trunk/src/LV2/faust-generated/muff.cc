...
#define fslider1 (*fslider1_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec2[0] = fTemp3;
		fRec11[0] = ((fConst75 * fRec11[1]) + (fConst74 * (fVec2[0] + fVec2[1])));
