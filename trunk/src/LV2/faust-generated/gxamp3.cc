...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec6[0] = fTemp19;
		fRec10[0] = fConst6 * (2.0 * (fTemp19 + fVec6[1]) - fConst7 * fRec10[1]);
		...
		fRec7[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp20 + fRec36[0] + fTemp21 + -2.3148439999999999))) + -95.677066666666661;
		...
		fVec8[0] = fTemp23;
		fRec4[0] = fConst6 * (2.0 * (fTemp23 + fVec8[1]) - fConst7 * fRec4[1]);
		...
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp24 + fRec38[0] + fTemp25 + -1.3565670000000001))) + -84.564999999999998;
