...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * ((fTemp15 * (4 - (4 * fabs(fTemp15)))) - fTemp15)) + ((fSlow10 * fTemp4) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp1)))) - 3.7189619999999977)) - 112.26066666666668);
		fRec8[0] = ((fConst59 * ((fConst41 * fRec9[1]) + (fConst4 * fRec9[0]))) + (fConst6 * fRec8[1]));
		double fTemp16 = (fRec8[0] * fRec7[0]);
		fVec5[0] = fTemp16;
		fRec6[0] = ((fConst60 * (fVec5[0] + fVec5[1])) + (fConst3 * fRec6[1]));
		...
		fVec7[0] = fTemp18;
		fRec3[0] = ((fConst60 * (fVec7[0] + fVec7[1])) + (fConst3 * fRec3[1]));
