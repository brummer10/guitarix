...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp13 = (fTemp0 * (1.0 - fRec20[0]));
		double fTemp14 = (fTemp13 + 1.0000000000000001e-15);
		double fTemp15 = (((fSlow3 * fRec12[0]) + ((fTemp13 + (fSlow9 * ((4.0 * (fTemp14 * (1.0 - std::fabs(fTemp14)))) + (-1.0000000000000001e-15 - fTemp13)))) + (fSlow10 * (fTemp1 + 1.0000000000000001e-15)))) + 2.0000000000000002e-15);
		fVec4[0] = fTemp15;
		fRec11[0] = ((0.93028479253239138 * (fTemp15 + fVec4[1])) - (0.86056958506478287 * fRec11[1]));
		fRec10[0] = (fRec11[0] - ((1.8405051250752198 * fRec10[1]) + (0.86129424393186271 * fRec10[2])));
		double fTemp16 = ((0.027 * fRec9[1]) + 1.0000000000000001e-15);
		fVec5[0] = fTemp16;
		fRec31[0] = (0.0 - (fConst60 * ((fConst61 * fRec31[1]) - (fTemp16 + fVec5[1]))));
		...
		double fTemp17 = (fRec9[0] * fRec4[0]);
		fVec6[0] = fTemp17;
		fRec8[0] = (fConst2 * ((0.050000000000000003 * (fTemp17 + fVec6[1])) - (fConst3 * fRec8[1])));
		double fTemp18 = (fRec8[0] + 1.0000000000000001e-15);
		fVec7[0] = fTemp18;
		fRec7[0] = ((0.93028479253239138 * (fTemp18 + fVec7[1])) - (0.86056958506478287 * fRec7[1]));
		...
		fVec8[0] = fTemp19;
		fRec32[0] = (0.0 - (fConst63 * ((fConst64 * fRec32[1]) - (fTemp19 + fVec8[1]))));
		...
		double fTemp20 = (fRec4[0] * fRec5[0]);
		fVec9[0] = fTemp20;
		fRec3[0] = (fConst2 * ((0.050000000000000003 * (fTemp20 + fVec9[1])) - (fConst3 * fRec3[1])));
		double fTemp21 = (fRec3[0] + 1.0000000000000001e-15);
		fVec10[0] = fTemp21;
		fRec2[0] = ((0.93028479253239138 * (fTemp21 + fVec10[1])) - (0.86056958506478287 * fRec2[1]));
		fRec1[0] = (fRec2[0] - ((1.8405051250752198 * fRec1[1]) + (0.86129424393186271 * fRec1[2])));
		double fTemp22 = ((0.0082000000000000007 * fRec0[1]) + 1.0000000000000001e-15);
		fVec11[0] = fTemp22;
		fRec33[0] = (0.0 - (fConst66 * ((fConst67 * fRec33[1]) - (fTemp22 + fVec11[1]))));
