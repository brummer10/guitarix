...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * fRec12[0]) + ((fSlow6 * fTemp4) + ((fSlow4 * ((fTemp3 * (4 - (4 * fabs(fTemp3)))) - fTemp3)) + (fRec11[0] + fTemp1)))) - 3.7189619999999977)) - 112.26066666666668);
