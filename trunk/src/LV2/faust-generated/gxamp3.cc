...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp19 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp16 + (fRec34[0] + fTemp17)) + -3.7189619999999999))));
		fRec12[0] = ((fTemp19 + (0.0013773933333333334 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp19))) + 100000.0))) + -250.0);
		...
		double fTemp24 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp21 + (fRec35[0] + fTemp22)) + -2.3148439999999999))));
		fRec7[0] = ((fTemp24 + (0.0015432293333333333 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp24))) + 100000.0))) + -250.0);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.025000000000000001 * (fRec7[0] - fRec7[1]))));
		double fTemp25 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp25;
		fRec4[0] = (fConst5 * ((2.0 * (fTemp25 + fVec8[1])) - (fConst6 * fRec4[1])));
		...
		double fTemp28 = ((fTemp27 + fTemp26) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp28;
		fRec36[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec36[1])));
		double fTemp29 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp26 + (fRec36[0] + fTemp27)) + -1.3565670000000001))));
		fRec1[0] = ((fTemp29 + (0.0016543500000000002 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp29))) + 100000.0))) + -250.0);
