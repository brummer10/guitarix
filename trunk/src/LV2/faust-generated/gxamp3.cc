...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fSlow11 * ((fTemp14 * (4 - (4 * fabs(fTemp14)))) - fTemp14)) + ((fSlow10 * fTemp3) + ((fSlow9 * fRec12[0]) + (fRec11[0] + fTemp1)))) - 3.7189619999999977)) - 112.26066666666668);
