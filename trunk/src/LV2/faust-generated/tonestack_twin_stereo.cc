...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (4.410000000000001e-07 * fSlow15 + fSlow1 * (4.846640000000001e-07 - fSlow2) + fSlow0 * (1.1764100000000001e-05 * fSlow1 + 1.1910000000000001e-06) + 4.764000000000001e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 1.974e-11) + fSlow15 * (fSlow4 + 1.41e-10 * (1.0 - fSlow1));
