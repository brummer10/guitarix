...
#define fHslider7 (*fHslider7_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec13[0] = -(fConst28 * (fConst27 * fRec13[1] - fConst21 * fTemp11));
		fRec12[0] = fRec13[0] - fConst26 * (fConst24 * fRec12[2] + fConst20 * fRec12[1]);
		fRec11[0] = fConst29 * (fRec12[2] + (fRec12[0] - 2.0 * fRec12[1])) - fConst23 * (fConst22 * fRec11[2] + fConst20 * fRec11[1]);
		fRec16[0] = -(fConst28 * (fConst27 * fRec16[1] - fTemp12));
		fRec15[0] = fRec16[0] - fConst26 * (fConst24 * fRec15[2] + fConst20 * fRec15[1]);
		fRec14[0] = fConst26 * (fRec15[2] + fRec15[0] + 2.0 * fRec15[1]) - fConst23 * (fConst22 * fRec14[2] + fConst20 * fRec14[1]);
		...
		output0[i0] = FAUSTFLOAT(fTemp0 + 0.1778279410038923 * fRec18[0] * fRec17[0] * (fConst23 * (fSlow7 * (fRec14[2] + fRec14[0] + 2.0 * fRec14[1]) + fConst19 * (fRec11[0] + fRec11[2] - 2.0 * fRec11[1])) + fConst7 * (fRec8[2] + fRec8[0] + 2.0 * fRec8[1] + fSlow6 * (fRec0[0] + fRec0[2] - 2.0 * fRec0[1]))));
		...
		fRec29[0] = -(fConst28 * (fConst27 * fRec29[1] - fConst21 * fTemp14));
		fRec28[0] = fRec29[0] - fConst26 * (fConst24 * fRec28[2] + fConst20 * fRec28[1]);
		fRec27[0] = fConst29 * (fRec28[2] + (fRec28[0] - 2.0 * fRec28[1])) - fConst23 * (fConst22 * fRec27[2] + fConst20 * fRec27[1]);
		fRec32[0] = -(fConst28 * (fConst27 * fRec32[1] - fTemp15));
		fRec31[0] = fRec32[0] - fConst26 * (fConst24 * fRec31[2] + fConst20 * fRec31[1]);
		fRec30[0] = fConst26 * (fRec31[2] + fRec31[0] + 2.0 * fRec31[1]) - fConst23 * (fConst22 * fRec30[2] + fConst20 * fRec30[1]);
		...
		output1[i0] = FAUSTFLOAT(fTemp9 + 0.1778279410038923 * fRec17[0] * fRec33[0] * (fConst23 * (fSlow7 * (fRec30[2] + fRec30[0] + 2.0 * fRec30[1]) + fConst19 * (fRec27[0] + fRec27[2] - 2.0 * fRec27[1])) + fConst7 * (fRec24[2] + fRec24[0] + 2.0 * fRec24[1] + fSlow6 * (fRec21[0] + fRec21[2] - 2.0 * fRec21[1]))));
		IOTA0 = IOTA0 + 1;
		fRec6[1] = fRec6[0];
		fRec5[1] = fRec5[0];
		fRec3[1] = fRec3[0];
