...
#define fVslider2 (*fVslider2_)
	...
	double fSlow16 = fConst1 * (9.187500000000001e-07 * fSlow15 + fSlow1 * (1.2265872000000003e-07 - fSlow2) + fSlow0 * (5.6541000000000015e-06 * fSlow1 + 2.48125e-06) + 4.764000000000001e-08);
	double fSlow17 = fSlow1 * (fSlow5 + 9.4752e-12) + fSlow15 * (fSlow4 + 1.41e-10 * (1.0 - fSlow1));
