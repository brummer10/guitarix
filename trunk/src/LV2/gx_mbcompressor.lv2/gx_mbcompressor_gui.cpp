...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_mbcompressor_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_mbcompressor_GUI *self)
  {
...
void Gx_mbcompressor_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_mbcompressor_GUI::set_skin()
{
...
void Gx_mbcompressor_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_mbcompressor_#_mbcompressor_", plugin_uri) == 0)
    {
      plug_name = "_mbcompressor_";
      set_knob("nm-knob");
    }
  else
    {
...
GtkWidget* Gx_mbcompressor_GUI::make_gui()
{
...
{
  Gx_mbcompressor_GUI* self = new Gx_mbcompressor_GUI();
...
{
  Gx_mbcompressor_GUI *pluginGui = static_cast<Gx_mbcompressor_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_mbcompressor_GUI *self = static_cast<Gx_mbcompressor_GUI*>(ui);
