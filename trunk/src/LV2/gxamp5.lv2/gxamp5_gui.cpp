...
void GXPluginGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";
    ...
    if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Princeton", plugin_uri) == 0)
    {
      plugskin = "princeton.png";
      plug_name = "Princeton";
      set_knob("princeton-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#GA15", plugin_uri) == 0)
    {
      plugskin = "ga15.png";
      plug_name = "GibsonGA15";
      set_knob("chicken-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Champ", plugin_uri) == 0)
    {
      plugskin = "champ.png";
      plug_name = "Champ";
      set_knob("chicken-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Champ12", plugin_uri) == 0)
    {
      plugskin = "champ.png";
      plug_name = "Champ12";
      set_knob("chicken-knob");
