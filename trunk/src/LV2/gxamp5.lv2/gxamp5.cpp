...
typedef void (GxAmp5Mono::*run_amp_mono)
...
void GxPlugin5Mono::do_work_mono()
{
  if (cab_changed())
    {
...
void GxPlugin5Mono::set_tubesel_mono(const LV2_Descriptor*     descriptor)
{
  //Here we define different amp/tonestack/cab combinations
  if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Princeton",descriptor->URI)== 0)
    {
      printf("Princeton\n");
      _a_ptr = &GxAmp5Mono::run_12ax76v6;
      _t_ptr = &TonestackMono::run_princeton;
      cabconv.cab_count = cab_data_Princeton.ir_count;
      cabconv.cab_sr = cab_data_Princeton.ir_sr;
      cabconv.cab_data = cab_data_Princeton.ir_data;
      tubesel  = 2;
    }else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Champ",descriptor->URI)== 0)
    {
      printf("Champ\n");
      _a_ptr = &GxAmp5Mono::run_12ax76v6;
      _t_ptr = &TonestackMono::run_champ;
      cabconv.cab_count = cab_data_1x8.ir_count;
      cabconv.cab_sr = cab_data_1x8.ir_sr;
      cabconv.cab_data = cab_data_1x8.ir_data;
      tubesel  = 3;
    }else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#Champ12",descriptor->URI)== 0)
    {
      printf("Champ12\n");
      _a_ptr = &GxAmp5Mono::run_12ax76v6;
      _t_ptr = &TonestackMono::run_champ;
      ...
      tubesel  = 4;
    }else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp5#GA15",descriptor->URI)== 0)
    {
      printf("Gibson GA15\n");
      _a_ptr = &GxAmp5Mono::run_12ax76v6;
      _t_ptr = &TonestackMono::run_gibson;
      cabconv.cab_count = cab_data_1x12.ir_count;
      cabconv.cab_sr = cab_data_1x12.ir_sr;
      cabconv.cab_data = cab_data_1x12.ir_data;
      tubesel  = 5;
...
void GxPlugin5Mono::init_dsp_mono(uint32_t rate, uint32_t bufsize_)
{
  AVOIDDENORMALS();
...
void GxPlugin5Mono::connect_mono(uint32_t port,void* data)
{
...
void GxPlugin5Mono::run_dsp_mono(uint32_t n_samples)
{
  // run dsp
...
void GxPlugin5Mono::connect_all_mono_ports(uint32_t port, void* data)
{
...
work(LV2_Handle                  instance,
     ...
     const void*                 data)
{
  GxPlugin5Mono* self = (GxPlugin5Mono*)instance;
  self->do_work_mono();
            ...
            const LV2_Feature* const* features)
{
  ...
  GxPlugin5Mono *self = new GxPlugin5Mono();
  if (!self)
    {
      return NULL;
    }
