...
public:
  ...
  void        run_twin(uint32_t n_samples, float *output);
  void        run_princeton(uint32_t n_samples, float *output);
  void        run_champ(uint32_t n_samples, float *output);
  void        run_gibson(uint32_t n_samples, float *output);
