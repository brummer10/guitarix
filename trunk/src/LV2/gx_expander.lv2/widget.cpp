...
logo("Expander")
{
  ...
  make_controller_box(&m_vbox3, "KNEE", 0.0, 2e+01, 0.1, KNEE);
  make_controller_box(&m_vbox4, "THRESHOLD", -96.0, 1e+01, 0.1, THRESHOLD);
  make_controller_box(&m_vbox5, "RELEASE", 0.0, 1e+01, 0.01, RELEASE);
  make_controller_box(&m_vbox6, "ATTACK", 0.0, 1.0, 0.001, ATTACK);
