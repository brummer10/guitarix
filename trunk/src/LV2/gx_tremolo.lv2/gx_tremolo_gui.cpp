...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_tremoloGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_tremoloGUI *self)
  {
...
void Gx_tremoloGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_tremoloGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_tremolo#_tremolo", plugin_uri) == 0)
    {
      plug_name = "_tremolo";
      set_knob("nk-knob");
    }
...
GtkWidget* Gx_tremoloGUI::make_gui()
{
...
{
  Gx_tremoloGUI* self = new Gx_tremoloGUI();
...
{
  Gx_tremoloGUI *pluginGui = static_cast<Gx_tremoloGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_tremoloGUI *self = static_cast<Gx_tremoloGUI*>(ui);
