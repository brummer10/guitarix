...
protected:
  ...
  Gxw::BigKnob      m_smallknob3;
  Gxw::BigKnob      m_smallknob4;
  Gxw::BigKnob      m_smallknob5;
  Gxw::BigKnob      m_smallknob6; //!!!Was here
  Gxw::BigKnob      m_smallknob7;
  Gxw::BigKnob      m_smallknob8;
  Gxw::BigKnob      m_smallknob9;
};
