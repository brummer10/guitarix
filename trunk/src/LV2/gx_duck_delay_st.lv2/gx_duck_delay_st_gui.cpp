...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_duck_delay_stGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_duck_delay_stGUI *self)
  {
...
void Gx_duck_delay_stGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_duck_delay_stGUI::set_skin()
{
  ...
  toparse +=     "_dark-paintbox\"\n"
                 ...
                 " }\n"
                 "\n"
                 "style 'gx_head_duck_delay_st_box' \n"
                 " { \n"
                 "    fg[NORMAL] = '#c0c6d0' \n"
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_duck_delay_st_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void Gx_duck_delay_stGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_duck_delay_st_#_duck_delay_st_", plugin_uri) == 0)
    {
      plug_name = "_duck_delay_st";
      set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_duck_delay_stGUI::make_gui()
{
...
{
  Gx_duck_delay_stGUI* self = new Gx_duck_delay_stGUI();
...
{
  Gx_duck_delay_stGUI *pluginGui = static_cast<Gx_duck_delay_stGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_duck_delay_stGUI *self = static_cast<Gx_duck_delay_stGUI*>(ui);
