...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_vibe_stereoGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_vibe_stereoGUI *self)
  {
...
void Gx_vibe_stereoGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_vibe_stereoGUI::set_skin()
{
...
void Gx_vibe_stereoGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_vibe_#_vibe_", plugin_uri) == 0)
    {
      plug_name = "_vibe_stereo";
     // set_knob("nk-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gx_vibe_#_vibe_mono", plugin_uri) == 0)
    {
      plug_name = "_vibe_mono";
    //  set_knob("nk-knob");
    }
}

GtkWidget* Gx_vibe_stereoGUI::make_gui()
{
...
{
  Gx_vibe_stereoGUI* self = new Gx_vibe_stereoGUI();
...
{
  Gx_vibe_stereoGUI *pluginGui = static_cast<Gx_vibe_stereoGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_vibe_stereoGUI *self = static_cast<Gx_vibe_stereoGUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_vibe_", instantiate, cleanup, port_event, NULL},
  {GXPLUGIN_UI_URI"#_vibe_mono", instantiate, cleanup, port_event, NULL}
};
