...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_rangem_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_rangem_GUI *self)
  {
...
void Gx_rangem_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_rangem_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_rangem_gui#_rangem_", plugin_uri) == 0)
    {
      plug_name = "RangeMaster";
      //set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_rangem_GUI::make_gui()
{
...
{
  Gx_rangem_GUI* self = new Gx_rangem_GUI();
...
{
  Gx_rangem_GUI *pluginGui = static_cast<Gx_rangem_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_rangem_GUI *self = static_cast<Gx_rangem_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_rangem_", instantiate, cleanup, port_event, NULL}
};
