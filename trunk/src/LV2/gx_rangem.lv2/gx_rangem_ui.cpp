...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        .bg =       { 0.13, 0.26, 0.27, 1.00},
        .base =     { 0.13, 0.26, 0.27, 1.00},
    ...
    main->color_scheme->selected = (Colors) {
        .fg =       { 0.9, 0.9, 0.9, 1.0},
        .bg =       { 0.13, 0.38, 0.27, 1.00},
        .base =     { 0.13, 0.38, 0.27, 1.00},
