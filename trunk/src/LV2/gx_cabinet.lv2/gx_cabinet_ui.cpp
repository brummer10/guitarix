...
static void draw_my_knob(void *w_, void* user_data) {
    ...
    cairo_pattern_add_color_stop_rgba (pat, 1,  0.54, 0.19, 0.01, 1.0);
    cairo_pattern_add_color_stop_rgba (pat, 0.75,  0.29, 0.1, 0.01, 1.0);
    ...
    pat = cairo_pattern_create_linear (0, 0, 0, knob_y);
    cairo_pattern_add_color_stop_rgba (pat, 0,  0.54, 0.19, 0.01, 1.0);
    cairo_pattern_add_color_stop_rgba (pat, 0.25,  0.29, 0.1, 0.01, 1.0);
    cairo_pattern_add_color_stop_rgba (pat, 0.5,  0.15, 0.15, 0.15, 1.0);
