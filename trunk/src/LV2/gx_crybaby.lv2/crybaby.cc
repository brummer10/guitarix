// generated from file './faust/crybaby.dsp' by dsp2cc:
...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (0.0010000000000000009 * faustpower<2>(fSlow2));
	double 	fSlow4 = (0.0010000000000000009 * (0 - (2.0 * (fSlow2 * cos((fConst2 * fSlow1))))));
	double 	fSlow5 = (0.0001000000000000001 * pow(4.0,fSlow0));
	double 	fSlow6 = double(fslider2);
	double 	fSlow7 = (0.01 * (fSlow6 * double(fslider1)));
	double 	fSlow8 = (1 - (0.01 * fSlow6));
	for (int i=0; i<count; i++) {
		fRec1[0] = (fSlow3 + (0.999 * fRec1[1]));
		fRec2[0] = (fSlow4 + (0.999 * fRec2[1]));
		fRec3[0] = ((0.999 * fRec3[1]) + fSlow5);
