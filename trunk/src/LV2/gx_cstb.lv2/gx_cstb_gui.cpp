...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_cstb_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_cstb_GUI *self)
  {
...
void Gx_cstb_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_cstb_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_cstb_gui#_cstb_", plugin_uri) == 0)
    {
      plug_name = "ColorSound Tonebender";
      //set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_cstb_GUI::make_gui()
{
...
{
  Gx_cstb_GUI* self = new Gx_cstb_GUI();
...
{
  Gx_cstb_GUI *pluginGui = static_cast<Gx_cstb_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_cstb_GUI *self = static_cast<Gx_cstb_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_cstb_", instantiate, cleanup, port_event, NULL}
};
