...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        .bg =       { 0.30, 0.10, 0.00, 1.00},
        .base =     { 0.30, 0.10, 0.00, 1.00},
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
    ...
    // create knob widgets
    ui->widget[0] = add_my_knob(ui->widget[0], OCTAVE1,"Octave1", ui,30, 40, 80, 105);
    set_adjustment(ui->widget[0]->adj,0.5, 0.5, 0.0, 1.0, 0.01, CL_CONTINUOS);

    ui->widget[1] = add_my_knob(ui->widget[1], OCTAVE2,"Ocatve2", ui,150, 40, 80, 105);
    set_adjustment(ui->widget[1]->adj,0.5, 0.5, 0.0, 1.0, 0.01, CL_CONTINUOS);

    ui->widget[2] = add_my_knob(ui->widget[2], DIRECT,"Direct", ui,100, 120, 60, 75);
