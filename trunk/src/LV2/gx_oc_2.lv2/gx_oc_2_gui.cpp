...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_oc_2_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_oc_2_GUI *self)
  {
...
void Gx_oc_2_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_oc_2_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_oc_2_gui#_oc_2_", plugin_uri) == 0)
    {
      plug_name = "oc_2";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_oc_2_GUI::make_gui()
{
...
{
  Gx_oc_2_GUI* self = new Gx_oc_2_GUI();
...
{
  Gx_oc_2_GUI *pluginGui = static_cast<Gx_oc_2_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_oc_2_GUI *self = static_cast<Gx_oc_2_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_oc_2_", instantiate, cleanup, port_event, NULL}
};
