...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_fuzzface_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_fuzzface_GUI *self)
  {
...
void Gx_fuzzface_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_fuzzface_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_fuzzface_gui#_fuzzface_", plugin_uri) == 0)
    {
      plug_name = "_fuzzface_";
      //set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_fuzzface_GUI::make_gui()
{
...
{
  Gx_fuzzface_GUI* self = new Gx_fuzzface_GUI();
...
{
  Gx_fuzzface_GUI *pluginGui = static_cast<Gx_fuzzface_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_fuzzface_GUI *self = static_cast<Gx_fuzzface_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_fuzzface_", instantiate, cleanup, port_event, NULL}
};
