...
logo("Flanger")
{
  ...
  make_controller_box(&m_vbox3, "width", 0, 10, 0.01, WIDTH);
  make_controller_box(&m_vbox4, "freq", 0.05, 10, 0.06, FREQ);
  make_controller_box(&m_vbox5, "feedback", -0.99, 0.99, 0.01, FEEDBACK);
  make_controller_box(&m_vbox6, "dry/wet", 0, 100, 1, WET);
  make_controller_box(&m_vbox7, "mix", -1, 1, 0.1, MIX);
