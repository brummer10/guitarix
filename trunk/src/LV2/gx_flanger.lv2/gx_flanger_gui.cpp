...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_flangerGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_flangerGUI *self)
  {
...
void Gx_flangerGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_flangerGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_flanger_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void Gx_flangerGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_flanger#_flanger", plugin_uri) == 0)
    {
      plug_name = "_flanger";
      set_knob("nk-knob");
    }
...
GtkWidget* Gx_flangerGUI::make_gui()
{
...
{
  Gx_flangerGUI* self = new Gx_flangerGUI();
...
{
  Gx_flangerGUI *pluginGui = static_cast<Gx_flangerGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_flangerGUI *self = static_cast<Gx_flangerGUI*>(ui);
