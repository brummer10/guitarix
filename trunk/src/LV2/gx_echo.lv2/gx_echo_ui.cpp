...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
    ...
    ui->widget[3] = add_my_knob(ui->widget[3], PERCENT_R,"Level (R)", ui,520, 25, 100, 125);
    set_adjustment(ui->widget[3]->adj,30.0, 30.0, 0.0, 100.0, 1.0, CL_CONTINUOS);

    ui->widget[4] = add_my_knob(ui->widget[4], PERCENT_L,"Level (L)", ui,40, 25, 100, 125);
