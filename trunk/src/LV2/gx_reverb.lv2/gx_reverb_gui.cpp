...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_reverbGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_reverbGUI *self)
  {
...
void Gx_reverbGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_reverbGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_reverb_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void Gx_reverbGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_reverb#_reverb", plugin_uri) == 0)
    {
...
GtkWidget* Gx_reverbGUI::make_gui()
{
...
{
  Gx_reverbGUI* self = new Gx_reverbGUI();
...
{
  Gx_reverbGUI *pluginGui = static_cast<Gx_reverbGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_reverbGUI *self = static_cast<Gx_reverbGUI*>(ui);
