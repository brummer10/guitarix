...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_susta_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_susta_GUI *self)
  {
...
void Gx_susta_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_susta_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_susta_gui#_susta_", plugin_uri) == 0)
    {
      plug_name = "_susta_";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_susta_GUI::make_gui()
{
...
{
  Gx_susta_GUI* self = new Gx_susta_GUI();
...
{
  Gx_susta_GUI *pluginGui = static_cast<Gx_susta_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_susta_GUI *self = static_cast<Gx_susta_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_susta_", instantiate, cleanup, port_event, NULL}
};
