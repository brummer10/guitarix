...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_compressorGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_compressorGUI *self)
  {
...
void Gx_compressorGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_compressorGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_compressor_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void Gx_compressorGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_compressor#_compressor", plugin_uri) == 0)
    {
      plug_name = "_compressor";
      set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_compressorGUI::make_gui()
{
...
{
  Gx_compressorGUI* self = new Gx_compressorGUI();
...
{
  Gx_compressorGUI *pluginGui = static_cast<Gx_compressorGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_compressorGUI *self = static_cast<Gx_compressorGUI*>(ui);
