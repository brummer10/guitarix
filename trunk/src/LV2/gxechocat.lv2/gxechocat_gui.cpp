...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(GxechocatGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(GxechocatGUI *self)
  {
...
void GxechocatGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void GxechocatGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gxechocat#echocat", plugin_uri) == 0)
    {
      plugskin = "echocat.png";
      plug_name = "gxechocat";
      set_knob("echocat-knob");
    }
  else
    {
      plugskin = "echocat.png";
...
GtkWidget* GxechocatGUI::make_gui()
{
...
{
  GxechocatGUI* self = new GxechocatGUI();
...
{
  GxechocatGUI *pluginGui = static_cast<GxechocatGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  GxechocatGUI *self = static_cast<GxechocatGUI*>(ui);
