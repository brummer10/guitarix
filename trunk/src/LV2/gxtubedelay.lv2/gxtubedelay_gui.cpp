...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(GxTubeDelayGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(GxTubeDelayGUI *self)
  {
...
void GxTubeDelayGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void GxTubeDelayGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_tubedelay_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void GxTubeDelayGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gxtubedelay#tubedelay", plugin_uri) == 0)
    {
      plugskin = "tubedelay.png";
      plug_name = "tubedelay";
      set_knob("tubedelay-knob");
    }
  else
    {
      plugskin = "tubedelay.png";
...
{
  GxTubeDelayGUI* self = new GxTubeDelayGUI();
...
{
  GxTubeDelayGUI *pluginGui = (GxTubeDelayGUI *) ui;
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  GxTubeDelayGUI *self = (GxTubeDelayGUI *) ui;

//  std::cout << "port event = " << port_index << std::endl;
