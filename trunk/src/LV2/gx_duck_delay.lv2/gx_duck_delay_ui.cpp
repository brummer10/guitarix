...
static LV2UI_Handle instantiate(const struct LV2UI_Descriptor * descriptor,
    ...
    ui->widget[2] = add_my_knob(ui->widget[2], ATTACK,"Attack", ui,250, 35, 80, 105);
    set_adjustment(ui->widget[2]->adj,0.1, 0.1, 0.05, 0.5, 0.001, CL_CONTINUOS);
    adj_set_scale(ui->widget[2]->adj, 2.0);

    ui->widget[3] = add_my_knob(ui->widget[3], RELESE,"Release", ui,350, 35, 80, 105);
    set_adjustment(ui->widget[3]->adj,0.1, 0.1, 0.05, 2.0, 0.01, CL_CONTINUOS);
    adj_set_scale(ui->widget[3]->adj, 2.0);

    ui->widget[4] = add_my_knob(ui->widget[4], AMOUNT,"Amount", ui,450, 35, 80, 105);
