...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_duck_delayGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_duck_delayGUI *self)
  {
...
void Gx_duck_delayGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_duck_delayGUI::set_skin()
{
...
void Gx_duck_delayGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";
...
GtkWidget* Gx_duck_delayGUI::make_gui()
{
...
{
  Gx_duck_delayGUI* self = new Gx_duck_delayGUI();
...
{
  Gx_duck_delayGUI *pluginGui = static_cast<Gx_duck_delayGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_duck_delayGUI *self = static_cast<Gx_duck_delayGUI*>(ui);
