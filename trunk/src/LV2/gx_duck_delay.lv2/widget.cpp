...
logo("Duck Delay")
{
  ...
  make_controller_box(&m_vbox3, "FEEDBACK", 0.0, 1.0, 0.01, FEEDBACK);
  make_controller_box(&m_vbox4, "ATTACK", 0.05, 0.5, 0.01, ATTACK);
  make_controller_box(&m_vbox5, "RELEASE", 0.05, 2.0, 0.01, RELESE);
  make_controller_box(&m_vbox6, "AMOUNT", 0.0, 56.0, 0.1, AMOUNT);
