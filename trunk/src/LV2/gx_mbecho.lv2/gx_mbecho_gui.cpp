...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_mbecho_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_mbecho_GUI *self)
  {
...
void Gx_mbecho_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_mbecho_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_mbecho_#_mbecho_", plugin_uri) == 0)
    {
      plug_name = "_mbecho_";
      set_knob("nm-knob");
    }
...
GtkWidget* Gx_mbecho_GUI::make_gui()
{
...
{
  Gx_mbecho_GUI* self = new Gx_mbecho_GUI();
...
{
  Gx_mbecho_GUI *pluginGui = static_cast<Gx_mbecho_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_mbecho_GUI *self = static_cast<Gx_mbecho_GUI*>(ui);
