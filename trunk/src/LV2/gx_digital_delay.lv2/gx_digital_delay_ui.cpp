...
static void draw_my_knob(void *w_, void* user_data) {
    ...
    cairo_pattern_add_color_stop_rgba (pat, 1,  0.15, 0.15, 0.25, 1.00);
    cairo_pattern_add_color_stop_rgba (pat, 0.75,  0.12, 0.12, 0.2, 1.00);
    ...
    pat = cairo_pattern_create_linear (0, 0, 0, knob_y);
    cairo_pattern_add_color_stop_rgba (pat, 0,  0.00, 0.00, 0.14, 1.00);
    cairo_pattern_add_color_stop_rgba (pat, 0.25,  0.2, 0.2, 0.24, 1.00);
