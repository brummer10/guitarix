...
logo(plugname)
{
  ...
  make_controller_box(&m_vboxc[0], "VOLUME", 0.0, 1.0, 0.01, VOLUME);
  make_controller_box(&m_vboxc[1], "TONE", 0.0, 1.0, 0.01, TONE);
  make_controller_box(&m_vboxc[2], "SUSTAIN", 0.0, 1.0, 0.01, SUSTAIN);
