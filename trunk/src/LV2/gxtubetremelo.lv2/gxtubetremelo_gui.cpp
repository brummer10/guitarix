...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(GxtubetremeloGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(GxtubetremeloGUI *self)
  {
...
void GxtubetremeloGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void GxtubetremeloGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_headtubetremelo_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void GxtubetremeloGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gxtubetremelo#tubetremelo", plugin_uri) == 0)
    {
      plugskin = "gxtubetremelo.png";
      plug_name = "gxtubetremelo";
...
GtkWidget* GxtubetremeloGUI::make_gui()
{
...
{
  GxtubetremeloGUI* self = new GxtubetremeloGUI();
...
{
  GxtubetremeloGUI *pluginGui = static_cast<GxtubetremeloGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  GxtubetremeloGUI *self = static_cast<GxtubetremeloGUI*>(ui);
