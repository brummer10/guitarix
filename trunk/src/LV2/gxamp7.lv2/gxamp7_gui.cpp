...
// Need to add the relavant subdirectory here.
...
void GXPluginGUI::set_plug_name( const char * plugin_uri)
{
  ...
  if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp7#Twin", plugin_uri) == 0)
    {
      plugskin = "twin.png";
      plug_name = "Twin";
      set_knob("chicken-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp7#Bassman", plugin_uri) == 0)
    {
      plugskin = "bassman.png";
      plug_name = "Bassman";
      set_knob("fender-knob");
    }
  else if (strcmp("http://guitarix.sourceforge.net/plugins/gxamp7#AmpegGVT15", plugin_uri) == 0)
    {
      plugskin = "Ampeg-GVT15H.png";
      plug_name = "AmpegGVT15H";
      set_knob("metal-knob");
    }
  else
    {
