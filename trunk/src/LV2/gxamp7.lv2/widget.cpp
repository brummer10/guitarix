...
// set propertys for the main paintbox holding the skin
  ...
  // extra box for the boxed presence/cabinet controllers
  ...
  // add presence controller box to main controller box
                                 ...
                                 Glib::ustring plug_name)
{
  ...
  // Use the plug name as GUI subdirectory
  // This allows different labels for each amp
