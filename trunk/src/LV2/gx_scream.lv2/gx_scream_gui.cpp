...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_scream_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_scream_GUI *self)
  {
...
void Gx_scream_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_scream_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_scream_gui#_scream_", plugin_uri) == 0)
    {
      plug_name = "_scream_";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_scream_GUI::make_gui()
{
...
{
  Gx_scream_GUI* self = new Gx_scream_GUI();
...
{
  Gx_scream_GUI *pluginGui = static_cast<Gx_scream_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_scream_GUI *self = static_cast<Gx_scream_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_scream_", instantiate, cleanup, port_event, NULL}
};
