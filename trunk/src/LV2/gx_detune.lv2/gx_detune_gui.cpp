...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_detune_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_detune_GUI *self)
  {
...
void Gx_detune_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_detune_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_detune_#_detune_", plugin_uri) == 0)
    {
      plug_name = "GxDetune";
      set_knob("nk-knob");
    }
...
GtkWidget* Gx_detune_GUI::make_gui()
{
...
{
  Gx_detune_GUI* self = new Gx_detune_GUI();
...
{
  Gx_detune_GUI *pluginGui = static_cast<Gx_detune_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_detune_GUI *self = static_cast<Gx_detune_GUI*>(ui);
