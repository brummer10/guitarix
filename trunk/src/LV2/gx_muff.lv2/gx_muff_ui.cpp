...
static void set_my_theme(Xputty *main) {
    main->color_scheme->normal = (Colors) {
        ...
        /*bg */       { 0.28, 0.11, 0.19, 1.00},
        /*base */     { 0.28, 0.11, 0.19, 1.00},
    ...
    main->color_scheme->selected = (Colors) {
        /*fg */       { 0.9, 0.9, 0.9, 1.0},
        /*bg */       { 0.37, 0.11, 0.19, 1.00},
        /*base */     { 0.37, 0.11, 0.19, 1.00},
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
    ...
    // create knob widgets
    ui->widget[0] = add_my_knob(ui->widget[0], TONE,"Tone", ui,40, 25, 80, 105);
