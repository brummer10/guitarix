...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_muff_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_muff_GUI *self)
  {
...
void Gx_muff_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_muff_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_muff_gui#_muff_", plugin_uri) == 0)
    {
      plug_name = "_muff_";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_muff_GUI::make_gui()
{
...
{
  Gx_muff_GUI* self = new Gx_muff_GUI();
...
{
  Gx_muff_GUI *pluginGui = static_cast<Gx_muff_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_muff_GUI *self = static_cast<Gx_muff_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_muff_", instantiate, cleanup, port_event, NULL}
};
