...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_bossds1_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_bossds1_GUI *self)
  {
...
void Gx_bossds1_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_bossds1_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_bossds1_gui#_bossds1_", plugin_uri) == 0)
    {
      plug_name = "Boss DS1";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_bossds1_GUI::make_gui()
{
...
{
  Gx_bossds1_GUI* self = new Gx_bossds1_GUI();
...
{
  Gx_bossds1_GUI *pluginGui = static_cast<Gx_bossds1_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_bossds1_GUI *self = static_cast<Gx_bossds1_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_bossds1_", instantiate, cleanup, port_event, NULL}
};
