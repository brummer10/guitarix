...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_gcb_95_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_gcb_95_GUI *self)
  {
...
void Gx_gcb_95_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_gcb_95_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_gcb_95_gui#_gcb_95_", plugin_uri) == 0)
    {
      plug_name = "gcb_95";
      //set_knob("nk-knob");
    }
...
GtkWidget* Gx_gcb_95_GUI::make_gui()
{
...
{
  Gx_gcb_95_GUI* self = new Gx_gcb_95_GUI();
...
{
  Gx_gcb_95_GUI *pluginGui = static_cast<Gx_gcb_95_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_gcb_95_GUI *self = static_cast<Gx_gcb_95_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_gcb_95_", instantiate, cleanup, port_event, NULL}
};
