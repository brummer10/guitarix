...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_phaserGUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_phaserGUI *self)
  {
...
void Gx_phaserGUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_phaserGUI::set_skin()
{
  ...
  toparse +=     " widget '*.amplabel' style:highest 'gx_head_phaser_box'\n"
                 "widget '*.";
  toparse +=     plug_name;
  toparse +=     "' style 'gx_";
  toparse +=     plug_name;
...
void Gx_phaserGUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_phaser#_phaser", plugin_uri) == 0)
    {
      plug_name = "_phaser";
      set_knob("nk-knob");
    }
...
GtkWidget* Gx_phaserGUI::make_gui()
{
...
{
  Gx_phaserGUI* self = new Gx_phaserGUI();
...
{
  Gx_phaserGUI *pluginGui = static_cast<Gx_phaserGUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_phaserGUI *self = static_cast<Gx_phaserGUI*>(ui);
