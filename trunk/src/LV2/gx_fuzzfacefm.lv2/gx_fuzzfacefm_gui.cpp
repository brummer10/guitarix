...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_fuzzfacefm_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_fuzzfacefm_GUI *self)
  {
...
void Gx_fuzzfacefm_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_fuzzfacefm_GUI::set_skin()
{
...
void Gx_fuzzfacefm_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";

  if (strcmp("http://guitarix.sourceforge.net/plugins/gx_fuzzfacefm_#_fuzzfacefm_", plugin_uri) == 0)
    {
      plug_name = "_fuzzfacefm_";
      //set_knob("nk-knob");
    }
  else
    {
...
GtkWidget* Gx_fuzzfacefm_GUI::make_gui()
{
...
{
  Gx_fuzzfacefm_GUI* self = new Gx_fuzzfacefm_GUI();
...
{
  Gx_fuzzfacefm_GUI *pluginGui = static_cast<Gx_fuzzfacefm_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_fuzzfacefm_GUI *self = static_cast<Gx_fuzzfacefm_GUI*>(ui);
...
{
  {GXPLUGIN_UI_URI"#_fuzzfacefm_", instantiate, cleanup, port_event, NULL}
};
