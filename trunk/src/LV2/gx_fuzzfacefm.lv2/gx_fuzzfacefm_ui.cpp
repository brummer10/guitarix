...
static LV2UI_Handle instantiate(const LV2UI_Descriptor * descriptor,
    ...
    ui->widget[1] = add_my_knob(ui->widget[1], FUZZ,"Fuzz", ui,160, 25, 100, 125);
    set_adjustment(ui->widget[1]->adj,0.5, 0.5, 0.0, 1.0, 0.01, CL_CONTINUOS);

    ui->widget[2] = add_my_knob(ui->widget[2], DRIVE,"Drive", ui,280, 25, 100, 125);
    set_adjustment(ui->widget[2]->adj,0.5, 0.5, 0.0, 1.0, 0.01, CL_CONTINUOS);

    ui->widget[3] = add_my_knob(ui->widget[3], LEVEL,"Level", ui,400, 25, 100, 125);
