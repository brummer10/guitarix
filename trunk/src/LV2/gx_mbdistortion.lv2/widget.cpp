...
plug_name(plugname)
{
  ...
  make_controller_box(&m_vbox[3], "DRIVE ", 0.0, 1.0, 0.01, DRIVE3, false);
  make_controller_box(&m_vbox[4], "DRIVE ", 0.0, 1.0, 0.01, DRIVE4, false);
  make_controller_box(&m_vbox[5], "DRIVE ", 0.0, 1.0, 0.01, DRIVE5, false);
  
  make_controller_box(&m_vbox[6], "Gain ", -4e+01, 4.0, 0.1 , GAIN, false);
  
  make_controller_box(&m_vbox[1], "OFFSET ", 0.0, 0.5, 0.01, OFFSET1, false);
  make_controller_box(&m_vbox[2], "OFFSET ", 0.0, 0.5, 0.01, OFFSET2, false);
  make_controller_box(&m_vbox[3], "OFFSET ", 0.0, 0.5, 0.01, OFFSET3, false);
  make_controller_box(&m_vbox[4], "OFFSET ", 0.0, 0.5, 0.01, OFFSET4, false);
  make_controller_box(&m_vbox[5], "OFFSET ", 0.0, 0.5, 0.01, OFFSET5, false);
