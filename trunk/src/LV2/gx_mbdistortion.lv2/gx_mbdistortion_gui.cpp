...
public:
  ...
  Widget* widget;
  static void set_plug_name_static(Gx_mbdistortion_GUI *self, const char * plugin_uri)
  {
    self->set_plug_name(plugin_uri);
  }
  static GtkWidget* make_gui_static(Gx_mbdistortion_GUI *self)
  {
...
void Gx_mbdistortion_GUI::set_knob( Glib::ustring knob)
{
  addKnob =   " style 'gx_";
  addKnob +=  plug_name;
...
void Gx_mbdistortion_GUI::set_skin()
{
...
void Gx_mbdistortion_GUI::set_plug_name( const char * plugin_uri)
{
  addKnob = "";
...
GtkWidget* Gx_mbdistortion_GUI::make_gui()
{
...
{
  Gx_mbdistortion_GUI* self = new Gx_mbdistortion_GUI();
...
{
  Gx_mbdistortion_GUI *pluginGui = static_cast<Gx_mbdistortion_GUI*>(ui);
...
static void port_event(LV2UI_Handle ui,
                       ...
                       const void * buffer)
{
  Gx_mbdistortion_GUI *self = static_cast<Gx_mbdistortion_GUI*>(ui);
