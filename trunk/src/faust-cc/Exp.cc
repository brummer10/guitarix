...
class mydsp : public dsp{
  ...
  public:
	...
	virtual void buildUserInterface(UI* interface) {
		...
		interface->addVerticalSlider("Bass", &fslider4, 0.5, 0.0, 1.0, 0.01);
		interface->addVerticalSlider("Middle", &fslider3, 0.5, 0.0, 1.0, 0.01);
		interface->addCheckButton("ON", &fcheckbox3);
		interface->addVerticalSlider("Treble", &fslider5, 0.5, 0.0, 1.0, 0.01);
		interface->closeBox();
		interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow6 = fslider3;
		double 	fSlow7 = (3.0937500000000006e-07 * fSlow6);
		double 	fSlow8 = exp((3.4 * (fslider4 - 1)));
		double 	fSlow9 = (1.08515e-06 + ((3.108600000000001e-05 * fSlow8) + (fSlow6 * (((1.2375000000000003e-05 * fSlow8) - 2.99475e-07) - fSlow7))));
		double 	fSlow10 = ((1.8513000000000002e-09 * fSlow8) - (4.628250000000001e-11 * fSlow6));
		double 	fSlow11 = (3.3880000000000003e-09 * fSlow8);
		double 	fSlow12 = (8.470000000000002e-11 + (fSlow11 + (fSlow6 * (fSlow10 - 3.8417500000000006e-11))));
		double 	fSlow13 = (fConst16 * fSlow12);
		double 	fSlow14 = (0.00055 * fSlow6);
		double 	fSlow15 = (0.022500000000000003 * fSlow8);
		double 	fSlow16 = (fConst16 * (0.0031515000000000002 + (fSlow15 + fSlow14)));
		double 	fSlow17 = ((fSlow16 + (fConst17 * (fSlow13 - fSlow9))) - 1);
		double 	fSlow18 = (fConst18 * fSlow12);
		double 	fSlow19 = ((fConst17 * (fSlow9 + fSlow18)) - (3 + fSlow16));
		double 	fSlow20 = ((fSlow16 + (fConst17 * (fSlow9 - fSlow18))) - 3);
		double 	fSlow21 = (1.0 / (0 - (1 + (fSlow16 + (fConst17 * (fSlow9 + fSlow13))))));
		double 	fSlow22 = fslider5;
		double 	fSlow23 = ((fSlow6 * (4.628250000000001e-11 + fSlow10)) + (fSlow22 * (fSlow11 + (8.470000000000002e-11 - (8.470000000000002e-11 * fSlow6)))));
		double 	fSlow24 = (fConst18 * fSlow23);
		double 	fSlow25 = (9.955000000000001e-08 + (((3.08e-07 * fSlow22) + (fSlow6 * (3.781250000000001e-07 - fSlow7))) + (fSlow8 * (3.982e-06 + (1.2375000000000003e-05 * fSlow6)))));
		double 	fSlow26 = (0.0005625000000000001 + (fSlow15 + (fSlow14 + (0.000125 * fSlow22))));
		double 	fSlow27 = (fConst16 * fSlow26);
		double 	fSlow28 = (fSlow27 + (fConst17 * (fSlow25 - fSlow24)));
		double 	fSlow29 = (fConst16 * fSlow23);
		double 	fSlow30 = (fSlow27 + (fConst17 * (fSlow29 - fSlow25)));
		double 	fSlow31 = (fConst16 * (0 - fSlow26));
		double 	fSlow32 = (fSlow31 + (fConst17 * (fSlow25 + fSlow24)));
		double 	fSlow33 = (fSlow31 - (fConst17 * (fSlow25 + fSlow29)));
		int 	iSlow34 = int(fcheckbox3);
		...
		for (int i=0; i<count; i++) {
			...
			double fTemp6 = ((iSlow5)?fRec7[0]:fVec3[0]);
			fRec11[0] = (fTemp6 - (fSlow21 * (((fSlow20 * fRec11[2]) + (fSlow19 * fRec11[1])) + (fSlow17 * fRec11[3]))));
			output0[i] = (FAUSTFLOAT)((iSlow34)?(fSlow21 * ((fSlow33 * fRec11[0]) + ((fSlow32 * fRec11[1]) + ((fSlow30 * fRec11[3]) + (fSlow28 * fRec11[2]))))):fTemp6);
			// post processing
...
DspBlock::DspBlock()
{
	...
	registerVar("test.tone.Bass","","S","",&fslider4,0.5,0.0,1.0,0.01);
	registerVar("test.tone.Middle","","S","",&fslider3,0.5,0.0,1.0,0.01);
	registerVar("test.tone.ON","","B","",&fcheckbox3,0,0,1,1);
	registerVar("test.tone.Treble","","S","",&fslider5,0.5,0.0,1.0,0.01);
