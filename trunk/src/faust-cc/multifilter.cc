...
{
	registerVar("MultiBandFilter.f250","","S","gain (dB) at 250 Hz",&fslider13, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q250","","S","",&fslider12, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f500","","S","gain (dB) at 500 Hz",&fslider11, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q500","","S","",&fslider10, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f62_5","","S","gain (dB) at 62.5 Hz",&fslider17, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q62_5","","S","",&fslider16, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f125","","S","gain (dB) at 125 Hz",&fslider15, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q125","","S","",&fslider14, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f31_25","","S","gain (dB) at 31.25 Hz",&fslider19, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q31_25","","S","",&fslider18, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f2k","","S","gain (dB) at 2 kHz",&fslider7, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q2k","","S","",&fslider6, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f4k","","S","gain (dB) at 4 kHz",&fslider5, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q4k","","S","",&fslider4, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f8k","","S","gain (dB) at 8 kHz",&fslider3, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q8k","","S","",&fslider2, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f16k","","S","gain (dB) at 16 kHz",&fslider1, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q16k","","S","",&fslider0, 50.0f, 1.0f, 100.0f, 1.0f);
	registerVar("MultiBandFilter.f1k","","S","gain (dB) at 1 kHz",&fslider9, 0.0f, -50.0f, 10.0f, 0.1f);
	registerVar("MultiBandFilter.Q1k","","S","",&fslider8, 50.0f, 1.0f, 100.0f, 1.0f);
	registerInit(init);
}
