...
void init(int samplingFreq)
{
	...
	fConst0 = tanf((50265.48245743669f / fSamplingFreq));
	fConst1 = (2 * (faustpower<2>(fConst0) - 1));
	fConst2 = tanf((25132.741228718343f / fSamplingFreq));
	fConst3 = (2 * (faustpower<2>(fConst2) - 1));
	fConst4 = tanf((12566.370614359172f / fSamplingFreq));
	fConst5 = (2 * (faustpower<2>(fConst4) - 1));
	fConst6 = tanf((6283.185307179586f / fSamplingFreq));
	fConst7 = (2 * (faustpower<2>(fConst6) - 1));
	fConst8 = tanf((3141.592653589793f / fSamplingFreq));
	fConst9 = (2 * (faustpower<2>(fConst8) - 1));
	fConst10 = tanf((1570.7963267948965f / fSamplingFreq));
	fConst11 = (2 * (faustpower<2>(fConst10) - 1));
	fConst12 = tanf((785.3981633974482f / fSamplingFreq));
	fConst13 = (2 * (faustpower<2>(fConst12) - 1));
	fConst14 = tanf((392.6990816987241f / fSamplingFreq));
	fConst15 = (2 * (faustpower<2>(fConst14) - 1));
	fConst16 = tanf((196.34954084936206f / fSamplingFreq));
	fConst17 = (2 * (faustpower<2>(fConst16) - 1));
	fConst18 = tanf((98.17477042468103f / fSamplingFreq));
...
{
	registerVar("MultiBandFilter.f250","","S","gain (dB) at 250 Hz",&fslider13, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q250","","S","",&fslider12, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f500","","S","gain (dB) at 500 Hz",&fslider11, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q500","","S","",&fslider10, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f62_5","","S","gain (dB) at 62.5 Hz",&fslider17, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q62_5","","S","",&fslider16, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f125","","S","gain (dB) at 125 Hz",&fslider15, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q125","","S","",&fslider14, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f31_25","","S","gain (dB) at 31.25 Hz",&fslider19, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q31_25","","S","",&fslider18, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f2k","","S","gain (dB) at 2 kHz",&fslider7, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q2k","","S","",&fslider6, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f4k","","S","gain (dB) at 4 kHz",&fslider5, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q4k","","S","",&fslider4, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f8k","","S","gain (dB) at 8 kHz",&fslider3, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q8k","","S","",&fslider2, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f16k","","S","gain (dB) at 16 kHz",&fslider1, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q16k","","S","",&fslider0, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("MultiBandFilter.f1k","","S","gain (dB) at 1 kHz",&fslider9, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("MultiBandFilter.Q1k","","S","",&fslider8, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerInit(init);
}
