...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		float fTemp0 = ((float)input0[i] + (fSlow1 * fRec5[1]));
		fVec1[IOTA&4095] = fTemp0;
		fRec5[0] = (0.5f * (fVec1[(IOTA-iSlow4)&4095] + fVec1[(IOTA-iSlow3)&4095]));
		float fTemp1 = (fRec5[0] + (2 * fRec4[0]));
		fVec2[0] = (fSlow7 * fTemp1);
		fRec7[0] = (fVec2[1] + (fSlow7 * (fTemp1 + (fSlow6 * fRec7[1]))));
		float fTemp2 = (fSlow10 * fRec7[0]);
		fVec3[0] = fTemp2;
		fRec6[0] = ((fVec3[0] + (fSlow11 * fRec6[1])) - fVec3[1]);
		float fTemp3 = ((iSlow12)?fRec6[0]:(fRec5[0] + fRec4[0]));
		float fTemp4 = (fRec4[0] + fTemp3);
