...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec2[0] = (0.5f * (fVec0[(IOTA-iSlow4)&4095] + fVec0[(IOTA-iSlow3)&4095]));
		S2[0] = fRec2[0];
		fVec1[0] = (fSlow7 * fRec2[0]);
		fRec4[0] = (fVec1[1] + (fSlow7 * (fRec2[0] + (fSlow6 * fRec4[1]))));
		float fTemp1 = (fSlow10 * fRec4[0]);
		fVec2[0] = fTemp1;
		fRec3[0] = ((fVec2[0] + (fSlow11 * fRec3[1])) - fVec2[1]);
		S2[1] = fRec3[0];
		float fTemp2 = S2[iSlow12];
		S1[0] = fTemp2;
		fVec3[0] = (fSlow21 * fTemp2);
		fRec8[0] = ((fSlow21 * (fTemp2 + (fSlow22 * fRec8[1]))) - fVec3[1]);
		fVec4[0] = (fSlow21 * fRec8[0]);
		fRec7[0] = ((fSlow21 * (fRec8[0] + (fSlow22 * fRec7[1]))) - fVec4[1]);
		fRec6[0] = (fRec7[0] - (fSlow19 * ((fSlow18 * fRec6[2]) + (fSlow14 * fRec6[1]))));
		fRec5[0] = ((fSlow19 * (fRec6[2] + (fRec6[0] + (2 * fRec6[1])))) - (fSlow17 * ((fSlow16 * fRec5[2]) + (fSlow14 * fRec5[1]))));
		S1[1] = (fSlow17 * (fRec5[2] + (fRec5[0] + (2 * fRec5[1]))));
		float fTemp3 = max(-1, min(1, (fSlow25 * (fSlow24 + S1[iSlow23]))));
		float fTemp4 = (fTemp3 * (1 - (0.333333f * (fTemp3 * fTemp3))));
		fVec5[0] = fTemp4;
		fRec1[0] = ((fVec5[0] + (0.995f * fRec1[1])) - fVec5[1]);
		float fTemp5 = (fRec1[0] * fRec0[0]);
		S0[0] = fTemp5;
		fVec6[0] = (fSlow21 * fTemp5);
		fRec12[0] = ((fSlow21 * (fTemp5 + (fSlow22 * fRec12[1]))) - fVec6[1]);
		fVec7[0] = (fSlow21 * fRec12[0]);
		fRec11[0] = ((fSlow21 * (fRec12[0] + (fSlow22 * fRec11[1]))) - fVec7[1]);
		fRec10[0] = (fRec11[0] - (fSlow19 * ((fSlow18 * fRec10[2]) + (fSlow14 * fRec10[1]))));
		fRec9[0] = ((fSlow19 * (fRec10[2] + (fRec10[0] + (2 * fRec10[1])))) - (fSlow17 * ((fSlow16 * fRec9[2]) + (fSlow14 * fRec9[1]))));
		S0[1] = (fSlow17 * (fRec9[2] + (fRec9[0] + (2 * fRec9[1]))));
