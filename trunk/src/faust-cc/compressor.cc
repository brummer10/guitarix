...
void init(int samplingFreq)
{
	...
	fConst0 = expf((0 - (1e+01f / fSamplingFreq)));
	fConst1 = (1 - fConst0);
...
{
	registerVar("compressor.ratio","","S","",&fentry2, 2.0f, 1.0f, 2e+01f, 0.1f);
	registerVar("compressor.knee","","S","",&fentry1, 3.0f, 0.0f, 2e+01f, 0.1f);
	registerVar("compressor.threshold","","S","",&fentry0, -2e+01f, -96.0f, 1e+01f, 0.1f);
	registerVar("compressor.release","","S","",&fslider1, 0.5f, 0.0f, 1e+01f, 0.01f);
	registerVar("compressor.attack","","S","",&fslider0, 0.002f, 0.0f, 1.0f, 0.001f);
	registerInit(init);
}
