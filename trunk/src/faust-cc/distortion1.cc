...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow18 = (1 + ((fSlow17 - 0.76536686473018) / fSlow15));
	double 	fSlow19 = (1.0 / (1 + ((0.76536686473018 + fSlow17) / fSlow15)));
	double 	fSlow20 = (1 + ((fSlow17 - 1.847759065022573) / fSlow15));
	double 	fSlow21 = (1.0 / (1 + ((1.847759065022573 + fSlow17) / fSlow15)));
