...
{
	registerVar("eq.f250","","S","gain (dB) at 250 Hz",&fslider13, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q250","","S","",&fslider12, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f500","","S","gain (dB) at 500 Hz",&fslider11, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q500","","S","",&fslider10, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f62_5","","S","gain (dB) at 62.5 Hz",&fslider17, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q62_5","","S","",&fslider16, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f125","","S","gain (dB) at 125 Hz",&fslider15, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q125","","S","",&fslider14, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f31_25","","S","gain (dB) at 31.25 Hz",&fslider19, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q31_25","","S","",&fslider18, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f2k","","S","gain (dB) at 2 kHz",&fslider7, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q2k","","S","",&fslider6, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f4k","","S","gain (dB) at 4 kHz",&fslider5, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q4k","","S","",&fslider4, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f8k","","S","gain (dB) at 8 kHz",&fslider3, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q8k","","S","",&fslider2, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f16k","","S","gain (dB) at 16 kHz",&fslider1, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q16k","","S","",&fslider0, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerVar("eq.f1k","","S","gain (dB) at 1 kHz",&fslider9, 0.0f, -5e+01f, 1e+01f, 0.1f);
	registerVar("eq.Q1k","","S","",&fslider8, 5e+01f, 1.0f, 1e+02f, 1.0f);
	registerInit(init);
}
