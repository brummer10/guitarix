...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow2 = pow(10,(0.025 * (fslider1 - fSlow1)));
	...
	double 	fSlow9 = pow(10,(0.0125 * fSlow0));
	...
	double 	fSlow23 = pow(10,(0.025 * (fslider2 - fSlow1)));
...
{
	registerVar("amp.tone.bass","bass","S","",&fslider2, 0.0, -2e+01, 2e+01, 0.1);
	registerVar("amp.tone.treble","treble","S","",&fslider1, 0.0, -2e+01, 2e+01, 0.1);
	registerVar("amp.tone.middle","middle","S","",&fslider0, 0.0, -2e+01, 2e+01, 0.1);
	registerInit(init);
}
