...
tubeax(preamp,gain1) =  hgroup("stage1", stage1) :
          ...
          with {
    stage1 = tubestage(TB_6C16_68k,86.0,2700.0,1.581656) : *(preamp):
    lowpass1(6531.0) : tubestage(TB_6C16_250k,132.0,1500.0,1.204285) : *(preamp); 
    stage2 = lowpass1(6531.0) : tubestage(TB_6C16_250k,194.0,820.0,0.840703) : *(gain1); 
};
