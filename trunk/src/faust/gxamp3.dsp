declare id "12AU7"; // in amp tube selector
declare name "12AU7";
...
tubeax(preamp,gain1) =  hgroup("stage1", stage1) :
    ...
    lowpass(1,6531.0) : tubestage(TB_12AU7_250k,132.0,1500.0,2.314844) : *(preamp) :*(2.0); 
    stage2 = lowpass(1,6531.0) : tubestage(TB_12AU7_250k,194.0,820.0,1.356567) : *(gain1):*(2.0); 
