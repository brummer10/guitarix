...
excursion = hslider("excursion", 0, 0, 16, 0.5);
decay = hslider("decay", 0.1, 0, 0.5, 0.01);
decay_diffusion1 = hslider("decay diff 1", 0.1, 0, 0.7, 0.01);
decay_diffusion2 = hslider("decay diff 2", 0.1, 0, 0.5, 0.01);
input_diffusion1 = hslider("input diff 1", 0.1, 0, 0.75, 0.01);
input_diffusion2 = hslider("input diff 2", 0.1, 0, 0.625, 0.01);
bandwidth = hslider("bandwidth", 0.9, 0.1, 0.95, 0.0005);
damping = hslider("damping", 0.0005, 0.1, 0.95, 0.0005);
...
get_length(x) = x/orig_sr:_*SR:int;
