...
d = 1 - vslider("vibrato[old:fresotube2]", 1, 0, 0.99, 0.01);
//a = vslider("trigger[name:resonanz][old:fresotube1]", 0.12, 0, 1, 0.01);
a = 0.9 - vslider("resonanz[old:fresotube1]", 0.5, 0, 0.9, 0.01);
};

//fuzzy = vslider("fuzzy[name:tube][old:fresotube3]", 0.5, 0, 1, 0.01);
fuzzy = vslider("fuzzy[name:tube][old:fresotube3]", 1, -3, 10, 1);
