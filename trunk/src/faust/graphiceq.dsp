...
v1(x)		= attach(x, envelop(x) : vbargraph("v1[nomidi:no][log]", -70, +5));
v2(x)		= attach(x, envelop(x) : vbargraph("v2[nomidi:no][log]", -70, +5));
v3(x)		= attach(x, envelop(x) : vbargraph("v3[nomidi:no][log]", -70, +5));
v4(x)		= attach(x, envelop(x) : vbargraph("v4[nomidi:no][log]", -70, +5));
v5(x)		= attach(x, envelop(x) : vbargraph("v5[nomidi:no][log]", -70, +5));

v6(x)		= attach(x, envelop(x) : vbargraph("v6[nomidi:no][log]", -70, +5));
v7(x)		= attach(x, envelop(x) : vbargraph("v7[nomidi:no][log]", -70, +5));
v8(x)		= attach(x, envelop(x) : vbargraph("v8[nomidi:no][log]", -70, +5));
v9(x)		= attach(x, envelop(x) : vbargraph("v9[nomidi:no][log]", -70, +5));
v10(x)		= attach(x, envelop(x) : vbargraph("v10[nomidi:no][log]", -70, +5));
v11(x)		= attach(x, envelop(x) : vbargraph("v11[nomidi:no][log]", -70, +5));
