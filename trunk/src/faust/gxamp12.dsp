...
process = hgroup("amp2", hgroup("stage1", stage1) : component("gxdistortion.dsp").dist(drive,wet_dry) : 
    ...
    lowpass1(6531.0) : tubestage130_20(TB_6DJ8_250k,132.0,1500.0,1.271609) :tubestage130_20(TB_6DJ8_250k,194.0,820.0,0.797043); 
