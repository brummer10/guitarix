...
gx_drive(drive) = _ <: _ + nonlin(4.,4.,0.125) * drive * 5 ;

process = gx_drive(vslider(".gxdistortion.drive[alias]",0.35, 0, 1, 0.01)) : component("gxamp2.dsp").tubeax(preamp,gain1) with {
