...
tl       = tempo(hslider("lbpm[name:Time L][tooltip:Echo in Beats per Minute]",120,24,360,1));
tr       = tempo(hslider("rbpm[name:Time R][tooltip:Echo in Beats per Minute]",120,24,360,1));
N       = int( 2^19);
