...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec27[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec33[0] + (fConst14 * (fRec32[0] * (fRec28[2] + (fRec28[0] + (2 * fRec28[1])))))) - 2.617753)) - 153.04618518518518);
		...
		fRec35[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec36[0] + fRec25[1]) - 1.887333)) - 124.17779999999999);
		...
		fRec23[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec37[0] + fRec24[0]) - 1.887333)) - 124.17779999999999);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec40[0] + fRec21[1]) - 1.256962)) - 96.7119512195122);
		...
		fRec20[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec41[0] + fRec21[0]) - 1.256962)) - 96.7119512195122);
