...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp6 = (fTemp4 + fTemp5) / (Ranode(TUBE_TABLE_12AT7_250k, fRec24[1]) + 1e+05);
		fVec0[0] = fTemp6;
		fRec27[0] = fConst6 * (8.2e+02 * (fTemp6 + fVec0[1]) - fConst5 * fRec27[1]);
		fRec24[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp5 + fRec27[0] + fTemp4 + -1.256962) + -96.7119512195122;
		double fTemp7 = fRec24[0] - fRec24[1];
		fRec23[0] = fConst8 * (fConst7 * fTemp7 - fConst3 * fRec23[1]);
		fRec28[0] = fConst11 * (fConst10 * fRec28[1] + 0.025 * fTemp7);
		...
		double fTemp10 = (fTemp8 + fTemp9) / (Ranode(TUBE_TABLE_12AT7_250k, fRec36[1]) + 1e+05);
		fVec1[0] = fTemp10;
		fRec39[0] = fConst14 * (1.5e+03 * (fTemp10 + fVec1[1]) - fConst13 * fRec39[1]);
		fRec36[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp9 + fRec39[0] + fTemp8 + -1.887333) + -124.17779999999999;
		double fTemp11 = fRec36[0] - fRec36[1];
		fRec35[0] = fConst8 * (fConst7 * fTemp11 - fConst3 * fRec35[1]);
		fRec40[0] = fConst11 * (fConst10 * fRec40[1] + 0.025 * fTemp11);
		fRec45[0] = fSlow4 + 0.999 * fRec45[1];
		double fTemp12 = double(buf[i0]) * fRec45[0];
		fVec2[0] = fTemp12;
		fRec44[0] = 0.9302847925323914 * (fTemp12 + fVec2[1]) - 0.8605695850647829 * fRec44[1];
		...
		double fTemp15 = (fTemp13 + fTemp14) / (Ranode(TUBE_TABLE_12AT7_68k, fRec42[1]) + 1e+05);
		fVec3[0] = fTemp15;
		fRec46[0] = fConst17 * (2.7e+03 * (fTemp15 + fVec3[1]) - fConst16 * fRec46[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp14 + fRec46[0] + fTemp13 + -2.617753) + -153.04618518518518;
		double fTemp16 = fRec42[0] - fRec42[1];
		fRec41[0] = fConst8 * (fConst7 * fTemp16 - fConst3 * fRec41[1]);
		fRec47[0] = fConst11 * (fConst10 * fRec47[1] + 0.025 * fTemp16);
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AT7_250k, fRec30[1]) + 1e+05);
		fVec4[0] = fTemp19;
		fRec48[0] = fConst14 * (1.5e+03 * (fTemp19 + fVec4[1]) - fConst13 * fRec48[1]);
		fRec30[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp18 + fRec48[0] + fTemp17 + -1.887333) + -124.17779999999999;
		double fTemp20 = fRec30[0] - fRec30[1];
		fRec29[0] = fConst8 * (fConst7 * fTemp20 - fConst3 * fRec29[1]);
		fRec49[0] = fConst11 * (fConst10 * fRec49[1] + 0.025 * fTemp20);
		...
		double fTemp23 = (fTemp21 + fTemp22) / (Ranode(TUBE_TABLE_12AT7_250k, fRec19[1]) + 1e+05);
		fVec5[0] = fTemp23;
		fRec50[0] = fConst6 * (8.2e+02 * (fTemp23 + fVec5[1]) - fConst5 * fRec50[1]);
		fRec19[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp22 + fRec50[0] + fTemp21 + -1.256962) + -96.7119512195122;
		double fTemp24 = fRec19[0] - fRec19[1];
		fRec18[0] = fConst8 * (fConst7 * fTemp24 - fConst3 * fRec18[1]);
		fRec51[0] = fConst11 * (fConst10 * fRec51[1] + 0.025 * fTemp24);
		...
		fRec73[0] = fConst8 * (fConst7 * fTemp56 - fConst3 * fRec73[1]);
