...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AT7_250k, fRec36[1]) + 1e+05);
		fVec1[0] = fTemp9;
		fRec39[0] = fConst15 * (1.5e+03 * (fTemp9 + fVec1[1]) - fConst14 * fRec39[1]);
		fRec36[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp8 + fRec39[0] + fTemp7 + -1.887333) + -124.17779999999999;
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_12AT7_68k, fRec42[1]) + 1e+05);
		fVec3[0] = fTemp13;
		fRec46[0] = fConst18 * (2.7e+03 * (fTemp13 + fVec3[1]) - fConst17 * fRec46[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp12 + fRec46[0] + fTemp11 + -2.617753) + -153.04618518518518;
		...
		double fTemp16 = (fTemp14 + fTemp15) / (Ranode(TUBE_TABLE_12AT7_250k, fRec30[1]) + 1e+05);
		fVec4[0] = fTemp16;
		fRec48[0] = fConst15 * (1.5e+03 * (fTemp16 + fVec4[1]) - fConst14 * fRec48[1]);
		fRec30[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp15 + fRec48[0] + fTemp14 + -1.887333) + -124.17779999999999;
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AT7_250k, fRec19[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec50[0] = fConst7 * (8.2e+02 * (fTemp19 + fVec5[1]) - fConst6 * fRec50[1]);
		fRec19[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp18 + fRec50[0] + fTemp17 + -1.256962) + -96.7119512195122;
