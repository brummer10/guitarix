...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec27[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp0 + (fRec30[0] + fTemp1)) + -1.2569619999999999)))) + -96.711951219512201);
		...
		double fTemp5 = ((fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec38[1]))) + 100000.0));
		fVec1[0] = fTemp5;
		fRec41[0] = (fConst31 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst32 * fRec41[1])));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp3 + (fRec41[0] + fTemp4)) + -1.8873329999999999)))) + -124.17779999999999);
		...
		double fTemp9 = ((fTemp8 + fTemp7) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec43[1]))) + 100000.0));
		fVec3[0] = fTemp9;
		fRec47[0] = (fConst34 * ((2700.0 * (fTemp9 + fVec3[1])) - (fConst35 * fRec47[1])));
		fRec43[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp7 + (fRec47[0] + fTemp8)) + -2.617753)))) + -153.04618518518518);
		...
		double fTemp12 = ((fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec32[1]))) + 100000.0));
		fVec4[0] = fTemp12;
		fRec48[0] = (fConst31 * ((1500.0 * (fTemp12 + fVec4[1])) - (fConst32 * fRec48[1])));
		fRec32[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp10 + (fRec48[0] + fTemp11)) + -1.8873329999999999)))) + -124.17779999999999);
		...
		double fTemp15 = ((fTemp14 + fTemp13) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec22[1]))) + 100000.0));
		fVec5[0] = fTemp15;
		fRec49[0] = (fConst28 * ((820.0 * (fTemp15 + fVec5[1])) - (fConst29 * fRec49[1])));
		fRec22[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp13 + (fRec49[0] + fTemp14)) + -1.2569619999999999)))) + -96.711951219512201);
		...
		double fTemp29 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec14[2] + (fConst55 * (fTemp28 + (fConst57 * fRec14[0])))) * std::pow(10.0, (1.2 * fRec54[0])))));
		...
		double fTemp30 = (fConst50 * fRec56[1]);
		fRec56[0] = ((fConst14 * (((fConst44 * fRec57[0]) + (fConst62 * fRec57[1])) + (fConst44 * fRec57[2]))) - (fConst63 * ((fConst64 * fRec56[2]) + fTemp30)));
		double fTemp31 = (fConst60 * fRec55[1]);
		fRec55[0] = ((fRec56[2] + (fConst63 * (fTemp30 + (fConst64 * fRec56[0])))) - (fConst55 * ((fConst57 * fRec55[2]) + fTemp31)));
		double fTemp32 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec55[2] + (fConst55 * (fTemp31 + (fConst57 * fRec55[0])))) * std::pow(10.0, (0.80000000000000004 * fRec54[0])))));
		fRec62[0] = (0.0 - (fConst67 * ((fConst47 * fRec62[1]) - (fConst14 * (fTemp27 + fVec8[1])))));
		fRec61[0] = (fRec62[0] - (fConst9 * ((fConst49 * fRec61[2]) + (fConst50 * fRec61[1]))));
		double fTemp33 = (fRec61[2] + (fRec61[0] + (2.0 * fRec61[1])));
		fVec9[0] = fTemp33;
		fRec60[0] = ((fConst9 * ((fConst66 * fTemp33) + (fConst68 * fVec9[1]))) - (fConst69 * fRec60[1]));
		fRec59[0] = (fRec60[0] - (fConst65 * ((fConst70 * fRec59[2]) + (fConst60 * fRec59[1]))));
		double fTemp34 = std::max<double>(-1.0, std::min<double>(1.0, (fConst65 * ((((fConst59 * fRec59[0]) + (fConst71 * fRec59[1])) + (fConst59 * fRec59[2])) * std::pow(10.0, (2.0 * fRec54[0]))))));
		fRec64[0] = (0.0 - (fConst72 * ((fConst56 * fRec64[1]) - (fConst9 * (fTemp33 + fVec9[1])))));
		fRec63[0] = (fRec64[0] - (fConst65 * ((fConst70 * fRec63[2]) + (fConst60 * fRec63[1]))));
		double fTemp35 = std::max<double>(-1.0, std::min<double>(1.0, (fConst65 * ((fRec63[2] + (fRec63[0] + (2.0 * fRec63[1]))) * std::pow(10.0, (0.90000000000000002 * fRec54[0]))))));
		...
		fVec11[0] = fTemp39;
		fRec12[0] = (0.0 - (fConst5 * ((fConst6 * fRec12[1]) - (fTemp39 + fVec11[1]))));
