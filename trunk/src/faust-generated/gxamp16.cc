...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow10 = (fConst78 * pow(1e+01,(2 * fSlow4)));
	double 	fSlow11 = (fConst78 * pow(1e+01,(0.9 * fSlow4)));
	...
	for (int i=0; i<count; i++) {
		...
		fVec1[0] = fTemp1;
		fRec21[0] = (fConst28 * ((fVec1[0] - fVec1[1]) + (fConst27 * fRec21[1])));
		...
		double fTemp2 = (fRec17[1] - 2.5e+02);
		fVec2[0] = fTemp2;
		fRec23[0] = ((fConst32 * (fVec2[0] + fVec2[1])) + (fConst31 * fRec23[1]));
		fRec17[0] = Ftube6(0, (fRec23[0] + (fConst23 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))));
		fRec16[0] = ((fConst34 * ((fConst33 * fRec17[1]) + (fConst12 * fRec17[0]))) + (fConst14 * fRec16[1]));
		double fTemp3 = (fRec25[1] - 2.5e+02);
		fVec3[0] = fTemp3;
		fRec26[0] = ((fConst38 * (fVec3[0] + fVec3[1])) + (fConst37 * fRec26[1]));
		fRec25[0] = Ftube6(1, (fRec26[0] + fRec15[1]));
		...
		double fTemp4 = (fRec13[1] - 2.5e+02);
		fVec4[0] = fTemp4;
		fRec27[0] = ((fConst38 * (fVec4[0] + fVec4[1])) + (fConst37 * fRec27[1]));
		fRec13[0] = Ftube6(1, (fRec27[0] + fRec14[0]));
		...
		fRec29[0] = Ftube6(1, (fRec30[0] + fRec11[1]));
		...
		fRec10[0] = Ftube6(1, (fRec31[0] + fRec11[0]));
		...
		double fTemp21 = (fConst48 * fRec37[1]);
		double fTemp22 = (fConst54 * fRec38[1]);
		fRec42[0] = ((0.024937655860349125 * fTemp20) - (fConst72 * ((fConst70 * fRec42[2]) + (fConst68 * fRec42[1]))));
		double fTemp23 = (fRec42[2] + (fRec42[0] + (2 * fRec42[1])));
		fVec8[0] = fTemp23;
		fRec41[0] = ((fConst73 * ((fConst33 * fVec8[1]) + (fConst12 * fVec8[0]))) + (fConst14 * fRec41[1]));
		fRec40[0] = ((fConst75 * ((fConst74 * fRec41[1]) + (fConst61 * fRec41[0]))) + (fConst66 * fRec40[1]));
		fRec39[0] = (fRec40[0] - (fConst64 * ((fConst62 * fRec39[2]) + (fConst60 * fRec39[1]))));
		fRec38[0] = ((fConst64 * (((fConst59 * fRec39[0]) + (fConst76 * fRec39[1])) + (fConst59 * fRec39[2]))) - (fConst57 * ((fConst56 * fRec38[2]) + fTemp22)));
		fRec37[0] = ((fRec38[2] + (fConst57 * (fTemp22 + (fConst56 * fRec38[0])))) - (fConst51 * ((fConst50 * fRec37[2]) + fTemp21)));
		double fTemp24 = max(-1, min(1, (fSlow9 * (fRec37[2] + (fConst51 * (fTemp21 + (fConst50 * fRec37[0])))))));
		fRec48[0] = ((fConst75 * (fRec41[0] + fRec41[1])) + (fConst66 * fRec48[1]));
		fRec47[0] = (fRec48[0] - (fConst64 * ((fConst62 * fRec47[2]) + (fConst60 * fRec47[1]))));
		double fTemp25 = (fRec47[2] + (fRec47[0] + (2 * fRec47[1])));
		fVec9[0] = fTemp25;
		fRec46[0] = ((fConst86 * (fVec9[0] + fVec9[1])) + (fConst85 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst83 * ((fConst81 * fRec45[2]) + (fConst54 * fRec45[1]))));
		double fTemp26 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec10[0] = fTemp26;
		fRec44[0] = ((fConst88 * ((fConst87 * fVec10[1]) + (fConst49 * fVec10[0]))) + (fConst80 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst78 * ((fConst77 * fRec43[2]) + (fConst48 * fRec43[1]))));
		double fTemp27 = max(-1, min(1, (fSlow10 * (((fConst47 * fRec43[0]) + (fConst89 * fRec43[1])) + (fConst47 * fRec43[2])))));
		fRec50[0] = ((fConst88 * (fVec10[0] + fVec10[1])) + (fConst80 * fRec50[1]));
		fRec49[0] = (fRec50[0] - (fConst78 * ((fConst77 * fRec49[2]) + (fConst48 * fRec49[1]))));
		double fTemp28 = max(-1, min(1, (fSlow11 * (fRec49[2] + (fRec49[0] + (2 * fRec49[1]))))));
		double fTemp29 = (fConst48 * fRec51[1]);
		fRec53[0] = ((fConst86 * ((fConst90 * fVec9[1]) + (fConst55 * fVec9[0]))) + (fConst85 * fRec53[1]));
		fRec52[0] = (fRec53[0] - (fConst83 * ((fConst81 * fRec52[2]) + (fConst54 * fRec52[1]))));
		fRec51[0] = ((fConst83 * (((fConst53 * fRec52[0]) + (fConst91 * fRec52[1])) + (fConst53 * fRec52[2]))) - (fConst51 * ((fConst50 * fRec51[2]) + fTemp29)));
		double fTemp30 = max(-1, min(1, (fSlow12 * (fRec51[2] + (fConst51 * (fTemp29 + (fConst50 * fRec51[0])))))));
		...
		fVec11[0] = fTemp31;
		fRec36[0] = ((fConst92 * (fVec11[0] + fVec11[1])) + (fConst17 * fRec36[1]));
		...
		fRec4[0] = Ftube2(0, (fTemp33 + fRec5[0]));
		...
		fRec55[0] = Ftube2(1, (fRec56[0] + fTemp33));
		fRec54[0] = ((fConst34 * ((fConst33 * fRec55[1]) + (fConst12 * fRec55[0]))) + (fConst14 * fRec54[1]));
