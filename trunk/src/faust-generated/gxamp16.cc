...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec31[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec39[0] + fRec32[0]) - 2.617753)) - 153.04618518518518);
		...
		fRec41[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec44[0] + fRec42[0]) - 1.887333)) - 124.17779999999999);
		...
		fRec25[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec45[0] + fRec26[0]) - 1.887333)) - 124.17779999999999);
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec50[0] + fRec48[0]) - 1.256962)) - 96.7119512195122);
		...
		fRec20[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec51[0] + fRec21[0]) - 1.256962)) - 96.7119512195122);
