...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec15[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec21[0] + (fConst17 * (fRec20[0] * (fRec16[2] + (fRec16[0] + (2 * fRec16[1])))))) - 2.617753)) - 153.04618518518518);
		...
		fRec23[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec24[0] + fRec13[1]) - 1.887333)) - 124.17779999999999);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec25[0] + fRec12[0]) - 1.887333)) - 124.17779999999999);
		...
		fRec27[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec28[0] + fRec9[1]) - 1.256962)) - 96.7119512195122);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec29[0] + fRec9[0]) - 1.256962)) - 96.7119512195122);
