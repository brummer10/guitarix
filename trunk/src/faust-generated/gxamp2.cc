...
{
#undef fslider3
	fslider3_ = reg.registerVar("amp2.stage1.Pregain",N_(""),"SA",N_(""),&fslider3, -6.0, -2e+01, 2e+01, 0.1);
#undef fslider2
	fslider2_ = reg.registerVar("gxdistortion.drive",N_(""),"SA",N_(""),&fslider2, 0.35, 0.0, 1.0, 0.01);
#undef fslider1
