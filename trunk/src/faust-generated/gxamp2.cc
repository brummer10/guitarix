...
inline void Dsp::clear_state_f()
{
	...
	for (int l36 = 0; (l36 < 2); l36 = (l36 + 1)) fRec9[l36] = 0.0;
	for (int l37 = 0; (l37 < 3); l37 = (l37 + 1)) fRec8[l37] = 0.0;
	for (int l38 = 0; (l38 < 2); l38 = (l38 + 1)) fVec8[l38] = 0.0;
	for (int l39 = 0; (l39 < 2); l39 = (l39 + 1)) fRec38[l39] = 0.0;
	for (int l40 = 0; (l40 < 2); l40 = (l40 + 1)) fRec7[l40] = 0.0;
	for (int l41 = 0; (l41 < 2); l41 = (l41 + 1)) fRec6[l41] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec24[0] = (fSlow3 + (0.999 * fRec24[1]));
		fRec23[0] = ((fTemp0 * fRec24[0]) - (fConst23 * ((fConst24 * fRec23[2]) + (fConst25 * fRec23[1]))));
		...
		fVec5[0] = fTemp17;
		fRec36[0] = (fConst60 * ((2700.0 * (fTemp17 + fVec5[1])) - (fConst61 * fRec36[1])));
		...
		fRec37[0] = (fConst63 * ((fConst64 * fRec37[1]) + (0.025000000000000001 * (fRec13[0] - fRec13[1]))));
		double fTemp18 = (iSlow1 ? fRec37[0] : fRec12[0]);
		fVec6[0] = fTemp18;
		fRec11[0] = (fConst6 * ((0.77000000000000002 * (fTemp18 + fVec6[1])) - (fConst7 * fRec11[1])));
		...
		fVec8[0] = fTemp22;
		fRec38[0] = (fConst66 * ((1500.0 * (fTemp22 + fVec8[1])) - (fConst67 * fRec38[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp20 + (fRec38[0] + fTemp21)) + -1.3646160000000001)))) + -159.0256);
		fRec6[0] = ((0.025000000000000001 * ((fConst4 * fRec7[0]) + (fConst26 * fRec7[1]))) - (fConst27 * fRec6[1]));
		fRec39[0] = (fConst63 * ((fConst64 * fRec39[1]) + (0.025000000000000001 * (fRec7[0] - fRec7[1]))));
		double fTemp23 = (iSlow1 ? fRec39[0] : fRec6[0]);
		fVec9[0] = fTemp23;
		fRec5[0] = (fConst6 * ((0.77000000000000002 * (fTemp23 + fVec9[1])) - (fConst7 * fRec5[1])));
		fRec40[0] = (fSlow5 + (0.999 * fRec40[1]));
		fRec4[0] = ((fRec5[0] * fRec40[0]) - ((fConst69 * fRec4[1]) + (0.85026841000000009 * fRec4[2])));
		double fTemp24 = (fRec4[0] - (1.0589999999999999 * fRec4[1]));
		fVec10[0] = fTemp24;
		fRec3[0] = ((0.93028479253239138 * (fTemp24 + fVec10[1])) - (0.86056958506478287 * fRec3[1]));
		...
		fVec11[0] = fTemp27;
		fRec41[0] = (fConst71 * ((820.0 * (fTemp27 + fVec11[1])) - (fConst72 * fRec41[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp25 + (fRec41[0] + fTemp26)) + -0.96213199999999999)))) + -132.6668292682927);
		fRec0[0] = ((0.025000000000000001 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec42[0] = (fConst63 * ((fConst64 * fRec42[1]) + (0.025000000000000001 * (fRec1[0] - fRec1[1]))));
		buf[i] = FAUSTFLOAT((0.77000000000000002 * (iSlow0 ? fRec42[0] : fRec0[0])));
		fRec10[1] = fRec10[0];
		fRec24[1] = fRec24[0];
		fRec23[2] = fRec23[1];
		fRec23[1] = fRec23[0];
