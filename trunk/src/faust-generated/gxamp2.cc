...
#define fslider3 (*fslider3_)
	...
	double 	fSlow8 = (fConst8 * pow(1e+01,(2 * fSlow2)));
	...
	for (int i=0; i<ReCount; i++) {
		...
		double fTemp2 = (fRec25[0] + (fRec25[2] + (2 * fRec25[1])));
		fVec0[0] = fTemp2;
		...
		fRec27[0] = ((fConst22 * ((fConst48 * fRec28[1]) + (fConst17 * (fRec28[2] + fRec28[0])))) - (fConst46 * ((fConst45 * fRec27[2]) + fTemp7)));
		fRec26[0] = ((fRec27[2] + (fConst46 * (fTemp7 + (fConst45 * fRec27[0])))) - (fConst44 * ((fConst43 * fRec26[2]) + fTemp6)));
		double fTemp8 = max((double)-1, min((double)1, (fSlow7 * (fRec26[2] + (fConst44 * (fTemp6 + (fConst43 * fRec26[0])))))));
		...
		double fTemp9 = max((double)-1, min((double)1, (fSlow8 * ((fConst50 * fRec30[1]) + (fConst6 * (fRec30[2] + fRec30[0]))))));
		double fTemp10 = (fConst7 * fRec32[1]);
		...
		fRec32[0] = ((fConst15 * ((fConst52 * fRec33[1]) + (fConst12 * (fRec33[2] + fRec33[0])))) - (fConst44 * ((fConst43 * fRec32[2]) + fTemp10)));
		double fTemp11 = max((double)-1, min((double)1, (fSlow9 * (fRec32[2] + (fConst44 * (fTemp10 + (fConst43 * fRec32[0])))))));
		...
		double fTemp13 = (fRec35[0] * ((fSlow10 * fRec17[0]) + (fTemp1 * ((fSlow5 * fRec16[0]) + (fTemp0 * (1 + (fSlow3 * (3 - (4 * fabs((fTemp1 * fTemp0)))))))))));
		fVec4[0] = fTemp13;
		...
		fRec36[0] = ((fConst60 * (fRec13[1] + fRec13[2])) + (fConst59 * fRec36[1]));
		...
		fRec37[0] = ((fConst66 * (fRec8[1] + fRec8[2])) + (fConst65 * fRec37[1]));
		...
		double fTemp15 = (1.059 * fRec4[1]);
		fVec6[0] = (fRec4[0] - fTemp15);
		fRec3[0] = ((0.9302847925323914 * ((fRec4[0] + fVec6[1]) - fTemp15)) - (0.8605695850647829 * fRec3[1]));
		fRec2[0] = (fRec3[0] - ((1.8405051250752198 * fRec2[1]) + (0.8612942439318627 * fRec2[2])));
		fRec38[0] = ((fConst70 * (fRec1[1] + fRec1[2])) + (fConst69 * fRec38[1]));
