...
inline void Dsp::clear_state_f()
{
	...
	for (int l28 = 0; (l28 < 3); l28 = (l28 + 1)) fRec13[l28] = 0.0;
	...
	for (int l39 = 0; (l39 < 3); l39 = (l39 + 1)) fRec4[l39] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec17[2] + (fConst41 * (fTemp3 + (fConst43 * fRec17[0])))))));
		...
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec25[2] + (fConst41 * (fTemp6 + (fConst43 * fRec25[0])))))));
		...
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst45 * fRec29[0]) + (fConst57 * fRec29[1])) + (fConst45 * fRec29[2])))));
		...
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec33[2] + (fRec33[0] + (2.0 * fRec33[1]))))));
		...
		double fTemp12 = (1.0 - fRec24[0]);
		double fTemp13 = (fRec10[0] * ((fSlow3 * fRec16[0]) + (((fTemp12 * ((fSlow9 * ((4.0 * (1.0 - std::fabs((fTemp12 * fTemp0)))) + -1.0)) + 1.0)) + (fSlow10 * fRec24[0])) * fTemp0)));
		fVec4[0] = fTemp13;
		...
		double fTemp14 = (fRec10[0] * fRec11[0]);
		fVec5[0] = fTemp14;
		fRec9[0] = ((0.93028479253239138 * (fTemp14 + fVec5[1])) - (0.86056958506478287 * fRec9[1]));
		...
		double fTemp15 = (fRec4[0] - (1.0589999999999999 * fRec4[1]));
		fVec6[0] = fTemp15;
		...
		fRec38[0] = (fConst68 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst69 * fRec38[1])));
