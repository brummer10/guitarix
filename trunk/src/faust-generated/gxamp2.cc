...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow5 = (1.000000000000001e-05 * fSlow1);
	double 	fSlow6 = (2 * (fSlow3 - 0.5));
	double 	fSlow7 = (1 - max(0, fSlow6));
	double 	fSlow8 = pow(1e+01,(0.8 * fSlow3));
	double 	fSlow9 = (fConst41 * pow(1e+01,(2 * fSlow3)));
	double 	fSlow10 = (fConst41 * pow(1e+01,(0.9 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (fConst10 * fRec13[1]);
		double fTemp2 = (fConst16 * fRec14[1]);
		fRec18[0] = ((fTemp0 * fRec11[0]) - (fConst34 * ((fConst32 * fRec18[2]) + (fConst30 * fRec18[1]))));
		double fTemp3 = (fRec18[2] + (fRec18[0] + (2 * fRec18[1])));
		fVec0[0] = fTemp3;
		fRec17[0] = ((fConst36 * ((fConst35 * fVec0[1]) + (fConst0 * fVec0[0]))) + (fConst2 * fRec17[1]));
		fRec16[0] = ((fConst38 * ((fConst37 * fRec17[1]) + (fConst23 * fRec17[0]))) + (fConst28 * fRec16[1]));
		fRec15[0] = (fRec16[0] - (fConst26 * ((fConst24 * fRec15[2]) + (fConst22 * fRec15[1]))));
		fRec14[0] = ((fConst26 * (((fConst21 * fRec15[0]) + (fConst39 * fRec15[1])) + (fConst21 * fRec15[2]))) - (fConst19 * ((fConst18 * fRec14[2]) + fTemp2)));
		fRec13[0] = ((fRec14[2] + (fConst19 * (fTemp2 + (fConst18 * fRec14[0])))) - (fConst13 * ((fConst12 * fRec13[2]) + fTemp1)));
		double fTemp4 = max(-1, min(1, (fSlow8 * (fRec13[2] + (fConst13 * (fTemp1 + (fConst12 * fRec13[0])))))));
		fRec24[0] = ((fConst38 * (fRec17[0] + fRec17[1])) + (fConst28 * fRec24[1]));
		fRec23[0] = (fRec24[0] - (fConst26 * ((fConst24 * fRec23[2]) + (fConst22 * fRec23[1]))));
		double fTemp5 = (fRec23[2] + (fRec23[0] + (2 * fRec23[1])));
		fVec1[0] = fTemp5;
		fRec22[0] = ((fConst49 * (fVec1[0] + fVec1[1])) + (fConst48 * fRec22[1]));
		fRec21[0] = (fRec22[0] - (fConst46 * ((fConst44 * fRec21[2]) + (fConst16 * fRec21[1]))));
		double fTemp6 = (fRec21[2] + (fRec21[0] + (2 * fRec21[1])));
		fVec2[0] = fTemp6;
		fRec20[0] = ((fConst51 * ((fConst50 * fVec2[1]) + (fConst11 * fVec2[0]))) + (fConst43 * fRec20[1]));
		fRec19[0] = (fRec20[0] - (fConst41 * ((fConst40 * fRec19[2]) + (fConst10 * fRec19[1]))));
		double fTemp7 = max(-1, min(1, (fSlow9 * (((fConst9 * fRec19[0]) + (fConst52 * fRec19[1])) + (fConst9 * fRec19[2])))));
		fRec26[0] = ((fConst51 * (fVec2[0] + fVec2[1])) + (fConst43 * fRec26[1]));
		fRec25[0] = (fRec26[0] - (fConst41 * ((fConst40 * fRec25[2]) + (fConst10 * fRec25[1]))));
		double fTemp8 = max(-1, min(1, (fSlow10 * (fRec25[2] + (fRec25[0] + (2 * fRec25[1]))))));
		double fTemp9 = (fConst10 * fRec27[1]);
		fRec29[0] = ((fConst49 * ((fConst53 * fVec1[1]) + (fConst17 * fVec1[0]))) + (fConst48 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst46 * ((fConst44 * fRec28[2]) + (fConst16 * fRec28[1]))));
		fRec27[0] = ((fConst46 * (((fConst15 * fRec28[0]) + (fConst54 * fRec28[1])) + (fConst15 * fRec28[2]))) - (fConst13 * ((fConst12 * fRec27[2]) + fTemp9)));
		double fTemp10 = max(-1, min(1, (fSlow11 * (fRec27[2] + (fConst13 * (fTemp9 + (fConst12 * fRec27[0])))))));
		...
		fVec3[0] = fTemp11;
		fRec12[0] = ((fConst55 * (fVec3[0] + fVec3[1])) + (fConst7 * fRec12[1]));
		fRec30[0] = (fSlow13 + (0.999 * fRec30[1]));
		double fTemp12 = (fRec9[1] - 2.5e+02);
		fVec4[0] = fTemp12;
		fRec31[0] = ((fConst59 * (fVec4[0] + fVec4[1])) + (fConst58 * fRec31[1]));
		fRec9[0] = Ftube2(0, (fRec31[0] + (fRec30[0] * ((fSlow12 * fRec12[0]) + (fTemp0 * ((fSlow7 * fRec11[0]) + (fRec10[0] * (1 + (fSlow4 * ((4 - (4 * fabs((fTemp0 * fRec10[0])))) - 1))))))))));
		...
		fRec6[0] = Ftube2(1, (fRec32[0] + (fRec30[0] * fRec7[0])));
