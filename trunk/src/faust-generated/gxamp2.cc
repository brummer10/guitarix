...
inline void Dsp::clear_state_f()
{
	...
	for (int l32 = 0; (l32 < 2); l32 = (l32 + 1)) fRec11[l32] = 0.0;
	...
	for (int l42 = 0; (l42 < 3); l42 = (l42 + 1)) fRec4[l42] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec23[0] = ((fTemp0 * fRec24[0]) - (fConst22 * ((fConst27 * fRec23[2]) + (fConst28 * fRec23[1]))));
		double fTemp1 = (fRec23[2] + (fRec23[0] + (2.0 * fRec23[1])));
		fVec0[0] = fTemp1;
		fRec22[0] = ((fConst22 * ((fConst26 * fTemp1) + (fConst29 * fVec0[1]))) - (fConst30 * fRec22[1]));
		...
		fVec1[0] = fTemp2;
		fRec19[0] = ((fConst14 * ((fConst16 * fTemp2) + (fConst35 * fVec1[1]))) - (fConst37 * fRec19[1]));
		fRec18[0] = (fRec19[0] - (fConst9 * ((fConst38 * fRec18[2]) + (fConst39 * fRec18[1]))));
		double fTemp3 = (fConst49 * fRec17[1]);
		fRec17[0] = ((fConst9 * (((fConst11 * fRec18[0]) + (fConst40 * fRec18[1])) + (fConst11 * fRec18[2]))) - (fConst44 * ((fConst46 * fRec17[2]) + fTemp3)));
		fRec25[0] = (fSlow2 + (0.999 * fRec25[1]));
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec17[2] + (fConst44 * (fTemp3 + (fConst46 * fRec17[0])))) * std::pow(10.0, (1.2 * fRec25[0])))));
		fRec29[0] = ((fConst50 * fRec22[1]) - (fConst18 * ((fConst19 * fRec29[1]) - (fConst13 * fRec22[0]))));
		fRec28[0] = (fRec29[0] - (fConst14 * ((fConst31 * fRec28[2]) + (fConst34 * fRec28[1]))));
		double fTemp5 = (fConst39 * fRec27[1]);
		fRec27[0] = ((fConst14 * (((fConst33 * fRec28[0]) + (fConst51 * fRec28[1])) + (fConst33 * fRec28[2]))) - (fConst52 * ((fConst53 * fRec27[2]) + fTemp5)));
		double fTemp6 = (fConst49 * fRec26[1]);
		fRec26[0] = ((fRec27[2] + (fConst52 * (fTemp5 + (fConst53 * fRec27[0])))) - (fConst44 * ((fConst46 * fRec26[2]) + fTemp6)));
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec26[2] + (fConst44 * (fTemp6 + (fConst46 * fRec26[0])))) * std::pow(10.0, (0.80000000000000004 * fRec25[0])))));
		fRec33[0] = (0.0 - (fConst56 * ((fConst36 * fRec33[1]) - (fConst14 * (fTemp2 + fVec1[1])))));
		fRec32[0] = (fRec33[0] - (fConst9 * ((fConst38 * fRec32[2]) + (fConst39 * fRec32[1]))));
		double fTemp8 = (fRec32[2] + (fRec32[0] + (2.0 * fRec32[1])));
		fVec2[0] = fTemp8;
		fRec31[0] = ((fConst9 * ((fConst55 * fTemp8) + (fConst57 * fVec2[1]))) - (fConst58 * fRec31[1]));
		fRec30[0] = (fRec31[0] - (fConst54 * ((fConst59 * fRec30[2]) + (fConst49 * fRec30[1]))));
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, (fConst54 * ((((fConst48 * fRec30[0]) + (fConst60 * fRec30[1])) + (fConst48 * fRec30[2])) * std::pow(10.0, (2.0 * fRec25[0]))))));
		fRec35[0] = (0.0 - (fConst61 * ((fConst45 * fRec35[1]) - (fConst9 * (fTemp8 + fVec2[1])))));
		fRec34[0] = (fRec35[0] - (fConst54 * ((fConst59 * fRec34[2]) + (fConst49 * fRec34[1]))));
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fConst54 * ((fRec34[2] + (fRec34[0] + (2.0 * fRec34[1]))) * std::pow(10.0, (0.90000000000000002 * fRec25[0]))))));
		...
		fVec3[0] = fTemp11;
		fRec16[0] = (0.0 - (fConst5 * ((fConst6 * fRec16[1]) - (fTemp11 + fVec3[1]))));
		double fTemp12 = (2.0 * (fRec25[0] + -0.5));
		double fTemp13 = (1.0 - fRec24[0]);
		double fTemp14 = (fRec10[0] * ((fRec16[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp12)))) + (fTemp0 * ((fTemp13 * ((1.25 * (fRec25[0] * ((4.0 * (1.0 - std::fabs((fTemp0 * fTemp13)))) + -1.0))) + 1.0)) + (fRec24[0] * (1.0 - std::max<double>(0.0, fTemp12)))))));
		fVec4[0] = fTemp14;
		...
		double fTemp15 = (0.92544984225177063 * (fRec14[0] + fRec14[2]));
		...
		double fTemp18 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp15 + (fRec36[0] + fTemp16)) + -2.2961499999999999))));
		fRec13[0] = ((fTemp18 + (0.00085042592592592592 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp18))) + 100000.0))) + -250.0);
		...
		fVec7[0] = fTemp22;
		fRec37[0] = (fConst66 * ((1500.0 * (fTemp22 + fVec7[1])) - (fConst67 * fRec37[1])));
		double fTemp23 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp20 + (fRec37[0] + fTemp21)) + -1.6755869999999999))));
		fRec7[0] = ((fTemp23 + (0.001117058 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp23))) + 100000.0))) + -250.0);
		...
		fRec4[0] = ((fRec5[0] * fRec38[0]) - ((fConst69 * fRec4[1]) + (0.85026841000000009 * fRec4[2])));
		...
		fVec9[0] = fTemp27;
		fRec39[0] = (fConst71 * ((820.0 * (fTemp27 + fVec9[1])) - (fConst72 * fRec39[1])));
		double fTemp28 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp25 + (fRec39[0] + fTemp26)) + -1.1304620000000001))));
		fRec1[0] = ((fTemp28 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp28))) + 100000.0))) + -250.0);
