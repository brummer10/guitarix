...
void init(int samplingFreq)
{
	...
	fConst9 = (1.0 / fConst8);
	fConst10 = (1 + ((fConst9 - 1.0) / fConst8));
	fConst11 = (1.0 / faustpower<2>(fConst8));
	fConst12 = (2 * (1 - fConst11));
	fConst13 = (1.0 / (1 + ((1.0 + fConst9) / fConst8)));
	...
	fConst40 = (1 + ((fConst9 - 1.0000000000000004) / fConst8));
	fConst41 = (1.0 / (1 + ((fConst9 + 1.0000000000000004) / fConst8)));
	fConst42 = (1 + fConst9);
...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = ((fRec12[2] + (fConst19 * (fTemp2 + (fConst18 * fRec12[0])))) - (fConst13 * (fTemp1 + (fConst10 * fRec11[2]))));
		double fTemp4 = max(-1, min(1, (fSlow8 * (fRec11[2] + (fConst13 * (fTemp1 + (fConst10 * fRec11[0])))))));
		...
		fVec2[0] = fTemp6;
		fRec18[0] = ((fConst51 * ((fConst50 * fVec2[1]) + (fConst9 * fVec2[0]))) + (fConst43 * fRec18[1]));
		fRec17[0] = (fRec18[0] - (fConst41 * ((fConst40 * fRec17[2]) + (fConst12 * fRec17[1]))));
		double fTemp7 = max(-1, min(1, (fSlow9 * (((fConst11 * fRec17[0]) + (fConst52 * fRec17[1])) + (fConst11 * fRec17[2])))));
		fRec24[0] = ((fConst51 * (fVec2[0] + fVec2[1])) + (fConst43 * fRec24[1]));
		fRec23[0] = (fRec24[0] - (fConst41 * ((fConst40 * fRec23[2]) + (fConst12 * fRec23[1]))));
		double fTemp8 = max(-1, min(1, (fSlow10 * (fRec23[2] + (fRec23[0] + (2 * fRec23[1]))))));
		double fTemp9 = (fConst12 * fRec25[1]);
		...
		fRec25[0] = ((fConst46 * (((fConst15 * fRec26[0]) + (fConst54 * fRec26[1])) + (fConst15 * fRec26[2]))) - (fConst13 * ((fConst10 * fRec25[2]) + fTemp9)));
		double fTemp10 = max(-1, min(1, (fSlow11 * (fRec25[2] + (fConst13 * (fTemp9 + (fConst10 * fRec25[0])))))));
