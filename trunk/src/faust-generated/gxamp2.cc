...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow3 = (0.0010000000000000009 * (1 - (0.01 * fSlow2)));
	double 	fSlow4 = fslider3;
	double 	fSlow5 = (1.25 * fSlow4);
	double 	fSlow6 = (1.000000000000001e-05 * fSlow2);
	double 	fSlow7 = (2 * (fSlow4 - 0.5));
	double 	fSlow8 = (1 - max(0, fSlow7));
	double 	fSlow9 = pow(1e+01,(0.8 * fSlow4));
	double 	fSlow10 = (fConst41 * pow(1e+01,(2 * fSlow4)));
	double 	fSlow11 = (fConst41 * pow(1e+01,(0.9 * fSlow4)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp0 = pow(10,(0.05 * fRec7[0]));
		fRec11[0] = (fSlow3 + (0.999 * fRec11[1]));
		double fTemp1 = (double)input0[i];
		fRec12[0] = (fSlow6 + (0.999 * fRec12[1]));
		double fTemp2 = (fConst10 * fRec14[1]);
		double fTemp3 = (fConst16 * fRec15[1]);
		fRec19[0] = ((fTemp1 * fRec12[0]) - (fConst34 * ((fConst32 * fRec19[2]) + (fConst30 * fRec19[1]))));
		double fTemp4 = (fRec19[2] + (fRec19[0] + (2 * fRec19[1])));
		fVec0[0] = fTemp4;
		fRec18[0] = ((fConst36 * ((fConst35 * fVec0[1]) + (fConst0 * fVec0[0]))) + (fConst2 * fRec18[1]));
		fRec17[0] = ((fConst38 * ((fConst37 * fRec18[1]) + (fConst23 * fRec18[0]))) + (fConst28 * fRec17[1]));
		fRec16[0] = (fRec17[0] - (fConst26 * ((fConst24 * fRec16[2]) + (fConst22 * fRec16[1]))));
		fRec15[0] = ((fConst26 * (((fConst21 * fRec16[0]) + (fConst39 * fRec16[1])) + (fConst21 * fRec16[2]))) - (fConst19 * ((fConst18 * fRec15[2]) + fTemp3)));
		fRec14[0] = ((fRec15[2] + (fConst19 * (fTemp3 + (fConst18 * fRec15[0])))) - (fConst13 * ((fConst12 * fRec14[2]) + fTemp2)));
		double fTemp5 = max(-1, min(1, (fSlow9 * (fRec14[2] + (fConst13 * (fTemp2 + (fConst12 * fRec14[0])))))));
		fRec25[0] = ((fConst38 * (fRec18[0] + fRec18[1])) + (fConst28 * fRec25[1]));
		fRec24[0] = (fRec25[0] - (fConst26 * ((fConst24 * fRec24[2]) + (fConst22 * fRec24[1]))));
		double fTemp6 = (fRec24[2] + (fRec24[0] + (2 * fRec24[1])));
		fVec1[0] = fTemp6;
		fRec23[0] = ((fConst49 * (fVec1[0] + fVec1[1])) + (fConst48 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst46 * ((fConst44 * fRec22[2]) + (fConst16 * fRec22[1]))));
		double fTemp7 = (fRec22[2] + (fRec22[0] + (2 * fRec22[1])));
		fVec2[0] = fTemp7;
		fRec21[0] = ((fConst51 * ((fConst50 * fVec2[1]) + (fConst11 * fVec2[0]))) + (fConst43 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fConst41 * ((fConst40 * fRec20[2]) + (fConst10 * fRec20[1]))));
		double fTemp8 = max(-1, min(1, (fSlow10 * (((fConst9 * fRec20[0]) + (fConst52 * fRec20[1])) + (fConst9 * fRec20[2])))));
		fRec27[0] = ((fConst51 * (fVec2[0] + fVec2[1])) + (fConst43 * fRec27[1]));
		fRec26[0] = (fRec27[0] - (fConst41 * ((fConst40 * fRec26[2]) + (fConst10 * fRec26[1]))));
		double fTemp9 = max(-1, min(1, (fSlow11 * (fRec26[2] + (fRec26[0] + (2 * fRec26[1]))))));
		double fTemp10 = (fConst10 * fRec28[1]);
		fRec30[0] = ((fConst49 * ((fConst53 * fVec1[1]) + (fConst17 * fVec1[0]))) + (fConst48 * fRec30[1]));
		fRec29[0] = (fRec30[0] - (fConst46 * ((fConst44 * fRec29[2]) + (fConst16 * fRec29[1]))));
		fRec28[0] = ((fConst46 * (((fConst15 * fRec29[0]) + (fConst54 * fRec29[1])) + (fConst15 * fRec29[2]))) - (fConst13 * ((fConst12 * fRec28[2]) + fTemp10)));
		double fTemp11 = max(-1, min(1, (fSlow12 * (fRec28[2] + (fConst13 * (fTemp10 + (fConst12 * fRec28[0])))))));
		...
		fVec3[0] = fTemp12;
		fRec13[0] = ((fConst55 * (fVec3[0] + fVec3[1])) + (fConst7 * fRec13[1]));
		double fTemp13 = (fRec10[1] - 2.5e+02);
		fVec4[0] = fTemp13;
		fRec31[0] = ((fConst59 * (fVec4[0] + fVec4[1])) + (fConst58 * fRec31[1]));
		fRec10[0] = Ftube2(0, (fRec31[0] + (fTemp0 * ((fSlow13 * fRec13[0]) + (fTemp1 * ((fSlow8 * fRec12[0]) + (fRec11[0] * (1 + (fSlow5 * ((4 - (4 * fabs((fTemp1 * fRec11[0])))) - 1))))))))));
		fRec9[0] = ((fConst60 * ((fConst35 * fRec10[1]) + (fConst0 * fRec10[0]))) + (fConst2 * fRec9[1]));
		fRec8[0] = ((fConst61 * (fRec9[0] + fRec9[1])) + (fConst7 * fRec8[1]));
		double fTemp14 = (fRec6[1] - 2.5e+02);
		fVec5[0] = fTemp14;
		fRec32[0] = ((fConst65 * (fVec5[0] + fVec5[1])) + (fConst64 * fRec32[1]));
		fRec6[0] = Ftube2(1, (fRec32[0] + (fRec8[0] * fTemp0)));
		fRec5[0] = ((fConst60 * ((fConst35 * fRec6[1]) + (fConst0 * fRec6[0]))) + (fConst2 * fRec5[1]));
		fRec4[0] = ((fConst61 * (fRec5[0] + fRec5[1])) + (fConst7 * fRec4[1]));
		fRec2[0] = ((fRec4[0] * pow(10,(0.05 * fRec3[0]))) - ((0.8502684100000001 * fRec2[2]) + (fConst4 * fRec2[1])));
		double fTemp15 = (fRec1[1] - 2.5e+02);
		fVec6[0] = fTemp15;
		fRec33[0] = ((fConst69 * (fVec6[0] + fVec6[1])) + (fConst68 * fRec33[1]));
		fRec1[0] = Ftube2(1, ((fRec33[0] + fRec2[0]) - (1.059 * fRec2[1])));
