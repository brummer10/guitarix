...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec25[0] = ((fTemp4 * fRec16[0]) - (fConst28 * ((fConst26 * fRec25[2]) + (fConst24 * fRec25[1]))));
		...
		fRec15[0] = ((fRec35[0] * ((fSlow10 * fRec17[0]) + (fTemp4 * ((fTemp3 * (1 + (fSlow5 * ((4 - (4 * fabs((fTemp4 * fTemp3)))) - 1)))) + (fSlow4 * fRec16[0]))))) - (fTemp2 + fRec15[2]));
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec36[0] + fRec14[0]) - 2.29615)) - 164.9574074074074);
		...
		fRec10[0] = ((fRec35[0] * fRec11[0]) - (fTemp1 + fRec10[2]));
		double fTemp17 = (fRec10[2] + (fRec10[0] + fTemp1));
		fVec5[0] = fTemp17;
		fRec9[0] = ((1.0000000000000002 * (fVec5[0] + fVec5[1])) - (0.9999999999999998 * fRec9[1]));
		fRec37[0] = ((fConst66 * fRec37[1]) + (fConst65 * (fRec8[1] + fRec8[2])));
		fRec8[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec37[0] + fRec9[0]) - 1.675587)) - 138.2942);
		...
		fRec3[0] = (fRec4[0] - (fRec3[2] + ((1.059 * fRec4[1]) + fTemp0)));
		double fTemp18 = (fRec3[2] + (fRec3[0] + fTemp0));
		fVec6[0] = fTemp18;
		fRec2[0] = ((1.0000000000000002 * (fVec6[0] + fVec6[1])) - (0.9999999999999998 * fRec2[1]));
		fRec38[0] = ((fConst70 * fRec38[1]) + (fConst69 * (fRec1[1] + fRec1[2])));
		fRec1[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec38[0] + fRec2[0]) - 1.130462)) - 112.13878048780487);
