...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec3[0] = fTemp19;
		fRec20[0] = ((fConst42 * fRec20[1]) + (fConst41 * (fVec3[1] + fVec3[0])));
		...
		fRec15[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec40[0] + fRec16[0]) - 1.25724)) - 83.43555555555557);
		...
		fRec42[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec45[0] + fRec43[0]) - 0.776162)) - 78.25586666666666);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec46[0] + fRec9[0]) - 0.776162)) - 78.25586666666666);
		...
		fRec48[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec51[0] + fRec49[0]) - 0.445487)) - 75.67231707317073);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec52[0] + fRec3[0]) - 0.445487)) - 75.67231707317073);
