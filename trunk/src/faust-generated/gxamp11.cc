...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp33 = (fTemp31 + fTemp32) / (Ranode(TUBE_TABLE_12AU7_68k, fRec20[1]) + 1e+05);
		fVec7[0] = fTemp33;
		fRec46[0] = fConst64 * (2.7e+03 * (fTemp33 + fVec7[1]) - fConst63 * fRec46[1]);
		fRec20[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp32 + fRec46[0] + fTemp31 + -1.25724) + -83.43555555555557;
		double fTemp34 = fRec20[0] - fRec20[1];
		fRec19[0] = fConst8 * (fConst7 * fTemp34 - fConst3 * fRec19[1]);
		fRec47[0] = fConst11 * (fConst10 * fRec47[1] + 0.1 * fTemp34);
		...
		double fTemp37 = (fTemp35 + fTemp36) / (Ranode(TUBE_TABLE_12AU7_250k, fRec49[1]) + 1e+05);
		fVec8[0] = fTemp37;
		fRec52[0] = fConst67 * (1.5e+03 * (fTemp37 + fVec8[1]) - fConst66 * fRec52[1]);
		fRec49[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp36 + fRec52[0] + fTemp35 + -0.776162) + -78.25586666666666;
		double fTemp38 = fRec49[0] - fRec49[1];
		fRec48[0] = fConst8 * (fConst7 * fTemp38 - fConst3 * fRec48[1]);
		fRec53[0] = fConst11 * (fConst10 * fRec53[1] + 0.1 * fTemp38);
		fRec18[0] = ((iSlow1) ? fRec53[0] : fRec48[0]) - ((iSlow1) ? fRec47[0] : fRec19[0]);
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_12AU7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp42;
		fRec54[0] = fConst67 * (1.5e+03 * (fTemp42 + fVec10[1]) - fConst66 * fRec54[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp41 + fRec54[0] + fTemp40 + -0.776162) + -78.25586666666666;
		double fTemp43 = fRec13[0] - fRec13[1];
		fRec12[0] = fConst8 * (fConst7 * fTemp43 - fConst3 * fRec12[1]);
		fRec55[0] = fConst11 * (fConst10 * fRec55[1] + 0.1 * fTemp43);
		fRec5[0] = ((iSlow1) ? fRec55[0] : fRec12[0]) + ((iSlow1) ? fRec11[0] : fRec6[0]);
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp46;
		fRec56[0] = fConst6 * (8.2e+02 * (fTemp46 + fVec11[1]) - fConst5 * fRec56[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp45 + fRec56[0] + fTemp44 + -0.445487) + -75.67231707317073;
		double fTemp47 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst8 * (fConst7 * fTemp47 - fConst3 * fRec0[1]);
		fRec57[0] = fConst11 * (fConst10 * fRec57[1] + 0.1 * fTemp47);
