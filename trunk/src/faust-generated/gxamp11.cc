...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	fConst13 = (3.1415926535897931 / fConst0);
	fConst14 = (1.0 / (fConst13 + 1.0));
	fConst15 = (1.0 - fConst13);
	fConst16 = (1.0 / std::tan((414.69023027385271 / fConst0)));
	...
	fConst29 = (fConst22 + 1.0);
	fConst30 = (1.0 / (fConst21 * fConst29));
	fConst31 = (fConst27 + 1.0);
	fConst32 = (1.0 / fConst31);
	fConst33 = (1.0 - fConst27);
	fConst34 = std::tan((47123.889803846898 / fConst0));
	...
	fConst40 = mydsp_faustpower2_f(fConst26);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		buf[i] = FAUSTFLOAT(((iSlow0 ? fRec57[0] : fRec0[0]) * fRec58[0]));
		fRec9[1] = fRec9[0];
		fRec8[2] = fRec8[1];
		fRec8[1] = fRec8[0];
		fVec0[1] = fVec0[0];
