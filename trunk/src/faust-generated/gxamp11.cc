...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp35 = (fTemp34 + fTemp33) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp35;
		fRec51[0] = fConst71 * (2700.0 * (fTemp35 + fVec8[1]) - fConst72 * fRec51[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(fTemp33 + fRec51[0] + fTemp34 + -1.2572399999999999))) + -83.435555555555567;
		fRec24[0] = 0.10000000000000001 * (fConst4 * fRec25[0] + fConst11 * fRec25[1]) - fConst12 * fRec24[1];
		fRec52[0] = fConst14 * (fConst15 * fRec52[1] + 0.10000000000000001 * (fRec25[0] - fRec25[1]));
		fRec17[0] = ((iSlow1) ? fRec23[0] : fRec18[0]) - ((iSlow1) ? fRec52[0] : fRec24[0]);
		...
		double fTemp39 = (fTemp38 + fTemp37) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp39;
		fRec54[0] = fConst17 * (1500.0 * (fTemp39 + fVec10[1]) - fConst18 * fRec54[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp37 + fRec54[0] + fTemp38 + -0.77616200000000002))) + -78.255866666666662;
		fRec12[0] = 0.10000000000000001 * (fConst4 * fRec13[0] + fConst11 * fRec13[1]) - fConst12 * fRec12[1];
		fRec55[0] = fConst14 * (fConst15 * fRec55[1] + 0.10000000000000001 * (fRec13[0] - fRec13[1]));
		fRec5[0] = ((iSlow1) ? fRec11[0] : fRec6[0]) + ((iSlow1) ? fRec55[0] : fRec12[0]);
		...
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(fTemp40 + fRec56[0] + fTemp41 + -0.44548700000000002))) + -75.672317073170731;
		fRec0[0] = 0.10000000000000001 * (fConst4 * fRec1[0] + fConst11 * fRec1[1]) - fConst12 * fRec0[1];
		fRec57[0] = fConst14 * (fConst15 * fRec57[1] + 0.10000000000000001 * (fRec1[0] - fRec1[1]));
