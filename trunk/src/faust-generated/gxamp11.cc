...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = Ftube3(0, ((fTemp14 * (fSlow15 + (fSlow12 * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((fSlow13 * fTemp14)))) - 0.024937655860349125)))))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec33[0] + (fSlow11 * fRec12[0])))));
