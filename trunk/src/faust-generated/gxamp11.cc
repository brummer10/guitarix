...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp17 = (2.0 * (fRec30[0] + -0.5));
		double fTemp18 = std::pow(10.0, (2.0 * fRec30[0]));
		double fTemp19 = (0.024937655860349125 * (fRec29[0] * fTemp15));
		...
		fRec38[0] = (fTemp19 - (fConst30 * ((fConst35 * fRec38[2]) + (fConst36 * fRec38[1]))));
		double fTemp21 = (fRec38[2] + (fRec38[0] + (2.0 * fRec38[1])));
		fVec3[0] = fTemp21;
		fRec37[0] = ((fConst30 * ((fConst34 * fTemp21) + (fConst37 * fVec3[1]))) - (fConst38 * fRec37[1]));
		fRec36[0] = (0.0 - (fConst26 * ((fConst27 * fRec36[1]) - (fRec37[0] + fRec37[1]))));
		fRec35[0] = (fRec36[0] - (fConst22 * ((fConst39 * fRec35[2]) + (fConst42 * fRec35[1]))));
		double fTemp22 = (fRec35[2] + (fRec35[0] + (2.0 * fRec35[1])));
		fVec4[0] = fTemp22;
		fRec34[0] = ((fConst22 * ((fConst24 * fTemp22) + (fConst43 * fVec4[1]))) - (fConst45 * fRec34[1]));
		fRec33[0] = (fRec34[0] - (fConst17 * ((fConst46 * fRec33[2]) + (fConst47 * fRec33[1]))));
		double fTemp23 = (fConst57 * fRec32[1]);
		fRec32[0] = ((fConst17 * (((fConst19 * fRec33[0]) + (fConst48 * fRec33[1])) + (fConst19 * fRec33[2]))) - (fConst52 * ((fConst54 * fRec32[2]) + fTemp23)));
		double fTemp24 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec32[2] + (fConst52 * (fTemp23 + (fConst54 * fRec32[0])))) * std::pow(10.0, (1.2 * fRec30[0])))));
		...
		double fTemp25 = (fConst47 * fRec40[1]);
		fRec40[0] = ((fConst22 * (((fConst41 * fRec41[0]) + (fConst59 * fRec41[1])) + (fConst41 * fRec41[2]))) - (fConst60 * ((fConst61 * fRec40[2]) + fTemp25)));
		double fTemp26 = (fConst57 * fRec39[1]);
		fRec39[0] = ((fRec40[2] + (fConst60 * (fTemp25 + (fConst61 * fRec40[0])))) - (fConst52 * ((fConst54 * fRec39[2]) + fTemp26)));
		double fTemp27 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec39[2] + (fConst52 * (fTemp26 + (fConst54 * fRec39[0])))) * std::pow(10.0, (0.80000000000000004 * fRec30[0])))));
		fRec46[0] = (0.0 - (fConst64 * ((fConst44 * fRec46[1]) - (fConst22 * (fTemp22 + fVec4[1])))));
		fRec45[0] = (fRec46[0] - (fConst17 * ((fConst46 * fRec45[2]) + (fConst47 * fRec45[1]))));
		double fTemp28 = (fRec45[2] + (fRec45[0] + (2.0 * fRec45[1])));
		fVec5[0] = fTemp28;
		fRec44[0] = ((fConst17 * ((fConst63 * fTemp28) + (fConst65 * fVec5[1]))) - (fConst66 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst62 * ((fConst67 * fRec43[2]) + (fConst57 * fRec43[1]))));
		double fTemp29 = std::max<double>(-1.0, std::min<double>(1.0, (fConst62 * (fTemp18 * (((fConst56 * fRec43[0]) + (fConst68 * fRec43[1])) + (fConst56 * fRec43[2]))))));
		fRec48[0] = (0.0 - (fConst69 * ((fConst53 * fRec48[1]) - (fConst17 * (fTemp28 + fVec5[1])))));
		fRec47[0] = (fRec48[0] - (fConst62 * ((fConst67 * fRec47[2]) + (fConst57 * fRec47[1]))));
		double fTemp30 = std::max<double>(-1.0, std::min<double>(1.0, (fConst62 * ((fRec47[2] + (fRec47[0] + (2.0 * fRec47[1]))) * std::pow(10.0, (0.90000000000000002 * fRec30[0]))))));
		...
		fVec6[0] = fTemp31;
		fRec31[0] = (0.0 - (fConst5 * ((fConst6 * fRec31[1]) - (fTemp31 + fVec6[1]))));
		double fTemp32 = ((fTemp15 * ((fTemp16 * ((1.25 * (fRec30[0] * ((0.099750623441396499 * (1.0 - std::fabs((0.024937655860349125 * (fTemp16 * fTemp15))))) + -0.024937655860349125))) + 0.024937655860349125)) + (0.024937655860349125 * (fRec29[0] * (1.0 - std::max<double>(0.0, fTemp17)))))) + ((0.5 * (fTemp20 * (1.0 - (0.33333333333333331 * mydsp_faustpower2_f(fTemp20))))) + (fRec31[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp17))))));
		fVec7[0] = fTemp32;
		...
		fVec8[0] = fTemp35;
		fRec49[0] = (fConst71 * ((2700.0 * (fTemp35 + fVec8[1])) - (fConst72 * fRec49[1])));
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp33 + (fRec49[0] + fTemp34)) + -1.2572399999999999)))) + -83.435555555555567);
		...
		double fTemp36 = (fRec16[0] * fRec50[0]);
		fVec9[0] = fTemp36;
		fRec15[0] = (0.0 - (fConst5 * ((fConst6 * fRec15[1]) - (fTemp36 + fVec9[1]))));
		...
		double fTemp37 = (0.92544984225177063 * (fRec13[0] + fRec13[2]));
		double fTemp38 = (1.8508996845035413 * fRec13[1]);
		double fTemp39 = ((fTemp38 + fTemp37) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp39;
		fRec51[0] = (fConst11 * ((1500.0 * (fTemp39 + fVec10[1])) - (fConst12 * fRec51[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp37 + (fRec51[0] + fTemp38)) + -0.77616200000000002)))) + -78.255866666666662);
		...
		double fTemp42 = ((fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp42;
		fRec52[0] = (fConst8 * ((820.0 * (fTemp42 + fVec11[1])) - (fConst9 * fRec52[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp40 + (fRec52[0] + fTemp41)) + -0.44548700000000002)))) + -75.672317073170731);
