...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec13[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp12 * ((fTemp26 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp26 * fTemp12))))) - 0.024937655860349125)))) + (fSlow11 * fRec17[0]))) + ((fSlow10 * fRec19[0]) + (fRec18[0] + (0.5 * (fTemp14 * (1 - (0.3333333333333333 * faustpower<2>(fTemp14)))))))) - 1.25724)) - 83.43555555555557);
		...
		fRec38[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec39[0] + fRec11[1]) - 0.776162)) - 78.25586666666666);
		fRec37[0] = ((fConst42 * fRec37[1]) + (fConst66 * ((fConst38 * fRec38[0]) + (fConst39 * fRec38[1]))));
		fRec11[0] = (fRec37[0] - fRec12[0]);
