...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = Ftube4(0, (fRec10[0] + (fTemp0 * (1 + (fSlow2 * ((4 - (4 * fabs(fTemp0))) - 1))))));
		...
		double fTemp3 = (fRec5[1] - 1.3e+02);
		fVec2[0] = fTemp3;
		fRec11[0] = ((fConst16 * (fVec2[0] + fVec2[1])) + (fConst15 * fRec11[1]));
		fRec5[0] = Ftube4(1, (fRec11[0] + fRec6[0]));
		...
		double fTemp5 = (fRec2[1] - 1.3e+02);
		fVec4[0] = fTemp5;
		fRec12[0] = ((fConst20 * (fVec4[0] + fVec4[1])) + (fConst19 * fRec12[1]));
		fRec2[0] = Ftube4(1, (fRec12[0] + fRec3[0]));
