...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec1[0] = fTemp5;
		fRec21[0] = (fConst14 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst15 * fRec21[1])));
		...
		fRec28[0] = ((fTemp8 + fRec28[1]) - fVec2[((IOTA - iConst17) & 32767)]);
		...
		fRec38[0] = (fTemp19 - (fConst33 * ((fConst34 * fRec38[2]) + (fConst35 * fRec38[1]))));
		double fTemp21 = (fRec38[2] + (fRec38[0] + (2.0 * fRec38[1])));
		fVec3[0] = fTemp21;
		fRec37[0] = ((fConst33 * ((fConst4 * fTemp21) + (fConst11 * fVec3[1]))) - (fConst12 * fRec37[1]));
		...
		fVec4[0] = fTemp22;
		fRec34[0] = ((fConst25 * ((fConst27 * fTemp22) + (fConst40 * fVec4[1]))) - (fConst42 * fRec34[1]));
		fRec33[0] = (fRec34[0] - (fConst20 * ((fConst43 * fRec33[2]) + (fConst44 * fRec33[1]))));
		double fTemp23 = (fConst54 * fRec32[1]);
		fRec32[0] = ((fConst20 * (((fConst22 * fRec33[0]) + (fConst45 * fRec33[1])) + (fConst22 * fRec33[2]))) - (fConst49 * ((fConst51 * fRec32[2]) + fTemp23)));
		double fTemp24 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec32[2] + (fConst49 * (fTemp23 + (fConst51 * fRec32[0])))) * std::pow(10.0, (1.2 * fRec30[0])))));
		...
		double fTemp25 = (fConst44 * fRec40[1]);
		fRec40[0] = ((fConst25 * (((fConst38 * fRec41[0]) + (fConst56 * fRec41[1])) + (fConst38 * fRec41[2]))) - (fConst57 * ((fConst58 * fRec40[2]) + fTemp25)));
		double fTemp26 = (fConst54 * fRec39[1]);
		fRec39[0] = ((fRec40[2] + (fConst57 * (fTemp25 + (fConst58 * fRec40[0])))) - (fConst49 * ((fConst51 * fRec39[2]) + fTemp26)));
		double fTemp27 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec39[2] + (fConst49 * (fTemp26 + (fConst51 * fRec39[0])))) * std::pow(10.0, (0.80000000000000004 * fRec30[0])))));
		fRec46[0] = (0.0 - (fConst61 * ((fConst41 * fRec46[1]) - (fConst25 * (fTemp22 + fVec4[1])))));
		fRec45[0] = (fRec46[0] - (fConst20 * ((fConst43 * fRec45[2]) + (fConst44 * fRec45[1]))));
		double fTemp28 = (fRec45[2] + (fRec45[0] + (2.0 * fRec45[1])));
		fVec5[0] = fTemp28;
		fRec44[0] = ((fConst20 * ((fConst60 * fTemp28) + (fConst62 * fVec5[1]))) - (fConst63 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst59 * ((fConst64 * fRec43[2]) + (fConst54 * fRec43[1]))));
		double fTemp29 = std::max<double>(-1.0, std::min<double>(1.0, (fConst59 * (fTemp18 * (((fConst53 * fRec43[0]) + (fConst65 * fRec43[1])) + (fConst53 * fRec43[2]))))));
		fRec48[0] = (0.0 - (fConst66 * ((fConst50 * fRec48[1]) - (fConst20 * (fTemp28 + fVec5[1])))));
		fRec47[0] = (fRec48[0] - (fConst59 * ((fConst64 * fRec47[2]) + (fConst54 * fRec47[1]))));
		double fTemp30 = std::max<double>(-1.0, std::min<double>(1.0, (fConst59 * ((fRec47[2] + (fRec47[0] + (2.0 * fRec47[1]))) * std::pow(10.0, (0.90000000000000002 * fRec30[0]))))));
		...
		fVec6[0] = fTemp31;
		fRec31[0] = (0.0 - (fConst6 * ((fConst7 * fRec31[1]) - (fTemp31 + fVec6[1]))));
		...
		fVec8[0] = fTemp35;
		fRec49[0] = (fConst68 * ((2700.0 * (fTemp35 + fVec8[1])) - (fConst69 * fRec49[1])));
		...
		fVec9[0] = fTemp36;
		fRec15[0] = (0.0 - (fConst6 * ((fConst7 * fRec15[1]) - (fTemp36 + fVec9[1]))));
		...
		fVec10[0] = fTemp39;
		fRec51[0] = (fConst14 * ((1500.0 * (fTemp39 + fVec10[1])) - (fConst15 * fRec51[1])));
		...
		fVec11[0] = fTemp42;
		fRec52[0] = (fConst9 * ((820.0 * (fTemp42 + fVec11[1])) - (fConst10 * fRec52[1])));
