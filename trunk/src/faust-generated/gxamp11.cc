...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec44[0] + (1.8508996845035413 * fRec19[1]))) + -1.2572399999999999)))) + -83.435555555555567);
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec46[0] + (1.8508996845035413 * fRec10[1]))) + -0.77616200000000002)))) + -78.255866666666662);
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec47[0] + (1.8508996845035413 * fRec1[1]))) + -0.44548700000000002)))) + -75.672317073170731);
		fRec48[0] = (fSlow3 + (0.999 * fRec48[1]));
		buf[i] = FAUSTFLOAT((0.10000000000000001 * (fRec0[0] * fRec48[0])));
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
		fRec6[1] = fRec6[0];
		fRec8[1] = fRec8[0];
