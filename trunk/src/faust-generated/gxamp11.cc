...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec20[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp31 + fRec46[0] + fTemp30 + -1.25724) + -83.43555555555557;
		fRec19[0] = 0.1 * (fConst8 * fRec20[0] + fConst9 * fRec20[1]) - fConst4 * fRec19[1];
		fRec47[0] = fConst12 * (fConst11 * fRec47[1] + 0.1 * (fRec20[0] - fRec20[1]));
		...
		double fTemp35 = (fTemp33 + fTemp34) / (Ranode(TUBE_TABLE_12AU7_250k, fRec49[1]) + 1e+05);
		fVec8[0] = fTemp35;
		fRec52[0] = fConst72 * (1.5e+03 * (fTemp35 + fVec8[1]) - fConst71 * fRec52[1]);
		fRec49[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp34 + fRec52[0] + fTemp33 + -0.776162) + -78.25586666666666;
		fRec48[0] = 0.1 * (fConst8 * fRec49[0] + fConst9 * fRec49[1]) - fConst4 * fRec48[1];
		fRec53[0] = fConst12 * (fConst11 * fRec53[1] + 0.1 * (fRec49[0] - fRec49[1]));
		...
		double fTemp39 = (fTemp37 + fTemp38) / (Ranode(TUBE_TABLE_12AU7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp39;
		fRec54[0] = fConst72 * (1.5e+03 * (fTemp39 + fVec10[1]) - fConst71 * fRec54[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp38 + fRec54[0] + fTemp37 + -0.776162) + -78.25586666666666;
		fRec12[0] = 0.1 * (fConst8 * fRec13[0] + fConst9 * fRec13[1]) - fConst4 * fRec12[1];
		fRec55[0] = fConst12 * (fConst11 * fRec55[1] + 0.1 * (fRec13[0] - fRec13[1]));
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp42;
		fRec56[0] = fConst7 * (8.2e+02 * (fTemp42 + fVec11[1]) - fConst6 * fRec56[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp41 + fRec56[0] + fTemp40 + -0.445487) + -75.67231707317073;
		fRec0[0] = 0.1 * (fConst8 * fRec1[0] + fConst9 * fRec1[1]) - fConst4 * fRec0[1];
		fRec57[0] = fConst12 * (fConst11 * fRec57[1] + 0.1 * (fRec1[0] - fRec1[1]));
