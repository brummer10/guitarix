...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst41 = 3.49189779003048e-15 * fConst2;
	fConst42 = fConst0 * (fConst41 + -1.12364567535709e-08);
	double fConst43 = 3.28238392262865e-18 * fConst0;
	...
	double fConst48 = 1.24133791983047e-18 * fConst0;
	...
	fConst69 = fConst2 * (-1.72230935485062e-12 - fConst16);
	fConst70 = fConst0 * (fConst0 * (fConst18 + 3.24125726288252e-12) + 4.69720733141079e-09);
	fConst71 = fConst2 * (fConst0 * (-6.50762769960225e-16 - fConst20) + 1.68853858318688e-12);
	fConst72 = fConst0 * (fConst0 * (fConst0 * (fConst22 + 3.72011206873759e-15) + 1.47087060946334e-12) + -4.60510522687332e-09);
	fConst73 = fConst6 * (fConst20 + 7.93613134097836e-16);
	fConst74 = fConst2 * (fConst0 * (-4.45721994768766e-15 - fConst22) + -3.85293803981734e-12);
	fConst75 = fConst0 * (fConst0 * (-1.35752299926304e-12 - fConst26) + -1.24043238434298e-09);
	fConst76 = fConst0 * (fConst0 * (fConst26 + 1.13415697533877e-12) + 5.05476196619765e-10);
	fConst77 = fConst0 * (fConst29 + 9.9677425108649e-10);
	double fConst78 = 2.98398538420786e-19 * fConst0;
	fConst79 = -1.58722626819567e-15 - fConst78;
	fConst80 = 1.53973645825126e-18 * fConst0;
	double fConst81 = 2.33293402765342e-16 * fConst2;
	fConst82 = fConst0 * (fConst81 + -2.48086476868596e-09);
	fConst83 = fConst6 * (fConst78 + 1.30152553992045e-15);
	fConst84 = fConst0 * (fConst2 * (-7.44022413747518e-15 - fConst80) + -9.21021045374664e-09);
	fConst85 = fConst0 * (1.01095239323953e-09 - fConst81);
	fConst86 = 3.17445253639134e-16 * fConst6;
	double fConst87 = 1.63801750877793e-15 * fConst2;
	fConst88 = fConst0 * (9.39441466282157e-09 - fConst87);
	fConst89 = 1.99354850217298e-09 * fConst0;
	fConst90 = -3.37707716637377e-12 - 4.47597807631179e-19 * fConst2;
	fConst91 = 2.30960468737688e-18 * fConst2;
	fConst92 = 4.47597807631179e-19 * fConst53;
	fConst93 = fConst2 * (7.70587607963469e-12 - fConst91);
	fConst94 = 2.71504599852608e-12 * fConst2;
	fConst95 = 1.58722626819567e-15 - fConst78;
	fConst96 = fConst0 * (2.48086476868596e-09 - fConst81);
	fConst97 = fConst6 * (fConst78 + -1.30152553992045e-15);
	fConst98 = fConst0 * (fConst2 * (7.44022413747518e-15 - fConst80) + 9.21021045374664e-09);
	fConst99 = fConst0 * (fConst81 + -1.01095239323953e-09);
	fConst100 = fConst0 * (fConst87 + -9.39441466282157e-09);
	clear_state_f();
}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp3 = fConst86 * fRec0[0];
		output0[i0] = FAUSTFLOAT((fRec2[3] * (fRec0[0] * (fConst100 - fTemp3) + fRec1[0] * (fConst99 + fRec0[0] * (fConst98 + fConst97 * fRec0[0]) + fRec1[0] * (fConst96 + fConst6 * fRec0[0] * (fConst80 + fConst95 * fRec0[0] + -8.91443989537532e-15)) + -6.20216192171491e-06) + 6.32620516014921e-06 - fConst89) + fRec2[2] * (fConst2 * (fRec0[0] * (3.44461870970124e-12 * fRec0[0] + -6.48251452576504e-12) + -4.96368942053919e-13) + fRec1[0] * (fRec1[0] * (fConst94 + fRec0[0] * (fConst93 + fConst92 * fRec0[0])) + fConst2 * (fRec0[0] * (fConst91 + fConst90 * fRec0[0] + -2.94174121892668e-12) + -2.26831395067755e-12) + -9.30324288257237e-06) + 9.48930774022381e-06) + fRec2[1] * (fConst89 + fRec0[0] * (fConst88 + fTemp3) + fRec1[0] * (fConst85 + fRec0[0] * (fConst84 + fConst83 * fRec0[0]) + fRec1[0] * (fConst82 + fConst6 * fRec0[0] * (fConst80 + fConst79 * fRec0[0] + 8.91443989537532e-15)) + -6.20216192171491e-06) + 6.32620516014921e-06) + fRec2[0] * (fConst77 + fRec1[0] * (fConst76 + fRec1[0] * (fConst75 + fRec0[0] * (fConst74 + fConst73 * fRec0[0])) + fRec0[0] * (fConst72 + fConst71 * fRec0[0]) + -1.55054048042873e-06) + fRec0[0] * (fConst70 + fConst69 * fRec0[0]) + 1.5815512900373e-06) + fRec2[4] * (fConst30 + fRec1[0] * (fConst28 + fRec1[0] * (fConst27 + fRec0[0] * (fConst25 + fConst24 * fRec0[0])) + fRec0[0] * (fConst23 + fConst21 * fRec0[0]) + -1.55054048042873e-06) + fRec0[0] * (fConst19 + fConst17 * fRec0[0]) + 1.5815512900373e-06)) / fTemp0);
		fRec0[1] = fRec0[0];
		fRec1[1] = fRec1[0];
