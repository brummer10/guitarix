...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec4[0] = fTemp13;
		fRec11[0] = ((fConst22 * ((fConst26 * fTemp13) + (fConst38 * fVec4[1]))) - (fConst39 * fRec11[1]));
		...
		fVec5[0] = fTemp14;
		fRec8[0] = ((fConst14 * ((fConst16 * fTemp14) + (fConst44 * fVec5[1]))) - (fConst46 * fRec8[1]));
		fRec7[0] = (fRec8[0] - (fConst9 * ((fConst47 * fRec7[2]) + (fConst48 * fRec7[1]))));
		double fTemp15 = (fConst58 * fRec6[1]);
		fRec6[0] = ((fConst9 * (((fConst11 * fRec7[0]) + (fConst49 * fRec7[1])) + (fConst11 * fRec7[2]))) - (fConst53 * ((fConst55 * fRec6[2]) + fTemp15)));
		fRec31[0] = (fSlow2 + (0.999 * fRec31[1]));
		double fTemp16 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec6[2] + (fConst53 * (fTemp15 + (fConst55 * fRec6[0])))) * std::pow(10.0, (1.2 * fRec31[0])))));
		...
		double fTemp17 = (fConst48 * fRec33[1]);
		fRec33[0] = ((fConst14 * (((fConst42 * fRec34[0]) + (fConst60 * fRec34[1])) + (fConst42 * fRec34[2]))) - (fConst61 * ((fConst62 * fRec33[2]) + fTemp17)));
		double fTemp18 = (fConst58 * fRec32[1]);
		fRec32[0] = ((fRec33[2] + (fConst61 * (fTemp17 + (fConst62 * fRec33[0])))) - (fConst53 * ((fConst55 * fRec32[2]) + fTemp18)));
		double fTemp19 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec32[2] + (fConst53 * (fTemp18 + (fConst55 * fRec32[0])))) * std::pow(10.0, (0.80000000000000004 * fRec31[0])))));
		fRec39[0] = (0.0 - (fConst65 * ((fConst45 * fRec39[1]) - (fConst14 * (fTemp14 + fVec5[1])))));
		fRec38[0] = (fRec39[0] - (fConst9 * ((fConst47 * fRec38[2]) + (fConst48 * fRec38[1]))));
		double fTemp20 = (fRec38[2] + (fRec38[0] + (2.0 * fRec38[1])));
		fVec6[0] = fTemp20;
		fRec37[0] = ((fConst9 * ((fConst64 * fTemp20) + (fConst66 * fVec6[1]))) - (fConst67 * fRec37[1]));
		fRec36[0] = (fRec37[0] - (fConst63 * ((fConst68 * fRec36[2]) + (fConst58 * fRec36[1]))));
		double fTemp21 = std::max<double>(-1.0, std::min<double>(1.0, (fConst63 * ((((fConst57 * fRec36[0]) + (fConst69 * fRec36[1])) + (fConst57 * fRec36[2])) * std::pow(10.0, (2.0 * fRec31[0]))))));
		fRec41[0] = (0.0 - (fConst70 * ((fConst54 * fRec41[1]) - (fConst9 * (fTemp20 + fVec6[1])))));
		fRec40[0] = (fRec41[0] - (fConst63 * ((fConst68 * fRec40[2]) + (fConst58 * fRec40[1]))));
		double fTemp22 = std::max<double>(-1.0, std::min<double>(1.0, (fConst63 * ((fRec40[2] + (fRec40[0] + (2.0 * fRec40[1]))) * std::pow(10.0, (0.90000000000000002 * fRec31[0]))))));
		...
		fVec7[0] = fTemp23;
		fRec5[0] = (0.0 - (fConst5 * ((fConst6 * fRec5[1]) - (fTemp23 + fVec7[1]))));
		double fTemp24 = (2.0 * (fRec31[0] + -0.5));
		double fTemp25 = (1.0 - fRec30[0]);
		double fTemp26 = ((fRec5[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp24)))) + (fRec13[0] * ((fTemp25 * ((1.25 * (fRec31[0] * ((4.0 * (1.0 - std::fabs((fRec13[0] * fTemp25)))) + -1.0))) + 1.0)) + (fRec30[0] * (1.0 - std::max<double>(0.0, fTemp24))))));
		fVec8[0] = fTemp26;
		fRec4[0] = (0.0 - (fConst5 * ((fConst6 * fRec4[1]) - (fTemp26 + fVec8[1]))));
		fRec42[0] = (fSlow3 + (0.999 * fRec42[1]));
		double fTemp27 = (fRec4[0] * fRec42[0]);
		fVec9[0] = fTemp27;
		fRec3[0] = ((0.93028479253239138 * (fTemp27 + fVec9[1])) - (0.86056958506478287 * fRec3[1]));
		...
		fVec10[0] = fTemp31;
		fRec43[0] = (fConst5 * ((820.0 * (fTemp31 + fVec10[1])) - (fConst6 * fRec43[1])));
		double fTemp32 = double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp28 + (fRec43[0] + fTemp29)) + -1.1304620000000001))));
		fRec1[0] = ((fTemp32 + (0.0013786121951219513 * (double(Ranode(int(TUBE_TABLE_6V6_250k), double(fTemp32))) + 100000.0))) + -250.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.025000000000000001 * (fRec1[0] - fRec1[1]))));
		double fTemp33 = (fTemp30 / (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fRec45[1]))) + 100000.0));
		fVec11[0] = fTemp33;
		fRec46[0] = (fConst5 * ((820.0 * (fTemp33 + fVec11[1])) - (fConst6 * fRec46[1])));
		double fTemp34 = double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp28 + (fRec46[0] + fTemp29)) + -1.1307400000000001))));
		fRec45[0] = ((fTemp34 + (0.0013789512195121953 * (double(Ranode(int(TUBE_TABLE_6V6_68k), double(fTemp34))) + 100000.0))) + -250.0);
