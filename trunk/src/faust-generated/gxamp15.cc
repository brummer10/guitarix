...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (fRec17[1] - 1.2e+02);
		fVec2[0] = fTemp2;
		...
		double fTemp3 = (fRec25[1] - 1.2e+02);
		fVec3[0] = fTemp3;
		...
		double fTemp4 = (fRec13[1] - 1.2e+02);
		fVec4[0] = fTemp4;
		...
		double fTemp5 = (fRec29[1] - 1.2e+02);
		fVec5[0] = fTemp5;
		...
		double fTemp6 = (fRec10[1] - 1.2e+02);
		fVec6[0] = fTemp6;
