...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec12[0] = (Ftube(TUBE_TABLE_12AT7_68k, ((fRec14[0] + ((double)input0[i] * fRec13[0])) - 2.617753)) - 153.04618518518518);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec15[0] + fRec10[0]) - 1.887332)) - 124.17786666666666);
		fRec8[0] = ((fConst13 * ((fConst12 * fRec9[1]) + (fConst1 * fRec9[0]))) + (fConst3 * fRec8[1]));
		fRec16[0] = ((fConst22 * (fRec7[1] + fRec7[2])) + (fConst21 * fRec16[1]));
		fRec7[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec16[0] + fRec8[0]) - 1.256962)) - 96.7119512195122);
