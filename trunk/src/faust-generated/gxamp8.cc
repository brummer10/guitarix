...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec23[0] = 0.1 * (fConst8 * fRec24[0] + fConst9 * fRec24[1]) - fConst4 * fRec23[1];
		fRec28[0] = fConst12 * (fConst11 * fRec28[1] + 0.1 * (fRec24[0] - fRec24[1]));
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AU7_250k, fRec36[1]) + 1e+05);
		fVec1[0] = fTemp9;
		fRec39[0] = fConst15 * (1.5e+03 * (fTemp9 + fVec1[1]) - fConst14 * fRec39[1]);
		fRec36[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp8 + fRec39[0] + fTemp7 + -0.776162) + -78.25586666666666;
		fRec35[0] = 0.1 * (fConst8 * fRec36[0] + fConst9 * fRec36[1]) - fConst4 * fRec35[1];
		fRec40[0] = fConst12 * (fConst11 * fRec40[1] + 0.1 * (fRec36[0] - fRec36[1]));
		fRec45[0] = fSlow4 + 0.999 * fRec45[1];
		double fTemp10 = double(buf[i0]) * fRec45[0];
		fVec2[0] = fTemp10;
		fRec44[0] = 1.8605695850647828 * (fTemp10 + fVec2[1]) - 0.8605695850647829 * fRec44[1];
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_12AU7_68k, fRec42[1]) + 1e+05);
		fVec3[0] = fTemp13;
		fRec46[0] = fConst18 * (2.7e+03 * (fTemp13 + fVec3[1]) - fConst17 * fRec46[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp12 + fRec46[0] + fTemp11 + -1.25724) + -83.43555555555557;
		fRec41[0] = 0.1 * (fConst8 * fRec42[0] + fConst9 * fRec42[1]) - fConst4 * fRec41[1];
		fRec47[0] = fConst12 * (fConst11 * fRec47[1] + 0.1 * (fRec42[0] - fRec42[1]));
		...
		double fTemp16 = (fTemp14 + fTemp15) / (Ranode(TUBE_TABLE_12AU7_250k, fRec30[1]) + 1e+05);
		fVec4[0] = fTemp16;
		fRec48[0] = fConst15 * (1.5e+03 * (fTemp16 + fVec4[1]) - fConst14 * fRec48[1]);
		fRec30[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp15 + fRec48[0] + fTemp14 + -0.776162) + -78.25586666666666;
		fRec29[0] = 0.1 * (fConst8 * fRec30[0] + fConst9 * fRec30[1]) - fConst4 * fRec29[1];
		fRec49[0] = fConst12 * (fConst11 * fRec49[1] + 0.1 * (fRec30[0] - fRec30[1]));
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AU7_250k, fRec19[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec50[0] = fConst7 * (8.2e+02 * (fTemp19 + fVec5[1]) - fConst6 * fRec50[1]);
		fRec19[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp18 + fRec50[0] + fTemp17 + -0.445487) + -75.67231707317073;
		fRec18[0] = 0.1 * (fConst8 * fRec19[0] + fConst9 * fRec19[1]) - fConst4 * fRec18[1];
		fRec51[0] = fConst12 * (fConst11 * fRec51[1] + 0.1 * (fRec19[0] - fRec19[1]));
