...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow9 = (fConst80 * pow(1e+01,(2 * fSlow4)));
	double 	fSlow10 = (fConst80 * pow(1e+01,(0.9 * fSlow4)));
	...
	for (int i=0; i<count; i++) {
		...
		fVec1[0] = fTemp1;
		fRec20[0] = (fConst29 * ((fVec1[0] - fVec1[1]) + (fConst28 * fRec20[1])));
		fRec19[0] = (fConst29 * ((fRec20[0] - fRec20[1]) + (fConst28 * fRec19[1])));
		fRec18[0] = (fRec19[0] - (fConst26 * ((fConst25 * fRec18[2]) + (fConst20 * fRec18[1]))));
		fRec17[0] = ((fConst26 * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))) - (fConst24 * ((fConst22 * fRec17[2]) + (fConst20 * fRec17[1]))));
		fRec21[0] = (fSlow1 + (0.999 * fRec21[1]));
		double fTemp2 = (fRec16[1] - 2.5e+02);
		fVec2[0] = fTemp2;
		fRec22[0] = ((fConst34 * (fVec2[0] + fVec2[1])) + (fConst33 * fRec22[1]));
		fRec16[0] = Ftube3(0, (fRec22[0] + (fConst30 * (fRec21[0] * (fRec17[2] + (fRec17[0] + (2 * fRec17[1])))))));
		fRec15[0] = ((fConst36 * ((fConst35 * fRec16[1]) + (fConst12 * fRec16[0]))) + (fConst14 * fRec15[1]));
		double fTemp3 = (fRec24[1] - 2.5e+02);
		fVec3[0] = fTemp3;
		fRec25[0] = ((fConst40 * (fVec3[0] + fVec3[1])) + (fConst39 * fRec25[1]));
		fRec24[0] = Ftube3(1, (fRec25[0] + fRec14[1]));
		fRec23[0] = ((fConst36 * ((fConst35 * fRec24[1]) + (fConst12 * fRec24[0]))) + (fConst14 * fRec23[1]));
		fRec14[0] = (fRec23[0] + fRec15[0]);
		fRec13[0] = ((fConst41 * (fRec14[0] + fRec14[1])) + (fConst17 * fRec13[1]));
		double fTemp4 = (fRec12[1] - 2.5e+02);
		fVec4[0] = fTemp4;
		fRec26[0] = ((fConst40 * (fVec4[0] + fVec4[1])) + (fConst39 * fRec26[1]));
		fRec12[0] = Ftube3(1, (fRec26[0] + fRec13[0]));
		fRec11[0] = ((fConst36 * ((fConst35 * fRec12[1]) + (fConst12 * fRec12[0]))) + (fConst14 * fRec11[1]));
		double fTemp5 = (fRec28[1] - 2.5e+02);
		fVec5[0] = fTemp5;
		fRec29[0] = ((fConst45 * (fVec5[0] + fVec5[1])) + (fConst44 * fRec29[1]));
		fRec28[0] = Ftube3(1, (fRec29[0] + fRec10[1]));
		fRec27[0] = ((fConst36 * ((fConst35 * fRec28[1]) + (fConst12 * fRec28[0]))) + (fConst14 * fRec27[1]));
		fRec10[0] = (fRec27[0] + fRec11[0]);
		double fTemp6 = (fRec9[1] - 2.5e+02);
		fVec6[0] = fTemp6;
		fRec30[0] = ((fConst45 * (fVec6[0] + fVec6[1])) + (fConst44 * fRec30[1]));
		fRec9[0] = Ftube3(1, (fRec30[0] + fRec10[0]));
		fRec8[0] = ((fConst36 * ((fConst35 * fRec9[1]) + (fConst12 * fRec9[0]))) + (fConst14 * fRec8[1]));
		...
		fRec32[0] = ((fVec7[IOTA&65535] + fRec32[1]) - fVec7[(IOTA-iConst46)&65535]);
		fRec31[0] = ((fConst47 * fRec32[0]) + (0.999 * fRec31[1]));
		...
		double fTemp20 = (fConst50 * fRec35[1]);
		double fTemp21 = (fConst56 * fRec36[1]);
		fRec40[0] = ((0.024937655860349125 * fTemp19) - (fConst74 * ((fConst72 * fRec40[2]) + (fConst70 * fRec40[1]))));
		double fTemp22 = (fRec40[2] + (fRec40[0] + (2 * fRec40[1])));
		fVec8[0] = fTemp22;
		fRec39[0] = ((fConst75 * ((fConst35 * fVec8[1]) + (fConst12 * fVec8[0]))) + (fConst14 * fRec39[1]));
		fRec38[0] = ((fConst77 * ((fConst76 * fRec39[1]) + (fConst63 * fRec39[0]))) + (fConst68 * fRec38[1]));
		fRec37[0] = (fRec38[0] - (fConst66 * ((fConst64 * fRec37[2]) + (fConst62 * fRec37[1]))));
		fRec36[0] = ((fConst66 * (((fConst61 * fRec37[0]) + (fConst78 * fRec37[1])) + (fConst61 * fRec37[2]))) - (fConst59 * ((fConst58 * fRec36[2]) + fTemp21)));
		fRec35[0] = ((fRec36[2] + (fConst59 * (fTemp21 + (fConst58 * fRec36[0])))) - (fConst53 * ((fConst52 * fRec35[2]) + fTemp20)));
		double fTemp23 = max(-1, min(1, (fSlow8 * (fRec35[2] + (fConst53 * (fTemp20 + (fConst52 * fRec35[0])))))));
		fRec46[0] = ((fConst77 * (fRec39[0] + fRec39[1])) + (fConst68 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst66 * ((fConst64 * fRec45[2]) + (fConst62 * fRec45[1]))));
		double fTemp24 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec9[0] = fTemp24;
		fRec44[0] = ((fConst88 * (fVec9[0] + fVec9[1])) + (fConst87 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst85 * ((fConst83 * fRec43[2]) + (fConst56 * fRec43[1]))));
		double fTemp25 = (fRec43[2] + (fRec43[0] + (2 * fRec43[1])));
		fVec10[0] = fTemp25;
		fRec42[0] = ((fConst90 * ((fConst89 * fVec10[1]) + (fConst51 * fVec10[0]))) + (fConst82 * fRec42[1]));
		fRec41[0] = (fRec42[0] - (fConst80 * ((fConst79 * fRec41[2]) + (fConst50 * fRec41[1]))));
		double fTemp26 = max(-1, min(1, (fSlow9 * (((fConst49 * fRec41[0]) + (fConst91 * fRec41[1])) + (fConst49 * fRec41[2])))));
		fRec48[0] = ((fConst90 * (fVec10[0] + fVec10[1])) + (fConst82 * fRec48[1]));
		fRec47[0] = (fRec48[0] - (fConst80 * ((fConst79 * fRec47[2]) + (fConst50 * fRec47[1]))));
		double fTemp27 = max(-1, min(1, (fSlow10 * (fRec47[2] + (fRec47[0] + (2 * fRec47[1]))))));
		double fTemp28 = (fConst50 * fRec49[1]);
		fRec51[0] = ((fConst88 * ((fConst92 * fVec9[1]) + (fConst57 * fVec9[0]))) + (fConst87 * fRec51[1]));
		fRec50[0] = (fRec51[0] - (fConst85 * ((fConst83 * fRec50[2]) + (fConst56 * fRec50[1]))));
		fRec49[0] = ((fConst85 * (((fConst55 * fRec50[0]) + (fConst93 * fRec50[1])) + (fConst55 * fRec50[2]))) - (fConst53 * ((fConst52 * fRec49[2]) + fTemp28)));
		double fTemp29 = max(-1, min(1, (fSlow11 * (fRec49[2] + (fConst53 * (fTemp28 + (fConst52 * fRec49[0])))))));
		...
		fVec11[0] = fTemp30;
		fRec34[0] = ((fConst94 * (fVec11[0] + fVec11[1])) + (fConst17 * fRec34[1]));
		...
		fRec3[0] = ((fConst36 * ((fConst35 * fRec4[1]) + (fConst12 * fRec4[0]))) + (fConst14 * fRec3[1]));
		double fTemp33 = (fRec53[1] - 2.5e+02);
		fVec13[0] = fTemp33;
		fRec54[0] = ((fConst18 * (fVec13[0] + fVec13[1])) + (fConst17 * fRec54[1]));
		fRec53[0] = Ftube2(1, (fRec54[0] + fTemp32));
		fRec52[0] = ((fConst36 * ((fConst35 * fRec53[1]) + (fConst12 * fRec53[0]))) + (fConst14 * fRec52[1]));
		double fTemp34 = (min(0.7, fRec52[0]) + max(-0.75, fRec3[0]));
		fVec14[0] = fTemp34;
		fRec2[0] = (fConst96 * ((fVec14[2] + (fVec14[0] + (fConst95 * fVec14[1]))) + ((fConst11 * fRec2[2]) + (fConst9 * fRec2[1]))));
