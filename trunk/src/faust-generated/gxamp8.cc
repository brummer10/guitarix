...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	fConst12 = (1.8605695850647828 / fConst5);
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec8[0] = ((fConst21 * fRec8[1]) + (fConst83 * ((fConst17 * fRec9[0]) + (fConst18 * fRec9[1]))));
		...
		fRec70[0] = ((fConst21 * fRec70[1]) + (fConst83 * ((fConst17 * fRec71[0]) + (fConst18 * fRec71[1]))));
