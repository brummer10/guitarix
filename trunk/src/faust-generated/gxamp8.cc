...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	fConst14 = (1 + ((0.7653668647301795 + fConst12) / fConst10));
	fConst15 = (1.0 / fConst14);
	fConst16 = (1 + ((fConst12 - 1.8477590650225735) / fConst10));
	fConst17 = (1.0 / (1 + ((fConst12 + 1.8477590650225735) / fConst10)));
	fConst18 = (973.8937226128359 / double(iConst0));
	fConst19 = (1 - fConst18);
	fConst20 = (1.0 / (1 + fConst18));
	fConst21 = (2.0 / fConst14);
	fConst22 = (1.0 / tan((270.1769682087222 / double(iConst0))));
	fConst23 = (1 + fConst22);
	fConst24 = (0.027 / fConst23);
	fConst25 = (0 - ((1 - fConst22) / fConst23));
	fConst26 = (1.0 / tan((97.38937226128358 / double(iConst0))));
	fConst27 = (0 - fConst26);
	fConst28 = (1 + fConst26);
	fConst29 = (0.1 / fConst28);
	fConst30 = (0 - ((1 - fConst26) / fConst28));
	fConst31 = (1.0 / tan((414.6902302738527 / double(iConst0))));
	fConst32 = (1 + fConst31);
	fConst33 = (0.015 / fConst32);
	fConst34 = (0 - ((1 - fConst31) / fConst32));
	fConst35 = (1.0 / fConst7);
	fConst36 = (1.0 / tan((609.4689747964198 / double(iConst0))));
	fConst37 = (1 + fConst36);
	fConst38 = (0.0082 / fConst37);
	...
	fConst47 = (1.0 / (1 + ((1.0000000000000004 + fConst45) / fConst42)));
	...
	fConst62 = tan((47123.8898038469 / double(iConst0)));
	fConst63 = (2 * (1 - (1.0 / faustpower<2>(fConst62))));
	fConst64 = (1.0 / fConst62);
	fConst65 = (1 + ((fConst64 - 1.414213562373095) / fConst62));
	fConst66 = (1 + ((1.414213562373095 + fConst64) / fConst62));
	fConst67 = (1.0 / fConst66);
	fConst68 = (1.0 / (fConst28 * fConst66));
	fConst69 = (1 + fConst58);
	fConst70 = (1.0 / fConst69);
	fConst71 = (0 - ((1 - fConst58) / fConst69));
	fConst72 = (1 + fConst51);
	fConst73 = (1.0 / (fConst72 * fConst60));
	fConst74 = (0 - ((1 - fConst51) / fConst72));
	fConst75 = (1 + fConst45);
	fConst76 = (1.0 / (fConst75 * fConst53));
	fConst77 = (0 - ((1 - fConst45) / fConst75));
	fConst78 = (1 + ((fConst45 - 1.0) / fConst42));
	fConst79 = (1.0 / (1 + ((1.0 + fConst45) / fConst42)));
	fConst80 = (0 - fConst51);
	fConst81 = (2 * (0 - fConst49));
	fConst82 = (1 + ((fConst51 - 1.0) / fConst48));
	fConst83 = (1.0 / (1 + ((1.0 + fConst51) / fConst48)));
	fConst84 = (0 - fConst58);
	fConst85 = (2 * (0 - fConst56));
	fConst86 = (0 - fConst45);
	fConst87 = (2 * (0 - fConst43));
	fConst88 = (0.025 / fConst28);
	fConst89 = (1 + fConst3);
	fConst90 = (1.0 / fConst89);
	fConst91 = (0 - ((1 - fConst3) / fConst89));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	double 	fSlow10 = (fConst47 * pow(1e+01,(2 * fSlow3)));
	...
	for (int i=0; i<ReCount; i++) {
		...
		fVec0[0] = fTemp3;
		fRec31[0] = (fConst20 * ((fVec0[0] - fVec0[1]) + (fConst19 * fRec31[1])));
		fRec30[0] = (fConst20 * ((fRec31[0] - fRec31[1]) + (fConst19 * fRec30[1])));
		fRec29[0] = (fRec30[0] - (fConst17 * ((fConst16 * fRec29[2]) + (fConst11 * fRec29[1]))));
		fRec28[0] = ((fConst17 * (fRec29[2] + (fRec29[0] + (2 * fRec29[1])))) - (fConst15 * ((fConst13 * fRec28[2]) + (fConst11 * fRec28[1]))));
		fRec32[0] = ((0.999 * fRec32[1]) + fSlow2);
		fRec33[0] = ((fConst25 * fRec33[1]) + (fConst24 * (fRec27[1] + fRec27[2])));
		fRec27[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec33[0] + (fConst21 * (fRec32[0] * (fRec28[2] + (fRec28[0] + (2 * fRec28[1])))))) - 1.25724)) - 83.43555555555557);
		fRec26[0] = ((fConst30 * fRec26[1]) + (fConst29 * ((fConst26 * fRec27[0]) + (fConst27 * fRec27[1]))));
		fRec36[0] = ((fConst34 * fRec36[1]) + (fConst33 * (fRec35[1] + fRec35[2])));
		fRec35[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec36[0] + fRec25[1]) - 0.776162)) - 78.25586666666666);
		fRec34[0] = ((fConst30 * fRec34[1]) + (fConst29 * ((fConst26 * fRec35[0]) + (fConst27 * fRec35[1]))));
		fRec25[0] = ((0.6 * fRec34[0]) + fRec26[0]);
		fRec24[0] = ((fConst9 * fRec24[1]) + (fConst35 * (fRec25[0] + fRec25[1])));
		fRec37[0] = ((fConst34 * fRec37[1]) + (fConst33 * (fRec23[1] + fRec23[2])));
		fRec23[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec37[0] + fRec24[0]) - 0.776162)) - 78.25586666666666);
		fRec22[0] = ((fConst30 * fRec22[1]) + (fConst29 * ((fConst26 * fRec23[0]) + (fConst27 * fRec23[1]))));
		fRec40[0] = ((fConst39 * fRec40[1]) + (fConst38 * (fRec39[1] + fRec39[2])));
		fRec39[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec40[0] + fRec21[1]) - 0.445487)) - 75.67231707317073);
		fRec38[0] = ((fConst30 * fRec38[1]) + (fConst29 * ((fConst26 * fRec39[0]) + (fConst27 * fRec39[1]))));
		fRec21[0] = ((0.6 * fRec38[0]) + fRec22[0]);
		fRec41[0] = ((fConst39 * fRec41[1]) + (fConst38 * (fRec20[1] + fRec20[2])));
		fRec20[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec41[0] + fRec21[0]) - 0.445487)) - 75.67231707317073);
		fRec19[0] = ((fConst30 * fRec19[1]) + (fConst29 * ((fConst26 * fRec20[0]) + (fConst27 * fRec20[1]))));
		...
		fRec16[0] = ((fVec1[IOTA&32767] + fRec16[1]) - fVec1[(IOTA-iConst40)&32767]);
		fRec15[0] = ((0.999 * fRec15[1]) + (fConst41 * fRec16[0]));
		...
		fRec50[0] = ((0.024937655860349125 * fTemp16) - (fConst67 * ((fConst65 * fRec50[2]) + (fConst63 * fRec50[1]))));
		double fTemp18 = (fRec50[2] + (fRec50[0] + (2 * fRec50[1])));
		fVec2[0] = fTemp18;
		fRec49[0] = ((fConst30 * fRec49[1]) + (fConst68 * ((fConst26 * fVec2[0]) + (fConst27 * fVec2[1]))));
		fRec48[0] = ((fConst71 * fRec48[1]) + (fConst70 * (fRec49[0] + fRec49[1])));
		fRec47[0] = (fRec48[0] - (fConst61 * ((fConst59 * fRec47[2]) + (fConst57 * fRec47[1]))));
		double fTemp19 = (fRec47[2] + (fRec47[0] + (2 * fRec47[1])));
		fVec3[0] = fTemp19;
		fRec46[0] = ((fConst74 * fRec46[1]) + (fConst73 * (fVec3[0] + fVec3[1])));
		fRec45[0] = (fRec46[0] - (fConst54 * ((fConst52 * fRec45[2]) + (fConst50 * fRec45[1]))));
		double fTemp20 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec4[0] = fTemp20;
		fRec44[0] = ((fConst77 * fRec44[1]) + (fConst76 * (fVec4[0] + fVec4[1])));
		fRec43[0] = (fRec44[0] - (fConst47 * ((fConst46 * fRec43[2]) + (fConst44 * fRec43[1]))));
		double fTemp21 = max((double)-1, min((double)1, (fSlow7 * (fRec43[2] + (fRec43[0] + (2 * fRec43[1]))))));
		double fTemp22 = (fConst44 * fRec51[1]);
		fRec53[0] = ((fConst74 * fRec53[1]) + (fConst73 * ((fConst51 * fVec3[0]) + (fConst80 * fVec3[1]))));
		fRec52[0] = (fRec53[0] - (fConst54 * ((fConst52 * fRec52[2]) + (fConst50 * fRec52[1]))));
		fRec51[0] = ((fConst54 * (((fConst49 * fRec52[0]) + (fConst81 * fRec52[1])) + (fConst49 * fRec52[2]))) - (fConst79 * ((fConst78 * fRec51[2]) + fTemp22)));
		double fTemp23 = max((double)-1, min((double)1, (fSlow8 * (fRec51[2] + (fConst79 * (fTemp22 + (fConst78 * fRec51[0])))))));
		double fTemp24 = (fConst44 * fRec54[1]);
		double fTemp25 = (fConst50 * fRec55[1]);
		fRec57[0] = ((fConst71 * fRec57[1]) + (fConst70 * ((fConst58 * fRec49[0]) + (fConst84 * fRec49[1]))));
		fRec56[0] = (fRec57[0] - (fConst61 * ((fConst59 * fRec56[2]) + (fConst57 * fRec56[1]))));
		fRec55[0] = ((fConst61 * (((fConst56 * fRec56[0]) + (fConst85 * fRec56[1])) + (fConst56 * fRec56[2]))) - (fConst83 * ((fConst82 * fRec55[2]) + fTemp25)));
		fRec54[0] = ((fRec55[2] + (fConst83 * (fTemp25 + (fConst82 * fRec55[0])))) - (fConst79 * ((fConst78 * fRec54[2]) + fTemp24)));
		double fTemp26 = max((double)-1, min((double)1, (fSlow9 * (fRec54[2] + (fConst79 * (fTemp24 + (fConst78 * fRec54[0])))))));
		fRec59[0] = ((fConst77 * fRec59[1]) + (fConst76 * ((fConst45 * fVec4[0]) + (fConst86 * fVec4[1]))));
		fRec58[0] = (fRec59[0] - (fConst47 * ((fConst46 * fRec58[2]) + (fConst44 * fRec58[1]))));
		double fTemp27 = max((double)-1, min((double)1, (fSlow10 * (((fConst43 * fRec58[0]) + (fConst87 * fRec58[1])) + (fConst43 * fRec58[2])))));
		...
		fRec60[0] = ((fConst30 * fRec60[1]) + (fConst88 * ((fConst26 * fRec61[0]) + (fConst27 * fRec61[1]))));
		...
		fVec7[0] = fTemp33;
		fRec1[0] = ((fConst91 * fRec1[1]) + (fConst90 * (fVec7[0] + fVec7[1])));
