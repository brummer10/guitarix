...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec0[0] = fTemp0;
		fRec39[0] = ((1.8605695850647828 * (fTemp0 + fVec0[1])) - (0.86056958506478287 * fRec39[1]));
		...
		double fTemp1 = (0.10000000000000001 * (fRec20[0] * fRec44[0]));
		...
		double fTemp24 = ((fRec12[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp22)))) + ((fTemp23 * ((1.25 * (fRec48[0] * ((0.40000000000000002 * (1.0 - std::fabs((0.10000000000000001 * fTemp23)))) + -0.10000000000000001))) + 0.10000000000000001)) + (0.024937655860349125 * (fTemp10 * (1.0 - std::max<double>(0.0, fTemp22))))));
		fVec6[0] = fTemp24;
