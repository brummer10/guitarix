...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	fConst29 = (3.1415926535897931 / fConst0);
	fConst30 = (1.0 / (fConst29 + 1.0));
	fConst31 = (1.0 - fConst29);
	fConst32 = (1.0 / std::tan((414.69023027385271 / fConst0)));
	fConst33 = (1.0 / (fConst32 + 1.0));
	fConst34 = (1.0 - fConst32);
	fConst35 = (1.0 / std::tan((270.1769682087222 / fConst0)));
	...
	fConst43 = mydsp_faustpower2_f(fConst13);
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp6 = (double(buf[i]) * fRec48[0]);
		fVec2[0] = fTemp6;
