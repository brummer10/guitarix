...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow8 = (fConst80 * pow(1e+01,(2 * fSlow3)));
	double 	fSlow9 = (fConst80 * pow(1e+01,(0.9 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp16 = (fConst56 * fRec37[1]);
		fRec41[0] = ((0.024937655860349125 * fTemp14) - (fConst74 * ((fConst72 * fRec41[2]) + (fConst70 * fRec41[1]))));
		double fTemp17 = (fRec41[2] + (fRec41[0] + (2 * fRec41[1])));
		fVec2[0] = fTemp17;
		fRec40[0] = ((fConst75 * ((fConst35 * fVec2[1]) + (fConst12 * fVec2[0]))) + (fConst14 * fRec40[1]));
		fRec39[0] = ((fConst77 * ((fConst76 * fRec40[1]) + (fConst63 * fRec40[0]))) + (fConst68 * fRec39[1]));
		fRec38[0] = (fRec39[0] - (fConst66 * ((fConst64 * fRec38[2]) + (fConst62 * fRec38[1]))));
		fRec37[0] = ((fConst66 * (((fConst61 * fRec38[0]) + (fConst78 * fRec38[1])) + (fConst61 * fRec38[2]))) - (fConst59 * ((fConst58 * fRec37[2]) + fTemp16)));
		fRec36[0] = ((fRec37[2] + (fConst59 * (fTemp16 + (fConst58 * fRec37[0])))) - (fConst53 * ((fConst52 * fRec36[2]) + fTemp15)));
		double fTemp18 = max(-1, min(1, (fSlow7 * (fRec36[2] + (fConst53 * (fTemp15 + (fConst52 * fRec36[0])))))));
		fRec47[0] = ((fConst77 * (fRec40[0] + fRec40[1])) + (fConst68 * fRec47[1]));
		fRec46[0] = (fRec47[0] - (fConst66 * ((fConst64 * fRec46[2]) + (fConst62 * fRec46[1]))));
		double fTemp19 = (fRec46[2] + (fRec46[0] + (2 * fRec46[1])));
		fVec3[0] = fTemp19;
		fRec45[0] = ((fConst88 * (fVec3[0] + fVec3[1])) + (fConst87 * fRec45[1]));
		fRec44[0] = (fRec45[0] - (fConst85 * ((fConst83 * fRec44[2]) + (fConst56 * fRec44[1]))));
		double fTemp20 = (fRec44[2] + (fRec44[0] + (2 * fRec44[1])));
		fVec4[0] = fTemp20;
		fRec43[0] = ((fConst90 * ((fConst89 * fVec4[1]) + (fConst51 * fVec4[0]))) + (fConst82 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst80 * ((fConst79 * fRec42[2]) + (fConst50 * fRec42[1]))));
		double fTemp21 = max(-1, min(1, (fSlow8 * (((fConst49 * fRec42[0]) + (fConst91 * fRec42[1])) + (fConst49 * fRec42[2])))));
		fRec49[0] = ((fConst90 * (fVec4[0] + fVec4[1])) + (fConst82 * fRec49[1]));
		fRec48[0] = (fRec49[0] - (fConst80 * ((fConst79 * fRec48[2]) + (fConst50 * fRec48[1]))));
		double fTemp22 = max(-1, min(1, (fSlow9 * (fRec48[2] + (fRec48[0] + (2 * fRec48[1]))))));
		double fTemp23 = (fConst50 * fRec50[1]);
		fRec52[0] = ((fConst88 * ((fConst92 * fVec3[1]) + (fConst57 * fVec3[0]))) + (fConst87 * fRec52[1]));
		fRec51[0] = (fRec52[0] - (fConst85 * ((fConst83 * fRec51[2]) + (fConst56 * fRec51[1]))));
		fRec50[0] = ((fConst85 * (((fConst55 * fRec51[0]) + (fConst93 * fRec51[1])) + (fConst55 * fRec51[2]))) - (fConst53 * ((fConst52 * fRec50[2]) + fTemp23)));
		double fTemp24 = max(-1, min(1, (fSlow10 * (fRec50[2] + (fConst53 * (fTemp23 + (fConst52 * fRec50[0])))))));
		...
		fVec5[0] = fTemp25;
		fRec35[0] = ((fConst94 * (fVec5[0] + fVec5[1])) + (fConst17 * fRec35[1]));
		...
		fRec53[0] = ((fConst95 * ((fConst35 * fRec54[1]) + (fConst12 * fRec54[0]))) + (fConst14 * fRec53[1]));
		double fTemp28 = (min(0.7, fRec53[0]) + max(-0.75, fRec3[0]));
		fVec7[0] = fTemp28;
		fRec2[0] = (fConst97 * ((fVec7[2] + (fVec7[0] + (fConst96 * fVec7[1]))) + ((fConst11 * fRec2[2]) + (fConst9 * fRec2[1]))));
