...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6C16_68k, ((fRec35[0] + fRec14[0]) - 2.921806)) - 141.78496296296294);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec36[0] + fRec8[0]) - 2.097743)) - 110.15046666666666);
		...
		fRec2[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec37[0] + fRec3[0]) - 1.378742)) - 81.86073170731709);
