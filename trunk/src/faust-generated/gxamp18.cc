...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp17 = (fTemp15 + fTemp16) / (Ranode(TUBE_TABLE_6C16_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp17;
		fRec34[0] = fConst61 * (2.7e+03 * (fTemp17 + fVec5[1]) - fConst60 * fRec34[1]);
		fRec11[0] = Ftube(TUBE_TABLE_6C16_68k, fTemp16 + fRec34[0] + fTemp15 + -2.921806) + -141.78496296296294;
		...
		double fTemp21 = (fTemp19 + fTemp20) / (Ranode(TUBE_TABLE_6C16_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp21;
		fRec37[0] = fConst67 * (1.5e+03 * (fTemp21 + fVec7[1]) - fConst66 * fRec37[1]);
		fRec6[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp20 + fRec37[0] + fTemp19 + -2.097743) + -110.15046666666666;
		...
		double fTemp25 = (fTemp23 + fTemp24) / (Ranode(TUBE_TABLE_6C16_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp25;
		fRec39[0] = fConst70 * (8.2e+02 * (fTemp25 + fVec9[1]) - fConst69 * fRec39[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp24 + fRec39[0] + fTemp23 + -1.378742) + -81.86073170731709;
