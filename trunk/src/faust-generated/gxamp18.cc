...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec19[0]))) + (fRec29[0] + (fSlow9 * fRec10[0]))) - 2.921806)) - 141.78496296296294);
