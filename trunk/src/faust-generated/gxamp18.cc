...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec11[0] = (Ftube(TUBE_TABLE_6C16_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec21[0]))) + (fRec31[0] + (fSlow9 * fRec12[0]))) - 2.921806)) - 141.78496296296294);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec32[0] + fRec8[0]) - 2.097743)) - 110.15046666666666);
		...
		fRec4[0] = (Ftube(TUBE_TABLE_6C16_250k, ((fRec33[0] + fRec5[0]) - 1.378742)) - 81.86073170731709);
