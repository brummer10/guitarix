...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp19 + (fRec36[0] + fTemp20)) + -2.0977429999999999)))) + -110.15046666666666);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp23 + (fRec37[0] + fTemp24)) + -1.3787419999999999)))) + -81.860731707317086);
