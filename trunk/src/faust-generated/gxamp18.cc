...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp18 = double(Ftube(int(TUBE_TABLE_6C16_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -2.9218060000000001))));
		fRec12[0] = ((fTemp18 + (0.0010821503703703705 * (double(Ranode(int(TUBE_TABLE_6C16_68k), double(fTemp18))) + 100000.0))) + -250.0);
		...
		double fTemp23 = double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp20 + (fRec36[0] + fTemp21)) + -2.0977429999999999))));
		fRec7[0] = ((fTemp23 + (0.0013984953333333332 * (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fTemp23))) + 100000.0))) + -250.0);
		...
		double fTemp28 = double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp25 + (fRec37[0] + fTemp26)) + -1.3787419999999999))));
		fRec1[0] = ((fTemp28 + (0.0016813926829268291 * (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fTemp28))) + 100000.0))) + -250.0);
