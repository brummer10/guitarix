...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec6[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp21 + fRec37[0] + fTemp20 + -2.097743) + -110.15046666666666;
		...
		fRec1[0] = Ftube(TUBE_TABLE_6C16_250k, fTemp26 + fRec39[0] + fTemp25 + -1.378742) + -81.86073170731709;
