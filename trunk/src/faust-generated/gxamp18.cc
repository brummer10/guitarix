...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp17 = ((fTemp16 + fTemp15) / (double(Ranode(int(TUBE_TABLE_6C16_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp17;
		fRec35[0] = (fConst60 * ((2700.0 * (fTemp17 + fVec5[1])) - (fConst61 * fRec35[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_6C16_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -2.9218060000000001)))) + -141.78496296296294);
		...
		double fTemp21 = ((fTemp20 + fTemp19) / (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp21;
		fRec37[0] = (fConst66 * ((1500.0 * (fTemp21 + fVec7[1])) - (fConst67 * fRec37[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp19 + (fRec37[0] + fTemp20)) + -2.0977429999999999)))) + -110.15046666666666);
		...
		double fTemp25 = ((fTemp24 + fTemp23) / (double(Ranode(int(TUBE_TABLE_6C16_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp25;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp25 + fVec9[1])) - (fConst70 * fRec39[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6C16_250k), double(((fTemp23 + (fRec39[0] + fTemp24)) + -1.3787419999999999)))) + -81.860731707317086);
		...
		buf[i] = FAUSTFLOAT(((iSlow0 ? fRec40[0] : fRec0[0]) * fRec41[0]));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
