...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		output0[i0] = FAUSTFLOAT(double(input0[i0]) * (1.0 - fSlow1 * (1.0 - ftbl0mydspSIG0[std::max<int>(0, std::min<int>(int(65536.0 * fRec1[0]), 65535))])));
		iVec1[1] = iVec1[0];
		fRec1[1] = fRec1[0];
	}
}
...
{
	reg.registerFloatVar("ring_modulator.dry/wet",N_("Mix"),"S","",&fHslider1, 0.5, 0.0, 1.0, 0.05, 0);
	reg.registerFloatVar("ring_modulator.freq",N_("Freq"),"S","",&fHslider0, 2.4e+02, 1.2e+02, 1.6e+03, 0.5, 0);
	return 0;
}
