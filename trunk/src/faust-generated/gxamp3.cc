...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp18 = double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -3.7189619999999999))));
		fRec12[0] = ((fTemp18 + (0.0013773933333333334 * (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fTemp18))) + 100000.0))) + -250.0);
		...
		double fTemp23 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp20 + (fRec36[0] + fTemp21)) + -2.3148439999999999))));
		fRec7[0] = ((fTemp23 + (0.0015432293333333333 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp23))) + 100000.0))) + -250.0);
		...
		double fTemp28 = double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp25 + (fRec37[0] + fTemp26)) + -1.3565670000000001))));
		fRec1[0] = ((fTemp28 + (0.0016543500000000002 * (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fTemp28))) + 100000.0))) + -250.0);
