...
#define fslider3 (*fslider3_)
	...
	double 	fSlow7 = (fConst6 * pow(1e+01,(2 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		fRec18[0] = ((fTemp0 * fRec19[0]) - (fConst26 * ((fConst24 * fRec18[2]) + (fConst22 * fRec18[1]))));
		double fTemp1 = (fRec18[2] + (fRec18[0] + (2 * fRec18[1])));
		fVec0[0] = fTemp1;
		fRec17[0] = ((fConst31 * fRec17[1]) + (fConst30 * ((fConst27 * fVec0[0]) + (fConst28 * fVec0[1]))));
		fRec16[0] = ((fConst34 * fRec16[1]) + (fConst33 * (fRec17[0] + fRec17[1])));
		fRec15[0] = (fRec16[0] - (fConst20 * ((fConst18 * fRec15[2]) + (fConst16 * fRec15[1]))));
		double fTemp2 = (fRec15[2] + (fRec15[0] + (2 * fRec15[1])));
		fVec1[0] = fTemp2;
		fRec14[0] = ((fConst37 * fRec14[1]) + (fConst36 * (fVec1[0] + fVec1[1])));
		fRec13[0] = (fRec14[0] - (fConst13 * ((fConst11 * fRec13[2]) + (fConst9 * fRec13[1]))));
		double fTemp3 = (fRec13[2] + (fRec13[0] + (2 * fRec13[1])));
		fVec2[0] = fTemp3;
		fRec12[0] = ((fConst40 * fRec12[1]) + (fConst39 * (fVec2[0] + fVec2[1])));
		fRec11[0] = (fRec12[0] - (fConst6 * ((fConst5 * fRec11[2]) + (fConst3 * fRec11[1]))));
		double fTemp4 = max((double)-1, min((double)1, (fSlow4 * (fRec11[2] + (fRec11[0] + (2 * fRec11[1]))))));
		double fTemp5 = (fConst3 * fRec20[1]);
		fRec22[0] = ((fConst37 * fRec22[1]) + (fConst36 * ((fConst10 * fVec1[0]) + (fConst43 * fVec1[1]))));
		fRec21[0] = (fRec22[0] - (fConst13 * ((fConst11 * fRec21[2]) + (fConst9 * fRec21[1]))));
		fRec20[0] = ((fConst13 * (((fConst8 * fRec21[0]) + (fConst44 * fRec21[1])) + (fConst8 * fRec21[2]))) - (fConst42 * ((fConst41 * fRec20[2]) + fTemp5)));
		double fTemp6 = max((double)-1, min((double)1, (fSlow5 * (fRec20[2] + (fConst42 * (fTemp5 + (fConst41 * fRec20[0])))))));
		double fTemp7 = (fConst3 * fRec23[1]);
		double fTemp8 = (fConst9 * fRec24[1]);
		fRec26[0] = ((fConst34 * fRec26[1]) + (fConst33 * ((fConst17 * fRec17[0]) + (fConst47 * fRec17[1]))));
		fRec25[0] = (fRec26[0] - (fConst20 * ((fConst18 * fRec25[2]) + (fConst16 * fRec25[1]))));
		fRec24[0] = ((fConst20 * (((fConst15 * fRec25[0]) + (fConst48 * fRec25[1])) + (fConst15 * fRec25[2]))) - (fConst46 * ((fConst45 * fRec24[2]) + fTemp8)));
		fRec23[0] = ((fRec24[2] + (fConst46 * (fTemp8 + (fConst45 * fRec24[0])))) - (fConst42 * ((fConst41 * fRec23[2]) + fTemp7)));
		double fTemp9 = max((double)-1, min((double)1, (fSlow6 * (fRec23[2] + (fConst42 * (fTemp7 + (fConst41 * fRec23[0])))))));
		fRec28[0] = ((fConst40 * fRec28[1]) + (fConst39 * ((fConst4 * fVec2[0]) + (fConst49 * fVec2[1]))));
		fRec27[0] = (fRec28[0] - (fConst6 * ((fConst5 * fRec27[2]) + (fConst3 * fRec27[1]))));
		double fTemp10 = max((double)-1, min((double)1, (fSlow7 * (((fConst2 * fRec27[0]) + (fConst50 * fRec27[1])) + (fConst2 * fRec27[2])))));
		...
		fVec3[0] = fTemp11;
		fRec10[0] = ((fConst54 * fRec10[1]) + (fConst53 * (fVec3[0] + fVec3[1])));
		fRec29[0] = ((fConst58 * fRec29[1]) + (fConst57 * (fRec9[1] + fRec9[2])));
		double fTemp12 = (1 - fRec19[0]);
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec19[0]))) + (fRec29[0] + (fSlow9 * fRec10[0]))) - 3.718962)) - 112.26066666666668);
		fRec8[0] = ((fConst31 * fRec8[1]) + (fConst59 * ((fConst27 * fRec9[0]) + (fConst28 * fRec9[1]))));
		double fTemp13 = (fRec8[0] * fRec7[0]);
		fVec4[0] = fTemp13;
		fRec6[0] = ((fConst54 * fRec6[1]) + (fConst60 * (fVec4[0] + fVec4[1])));
		fRec30[0] = ((fConst64 * fRec30[1]) + (fConst63 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec30[0] + fRec6[0]) - 2.314844)) - 95.67706666666666);
		fRec4[0] = ((fConst31 * fRec4[1]) + (fConst59 * ((fConst27 * fRec5[0]) + (fConst28 * fRec5[1]))));
		double fTemp14 = (fRec7[0] * fRec4[0]);
		fVec5[0] = fTemp14;
		fRec3[0] = ((fConst54 * fRec3[1]) + (fConst60 * (fVec5[0] + fVec5[1])));
		fRec31[0] = ((fConst68 * fRec31[1]) + (fConst67 * (fRec2[1] + fRec2[2])));
