...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp0 = pow(10,(0.05 * fRec4[0]));
		double fTemp1 = (fConst8 * fRec11[1]);
		double fTemp2 = (fConst14 * fRec12[1]);
		fRec17[0] = (fSlow3 + (0.999 * fRec17[1]));
		double fTemp3 = (double)input0[i];
		fRec16[0] = ((fTemp3 * fRec17[0]) - (fConst32 * ((fConst30 * fRec16[2]) + (fConst28 * fRec16[1]))));
		...
		fRec12[0] = ((fConst24 * (((fConst19 * fRec13[0]) + (fConst37 * fRec13[1])) + (fConst19 * fRec13[2]))) - (fConst17 * ((fConst16 * fRec12[2]) + fTemp2)));
		fRec11[0] = ((fRec12[2] + (fConst17 * (fTemp2 + (fConst16 * fRec12[0])))) - (fConst11 * ((fConst10 * fRec11[2]) + fTemp1)));
		double fTemp5 = max(-1, min(1, (fSlow5 * (fRec11[2] + (fConst11 * (fTemp1 + (fConst10 * fRec11[0])))))));
		...
		double fTemp8 = max(-1, min(1, (fSlow6 * (((fConst7 * fRec18[0]) + (fConst50 * fRec18[1])) + (fConst7 * fRec18[2])))));
		fRec25[0] = ((fConst49 * (fVec2[0] + fVec2[1])) + (fConst41 * fRec25[1]));
		fRec24[0] = (fRec25[0] - (fConst39 * ((fConst38 * fRec24[2]) + (fConst8 * fRec24[1]))));
		double fTemp9 = max(-1, min(1, (fSlow7 * (fRec24[2] + (fRec24[0] + (2 * fRec24[1]))))));
		...
		fRec26[0] = ((fConst44 * (((fConst13 * fRec27[0]) + (fConst52 * fRec27[1])) + (fConst13 * fRec27[2]))) - (fConst11 * ((fConst10 * fRec26[2]) + fTemp10)));
		double fTemp11 = max(-1, min(1, (fSlow8 * (fRec26[2] + (fConst11 * (fTemp10 + (fConst10 * fRec26[0])))))));
		...
		double fTemp13 = (fRec9[1] - 2.5e+02);
		fVec4[0] = fTemp13;
		fRec29[0] = ((fConst57 * (fVec4[0] + fVec4[1])) + (fConst56 * fRec29[1]));
		fRec30[0] = (fSlow11 + (0.999 * fRec30[1]));
		fRec9[0] = Ftube3(0, ((fTemp3 * ((fSlow13 * fRec17[0]) + (fRec30[0] * (1 + (fSlow12 * ((4 - (4 * fabs((fTemp3 * fRec30[0])))) - 1)))))) + (fRec29[0] + (fSlow10 * fRec10[0]))));
		fRec8[0] = ((fConst58 * ((fConst33 * fRec9[1]) + (fConst0 * fRec9[0]))) + (fConst2 * fRec8[1]));
		double fTemp14 = (fRec8[0] * fTemp0);
		fVec5[0] = fTemp14;
		fRec7[0] = ((fConst59 * (fVec5[0] + fVec5[1])) + (fConst5 * fRec7[1]));
		double fTemp15 = (fRec6[1] - 2.5e+02);
		fVec6[0] = fTemp15;
		fRec31[0] = ((fConst63 * (fVec6[0] + fVec6[1])) + (fConst62 * fRec31[1]));
		fRec6[0] = Ftube3(1, (fRec31[0] + fRec7[0]));
		fRec5[0] = ((fConst58 * ((fConst33 * fRec6[1]) + (fConst0 * fRec6[0]))) + (fConst2 * fRec5[1]));
		double fTemp16 = (fRec5[0] * fTemp0);
		fVec7[0] = fTemp16;
		fRec3[0] = ((fConst59 * (fVec7[0] + fVec7[1])) + (fConst5 * fRec3[1]));
		double fTemp17 = (fRec2[1] - 2.5e+02);
		fVec8[0] = fTemp17;
		fRec32[0] = ((fConst67 * (fVec8[0] + fVec8[1])) + (fConst66 * fRec32[1]));
		fRec2[0] = Ftube3(1, (fRec32[0] + fRec3[0]));
		fRec1[0] = ((fConst58 * ((fConst33 * fRec2[1]) + (fConst0 * fRec2[0]))) + (fConst2 * fRec1[1]));
		output0[i] = (FAUSTFLOAT)(2.0 * (fRec1[0] * pow(10,(0.05 * fRec0[0]))));
		// post processing
		fRec1[1] = fRec1[0];
		fRec2[1] = fRec2[0];
		fRec32[1] = fRec32[0];
