...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow4 = (fConst39 * pow(1e+01,(2 * fSlow2)));
	double 	fSlow5 = (fConst39 * pow(1e+01,(0.9 * fSlow2)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp7 = max(-1, min(1, (fSlow4 * (((fConst7 * fRec17[0]) + (fConst50 * fRec17[1])) + (fConst7 * fRec17[2])))));
		fRec24[0] = ((fConst49 * (fVec2[0] + fVec2[1])) + (fConst41 * fRec24[1]));
		fRec23[0] = (fRec24[0] - (fConst39 * ((fConst38 * fRec23[2]) + (fConst8 * fRec23[1]))));
		double fTemp8 = max(-1, min(1, (fSlow5 * (fRec23[2] + (fRec23[0] + (2 * fRec23[1]))))));
		...
		double fTemp10 = max(-1, min(1, (fSlow6 * (fRec25[2] + (fConst11 * (fTemp9 + (fConst10 * fRec25[0])))))));
