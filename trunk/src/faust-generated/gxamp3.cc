...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp19 + (fRec36[0] + fTemp20)) + -2.3148439999999999)))) + -95.677066666666661);
		...
		fVec9[0] = fTemp25;
		fRec37[0] = (fConst66 * ((820.0 * (fTemp25 + fVec9[1])) - (fConst67 * fRec37[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp23 + (fRec37[0] + fTemp24)) + -1.3565670000000001)))) + -84.564999999999998);
