...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp17 = ((fTemp16 + fTemp15) / (double(Ranode(int(TUBE_TABLE_12AU7_68k), double(fRec12[1]))) + 100000.0));
		fVec5[0] = fTemp17;
		fRec35[0] = (fConst60 * ((2700.0 * (fTemp17 + fVec5[1])) - (fConst61 * fRec35[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -3.7189619999999999)))) + -112.26066666666668);
		fRec11[0] = ((0.025000000000000001 * ((fConst4 * fRec12[0]) + (fConst26 * fRec12[1]))) - (fConst27 * fRec11[1]));
		fRec36[0] = (fConst63 * ((fConst64 * fRec36[1]) + (0.025000000000000001 * (fRec12[0] - fRec12[1]))));
		...
		double fTemp21 = ((fTemp20 + fTemp19) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp21;
		fRec37[0] = (fConst66 * ((1500.0 * (fTemp21 + fVec7[1])) - (fConst67 * fRec37[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp19 + (fRec37[0] + fTemp20)) + -2.3148439999999999)))) + -95.677066666666661);
		...
		fVec8[0] = fTemp22;
		fRec4[0] = (fConst6 * ((2.0 * (fTemp22 + fVec8[1])) - (fConst7 * fRec4[1])));
		...
		double fTemp25 = ((fTemp24 + fTemp23) / (double(Ranode(int(TUBE_TABLE_12AU7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp25;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp25 + fVec9[1])) - (fConst70 * fRec39[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double(((fTemp23 + (fRec39[0] + fTemp24)) + -1.3565670000000001)))) + -84.564999999999998);
		fRec0[0] = ((0.025000000000000001 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec40[0] = (fConst63 * ((fConst64 * fRec40[1]) + (0.025000000000000001 * (fRec1[0] - fRec1[1]))));
		fRec41[0] = (fSlow5 + (0.999 * fRec41[1]));
		buf[i] = FAUSTFLOAT((2.0 * ((iSlow0 ? fRec40[0] : fRec0[0]) * fRec41[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
