...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec32[0] + (1.8508996845035413 * fRec10[1]))) + -3.7189619999999999)))) + -112.26066666666668);
		double fTemp15 = (fRec9[0] * fRec4[0]);
		fVec5[0] = fTemp15;
		fRec8[0] = (fConst2 * ((0.050000000000000003 * (fTemp15 + fVec5[1])) - (fConst3 * fRec8[1])));
		...
		fRec5[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec6[0] + fRec6[2])) + (fRec33[0] + (1.8508996845035413 * fRec6[1]))) + -2.3148439999999999)))) + -95.677066666666661);
		double fTemp16 = (fRec4[0] * fRec5[0]);
		fVec6[0] = fTemp16;
		fRec3[0] = (fConst2 * ((0.050000000000000003 * (fTemp16 + fVec6[1])) - (fConst3 * fRec3[1])));
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec34[0] + (1.8508996845035413 * fRec1[1]))) + -1.3565670000000001)))) + -84.564999999999998);
		fRec35[0] = (fSlow3 + (0.999 * fRec35[1]));
		buf[i] = FAUSTFLOAT((0.050000000000000003 * (fRec0[0] * fRec35[0])));
		fRec4[1] = fRec4[0];
		fRec20[1] = fRec20[0];
		fRec19[2] = fRec19[1];
		fRec19[1] = fRec19[0];
