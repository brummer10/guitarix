...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (2.0 * fRec9[1]);
		fRec11[0] = ((0.999 * fRec11[1]) + fSlow1);
		double fTemp2 = (2.0 * fRec15[1]);
		fRec16[0] = (fSlow2 + (0.999 * fRec16[1]));
		double fTemp3 = (1 - fRec16[0]);
		double fTemp4 = (double)input0[i];
		fRec25[0] = ((fTemp4 * fRec16[0]) - (fConst26 * ((fConst24 * fRec25[2]) + (fConst22 * fRec25[1]))));
		...
		fRec15[0] = (((fSlow11 * fRec17[0]) + (fTemp4 * ((fTemp3 * (1 + (fSlow6 * ((4 - (4 * fabs((fTemp4 * fTemp3)))) - 1)))) + (fSlow5 * fRec16[0])))) - (fTemp2 + fRec15[2]));
		double fTemp16 = (fRec15[2] + (fRec15[0] + fTemp2));
		fVec4[0] = fTemp16;
		fRec14[0] = ((1.0000000000000002 * (fVec4[0] + fVec4[1])) - (0.9999999999999998 * fRec14[1]));
		fRec35[0] = ((fConst58 * fRec35[1]) + (fConst57 * (fRec13[1] + fRec13[2])));
		fRec13[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec35[0] + fRec14[0]) - 3.718962)) - 112.26066666666668);
		...
		fRec9[0] = (fRec10[0] - (fTemp1 + fRec9[2]));
		double fTemp18 = (fRec9[2] + (fRec9[0] + fTemp1));
		fVec6[0] = fTemp18;
		fRec8[0] = ((1.0000000000000002 * (fVec6[0] + fVec6[1])) - (0.9999999999999998 * fRec8[1]));
		fRec36[0] = ((fConst64 * fRec36[1]) + (fConst63 * (fRec7[1] + fRec7[2])));
		fRec7[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec36[0] + fRec8[0]) - 2.314844)) - 95.67706666666666);
		fRec6[0] = ((fConst31 * fRec6[1]) + (fConst59 * ((fConst27 * fRec7[0]) + (fConst28 * fRec7[1]))));
		double fTemp19 = (fRec11[0] * fRec6[0]);
		fVec7[0] = fTemp19;
		fRec5[0] = ((fConst54 * fRec5[1]) + (fConst60 * (fVec7[0] + fVec7[1])));
		...
		fRec37[0] = ((fConst68 * fRec37[1]) + (fConst67 * (fRec2[1] + fRec2[2])));
		fRec2[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec37[0] + fRec3[0]) - 1.356567)) - 84.565);
