...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec24[0] = fTemp2 * fRec15[0] - fConst32 * (fConst31 * fRec24[2] + fConst29 * fRec24[1]);
		double fTemp3 = fRec24[2] + fRec24[0] + 2.0 * fRec24[1];
		fVec0[0] = fTemp3;
		fRec23[0] = fConst32 * (fConst33 * fTemp3 + fConst34 * fVec0[1]) - fConst4 * fRec23[1];
		fRec22[0] = 0.0 - fConst37 * (fConst35 * fRec22[1] - (fRec23[0] + fRec23[1]));
		fRec21[0] = fRec22[0] - fConst27 * (fConst26 * fRec21[2] + fConst24 * fRec21[1]);
		double fTemp4 = fRec21[2] + fRec21[0] + 2.0 * fRec21[1];
		fVec1[0] = fTemp4;
		fRec20[0] = 0.0 - fConst40 * (fConst38 * fRec20[1] - fConst27 * (fTemp4 + fVec1[1]));
		fRec19[0] = fRec20[0] - fConst20 * (fConst19 * fRec19[2] + fConst17 * fRec19[1]);
		double fTemp5 = fRec19[2] + fRec19[0] + 2.0 * fRec19[1];
		fVec2[0] = fTemp5;
		fRec18[0] = 0.0 - fConst43 * (fConst41 * fRec18[1] - fConst20 * (fTemp5 + fVec2[1]));
		fRec17[0] = fRec18[0] - fConst13 * (fConst12 * fRec17[2] + fConst10 * fRec17[1]);
		double fTemp6 = std::max<double>(-1.0, std::min<double>(1.0, fConst13 * (fRec17[2] + fRec17[0] + 2.0 * fRec17[1]) * std::pow(1e+01, 0.9 * fRec14[0])));
		fRec26[0] = fConst20 * (fConst45 * fTemp5 + fConst46 * fVec2[1]) - fConst44 * fRec26[1];
		fRec25[0] = fRec26[0] - fConst13 * (fConst12 * fRec25[2] + fConst10 * fRec25[1]);
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, fConst13 * (fConst9 * fRec25[0] + fConst47 * fRec25[1] + fConst9 * fRec25[2]) * std::pow(1e+01, 2.0 * fRec14[0])));
		double fTemp8 = fConst10 * fRec27[1];
		double fTemp9 = fConst17 * fRec28[1];
		fRec30[0] = fConst52 * fRec23[1] - fConst37 * (fConst35 * fRec30[1] - fConst25 * fRec23[0]);
		fRec29[0] = fRec30[0] - fConst27 * (fConst26 * fRec29[2] + fConst24 * fRec29[1]);
		fRec28[0] = fConst27 * (fConst23 * fRec29[0] + fConst53 * fRec29[1] + fConst23 * fRec29[2]) - fConst51 * (fConst50 * fRec28[2] + fTemp9);
		fRec27[0] = fRec28[2] + fConst51 * (fTemp9 + fConst50 * fRec28[0]) - fConst49 * (fConst48 * fRec27[2] + fTemp8);
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fRec27[2] + fConst49 * (fTemp8 + fConst48 * fRec27[0])) * std::pow(1e+01, 0.8 * fRec14[0])));
		double fTemp11 = fConst10 * fRec31[1];
		fRec33[0] = fConst27 * (fConst55 * fTemp4 + fConst56 * fVec1[1]) - fConst54 * fRec33[1];
		fRec32[0] = fRec33[0] - fConst20 * (fConst19 * fRec32[2] + fConst17 * fRec32[1]);
		fRec31[0] = fConst20 * (fConst16 * fRec32[0] + fConst57 * fRec32[1] + fConst16 * fRec32[2]) - fConst49 * (fConst48 * fRec31[2] + fTemp11);
		double fTemp12 = std::max<double>(-1.0, std::min<double>(1.0, (fRec31[2] + fConst49 * (fTemp11 + fConst48 * fRec31[0])) * std::pow(1e+01, 1.2 * fRec14[0])));
		...
		fVec3[0] = fTemp13;
		fRec16[0] = 0.0 - fConst58 * (fConst6 * fRec16[1] - (fTemp13 + fVec3[1]));
		...
		double fTemp17 = (fTemp15 + fTemp16) / (Ranode(TUBE_TABLE_12AU7_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp17;
		fRec34[0] = fConst61 * (2.7e+03 * (fTemp17 + fVec5[1]) - fConst60 * fRec34[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AU7_68k, fTemp16 + fRec34[0] + fTemp15 + -3.718962) + -112.26066666666668;
		...
		fVec6[0] = fTemp18;
		fRec9[0] = fConst58 * (2.0 * (fTemp18 + fVec6[1]) - fConst6 * fRec9[1]);
		...
		double fTemp21 = (fTemp19 + fTemp20) / (Ranode(TUBE_TABLE_12AU7_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp21;
		fRec37[0] = fConst67 * (1.5e+03 * (fTemp21 + fVec7[1]) - fConst66 * fRec37[1]);
		fRec6[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp20 + fRec37[0] + fTemp19 + -2.314844) + -95.67706666666666;
		...
		fVec8[0] = fTemp22;
		fRec4[0] = fConst58 * (2.0 * (fTemp22 + fVec8[1]) - fConst6 * fRec4[1]);
		...
		double fTemp25 = (fTemp23 + fTemp24) / (Ranode(TUBE_TABLE_12AU7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp25;
		fRec39[0] = fConst70 * (8.2e+02 * (fTemp25 + fVec9[1]) - fConst69 * fRec39[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AU7_250k, fTemp24 + fRec39[0] + fTemp23 + -1.356567) + -84.565;
		...
		buf[i0] = FAUSTFLOAT(2.0 * fRec41[0] * ((iSlow0) ? fRec40[0] : fRec0[0]));
		fRec14[1] = fRec14[0];
		fRec15[1] = fRec15[0];
		fRec24[2] = fRec24[1];
		fRec24[1] = fRec24[0];
