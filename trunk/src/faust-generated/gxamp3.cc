...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fVec5[0] = fTemp14;
		fRec10[0] = ((fConst54 * fRec10[1]) + (fConst60 * (fVec5[0] + fVec5[1])));
		...
		fRec36[0] = ((fConst64 * (fRec7[1] + fRec7[2])) + (fConst63 * fRec36[1]));
		...
		fVec6[0] = fTemp15;
		fRec5[0] = ((fConst54 * fRec5[1]) + (fConst60 * (fVec6[0] + fVec6[1])));
		...
		fRec37[0] = ((fConst68 * (fRec2[1] + fRec2[2])) + (fConst67 * fRec37[1]));
		...
		buf[i] = (FAUSTFLOAT)(2.0 * (fRec1[0] * fRec0[0]));
		// post processing
		fRec1[1] = fRec1[0];
