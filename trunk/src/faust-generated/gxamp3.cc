...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec6[0] = fTemp18;
		fRec10[0] = (fConst5 * ((2.0 * (fTemp18 + fVec6[1])) - (fConst6 * fRec10[1])));
		...
		fVec8[0] = fTemp22;
		fRec4[0] = (fConst5 * ((2.0 * (fTemp22 + fVec8[1])) - (fConst6 * fRec4[1])));
		...
		fVec9[0] = fTemp25;
		fRec37[0] = (fConst69 * ((820.0 * (fTemp25 + fVec9[1])) - (fConst70 * fRec37[1])));
