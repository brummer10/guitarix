...
inline void Dsp::clear_state_f()
{
	...
	for (int l44 = 0; (l44 < 2); l44 = (l44 + 1)) fRec37[l44] = 0.0;
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec5[0] = fTemp14;
		fRec10[0] = (fConst6 * ((2.0 * (fTemp14 + fVec5[1])) - (fConst7 * fRec10[1])));
		...
		fVec6[0] = fTemp15;
		fRec4[0] = (fConst6 * ((2.0 * (fTemp15 + fVec6[1])) - (fConst7 * fRec4[1])));
		...
		buf[i] = FAUSTFLOAT((2.0 * (fRec0[0] * fRec37[0])));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
