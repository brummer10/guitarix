...
void init(int samplingFreq)
{
	...
	fConst38 = (1 + ((fConst15 - 1.0000000000000004) / fConst12));
	fConst39 = (1 + ((fConst15 + 1.0000000000000004) / fConst12));
	fConst40 = (1.0 / fConst39);
	fConst41 = (1 + fConst15);
	fConst42 = (0 - ((1 - fConst15) / fConst41));
	for (int i=0; i<2; i++) fRec21[i] = 0;
	for (int i=0; i<3; i++) fRec20[i] = 0;
	for (int i=0; i<2; i++) fVec1[i] = 0;
	fConst43 = (0 - fConst15);
	fConst44 = (1.0 / (fConst41 * fConst23));
	for (int i=0; i<2; i++) fRec19[i] = 0;
	for (int i=0; i<3; i++) fRec18[i] = 0;
	fConst45 = (2 * (0 - fConst13));
	for (int i=0; i<3; i++) fRec17[i] = 0;
	fConst46 = (1 + ((fConst9 - 1.0000000000000004) / fConst6));
	fConst47 = (1.0 / (1 + ((fConst9 + 1.0000000000000004) / fConst6)));
	fConst48 = (1 + fConst9);
	fConst49 = (0 - ((1 - fConst9) / fConst48));
	for (int i=0; i<2; i++) fRec25[i] = 0;
	for (int i=0; i<3; i++) fRec24[i] = 0;
	for (int i=0; i<2; i++) fVec2[i] = 0;
	fConst50 = (0 - fConst9);
	fConst51 = (1.0 / (fConst48 * fConst39));
...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow5 = (fConst47 * pow(1e+01,(2 * fSlow2)));
	double 	fSlow6 = (fConst47 * pow(1e+01,(0.9 * fSlow2)));
	...
	for (int i=0; i<count; i++) {
		...
		fRec16[0] = (fTemp2 - (fConst32 * ((fConst30 * fRec16[2]) + (fConst28 * fRec16[1]))));
		...
		double fTemp4 = max(-1, min(1, (fSlow3 * (fRec11[2] + (fConst11 * (fTemp0 + (fConst10 * fRec11[0])))))));
		double fTemp5 = (fConst8 * fRec17[1]);
		fRec21[0] = ((fConst36 * (fRec15[0] + fRec15[1])) + (fConst26 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fConst24 * ((fConst22 * fRec20[2]) + (fConst20 * fRec20[1]))));
		double fTemp6 = (fRec20[2] + (fRec20[0] + (2 * fRec20[1])));
		fVec1[0] = fTemp6;
		fRec19[0] = ((fConst44 * ((fConst43 * fVec1[1]) + (fConst15 * fVec1[0]))) + (fConst42 * fRec19[1]));
		fRec18[0] = (fRec19[0] - (fConst40 * ((fConst38 * fRec18[2]) + (fConst14 * fRec18[1]))));
		fRec17[0] = ((fConst40 * (((fConst13 * fRec18[0]) + (fConst45 * fRec18[1])) + (fConst13 * fRec18[2]))) - (fConst11 * ((fConst10 * fRec17[2]) + fTemp5)));
		double fTemp7 = max(-1, min(1, (fSlow4 * (fRec17[2] + (fConst11 * (fTemp5 + (fConst10 * fRec17[0])))))));
		fRec25[0] = ((fConst44 * (fVec1[0] + fVec1[1])) + (fConst42 * fRec25[1]));
		fRec24[0] = (fRec25[0] - (fConst40 * ((fConst38 * fRec24[2]) + (fConst14 * fRec24[1]))));
		double fTemp8 = (fRec24[2] + (fRec24[0] + (2 * fRec24[1])));
		fVec2[0] = fTemp8;
		fRec23[0] = ((fConst51 * ((fConst50 * fVec2[1]) + (fConst9 * fVec2[0]))) + (fConst49 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst47 * ((fConst46 * fRec22[2]) + (fConst8 * fRec22[1]))));
		double fTemp9 = max(-1, min(1, (fSlow5 * (((fConst7 * fRec22[0]) + (fConst52 * fRec22[1])) + (fConst7 * fRec22[2])))));
		fRec27[0] = ((fConst51 * (fVec2[0] + fVec2[1])) + (fConst49 * fRec27[1]));
		fRec26[0] = (fRec27[0] - (fConst47 * ((fConst46 * fRec26[2]) + (fConst8 * fRec26[1]))));
		double fTemp10 = max(-1, min(1, (fSlow6 * (fRec26[2] + (fRec26[0] + (2 * fRec26[1]))))));
		...
		fRec9[0] = Ftube3(0, ((fSlow9 * fTemp2) + (fRec28[0] + (fSlow8 * fRec10[0]))));
		...
		fRec5[0] = Ftube3(1, (fRec29[0] + fRec6[0]));
		...
		fRec2[0] = Ftube3(1, (fRec30[0] + fRec3[0]));
