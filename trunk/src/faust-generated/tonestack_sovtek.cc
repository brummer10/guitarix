...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = ((2.8889960000000004e-05 * fSlow2) + (fSlow0 * ((4.943400000000001e-06 * fSlow2) - (1.2634599999999999e-07 + fSlow1))));
	double 	fSlow4 = (7.748796000000001e-07 + fSlow3);
	double 	fSlow5 = (1.2443156000000002e-11 * fSlow0);
	double 	fSlow6 = (1.2443156000000004e-09 * fSlow2);
	double 	fSlow7 = (5.345780000000001e-09 * fSlow2);
	double 	fSlow8 = (5.345780000000001e-11 + (fSlow7 + (fSlow0 * (fSlow6 - (fSlow5 + 4.101464400000001e-11)))));
	double 	fSlow9 = (fConst1 * fSlow8);
	double 	fSlow10 = (0.022470000000000004 * fSlow2);
	double 	fSlow11 = (0.00022 * fSlow0);
	double 	fSlow12 = (fConst1 * (0.0025277 + (fSlow11 + fSlow10)));
	...
	double 	fSlow16 = ((fConst2 * (7.748796000000001e-07 + (fSlow3 + fSlow14))) - (3 + fSlow12));
	double 	fSlow17 = (1.0 / (0 - (1 + (fSlow12 + (fConst2 * (7.748796000000001e-07 + (fSlow3 + fSlow9)))))));
	double 	fSlow18 = double(fslider2);
	double 	fSlow19 = ((fSlow0 * ((1.2443156000000002e-11 + fSlow6) - fSlow5)) + (fSlow18 * ((5.345780000000001e-11 + fSlow7) - (5.345780000000001e-11 * fSlow0))));
	double 	fSlow20 = (fConst1 * fSlow19);
	double 	fSlow21 = (((4.859800000000001e-07 * fSlow18) + (fSlow0 * (1.0113400000000001e-07 - fSlow1))) + (fSlow2 * (6.141960000000001e-06 + (4.943400000000001e-06 * fSlow0))));
	double 	fSlow22 = (fSlow21 + 6.141960000000001e-08);
	double 	fSlow23 = ((fSlow10 + (fSlow11 + (0.00023500000000000002 * fSlow18))) + 0.00022470000000000001);
	...
	double 	fSlow29 = (fSlow28 + (fConst2 * (6.141960000000001e-08 + (fSlow21 + fSlow26))));
	double 	fSlow30 = (fSlow28 - (fConst2 * (6.141960000000001e-08 + (fSlow21 + fSlow20))));
