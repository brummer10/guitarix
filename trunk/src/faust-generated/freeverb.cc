...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		output0[i0] = FAUSTFLOAT(fRec1 + fSlow1 * fTemp0);
		fRec9[1] = fRec9[0];
		IOTA0 = IOTA0 + 1;
		fRec8[1] = fRec8[0];
		fRec11[1] = fRec11[0];
...
{
	reg.registerFloatVar("freeverb.RoomSize",N_("Room Size"),"S","",&fVslider2, 0.5, 0.0, 1.0, 0.025, 0);
	reg.registerFloatVar("freeverb.damp",N_("HF Damp"),"S","",&fVslider1, 0.5, 0.0, 1.0, 0.025, 0);
	reg.registerFloatVar("freeverb.wet_dry",N_("Wet/Dry"),"S","",&fVslider0, 5e+01, 0.0, 1e+02, 1.0, 0);
	return 0;
}
