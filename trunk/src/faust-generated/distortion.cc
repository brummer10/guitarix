// generated from file '../src/faust/distortion.dsp' by dsp2cc:
...
static FAUSTFLOAT 	fentry3;
static FAUSTFLOAT 	fentry4;
...
static double 	fVec8[3];
static double 	fRec0[3];
static double 	fVec9[2];
static double 	fRec30[2];
static double 	fVec10[2];
