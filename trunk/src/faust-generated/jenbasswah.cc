...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst4 = 1.0 - fConst3;
	fConst5 = 1.0 - fConst2;
	double fConst6 = 7.02628418882998e-20 * fConst0;
	fConst7 = mydsp_faustpower2_f(fConst0);
	fConst8 = fConst7 * (fConst0 * (-8.45822966675918e-18 - fConst6) + -1.78928790753088e-14);
	double fConst9 = 3.87350386089898e-19 * fConst0;
	fConst10 = fConst0 * (fConst0 * (fConst0 * (fConst9 + 2.30787830877444e-17) + 1.57249804702232e-14) + 4.06656342620655e-13);
	double fConst11 = 1.19054639174528e-20 * fConst0;
	fConst12 = fConst0 * (fConst0 * (fConst0 * (fConst11 + 6.24901706816551e-18) + 8.55689125277824e-14) + 1.62180722455991e-12);
	double fConst13 = 4.28115775363339e-21 * fConst0;
	fConst14 = fConst7 * (fConst0 * (fConst13 + -1.30268272702044e-17) + 1.36038216822257e-14);
	double fConst15 = 4.26765051664369e-21 * fConst0;
	fConst16 = fConst0 * (fConst0 * (fConst0 * (1.30609446727126e-17 - fConst15) + -1.3782974775989e-14) + 2.52409371323892e-13);
	double fConst17 = 7.47901710601256e-21 * fConst0;
	fConst18 = fConst0 * (fConst0 * (fConst0 * (3.70620297844195e-17 - fConst17) + -5.22012186323421e-14) + 3.09177765505129e-15);
	fConst19 = fConst7 * (fConst0 * (8.45822966675918e-18 - fConst6) + -1.78928790753088e-14);
	fConst20 = fConst0 * (fConst0 * (fConst0 * (fConst9 + -2.30787830877444e-17) + 1.57249804702232e-14) + -4.06656342620655e-13);
	fConst21 = fConst0 * (fConst0 * (fConst0 * (fConst11 + -6.24901706816551e-18) + 8.55689125277824e-14) + -1.62180722455991e-12);
	double fConst22 = 2.81051367553199e-19 * fConst0;
	double fConst23 = mydsp_faustpower3_f(fConst0);
	fConst24 = fConst23 * (fConst22 + -1.69164593335184e-17);
	double fConst25 = 1.54940154435959e-18 * fConst0;
	fConst26 = fConst0 * (fConst7 * (4.61575661754889e-17 - fConst25) + -8.1331268524131e-13);
	double fConst27 = 4.76218556698113e-20 * fConst0;
	...
	fConst32 = fConst23 * (fConst22 + 1.69164593335184e-17);
	...
	double fConst35 = 718.2824771643642 / fConst0;
	double fConst36 = fConst35 + 1.0;
	fConst37 = 0.01 / fConst36;
	fConst38 = 1.0 - fConst35;
	fConst39 = 1.0 / fConst36;
	double fConst40 = 1.71246310145335e-20 * fConst0;
	fConst41 = fConst23 * (2.60536545404087e-17 - fConst40);
	double fConst42 = 1.70706020665747e-20 * fConst0;
	fConst43 = fConst0 * (fConst7 * (fConst42 + -2.61218893454252e-17) + 5.04818742647784e-13);
	double fConst44 = 2.99160684240502e-20 * fConst0;
	fConst45 = fConst0 * (fConst7 * (fConst44 + -7.4124059568839e-17) + 6.18355531010259e-15);
	fConst46 = 2.56869465218003e-20 * fConst7 + -2.72076433644514e-14;
	fConst47 = 2.75659495519781e-14 - 2.56059030998621e-20 * fConst7;
	fConst48 = 1.04402437264684e-13 - 4.48741026360754e-20 * fConst7;
	fConst49 = fConst23 * (-2.60536545404087e-17 - fConst40);
	fConst50 = fConst0 * (fConst7 * (fConst42 + 2.61218893454252e-17) + -5.04818742647784e-13);
	fConst51 = fConst0 * (fConst7 * (fConst44 + 7.4124059568839e-17) + -6.18355531010259e-15);
	fConst52 = fConst7 * (fConst0 * (fConst13 + 1.30268272702044e-17) + 1.36038216822257e-14);
	fConst53 = fConst0 * (fConst0 * (fConst0 * (-1.30609446727126e-17 - fConst15) + -1.3782974775989e-14) + -2.52409371323892e-13);
	fConst54 = fConst0 * (fConst0 * (fConst0 * (-3.70620297844195e-17 - fConst17) + -5.22012186323421e-14) + -3.09177765505129e-15);
	clear_state_f();
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = fRec8[0] - (fRec7[1] * (fConst34 + fTemp2 * (fConst33 + fConst32 * fTemp2) + 3.69687584200595e-13) + fRec7[2] * (fConst7 * (fConst31 + fTemp2 * (fConst30 + fConst29 * fTemp2)) + 5.54531376300893e-13) + fRec7[3] * (fConst28 + fTemp2 * (fConst26 + fConst24 * fTemp2) + 3.69687584200595e-13) + fRec7[4] * (fConst21 + fTemp2 * (fConst20 + fConst19 * fTemp2) + 9.24218960501488e-14)) / fTemp3;
