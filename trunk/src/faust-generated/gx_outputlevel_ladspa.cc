...
{
	double fSlow0 = 0.0010000000000000009 * std::pow(1e+01, 0.05 * (double(fVslider1) + double(fVslider0)));
...
{
	reg.registerFloatVar("amp.out_master",N_("Level"),"S","",&fVslider0, 0.0, -5e+01, 4.0, 0.1, 0);
	reg.registerFloatVar("amp.out_master_ladspa",N_("Ladspa Level"),"S","",&fVslider1, 0.0, -2e+01, 2e+01, 0.1, 0);
	return 0;
}
