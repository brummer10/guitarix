...
{
	registerVar("low_high_pass.low_highcutoff.on_off","low highcutoff","B","",&fcheckbox1, 0.0, 0.0, 1.0, 1.0);
	registerVar("low_high_pass.low_highpass.on_off","low highpass","B","",&fcheckbox0, 0.0, 0.0, 1.0, 1.0);
	registerVar("low_high_pass.low_highpass.low_freq","low freq","S","",&fentry1, 5e+03, 2e+01, 1.2e+04, 1e+01);
	registerVar("low_high_pass.low_highpass.high_freq","high freq","S","",&fentry0, 1.3e+02, 2e+01, 7.04e+03, 1e+01);
	registerVar("low_high_pass.low_highcutoff.low_freq","low freq","S","low-freq cutoff Hz",&fslider1, 1.3e+02, 2e+01, 1e+03, 1e+01);
	registerVar("low_high_pass.low_highcutoff.high_freq","high freq","S","high-freq cutoff Hz",&fslider0, 5e+03, 1e+03, 1.2e+04, 1e+01);
