...
#define fVslider2 (*fVslider2_)
	...
	double fSlow5 = (((fSlow0 * (((1.1779375000000001e-05 * fSlow1) + -4.1994500000000009e-06) - fSlow4)) + (0.00011998125000000002 * fSlow1)) + 5.718000000000001e-06);
	double fSlow6 = ((1.0281250000000001e-09 * fSlow1) - (4.1125e-11 * fSlow0));
	double fSlow7 = (7.3437500000000008e-09 * fSlow1);
	double fSlow8 = (((fSlow0 * (fSlow6 + -2.5262499999999999e-10)) + fSlow7) + 2.9374999999999999e-10);
	...
	double fSlow13 = (((9.187500000000001e-07 * fSlow11) + ((fSlow0 * (5.0055000000000002e-07 - fSlow4)) + (fSlow1 * ((1.1779375000000001e-05 * fSlow0) + 2.4812500000000002e-06)))) + 9.9250000000000005e-08);
	double fSlow14 = ((fSlow0 * (fSlow6 + 4.1125e-11)) + (fSlow11 * (fSlow7 - (2.9374999999999999e-10 * (fSlow0 + -1.0)))));
