// generated from file '../src/faust/multifilter.dsp' by dsp2cc:
...
{
	registerVar("MultiBandFilter.f250","","S","gain (dB) at 250 Hz",&fslider13, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q250","","S","",&fslider12, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f500","","S","gain (dB) at 500 Hz",&fslider11, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q500","","S","",&fslider10, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f62_5","","S","gain (dB) at 62.5 Hz",&fslider17, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q62_5","","S","",&fslider16, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f125","","S","gain (dB) at 125 Hz",&fslider15, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q125","","S","",&fslider14, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f31_25","","S","gain (dB) at 31.25 Hz",&fslider19, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q31_25","","S","",&fslider18, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f2k","","S","gain (dB) at 2 kHz",&fslider7, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q2k","","S","",&fslider6, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f4k","","S","gain (dB) at 4 kHz",&fslider5, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q4k","","S","",&fslider4, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f8k","","S","gain (dB) at 8 kHz",&fslider3, 0.0, -5e+01, 1e+01, 0.1);
	registerVar("MultiBandFilter.Q8k","","S","",&fslider2, 5e+01, 1.0, 1e+02, 1.0);
	registerVar("MultiBandFilter.f16k","","S","gain (dB) at 16 kHz",&fslider1, 0.0, -5e+01, 1e+01, 0.1);
