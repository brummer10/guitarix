...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	double fConst1 = 1.8695728816241201e-19 * fConst0;
	double fConst2 = fConst0 * (fConst0 * (fConst0 * (fConst1 + 6.8201040728630095e-17) + 4.5345401396126398e-15) + 6.5110413991823704e-14) + 4.7364264039631899e-17;
	fConst3 = fConst0 / fConst2;
	double fConst4 = 6.57377333665727e-19 * fConst0;
	...
	double fConst8 = 7.4782915264964696e-19 * fConst0;
	...
	double fConst13 = 2.6295093346629099e-18 * fConst0;
...
#define fVslider1 (*fVslider1_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fThen0 = double(orangedarkterrorp3clip(double(fTemp0)));
		double fElse0 = double(orangedarkterrorp3_negclip(double(fTemp0)));
		buf[i0] = FAUSTFLOAT(0.59999999999999998 * fRec0[0] * ((int(signbit(double(fTemp0)))) ? fElse0 : fThen0));
		fRec0[1] = fRec0[0];
		fRec2[1] = fRec2[0];
