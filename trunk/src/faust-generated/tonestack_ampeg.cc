...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (((fSlow1 * (((1.2358500000000002e-05 * fSlow0) - 1.361249999999999e-08) - fSlow2)) + (1.8734760000000003e-05 * fSlow0)) + 6.338090000000001e-07);
	double 	fSlow4 = (1.8198400000000004e-09 * fSlow0);
	double 	fSlow5 = ((1.6037340000000005e-09 * fSlow0) - (4.0093350000000015e-11 * fSlow1));
	double 	fSlow6 = (4.5496000000000015e-11 + ((fSlow1 * (fSlow5 - 5.40265e-12)) + fSlow4));
	...
	double 	fSlow17 = ((((1.6544000000000003e-07 * fSlow16) + (fSlow1 * (3.735875000000001e-07 - fSlow2))) + (fSlow0 * (3.24676e-06 + (1.2358500000000002e-05 * fSlow1)))) + 8.1169e-08);
	double 	fSlow18 = ((fSlow1 * (4.0093350000000015e-11 + fSlow5)) + (fSlow16 * (fSlow4 + (4.5496000000000015e-11 - (4.5496000000000015e-11 * fSlow1)))));
	double 	fSlow19 = (fConst0 * fSlow18);
	double 	fSlow20 = ((fSlow8 + (fSlow9 + (0.00011750000000000001 * fSlow16))) + 0.0005617500000000001);
