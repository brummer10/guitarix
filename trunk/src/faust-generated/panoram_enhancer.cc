...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst1 = std::tan(11309.733552923255 / fConst0);
	...
	double fConst6 = std::tan(5654.8667764616275 / fConst0);
	...
	double fConst20 = mydsp_faustpower2_f(fConst1);
	...
	double fConst25 = std::tan(20106.192982974677 / fConst0);
	...
	double fConst33 = mydsp_faustpower2_f(fConst25);
	...
	double fConst38 = std::tan(62831.853071795864 / fConst0);
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec5[0] = (fVec0[(IOTA0 - iTemp3) & 131071] * fTemp5 + fTemp6 * fVec0[(IOTA0 - iTemp7) & 131071]) - fConst12 * (fConst14 * fRec5[2] + fConst15 * fRec5[1]);
		...
		fRec12[0] = (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp9))) & 131071] * (fTemp10 + 1.0 - fTemp8) + (fTemp8 - fTemp10) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp9 + 1))) & 131071]) - fConst5 * (fConst19 * fRec12[2] + fConst22 * fRec12[1]);
		...
		fRec18[0] = (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp12))) & 131071] * (fTemp13 + 1.0 - fTemp11) + (fTemp11 - fTemp13) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp12 + 1))) & 131071]) - fConst29 * (fConst32 * fRec18[2] + fConst35 * fRec18[1]);
		...
		double fTemp14 = double(input1[i0]);
		fVec1[IOTA0 & 131071] = fTemp14;
		...
		output0[i0] = FAUSTFLOAT(fSlow1 * (fRec0[2] + fRec0[0] + 2.0 * fRec0[1]) + fSlow4 * (fRec7[2] + fRec7[0] + 2.0 * fRec7[1]) + fSlow6 * (fRec13[2] + fRec13[0] + 2.0 * fRec13[1]) + fTemp15);
		double fTemp16 = fConst54 * fRec6[0];
		int iTemp17 = int(fTemp16);
		double fTemp18 = std::floor(fTemp16);
		fRec26[0] = (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp17))) & 131071] * (fTemp18 + 1.0 - fTemp16) + (fTemp16 - fTemp18) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp17 + 1))) & 131071]) - fSlow21 * (fSlow22 * fRec26[2] + fSlow23 * fRec26[1]);
		...
		fRec32[0] = (fVec1[(IOTA0 - iTemp3) & 131071] * fTemp5 + fTemp6 * fVec1[(IOTA0 - iTemp7) & 131071]) - fSlow40 * (fSlow41 * fRec32[2] + fSlow42 * fRec32[1]);
		...
		fRec38[0] = (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp20))) & 131071] * (fTemp21 + 1.0 - fTemp19) + (fTemp19 - fTemp21) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp20 + 1))) & 131071]) - fSlow53 * (fSlow54 * fRec38[2] + fSlow55 * fRec38[1]);
		...
		output1[i0] = FAUSTFLOAT(fSlow11 * (fRec21[2] + fRec21[0] + 2.0 * fRec21[1]) + fSlow32 * (fRec27[2] + fRec27[0] + 2.0 * fRec27[1]) + fTemp15 + fSlow46 * (fRec33[2] + fRec33[0] + 2.0 * fRec33[1]));
		IOTA0 = IOTA0 + 1;
		fRec6[1] = fRec6[0];
		fRec5[2] = fRec5[1];
		fRec5[1] = fRec5[0];
