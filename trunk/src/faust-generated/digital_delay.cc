...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		float fTemp21 = fVec2[(IOTA0 - int(std::min<float>(524288.0f, std::max<float>(0.0f, fRec30[0])))) & 1048575];
		float fTemp22 = fTemp21 + fRec29[0] * (fVec2[(IOTA0 - int(std::min<float>(524288.0f, std::max<float>(0.0f, fRec31[0])))) & 1048575] - fTemp21);
		fRec0[0] = ((iSlow1) ? fTemp22 : fSlow28 * fTemp22);
