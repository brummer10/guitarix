...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp0 = (1 + (fSlow4 * (fRec0[0] - 1)));
...
{
	reg.registerVar("ringModulatorSt.dry/wet",N_("Mix"),"S","",&fslider1, 0.5, 0.0, 1.0, 0.05);
	reg.registerVar("ringModulatorSt.freq",N_("Freq"),"S","",&fslider0, 2.4e+02, 1.2e+02, 1.6e+03, 0.5);
	return 0;
}
