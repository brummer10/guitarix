...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow23 = (fConst0 * (0 - fSlow20));
	double 	fSlow24 = (fSlow23 + (fConst1 * (fSlow19 + fSlow18)));
	double 	fSlow25 = (fConst0 * fSlow17);
	double 	fSlow26 = (fSlow21 + (fConst1 * (fSlow25 - fSlow19)));
	double 	fSlow27 = (fSlow23 - (fConst1 * (fSlow19 + fSlow25)));
	for (int i=0; i<count; i++) {
		fRec0[0] = ((double)input0[i] - (fSlow15 * (((fSlow14 * fRec0[2]) + (fSlow13 * fRec0[1])) + (fSlow11 * fRec0[3]))));
		output0[i] = (FAUSTFLOAT)(fSlow15 * ((fSlow27 * fRec0[0]) + ((fSlow26 * fRec0[3]) + ((fSlow24 * fRec0[1]) + (fSlow22 * fRec0[2])))));
		// post processing
