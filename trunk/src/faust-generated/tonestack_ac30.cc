...
#define fVslider2 (*fVslider2_)
	...
	double fSlow5 = (((fSlow0 * (((4.8510000000000015e-06 * fSlow1) + -4.2449000000000006e-07) - fSlow4)) + (4.9720000000000012e-05 * fSlow1)) + 7.172000000000001e-07);
	double fSlow6 = ((2.6620000000000007e-10 * fSlow1) - (2.6620000000000002e-12 * fSlow0));
	double fSlow7 = (2.4200000000000003e-09 * fSlow1);
	double fSlow8 = (((fSlow0 * (fSlow6 + -2.1538000000000003e-11)) + fSlow7) + 2.4200000000000004e-11);
	...
	double fSlow13 = (((2.2000000000000004e-07 * fSlow11) + ((fSlow0 * (5.9510000000000008e-08 - fSlow4)) + (fSlow1 * ((4.8510000000000015e-06 * fSlow0) + 1.3200000000000001e-06)))) + 1.3200000000000001e-08);
	double fSlow14 = ((fSlow0 * (fSlow6 + 2.6620000000000002e-12)) + (fSlow11 * (fSlow7 - (2.4200000000000004e-11 * (fSlow0 + -1.0)))));
