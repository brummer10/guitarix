...
{
	reg.registerVar("stereoverb.LFO freq",N_("LFO Freq"),"S","",&fslider0, 0.2, 0.0, 5.0, 0.01);
	reg.registerVar("stereoverb.RoomSize",N_("Room Size"),"S","",&fslider3, 0.5, 0.0, 1.0, 0.025);
	reg.registerVar("stereoverb.damp",N_("Damp"),"S","",&fslider2, 0.5, 0.0, 1.0, 0.025);
	...
	reg.registerVar("stereoverb.wet_dry",N_("Dry/Wet"),"S","",&fslider1, 5e+01, 0.0, 1e+02, 1.0);
	return 0;
}
