...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fVec1[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec9[0];
		fRec8[0] = fVec1[(IOTA0 - 1139) & 2047];
		fRec11[0] = fSlow4 * fRec11[1] + fSlow5 * fRec10[1];
		fVec2[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec11[0];
		fRec10[0] = fVec2[(IOTA0 - 1211) & 2047];
		fRec13[0] = fSlow4 * fRec13[1] + fSlow5 * fRec12[1];
		fVec3[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec13[0];
		fRec12[0] = fVec3[(IOTA0 - 1300) & 2047];
		fRec15[0] = fSlow4 * fRec15[1] + fSlow5 * fRec14[1];
		fVec4[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec15[0];
		fRec14[0] = fVec4[(IOTA0 - 1379) & 2047];
		fRec17[0] = fSlow4 * fRec17[1] + fSlow5 * fRec16[1];
		fVec5[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec17[0];
		fRec16[0] = fVec5[(IOTA0 - 1445) & 2047];
		fRec19[0] = fSlow4 * fRec19[1] + fSlow5 * fRec18[1];
		fVec6[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec19[0];
		fRec18[0] = fVec6[(IOTA0 - 1514) & 2047];
		fRec21[0] = fSlow4 * fRec21[1] + fSlow5 * fRec20[1];
		fVec7[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec21[0];
		fRec20[0] = fVec7[(IOTA0 - 1580) & 2047];
		fRec23[0] = fSlow4 * fRec23[1] + fSlow5 * fRec22[1];
		fVec8[IOTA0 & 2047] = fTemp1 + fSlow3 * fRec23[0];
		fRec22[0] = fVec8[(IOTA0 - 1640) & 2047];
		double fTemp2 = fRec8[0] + fRec10[0] + fRec12[0] + fRec14[0] + fRec16[0] + fRec18[0] + fRec20[0] + fRec22[0];
		fVec9[IOTA0 & 1023] = fTemp2 + 0.5 * fRec6[1];
		fRec6[0] = fVec9[(IOTA0 - 579) & 1023];
		double fRec7 = fRec6[1] - fTemp2;
		fVec10[IOTA0 & 511] = fRec7 + 0.5 * fRec4[1];
		fRec4[0] = fVec10[(IOTA0 - 464) & 511];
		double fRec5 = fRec4[1] - fRec7;
		fVec11[IOTA0 & 511] = fRec5 + 0.5 * fRec2[1];
		fRec2[0] = fVec11[(IOTA0 - 364) & 511];
		double fRec3 = fRec2[1] - fRec5;
		fVec12[IOTA0 & 255] = fRec3 + 0.5 * fRec0[1];
		fRec0[0] = fVec12[(IOTA0 - 248) & 255];
		...
		output0[i0] = FAUSTFLOAT(fSlow1 * fTemp0 + (fRec1 + fSlow6 * fTemp0) * (1.0 - fSlow7 * fRec24[0]));
		double fTemp3 = double(input1[i0]);
		double fTemp4 = fSlow2 * fTemp3;
		fRec35[0] = fSlow4 * fRec35[1] + fSlow5 * fRec34[1];
		fVec13[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec35[0];
		fRec34[0] = fVec13[(IOTA0 - 1139) & 2047];
		fRec37[0] = fSlow4 * fRec37[1] + fSlow5 * fRec36[1];
		fVec14[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec37[0];
		fRec36[0] = fVec14[(IOTA0 - 1211) & 2047];
		fRec39[0] = fSlow4 * fRec39[1] + fSlow5 * fRec38[1];
		fVec15[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec39[0];
		fRec38[0] = fVec15[(IOTA0 - 1300) & 2047];
		fRec41[0] = fSlow4 * fRec41[1] + fSlow5 * fRec40[1];
		fVec16[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec41[0];
		fRec40[0] = fVec16[(IOTA0 - 1379) & 2047];
		fRec43[0] = fSlow4 * fRec43[1] + fSlow5 * fRec42[1];
		fVec17[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec43[0];
		fRec42[0] = fVec17[(IOTA0 - 1445) & 2047];
		fRec45[0] = fSlow4 * fRec45[1] + fSlow5 * fRec44[1];
		fVec18[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec45[0];
		fRec44[0] = fVec18[(IOTA0 - 1514) & 2047];
		fRec47[0] = fSlow4 * fRec47[1] + fSlow5 * fRec46[1];
		fVec19[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec47[0];
		fRec46[0] = fVec19[(IOTA0 - 1580) & 2047];
		fRec49[0] = fSlow4 * fRec49[1] + fSlow5 * fRec48[1];
		fVec20[IOTA0 & 2047] = fTemp4 + fSlow3 * fRec49[0];
		fRec48[0] = fVec20[(IOTA0 - 1640) & 2047];
		...
		output1[i0] = FAUSTFLOAT(fSlow1 * fTemp3 + (fRec27 + fSlow6 * fTemp3) * (1.0 - fSlow7 * (0.0 - fRec24[0])));
		iVec0[1] = iVec0[0];
		fRec9[1] = fRec9[0];
		IOTA0 = IOTA0 + 1;
		fRec8[1] = fRec8[0];
