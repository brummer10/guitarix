...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec0[0] = ((fConst8 * (((fConst4 * fRec1[0]) + (fConst16 * fRec1[1])) + (fConst4 * fRec1[2]))) - (fConst6 * ((fConst5 * fRec0[1]) + (fConst3 * fRec0[2]))));
		...
		fRec8[0] = ((fConst8 * (fRec9[2] + (fRec9[0] + (2 * fRec9[1])))) - (fConst6 * ((fConst3 * fRec8[2]) + (fConst5 * fRec8[1]))));
		...
		output0[i] = (FAUSTFLOAT)(fTemp0 + (0.1778279410038923 * ((fRec18[0] * fRec17[0]) * ((fConst22 * ((((fConst18 * fRec14[0]) + (fConst29 * fRec14[1])) + (fConst18 * fRec14[2])) + (fSlow7 * (fRec11[2] + (fRec11[0] + (2 * fRec11[1])))))) + (fConst6 * ((fRec8[2] + (fRec8[0] + (2 * fRec8[1]))) + (fSlow6 * (((fConst4 * fRec0[0]) + (fConst16 * fRec0[1])) + (fConst4 * fRec0[2])))))))));
		...
		fRec21[0] = ((fConst8 * (((fConst4 * fRec22[0]) + (fConst16 * fRec22[1])) + (fConst4 * fRec22[2]))) - (fConst6 * ((fConst3 * fRec21[2]) + (fConst5 * fRec21[1]))));
		...
		fRec24[0] = ((fConst8 * (fRec25[2] + (fRec25[0] + (2 * fRec25[1])))) - (fConst6 * ((fConst3 * fRec24[2]) + (fConst5 * fRec24[1]))));
		...
		output1[i] = (FAUSTFLOAT)(fTemp9 + (0.1778279410038923 * ((fRec17[0] * fRec33[0]) * ((fConst22 * ((((fConst18 * fRec30[0]) + (fConst29 * fRec30[1])) + (fConst18 * fRec30[2])) + (fSlow7 * (fRec27[2] + (fRec27[0] + (2 * fRec27[1])))))) + (fConst6 * ((fRec24[2] + (fRec24[0] + (2 * fRec24[1]))) + (fSlow6 * (((fConst4 * fRec21[0]) + (fConst16 * fRec21[1])) + (fConst4 * fRec21[2])))))))));
		// post processing
		fRec33[1] = fRec33[0];
		fRec34[1] = fRec34[0];
		fRec35[1] = fRec35[0];
...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerVar("duckDelaySt.attack","","S","",&fslider6, 0.1, 0.05, 0.5, 0.05);
	...
	reg.registerVar("duckDelaySt.release","","S","",&fslider5, 0.1, 0.05, 2.0, 0.05);
