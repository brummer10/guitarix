...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp9 = (fSlow2 * fRec14[1]);
		fRec16[0] = ((fSlow33 * ((fSlow47 * fVec3[1]) + (fSlow46 * fTemp3))) + (fSlow17 * fRec16[1]));
		fRec15[0] = (fRec16[0] - (fSlow15 * ((fSlow13 * fRec15[2]) + (fSlow11 * fRec15[1]))));
		fRec14[0] = ((fSlow15 * (((fSlow10 * fRec15[0]) + (fSlow48 * fRec15[1])) + (fSlow10 * fRec15[2]))) - (fSlow45 * ((fSlow44 * fRec14[2]) + fTemp9)));
		double fTemp10 = max(-1, min(1, (fSlow40 + (fSlow49 * (fRec14[2] + (fSlow45 * (fTemp9 + (fSlow44 * fRec14[0]))))))));
		fRec17[0] = (fSlow50 + (0.999 * fRec17[1]));
		double fTemp11 = (fSlow2 * fRec18[1]);
		double fTemp12 = (fSlow11 * fRec19[1]);
		fRec21[0] = ((fSlow32 * ((fSlow53 * fRec7[1]) + (fSlow21 * fRec7[0]))) + (fSlow26 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fSlow24 * ((fSlow22 * fRec20[2]) + (fSlow20 * fRec20[1]))));
		fRec19[0] = ((fSlow24 * (((fSlow19 * fRec20[0]) + (fSlow54 * fRec20[1])) + (fSlow19 * fRec20[2]))) - (fSlow52 * ((fSlow51 * fRec19[2]) + fTemp12)));
		fRec18[0] = ((fRec19[2] + (fSlow52 * (fTemp12 + (fSlow51 * fRec19[0])))) - (fSlow45 * ((fSlow44 * fRec18[2]) + fTemp11)));
		double fTemp13 = max(-1, min(1, (fSlow40 + (fSlow55 * (fRec18[2] + (fSlow45 * (fTemp11 + (fSlow44 * fRec18[0]))))))));
		fRec22[0] = (fSlow56 + (0.999 * fRec22[1]));
		fRec23[0] = (fSlow57 + (0.999 * fRec23[1]));
		double fTemp14 = (fRec23[0] * (((fRec22[0] * fTemp13) * (1 - (0.3333333333333333 * faustpower<2>(fTemp13)))) + (((fRec17[0] * fTemp10) * (1 - (0.3333333333333333 * faustpower<2>(fTemp10)))) + (((fRec13[0] * fTemp8) * (1 - (0.3333333333333333 * faustpower<2>(fTemp8)))) + ((fRec10[0] * fTemp7) * (1 - (0.3333333333333333 * faustpower<2>(fTemp7))))))));
		fVec5[0] = fTemp14;
