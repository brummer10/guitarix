...
#define fVslider2 (*fVslider2_)
	...
	double fSlow1 = 3.108600000000001e-05 * fSlow0;
	double fSlow2 = double(fVslider1);
	double fSlow3 = 3.0937500000000006e-07 * fSlow2;
	double fSlow4 = 1.2375000000000003e-05 * fSlow0;
	double fSlow5 = fConst1 * (fSlow2 * (fSlow4 + -2.99475e-07 - fSlow3) + fSlow1 + 1.08515e-06);
	double fSlow6 = 3.3880000000000003e-09 * fSlow0;
	double fSlow7 = 4.628250000000001e-11 * fSlow2;
	double fSlow8 = 1.8513000000000002e-09 * fSlow0;
	double fSlow9 = fConst2 * (fSlow2 * (fSlow8 - fSlow7 + -3.8417500000000006e-11) + fSlow6 + 8.470000000000002e-11);
	double fSlow10 = 0.022500000000000003 * fSlow0;
	double fSlow11 = 0.00055 * fSlow2;
	double fSlow12 = fConst0 * (fSlow11 + fSlow10 + 0.0031515000000000002);
	...
	double fSlow20 = fSlow19 * (fSlow6 + 8.470000000000002e-11 * fSlow18) + fSlow2 * (fSlow8 + 4.628250000000001e-11 * fSlow18);
	double fSlow21 = fConst2 * fSlow20;
	double fSlow22 = fConst1 * (3.08e-07 * fSlow19 + fSlow2 * (3.781250000000001e-07 - fSlow3) + fSlow0 * (1.2375000000000003e-05 * fSlow2 + 3.982e-06) + 9.955000000000001e-08);
	...
	double fSlow30 = 1.0 / (-1.0 - (fSlow12 + fConst1 * (fSlow1 + fSlow2 * (fSlow4 + (-2.99475e-07 - fSlow3)) + 1.08515e-06) + fConst2 * (fSlow6 + fSlow2 * (fSlow8 + (-3.8417500000000006e-11 - fSlow7)) + 8.470000000000002e-11)));
