...
#define fVslider2 (*fVslider2_)
	...
	double fSlow5 = (((fSlow0 * (((1.0875480000000001e-05 * fSlow1) + -6.207784000000001e-08) - fSlow4)) + (1.8929240000000001e-05 * fSlow1)) + 5.6658008000000006e-07);
	double fSlow6 = ((1.2661536800000005e-09 * fSlow1) - (2.7855380960000008e-11 * fSlow0));
	double fSlow7 = (1.6515048000000004e-09 * fSlow1);
	double fSlow8 = (((fSlow0 * (fSlow6 + -8.4777246400000062e-12)) + fSlow7) + 3.6333105600000014e-11);
	...
	double fSlow13 = (((1.5013680000000003e-07 * fSlow11) + ((fSlow0 * (2.8930616000000009e-07 - fSlow4)) + (fSlow1 * ((1.0875480000000001e-05 * fSlow0) + 2.9572400000000001e-06)))) + 6.505928000000001e-08);
	double fSlow14 = ((fSlow0 * (fSlow6 + 2.7855380960000008e-11)) + (fSlow11 * (fSlow7 - (3.6333105600000014e-11 * (fSlow0 + -1.0)))));
