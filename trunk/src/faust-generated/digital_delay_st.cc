...
void always_inline Dsp::compute(int count, float *input0, float *input1, float *output0, float *output1)
{
	...
	float 	fSlow2 = tanf((fConst1 * fslider1));
	...
	float 	fSlow8 = tanf((fConst1 * fslider2));
	...
	float 	fSlow14 = (0.01f * fslider3);
	float 	fSlow15 = (2 * (0 - fSlow9));
	float 	fSlow16 = (fConst50 / fSlow6);
	...
	float 	fSlow21 = min(524288.0f, B2N(fslider5, (float(iConst77) / fslider6)));
	float 	fSlow22 = (0.01f * fslider7);
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = ((fConst56 * ((fConst55 * fVec0[1]) + (fSlow16 * fTemp1))) + (fConst54 * fRec11[1]));
		...
		float fTemp14 = ((iSlow19==0)? fTemp9 : ((iSlow19==1)?(fRec13 + fRec12[1]):fTemp9) );
		...
		float fTemp19 = ((fSlow0 * fTemp0) + ((iSlow20==0)? fTemp14 : ((iSlow20==1)?(fRec21 + fRec20[1]):fTemp14) ));
		fVec2[IOTA&524287] = fTemp19;
		float fTemp20 = ((int((fRec28[1] != 0.0f)))?((int(((fRec29[1] > 0.0f) & (fRec29[1] < 1.0f))))?fRec28[1]:0):((int(((fRec29[1] == 0.0f) & (fSlow21 != fRec30[1]))))?fConst75:((int(((fRec29[1] == 1.0f) & (fSlow21 != fRec31[1]))))?fConst76:0)));
		fRec28[0] = fTemp20;
		fRec29[0] = max(0.0f, min(1.0f, (fRec29[1] + fTemp20)));
		fRec30[0] = ((int(((fRec29[1] >= 1.0f) & (fRec31[1] != fSlow21))))?fSlow21:fRec30[1]);
		fRec31[0] = ((int(((fRec29[1] <= 0.0f) & (fRec30[1] != fSlow21))))?fSlow21:fRec31[1]);
		int iTemp21 = int((int(fRec30[0]) & 524287));
		float fTemp22 = (1.0f - fRec29[0]);
		int iTemp23 = int((int(fRec31[0]) & 524287));
		fRec0[0] = (fSlow22 * ((fRec29[0] * fVec2[(IOTA-iTemp23)&524287]) + (fTemp22 * fVec2[(IOTA-iTemp21)&524287])));
		output0[i] = (FAUSTFLOAT)(fRec0[0] + (fSlow1 * fTemp0));
		float fTemp24 = (float)input1[i];
		...
		float fTemp25 = (fRec33[2] + (fRec33[0] + (2 * fRec33[1])));
		float fTemp26 = (fSlow7 * fTemp25);
		fVec3[0] = fTemp26;
		float fTemp27 = (fConst11 * fRec37[1]);
		float fTemp28 = (fConst20 * fRec38[1]);
		float fTemp29 = (fConst27 * fRec39[1]);
		float fTemp30 = (fConst34 * fRec40[1]);
		float fTemp31 = (fConst41 * fRec41[1]);
		fRec43[0] = ((fConst56 * ((fConst55 * fVec3[1]) + (fSlow16 * fTemp25))) + (fConst54 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst52 * ((fConst51 * fRec42[2]) + (fConst49 * fRec42[1]))));
		fRec41[0] = ((fConst52 * (((fConst48 * fRec42[0]) + (fConst57 * fRec42[1])) + (fConst48 * fRec42[2]))) - (fConst46 * ((fConst45 * fRec41[2]) + fTemp31)));
		fRec40[0] = ((fConst46 * ((fTemp31 + (fConst60 * fRec41[0])) + (fConst59 * fRec41[2]))) - (fConst39 * ((fConst38 * fRec40[2]) + fTemp30)));
		fRec39[0] = ((fConst39 * ((fTemp30 + (fConst63 * fRec40[0])) + (fConst62 * fRec40[2]))) - (fConst32 * ((fConst31 * fRec39[2]) + fTemp29)));
		fRec38[0] = ((fConst32 * ((fTemp29 + (fConst66 * fRec39[0])) + (fConst65 * fRec39[2]))) - (fConst25 * ((fConst24 * fRec38[2]) + fTemp28)));
		fRec37[0] = ((fConst25 * ((fTemp28 + (fConst69 * fRec38[0])) + (fConst68 * fRec38[2]))) - (fConst18 * ((fConst16 * fRec37[2]) + fTemp27)));
		float fTemp32 = ((fTemp27 + (fConst72 * fRec37[0])) + (fConst71 * fRec37[2]));
		fVec4[0] = fTemp32;
		fRec36[0] = ((fConst73 * (fVec4[0] + fVec4[1])) + (fConst9 * fRec36[1]));
		fRec35[0] = (fRec36[0] - (fConst7 * ((fConst5 * fRec35[2]) + (fConst3 * fRec35[1]))));
		float fTemp33 = ((iSlow18==0)? fVec3[0] : ((iSlow18==1)?(fConst74 * (fRec35[2] + (fRec35[0] + (2 * fRec35[1])))):fVec3[0]) );
		float fTemp34 = (0.1f * fRec44[1]);
		float fTemp35 = (fTemp34 + (0.4f * fRec48[1]));
		float fTemp36 = (fTemp33 + (0.2f * fRec46[1]));
		float fTemp37 = ((fTemp36 + (0.6f * fRec50[1])) - fTemp35);
		fRec50[0] = fTemp37;
		float 	fRec51 = (0 - (0.6f * fTemp37));
		fRec48[0] = (fRec51 + fRec50[1]);
		float 	fRec49 = (0.4f * (fTemp36 - fTemp35));
		fRec46[0] = (fRec49 + fRec48[1]);
		float 	fRec47 = (0 - (0.2f * (fTemp36 - fTemp34)));
		fRec44[0] = (fRec47 + fRec46[1]);
		float 	fRec45 = (0.1f * (fTemp33 - fTemp34));
		float fTemp38 = ((iSlow19==0)? fTemp33 : ((iSlow19==1)?(fRec45 + fRec44[1]):fTemp33) );
		float fTemp39 = (0.5f * fRec52[1]);
		float fTemp40 = (fTemp39 + (0.4f * fRec54[1]));
		float fTemp41 = (fTemp38 + (0.3f * fRec56[1]));
		float fTemp42 = ((fTemp41 + (0.2f * fRec58[1])) - fTemp40);
		fRec58[0] = fTemp42;
		float 	fRec59 = (0 - (0.2f * fTemp42));
		fRec56[0] = (fRec59 + fRec58[1]);
		float 	fRec57 = (0 - (0.3f * (fTemp41 - fTemp40)));
		fRec54[0] = (fRec57 + fRec56[1]);
		float 	fRec55 = (0.4f * (fTemp38 - fTemp40));
		fRec52[0] = (fRec55 + fRec54[1]);
		float 	fRec53 = (0.5f * (fTemp38 - fTemp39));
		float fTemp43 = ((fSlow0 * fTemp24) + ((iSlow20==0)? fTemp38 : ((iSlow20==1)?(fRec53 + fRec52[1]):fTemp38) ));
		fVec5[IOTA&524287] = fTemp43;
		fRec32[0] = (fSlow22 * ((fRec29[0] * fVec5[(IOTA-iTemp23)&524287]) + (fTemp22 * fVec5[(IOTA-iTemp21)&524287])));
		output1[i] = (FAUSTFLOAT)(fRec32[0] + (fSlow1 * fTemp24));
		// post processing
		fRec32[1] = fRec32[0];
		fRec52[1] = fRec52[0];
		fRec54[1] = fRec54[0];
