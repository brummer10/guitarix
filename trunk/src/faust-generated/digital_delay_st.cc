...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst2 = std::tan((37699.1133f / fConst0));
	fConst3 = (1.0f / fConst2);
	fConst4 = (((fConst3 + 1.0f) / fConst2) + 1.0f);
	fConst5 = (0.800000012f / fConst4);
	fConst6 = (1.0f / (fConst3 + 1.0f));
	fConst7 = (1.0f - fConst3);
	fConst8 = (25132.7422f / fConst0);
	fConst9 = std::tan(fConst8);
	fConst10 = (1.0f / fConst9);
	fConst11 = (fConst0 * std::sin((50265.4844f / fConst0)));
	...
	fConst15 = (12566.3711f / fConst0);
	fConst16 = std::tan(fConst15);
	fConst17 = (1.0f / fConst16);
	fConst18 = (fConst0 * std::sin(fConst8));
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		float fTemp35 = (iSlow12 ? fTemp28 : (iSlow13 ? (fConst5 * (fRec35[2] + (fRec35[0] + (2.0f * fRec35[1])))) : fTemp28));
		...
		float fTemp41 = (iSlow9 ? fTemp35 : (iSlow10 ? (fRec45 + fRec44[1]) : fTemp35));
		...
		float fTemp46 = ((iSlow2 ? fRec32[1] : (iSlow6 ? fTemp41 : (iSlow7 ? (fRec53 + fRec52[1]) : fTemp41))) + (fSlow30 * fTemp26));
		...
		fRec32[0] = (iSlow2 ? fTemp48 : (fSlow3 * fTemp48));
