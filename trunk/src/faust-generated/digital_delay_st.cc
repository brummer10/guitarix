...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i=0; i<count; i++) {
		...
		int iTemp21 = int((int(fRec30[0]) & 524287));
		float fTemp22 = (1.0f - fRec29[0]);
		int iTemp23 = int((int(fRec31[0]) & 524287));
		fRec0[0] = (fSlow21 * ((fRec29[0] * fVec2[(IOTA-iTemp23)&524287]) + (fTemp22 * fVec2[(IOTA-iTemp21)&524287])));
		output0[i] = (FAUSTFLOAT)(fTemp18 + fRec0[0]);
		fRec34[0] = ((fSlow12 * fRec32[1]) - (fSlow11 * ((fSlow10 * fRec34[2]) + (fSlow8 * fRec34[1]))));
		fRec33[0] = ((fSlow11 * (((fSlow7 * fRec34[0]) + (fSlow13 * fRec34[1])) + (fSlow7 * fRec34[2]))) - (fSlow5 * ((fSlow3 * fRec33[2]) + (fSlow1 * fRec33[1]))));
		float fTemp24 = (fRec33[2] + (fRec33[0] + (2 * fRec33[1])));
		float fTemp25 = (fSlow5 * fTemp24);
		fVec3[0] = fTemp25;
		float fTemp26 = (fConst11 * fRec37[1]);
		float fTemp27 = (fConst20 * fRec38[1]);
		float fTemp28 = (fConst27 * fRec39[1]);
		float fTemp29 = (fConst34 * fRec40[1]);
		float fTemp30 = (fConst41 * fRec41[1]);
		fRec43[0] = ((fConst56 * ((fConst55 * fVec3[1]) + (fSlow14 * fTemp24))) + (fConst54 * fRec43[1]));
		fRec42[0] = (fRec43[0] - (fConst52 * ((fConst51 * fRec42[2]) + (fConst49 * fRec42[1]))));
		fRec41[0] = ((fConst52 * (((fConst48 * fRec42[0]) + (fConst57 * fRec42[1])) + (fConst48 * fRec42[2]))) - (fConst46 * ((fConst45 * fRec41[2]) + fTemp30)));
		fRec40[0] = ((fConst46 * ((fTemp30 + (fConst60 * fRec41[0])) + (fConst59 * fRec41[2]))) - (fConst39 * ((fConst38 * fRec40[2]) + fTemp29)));
		fRec39[0] = ((fConst39 * ((fTemp29 + (fConst63 * fRec40[0])) + (fConst62 * fRec40[2]))) - (fConst32 * ((fConst31 * fRec39[2]) + fTemp28)));
		fRec38[0] = ((fConst32 * ((fTemp28 + (fConst66 * fRec39[0])) + (fConst65 * fRec39[2]))) - (fConst25 * ((fConst24 * fRec38[2]) + fTemp27)));
		fRec37[0] = ((fConst25 * ((fTemp27 + (fConst69 * fRec38[0])) + (fConst68 * fRec38[2]))) - (fConst18 * ((fConst16 * fRec37[2]) + fTemp26)));
		float fTemp31 = ((fTemp26 + (fConst72 * fRec37[0])) + (fConst71 * fRec37[2]));
		fVec4[0] = fTemp31;
		fRec36[0] = ((fConst73 * (fVec4[0] + fVec4[1])) + (fConst9 * fRec36[1]));
		fRec35[0] = (fRec36[0] - (fConst7 * ((fConst5 * fRec35[2]) + (fConst3 * fRec35[1]))));
		float fTemp32 = ((iSlow16==0)? fVec3[0] : ((iSlow16==1)?(fConst74 * (fRec35[2] + (fRec35[0] + (2 * fRec35[1])))):fVec3[0]) );
		float fTemp33 = (0.1f * fRec44[1]);
		float fTemp34 = (fTemp33 + (0.4f * fRec48[1]));
		float fTemp35 = (fTemp32 + (0.2f * fRec46[1]));
		float fTemp36 = ((fTemp35 + (0.6f * fRec50[1])) - fTemp34);
		fRec50[0] = fTemp36;
		float 	fRec51 = (0 - (0.6f * fTemp36));
		fRec48[0] = (fRec51 + fRec50[1]);
		float 	fRec49 = (0.4f * (fTemp35 - fTemp34));
		fRec46[0] = (fRec49 + fRec48[1]);
		float 	fRec47 = (0 - (0.2f * (fTemp35 - fTemp33)));
		fRec44[0] = (fRec47 + fRec46[1]);
		float 	fRec45 = (0.1f * (fTemp32 - fTemp33));
		float fTemp37 = ((iSlow17==0)? fTemp32 : ((iSlow17==1)?(fRec45 + fRec44[1]):fTemp32) );
		float fTemp38 = (0.5f * fRec52[1]);
		float fTemp39 = (fTemp38 + (0.4f * fRec54[1]));
		float fTemp40 = (fTemp37 + (0.3f * fRec56[1]));
		float fTemp41 = ((fTemp40 + (0.2f * fRec58[1])) - fTemp39);
		fRec58[0] = fTemp41;
		float 	fRec59 = (0 - (0.2f * fTemp41));
		fRec56[0] = (fRec59 + fRec58[1]);
		float 	fRec57 = (0 - (0.3f * (fTemp40 - fTemp39)));
		fRec54[0] = (fRec57 + fRec56[1]);
		float 	fRec55 = (0.4f * (fTemp37 - fTemp39));
		fRec52[0] = (fRec55 + fRec54[1]);
		float 	fRec53 = (0.5f * (fTemp37 - fTemp38));
		float fTemp42 = (float)input1[i];
		float fTemp43 = ((fSlow19 * fTemp42) + ((iSlow18==0)? fTemp37 : ((iSlow18==1)?(fRec53 + fRec52[1]):fTemp37) ));
		fVec5[IOTA&524287] = fTemp43;
		fRec32[0] = (fSlow21 * ((fRec29[0] * fVec5[(IOTA-iTemp23)&524287]) + (fTemp22 * fVec5[(IOTA-iTemp21)&524287])));
		output1[i] = (FAUSTFLOAT)(fTemp42 + fRec32[0]);
		// post processing
		fRec32[1] = fRec32[0];
		fRec52[1] = fRec52[0];
		fRec54[1] = fRec54[0];
...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerVar("didest.feedback","","S",N_("percentage of the feedback level in the delay loop"),&fslider2, 5e+01f, 1.0f, 1e+02f, 1.0f);
	reg.registerVar("didest.gain","","S",N_("overall gain of the delay line in percent"),&fslider4, 1e+02f, 0.0f, 1.2e+02f, 1.0f);
	reg.registerVar("didest.highpass",N_("highpass (hz)"),"S",N_("highpass filter frequency in the feddback loop"),&fslider1, 1.2e+02f, 2e+01f, 2e+04f, 1.0f);
	reg.registerVar("didest.howpass",N_("lowpass (hz)"),"S",N_("lowpass filter frequency in the feddback loop"),&fslider0, 1.2e+04f, 2e+01f, 2e+04f, 1.0f);
	...
	reg.registerEnumVar("didest.mode","","S","",fslider3_values,&fslider3, 0.0f, 0.0f, 3.0f, 1.0f);
