...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (((fSlow1 * (((2.3606220000000006e-05 * fSlow0) - 3.2220474e-07) - fSlow2)) + (3.7475640000000014e-05 * fSlow0)) + 1.4106061200000003e-06);
	double 	fSlow4 = (1.9775250000000004e-09 * fSlow0);
	double 	fSlow5 = ((1.5406083e-09 * fSlow0) - (5.08400739e-11 * fSlow1));
	double 	fSlow6 = (6.5258325e-11 + ((fSlow1 * (fSlow5 - 1.4418251099999996e-11)) + fSlow4));
	double 	fSlow7 = (fConst0 * fSlow6);
	double 	fSlow8 = (0.015220000000000001 * fSlow0);
	double 	fSlow9 = (0.001551 * fSlow1);
	...
	double 	fSlow17 = ((((1.7391e-07 * fSlow16) + (fSlow1 * (8.643102600000002e-07 - fSlow2))) + (fSlow0 * (1.5206400000000001e-06 + (2.3606220000000006e-05 * fSlow1)))) + 5.018112e-08);
	double 	fSlow18 = ((fSlow1 * (5.08400739e-11 + fSlow5)) + (fSlow16 * (fSlow4 + (6.5258325e-11 - (6.5258325e-11 * fSlow1)))));
	double 	fSlow19 = (fConst0 * fSlow18);
	double 	fSlow20 = ((fSlow8 + (fSlow9 + (5.4999999999999995e-05 * fSlow16))) + 0.0005022600000000001);
