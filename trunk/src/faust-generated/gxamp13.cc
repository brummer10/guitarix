...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6DJ8_68k, (((fTemp12 * ((fTemp26 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp26 * fTemp12))))) - 0.024937655860349125)))) + (fSlow11 * fRec17[0]))) + ((fSlow10 * fRec19[0]) + (fRec18[0] + (0.5 * (fTemp14 * (1 - (0.3333333333333333 * faustpower<2>(fTemp14)))))))) - 1.863946)) - 60.96496296296296);
		...
		fRec38[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec39[0] + fRec11[1]) - 1.271609)) - 45.22606666666667);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec40[0] + fRec9[0]) - 1.271609)) - 45.22606666666667);
		fRec7[0] = ((fConst42 * fRec7[1]) + (fConst66 * ((fConst38 * fRec8[0]) + (fConst39 * fRec8[1]))));
		fRec43[0] = ((fConst74 * fRec43[1]) + (fConst73 * (fRec42[1] + fRec42[2])));
		fRec42[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec43[0] + fRec6[1]) - 0.797043)) - 32.799634146341475);
		...
		fRec4[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec44[0] + fRec5[0]) - 0.797043)) - 32.799634146341475);
