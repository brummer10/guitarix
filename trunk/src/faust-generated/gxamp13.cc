...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow12 = (1 - (0.01 * fSlow2));
	double 	fSlow13 = (0.024937655860349125 * fSlow12);
	double 	fSlow14 = (1.25 * fSlow4);
	double 	fSlow15 = (0.00024937655860349125 * (fSlow2 * (1 - max(0, fSlow10))));
	for (int i=0; i<count; i++) {
		...
		double fTemp19 = (fRec24[2] + (fRec24[0] + (2 * fRec24[1])));
		fVec3[0] = fTemp19;
		...
		double fTemp20 = max(-1, min(1, (fSlow7 * (((fConst7 * fRec22[0]) + (fConst52 * fRec22[1])) + (fConst7 * fRec22[2])))));
		fRec29[0] = ((fConst51 * (fVec3[0] + fVec3[1])) + (fConst43 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst41 * ((fConst40 * fRec28[2]) + (fConst8 * fRec28[1]))));
		double fTemp21 = max(-1, min(1, (fSlow8 * (fRec28[2] + (fRec28[0] + (2 * fRec28[1]))))));
		double fTemp22 = (fConst8 * fRec30[1]);
		...
		fRec30[0] = ((fConst46 * (((fConst13 * fRec31[0]) + (fConst54 * fRec31[1])) + (fConst13 * fRec31[2]))) - (fConst11 * ((fConst10 * fRec30[2]) + fTemp22)));
		double fTemp23 = max(-1, min(1, (fSlow9 * (fRec30[2] + (fConst11 * (fTemp22 + (fConst10 * fRec30[0])))))));
		...
		fRec11[0] = Ftube4(0, ((fTemp14 * (fSlow15 + (fSlow12 * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((fSlow13 * fTemp14)))) - 0.024937655860349125)))))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec33[0] + (fSlow11 * fRec12[0])))));
		fRec10[0] = ((fConst60 * ((fConst35 * fRec11[1]) + (fConst0 * fRec11[0]))) + (fConst2 * fRec10[1]));
		double fTemp27 = (fRec35[1] - 1.3e+02);
		fVec6[0] = fTemp27;
		fRec36[0] = ((fConst64 * (fVec6[0] + fVec6[1])) + (fConst63 * fRec36[1]));
		fRec35[0] = Ftube4(1, (fRec36[0] + fRec9[1]));
		...
		fRec2[0] = Ftube4(1, (fRec41[0] + fRec3[0]));
