...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp33 + (fRec49[0] + fTemp34)) + -1.8639460000000001)))) + -60.964962962962957);
		...
		double fTemp39 = ((fTemp38 + fTemp37) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp39;
		fRec51[0] = (fConst11 * ((1500.0 * (fTemp39 + fVec10[1])) - (fConst12 * fRec51[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp37 + (fRec51[0] + fTemp38)) + -1.271609)))) + -45.226066666666668);
		...
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp40 + (fRec52[0] + fTemp41)) + -0.79704299999999995)))) + -32.799634146341475);
