namespace gxamp13 {
// generated from file '../src/faust/gxamp13.dsp'
...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow6 = pow(1e+01,(2 * fSlow4));
	double 	fSlow7 = (fConst41 * fSlow6);
	double 	fSlow8 = (fConst41 * pow(1e+01,(0.9 * fSlow4)));
	double 	fSlow9 = pow(1e+01,(1.2 * fSlow4));
	double 	fSlow10 = (2 * (fSlow4 - 0.5));
	double 	fSlow11 = (1 - max(0, (0 - fSlow10)));
	double 	fSlow12 = (0.024937655860349125 * (1 - max(0, fSlow10)));
	double 	fSlow13 = (0.0010000000000000009 * (1 - (0.01 * fSlow2)));
	double 	fSlow14 = (1.25 * fSlow4);
	for (int i=0; i<count; i++) {
		...
		double fTemp17 = max(-1, min(1, (fSlow5 * (fRec13[2] + (fConst11 * (fTemp0 + (fConst10 * fRec13[0])))))));
		...
		double fTemp20 = max(-1, min(1, (fSlow7 * (((fConst7 * fRec23[0]) + (fConst52 * fRec23[1])) + (fConst7 * fRec23[2])))));
		fRec30[0] = ((fConst51 * (fVec3[0] + fVec3[1])) + (fConst43 * fRec30[1]));
		fRec29[0] = (fRec30[0] - (fConst41 * ((fConst40 * fRec29[2]) + (fConst8 * fRec29[1]))));
		double fTemp21 = max(-1, min(1, (fSlow8 * (fRec29[2] + (fRec29[0] + (2 * fRec29[1]))))));
		...
		double fTemp23 = max(-1, min(1, (fSlow9 * (fRec31[2] + (fConst11 * (fTemp22 + (fConst10 * fRec31[0])))))));
		...
		double fTemp25 = (fRec11[1] - 1.3e+02);
		fVec5[0] = fTemp25;
		fRec34[0] = ((fConst59 * (fVec5[0] + fVec5[1])) + (fConst58 * fRec34[1]));
		double fTemp26 = max(-1, min(1, (fSlow6 * max(-0.7, min(0.7, fTemp15)))));
		fRec35[0] = (fSlow13 + (0.999 * fRec35[1]));
		fRec11[0] = Ftube4(0, ((fTemp14 * ((fRec35[0] * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fRec35[0] * fTemp14))))) - 0.024937655860349125)))) + (fSlow12 * fRec22[0]))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec34[0] + (fSlow11 * fRec12[0])))));
		fRec10[0] = ((fConst60 * ((fConst35 * fRec11[1]) + (fConst0 * fRec11[0]))) + (fConst2 * fRec10[1]));
		double fTemp27 = (fRec37[1] - 1.3e+02);
		fVec6[0] = fTemp27;
		fRec38[0] = ((fConst64 * (fVec6[0] + fVec6[1])) + (fConst63 * fRec38[1]));
		fRec37[0] = Ftube4(1, (fRec38[0] + fRec9[1]));
		...
		double fTemp29 = (fRec6[1] - 1.3e+02);
		fVec8[0] = fTemp29;
		fRec39[0] = ((fConst64 * (fVec8[0] + fVec8[1])) + (fConst63 * fRec39[1]));
		fRec6[0] = Ftube4(1, (fRec39[0] + fRec7[0]));
		fRec5[0] = ((fConst60 * ((fConst35 * fRec6[1]) + (fConst0 * fRec6[0]))) + (fConst2 * fRec5[1]));
		double fTemp30 = (fRec41[1] - 1.3e+02);
		fVec9[0] = fTemp30;
		fRec42[0] = ((fConst69 * (fVec9[0] + fVec9[1])) + (fConst68 * fRec42[1]));
		fRec41[0] = Ftube4(1, (fRec42[0] + fRec4[1]));
		fRec40[0] = ((fConst60 * ((fConst35 * fRec41[1]) + (fConst0 * fRec41[0]))) + (fConst2 * fRec40[1]));
		fRec4[0] = (fRec40[0] + fRec5[0]);
		fRec3[0] = ((fConst65 * (fRec4[0] + fRec4[1])) + (fConst5 * fRec3[1]));
		double fTemp31 = (fRec2[1] - 1.3e+02);
		fVec10[0] = fTemp31;
		fRec43[0] = ((fConst69 * (fVec10[0] + fVec10[1])) + (fConst68 * fRec43[1]));
		fRec2[0] = Ftube4(1, (fRec43[0] + fRec3[0]));
