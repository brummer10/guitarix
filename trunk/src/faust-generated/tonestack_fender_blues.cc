...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = ((1.2718750000000003e-05 * fSlow2) + (fSlow0 * ((3.0593750000000007e-06 * fSlow2) - (8.696875000000003e-07 + fSlow1))));
	double 	fSlow4 = (1.5468750000000003e-06 + fSlow3);
	double 	fSlow5 = (2.6468750000000002e-11 * fSlow0);
	double 	fSlow6 = (2.646875e-10 * fSlow2);
	double 	fSlow7 = (7.5625e-10 * fSlow2);
	double 	fSlow8 = (7.562500000000001e-11 + (fSlow7 + (fSlow0 * (fSlow6 - (fSlow5 + 4.915625000000001e-11)))));
	double 	fSlow9 = (fConst1 * fSlow8);
	double 	fSlow10 = (0.005562500000000001 * fSlow2);
	double 	fSlow11 = (0.00055 * fSlow0);
	double 	fSlow12 = (fConst1 * (0.005018750000000001 + (fSlow11 + fSlow10)));
	...
	double 	fSlow16 = ((fConst2 * (1.5468750000000003e-06 + (fSlow3 + fSlow14))) - (3 + fSlow12));
	double 	fSlow17 = (1.0 / (0 - (1 + (fSlow12 + (fConst2 * (1.5468750000000003e-06 + (fSlow3 + fSlow9)))))));
	double 	fSlow18 = double(fslider2);
	double 	fSlow19 = ((fSlow0 * ((2.6468750000000002e-11 + fSlow6) - fSlow5)) + (fSlow18 * ((7.562500000000001e-11 + fSlow7) - (7.562500000000001e-11 * fSlow0))));
	double 	fSlow20 = (fConst1 * fSlow19);
	double 	fSlow21 = (((2.75e-07 * fSlow18) + (fSlow0 * (3.403125000000001e-07 - fSlow1))) + (fSlow2 * (6.1875e-07 + (3.0593750000000007e-06 * fSlow0))));
	double 	fSlow22 = (fSlow21 + 6.1875e-08);
	double 	fSlow23 = ((fSlow10 + (fSlow11 + (6.25e-05 * fSlow18))) + 0.00055625);
	...
	double 	fSlow29 = (fSlow28 + (fConst2 * (6.1875e-08 + (fSlow21 + fSlow26))));
	double 	fSlow30 = (fSlow28 - (fConst2 * (6.1875e-08 + (fSlow21 + fSlow20))));
