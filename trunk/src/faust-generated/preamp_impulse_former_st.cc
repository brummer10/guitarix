...
{
	fslider2_ = reg.registerVar("pre_st.Level",N_("Level"),"SA",N_("Level"),&fslider2, 1.0, 0.1, 2.1, 0.1);
	fslider1_ = reg.registerVar("pre_st.bass",N_("Bass"),"SA",N_("Bass"),&fslider1, 0.0, -1e+01, 1e+01, 0.5);
	fslider0_ = reg.registerVar("pre_st.treble",N_("Treble"),"SA",N_("Treble"),&fslider0, 0.0, -1e+01, 1e+01, 0.5);
	return 0;
}
