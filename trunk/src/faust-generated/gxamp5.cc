...
#define fslider3 (*fslider3_)
	...
	double 	fSlow7 = (fConst27 * pow(1e+01,(0.9 * fSlow2)));
	double 	fSlow8 = pow(1e+01,(1.2 * fSlow2));
	double 	fSlow9 = pow(1e+01,(0.8 * fSlow2));
	double 	fSlow10 = (fConst27 * pow(1e+01,(2 * fSlow2)));
	...
	for (int i=0; i<count; i++) {
		...
		fRec20[0] = ((0.999 * fRec20[1]) + fSlow5);
		...
		fRec21[0] = ((fConst4 * fRec21[1]) + (fConst3 * (fRec17[1] + fRec17[2])));
		fRec17[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec21[0] + (0.9254498422517706 * (fRec18[2] + (fRec18[0] + (2.0 * fRec18[1]))))) - 1.581656)) - 191.42014814814814);
		...
		fRec22[0] = ((fConst17 * fRec22[1]) + (fConst16 * (fRec12[1] + fRec12[2])));
		fRec12[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec22[0] + (0.9254498422517706 * (fRec13[2] + (fRec13[0] + (2.0 * fRec13[1]))))) - 1.204285)) - 169.71433333333334);
		...
		fRec9[0] = (fRec10[0] - ((0.8612942439318627 * fRec9[2]) + (1.8405051250752198 * fRec9[1])));
		fRec23[0] = ((fConst21 * fRec23[1]) + (fConst20 * (fRec8[1] + fRec8[2])));
		fRec8[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec23[0] + (0.9254498422517706 * (fRec9[2] + (fRec9[0] + (2.0 * fRec9[1]))))) - 0.840703)) - 147.47524390243905);
		...
		double fTemp3 = (fRec29[2] + (fRec29[0] + (2 * fRec29[1])));
		fVec2[0] = fTemp3;
		fRec28[0] = ((fConst54 * fRec28[1]) + (fConst53 * (fVec2[0] + fVec2[1])));
		fRec27[0] = (fRec28[0] - (fConst34 * ((fConst32 * fRec27[2]) + (fConst30 * fRec27[1]))));
		double fTemp4 = (fRec27[2] + (fRec27[0] + (2 * fRec27[1])));
		fVec3[0] = fTemp4;
		fRec26[0] = ((fConst57 * fRec26[1]) + (fConst56 * (fVec3[0] + fVec3[1])));
		fRec25[0] = (fRec26[0] - (fConst27 * ((fConst26 * fRec25[2]) + (fConst24 * fRec25[1]))));
		double fTemp5 = max((double)-1, min((double)1, (fSlow7 * (fRec25[2] + (fRec25[0] + (2 * fRec25[1]))))));
		double fTemp6 = (fConst24 * fRec33[1]);
		fRec35[0] = ((fConst54 * fRec35[1]) + (fConst53 * ((fConst31 * fVec2[0]) + (fConst60 * fVec2[1]))));
		fRec34[0] = (fRec35[0] - (fConst34 * ((fConst32 * fRec34[2]) + (fConst30 * fRec34[1]))));
		fRec33[0] = ((fConst34 * (((fConst29 * fRec34[0]) + (fConst61 * fRec34[1])) + (fConst29 * fRec34[2]))) - (fConst59 * ((fConst58 * fRec33[2]) + fTemp6)));
		double fTemp7 = max((double)-1, min((double)1, (fSlow8 * (fRec33[2] + (fConst59 * (fTemp6 + (fConst58 * fRec33[0])))))));
		double fTemp8 = (fConst24 * fRec36[1]);
		double fTemp9 = (fConst30 * fRec37[1]);
		...
		fRec37[0] = ((fConst41 * (((fConst36 * fRec38[0]) + (fConst65 * fRec38[1])) + (fConst36 * fRec38[2]))) - (fConst63 * ((fConst62 * fRec37[2]) + fTemp9)));
		fRec36[0] = ((fRec37[2] + (fConst63 * (fTemp9 + (fConst62 * fRec37[0])))) - (fConst59 * ((fConst58 * fRec36[2]) + fTemp8)));
		double fTemp10 = max((double)-1, min((double)1, (fSlow9 * (fRec36[2] + (fConst59 * (fTemp8 + (fConst58 * fRec36[0])))))));
		fRec41[0] = ((fConst57 * fRec41[1]) + (fConst56 * ((fConst25 * fVec3[0]) + (fConst66 * fVec3[1]))));
		fRec40[0] = (fRec41[0] - (fConst27 * ((fConst26 * fRec40[2]) + (fConst24 * fRec40[1]))));
		double fTemp11 = max((double)-1, min((double)1, (fSlow10 * (((fConst23 * fRec40[0]) + (fConst67 * fRec40[1])) + (fConst23 * fRec40[2])))));
		...
		double fTemp13 = ((fSlow11 * fRec24[0]) + (fRec7[0] * ((fTemp0 * (1 + (fSlow6 * ((4 - (4 * fabs((fRec7[0] * fTemp0)))) - 1)))) + (fSlow4 * fRec6[0]))));
		fVec5[0] = fTemp13;
		...
		double fTemp15 = (0.9254498422517706 * (fRec2[2] + (fRec2[0] + (2.0 * fRec2[1]))));
		fRec42[0] = ((fConst13 * fRec42[1]) + (fConst68 * (fRec1[1] + fRec1[2])));
		...
		fRec45[0] = ((fConst13 * fRec45[1]) + (fConst68 * (fRec44[1] + fRec44[2])));
