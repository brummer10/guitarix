...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec14[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec16[0] + ((double)buf[i] * fRec15[0])) - 1.581656)) - 191.42014814814814);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec17[0] + fRec12[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec18[0] + fRec10[0]) - 0.840703)) - 147.47524390243905);
