...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec23[0] = fConst12 * (fConst11 * fRec23[1] + 0.025 * (fRec18[0] - fRec18[1]));
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_12AX7_250k, fRec13[1]) + 1e+05);
		fVec3[0] = fTemp9;
		fRec24[0] = fConst18 * (1.5e+03 * (fTemp9 + fVec3[1]) - fConst17 * fRec24[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp8 + fRec24[0] + fTemp7 + -1.204285) + -169.71433333333334;
		fRec12[0] = 0.025 * (fConst8 * fRec13[0] + fConst9 * fRec13[1]) - fConst4 * fRec12[1];
		fRec25[0] = fConst12 * (fConst11 * fRec25[1] + 0.025 * (fRec13[0] - fRec13[1]));
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_12AX7_250k, fRec9[1]) + 1e+05);
		fVec5[0] = fTemp13;
		fRec26[0] = fConst21 * (8.2e+02 * (fTemp13 + fVec5[1]) - fConst20 * fRec26[1]);
		fRec9[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp12 + fRec26[0] + fTemp11 + -0.840703) + -147.47524390243905;
		fRec8[0] = 0.025 * (fConst8 * fRec9[0] + fConst9 * fRec9[1]) - fConst4 * fRec8[1];
		fRec27[0] = fConst12 * (fConst11 * fRec27[1] + 0.025 * (fRec9[0] - fRec9[1]));
