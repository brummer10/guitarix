...
void init(int samplingFreq)
{
	...
	fConst67 = (1.5848931924611136 / fConst8);
...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow6 = (fConst53 * pow(1e+01,(2 * fSlow2)));
	double 	fSlow7 = (fConst53 * pow(1e+01,(0.9 * fSlow2)));
	...
	for (int i=0; i<count; i++) {
		...
		fRec28[0] = ((fConst50 * (fRec21[0] + fRec21[1])) + (fConst41 * fRec28[1]));
		fRec27[0] = (fRec28[0] - (fConst39 * ((fConst37 * fRec27[2]) + (fConst35 * fRec27[1]))));
		double fTemp8 = (fRec27[2] + (fRec27[0] + (2 * fRec27[1])));
		fVec5[0] = fTemp8;
		fRec26[0] = ((fConst61 * (fVec5[0] + fVec5[1])) + (fConst60 * fRec26[1]));
		fRec25[0] = (fRec26[0] - (fConst58 * ((fConst56 * fRec25[2]) + (fConst29 * fRec25[1]))));
		double fTemp9 = (fRec25[2] + (fRec25[0] + (2 * fRec25[1])));
		fVec6[0] = fTemp9;
		fRec24[0] = ((fConst63 * ((fConst62 * fVec6[1]) + (fConst24 * fVec6[0]))) + (fConst55 * fRec24[1]));
		fRec23[0] = (fRec24[0] - (fConst53 * ((fConst52 * fRec23[2]) + (fConst23 * fRec23[1]))));
		double fTemp10 = max(-1, min(1, (fSlow6 * (((fConst22 * fRec23[0]) + (fConst64 * fRec23[1])) + (fConst22 * fRec23[2])))));
		fRec30[0] = ((fConst63 * (fVec6[0] + fVec6[1])) + (fConst55 * fRec30[1]));
		fRec29[0] = (fRec30[0] - (fConst53 * ((fConst52 * fRec29[2]) + (fConst23 * fRec29[1]))));
		double fTemp11 = max(-1, min(1, (fSlow7 * (fRec29[2] + (fRec29[0] + (2 * fRec29[1]))))));
		double fTemp12 = (fConst23 * fRec31[1]);
		fRec33[0] = ((fConst61 * ((fConst65 * fVec5[1]) + (fConst30 * fVec5[0]))) + (fConst60 * fRec33[1]));
		fRec32[0] = (fRec33[0] - (fConst58 * ((fConst56 * fRec32[2]) + (fConst29 * fRec32[1]))));
		fRec31[0] = ((fConst58 * (((fConst28 * fRec32[0]) + (fConst66 * fRec32[1])) + (fConst28 * fRec32[2]))) - (fConst26 * ((fConst25 * fRec31[2]) + fTemp12)));
		double fTemp13 = max(-1, min(1, (fSlow8 * (fRec31[2] + (fConst26 * (fTemp12 + (fConst25 * fRec31[0])))))));
