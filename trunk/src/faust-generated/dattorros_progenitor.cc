...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp4 = fVec0[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec20[0])))) & 524287];
		fRec17[0] = fSlow6 * fRec17[2] + fSlow5 * (0.5 * fTemp4 + fRec19[0] * (0.0 - 0.5 * (fTemp4 - fVec0[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec21[0])))) & 524287])));
		...
		fRec7[0] = fVec5[(IOTA0 - (iConst8 + iTemp14)) & 8191] * fTemp16 + fTemp17 * fVec5[(IOTA0 - (iConst8 + iTemp18)) & 8191];
		fRec8[IOTA0 & 32767] = fRec7[1] - (fTemp10 + fTemp9);
		fRec6[0] = fSlow3 * fRec6[2] + fSlow4 * fRec8[(IOTA0 - iConst10) & 32767];
		...
		fRec0[0] = fSlow2 * fVec8[(IOTA0 - iConst12) & 32767];
		double fTemp20 = 0.5 * fRec0[1];
		double fTemp21 = fTemp20 + fTemp9 + fSlow10 * fRec27[1];
		fVec9[IOTA0 & 8191] = fTemp21;
		fRec27[0] = fTemp16 * fVec9[(IOTA0 - (iConst13 + iTemp14)) & 8191] + fTemp17 * fVec9[(IOTA0 - (iConst13 + iTemp18)) & 8191];
		fRec28[IOTA0 & 32767] = fRec27[1] - (fTemp9 + fTemp20);
		fRec26[0] = fSlow3 * fRec26[2] + fSlow4 * fRec28[(IOTA0 - iConst14) & 32767];
		...
		fRec1[0] = fSlow2 * fVec11[(IOTA0 - iConst16) & 32767];
