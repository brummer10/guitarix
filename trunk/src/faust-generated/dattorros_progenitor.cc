  ...
  public:
	...
	void fillmydspSIG0(int count, double* table) {
		for (int i1 = 0; (i1 < count); i1 = (i1 + 1)) {
			...
			table[i1] = std::sin((9.5873799242852573e-05 * double(iRec22[0])));
			iVec6[1] = iVec6[0];
			iRec22[1] = iRec22[0];
		}
	}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	double fSlow8 = double(fHslider5);
	double fSlow9 = double(fHslider6);
	double fSlow10 = double(fHslider7);
	double fSlow11 = (0.5 * double(fHslider8));
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		fRec21[0] = (((fRec19[1] <= 0.0) & (fRec20[1] != fSlow7)) ? fSlow7 : fRec21[1]);
		double fTemp4 = fVec0[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec20[0])))) & 524287)];
		fRec17[0] = ((fSlow6 * fRec17[2]) + (fSlow5 * ((0.5 * fTemp4) + (fRec19[0] * (0.0 - (0.5 * (fTemp4 - fVec0[((IOTA - int(std::min<double>(262144.0, std::max<double>(0.0, fRec21[0])))) & 524287)])))))));
		double fTemp5 = (fRec17[0] - (fSlow8 * fRec15[1]));
		fVec1[(IOTA & 1023)] = fTemp5;
		fRec15[0] = fVec1[((IOTA - iConst4) & 1023)];
		double fRec16 = (fSlow8 * fTemp5);
		double fTemp6 = ((fRec16 + fRec15[1]) - (fSlow8 * fRec13[1]));
		fVec2[(IOTA & 1023)] = fTemp6;
		fRec13[0] = fVec2[((IOTA - iConst5) & 1023)];
		double fRec14 = (fSlow8 * fTemp6);
		double fTemp7 = ((fRec14 + fRec13[1]) - (fSlow9 * fRec11[1]));
		fVec3[(IOTA & 4095)] = fTemp7;
		fRec11[0] = fVec3[((IOTA - iConst6) & 4095)];
		double fRec12 = (fSlow9 * fTemp7);
		double fTemp8 = ((fRec12 + fRec11[1]) - (fSlow9 * fRec9[1]));
		fVec4[(IOTA & 2047)] = fTemp8;
		fRec9[0] = fVec4[((IOTA - iConst7) & 2047)];
		double fRec10 = (fSlow9 * fTemp8);
		double fTemp9 = (0.29999999999999999 * (fRec10 + fRec9[1]));
		double fTemp10 = (0.5 * fRec1[1]);
		double fTemp11 = (fTemp9 + ((fSlow10 * fRec7[1]) + fTemp10));
		fVec5[(IOTA & 8191)] = fTemp11;
		fRec23[0] = (fConst9 + (fRec23[1] - std::floor((fConst9 + fRec23[1]))));
		double fTemp12 = (fSlow11 * (ftbl0mydspSIG0[int((65536.0 * fRec23[0]))] + 1.0));
		int iTemp13 = int(fTemp12);
		int iTemp14 = std::min<int>(18, std::max<int>(0, iTemp13));
		double fTemp15 = std::floor(fTemp12);
		double fTemp16 = (fTemp15 + (1.0 - fTemp12));
		double fTemp17 = (fTemp12 - fTemp15);
		int iTemp18 = std::min<int>(18, std::max<int>(0, (iTemp13 + 1)));
		fRec7[0] = ((fVec5[((IOTA - (iConst8 + iTemp14)) & 8191)] * fTemp16) + (fTemp17 * fVec5[((IOTA - (iConst8 + iTemp18)) & 8191)]));
		fRec8[(IOTA & 32767)] = (fRec7[1] - (fTemp10 + fTemp9));
		fRec6[0] = ((fSlow3 * fRec6[2]) + (fSlow4 * fRec8[((IOTA - iConst10) & 32767)]));
		double fTemp19 = ((fSlow2 * fRec6[0]) - (fSlow12 * fRec4[1]));
		fVec7[(IOTA & 16383)] = fTemp19;
		fRec4[0] = fVec7[((IOTA - iConst11) & 16383)];
		double fRec5 = (fSlow12 * fTemp19);
		fVec8[(IOTA & 32767)] = (fRec5 + fRec4[1]);
		fRec0[0] = (fSlow2 * fVec8[((IOTA - iConst12) & 32767)]);
		double fTemp20 = (0.5 * fRec0[1]);
		double fTemp21 = (fTemp20 + (fTemp9 + (fSlow10 * fRec27[1])));
		fVec9[(IOTA & 8191)] = fTemp21;
		fRec27[0] = ((fTemp16 * fVec9[((IOTA - (iConst13 + iTemp14)) & 8191)]) + (fTemp17 * fVec9[((IOTA - (iConst13 + iTemp18)) & 8191)]));
		fRec28[(IOTA & 32767)] = (fRec27[1] - (fTemp9 + fTemp20));
		fRec26[0] = ((fSlow3 * fRec26[2]) + (fSlow4 * fRec28[((IOTA - iConst14) & 32767)]));
		double fTemp22 = ((fSlow2 * fRec26[0]) - (fSlow12 * fRec24[1]));
		fVec10[(IOTA & 32767)] = fTemp22;
		fRec24[0] = fVec10[((IOTA - iConst15) & 32767)];
		double fRec25 = (fSlow12 * fTemp22);
		fVec11[(IOTA & 32767)] = (fRec25 + fRec24[1]);
		fRec1[0] = (fSlow2 * fVec11[((IOTA - iConst16) & 32767)]);
		double fRec2 = fRec8[((IOTA - 0) & 32767)];
		double fRec3 = fRec28[((IOTA - 0) & 32767)];
		output0[i0] = FAUSTFLOAT(((fSlow1 * fTemp0) + (fSlow0 * (fRec0[0] + fRec2))));
		output1[i0] = FAUSTFLOAT(((fSlow1 * fTemp1) + (fSlow0 * (fRec1[0] + fRec3))));
		IOTA = (IOTA + 1);
		fRec18[1] = fRec18[0];
		fRec19[1] = fRec19[0];
		fRec20[1] = fRec20[0];
