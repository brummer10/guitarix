...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = ((fTemp3 * fRec18[0]) - (fConst36 * ((fConst34 * fRec17[2]) + (fConst32 * fRec17[1]))));
		...
		double fTemp5 = max(-1, min(1, (fSlow5 * (fRec12[2] + (fConst15 * (fTemp1 + (fConst14 * fRec12[0])))))));
		...
		double fTemp8 = max(-1, min(1, (fSlow6 * (((fConst11 * fRec19[0]) + (fConst54 * fRec19[1])) + (fConst11 * fRec19[2])))));
		fRec26[0] = ((fConst53 * (fVec3[0] + fVec3[1])) + (fConst45 * fRec26[1]));
		fRec25[0] = (fRec26[0] - (fConst43 * ((fConst42 * fRec25[2]) + (fConst12 * fRec25[1]))));
		double fTemp9 = max(-1, min(1, (fSlow7 * (fRec25[2] + (fRec25[0] + (2 * fRec25[1]))))));
		double fTemp10 = (fConst12 * fRec27[1]);
		...
		fRec27[0] = ((fConst48 * (((fConst17 * fRec28[0]) + (fConst56 * fRec28[1])) + (fConst17 * fRec28[2]))) - (fConst15 * ((fConst14 * fRec27[2]) + fTemp10)));
		double fTemp11 = max(-1, min(1, (fSlow8 * (fRec27[2] + (fConst15 * (fTemp10 + (fConst14 * fRec27[0])))))));
		...
		fRec10[0] = Ftube4(0, ((fTemp3 * ((fSlow13 * fRec18[0]) + (fRec31[0] * (1 + (fSlow12 * ((4 - (4 * fabs((fTemp3 * fRec31[0])))) - 1)))))) + (fRec30[0] + (fSlow10 * fRec11[0]))));
		...
		fRec6[0] = Ftube4(1, (fRec32[0] + fRec7[0]));
		...
		double fTemp17 = (fRec34[1] - 1.3e+02);
		fVec9[0] = fTemp17;
		...
		output0[i] = (FAUSTFLOAT)((fRec33[0] + fRec1[0]) * fRec0[0]);
		// post processing
		fRec33[1] = fRec33[0];
		fRec34[1] = fRec34[0];
		fRec35[1] = fRec35[0];
