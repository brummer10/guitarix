...
inline void Dsp::clear_state_f()
{
	...
	for (int l48 = 0; (l48 < 2); l48 = (l48 + 1)) fVec10[l48] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp18 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -1.8639460000000001))));
		fRec12[0] = ((fTemp18 + (0.00069035037037037039 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp18))) + 100000.0))) + -130.0);
		...
		double fTemp22 = ((fTemp21 + fTemp20) / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp22;
		fRec36[0] = (fConst66 * ((1500.0 * (fTemp22 + fVec7[1])) - (fConst67 * fRec36[1])));
		double fTemp23 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp20 + (fRec36[0] + fTemp21)) + -1.271609))));
		fRec7[0] = ((fTemp23 + (0.00084773933333333329 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp23))) + 100000.0))) + -130.0);
		...
		fVec9[0] = fTemp28;
		fRec37[0] = (fConst69 * ((820.0 * (fTemp28 + fVec9[1])) - (fConst70 * fRec37[1])));
		double fTemp29 = double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp25 + (fRec37[0] + fTemp26)) + -0.79903100000000005))));
		fRec1[0] = ((fTemp29 + (0.00097442804878048784 * (double(Ranode(int(TUBE_TABLE_6DJ8_68k), double(fTemp29))) + 100000.0))) + -130.0);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp30 = (fTemp27 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec39[1]))) + 100000.0));
		fVec10[0] = fTemp30;
		fRec40[0] = (fConst69 * ((820.0 * (fTemp30 + fVec10[1])) - (fConst70 * fRec40[1])));
		double fTemp31 = double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp25 + (fRec40[0] + fTemp26)) + -0.79704299999999995))));
		fRec39[0] = ((fTemp31 + (0.00097200365853658533 * (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fTemp31))) + 100000.0))) + -130.0);
		fRec38[0] = (fConst2 * ((fConst3 * fRec38[1]) + (0.050000000000000003 * (fRec39[0] - fRec39[1]))));
