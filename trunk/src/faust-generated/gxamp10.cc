...
inline void Dsp::clear_state_f()
{
	...
	for (int l28 = 0; (l28 < 3); l28 = (l28 + 1)) fRec12[l28] = 0.0;
	for (int l29 = 0; (l29 < 2); l29 = (l29 + 1)) fRec11[l29] = 0.0;
	for (int l30 = 0; (l30 < 2); l30 = (l30 + 1)) fVec5[l30] = 0.0;
	for (int l31 = 0; (l31 < 2); l31 = (l31 + 1)) fRec10[l31] = 0.0;
	...
	for (int l36 = 0; (l36 < 2); l36 = (l36 + 1)) fRec6[l36] = 0.0;
	...
	for (int l43 = 0; (l43 < 2); l43 = (l43 + 1)) fRec0[l43] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow4 * (fRec16[2] + (fConst41 * (fTemp3 + (fConst43 * fRec16[0])))))));
		...
		double fTemp5 = (fConst36 * fRec25[1]);
		fRec25[0] = ((fConst15 * (((fConst30 * fRec26[0]) + (fConst48 * fRec26[1])) + (fConst30 * fRec26[2]))) - (fConst49 * ((fConst50 * fRec25[2]) + fTemp5)));
		double fTemp6 = (fConst46 * fRec24[1]);
		fRec24[0] = ((fRec25[2] + (fConst49 * (fTemp5 + (fConst50 * fRec25[0])))) - (fConst41 * ((fConst43 * fRec24[2]) + fTemp6)));
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec24[2] + (fConst41 * (fTemp6 + (fConst43 * fRec24[0])))))));
		fRec31[0] = (0.0 - (fConst53 * ((fConst33 * fRec31[1]) - (fConst15 * (fTemp2 + fVec1[1])))));
		fRec30[0] = (fRec31[0] - (fConst10 * ((fConst35 * fRec30[2]) + (fConst36 * fRec30[1]))));
		double fTemp8 = (fRec30[2] + (fRec30[0] + (2.0 * fRec30[1])));
		fVec2[0] = fTemp8;
		...
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst45 * fRec28[0]) + (fConst57 * fRec28[1])) + (fConst45 * fRec28[2])))));
		fRec33[0] = (0.0 - (fConst58 * ((fConst42 * fRec33[1]) - (fConst10 * (fTemp8 + fVec2[1])))));
		fRec32[0] = (fRec33[0] - (fConst51 * ((fConst56 * fRec32[2]) + (fConst46 * fRec32[1]))));
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec32[2] + (fRec32[0] + (2.0 * fRec32[1]))))));
		...
		double fTemp12 = (1.0 - fRec23[0]);
		double fTemp13 = ((fSlow3 * fRec15[0]) + (((fTemp12 * ((fSlow9 * ((4.0 * (1.0 - std::fabs((fTemp12 * fTemp0)))) + -1.0)) + 1.0)) + (fSlow10 * fRec23[0])) * fTemp0));
		fVec4[0] = fTemp13;
		fRec14[0] = ((0.93028479253239138 * (fTemp13 + fVec4[1])) - (0.86056958506478287 * fRec14[1]));
		fRec13[0] = (fRec14[0] - ((1.8405051250752198 * fRec13[1]) + (0.86129424393186271 * fRec13[2])));
		fRec34[0] = (fConst60 * ((0.027 * (fRec12[1] + fRec12[2])) - (fConst61 * fRec34[1])));
		...
		double fTemp14 = (fRec11[0] * fRec5[0]);
		fVec5[0] = fTemp14;
		fRec10[0] = (0.0 - (fConst6 * ((fConst7 * fRec10[1]) - (fTemp14 + fVec5[1]))));
		...
		fRec35[0] = (fConst63 * ((0.014999999999999999 * (fRec7[1] + fRec7[2])) - (fConst64 * fRec35[1])));
		...
		double fTemp15 = (fRec5[0] * fRec6[0]);
		fVec6[0] = fTemp15;
		...
		fRec36[0] = (fConst66 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst67 * fRec36[1])));
		double fTemp17 = (1.8508996845035413 * fRec2[1]);
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp16 + (fRec36[0] + fTemp17)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = ((0.050000000000000003 * ((fConst4 * fRec1[0]) + (fConst26 * fRec1[1]))) - (fConst27 * fRec0[1]));
		fRec39[0] = (fConst66 * ((0.0082000000000000007 * (fRec38[1] + fRec38[2])) - (fConst67 * fRec39[1])));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp16 + (fRec39[0] + fTemp17)) + -0.79704299999999995)))) + -32.799634146341475);
		fRec37[0] = ((0.050000000000000003 * ((fConst4 * fRec38[0]) + (fConst26 * fRec38[1]))) - (fConst27 * fRec37[1]));
		fRec40[0] = (fSlow11 + (0.999 * fRec40[1]));
		buf[i] = FAUSTFLOAT(((fRec0[0] + fRec37[0]) * fRec40[0]));
		fRec5[1] = fRec5[0];
		fRec23[1] = fRec23[0];
		fRec22[2] = fRec22[1];
		fRec22[1] = fRec22[0];
