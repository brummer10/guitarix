...
#define fslider3 (*fslider3_)
	...
	double 	fSlow4 = (fConst10 * pow(1e+01,(0.9 * fSlow3)));
	double 	fSlow5 = pow(1e+01,(1.2 * fSlow3));
	double 	fSlow6 = pow(1e+01,(0.8 * fSlow3));
	double 	fSlow7 = (fConst10 * pow(1e+01,(2 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		fRec19[0] = ((fTemp0 * fRec20[0]) - (fConst30 * ((fConst28 * fRec19[2]) + (fConst26 * fRec19[1]))));
		double fTemp1 = (fRec19[2] + (fRec19[0] + (2 * fRec19[1])));
		fVec0[0] = fTemp1;
		fRec18[0] = ((fConst35 * fRec18[1]) + (fConst34 * ((fConst31 * fVec0[0]) + (fConst32 * fVec0[1]))));
		fRec17[0] = ((fConst38 * fRec17[1]) + (fConst37 * (fRec18[0] + fRec18[1])));
		fRec16[0] = (fRec17[0] - (fConst24 * ((fConst22 * fRec16[2]) + (fConst20 * fRec16[1]))));
		double fTemp2 = (fRec16[2] + (fRec16[0] + (2 * fRec16[1])));
		fVec1[0] = fTemp2;
		fRec15[0] = ((fConst41 * fRec15[1]) + (fConst40 * (fVec1[0] + fVec1[1])));
		fRec14[0] = (fRec15[0] - (fConst17 * ((fConst15 * fRec14[2]) + (fConst13 * fRec14[1]))));
		double fTemp3 = (fRec14[2] + (fRec14[0] + (2 * fRec14[1])));
		fVec2[0] = fTemp3;
		fRec13[0] = ((fConst44 * fRec13[1]) + (fConst43 * (fVec2[0] + fVec2[1])));
		fRec12[0] = (fRec13[0] - (fConst10 * ((fConst9 * fRec12[2]) + (fConst7 * fRec12[1]))));
		double fTemp4 = max((double)-1, min((double)1, (fSlow4 * (fRec12[2] + (fRec12[0] + (2 * fRec12[1]))))));
		double fTemp5 = (fConst7 * fRec21[1]);
		fRec23[0] = ((fConst41 * fRec23[1]) + (fConst40 * ((fConst14 * fVec1[0]) + (fConst47 * fVec1[1]))));
		fRec22[0] = (fRec23[0] - (fConst17 * ((fConst15 * fRec22[2]) + (fConst13 * fRec22[1]))));
		fRec21[0] = ((fConst17 * (((fConst12 * fRec22[0]) + (fConst48 * fRec22[1])) + (fConst12 * fRec22[2]))) - (fConst46 * ((fConst45 * fRec21[2]) + fTemp5)));
		double fTemp6 = max((double)-1, min((double)1, (fSlow5 * (fRec21[2] + (fConst46 * (fTemp5 + (fConst45 * fRec21[0])))))));
		double fTemp7 = (fConst7 * fRec24[1]);
		double fTemp8 = (fConst13 * fRec25[1]);
		fRec27[0] = ((fConst38 * fRec27[1]) + (fConst37 * ((fConst21 * fRec18[0]) + (fConst51 * fRec18[1]))));
		fRec26[0] = (fRec27[0] - (fConst24 * ((fConst22 * fRec26[2]) + (fConst20 * fRec26[1]))));
		fRec25[0] = ((fConst24 * (((fConst19 * fRec26[0]) + (fConst52 * fRec26[1])) + (fConst19 * fRec26[2]))) - (fConst50 * ((fConst49 * fRec25[2]) + fTemp8)));
		fRec24[0] = ((fRec25[2] + (fConst50 * (fTemp8 + (fConst49 * fRec25[0])))) - (fConst46 * ((fConst45 * fRec24[2]) + fTemp7)));
		double fTemp9 = max((double)-1, min((double)1, (fSlow6 * (fRec24[2] + (fConst46 * (fTemp7 + (fConst45 * fRec24[0])))))));
		fRec29[0] = ((fConst44 * fRec29[1]) + (fConst43 * ((fConst8 * fVec2[0]) + (fConst53 * fVec2[1]))));
		fRec28[0] = (fRec29[0] - (fConst10 * ((fConst9 * fRec28[2]) + (fConst7 * fRec28[1]))));
		double fTemp10 = max((double)-1, min((double)1, (fSlow7 * (((fConst6 * fRec28[0]) + (fConst54 * fRec28[1])) + (fConst6 * fRec28[2])))));
		...
		fVec3[0] = fTemp11;
		fRec11[0] = ((fConst58 * fRec11[1]) + (fConst57 * (fVec3[0] + fVec3[1])));
		fRec30[0] = ((fConst62 * fRec30[1]) + (fConst61 * (fRec10[1] + fRec10[2])));
		double fTemp12 = (1 - fRec20[0]);
		fRec10[0] = (Ftube(TUBE_TABLE_6DJ8_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec20[0]))) + (fRec30[0] + (fSlow9 * fRec11[0]))) - 1.863946)) - 60.96496296296296);
		fRec9[0] = ((fConst35 * fRec9[1]) + (fConst63 * ((fConst31 * fRec10[0]) + (fConst32 * fRec10[1]))));
		double fTemp13 = (fRec9[0] * fRec8[0]);
		fVec4[0] = fTemp13;
		fRec7[0] = ((fConst58 * fRec7[1]) + (fConst57 * (fVec4[0] + fVec4[1])));
		fRec31[0] = ((fConst67 * fRec31[1]) + (fConst66 * (fRec6[1] + fRec6[2])));
		fRec6[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec31[0] + fRec7[0]) - 1.271609)) - 45.22606666666667);
		fRec5[0] = ((fConst35 * fRec5[1]) + (fConst63 * ((fConst31 * fRec6[0]) + (fConst32 * fRec6[1]))));
		double fTemp14 = (fRec8[0] * fRec5[0]);
		fVec5[0] = fTemp14;
		fRec4[0] = ((fConst58 * fRec4[1]) + (fConst57 * (fVec5[0] + fVec5[1])));
		...
		fRec34[0] = ((fConst4 * fRec34[1]) + (fConst3 * (fRec33[1] + fRec33[2])));
		fRec33[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec34[0] + fRec4[0]) - 0.799031)) - 32.55719512195121);
		fRec32[0] = ((fConst35 * fRec32[1]) + (fConst63 * ((fConst31 * fRec33[0]) + (fConst32 * fRec33[1]))));
