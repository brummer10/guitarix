...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec24[0] = fTemp2 * fRec15[0] - fConst30 * (fConst29 * fRec24[2] + fConst27 * fRec24[1]);
		double fTemp3 = fRec24[2] + fRec24[0] + 2.0 * fRec24[1];
		fVec0[0] = fTemp3;
		fRec23[0] = fConst30 * (fConst31 * fTemp3 + fConst32 * fVec0[1]) - fConst4 * fRec23[1];
		fRec22[0] = 0.0 - fConst35 * (fConst33 * fRec22[1] - (fRec23[0] + fRec23[1]));
		fRec21[0] = fRec22[0] - fConst25 * (fConst24 * fRec21[2] + fConst22 * fRec21[1]);
		double fTemp4 = fRec21[2] + fRec21[0] + 2.0 * fRec21[1];
		fVec1[0] = fTemp4;
		fRec20[0] = 0.0 - fConst38 * (fConst36 * fRec20[1] - fConst25 * (fTemp4 + fVec1[1]));
		fRec19[0] = fRec20[0] - fConst18 * (fConst17 * fRec19[2] + fConst15 * fRec19[1]);
		double fTemp5 = fRec19[2] + fRec19[0] + 2.0 * fRec19[1];
		fVec2[0] = fTemp5;
		fRec18[0] = 0.0 - fConst41 * (fConst39 * fRec18[1] - fConst18 * (fTemp5 + fVec2[1]));
		fRec17[0] = fRec18[0] - fConst11 * (fConst10 * fRec17[2] + fConst8 * fRec17[1]);
		double fTemp6 = std::max<double>(-1.0, std::min<double>(1.0, fConst11 * (fRec17[2] + fRec17[0] + 2.0 * fRec17[1]) * std::pow(1e+01, 0.9 * fRec14[0])));
		fRec26[0] = fConst18 * (fConst43 * fTemp5 + fConst44 * fVec2[1]) - fConst42 * fRec26[1];
		fRec25[0] = fRec26[0] - fConst11 * (fConst10 * fRec25[2] + fConst8 * fRec25[1]);
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, fConst11 * (fConst7 * fRec25[0] + fConst45 * fRec25[1] + fConst7 * fRec25[2]) * std::pow(1e+01, 2.0 * fRec14[0])));
		double fTemp8 = fConst8 * fRec27[1];
		double fTemp9 = fConst15 * fRec28[1];
		fRec30[0] = fConst50 * fRec23[1] - fConst35 * (fConst33 * fRec30[1] - fConst23 * fRec23[0]);
		fRec29[0] = fRec30[0] - fConst25 * (fConst24 * fRec29[2] + fConst22 * fRec29[1]);
		fRec28[0] = fConst25 * (fConst21 * fRec29[0] + fConst51 * fRec29[1] + fConst21 * fRec29[2]) - fConst49 * (fConst48 * fRec28[2] + fTemp9);
		fRec27[0] = fRec28[2] + fConst49 * (fTemp9 + fConst48 * fRec28[0]) - fConst47 * (fConst46 * fRec27[2] + fTemp8);
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fRec27[2] + fConst47 * (fTemp8 + fConst46 * fRec27[0])) * std::pow(1e+01, 0.8 * fRec14[0])));
		double fTemp11 = fConst8 * fRec31[1];
		fRec33[0] = fConst25 * (fConst53 * fTemp4 + fConst54 * fVec1[1]) - fConst52 * fRec33[1];
		fRec32[0] = fRec33[0] - fConst18 * (fConst17 * fRec32[2] + fConst15 * fRec32[1]);
		fRec31[0] = fConst18 * (fConst14 * fRec32[0] + fConst55 * fRec32[1] + fConst14 * fRec32[2]) - fConst47 * (fConst46 * fRec31[2] + fTemp11);
		double fTemp12 = std::max<double>(-1.0, std::min<double>(1.0, (fRec31[2] + fConst47 * (fTemp11 + fConst46 * fRec31[0])) * std::pow(1e+01, 1.2 * fRec14[0])));
		...
		fVec3[0] = fTemp13;
		fRec16[0] = 0.0 - fConst58 * (fConst57 * fRec16[1] - (fTemp13 + fVec3[1]));
		double fTemp14 = fRec16[0] * (1.0 - std::max<double>(0.0, -1.0 * fTemp0)) + fTemp2 * (fTemp1 * (1.25 * fRec14[0] * (4.0 * (1.0 - std::fabs(fTemp2 * fTemp1)) + -1.0) + 1.0) + fRec15[0] * (1.0 - std::max<double>(0.0, fTemp0)));
		fVec4[0] = fTemp14;
		...
		fVec5[0] = fTemp17;
		fRec34[0] = fConst61 * (2.7e+03 * (fTemp17 + fVec5[1]) - fConst60 * fRec34[1]);
		...
		fRec35[0] = fConst64 * (fConst63 * fRec35[1] + 0.05 * (fRec11[0] - fRec11[1]));
		fRec36[0] = fSlow4 + 0.999 * fRec36[1];
		double fTemp18 = fRec36[0] * ((iSlow1) ? fRec35[0] : fRec10[0]);
		fVec6[0] = fTemp18;
		fRec9[0] = 0.0 - fConst58 * (fConst57 * fRec9[1] - (fTemp18 + fVec6[1]));
		...
		double fTemp19 = 1.8508996845035413 * fRec7[1];
		double fTemp20 = 0.9254498422517706 * (fRec7[0] + fRec7[2]);
		double fTemp21 = (fTemp19 + fTemp20) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp21;
		fRec37[0] = fConst67 * (1.5e+03 * (fTemp21 + fVec7[1]) - fConst66 * fRec37[1]);
		fRec6[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp20 + fRec37[0] + fTemp19 + -1.271609) + -45.22606666666667;
		fRec5[0] = 0.05 * (fConst31 * fRec6[0] + fConst32 * fRec6[1]) - fConst4 * fRec5[1];
		fRec38[0] = fConst64 * (fConst63 * fRec38[1] + 0.05 * (fRec6[0] - fRec6[1]));
		double fTemp22 = fRec36[0] * ((iSlow1) ? fRec38[0] : fRec5[0]);
		fVec8[0] = fTemp22;
		fRec4[0] = 0.0 - fConst58 * (fConst57 * fRec4[1] - (fTemp22 + fVec8[1]));
		fRec3[0] = 0.9302847925323914 * (fRec4[0] + fRec4[1]) - 0.8605695850647829 * fRec3[1];
		fRec2[0] = fRec3[0] - (1.8405051250752198 * fRec2[1] + 0.8612942439318627 * fRec2[2]);
		double fTemp23 = 1.8508996845035413 * fRec2[1];
		double fTemp24 = 0.9254498422517706 * (fRec2[0] + fRec2[2]);
		double fTemp25 = fTemp23 + fTemp24;
		double fTemp26 = fTemp25 / (Ranode(TUBE_TABLE_6DJ8_68k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp26;
		fRec39[0] = fConst70 * (8.2e+02 * (fTemp26 + fVec9[1]) - fConst69 * fRec39[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp24 + fRec39[0] + fTemp23 + -0.799031) + -32.55719512195121;
		fRec0[0] = 0.05 * (fConst31 * fRec1[0] + fConst32 * fRec1[1]) - fConst4 * fRec0[1];
		fRec40[0] = fConst64 * (fConst63 * fRec40[1] + 0.05 * (fRec1[0] - fRec1[1]));
		double fTemp27 = fTemp25 / (Ranode(TUBE_TABLE_6DJ8_250k, fRec42[1]) + 1e+05);
		fVec10[0] = fTemp27;
		fRec43[0] = fConst70 * (8.2e+02 * (fTemp27 + fVec10[1]) - fConst69 * fRec43[1]);
		fRec42[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp24 + fRec43[0] + fTemp23 + -0.797043) + -32.799634146341475;
		fRec41[0] = 0.05 * (fConst31 * fRec42[0] + fConst32 * fRec42[1]) - fConst4 * fRec41[1];
		fRec44[0] = fConst64 * (fConst63 * fRec44[1] + 0.05 * (fRec42[0] - fRec42[1]));
