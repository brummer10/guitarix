...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fVec6[0] = fTemp18;
		fRec10[0] = (0.0 - (fConst5 * ((fConst6 * fRec10[1]) - (fTemp18 + fVec6[1]))));
		...
		fVec7[0] = fTemp21;
		fRec36[0] = (fConst66 * ((1500.0 * (fTemp21 + fVec7[1])) - (fConst67 * fRec36[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp19 + (fRec36[0] + fTemp20)) + -1.271609)))) + -45.226066666666668);
		fRec6[0] = (fConst2 * ((fConst3 * fRec6[1]) + (0.050000000000000003 * (fRec7[0] - fRec7[1]))));
		double fTemp22 = (fRec5[0] * fRec6[0]);
		fVec8[0] = fTemp22;
		fRec4[0] = (0.0 - (fConst5 * ((fConst6 * fRec4[1]) - (fTemp22 + fVec8[1]))));
		...
		fVec9[0] = fTemp26;
		fRec37[0] = (fConst69 * ((820.0 * (fTemp26 + fVec9[1])) - (fConst70 * fRec37[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp23 + (fRec37[0] + fTemp24)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec0[0] = (fConst2 * ((fConst3 * fRec0[1]) + (0.050000000000000003 * (fRec1[0] - fRec1[1]))));
		double fTemp27 = (fTemp25 / (double(Ranode(int(TUBE_TABLE_6DJ8_250k), double(fRec39[1]))) + 100000.0));
		fVec10[0] = fTemp27;
		fRec40[0] = (fConst69 * ((820.0 * (fTemp27 + fVec10[1])) - (fConst70 * fRec40[1])));
		fRec39[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp23 + (fRec40[0] + fTemp24)) + -0.79704299999999995)))) + -32.799634146341475);
