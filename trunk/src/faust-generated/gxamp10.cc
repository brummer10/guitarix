...
inline void Dsp::clear_state_f()
{
	...
	for (int l15 = 0; (l15 < 3); l15 = (l15 + 1)) fRec24[l15] = 0.0;
	...
	for (int l22 = 0; (l22 < 2); l22 = (l22 + 1)) fRec32[l22] = 0.0;
	...
	for (int l27 = 0; (l27 < 2); l27 = (l27 + 1)) fRec12[l27] = 0.0;
	for (int l28 = 0; (l28 < 3); l28 = (l28 + 1)) fRec11[l28] = 0.0;
	for (int l29 = 0; (l29 < 2); l29 = (l29 + 1)) fRec33[l29] = 0.0;
	for (int l30 = 0; (l30 < 3); l30 = (l30 + 1)) fRec10[l30] = 0.0;
	...
	for (int l36 = 0; (l36 < 3); l36 = (l36 + 1)) fRec6[l36] = 0.0;
	...
	for (int l40 = 0; (l40 < 3); l40 = (l40 + 1)) fRec2[l40] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	double fSlow2 = (1.0000000000000009e-05 * double(fVslider2));
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp14 = ((fRec13[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp12)))) + (fTemp0 * ((fTemp13 * ((1.25 * (fRec22[0] * ((4.0 * (1.0 - std::fabs((fTemp0 * fTemp13)))) + -1.0))) + 1.0)) + (fRec21[0] * (1.0 - std::max<double>(0.0, fTemp12))))));
		fVec4[0] = fTemp14;
		...
		fRec10[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec11[0] + fRec11[2])) + (fRec33[0] + (1.8508996845035413 * fRec11[1]))) + -1.8639460000000001)))) + -60.964962962962957);
		double fTemp15 = (fRec10[0] * fRec5[0]);
		fVec5[0] = fTemp15;
		fRec9[0] = (fConst2 * ((0.050000000000000003 * (fTemp15 + fVec5[1])) - (fConst3 * fRec9[1])));
		...
		fRec34[0] = (fConst63 * ((0.014999999999999999 * (fRec6[1] + fRec6[2])) - (fConst64 * fRec34[1])));
		fRec6[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec7[0] + fRec7[2])) + (fRec34[0] + (1.8508996845035413 * fRec7[1]))) + -1.271609)))) + -45.226066666666668);
		double fTemp16 = (fRec5[0] * fRec6[0]);
		fVec6[0] = fTemp16;
		fRec4[0] = (fConst2 * ((0.050000000000000003 * (fTemp16 + fVec6[1])) - (fConst3 * fRec4[1])));
		...
		fRec35[0] = (fConst66 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst67 * fRec35[1])));
		double fTemp18 = (1.8508996845035413 * fRec2[1]);
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp17 + (fRec35[0] + fTemp18)) + -0.79903100000000005)))) + -32.55719512195121);
		fRec37[0] = (fConst66 * ((0.0082000000000000007 * (fRec36[1] + fRec36[2])) - (fConst67 * fRec37[1])));
		fRec36[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp17 + (fRec37[0] + fTemp18)) + -0.79704299999999995)))) + -32.799634146341475);
		buf[i] = FAUSTFLOAT((0.050000000000000003 * (fRec0[0] * (fRec1[0] + fRec36[0]))));
		fRec0[1] = fRec0[0];
		fRec5[1] = fRec5[0];
		fRec21[1] = fRec21[0];
		fRec20[2] = fRec20[1];
...
{
	fVslider3_ = reg.registerFloatVar("gxdistortion.drive","","SA","",&fVslider3, 0.34999999999999998, 0.0, 1.0, 0.01, 0);
	fVslider2_ = reg.registerFloatVar("gxdistortion.wet_dry","","SA","",&fVslider2, 100.0, 0.0, 100.0, 1.0, 0);
	fVslider1_ = reg.registerFloatVar("amp2.stage1.Pregain","","SA","",&fVslider1, -6.0, -20.0, 20.0, 0.10000000000000001, 0);
