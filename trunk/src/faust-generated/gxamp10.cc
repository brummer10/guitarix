...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow6 = (fConst43 * pow(1e+01,(0.9 * fSlow3)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (fConst18 * fRec13[1]);
		fRec18[0] = (fSlow2 + (0.999 * fRec18[1]));
		double fTemp2 = (double)input0[i];
		fRec17[0] = ((fTemp2 * fRec18[0]) - (fConst36 * ((fConst34 * fRec17[2]) + (fConst32 * fRec17[1]))));
		double fTemp3 = (fRec17[2] + (fRec17[0] + (2 * fRec17[1])));
		fVec0[0] = fTemp3;
		fRec16[0] = ((fConst38 * ((fConst37 * fVec0[1]) + (fConst0 * fVec0[0]))) + (fConst2 * fRec16[1]));
		...
		fRec13[0] = ((fConst28 * (((fConst23 * fRec14[0]) + (fConst41 * fRec14[1])) + (fConst23 * fRec14[2]))) - (fConst21 * ((fConst20 * fRec13[2]) + fTemp1)));
		fRec12[0] = ((fRec13[2] + (fConst21 * (fTemp1 + (fConst20 * fRec13[0])))) - (fConst15 * ((fConst14 * fRec12[2]) + fTemp0)));
		...
		fVec1[0] = fTemp5;
		fRec22[0] = ((fConst51 * (fVec1[0] + fVec1[1])) + (fConst50 * fRec22[1]));
		fRec21[0] = (fRec22[0] - (fConst48 * ((fConst46 * fRec21[2]) + (fConst18 * fRec21[1]))));
		double fTemp6 = (fRec21[2] + (fRec21[0] + (2 * fRec21[1])));
		fVec2[0] = fTemp6;
		fRec20[0] = ((fConst53 * ((fConst52 * fVec2[1]) + (fConst13 * fVec2[0]))) + (fConst45 * fRec20[1]));
		fRec19[0] = (fRec20[0] - (fConst43 * ((fConst42 * fRec19[2]) + (fConst12 * fRec19[1]))));
		double fTemp7 = max(-1, min(1, (fSlow5 * (((fConst11 * fRec19[0]) + (fConst54 * fRec19[1])) + (fConst11 * fRec19[2])))));
		fRec26[0] = ((fConst53 * (fVec2[0] + fVec2[1])) + (fConst45 * fRec26[1]));
		fRec25[0] = (fRec26[0] - (fConst43 * ((fConst42 * fRec25[2]) + (fConst12 * fRec25[1]))));
		double fTemp8 = max(-1, min(1, (fSlow6 * (fRec25[2] + (fRec25[0] + (2 * fRec25[1]))))));
		double fTemp9 = (fConst12 * fRec27[1]);
		fRec29[0] = ((fConst51 * ((fConst55 * fVec1[1]) + (fConst19 * fVec1[0]))) + (fConst50 * fRec29[1]));
		fRec28[0] = (fRec29[0] - (fConst48 * ((fConst46 * fRec28[2]) + (fConst18 * fRec28[1]))));
		fRec27[0] = ((fConst48 * (((fConst17 * fRec28[0]) + (fConst56 * fRec28[1])) + (fConst17 * fRec28[2]))) - (fConst15 * ((fConst14 * fRec27[2]) + fTemp9)));
		double fTemp10 = max(-1, min(1, (fSlow7 * (fRec27[2] + (fConst15 * (fTemp9 + (fConst14 * fRec27[0])))))));
		...
		fRec10[0] = (Ftube(TUBE_TABLE_6DJ8_68k, (((fTemp2 * ((fSlow11 * fRec18[0]) + (fTemp12 * (1 + (fSlow10 * ((4 - (4 * fabs((fTemp2 * fTemp12)))) - 1)))))) + (fRec30[0] + (fSlow9 * fRec11[0]))) - 1.863946)) - 60.96496296296296);
		fRec9[0] = ((fConst62 * ((fConst37 * fRec10[1]) + (fConst0 * fRec10[0]))) + (fConst2 * fRec9[1]));
		double fTemp13 = (fRec9[0] * fRec8[0]);
		fVec4[0] = fTemp13;
		fRec7[0] = ((fConst63 * (fVec4[0] + fVec4[1])) + (fConst9 * fRec7[1]));
		...
		fVec5[0] = fTemp14;
		fRec4[0] = ((fConst63 * (fVec5[0] + fVec5[1])) + (fConst9 * fRec4[1]));
		...
		fRec32[0] = ((fConst62 * ((fConst37 * fRec33[1]) + (fConst0 * fRec33[0]))) + (fConst2 * fRec32[1]));
