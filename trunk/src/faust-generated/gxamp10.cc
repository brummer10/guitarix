...
#define fslider3 (*fslider3_)
	...
	double 	fSlow6 = (fConst6 * pow(1e+01,(0.9 * fSlow2)));
	double 	fSlow7 = pow(1e+01,(0.8 * fSlow2));
	double 	fSlow8 = (fConst6 * pow(1e+01,(2 * fSlow2)));
	double 	fSlow9 = pow(1e+01,(1.2 * fSlow2));
	double 	fSlow10 = (1 - max((double)0, (0 - fSlow4)));
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec24[0] = ((fTemp1 * fRec15[0]) - (fConst26 * ((fConst24 * fRec24[2]) + (fConst22 * fRec24[1]))));
		double fTemp2 = (fRec24[0] + (fRec24[2] + (2 * fRec24[1])));
		fVec0[0] = fTemp2;
		...
		fRec26[0] = ((fConst20 * ((fConst46 * fRec27[1]) + (fConst15 * (fRec27[2] + fRec27[0])))) - (fConst44 * ((fConst43 * fRec26[2]) + fTemp7)));
		fRec25[0] = ((fRec26[2] + (fConst44 * (fTemp7 + (fConst43 * fRec26[0])))) - (fConst42 * ((fConst41 * fRec25[2]) + fTemp6)));
		double fTemp8 = max((double)-1, min((double)1, (fSlow7 * (fRec25[2] + (fConst42 * (fTemp6 + (fConst41 * fRec25[0])))))));
		...
		double fTemp9 = max((double)-1, min((double)1, (fSlow8 * ((fConst48 * fRec29[1]) + (fConst4 * (fRec29[2] + fRec29[0]))))));
		double fTemp10 = (fConst5 * fRec31[1]);
		...
		fRec31[0] = ((fConst13 * ((fConst50 * fRec32[1]) + (fConst10 * (fRec32[2] + fRec32[0])))) - (fConst42 * ((fConst41 * fRec31[2]) + fTemp10)));
		double fTemp11 = max((double)-1, min((double)1, (fSlow9 * (fRec31[2] + (fConst42 * (fTemp10 + (fConst41 * fRec31[0])))))));
		...
		double fTemp13 = ((fSlow10 * fRec16[0]) + (fTemp1 * ((fSlow5 * fRec15[0]) + (fTemp0 * (1 + (fSlow3 * (3 - (4 * fabs((fTemp1 * fTemp0))))))))));
		fVec4[0] = fTemp13;
		fRec14[0] = ((0.9302847925323914 * (fVec4[0] + fVec4[1])) - (0.8605695850647829 * fRec14[1]));
		fRec13[0] = (fRec14[0] - ((1.8405051250752198 * fRec13[1]) + (0.8612942439318627 * fRec13[2])));
		fRec34[0] = ((fConst58 * (fRec12[1] + fRec12[2])) + (fConst57 * fRec34[1]));
		...
		fRec9[0] = ((0.9302847925323914 * (fRec10[1] + fRec10[0])) - (0.8605695850647829 * fRec9[1]));
		fRec8[0] = (fRec9[0] - ((1.8405051250752198 * fRec8[1]) + (0.8612942439318627 * fRec8[2])));
		fRec36[0] = ((fConst63 * (fRec7[1] + fRec7[2])) + (fConst62 * fRec36[1]));
		...
		double fTemp15 = (fRec35[0] * fRec6[0]);
		fVec6[0] = fTemp15;
		...
		double fTemp16 = (0.9254498422517706 * (fRec3[0] + (fRec3[2] + (2.0 * fRec3[1]))));
		fRec37[0] = ((fConst67 * (fRec2[1] + fRec2[2])) + (fConst66 * fRec37[1]));
		fRec2[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec37[0] + fTemp16) - 0.797043)) - 32.799634146341475);
		fRec1[0] = ((fConst31 * fRec1[1]) + (fConst59 * ((fConst27 * fRec2[0]) + (fConst28 * fRec2[1]))));
		fRec40[0] = ((fConst67 * (fRec39[1] + fRec39[2])) + (fConst66 * fRec40[1]));
