...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		double fTemp27 = ((fTemp12 * ((fTemp26 * (0.024937655860349125 + (fSlow12 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fTemp26 * fTemp12))))) - 0.024937655860349125)))) + (fSlow11 * fRec30[0]))) + ((0.5 * (fTemp25 * (1 - (0.3333333333333333 * faustpower<2>(fTemp25))))) + (fSlow10 * fRec18[0])));
		fVec5[0] = fTemp27;
