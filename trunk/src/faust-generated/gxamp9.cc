...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = Ftube(0, ((fTemp14 * ((fRec35[0] * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fRec35[0] * fTemp14))))) - 0.024937655860349125)))) + (fSlow12 * fRec22[0]))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec34[0] + (fSlow11 * fRec12[0])))));
		...
		fRec6[0] = Ftube(1, (fRec39[0] + fRec7[0]));
		...
		fRec41[0] = Ftube(1, (fRec42[0] + fRec4[1]));
