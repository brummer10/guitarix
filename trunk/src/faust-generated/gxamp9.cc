namespace gxamp9 {
// generated from file '../src/faust/gxamp9.dsp'
...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = Ftube2(0, (fRec10[0] + (fTemp0 * (1 + (fSlow2 * ((4 - (4 * fabs(fTemp0))) - 1))))));
		...
		fVec1[0] = fTemp2;
		fRec11[0] = ((fConst16 * (fVec1[0] + fVec1[1])) + (fConst15 * fRec11[1]));
		fRec5[0] = Ftube2(1, (fRec11[0] + (fRec7[0] * fRec6[0])));
		fRec4[0] = ((fConst11 * ((fConst10 * fRec5[1]) + (fConst0 * fRec5[0]))) + (fConst2 * fRec4[1]));
		fRec3[0] = ((fConst12 * (fRec4[0] + fRec4[1])) + (fConst5 * fRec3[1]));
		double fTemp3 = (fRec1[1] - 2.5e+02);
		fVec2[0] = fTemp3;
		fRec12[0] = ((fConst20 * (fVec2[0] + fVec2[1])) + (fConst19 * fRec12[1]));
		fRec1[0] = Ftube2(1, (fRec12[0] + (fRec3[0] * fRec2[0])));
