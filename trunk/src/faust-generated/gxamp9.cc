...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp37 = ((fTemp36 + fTemp35) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec23[1]))) + 100000.0));
		fVec8[0] = fTemp37;
		fRec49[0] = (fConst71 * ((2700.0 * (fTemp37 + fVec8[1])) - (fConst72 * fRec49[1])));
		double fTemp38 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp35 + (fRec49[0] + fTemp36)) + -1.581656))));
		fRec23[0] = ((fTemp38 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp38))) + 100000.0))) + -250.0);
		...
		double fTemp42 = ((fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp42;
		fRec51[0] = (fConst11 * ((1500.0 * (fTemp42 + fVec10[1])) - (fConst12 * fRec51[1])));
		double fTemp43 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp40 + (fRec51[0] + fTemp41)) + -1.204285))));
		fRec12[0] = ((fTemp43 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp43))) + 100000.0))) + -250.0);
		...
		double fTemp46 = ((fTemp45 + fTemp44) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp46;
		fRec52[0] = (fConst8 * ((820.0 * (fTemp46 + fVec11[1])) - (fConst9 * fRec52[1])));
		double fTemp47 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp44 + (fRec52[0] + fTemp45)) + -0.84070199999999995))));
		fRec1[0] = ((fTemp47 + (0.0010252463414634147 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp47))) + 100000.0))) + -250.0);
