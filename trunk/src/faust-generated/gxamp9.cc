...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp24 = (fRec11[1] - 2.5e+02);
		fVec5[0] = fTemp24;
		fRec33[0] = ((fConst59 * (fVec5[0] + fVec5[1])) + (fConst58 * fRec33[1]));
		fRec11[0] = Ftube(0, ((fTemp14 * (fSlow14 + (fSlow11 * (0.024937655860349125 + (fSlow13 * ((0.0997506234413965 - (0.0997506234413965 * fabs((fSlow12 * fTemp14)))) - 0.024937655860349125)))))) + (fRec33[0] + (fSlow10 * fRec12[0]))));
		fRec10[0] = ((fConst60 * ((fConst35 * fRec11[1]) + (fConst0 * fRec11[0]))) + (fConst2 * fRec10[1]));
		double fTemp25 = (fRec35[1] - 2.5e+02);
		fVec6[0] = fTemp25;
		...
		double fTemp27 = (fRec6[1] - 2.5e+02);
		fVec8[0] = fTemp27;
		...
		double fTemp28 = (fRec39[1] - 2.5e+02);
		fVec9[0] = fTemp28;
		...
		double fTemp29 = (fRec2[1] - 2.5e+02);
		fVec10[0] = fTemp29;
