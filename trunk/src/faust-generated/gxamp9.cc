...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec20[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp31 + fRec46[0] + fTemp30 + -1.581656) + -191.42014814814814;
		...
		double fTemp35 = (fTemp33 + fTemp34) / (Ranode(TUBE_TABLE_12AX7_250k, fRec49[1]) + 1e+05);
		fVec8[0] = fTemp35;
		fRec52[0] = fConst72 * (1.5e+03 * (fTemp35 + fVec8[1]) - fConst71 * fRec52[1]);
		fRec49[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp34 + fRec52[0] + fTemp33 + -1.204285) + -169.71433333333334;
		...
		double fTemp39 = (fTemp37 + fTemp38) / (Ranode(TUBE_TABLE_12AX7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp39;
		fRec54[0] = fConst72 * (1.5e+03 * (fTemp39 + fVec10[1]) - fConst71 * fRec54[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp38 + fRec54[0] + fTemp37 + -1.204285) + -169.71433333333334;
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_12AX7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp42;
		fRec56[0] = fConst7 * (8.2e+02 * (fTemp42 + fVec11[1]) - fConst6 * fRec56[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp41 + fRec56[0] + fTemp40 + -0.840702) + -147.47536585365856;
