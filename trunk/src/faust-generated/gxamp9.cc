...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec11[0] = Ftube(0, ((fTemp14 * (fSlow15 + (fSlow12 * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((fSlow13 * fTemp14)))) - 0.024937655860349125)))))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec33[0] + (fSlow11 * fRec12[0])))));
		fRec10[0] = ((fConst60 * ((fConst35 * fRec11[1]) + (fConst0 * fRec11[0]))) + (fConst2 * fRec10[1]));
		double fTemp27 = (fRec35[1] - 2.5e+02);
		fVec6[0] = fTemp27;
		fRec36[0] = ((fConst64 * (fVec6[0] + fVec6[1])) + (fConst63 * fRec36[1]));
		fRec35[0] = Ftube(1, (fRec36[0] + fRec9[1]));
		...
		fRec2[0] = Ftube(1, (fRec41[0] + fRec3[0]));
