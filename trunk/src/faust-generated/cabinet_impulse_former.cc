...
{
	fVslider0_ = reg.registerVar("cab.Level",N_("Level"),"SA",N_("Level"),&fVslider0, 1.0, 0.5, 5.0, 0.5);
	fVslider2_ = reg.registerVar("cab.bass",N_("Bass"),"SA",N_("Bass"),&fVslider2, 0.0, -10.0, 10.0, 0.5);
	fVslider1_ = reg.registerVar("cab.treble",N_("Treble"),"SA",N_("Treble"),&fVslider1, 0.0, -10.0, 10.0, 0.5);
	return 0;
}
