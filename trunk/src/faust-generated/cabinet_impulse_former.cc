...
{
	fVslider2_ = reg.registerFloatVar("cab.Level",N_("Level"),"SA",N_("Level"),&fVslider2, 1.0, 0.5, 5.0, 0.5, 0);
	fVslider0_ = reg.registerFloatVar("cab.bass",N_("Bass"),"SA",N_("Bass"),&fVslider0, 0.0, -1e+01, 1e+01, 0.5, 0);
	fVslider1_ = reg.registerFloatVar("cab.treble",N_("Treble"),"SA",N_("Treble"),&fVslider1, 0.0, -1e+01, 1e+01, 0.5, 0);
	return 0;
}
