...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (((fSlow1 * (((1.2375000000000003e-05 * fSlow0) - 2.1175000000000003e-08) - fSlow2)) + (1.9448000000000004e-05 * fSlow0)) + 6.677000000000001e-07);
	double 	fSlow4 = (1.9965000000000003e-09 * fSlow0);
	double 	fSlow5 = ((1.7121500000000001e-09 * fSlow0) - (4.2803750000000003e-11 * fSlow1));
	double 	fSlow6 = (4.991250000000001e-11 + ((fSlow1 * (fSlow5 - 7.108750000000004e-12)) + fSlow4));
	...
	double 	fSlow17 = ((((1.815e-07 * fSlow16) + (fSlow1 * (3.781250000000001e-07 - fSlow2))) + (fSlow0 * (3.4760000000000007e-06 + (1.2375000000000003e-05 * fSlow1)))) + 8.690000000000002e-08);
	double 	fSlow18 = ((fSlow1 * (4.2803750000000003e-11 + fSlow5)) + (fSlow16 * (fSlow4 + (4.991250000000001e-11 - (4.991250000000001e-11 * fSlow1)))));
