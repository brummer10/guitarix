...
inline void Dsp::compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow4 = (fConst1 * fslider3);
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = ((fSlow3 * fRec0[1]) - fTemp1);
...
{
	reg.registerVar("flanger_mono.freq","","S","",&fslider3, 0.2, 0.0, 5.0, 0.01);
	reg.registerVar("flanger_mono.feedback gain","","S","",&fslider2, 0.5, 0.0, 1.0, 0.01);
