...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst15 = (1 + ((fConst13 + 1.0000000000000004) / fConst10));
	...
	fConst78 = (1 + ((fConst76 + 1.0000000000000004) / fConst73));
	...
	fConst87 = (1 + ((1.0000000000000004 + fConst85) / fConst82));
	fConst88 = (1.0 / fConst87);
	fConst89 = (1 + fConst85);
	fConst90 = (0 - ((1 - fConst85) / fConst89));
	fConst91 = (1.0 / fConst89);
	fConst92 = (1.0 / (fConst80 * fConst87));
	fConst93 = (1.0 / (fConst71 * fConst78));
	fConst94 = (1.0 / (fConst62 * fConst69));
	fConst95 = (1.0 / (fConst53 * fConst60));
	fConst96 = (1.0 / (fConst44 * fConst51));
	fConst97 = (1.0 / (fConst35 * fConst42));
	fConst98 = (1.0 / (fConst26 * fConst33));
	fConst99 = (1.0 / (fConst17 * fConst24));
	fConst100 = (0 - fConst5);
	fConst101 = (1.0 / (fConst8 * fConst15));
	fConst102 = (2 * (0 - fConst3));
	fConst103 = (1 + ((fConst5 - 1.0) / fConst2));
	fConst104 = (1.0 / (1 + ((1.0 + fConst5) / fConst2)));
	fConst105 = (0 - fConst13);
	fConst106 = (2 * (0 - fConst11));
	fConst107 = (1 + ((fConst13 - 1.0) / fConst10));
	fConst108 = (1.0 / (1 + ((1.0 + fConst13) / fConst10)));
	fConst109 = (0 - fConst22);
	fConst110 = (2 * (0 - fConst20));
	fConst111 = (1 + ((fConst22 - 1.0) / fConst19));
	fConst112 = (1.0 / (1 + ((1.0 + fConst22) / fConst19)));
	fConst113 = (0 - fConst31);
	fConst114 = (2 * (0 - fConst29));
	fConst115 = (1 + ((fConst31 - 1.0) / fConst28));
	fConst116 = (1.0 / (1 + ((1.0 + fConst31) / fConst28)));
	fConst117 = (0 - fConst40);
	fConst118 = (2 * (0 - fConst38));
	fConst119 = (1 + ((fConst40 - 1.0) / fConst37));
	fConst120 = (1.0 / (1 + ((1.0 + fConst40) / fConst37)));
	fConst121 = (0 - fConst49);
	fConst122 = (2 * (0 - fConst47));
	fConst123 = (1 + ((fConst49 - 1.0) / fConst46));
	fConst124 = (1.0 / (1 + ((1.0 + fConst49) / fConst46)));
	fConst125 = (0 - fConst58);
	fConst126 = (2 * (0 - fConst56));
	fConst127 = (1 + ((fConst58 - 1.0) / fConst55));
	fConst128 = (1.0 / (1 + ((1.0 + fConst58) / fConst55)));
	fConst129 = (0 - fConst67);
	fConst130 = (2 * (0 - fConst65));
	fConst131 = (1 + ((fConst67 - 1.0) / fConst64));
	fConst132 = (1.0 / (1 + ((1.0 + fConst67) / fConst64)));
	fConst133 = (0 - fConst76);
	fConst134 = (2 * (0 - fConst74));
	fConst135 = (1 + ((fConst76 - 1.0) / fConst73));
	fConst136 = (1.0 / (1 + ((1.0 + fConst76) / fConst73)));
	fConst137 = (0 - fConst85);
	fConst138 = (2 * (0 - fConst83));
	clear_state_f();
}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double 	fSlow4 = (0.0010000000000000009 * pow(10,(0.05 * fslider4)));
	double 	fSlow5 = (0.0010000000000000009 * pow(10,(0.05 * fslider5)));
	double 	fSlow6 = (0.0010000000000000009 * pow(10,(0.05 * fslider6)));
	double 	fSlow7 = (0.0010000000000000009 * pow(10,(0.05 * fslider7)));
	double 	fSlow8 = (0.0010000000000000009 * pow(10,(0.05 * fslider8)));
	double 	fSlow9 = (0.0010000000000000009 * pow(10,(0.05 * fslider9)));
	double 	fSlow10 = (0.0010000000000000009 * pow(10,(0.05 * fslider10)));
	for (int i=0; i<count; i++) {
		double fTemp0 = (double)input0[i];
		fVec0[0] = fTemp0;
		fRec23[0] = ((fConst91 * (fVec0[0] + fVec0[1])) + (fConst90 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst88 * ((fConst86 * fRec22[2]) + (fConst84 * fRec22[1]))));
		double fTemp1 = (fRec22[2] + (fRec22[0] + (2 * fRec22[1])));
		fVec1[0] = fTemp1;
		fRec21[0] = ((fConst92 * (fVec1[0] + fVec1[1])) + (fConst81 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fConst79 * ((fConst77 * fRec20[2]) + (fConst75 * fRec20[1]))));
		double fTemp2 = (fRec20[2] + (fRec20[0] + (2 * fRec20[1])));
		fVec2[0] = fTemp2;
		fRec19[0] = ((fConst93 * (fVec2[0] + fVec2[1])) + (fConst72 * fRec19[1]));
		fRec18[0] = (fRec19[0] - (fConst70 * ((fConst68 * fRec18[2]) + (fConst66 * fRec18[1]))));
		double fTemp3 = (fRec18[2] + (fRec18[0] + (2 * fRec18[1])));
		fVec3[0] = fTemp3;
		fRec17[0] = ((fConst94 * (fVec3[0] + fVec3[1])) + (fConst63 * fRec17[1]));
		fRec16[0] = (fRec17[0] - (fConst61 * ((fConst59 * fRec16[2]) + (fConst57 * fRec16[1]))));
		double fTemp4 = (fRec16[2] + (fRec16[0] + (2 * fRec16[1])));
		fVec4[0] = fTemp4;
		fRec15[0] = ((fConst95 * (fVec4[0] + fVec4[1])) + (fConst54 * fRec15[1]));
		fRec14[0] = (fRec15[0] - (fConst52 * ((fConst50 * fRec14[2]) + (fConst48 * fRec14[1]))));
		double fTemp5 = (fRec14[2] + (fRec14[0] + (2 * fRec14[1])));
		fVec5[0] = fTemp5;
		fRec13[0] = ((fConst96 * (fVec5[0] + fVec5[1])) + (fConst45 * fRec13[1]));
		fRec12[0] = (fRec13[0] - (fConst43 * ((fConst41 * fRec12[2]) + (fConst39 * fRec12[1]))));
		double fTemp6 = (fRec12[2] + (fRec12[0] + (2 * fRec12[1])));
		fVec6[0] = fTemp6;
		fRec11[0] = ((fConst97 * (fVec6[0] + fVec6[1])) + (fConst36 * fRec11[1]));
		fRec10[0] = (fRec11[0] - (fConst34 * ((fConst32 * fRec10[2]) + (fConst30 * fRec10[1]))));
		double fTemp7 = (fRec10[2] + (fRec10[0] + (2 * fRec10[1])));
		fVec7[0] = fTemp7;
		fRec9[0] = ((fConst98 * (fVec7[0] + fVec7[1])) + (fConst27 * fRec9[1]));
		fRec8[0] = (fRec9[0] - (fConst25 * ((fConst23 * fRec8[2]) + (fConst21 * fRec8[1]))));
		double fTemp8 = (fRec8[2] + (fRec8[0] + (2 * fRec8[1])));
		fVec8[0] = fTemp8;
		fRec7[0] = ((fConst99 * (fVec8[0] + fVec8[1])) + (fConst18 * fRec7[1]));
		fRec6[0] = (fRec7[0] - (fConst16 * ((fConst14 * fRec6[2]) + (fConst12 * fRec6[1]))));
		double fTemp9 = (fRec6[2] + (fRec6[0] + (2 * fRec6[1])));
		fVec9[0] = fTemp9;
		fRec5[0] = ((fConst101 * ((fConst100 * fVec9[1]) + (fConst5 * fVec9[0]))) + (fConst9 * fRec5[1]));
		fRec4[0] = (fRec5[0] - (fConst7 * ((fConst6 * fRec4[2]) + (fConst4 * fRec4[1]))));
		fRec24[0] = (fSlow0 + (0.999 * fRec24[1]));
		double fTemp10 = (fConst7 * (fRec24[0] * (((fConst3 * fRec4[0]) + (fConst102 * fRec4[1])) + (fConst3 * fRec4[2]))));
		...
		fbargraph0 = fRec2[0];
		fRec30[0] = ((fConst101 * (fVec9[0] + fVec9[1])) + (fConst9 * fRec30[1]));
		fRec29[0] = (fRec30[0] - (fConst7 * ((fConst6 * fRec29[2]) + (fConst4 * fRec29[1]))));
		fRec31[0] = (fSlow1 + (0.999 * fRec31[1]));
		double fTemp12 = (fConst7 * (fRec31[0] * (fRec29[2] + (fRec29[0] + (2 * fRec29[1])))));
		...
		fRec38[0] = ((fConst99 * ((fConst105 * fVec8[1]) + (fConst13 * fVec8[0]))) + (fConst18 * fRec38[1]));
		fRec37[0] = (fRec38[0] - (fConst16 * ((fConst14 * fRec37[2]) + (fConst12 * fRec37[1]))));
		fRec36[0] = ((fConst16 * (((fConst11 * fRec37[0]) + (fConst106 * fRec37[1])) + (fConst11 * fRec37[2]))) - (fConst104 * ((fConst103 * fRec36[2]) + fTemp14)));
		...
		fRec47[0] = ((fConst98 * ((fConst109 * fVec7[1]) + (fConst22 * fVec7[0]))) + (fConst27 * fRec47[1]));
		fRec46[0] = (fRec47[0] - (fConst25 * ((fConst23 * fRec46[2]) + (fConst21 * fRec46[1]))));
		fRec45[0] = ((fConst25 * (((fConst20 * fRec46[0]) + (fConst110 * fRec46[1])) + (fConst20 * fRec46[2]))) - (fConst108 * ((fConst107 * fRec45[2]) + fTemp18)));
		...
		double fTemp23 = (fConst21 * fRec55[1]);
		fRec57[0] = ((fConst97 * ((fConst113 * fVec6[1]) + (fConst31 * fVec6[0]))) + (fConst36 * fRec57[1]));
		fRec56[0] = (fRec57[0] - (fConst34 * ((fConst32 * fRec56[2]) + (fConst30 * fRec56[1]))));
		fRec55[0] = ((fConst34 * (((fConst29 * fRec56[0]) + (fConst114 * fRec56[1])) + (fConst29 * fRec56[2]))) - (fConst112 * ((fConst111 * fRec55[2]) + fTemp23)));
		...
		double fTemp28 = (fConst21 * fRec65[1]);
		double fTemp29 = (fConst30 * fRec66[1]);
		fRec68[0] = ((fConst96 * ((fConst117 * fVec5[1]) + (fConst40 * fVec5[0]))) + (fConst45 * fRec68[1]));
		fRec67[0] = (fRec68[0] - (fConst43 * ((fConst41 * fRec67[2]) + (fConst39 * fRec67[1]))));
		fRec66[0] = ((fConst43 * (((fConst38 * fRec67[0]) + (fConst118 * fRec67[1])) + (fConst38 * fRec67[2]))) - (fConst116 * ((fConst115 * fRec66[2]) + fTemp29)));
		...
		double fTemp34 = (fConst21 * fRec76[1]);
		double fTemp35 = (fConst30 * fRec77[1]);
		double fTemp36 = (fConst39 * fRec78[1]);
		fRec80[0] = ((fConst95 * ((fConst121 * fVec4[1]) + (fConst49 * fVec4[0]))) + (fConst54 * fRec80[1]));
		fRec79[0] = (fRec80[0] - (fConst52 * ((fConst50 * fRec79[2]) + (fConst48 * fRec79[1]))));
		fRec78[0] = ((fConst52 * (((fConst47 * fRec79[0]) + (fConst122 * fRec79[1])) + (fConst47 * fRec79[2]))) - (fConst120 * ((fConst119 * fRec78[2]) + fTemp36)));
		...
		double fTemp41 = (fConst21 * fRec88[1]);
		double fTemp42 = (fConst30 * fRec89[1]);
		double fTemp43 = (fConst39 * fRec90[1]);
		double fTemp44 = (fConst48 * fRec91[1]);
		fRec93[0] = ((fConst94 * ((fConst125 * fVec3[1]) + (fConst58 * fVec3[0]))) + (fConst63 * fRec93[1]));
		fRec92[0] = (fRec93[0] - (fConst61 * ((fConst59 * fRec92[2]) + (fConst57 * fRec92[1]))));
		fRec91[0] = ((fConst61 * (((fConst56 * fRec92[0]) + (fConst126 * fRec92[1])) + (fConst56 * fRec92[2]))) - (fConst124 * ((fConst123 * fRec91[2]) + fTemp44)));
		...
		double fTemp49 = (fConst21 * fRec101[1]);
		double fTemp50 = (fConst30 * fRec102[1]);
		double fTemp51 = (fConst39 * fRec103[1]);
		double fTemp52 = (fConst48 * fRec104[1]);
		double fTemp53 = (fConst57 * fRec105[1]);
		fRec107[0] = ((fConst93 * ((fConst129 * fVec2[1]) + (fConst67 * fVec2[0]))) + (fConst72 * fRec107[1]));
		fRec106[0] = (fRec107[0] - (fConst70 * ((fConst68 * fRec106[2]) + (fConst66 * fRec106[1]))));
		fRec105[0] = ((fConst70 * (((fConst65 * fRec106[0]) + (fConst130 * fRec106[1])) + (fConst65 * fRec106[2]))) - (fConst128 * ((fConst127 * fRec105[2]) + fTemp53)));
		...
		double fTemp58 = (fConst21 * fRec115[1]);
		double fTemp59 = (fConst30 * fRec116[1]);
		double fTemp60 = (fConst39 * fRec117[1]);
		double fTemp61 = (fConst48 * fRec118[1]);
		double fTemp62 = (fConst57 * fRec119[1]);
		double fTemp63 = (fConst66 * fRec120[1]);
		fRec122[0] = ((fConst92 * ((fConst133 * fVec1[1]) + (fConst76 * fVec1[0]))) + (fConst81 * fRec122[1]));
		fRec121[0] = (fRec122[0] - (fConst79 * ((fConst77 * fRec121[2]) + (fConst75 * fRec121[1]))));
		fRec120[0] = ((fConst79 * (((fConst74 * fRec121[0]) + (fConst134 * fRec121[1])) + (fConst74 * fRec121[2]))) - (fConst132 * ((fConst131 * fRec120[2]) + fTemp63)));
		...
		double fTemp68 = (fConst21 * fRec130[1]);
		double fTemp69 = (fConst30 * fRec131[1]);
		double fTemp70 = (fConst39 * fRec132[1]);
		double fTemp71 = (fConst48 * fRec133[1]);
		double fTemp72 = (fConst57 * fRec134[1]);
		double fTemp73 = (fConst66 * fRec135[1]);
		double fTemp74 = (fConst75 * fRec136[1]);
		fRec138[0] = ((fConst91 * ((fConst137 * fVec0[1]) + (fConst85 * fVec0[0]))) + (fConst90 * fRec138[1]));
		fRec137[0] = (fRec138[0] - (fConst88 * ((fConst86 * fRec137[2]) + (fConst84 * fRec137[1]))));
		fRec136[0] = ((fConst88 * (((fConst83 * fRec137[0]) + (fConst138 * fRec137[1])) + (fConst83 * fRec137[2]))) - (fConst136 * ((fConst135 * fRec136[2]) + fTemp74)));
...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerNonMidiFloatVar("graphiceq.v2",&fbargraph0, false, true, -70.0, -70.0, 4.0, 0.00001);
