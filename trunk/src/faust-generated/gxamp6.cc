...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp1 = (0.050000000000000003 * (fRec20[0] * fRec44[0]));
		...
		double fTemp24 = ((fRec12[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp22)))) + ((fTemp23 * ((1.25 * (fRec48[0] * ((0.20000000000000001 * (1.0 - std::fabs((0.050000000000000003 * fTemp23)))) + -0.050000000000000003))) + 0.050000000000000003)) + (0.024937655860349125 * (fTemp10 * (1.0 - std::max<double>(0.0, fTemp22))))));
		fVec6[0] = fTemp24;
