...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec23[0] = 0.05 * (fConst8 * fRec24[0] + fConst9 * fRec24[1]) - fConst4 * fRec23[1];
		fRec28[0] = fConst12 * (fConst11 * fRec28[1] + 0.05 * (fRec24[0] - fRec24[1]));
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec36[1]) + 1e+05);
		fVec1[0] = fTemp9;
		fRec39[0] = fConst15 * (1.5e+03 * (fTemp9 + fVec1[1]) - fConst14 * fRec39[1]);
		fRec36[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp8 + fRec39[0] + fTemp7 + -1.271609) + -45.22606666666667;
		fRec35[0] = 0.05 * (fConst8 * fRec36[0] + fConst9 * fRec36[1]) - fConst4 * fRec35[1];
		fRec40[0] = fConst12 * (fConst11 * fRec40[1] + 0.05 * (fRec36[0] - fRec36[1]));
		...
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_6DJ8_68k, fRec42[1]) + 1e+05);
		fVec3[0] = fTemp13;
		fRec46[0] = fConst18 * (2.7e+03 * (fTemp13 + fVec3[1]) - fConst17 * fRec46[1]);
		fRec42[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp12 + fRec46[0] + fTemp11 + -1.863946) + -60.96496296296296;
		fRec41[0] = 0.05 * (fConst8 * fRec42[0] + fConst9 * fRec42[1]) - fConst4 * fRec41[1];
		fRec47[0] = fConst12 * (fConst11 * fRec47[1] + 0.05 * (fRec42[0] - fRec42[1]));
		...
		double fTemp16 = (fTemp14 + fTemp15) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec30[1]) + 1e+05);
		fVec4[0] = fTemp16;
		fRec48[0] = fConst15 * (1.5e+03 * (fTemp16 + fVec4[1]) - fConst14 * fRec48[1]);
		fRec30[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp15 + fRec48[0] + fTemp14 + -1.271609) + -45.22606666666667;
		fRec29[0] = 0.05 * (fConst8 * fRec30[0] + fConst9 * fRec30[1]) - fConst4 * fRec29[1];
		fRec49[0] = fConst12 * (fConst11 * fRec49[1] + 0.05 * (fRec30[0] - fRec30[1]));
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec19[1]) + 1e+05);
		fVec5[0] = fTemp19;
		fRec50[0] = fConst7 * (8.2e+02 * (fTemp19 + fVec5[1]) - fConst6 * fRec50[1]);
		fRec19[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp18 + fRec50[0] + fTemp17 + -0.797043) + -32.799634146341475;
		fRec18[0] = 0.05 * (fConst8 * fRec19[0] + fConst9 * fRec19[1]) - fConst4 * fRec18[1];
		fRec51[0] = fConst12 * (fConst11 * fRec51[1] + 0.05 * (fRec19[0] - fRec19[1]));
