...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst103 = (0.025 / fConst24);
	fConst104 = (2148.983059849188 * fConst18);
	fConst105 = (1 + ((fConst20 - fConst104) / fConst16));
	fConst106 = (1 + ((fConst104 + fConst20) / fConst16));
	fConst107 = (3491.150146031474 * fConst11);
	fConst108 = (1 + ((fConst13 - fConst107) / fConst9));
	fConst109 = (1 + ((fConst107 + fConst13) / fConst9));
	fConst110 = (829.9725931944553 * fConst4);
	fConst111 = (1 + ((fConst6 - fConst110) / fConst1));
	fConst112 = (1 + ((fConst110 + fConst6) / fConst1));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec23[0] + (fConst34 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fRec25[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec26[0] + fRec15[1]) - 1.271609)) - 45.22606666666667);
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec27[0] + fRec14[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec29[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec30[0] + fRec11[1]) - 0.797043)) - 32.799634146341475);
		...
		fRec10[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec31[0] + fRec11[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec3[0] = ((fConst103 * ((fConst44 * fRec4[1]) + (fConst23 * fRec4[0]))) + (fConst25 * fRec3[1]));
		...
		fRec53[0] = ((fConst103 * ((fConst44 * fRec54[1]) + (fConst23 * fRec54[0]))) + (fConst25 * fRec53[1]));
		fRec2[0] = ((min(0.7, fRec53[0]) + max(-0.75, fRec3[0])) - (fConst22 * ((fConst21 * fRec2[2]) + fTemp2)));
		fRec1[0] = ((fConst22 * ((fTemp2 + (fConst106 * fRec2[0])) + (fConst105 * fRec2[2]))) - (fConst15 * ((fConst14 * fRec1[2]) + fTemp1)));
		fRec0[0] = ((fConst15 * ((fTemp1 + (fConst109 * fRec1[0])) + (fConst108 * fRec1[2]))) - (fConst8 * ((fConst7 * fRec0[2]) + fTemp0)));
		output0[i] = (FAUSTFLOAT)(fConst8 * ((fTemp0 + (fConst112 * fRec0[0])) + (fConst111 * fRec0[2])));
		// post processing
