...
static void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec23[0] + (fConst23 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fRec42[0] = ((0.024937655860349125 * fTemp14) - (fConst75 * ((fConst73 * fRec42[2]) + (fConst71 * fRec42[1]))));
		double fTemp16 = (fRec42[2] + (fRec42[0] + (2 * fRec42[1])));
		fVec2[0] = fTemp16;
		fRec41[0] = ((fConst76 * ((fConst33 * fVec2[1]) + (fConst12 * fVec2[0]))) + (fConst14 * fRec41[1]));
		...
		fVec3[0] = fTemp17;
		fRec38[0] = ((fConst79 * ((fConst78 * fVec3[1]) + (fConst55 * fVec3[0]))) + (fConst60 * fRec38[1]));
		fRec37[0] = (fRec38[0] - (fConst58 * ((fConst56 * fRec37[2]) + (fConst54 * fRec37[1]))));
		fRec36[0] = ((fConst58 * (((fConst53 * fRec37[0]) + (fConst80 * fRec37[1])) + (fConst53 * fRec37[2]))) - (fConst51 * ((fConst50 * fRec36[2]) + fTemp15)));
		double fTemp18 = max(-1, min(1, (fSlow7 * (fRec36[2] + (fConst51 * (fTemp15 + (fConst50 * fRec36[0])))))));
		fRec46[0] = ((fConst79 * (fVec3[0] + fVec3[1])) + (fConst60 * fRec46[1]));
		fRec45[0] = (fRec46[0] - (fConst58 * ((fConst56 * fRec45[2]) + (fConst54 * fRec45[1]))));
		double fTemp19 = (fRec45[2] + (fRec45[0] + (2 * fRec45[1])));
		fVec4[0] = fTemp19;
		fRec44[0] = ((fConst86 * ((fConst85 * fVec4[1]) + (fConst49 * fVec4[0]))) + (fConst84 * fRec44[1]));
		fRec43[0] = (fRec44[0] - (fConst82 * ((fConst81 * fRec43[2]) + (fConst48 * fRec43[1]))));
		double fTemp20 = max(-1, min(1, (fSlow8 * (((fConst47 * fRec43[0]) + (fConst87 * fRec43[1])) + (fConst47 * fRec43[2])))));
		double fTemp21 = (fConst48 * fRec47[1]);
		double fTemp22 = (fConst54 * fRec48[1]);
		...
		fRec48[0] = ((fConst67 * (((fConst62 * fRec49[0]) + (fConst91 * fRec49[1])) + (fConst62 * fRec49[2]))) - (fConst89 * ((fConst88 * fRec48[2]) + fTemp22)));
		fRec47[0] = ((fRec48[2] + (fConst89 * (fTemp22 + (fConst88 * fRec48[0])))) - (fConst51 * ((fConst50 * fRec47[2]) + fTemp21)));
		double fTemp23 = max(-1, min(1, (fSlow9 * (fRec47[2] + (fConst51 * (fTemp21 + (fConst50 * fRec47[0])))))));
		fRec52[0] = ((fConst86 * (fVec4[0] + fVec4[1])) + (fConst84 * fRec52[1]));
		...
		fVec5[0] = fTemp25;
		fRec35[0] = ((fConst39 * (fVec5[0] + fVec5[1])) + (fConst17 * fRec35[1]));
		...
		fRec3[0] = ((fConst92 * ((fConst33 * fRec4[1]) + (fConst12 * fRec4[0]))) + (fConst14 * fRec3[1]));
		...
		fRec53[0] = ((fConst92 * ((fConst33 * fRec54[1]) + (fConst12 * fRec54[0]))) + (fConst14 * fRec53[1]));
...
PluginDef plugin = {
    PLUGINDEF_VERSION,
    0,   // flags
    "pre 6DJ8/ push-pull 6V6",  // id
    N_("pre 6DJ8/ push-pull 6V6"),  // name
    0,  // groups
    compute,  // mono_audio
    0,  // stereo_audio
    init,  // set_samplerate
