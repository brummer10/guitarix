...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec25[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec31[0] + (fConst9 * (fRec30[0] * (fRec26[2] + (fRec26[0] + (2 * fRec26[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fRec33[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec34[0] + fRec23[1]) - 1.271609)) - 45.22606666666667);
		...
		fRec21[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec35[0] + fRec22[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec37[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec38[0] + fRec19[1]) - 0.797043)) - 32.799634146341475);
		...
		fRec18[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec39[0] + fRec19[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec58[0] = ((fConst23 * fRec58[1]) + (fConst81 * ((fConst19 * fRec59[0]) + (fConst20 * fRec59[1]))));
