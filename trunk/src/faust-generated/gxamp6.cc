...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec22[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec28[0] + (fConst12 * (fRec27[0] * (fRec23[2] + (fRec23[0] + (2 * fRec23[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fRec30[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec31[0] + fRec20[1]) - 1.271609)) - 45.22606666666667);
		...
		fRec18[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec32[0] + fRec19[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec34[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec35[0] + fRec16[1]) - 0.797043)) - 32.799634146341475);
		...
		fRec15[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec36[0] + fRec16[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec8[0] = ((fConst81 * ((fConst22 * fRec9[1]) + (fConst1 * fRec9[0]))) + (fConst3 * fRec8[1]));
		...
		fRec58[0] = ((fConst81 * ((fConst22 * fRec59[1]) + (fConst1 * fRec59[0]))) + (fConst3 * fRec58[1]));
