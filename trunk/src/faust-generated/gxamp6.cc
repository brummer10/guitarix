...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst44 = (1 + ((fConst43 - 1.0000000000000004) / fConst42));
	fConst45 = (1.0 / faustpower<2>(fConst42));
	fConst46 = (2 * (1 - fConst45));
	fConst47 = (1 + ((1.0000000000000004 + fConst43) / fConst42));
	...
	fConst68 = (0 - ((1 - fConst43) / fConst66));
	fConst69 = (1 + fConst39);
	...
	fConst74 = (0 - fConst43);
	fConst75 = (2 * (0 - fConst45));
	fConst76 = (1 + ((fConst43 - 1.0) / fConst42));
	fConst77 = (1.0 / (1 + ((1.0 + fConst43) / fConst42)));
	fConst78 = (0 - fConst52);
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec54[0] = (fRec55[0] - (fConst48 * ((fConst46 * fRec54[1]) + (fConst44 * fRec54[2]))));
		...
		fRec62[0] = ((fConst68 * fRec62[1]) + (fConst67 * ((fConst43 * fVec4[0]) + (fConst74 * fVec4[1]))));
		fRec61[0] = (fRec62[0] - (fConst48 * ((fConst44 * fRec61[2]) + (fConst46 * fRec61[1]))));
		fRec60[0] = ((fConst48 * (((fConst45 * fRec61[0]) + (fConst75 * fRec61[1])) + (fConst45 * fRec61[2]))) - (fConst73 * ((fConst72 * fRec60[2]) + fTemp23)));
		...
		double fTemp26 = (fConst46 * fRec64[1]);
