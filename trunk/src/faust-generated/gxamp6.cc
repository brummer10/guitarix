...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst93 = (0.025 / fConst14);
	fConst94 = (0 - fConst10);
	fConst95 = (1.0 / (1 + fConst11));
	fConst96 = (0 - fConst6);
	fConst97 = (1.0 / (1 + fConst7));
	fConst98 = (0 - fConst2);
	fConst99 = (1.0 / (1 + fConst3));
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec23[0] + (fConst24 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.863946)) - 60.96496296296296);
		...
		fVec7[0] = fTemp28;
		fRec2[0] = (fConst95 * ((fVec7[2] + (fVec7[0] + (fConst94 * fVec7[1]))) + ((fConst12 * fRec2[2]) + (fConst10 * fRec2[1]))));
		fRec1[0] = (fConst97 * ((fRec2[2] + (fRec2[0] + (fConst96 * fRec2[1]))) + ((fConst8 * fRec1[2]) + (fConst6 * fRec1[1]))));
		fRec0[0] = (fConst99 * ((fRec1[2] + (fRec1[0] + (fConst98 * fRec1[1]))) + ((fConst4 * fRec0[2]) + (fConst2 * fRec0[1]))));
