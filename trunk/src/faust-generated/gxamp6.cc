...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fVec0[0] = fTemp7;
		fRec37[0] = (fConst14 * ((fVec0[0] - fVec0[1]) + (fConst13 * fRec37[1])));
		fRec36[0] = (fConst14 * ((fRec37[0] - fRec37[1]) + (fConst13 * fRec36[1])));
		fRec35[0] = (fRec36[0] - (fConst11 * ((fConst10 * fRec35[2]) + (fConst6 * fRec35[1]))));
		fRec34[0] = ((fConst11 * (fRec35[2] + (fRec35[0] + (2 * fRec35[1])))) - (fConst9 * ((fConst8 * fRec34[2]) + (fConst6 * fRec34[1]))));
		fRec38[0] = ((0.999 * fRec38[1]) + fSlow2);
		fRec33[0] = ((fConst9 * (fRec38[0] * (fRec34[2] + (fRec34[0] + (2 * fRec34[1]))))) - (fTemp6 + fRec33[2]));
		double fTemp8 = (fRec33[2] + (fRec33[0] + fTemp6));
		fVec1[0] = fTemp8;
		fRec32[0] = ((1.0000000000000002 * (fVec1[0] + fVec1[1])) - (0.9999999999999998 * fRec32[1]));
		fRec39[0] = ((fConst18 * fRec39[1]) + (fConst17 * (fRec31[1] + fRec31[2])));
		fRec31[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec39[0] + fRec32[0]) - 1.863946)) - 60.96496296296296);
		fRec30[0] = ((fConst23 * fRec30[1]) + (fConst22 * ((fConst19 * fRec31[0]) + (fConst20 * fRec31[1]))));
		...
		fRec44[0] = ((fConst27 * fRec44[1]) + (fConst26 * (fRec41[1] + fRec41[2])));
		fRec41[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec44[0] + fRec42[0]) - 1.271609)) - 45.22606666666667);
		fRec40[0] = ((fConst23 * fRec40[1]) + (fConst22 * ((fConst19 * fRec41[0]) + (fConst20 * fRec41[1]))));
		fRec29[0] = ((0.6 * fRec40[0]) + fRec30[0]);
		fRec28[0] = ((fConst4 * fRec28[1]) + (fConst28 * (fRec29[0] + fRec29[1])));
		...
		fRec45[0] = ((fConst27 * fRec45[1]) + (fConst26 * (fRec25[1] + fRec25[2])));
		fRec25[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec45[0] + fRec26[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec50[0] = ((fConst32 * fRec50[1]) + (fConst31 * (fRec47[1] + fRec47[2])));
		fRec47[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec50[0] + fRec48[0]) - 0.797043)) - 32.799634146341475);
		fRec46[0] = ((fConst23 * fRec46[1]) + (fConst22 * ((fConst19 * fRec47[0]) + (fConst20 * fRec47[1]))));
		...
		fRec51[0] = ((fConst32 * fRec51[1]) + (fConst31 * (fRec20[1] + fRec20[2])));
		fRec20[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec51[0] + fRec21[0]) - 0.797043)) - 32.799634146341475);
		fRec19[0] = ((fConst23 * fRec19[1]) + (fConst22 * ((fConst19 * fRec20[0]) + (fConst20 * fRec20[1]))));
		...
		fRec16[0] = ((fVec6[IOTA&32767] + fRec16[1]) - fVec6[(IOTA-iConst33)&32767]);
		fRec15[0] = ((0.999 * fRec15[1]) + (fConst34 * fRec16[0]));
		...
		fRec60[0] = ((0.024937655860349125 * fTemp27) - (fConst60 * ((fConst58 * fRec60[2]) + (fConst56 * fRec60[1]))));
		double fTemp29 = (fRec60[2] + (fRec60[0] + (2 * fRec60[1])));
		fVec7[0] = fTemp29;
		fRec59[0] = ((fConst23 * fRec59[1]) + (fConst61 * ((fConst19 * fVec7[0]) + (fConst20 * fVec7[1]))));
		fRec58[0] = ((fConst64 * fRec58[1]) + (fConst63 * (fRec59[0] + fRec59[1])));
		fRec57[0] = (fRec58[0] - (fConst54 * ((fConst52 * fRec57[2]) + (fConst50 * fRec57[1]))));
		double fTemp30 = (fRec57[2] + (fRec57[0] + (2 * fRec57[1])));
		fVec8[0] = fTemp30;
		fRec56[0] = ((fConst67 * fRec56[1]) + (fConst66 * (fVec8[0] + fVec8[1])));
		fRec55[0] = (fRec56[0] - (fConst47 * ((fConst45 * fRec55[2]) + (fConst43 * fRec55[1]))));
		double fTemp31 = (fRec55[2] + (fRec55[0] + (2 * fRec55[1])));
		fVec9[0] = fTemp31;
		fRec54[0] = ((fConst70 * fRec54[1]) + (fConst69 * (fVec9[0] + fVec9[1])));
		fRec53[0] = (fRec54[0] - (fConst40 * ((fConst39 * fRec53[2]) + (fConst37 * fRec53[1]))));
		double fTemp32 = max((double)-1, min((double)1, (fSlow7 * (fRec53[2] + (fRec53[0] + (2 * fRec53[1]))))));
		double fTemp33 = (fConst37 * fRec61[1]);
		fRec63[0] = ((fConst67 * fRec63[1]) + (fConst66 * ((fConst44 * fVec8[0]) + (fConst73 * fVec8[1]))));
		fRec62[0] = (fRec63[0] - (fConst47 * ((fConst45 * fRec62[2]) + (fConst43 * fRec62[1]))));
		fRec61[0] = ((fConst47 * (((fConst42 * fRec62[0]) + (fConst74 * fRec62[1])) + (fConst42 * fRec62[2]))) - (fConst72 * ((fConst71 * fRec61[2]) + fTemp33)));
		double fTemp34 = max((double)-1, min((double)1, (fSlow8 * (fRec61[2] + (fConst72 * (fTemp33 + (fConst71 * fRec61[0])))))));
		double fTemp35 = (fConst37 * fRec64[1]);
		double fTemp36 = (fConst43 * fRec65[1]);
		fRec67[0] = ((fConst64 * fRec67[1]) + (fConst63 * ((fConst51 * fRec59[0]) + (fConst77 * fRec59[1]))));
		fRec66[0] = (fRec67[0] - (fConst54 * ((fConst52 * fRec66[2]) + (fConst50 * fRec66[1]))));
		fRec65[0] = ((fConst54 * (((fConst49 * fRec66[0]) + (fConst78 * fRec66[1])) + (fConst49 * fRec66[2]))) - (fConst76 * ((fConst75 * fRec65[2]) + fTemp36)));
		fRec64[0] = ((fRec65[2] + (fConst76 * (fTemp36 + (fConst75 * fRec65[0])))) - (fConst72 * ((fConst71 * fRec64[2]) + fTemp35)));
		double fTemp37 = max((double)-1, min((double)1, (fSlow9 * (fRec64[2] + (fConst72 * (fTemp35 + (fConst71 * fRec64[0])))))));
		fRec69[0] = ((fConst70 * fRec69[1]) + (fConst69 * ((fConst38 * fVec9[0]) + (fConst79 * fVec9[1]))));
		fRec68[0] = (fRec69[0] - (fConst40 * ((fConst39 * fRec68[2]) + (fConst37 * fRec68[1]))));
		double fTemp38 = max((double)-1, min((double)1, (fSlow10 * (((fConst36 * fRec68[0]) + (fConst80 * fRec68[1])) + (fConst36 * fRec68[2])))));
		...
		fVec10[0] = fTemp39;
		fRec52[0] = ((fConst4 * fRec52[1]) + (fConst28 * (fVec10[0] + fVec10[1])));
		double fTemp40 = ((fSlow11 * fRec52[0]) + ((fTemp28 * (1 + (fSlow6 * ((4 - (4 * fabs(fTemp28))) - 1)))) + (fSlow5 * fTemp27)));
		fVec11[0] = fTemp40;
		fRec14[0] = ((fConst4 * fRec14[1]) + (fConst28 * (fVec11[0] + fVec11[1])));
		...
		fRec8[0] = ((fConst23 * fRec8[1]) + (fConst81 * ((fConst19 * fRec9[0]) + (fConst20 * fRec9[1]))));
		...
		fRec70[0] = ((fConst23 * fRec70[1]) + (fConst81 * ((fConst19 * fRec71[0]) + (fConst20 * fRec71[1]))));
