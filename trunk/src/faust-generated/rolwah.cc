...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst4 = 1.0 - fConst3;
	fConst5 = 1.0 - fConst2;
	double fConst6 = 1.00220281601996e-19 * fConst0;
	fConst7 = mydsp_faustpower2_f(fConst0);
	fConst8 = fConst7 * (fConst0 * (-1.70950590451549e-17 - fConst6) + -1.90549124429613e-13);
	double fConst9 = 4.01507415376654e-19 * fConst0;
	fConst10 = fConst0 * (fConst0 * (fConst0 * (fConst9 + 3.69834165265026e-17) + 1.74041670594569e-13) + 2.88710794590323e-12);
	double fConst11 = 1.17381624550525e-20 * fConst0;
	fConst12 = fConst0 * (fConst0 * (fConst0 * (fConst11 + 1.80001288492797e-17) + 5.87277230952925e-13) + 1.11753192188666e-11);
	double fConst13 = 1.67423892093516e-21 * fConst0;
	fConst14 = fConst7 * (fConst0 * (fConst13 + -2.84356697701846e-17) + 4.21808310223676e-14);
	double fConst15 = 1.67086003986576e-21 * fConst0;
	fConst16 = fConst0 * (fConst0 * (fConst0 * (2.84459385679371e-17 - fConst15) + -4.25288501077712e-14) + 5.40786717438269e-13);
	double fConst17 = 2.25167399879093e-21 * fConst0;
	fConst18 = fConst0 * (fConst0 * (fConst0 * (7.2000883805872e-17 - fConst17) + -1.122655366476e-13) + 6.39103500338903e-13);
	fConst19 = fConst7 * (fConst0 * (1.70950590451549e-17 - fConst6) + -1.90549124429613e-13);
	fConst20 = fConst0 * (fConst0 * (fConst0 * (fConst9 + -3.69834165265026e-17) + 1.74041670594569e-13) + -2.88710794590323e-12);
	fConst21 = fConst0 * (fConst0 * (fConst0 * (fConst11 + -1.80001288492797e-17) + 5.87277230952925e-13) + -1.11753192188666e-11);
	double fConst22 = 4.00881126407982e-19 * fConst0;
	double fConst23 = mydsp_faustpower3_f(fConst0);
	fConst24 = fConst23 * (fConst22 + -3.41901180903099e-17);
	double fConst25 = 1.60602966150662e-18 * fConst0;
	fConst26 = fConst0 * (fConst7 * (7.39668330530053e-17 - fConst25) + -5.77421589180647e-12);
	double fConst27 = 4.69526498202101e-20 * fConst0;
	...
	fConst32 = fConst23 * (fConst22 + 3.41901180903099e-17);
	...
	double fConst35 = 561.1941267851723 / fConst0;
	double fConst36 = fConst35 + 1.0;
	fConst37 = 0.01 / fConst36;
	fConst38 = 1.0 - fConst35;
	fConst39 = 1.0 / fConst36;
	double fConst40 = 6.69695568374064e-21 * fConst0;
	fConst41 = fConst23 * (5.68713395403691e-17 - fConst40);
	double fConst42 = 6.68344015946305e-21 * fConst0;
	fConst43 = fConst0 * (fConst7 * (fConst42 + -5.68918771358741e-17) + 1.08157343487654e-12);
	double fConst44 = 9.00669599516373e-21 * fConst0;
	fConst45 = fConst0 * (fConst7 * (fConst44 + -1.44001767611744e-16) + 1.27820700067781e-12);
	fConst46 = 1.0045433525611e-20 * fConst7 + -8.43616620447352e-14;
	fConst47 = 8.50577002155424e-14 - 1.00251602391946e-20 * fConst7;
	fConst48 = 2.245310732952e-13 - 1.35100439927456e-20 * fConst7;
	fConst49 = fConst23 * (-5.68713395403691e-17 - fConst40);
	fConst50 = fConst0 * (fConst7 * (fConst42 + 5.68918771358741e-17) + -1.08157343487654e-12);
	fConst51 = fConst0 * (fConst7 * (fConst44 + 1.44001767611744e-16) + -1.27820700067781e-12);
	fConst52 = fConst7 * (fConst0 * (fConst13 + 2.84356697701846e-17) + 4.21808310223676e-14);
	fConst53 = fConst0 * (fConst0 * (fConst0 * (-2.84459385679371e-17 - fConst15) + -4.25288501077712e-14) + -5.40786717438269e-13);
	fConst54 = fConst0 * (fConst0 * (fConst0 * (-7.2000883805872e-17 - fConst17) + -1.122655366476e-13) + -6.39103500338903e-13);
	clear_state_f();
}
...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec7[0] = fRec8[0] - (fRec7[1] * (fConst34 + fTemp2 * (fConst33 + fConst32 * fTemp2) + 1.7497623914565e-10) + fRec7[2] * (fConst7 * (fConst31 + fTemp2 * (fConst30 + fConst29 * fTemp2)) + 2.62464358718476e-10) + fRec7[3] * (fConst28 + fTemp2 * (fConst26 + fConst24 * fTemp2) + 1.7497623914565e-10) + fRec7[4] * (fConst21 + fTemp2 * (fConst20 + fConst19 * fTemp2) + 4.37440597864126e-11)) / fTemp3;
