...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst1 = 561.19412678517233 / fConst0;
	double fConst2 = fConst1 + 1.0;
	fConst3 = 1.0 / fConst2;
	fConst4 = 1.0 - fConst1;
	fConst5 = 0.01 / fConst2;
	fConst6 = mydsp_faustpower2_f(fConst0);
	double fConst7 = 4.6952649820210102e-20 * fConst0;
	...
	double fConst14 = 1.6060296615066201e-18 * fConst0;
	fConst15 = fConst6 * (-7.39668330530053e-17 - fConst14) + 5.7742158918064703e-12;
	double fConst16 = 4.0088112640798199e-19 * fConst0;
