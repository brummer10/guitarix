...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec31[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec39[0] + fRec32[0]) - 1.581656)) - 191.42014814814814);
		...
		fRec41[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec44[0] + fRec42[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec25[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec45[0] + fRec26[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec47[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec50[0] + fRec48[0]) - 0.840703)) - 147.47524390243905);
		...
		fRec20[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec51[0] + fRec21[0]) - 0.840703)) - 147.47524390243905);
		...
		fRec70[0] = ((fConst23 * fRec70[1]) + (fConst22 * ((fConst19 * fRec71[0]) + (fConst20 * fRec71[1]))));
