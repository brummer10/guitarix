...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec27[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec33[0] + (fConst14 * (fRec32[0] * (fRec28[2] + (fRec28[0] + (2 * fRec28[1])))))) - 1.581656)) - 191.42014814814814);
		...
		fRec35[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec36[0] + fRec25[1]) - 1.204285)) - 169.71433333333334);
		...
		fRec23[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec37[0] + fRec24[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec39[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec40[0] + fRec21[1]) - 0.840703)) - 147.47524390243905);
		...
		fRec20[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec41[0] + fRec21[0]) - 0.840703)) - 147.47524390243905);
		...
		fRec10[0] = ((fConst28 * fRec10[1]) + (fConst27 * ((fConst24 * fRec11[0]) + (fConst25 * fRec11[1]))));
		...
		fRec60[0] = ((fConst28 * fRec60[1]) + (fConst27 * ((fConst24 * fRec61[0]) + (fConst25 * fRec61[1]))));
		...
		fVec7[0] = fTemp33;
		fRec1[0] = ((fConst88 * fRec1[1]) + (fConst87 * (fVec7[0] + fVec7[1])));
