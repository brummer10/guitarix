...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec15[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec21[0] + (fConst17 * (fRec20[0] * (fRec16[2] + (fRec16[0] + (2 * fRec16[1])))))) - 1.581656)) - 191.42014814814814);
		...
		fRec23[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec24[0] + fRec13[1]) - 1.204285)) - 169.71433333333334);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec25[0] + fRec12[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec27[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec28[0] + fRec9[1]) - 0.840703)) - 147.47524390243905);
		...
		fRec8[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec29[0] + fRec9[0]) - 0.840703)) - 147.47524390243905);
		...
		double fTemp29 = (fRec54[1] + (fConst87 * fRec54[2]));
		fRec54[0] = (fConst90 * (fConst89 - fTemp29));
		double fTemp30 = (fRec55[1] + (fConst92 * fRec55[2]));
		fRec55[0] = (fConst95 * (fConst94 - fTemp30));
		output0[i] = (FAUSTFLOAT)((fConst95 * fTemp30) + (fRec55[0] * ((fConst90 * fTemp29) + (fRec54[0] * (((min(0.7, fRec51[0]) + max(-0.75, fRec1[0])) * fRec0[0]) + (fConst5 * fTemp0))))));
		// post processing
