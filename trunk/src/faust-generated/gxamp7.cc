...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec22[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec28[0] + (fConst12 * (fRec27[0] * (fRec23[2] + (fRec23[0] + (2 * fRec23[1])))))) - 1.581656)) - 191.42014814814814);
		...
		fRec30[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec31[0] + fRec20[1]) - 1.204285)) - 169.71433333333334);
		...
		fRec18[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec32[0] + fRec19[0]) - 1.204285)) - 169.71433333333334);
		...
		fRec34[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec35[0] + fRec16[1]) - 0.840703)) - 147.47524390243905);
		...
		fRec15[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec36[0] + fRec16[0]) - 0.840703)) - 147.47524390243905);
