...
static void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec17[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec23[0] + (fConst23 * (fRec22[0] * (fRec18[2] + (fRec18[0] + (2 * fRec18[1])))))) - 1.581656)) - 191.42014814814814);
		...
		fVec7[0] = fTemp28;
		fRec2[0] = (fConst93 * ((fVec7[2] + (fVec7[0] + (fConst92 * fVec7[1]))) + ((fConst11 * fRec2[2]) + (fConst9 * fRec2[1]))));
...
PluginDef plugin = {
    PLUGINDEF_VERSION,
    0,   // flags
    "pre 12ax7/ push-pull 6V6",  // id
    N_("pre 12ax7/ push-pull 6V6"),  // name
    0,  // groups
    compute,  // mono_audio
    0,  // stereo_audio
    init,  // set_samplerate
