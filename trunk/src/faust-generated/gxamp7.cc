...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp10 = (fTemp8 + fTemp9) / (Ranode(TUBE_TABLE_12AX7_250k, fRec36[1]) + 1e+05);
		fVec1[0] = fTemp10;
		fRec39[0] = fConst14 * (1.5e+03 * (fTemp10 + fVec1[1]) - fConst13 * fRec39[1]);
		fRec36[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp9 + fRec39[0] + fTemp8 + -1.204285) + -169.71433333333334;
		...
		double fTemp15 = (fTemp13 + fTemp14) / (Ranode(TUBE_TABLE_12AX7_68k, fRec42[1]) + 1e+05);
		fVec3[0] = fTemp15;
		fRec46[0] = fConst17 * (2.7e+03 * (fTemp15 + fVec3[1]) - fConst16 * fRec46[1]);
		fRec42[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp14 + fRec46[0] + fTemp13 + -1.581656) + -191.42014814814814;
		...
		double fTemp19 = (fTemp17 + fTemp18) / (Ranode(TUBE_TABLE_12AX7_250k, fRec30[1]) + 1e+05);
		fVec4[0] = fTemp19;
		fRec48[0] = fConst14 * (1.5e+03 * (fTemp19 + fVec4[1]) - fConst13 * fRec48[1]);
		fRec30[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp18 + fRec48[0] + fTemp17 + -1.204285) + -169.71433333333334;
		...
		double fTemp23 = (fTemp21 + fTemp22) / (Ranode(TUBE_TABLE_12AX7_250k, fRec19[1]) + 1e+05);
		fVec5[0] = fTemp23;
		fRec50[0] = fConst6 * (8.2e+02 * (fTemp23 + fVec5[1]) - fConst5 * fRec50[1]);
		fRec19[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp22 + fRec50[0] + fTemp21 + -0.840703) + -147.47524390243905;
