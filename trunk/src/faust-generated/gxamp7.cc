...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp5 = ((fTemp4 + fTemp3) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec38[1]))) + 100000.0));
		fVec1[0] = fTemp5;
		fRec41[0] = (fConst31 * ((1500.0 * (fTemp5 + fVec1[1])) - (fConst32 * fRec41[1])));
		fRec38[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp3 + (fRec41[0] + fTemp4)) + -1.204285)))) + -169.71433333333334);
		...
		double fTemp9 = ((fTemp8 + fTemp7) / (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fRec43[1]))) + 100000.0));
		fVec3[0] = fTemp9;
		fRec47[0] = (fConst34 * ((2700.0 * (fTemp9 + fVec3[1])) - (fConst35 * fRec47[1])));
		fRec43[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp7 + (fRec47[0] + fTemp8)) + -1.581656)))) + -191.42014814814814);
		...
		double fTemp12 = ((fTemp11 + fTemp10) / (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fRec32[1]))) + 100000.0));
		fVec4[0] = fTemp12;
		fRec48[0] = (fConst31 * ((1500.0 * (fTemp12 + fVec4[1])) - (fConst32 * fRec48[1])));
		fRec32[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp10 + (fRec48[0] + fTemp11)) + -1.204285)))) + -169.71433333333334);
		...
		fRec22[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp13 + (fRec49[0] + fTemp14)) + -0.84070299999999998)))) + -147.47524390243905);
