...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (fConst2 * (fSlow2 - 1));
	double 	fSlow4 = (fConst3 * sqrt(fSlow2));
	double 	fSlow5 = (1 + fSlow2);
	double 	fSlow6 = (fSlow5 - (fSlow4 + fSlow3));
	double 	fSlow7 = (fConst2 * fSlow5);
	double 	fSlow8 = (2 * (0 - ((1 + fSlow7) - fSlow2)));
	...
	double 	fSlow45 = (fSlow2 * ((1 + (fSlow2 + fSlow3)) - fSlow4));
	double 	fSlow46 = (fSlow2 + fSlow4);
	double 	fSlow47 = (fSlow2 * (1 + (fSlow3 + fSlow46)));
	double 	fSlow48 = (((fSlow2 + fSlow7) - 1) * (0 - (2 * fSlow2)));
	double 	fSlow49 = (1.0 / ((1 + fSlow46) - fSlow3));
	for (int i=0; i<count; i++) {
		...
		fRec0[0] = (fSlow49 * ((((fSlow48 * fRec1[1]) + (fSlow47 * fRec1[0])) + (fSlow45 * fRec1[2])) + (0 - ((fSlow8 * fRec0[1]) + (fSlow6 * fRec0[2])))));
