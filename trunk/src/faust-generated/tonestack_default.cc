...
{
#undef fslider2
	fslider2_ = reg.registerVar("amp.tonestack.Bass",N_(""),"SA",N_(""),&fslider2, 0.5, 0.0, 1.0, 0.01);
#undef fslider1
	fslider1_ = reg.registerVar("amp.tonestack.Treble",N_(""),"SA",N_(""),&fslider1, 0.5, 0.0, 1.0, 0.01);
#undef fslider0
