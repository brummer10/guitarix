...
#define fVslider2 (*fVslider2_)
	...
	double fSlow5 = fSlow0 * ((4.4744000000000004e-05 * fSlow1 + -3.3821199999999999e-06) - fSlow4) + 0.00023358999999999999 * fSlow1 + 6.0817999999999999e-06;
	double fSlow6 = 9.2778000000000012e-09 * fSlow1 - 1.8555600000000002e-10 * fSlow0;
	double fSlow7 = 3.3135000000000005e-08 * fSlow1;
	double fSlow8 = fSlow0 * (fSlow6 + -4.7714400000000011e-10) + fSlow7 + 6.627000000000001e-10;
	...
	double fSlow13 = 1.4100000000000001e-06 * fSlow11 + fSlow0 * (1.0358800000000002e-06 - fSlow4) + fSlow1 * (4.4744000000000004e-05 * fSlow0 + 1.269e-05) + 2.5380000000000001e-07;
	double fSlow14 = fSlow0 * (fSlow6 + 1.8555600000000002e-10) + fSlow11 * (fSlow7 - 6.627000000000001e-10 * (fSlow0 + -1.0));
