...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (((fSlow1 * (((4.4744000000000004e-05 * fSlow0) - 3.38212e-06) - fSlow2)) + (0.00023359 * fSlow0)) + 6.0818e-06);
	double 	fSlow4 = (3.3135000000000005e-08 * fSlow0);
	double 	fSlow5 = ((9.277800000000001e-09 * fSlow0) - (1.8555600000000002e-10 * fSlow1));
	double 	fSlow6 = (6.627000000000001e-10 + ((fSlow1 * (fSlow5 - 4.771440000000001e-10)) + fSlow4));
	double 	fSlow7 = (fConst0 * fSlow6);
	double 	fSlow8 = (0.04760000000000001 * fSlow0);
	double 	fSlow9 = (0.0009400000000000001 * fSlow1);
	...
	double 	fSlow17 = ((((1.41e-06 * fSlow16) + (fSlow1 * (1.0358800000000002e-06 - fSlow2))) + (fSlow0 * (1.269e-05 + (4.4744000000000004e-05 * fSlow1)))) + 2.538e-07);
	double 	fSlow18 = ((fSlow1 * (1.8555600000000002e-10 + fSlow5)) + (fSlow16 * (fSlow4 + (6.627000000000001e-10 - (6.627000000000001e-10 * fSlow1)))));
	double 	fSlow19 = (fConst0 * fSlow18);
	double 	fSlow20 = ((fSlow8 + (fSlow9 + (0.00015 * fSlow16))) + 0.000952);
