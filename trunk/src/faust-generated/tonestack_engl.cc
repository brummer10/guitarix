...
#define fslider2 (*fslider2_)
	...
	double 	fSlow3 = (6.0818e-06 + ((0.00023359 * fSlow2) + (fSlow0 * (((4.4744000000000004e-05 * fSlow2) - 3.38212e-06) - fSlow1))));
	double 	fSlow4 = ((9.277800000000001e-09 * fSlow2) - (1.8555600000000002e-10 * fSlow0));
	double 	fSlow5 = (3.3135000000000005e-08 * fSlow2);
	double 	fSlow6 = (6.627000000000001e-10 + (fSlow5 + (fSlow0 * (fSlow4 - 4.771440000000001e-10))));
	double 	fSlow7 = (fConst0 * fSlow6);
	double 	fSlow8 = (0.0009400000000000001 * fSlow0);
	double 	fSlow9 = (0.04760000000000001 * fSlow2);
	double 	fSlow10 = (fConst0 * (0.010502000000000001 + (fSlow9 + fSlow8)));
	...
	double 	fSlow17 = ((fSlow0 * (1.8555600000000002e-10 + fSlow4)) + (fSlow16 * (fSlow5 + (6.627000000000001e-10 - (6.627000000000001e-10 * fSlow0)))));
	double 	fSlow18 = (fConst2 * fSlow17);
	double 	fSlow19 = (2.538e-07 + (((1.41e-06 * fSlow16) + (fSlow0 * (1.0358800000000002e-06 - fSlow1))) + (fSlow2 * (1.269e-05 + (4.4744000000000004e-05 * fSlow0)))));
	double 	fSlow20 = (0.000952 + (fSlow9 + (fSlow8 + (0.00015 * fSlow16))));
