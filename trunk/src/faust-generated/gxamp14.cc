...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec19[0]))) + (fRec29[0] + (fSlow9 * fRec10[0]))) - 2.617753)) - 153.04618518518518);
		fRec8[0] = ((fConst31 * fRec8[1]) + (fConst59 * ((fConst27 * fRec9[0]) + (fConst28 * fRec9[1]))));
		double fTemp13 = (fRec8[0] * fRec7[0]);
		fVec4[0] = fTemp13;
		fRec6[0] = ((fConst54 * fRec6[1]) + (fConst53 * (fVec4[0] + fVec4[1])));
		fRec30[0] = ((fConst63 * fRec30[1]) + (fConst62 * (fRec5[1] + fRec5[2])));
		...
		fVec5[0] = fTemp14;
		fRec3[0] = ((fConst54 * fRec3[1]) + (fConst53 * (fVec5[0] + fVec5[1])));
		fRec31[0] = ((fConst67 * fRec31[1]) + (fConst66 * (fRec2[1] + fRec2[2])));
