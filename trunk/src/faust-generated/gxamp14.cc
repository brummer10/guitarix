...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec6[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp21 + fRec37[0] + fTemp20 + -1.887332) + -124.17786666666666;
		...
		fRec1[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp26 + fRec39[0] + fTemp25 + -1.256962) + -96.7119512195122;
