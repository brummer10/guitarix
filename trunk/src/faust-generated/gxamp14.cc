...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec21[0]))) + (fRec31[0] + (fSlow9 * fRec12[0]))) - 2.617753)) - 153.04618518518518);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec32[0] + fRec8[0]) - 1.887332)) - 124.17786666666666);
		...
		fRec4[0] = (Ftube(TUBE_TABLE_12AT7_250k, ((fRec33[0] + fRec5[0]) - 1.256962)) - 96.7119512195122);
