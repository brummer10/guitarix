...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AT7_68k, (((fTemp2 * ((fSlow11 * fRec17[0]) + (fTemp12 * (1 + (fSlow10 * ((4 - (4 * fabs((fTemp2 * fTemp12)))) - 1)))))) + (fRec29[0] + (fSlow9 * fRec10[0]))) - 2.617753)) - 153.04618518518518);
