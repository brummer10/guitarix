...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -2.617753)))) + -153.04618518518518);
		...
		double fTemp21 = ((fTemp20 + fTemp19) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec7[1]))) + 100000.0));
		fVec7[0] = fTemp21;
		fRec37[0] = (fConst66 * ((1500.0 * (fTemp21 + fVec7[1])) - (fConst67 * fRec37[1])));
		fRec7[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp19 + (fRec37[0] + fTemp20)) + -1.887332)))) + -124.17786666666666);
		...
		double fTemp25 = ((fTemp24 + fTemp23) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec1[1]))) + 100000.0));
		fVec9[0] = fTemp25;
		fRec39[0] = (fConst69 * ((820.0 * (fTemp25 + fVec9[1])) - (fConst70 * fRec39[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp23 + (fRec39[0] + fTemp24)) + -1.2569619999999999)))) + -96.711951219512201);
