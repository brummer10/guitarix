...
int Dsp::register_par(const ParamReg& reg)
{
	...
	fslider1_ = reg.registerVar("pre.bass",N_("Bass"),"SA",N_("Bass"),&fslider1, 0.0, -1e+01, 1e+01, 0.5);
	fslider0_ = reg.registerVar("pre.treble",N_("Treble"),"SA",N_("Treble"),&fslider0, 0.0, -1e+01, 1e+01, 0.5);
	return 0;
}
