...
{
	fVslider0_ = reg.registerVar("pre.Level",N_("Level"),"SA",N_("Level"),&fVslider0, 1.0, 0.10000000000000001, 2.1000000000000001, 0.10000000000000001);
	fVslider2_ = reg.registerVar("pre.bass",N_("Bass"),"SA",N_("Bass"),&fVslider2, 0.0, -10.0, 10.0, 0.5);
	fVslider1_ = reg.registerVar("pre.treble",N_("Treble"),"SA",N_("Treble"),&fVslider1, 0.0, -10.0, 10.0, 0.5);
	return 0;
}
