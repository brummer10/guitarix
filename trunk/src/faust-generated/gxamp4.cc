...
inline void Dsp::clear_state_f()
{
	...
	for (int l31 = 0; (l31 < 3); l31 = (l31 + 1)) fRec31[l31] = 0.0;
	...
	for (int l39 = 0; (l39 < 2); l39 = (l39 + 1)) fVec4[l39] = 0.0;
	for (int l40 = 0; (l40 < 2); l40 = (l40 + 1)) fRec5[l40] = 0.0;
	for (int l41 = 0; (l41 < 2); l41 = (l41 + 1)) fVec5[l41] = 0.0;
	for (int l42 = 0; (l42 < 2); l42 = (l42 + 1)) fRec4[l42] = 0.0;
	for (int l43 = 0; (l43 < 2); l43 = (l43 + 1)) fRec41[l43] = 0.0;
	for (int l44 = 0; (l44 < 2); l44 = (l44 + 1)) fVec6[l44] = 0.0;
	for (int l45 = 0; (l45 < 2); l45 = (l45 + 1)) fRec3[l45] = 0.0;
	for (int l46 = 0; (l46 < 3); l46 = (l46 + 1)) fRec2[l46] = 0.0;
...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp4 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow3 * (fRec6[2] + (fConst50 * (fTemp3 + (fConst52 * fRec6[0])))))));
		...
		double fTemp5 = (fConst45 * fRec32[1]);
		fRec32[0] = ((fConst15 * (((fConst39 * fRec33[0]) + (fConst57 * fRec33[1])) + (fConst39 * fRec33[2]))) - (fConst58 * ((fConst59 * fRec32[2]) + fTemp5)));
		double fTemp6 = (fConst55 * fRec31[1]);
		fRec31[0] = ((fRec32[2] + (fConst58 * (fTemp5 + (fConst59 * fRec32[0])))) - (fConst50 * ((fConst52 * fRec31[2]) + fTemp6)));
		double fTemp7 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow6 * (fRec31[2] + (fConst50 * (fTemp6 + (fConst52 * fRec31[0])))))));
		fRec38[0] = (0.0 - (fConst62 * ((fConst42 * fRec38[1]) - (fConst15 * (fTemp2 + fVec2[1])))));
		fRec37[0] = (fRec38[0] - (fConst10 * ((fConst44 * fRec37[2]) + (fConst45 * fRec37[1]))));
		double fTemp8 = (fRec37[2] + (fRec37[0] + (2.0 * fRec37[1])));
		fVec3[0] = fTemp8;
		...
		double fTemp9 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow7 * (((fConst54 * fRec35[0]) + (fConst66 * fRec35[1])) + (fConst54 * fRec35[2])))));
		fRec40[0] = (0.0 - (fConst67 * ((fConst51 * fRec40[1]) - (fConst10 * (fTemp8 + fVec3[1])))));
		fRec39[0] = (fRec40[0] - (fConst60 * ((fConst65 * fRec39[2]) + (fConst55 * fRec39[1]))));
		double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fSlow8 * (fRec39[2] + (fRec39[0] + (2.0 * fRec39[1]))))));
		...
		double fTemp12 = (1.0 - fRec30[0]);
		double fTemp13 = ((fSlow2 * fRec5[0]) + (fRec13[0] * ((fTemp12 * ((fSlow9 * ((4.0 * (1.0 - std::fabs((fRec13[0] * fTemp12)))) + -1.0)) + 1.0)) + (fSlow10 * fRec30[0]))));
		fVec5[0] = fTemp13;
		fRec4[0] = (0.0 - (fConst6 * ((fConst7 * fRec4[1]) - (fTemp13 + fVec5[1]))));
		fRec41[0] = (fSlow11 + (0.999 * fRec41[1]));
		double fTemp14 = (fRec4[0] * fRec41[0]);
		fVec6[0] = fTemp14;
		fRec3[0] = ((0.93028479253239138 * (fTemp14 + fVec6[1])) - (0.86056958506478287 * fRec3[1]));
		fRec2[0] = (fRec3[0] - ((1.8405051250752198 * fRec2[1]) + (0.86129424393186271 * fRec2[2])));
		double fTemp15 = (0.92544984225177063 * (fRec2[0] + fRec2[2]));
		fRec42[0] = (fConst6 * ((0.0082000000000000007 * (fRec1[1] + fRec1[2])) - (fConst7 * fRec42[1])));
		double fTemp16 = (1.8508996845035413 * fRec2[1]);
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_6V6_250k), double(((fTemp15 + (fRec42[0] + fTemp16)) + -1.1304620000000001)))) + -112.13878048780487);
		fRec0[0] = ((0.025000000000000001 * ((fConst4 * fRec1[0]) + (fConst27 * fRec1[1]))) - (fConst28 * fRec0[1]));
		fRec45[0] = (fConst6 * ((0.0082000000000000007 * (fRec44[1] + fRec44[2])) - (fConst7 * fRec45[1])));
		fRec44[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double(((fTemp15 + (fRec45[0] + fTemp16)) + -1.1307400000000001)))) + -112.10487804878048);
		fRec43[0] = ((0.025000000000000001 * ((fConst4 * fRec44[0]) + (fConst27 * fRec44[1]))) - (fConst28 * fRec43[1]));
		buf[i] = FAUSTFLOAT((fRec0[0] + fRec43[0]));
		fRec26[1] = fRec26[0];
		fVec0[1] = fVec0[0];
		fRec25[1] = fRec25[0];
		fRec24[2] = fRec24[1];
