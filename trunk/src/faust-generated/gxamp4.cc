...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst59 = (0 - fConst26);
	fConst60 = (2 * (0 - fConst24));
	fConst61 = (1 + ((fConst26 - 1.0) / fConst23));
	fConst62 = (1.0 / (1 + ((1.0 + fConst26) / fConst23)));
	fConst63 = (0 - fConst32);
	fConst64 = (2 * (0 - fConst30));
	fConst65 = (1 + ((fConst32 - 1.0) / fConst29));
	fConst66 = (1.0 / (1 + ((1.0 + fConst32) / fConst29)));
	fConst67 = (0 - fConst39);
	fConst68 = (2 * (0 - fConst37));
	fConst69 = (0.025 / fConst11);
	clear_state_f();
}
...
#define fslider3 (*fslider3_)
	...
	double 	fSlow8 = (fConst28 * pow(1e+01,(2 * fSlow2)));
	double 	fSlow9 = pow(1e+01,(1.2 * fSlow2));
	double 	fSlow10 = pow(1e+01,(0.8 * fSlow2));
	...
	for (int i=0; i<count; i++) {
		...
		fRec12[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec14[0] + ((double)input0[i] * fRec13[0])) - 1.25724)) - 83.43555555555557);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec15[0] + fRec10[0]) - 0.776162)) - 78.25586666666666);
		fRec8[0] = ((fConst13 * fRec8[1]) + (fConst12 * ((fConst9 * fRec9[0]) + (fConst10 * fRec9[1]))));
		fRec16[0] = ((fConst22 * fRec16[1]) + (fConst21 * (fRec7[1] + fRec7[2])));
		fRec7[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec16[0] + fRec8[0]) - 0.445487)) - 75.67231707317073);
		...
		fRec27[0] = ((fConst58 * fRec27[1]) + (fConst57 * ((fConst26 * fVec2[0]) + (fConst59 * fVec2[1]))));
		fRec26[0] = (fRec27[0] - (fConst28 * ((fConst27 * fRec26[2]) + (fConst25 * fRec26[1]))));
		double fTemp5 = max((double)-1, min((double)1, (fSlow8 * (((fConst24 * fRec26[0]) + (fConst60 * fRec26[1])) + (fConst24 * fRec26[2])))));
		double fTemp6 = (fConst25 * fRec28[1]);
		fRec30[0] = ((fConst55 * fRec30[1]) + (fConst54 * ((fConst32 * fVec1[0]) + (fConst63 * fVec1[1]))));
		fRec29[0] = (fRec30[0] - (fConst35 * ((fConst33 * fRec29[2]) + (fConst31 * fRec29[1]))));
		fRec28[0] = ((fConst35 * (((fConst30 * fRec29[0]) + (fConst64 * fRec29[1])) + (fConst30 * fRec29[2]))) - (fConst62 * ((fConst61 * fRec28[2]) + fTemp6)));
		double fTemp7 = max((double)-1, min((double)1, (fSlow9 * (fRec28[2] + (fConst62 * (fTemp6 + (fConst61 * fRec28[0])))))));
		double fTemp8 = (fConst25 * fRec31[1]);
		double fTemp9 = (fConst31 * fRec32[1]);
		fRec34[0] = ((fConst52 * fRec34[1]) + (fConst51 * ((fConst39 * fRec24[0]) + (fConst67 * fRec24[1]))));
		fRec33[0] = (fRec34[0] - (fConst42 * ((fConst40 * fRec33[2]) + (fConst38 * fRec33[1]))));
		fRec32[0] = ((fConst42 * (((fConst37 * fRec33[0]) + (fConst68 * fRec33[1])) + (fConst37 * fRec33[2]))) - (fConst66 * ((fConst65 * fRec32[2]) + fTemp9)));
		fRec31[0] = ((fRec32[2] + (fConst66 * (fTemp9 + (fConst65 * fRec32[0])))) - (fConst62 * ((fConst61 * fRec31[2]) + fTemp8)));
		double fTemp10 = max((double)-1, min((double)1, (fSlow10 * (fRec31[2] + (fConst62 * (fTemp8 + (fConst61 * fRec31[0])))))));
		double fTemp11 = ((1.584893192 * (((fTemp10 * (1 - (0.3333333333333333 * faustpower<2>(fTemp10)))) + (0.8413951417869425 * (fTemp7 * (1 - (0.3333333333333333 * faustpower<2>(fTemp7)))))) + (fTemp5 * (1 - (0.3333333333333333 * faustpower<2>(fTemp5)))))) + (1.2589412 * (fTemp4 * (1 - (0.3333333333333333 * faustpower<2>(fTemp4))))));
		fVec3[0] = fTemp11;
		...
		fRec0[0] = ((fConst13 * fRec0[1]) + (fConst69 * ((fConst9 * fRec1[0]) + (fConst10 * fRec1[1]))));
		...
		fRec35[0] = ((fConst13 * fRec35[1]) + (fConst69 * ((fConst9 * fRec36[0]) + (fConst10 * fRec36[1]))));
