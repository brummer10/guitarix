...
void init(int samplingFreq)
{
	...
	fConst40 = (1 + ((fConst17 - 1.0000000000000004) / fConst14));
	fConst41 = (1 + ((fConst17 + 1.0000000000000004) / fConst14));
	fConst42 = (1.0 / fConst41);
	fConst43 = (1 + fConst17);
	fConst44 = (0 - ((1 - fConst17) / fConst43));
	for (int i=0; i<2; i++) fRec21[i] = 0;
	for (int i=0; i<3; i++) fRec20[i] = 0;
	for (int i=0; i<2; i++) fVec1[i] = 0;
	fConst45 = (0 - fConst17);
	fConst46 = (1.0 / (fConst43 * fConst25));
	for (int i=0; i<2; i++) fRec19[i] = 0;
	for (int i=0; i<3; i++) fRec18[i] = 0;
	fConst47 = (2 * (0 - fConst15));
	for (int i=0; i<3; i++) fRec17[i] = 0;
	fConst48 = (1 + ((fConst11 - 1.0000000000000004) / fConst8));
	fConst49 = (1.0 / (1 + ((fConst11 + 1.0000000000000004) / fConst8)));
	fConst50 = (1 + fConst11);
	fConst51 = (0 - ((1 - fConst11) / fConst50));
	for (int i=0; i<2; i++) fRec25[i] = 0;
	for (int i=0; i<3; i++) fRec24[i] = 0;
	for (int i=0; i<2; i++) fVec2[i] = 0;
	fConst52 = (0 - fConst11);
	fConst53 = (1.0 / (fConst50 * fConst41));
	for (int i=0; i<2; i++) fRec23[i] = 0;
	for (int i=0; i<3; i++) fRec22[i] = 0;
	fConst54 = (2 * (0 - fConst9));
	for (int i=0; i<2; i++) fRec27[i] = 0;
	for (int i=0; i<3; i++) fRec26[i] = 0;
	for (int i=0; i<2; i++) fVec3[i] = 0;
	fConst55 = (4.0 / fConst6);
...
void compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow6 = (fConst49 * pow(1e+01,(2 * fSlow1)));
	double 	fSlow7 = (fConst49 * pow(1e+01,(0.9 * fSlow1)));
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp5 = (fConst10 * fRec17[1]);
		fRec21[0] = ((fConst38 * (fRec15[0] + fRec15[1])) + (fConst28 * fRec21[1]));
		fRec20[0] = (fRec21[0] - (fConst26 * ((fConst24 * fRec20[2]) + (fConst22 * fRec20[1]))));
		double fTemp6 = (fRec20[2] + (fRec20[0] + (2 * fRec20[1])));
		fVec1[0] = fTemp6;
		fRec19[0] = ((fConst46 * ((fConst45 * fVec1[1]) + (fConst17 * fVec1[0]))) + (fConst44 * fRec19[1]));
		fRec18[0] = (fRec19[0] - (fConst42 * ((fConst40 * fRec18[2]) + (fConst16 * fRec18[1]))));
		fRec17[0] = ((fConst42 * (((fConst15 * fRec18[0]) + (fConst47 * fRec18[1])) + (fConst15 * fRec18[2]))) - (fConst13 * ((fConst12 * fRec17[2]) + fTemp5)));
		double fTemp7 = max(-1, min(1, (fSlow5 * (fRec17[2] + (fConst13 * (fTemp5 + (fConst12 * fRec17[0])))))));
		fRec25[0] = ((fConst46 * (fVec1[0] + fVec1[1])) + (fConst44 * fRec25[1]));
		fRec24[0] = (fRec25[0] - (fConst42 * ((fConst40 * fRec24[2]) + (fConst16 * fRec24[1]))));
		double fTemp8 = (fRec24[2] + (fRec24[0] + (2 * fRec24[1])));
		fVec2[0] = fTemp8;
		fRec23[0] = ((fConst53 * ((fConst52 * fVec2[1]) + (fConst11 * fVec2[0]))) + (fConst51 * fRec23[1]));
		fRec22[0] = (fRec23[0] - (fConst49 * ((fConst48 * fRec22[2]) + (fConst10 * fRec22[1]))));
		double fTemp9 = max(-1, min(1, (fSlow6 * (((fConst9 * fRec22[0]) + (fConst54 * fRec22[1])) + (fConst9 * fRec22[2])))));
		fRec27[0] = ((fConst53 * (fVec2[0] + fVec2[1])) + (fConst51 * fRec27[1]));
		fRec26[0] = (fRec27[0] - (fConst49 * ((fConst48 * fRec26[2]) + (fConst10 * fRec26[1]))));
		double fTemp10 = max(-1, min(1, (fSlow7 * (fRec26[2] + (fRec26[0] + (2 * fRec26[1]))))));
		double fTemp11 = ((((fTemp10 * (1 - (0.3333333333333333 * faustpower<2>(fTemp10)))) + (fTemp9 * (1 - (0.3333333333333333 * faustpower<2>(fTemp9))))) + (0.625 * (fTemp7 * (1 - (0.3333333333333333 * faustpower<2>(fTemp7)))))) + (0.5 * (fTemp4 * (1 - (0.3333333333333333 * faustpower<2>(fTemp4))))));
		fVec3[0] = fTemp11;
		...
		fRec9[0] = Ftube3(0, (fRec29[0] + (fRec28[0] * ((fSlow8 * fRec10[0]) + (fSlow3 * fTemp0)))));
		...
		fRec6[0] = Ftube3(1, (fRec30[0] + (fRec28[0] * fRec7[0])));
