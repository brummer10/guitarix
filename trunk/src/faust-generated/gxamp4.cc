...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = Ftube3(0, (fRec28[0] + (fRec27[0] * ((fSlow8 * ((((fTemp10 * (1 - (0.3333333333333333 * faustpower<2>(fTemp10)))) + (fTemp9 * (1 - (0.3333333333333333 * faustpower<2>(fTemp9))))) + (0.625 * (fTemp7 * (1 - (0.3333333333333333 * faustpower<2>(fTemp7)))))) + (0.5 * (fTemp4 * (1 - (0.3333333333333333 * faustpower<2>(fTemp4))))))) + (fSlow3 * fTemp0)))));
		...
		fRec6[0] = Ftube3(1, (fRec29[0] + (fRec27[0] * fRec7[0])));
