...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec14[0] = (Ftube(TUBE_TABLE_12AU7_68k, ((fRec16[0] + ((double)buf[i] * fRec15[0])) - 1.25724)) - 83.43555555555557);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec17[0] + fRec12[0]) - 0.776162)) - 78.25586666666666);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_12AU7_250k, ((fRec18[0] + fRec10[0]) - 0.445487)) - 75.67231707317073);
