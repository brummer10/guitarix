...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec18[0] = ((fConst4 * (fRec14[1] + fRec14[2])) + (fConst3 * fRec18[1]));
		...
		fRec19[0] = ((fConst17 * (fRec8[1] + fRec8[2])) + (fConst16 * fRec19[1]));
		...
		fRec20[0] = ((fConst21 * (fRec2[1] + fRec2[2])) + (fConst20 * fRec20[1]));
		...
		buf[i] = (FAUSTFLOAT)((fSlow7 * fRec21[0]) + (fSlow5 * fRec0[0]));
		...
		fRec37[0] = ((fConst4 * (fRec34[1] + fRec34[2])) + (fConst3 * fRec37[1]));
		...
		fRec38[0] = ((fConst17 * (fRec29[1] + fRec29[2])) + (fConst16 * fRec38[1]));
		...
		fRec39[0] = ((fConst21 * (fRec24[1] + fRec24[2])) + (fConst20 * fRec39[1]));
		...
		bufs[i] = (FAUSTFLOAT)((fSlow7 * fRec40[0]) + (fSlow5 * fRec22[0]));
		// post processing
...
{
	reg.registerVar("ampmodul.feedbac",N_("Dry/FB"),"S","",&fslider5, 0.0, -1.0, 1.0, 0.01);
	reg.registerVar("ampmodul.feedback",N_("Wet/FB"),"S","",&fslider0, 0.0, -1.0, 1.0, 0.01);
	reg.registerVar("ampmodul.level",N_("Level"),"S","",&fslider3, -2e+01, -4e+01, 4.0, 0.1);
	reg.registerVar("ampmodul.amp2.stage1.tube1",N_("Tube I"),"S","",&fslider2, 6.0, -2e+01, 2e+01, 0.1);
	reg.registerVar("ampmodul.amp2.stage2.tube2",N_("Tube II"),"S","",&fslider1, 6.0, -2e+01, 2e+01, 0.1);
	reg.registerVar("ampmodul.wet_dry",N_("Dry/Wet"),"S","",&fslider4, 0.0, -1.0, 1.0, 0.1);
	return 0;
}
