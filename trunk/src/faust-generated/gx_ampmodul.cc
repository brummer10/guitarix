...
void compute(int count, float *input0, float *input1, float *output0, float *output1)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec23[0] = Ftube2(0, (fRec24[0] + (((double)input1[i] * fRec11[0]) * fRec10[0])));
		fRec22[0] = ((fConst11 * ((fConst10 * fRec23[1]) + (fConst0 * fRec23[0]))) + (fConst2 * fRec22[1]));
		fRec21[0] = ((fConst12 * (fRec22[0] + fRec22[1])) + (fConst5 * fRec21[1]));
		double fTemp4 = (fRec20[1] - 2.5e+02);
		fVec4[0] = fTemp4;
		fRec25[0] = ((fConst16 * (fVec4[0] + fVec4[1])) + (fConst15 * fRec25[1]));
		fRec20[0] = Ftube2(1, (fRec25[0] + (fRec10[0] * fRec21[0])));
		fRec19[0] = ((fConst11 * ((fConst10 * fRec20[1]) + (fConst0 * fRec20[0]))) + (fConst2 * fRec19[1]));
		fRec18[0] = ((fConst12 * (fRec19[0] + fRec19[1])) + (fConst5 * fRec18[1]));
		double fTemp5 = (fRec17[1] - 2.5e+02);
		fVec5[0] = fTemp5;
		fRec26[0] = ((fConst20 * (fVec5[0] + fVec5[1])) + (fConst19 * fRec26[1]));
		fRec17[0] = Ftube2(1, (fRec26[0] + (fRec3[0] * fRec18[0])));
		fRec16[0] = ((fConst11 * ((fConst10 * fRec17[1]) + (fConst0 * fRec17[0]))) + (fConst2 * fRec16[1]));
		fRec15[0] = (fRec16[0] - (fSlow0 * fRec15[5]));
