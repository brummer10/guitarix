...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec16[0] = ((fTemp3 * fRec17[0]) - (fTemp2 + fRec16[2]));
		double fTemp4 = (fRec16[2] + (fRec16[0] + fTemp2));
		fVec0[0] = fTemp4;
		fRec15[0] = ((1.0000000000000002 * (fVec0[0] + fVec0[1])) - (0.9999999999999998 * fRec15[1]));
		fRec18[0] = ((fConst4 * fRec18[1]) + (fConst3 * (fRec14[1] + fRec14[2])));
		fRec14[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec18[0] + fRec15[0]) - 2.29615)) - 164.9574074074074);
		fRec13[0] = ((fConst9 * fRec13[1]) + (fConst8 * ((fConst5 * fRec14[0]) + (fConst6 * fRec14[1]))));
		fRec12[0] = ((fConst13 * fRec12[1]) + (fConst12 * (fRec13[0] + fRec13[1])));
		fRec10[0] = ((fRec12[0] * fRec11[0]) - (fTemp1 + fRec10[2]));
		double fTemp5 = (fRec10[2] + (fRec10[0] + fTemp1));
		fVec1[0] = fTemp5;
		fRec9[0] = ((1.0000000000000002 * (fVec1[0] + fVec1[1])) - (0.9999999999999998 * fRec9[1]));
		fRec19[0] = ((fConst17 * fRec19[1]) + (fConst16 * (fRec8[1] + fRec8[2])));
		fRec8[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec19[0] + fRec9[0]) - 1.675587)) - 138.2942);
		...
		double fTemp6 = (fRec4[2] + (fRec4[0] + fTemp0));
		fVec2[0] = fTemp6;
		fRec3[0] = ((1.0000000000000002 * (fVec2[0] + fVec2[1])) - (0.9999999999999998 * fRec3[1]));
		fRec20[0] = ((fConst21 * fRec20[1]) + (fConst20 * (fRec2[1] + fRec2[2])));
		fRec2[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec20[0] + fRec3[0]) - 1.130462)) - 112.13878048780487);
		fRec1[0] = ((fConst9 * fRec1[1]) + (fConst8 * ((fConst5 * fRec2[0]) + (fConst6 * fRec2[1]))));
		fRec0[0] = (fRec1[0] - (fSlow0 * fRec0[5]));
		fRec21[0] = (fTemp3 - (fSlow6 * fRec21[5]));
		output0[i] = (FAUSTFLOAT)((fSlow7 * fRec21[0]) + (fSlow5 * fRec0[0]));
		double fTemp7 = (2.0 * fRec26[1]);
		double fTemp8 = (2.0 * fRec31[1]);
		double fTemp9 = (2.0 * fRec36[1]);
		double fTemp10 = (double)input1[i];
		fRec36[0] = ((fTemp10 * fRec17[0]) - (fTemp9 + fRec36[2]));
		double fTemp11 = (fRec36[2] + (fRec36[0] + fTemp9));
		fVec3[0] = fTemp11;
		fRec35[0] = ((1.0000000000000002 * (fVec3[0] + fVec3[1])) - (0.9999999999999998 * fRec35[1]));
		fRec37[0] = ((fConst4 * fRec37[1]) + (fConst3 * (fRec34[1] + fRec34[2])));
		fRec34[0] = (Ftube(TUBE_TABLE_6V6_68k, ((fRec37[0] + fRec35[0]) - 2.29615)) - 164.9574074074074);
		fRec33[0] = ((fConst9 * fRec33[1]) + (fConst8 * ((fConst5 * fRec34[0]) + (fConst6 * fRec34[1]))));
		fRec32[0] = ((fConst13 * fRec32[1]) + (fConst12 * (fRec33[0] + fRec33[1])));
		fRec31[0] = ((fRec11[0] * fRec32[0]) - (fTemp8 + fRec31[2]));
		double fTemp12 = (fRec31[2] + (fRec31[0] + fTemp8));
		fVec4[0] = fTemp12;
		fRec30[0] = ((1.0000000000000002 * (fVec4[1] + fVec4[0])) - (0.9999999999999998 * fRec30[1]));
		fRec38[0] = ((fConst17 * fRec38[1]) + (fConst16 * (fRec29[1] + fRec29[2])));
		fRec29[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec38[0] + fRec30[0]) - 1.675587)) - 138.2942);
		fRec28[0] = ((fConst9 * fRec28[1]) + (fConst8 * ((fConst5 * fRec29[0]) + (fConst6 * fRec29[1]))));
		fRec27[0] = ((fConst13 * fRec27[1]) + (fConst12 * (fRec28[0] + fRec28[1])));
		fRec26[0] = ((fRec5[0] * fRec27[0]) - (fTemp7 + fRec26[2]));
		double fTemp13 = (fRec26[2] + (fRec26[0] + fTemp7));
		fVec5[0] = fTemp13;
		fRec25[0] = ((1.0000000000000002 * (fVec5[0] + fVec5[1])) - (0.9999999999999998 * fRec25[1]));
		fRec39[0] = ((fConst21 * fRec39[1]) + (fConst20 * (fRec24[1] + fRec24[2])));
		fRec24[0] = (Ftube(TUBE_TABLE_6V6_250k, ((fRec39[0] + fRec25[0]) - 1.130462)) - 112.13878048780487);
		fRec23[0] = ((fConst9 * fRec23[1]) + (fConst8 * ((fConst5 * fRec24[0]) + (fConst6 * fRec24[1]))));
		fRec22[0] = (fRec23[0] - (fSlow0 * fRec22[5]));
		fRec40[0] = (fTemp10 - (fSlow6 * fRec40[5]));
