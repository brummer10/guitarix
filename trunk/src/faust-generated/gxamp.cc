...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp17 = (fTemp15 + fTemp16) / (Ranode(TUBE_TABLE_12AX7_68k, fRec11[1]) + 1e+05);
		fVec5[0] = fTemp17;
		fRec34[0] = fConst61 * (2.7e+03 * (fTemp17 + fVec5[1]) - fConst60 * fRec34[1]);
		fRec11[0] = Ftube(TUBE_TABLE_12AX7_68k, fTemp16 + fRec34[0] + fTemp15 + -1.581656) + -191.42014814814814;
		fRec10[0] = 0.025 * (fConst31 * fRec11[0] + fConst32 * fRec11[1]) - fConst4 * fRec10[1];
		fRec35[0] = fConst64 * (fConst63 * fRec35[1] + 0.025 * (fRec11[0] - fRec11[1]));
		...
		double fTemp21 = (fTemp19 + fTemp20) / (Ranode(TUBE_TABLE_12AX7_250k, fRec6[1]) + 1e+05);
		fVec7[0] = fTemp21;
		fRec37[0] = fConst67 * (1.5e+03 * (fTemp21 + fVec7[1]) - fConst66 * fRec37[1]);
		fRec6[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp20 + fRec37[0] + fTemp19 + -1.204285) + -169.71433333333334;
		fRec5[0] = 0.025 * (fConst31 * fRec6[0] + fConst32 * fRec6[1]) - fConst4 * fRec5[1];
		fRec38[0] = fConst64 * (fConst63 * fRec38[1] + 0.025 * (fRec6[0] - fRec6[1]));
		...
		double fTemp25 = (fTemp23 + fTemp24) / (Ranode(TUBE_TABLE_12AX7_250k, fRec1[1]) + 1e+05);
		fVec9[0] = fTemp25;
		fRec39[0] = fConst70 * (8.2e+02 * (fTemp25 + fVec9[1]) - fConst69 * fRec39[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp24 + fRec39[0] + fTemp23 + -0.840703) + -147.47524390243905;
		fRec0[0] = 0.025 * (fConst31 * fRec1[0] + fConst32 * fRec1[1]) - fConst4 * fRec0[1];
		fRec40[0] = fConst64 * (fConst63 * fRec40[1] + 0.025 * (fRec1[0] - fRec1[1]));
		fRec41[0] = fSlow5 + 0.999 * fRec41[1];
		buf[i0] = FAUSTFLOAT(fRec41[0] * ((iSlow0) ? fRec40[0] : fRec0[0]));
		fRec14[1] = fRec14[0];
		fRec15[1] = fRec15[0];
		fRec24[2] = fRec24[1];
		fRec24[1] = fRec24[0];
