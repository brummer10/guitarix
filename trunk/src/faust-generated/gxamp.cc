...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec32[0] + (1.8508996845035413 * fRec10[1]))) + -1.581656)))) + -191.42014814814814);
		...
		fRec5[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec6[0] + fRec6[2])) + (fRec33[0] + (1.8508996845035413 * fRec6[1]))) + -1.204285)))) + -169.71433333333334);
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec34[0] + (1.8508996845035413 * fRec1[1]))) + -0.84070299999999998)))) + -147.47524390243905);
