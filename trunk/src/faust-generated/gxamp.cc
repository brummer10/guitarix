...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec29[0] = ((fRec30[2] + (fConst46 * ((fConst45 * fRec30[0]) + fTemp12))) - (fConst42 * ((fConst41 * fRec29[2]) + fTemp11)));
		...
		fRec13[0] = (Ftube(TUBE_TABLE_12AX7_68k, ((fRec35[0] + fRec14[0]) - 1.581656)) - 191.42014814814814);
		...
		fRec7[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec36[0] + fRec8[0]) - 1.204285)) - 169.71433333333334);
		fRec6[0] = ((fConst31 * fRec6[1]) + (fConst59 * ((fConst27 * fRec7[0]) + (fConst28 * fRec7[1]))));
		double fTemp19 = (fRec11[0] * fRec6[0]);
		fVec7[0] = fTemp19;
		fRec5[0] = ((fConst54 * fRec5[1]) + (fConst53 * (fVec7[0] + fVec7[1])));
		...
		fRec2[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec37[0] + fRec3[0]) - 0.840703)) - 147.47524390243905);
