...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp18 = double(Ftube(int(TUBE_TABLE_12AX7_68k), double(((fTemp15 + (fRec35[0] + fTemp16)) + -1.581656))));
		fRec12[0] = ((fTemp18 + (0.00058579851851851849 * (double(Ranode(int(TUBE_TABLE_12AX7_68k), double(fTemp18))) + 100000.0))) + -250.0);
		...
		double fTemp23 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp20 + (fRec36[0] + fTemp21)) + -1.204285))));
		fRec7[0] = ((fTemp23 + (0.00080285666666666665 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp23))) + 100000.0))) + -250.0);
		...
		double fTemp28 = double(Ftube(int(TUBE_TABLE_12AX7_250k), double(((fTemp25 + (fRec37[0] + fTemp26)) + -0.84070299999999998))));
		fRec1[0] = ((fTemp28 + (0.0010252475609756097 * (double(Ranode(int(TUBE_TABLE_12AX7_250k), double(fTemp28))) + 100000.0))) + -250.0);
