...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	fConst65 = (1.0 / tan((414.6902302738527 / double(iConst0))));
	fConst66 = (1 + fConst65);
	fConst67 = (0.015 / fConst66);
	fConst68 = (0 - ((1 - fConst65) / fConst66));
	fConst69 = (1.0 / tan((609.4689747964198 / double(iConst0))));
	fConst70 = (1 + fConst69);
	fConst71 = (0.0082 / fConst70);
...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec11[0] = (Ftube(TUBE_TABLE_12AX7_68k, (((fTemp0 * ((fTemp12 * (1 + (fSlow11 * ((4 - (4 * fabs((fTemp0 * fTemp12)))) - 1)))) + (fSlow10 * fRec21[0]))) + (fRec31[0] + (fSlow9 * fRec12[0]))) - 1.581656)) - 191.42014814814814);
		fRec10[0] = ((fConst36 * fRec10[1]) + (fConst64 * ((fConst32 * fRec11[0]) + (fConst33 * fRec11[1]))));
		double fTemp13 = (fRec10[0] * fRec9[0]);
		fVec4[0] = fTemp13;
		fRec8[0] = ((fConst59 * fRec8[1]) + (fConst58 * (fVec4[0] + fVec4[1])));
		fRec32[0] = ((fConst68 * fRec32[1]) + (fConst67 * (fRec7[1] + fRec7[2])));
		fRec7[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec32[0] + fRec8[0]) - 1.204285)) - 169.71433333333334);
		fRec6[0] = ((fConst36 * fRec6[1]) + (fConst64 * ((fConst32 * fRec7[0]) + (fConst33 * fRec7[1]))));
		double fTemp14 = (fRec9[0] * fRec6[0]);
		fVec5[0] = fTemp14;
		fRec5[0] = ((fConst59 * fRec5[1]) + (fConst58 * (fVec5[0] + fVec5[1])));
		fRec33[0] = ((fConst72 * fRec33[1]) + (fConst71 * (fRec4[1] + fRec4[2])));
		fRec4[0] = (Ftube(TUBE_TABLE_12AX7_250k, ((fRec33[0] + fRec5[0]) - 0.840703)) - 147.47524390243905);
