...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = Ftube(0, ((fTemp3 * ((fSlow13 * fRec17[0]) + (fRec30[0] * (1 + (fSlow12 * ((4 - (4 * fabs((fTemp3 * fRec30[0])))) - 1)))))) + (fRec29[0] + (fSlow10 * fRec10[0]))));
		...
		fRec6[0] = Ftube(1, (fRec31[0] + fRec7[0]));
		...
		fRec2[0] = Ftube(1, (fRec32[0] + fRec3[0]));
