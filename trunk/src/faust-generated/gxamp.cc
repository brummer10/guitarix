...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fRec6[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp21 + fRec37[0] + fTemp20 + -1.204285) + -169.71433333333334;
		...
		fRec1[0] = Ftube(TUBE_TABLE_12AX7_250k, fTemp26 + fRec39[0] + fTemp25 + -0.840703) + -147.47524390243905;
		double fTemp28 = fRec1[0] - fRec1[1];
		fRec0[0] = fConst32 * (fConst56 * fTemp28 - fConst3 * fRec0[1]);
