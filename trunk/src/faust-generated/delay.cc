...
{
	reg.registerVar("delay.bpm",N_("BPM"),"S",N_("Delay in Beats per Minute"),&fslider0, 1.2e+02f, 24.0f, 3.6e+02f, 1.0f);
	reg.registerVar("delay.gain",N_("Gain"),"S","",&fslider1, 0.0f, -2e+01f, 2e+01f, 0.1f);
	return 0;
}
