...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec0[0] = ((fConst9 * fRec0[1]) + (fConst69 * ((fConst5 * fRec1[0]) + (fConst6 * fRec1[1]))));
		...
		fRec43[0] = ((fConst9 * fRec43[1]) + (fConst69 * ((fConst5 * fRec44[0]) + (fConst6 * fRec44[1]))));
