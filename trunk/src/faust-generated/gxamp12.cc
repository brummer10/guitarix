...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec14[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec16[0] + ((double)buf[i] * fRec15[0])) - 1.863946)) - 60.96496296296296);
		...
		fRec11[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec17[0] + fRec12[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec18[0] + fRec10[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec2[0] = ((fConst18 * fRec2[1]) + (fConst74 * ((fConst14 * fRec3[0]) + (fConst15 * fRec3[1]))));
		...
		fRec37[0] = ((fConst18 * fRec37[1]) + (fConst74 * ((fConst14 * fRec38[0]) + (fConst15 * fRec38[1]))));
		double fTemp14 = (fRec37[0] + fRec2[0]);
		fVec5[0] = fTemp14;
		fRec1[0] = ((fConst77 * fRec1[1]) + (fConst76 * (fVec5[0] + fVec5[1])));
