...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec14[0] = ((0.046514239626619575 * (fRec15[0] + fRec15[1])) - (0.86056958506478287 * fRec14[1]));
		...
		fRec11[0] = ((0.050000000000000003 * (fRec12[0] * fRec26[0])) - (fConst19 * ((fConst33 * fRec11[2]) + (fConst34 * fRec11[1]))));
		...
		double fTemp14 = ((fRec4[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp12)))) + (fRec12[0] * ((fTemp13 * ((1.25 * (fRec27[0] * ((0.20000000000000001 * (1.0 - std::fabs((0.050000000000000003 * (fRec12[0] * fTemp13))))) + -0.050000000000000003))) + 0.050000000000000003)) + (0.050000000000000003 * (fRec26[0] * (1.0 - std::max<double>(0.0, fTemp12)))))));
		fVec5[0] = fTemp14;
