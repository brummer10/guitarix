...
#define fslider3 (*fslider3_)
	...
	for (int i=0; i<count; i++) {
		...
		fRec18[0] = (Ftube(TUBE_TABLE_6DJ8_68k, ((fRec22[0] + fRec19[0]) - 1.863946)) - 60.96496296296296);
		...
		fRec13[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec23[0] + fRec14[0]) - 1.271609)) - 45.22606666666667);
		...
		fRec9[0] = (Ftube(TUBE_TABLE_6DJ8_250k, ((fRec24[0] + fRec10[0]) - 0.797043)) - 32.799634146341475);
		...
		fRec37[0] = ((fRec38[2] + (fConst64 * (fTemp15 + (fConst63 * fRec38[0])))) - (fConst60 * ((fConst59 * fRec37[2]) + fTemp14)));
		...
		fRec43[0] = ((fConst13 * fRec43[1]) + (fConst69 * ((fConst9 * fRec44[0]) + (fConst10 * fRec44[1]))));
