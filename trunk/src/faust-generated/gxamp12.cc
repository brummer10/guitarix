...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fVec1[0] = fTemp5;
		fRec22[0] = fConst7 * (2.7e+03 * (fTemp5 + fVec1[1]) - fConst6 * fRec22[1]);
		fRec18[0] = Ftube(TUBE_TABLE_6DJ8_68k, fTemp4 + fRec22[0] + fTemp3 + -1.863946) + -60.96496296296296;
		fRec17[0] = 0.05 * (fConst8 * fRec18[0] + fConst9 * fRec18[1]) - fConst4 * fRec17[1];
		fRec23[0] = fConst12 * (fConst11 * fRec23[1] + 0.05 * (fRec18[0] - fRec18[1]));
		double fTemp6 = ((iSlow4) ? fRec23[0] : fRec17[0]);
		fVec2[0] = fTemp6;
		fRec16[0] = 0.0 - fConst15 * (fConst14 * fRec16[1] - (fTemp6 + fVec2[1]));
		...
		double fTemp9 = (fTemp7 + fTemp8) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec13[1]) + 1e+05);
		fVec3[0] = fTemp9;
		fRec24[0] = fConst18 * (1.5e+03 * (fTemp9 + fVec3[1]) - fConst17 * fRec24[1]);
		fRec13[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp8 + fRec24[0] + fTemp7 + -1.271609) + -45.22606666666667;
		fRec12[0] = 0.05 * (fConst8 * fRec13[0] + fConst9 * fRec13[1]) - fConst4 * fRec12[1];
		fRec25[0] = fConst12 * (fConst11 * fRec25[1] + 0.05 * (fRec13[0] - fRec13[1]));
		double fTemp10 = ((iSlow4) ? fRec25[0] : fRec12[0]);
		fVec4[0] = fTemp10;
		fRec11[0] = 0.9302847925323914 * (fTemp10 + fVec4[1]) - 0.8605695850647829 * fRec11[1];
		fRec10[0] = fRec11[0] - (1.8405051250752198 * fRec10[1] + 0.8612942439318627 * fRec10[2]);
		double fTemp11 = 1.8508996845035413 * fRec10[1];
		double fTemp12 = 0.9254498422517706 * (fRec10[0] + fRec10[2]);
		double fTemp13 = (fTemp11 + fTemp12) / (Ranode(TUBE_TABLE_6DJ8_250k, fRec9[1]) + 1e+05);
		fVec5[0] = fTemp13;
		fRec26[0] = fConst21 * (8.2e+02 * (fTemp13 + fVec5[1]) - fConst20 * fRec26[1]);
		fRec9[0] = Ftube(TUBE_TABLE_6DJ8_250k, fTemp12 + fRec26[0] + fTemp11 + -0.797043) + -32.799634146341475;
		fRec8[0] = 0.05 * (fConst8 * fRec9[0] + fConst9 * fRec9[1]) - fConst4 * fRec8[1];
		fRec27[0] = fConst12 * (fConst11 * fRec27[1] + 0.05 * (fRec9[0] - fRec9[1]));
		double fTemp14 = ((iSlow4) ? fRec27[0] : fRec8[0]);
		fRec36[0] = fRec7[0] * fTemp14 - fConst47 * (fConst46 * fRec36[2] + fConst44 * fRec36[1]);
		double fTemp15 = fRec36[2] + fRec36[0] + 2.0 * fRec36[1];
		fVec6[0] = fTemp15;
		fRec35[0] = fConst47 * (fConst8 * fTemp15 + fConst9 * fVec6[1]) - fConst4 * fRec35[1];
		fRec34[0] = 0.0 - fConst50 * (fConst48 * fRec34[1] - (fRec35[0] + fRec35[1]));
		fRec33[0] = fRec34[0] - fConst42 * (fConst41 * fRec33[2] + fConst39 * fRec33[1]);
		double fTemp16 = fRec33[2] + fRec33[0] + 2.0 * fRec33[1];
		fVec7[0] = fTemp16;
		fRec32[0] = 0.0 - fConst53 * (fConst51 * fRec32[1] - fConst42 * (fTemp16 + fVec7[1]));
		fRec31[0] = fRec32[0] - fConst35 * (fConst34 * fRec31[2] + fConst32 * fRec31[1]);
		double fTemp17 = fRec31[2] + fRec31[0] + 2.0 * fRec31[1];
		fVec8[0] = fTemp17;
		fRec30[0] = 0.0 - fConst56 * (fConst54 * fRec30[1] - fConst35 * (fTemp17 + fVec8[1]));
		fRec29[0] = fRec30[0] - fConst28 * (fConst27 * fRec29[2] + fConst25 * fRec29[1]);
		double fTemp18 = std::max<double>(-1.0, std::min<double>(1.0, fConst28 * (fRec29[2] + fRec29[0] + 2.0 * fRec29[1]) * std::pow(1e+01, 0.9 * fRec6[0])));
		fRec38[0] = fConst35 * (fConst58 * fTemp17 + fConst59 * fVec8[1]) - fConst57 * fRec38[1];
		fRec37[0] = fRec38[0] - fConst28 * (fConst27 * fRec37[2] + fConst25 * fRec37[1]);
		double fTemp19 = std::max<double>(-1.0, std::min<double>(1.0, fConst28 * (fConst24 * fRec37[0] + fConst60 * fRec37[1] + fConst24 * fRec37[2]) * std::pow(1e+01, 2.0 * fRec6[0])));
		double fTemp20 = fConst25 * fRec39[1];
		double fTemp21 = fConst32 * fRec40[1];
		fRec42[0] = fConst65 * fRec35[1] - fConst50 * (fConst48 * fRec42[1] - fConst40 * fRec35[0]);
		fRec41[0] = fRec42[0] - fConst42 * (fConst41 * fRec41[2] + fConst39 * fRec41[1]);
		fRec40[0] = fConst42 * (fConst38 * fRec41[0] + fConst66 * fRec41[1] + fConst38 * fRec41[2]) - fConst64 * (fConst63 * fRec40[2] + fTemp21);
		fRec39[0] = fRec40[2] + fConst64 * (fTemp21 + fConst63 * fRec40[0]) - fConst62 * (fConst61 * fRec39[2] + fTemp20);
		double fTemp22 = std::max<double>(-1.0, std::min<double>(1.0, (fRec39[2] + fConst62 * (fTemp20 + fConst61 * fRec39[0])) * std::pow(1e+01, 0.8 * fRec6[0])));
		double fTemp23 = fConst25 * fRec43[1];
		fRec45[0] = fConst42 * (fConst68 * fTemp16 + fConst69 * fVec7[1]) - fConst67 * fRec45[1];
		fRec44[0] = fRec45[0] - fConst35 * (fConst34 * fRec44[2] + fConst32 * fRec44[1]);
		fRec43[0] = fConst35 * (fConst31 * fRec44[0] + fConst70 * fRec44[1] + fConst31 * fRec44[2]) - fConst62 * (fConst61 * fRec43[2] + fTemp23);
		double fTemp24 = std::max<double>(-1.0, std::min<double>(1.0, (fRec43[2] + fConst62 * (fTemp23 + fConst61 * fRec43[0])) * std::pow(1e+01, 1.2 * fRec6[0])));
		...
		fVec9[0] = fTemp25;
		fRec28[0] = 0.0 - fConst15 * (fConst14 * fRec28[1] - (fTemp25 + fVec9[1]));
		double fTemp26 = fRec28[0] * (1.0 - std::max<double>(0.0, -1.0 * fTemp0)) + fTemp14 * (fTemp1 * (1.25 * fRec6[0] * (4.0 * (1.0 - std::fabs(fTemp14 * fTemp1)) + -1.0) + 1.0) + fRec7[0] * (1.0 - std::max<double>(0.0, fTemp0)));
		fVec10[0] = fTemp26;
		fRec5[0] = 0.0 - fConst15 * (fConst14 * fRec5[1] - (fTemp26 + fVec10[1]));
		double fTemp27 = fRec5[0] * fRec4[0];
		fVec11[0] = fTemp27;
		fRec3[0] = 0.9302847925323914 * (fTemp27 + fVec11[1]) - 0.8605695850647829 * fRec3[1];
		fRec2[0] = fRec3[0] - (1.8405051250752198 * fRec2[1] + 0.8612942439318627 * fRec2[2]);
		double fTemp28 = 1.8508996845035413 * fRec2[1];
		double fTemp29 = 0.9254498422517706 * (fRec2[0] + fRec2[2]);
		double fTemp30 = fTemp28 + fTemp29;
		double fTemp31 = fTemp30 / (Ranode(TUBE_TABLE_6V6_250k, fRec1[1]) + 1e+05);
		fVec12[0] = fTemp31;
		fRec46[0] = fConst15 * (8.2e+02 * (fTemp31 + fVec12[1]) - fConst14 * fRec46[1]);
		fRec1[0] = Ftube(TUBE_TABLE_6V6_250k, fTemp29 + fRec46[0] + fTemp28 + -0.962132) + -132.6668292682927;
		fRec0[0] = 0.025 * (fConst8 * fRec1[0] + fConst9 * fRec1[1]) - fConst4 * fRec0[1];
		fRec47[0] = fConst12 * (fConst11 * fRec47[1] + 0.025 * (fRec1[0] - fRec1[1]));
		double fTemp32 = fTemp30 / (Ranode(TUBE_TABLE_6V6_68k, fRec49[1]) + 1e+05);
		fVec13[0] = fTemp32;
		fRec50[0] = fConst15 * (8.2e+02 * (fTemp32 + fVec13[1]) - fConst14 * fRec50[1]);
		fRec49[0] = Ftube(TUBE_TABLE_6V6_68k, fTemp29 + fRec50[0] + fTemp28 + -0.963342) + -132.5192682926829;
		fRec48[0] = 0.025 * (fConst8 * fRec49[0] + fConst9 * fRec49[1]) - fConst4 * fRec48[1];
		fRec51[0] = fConst12 * (fConst11 * fRec51[1] + 0.025 * (fRec49[0] - fRec49[1]));
