...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (fRec12[1] - 1.3e+02);
		fVec1[0] = fTemp1;
		fRec14[0] = ((fConst10 * (fVec1[0] + fVec1[1])) + (fConst9 * fRec14[1]));
		fRec12[0] = Ftube4(0, (fRec14[0] + ((double)input0[i] * fRec13[0])));
		...
		fRec36[0] = ((fConst69 * ((fConst11 * fRec37[1]) + (fConst0 * fRec37[0]))) + (fConst2 * fRec36[1]));
