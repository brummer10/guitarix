...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *input1, FAUSTFLOAT *output0, FAUSTFLOAT *output1)
{
	...
	double fSlow8 = (fSlow4 + 1.111140466039204) / fSlow0 + 1.0;
	double fSlow9 = 1.0 / fSlow8;
	double fSlow10 = (fSlow4 + -1.66293922460509) / fSlow0 + 1.0;
	double fSlow11 = (fSlow4 + 1.66293922460509) / fSlow0 + 1.0;
	double fSlow12 = 1.0 / fSlow11;
	double fSlow13 = (fSlow4 + -1.9615705608064609) / fSlow0 + 1.0;
	double fSlow14 = (fSlow4 + 1.9615705608064609) / fSlow0 + 1.0;
	double fSlow15 = 1.0 / fSlow14;
	double fSlow16 = 1.0 / (fSlow1 * fSlow14);
	double fSlow17 = 1.0 / (fSlow1 * fSlow11);
	double fSlow18 = 1.0 / (fSlow1 * fSlow8);
	double fSlow19 = 0.0010000000000000009 * std::pow(1e+01, 0.05 * double(fHslider1));
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		double fTemp0 = double(input0[i0]);
		fVec0[0] = fTemp0;
		fRec4[0] = fConst4 * (fTemp0 - fVec0[1] + fConst3 * fRec4[1]);
		fRec3[0] = fRec4[0] - fSlow15 * (fSlow13 * fRec3[2] + fSlow3 * fRec3[1]);
		fRec2[0] = fSlow16 * (fRec3[2] + (fRec3[0] - 2.0 * fRec3[1])) - fSlow12 * (fSlow10 * fRec2[2] + fSlow3 * fRec2[1]);
		fRec1[0] = fSlow17 * (fRec2[2] + (fRec2[0] - 2.0 * fRec2[1])) - fSlow9 * (fSlow7 * fRec1[2] + fSlow3 * fRec1[1]);
		fRec0[0] = fSlow18 * (fRec1[2] + (fRec1[0] - 2.0 * fRec1[1])) - fSlow6 * (fSlow5 * fRec0[2] + fSlow3 * fRec0[1]);
		double fTemp1 = double(input1[i0]);
		fVec1[0] = fTemp1;
		double fTemp2 = fTemp0 + fTemp1;
		fVec2[0] = fTemp2;
		fRec9[0] = fConst4 * (fTemp2 - fVec2[1] + fConst3 * fRec9[1]);
		fRec8[0] = fRec9[0] - fSlow15 * (fSlow13 * fRec8[2] + fSlow3 * fRec8[1]);
		fRec7[0] = fSlow15 * (fRec8[2] + fRec8[0] + 2.0 * fRec8[1]) - fSlow12 * (fSlow10 * fRec7[2] + fSlow3 * fRec7[1]);
		fRec6[0] = fSlow12 * (fRec7[2] + fRec7[0] + 2.0 * fRec7[1]) - fSlow9 * (fSlow7 * fRec6[2] + fSlow3 * fRec6[1]);
		fRec5[0] = fSlow9 * (fRec6[2] + fRec6[0] + 2.0 * fRec6[1]) - fSlow6 * (fSlow5 * fRec5[2] + fSlow3 * fRec5[1]);
		double fTemp3 = fRec5[2] + fRec5[0] + 2.0 * fRec5[1];
		fRec10[0] = fSlow19 + 0.999 * fRec10[1];
		fRec17[0] = fTemp2 - fSlow15 * (fSlow13 * fRec17[2] + fSlow3 * fRec17[1]);
		fRec16[0] = fSlow15 * (fRec17[2] + fRec17[0] + 2.0 * fRec17[1]) - fSlow12 * (fSlow10 * fRec16[2] + fSlow3 * fRec16[1]);
		fRec15[0] = fSlow12 * (fRec16[2] + fRec16[0] + 2.0 * fRec16[1]) - fSlow9 * (fSlow7 * fRec15[2] + fSlow3 * fRec15[1]);
		fRec14[0] = fSlow9 * (fRec15[2] + fRec15[0] + 2.0 * fRec15[1]) - fSlow6 * (fSlow5 * fRec14[2] + fSlow3 * fRec14[1]);
		...
		output0[i0] = FAUSTFLOAT(fTemp6 + fSlow6 * (fTemp3 + fSlow2 * (fRec0[0] + fRec0[2] - 2.0 * fRec0[1])));
		fRec22[0] = fConst4 * (fTemp1 - fVec1[1] + fConst3 * fRec22[1]);
		fRec21[0] = fRec22[0] - fSlow15 * (fSlow13 * fRec21[2] + fSlow3 * fRec21[1]);
		fRec20[0] = fSlow16 * (fRec21[2] + (fRec21[0] - 2.0 * fRec21[1])) - fSlow12 * (fSlow10 * fRec20[2] + fSlow3 * fRec20[1]);
		fRec19[0] = fSlow17 * (fRec20[2] + (fRec20[0] - 2.0 * fRec20[1])) - fSlow9 * (fSlow7 * fRec19[2] + fSlow3 * fRec19[1]);
		fRec18[0] = fSlow18 * (fRec19[2] + (fRec19[0] - 2.0 * fRec19[1])) - fSlow6 * (fSlow5 * fRec18[2] + fSlow3 * fRec18[1]);
		output1[i0] = FAUSTFLOAT(fTemp6 + fSlow6 * (fTemp3 + fSlow2 * (fRec18[0] + fRec18[2] - 2.0 * fRec18[1])));
		fVec0[1] = fVec0[0];
		fRec4[1] = fRec4[0];
		fRec3[2] = fRec3[1];
		fRec3[1] = fRec3[0];
