...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (2.44402781742033e-09 + (fConst1 * ((fRec8[0] * (fConst6 + (fConst5 * fRec8[0]))) + fConst3)));
		fRec9[0] = ((0.993 * fRec9[1]) + fSlow1);
		double fTemp3 = (fConst13 * fRec9[0]);
		fRec10[0] = ((double)input0[i] - ((((((fRec10[1] * (1.22201390871017e-08 + (fConst1 * ((fRec8[0] * (fConst33 + (fConst32 * fRec8[0]))) + fConst31)))) + (fRec10[2] * (2.44402781742033e-08 + (fConst1 * ((fRec8[0] * (fConst30 + (fConst29 * fRec8[0]))) + fConst28))))) + (fRec10[3] * (2.44402781742033e-08 + (fConst1 * ((fRec8[0] * (fConst27 + (fConst26 * fRec8[0]))) + fConst24))))) + (fRec10[4] * (1.22201390871017e-08 + (fConst1 * ((fRec8[0] * (fConst22 + (fConst21 * fRec8[0]))) + fConst19))))) + (fRec10[5] * (2.44402781742033e-09 + (fConst1 * ((fRec8[0] * (fConst17 + (fConst16 * fRec8[0]))) + fConst15))))) / fTemp2));
		double fTemp4 = (fConst40 * fRec9[0]);
		fRec7[0] = ((fConst63 * (((((((fRec10[0] * (fConst39 + ((fConst1 * (fRec8[0] * (fConst62 + ((fRec8[0] * (fConst61 + (fConst60 * fRec9[0]))) + (fConst59 * fRec9[0]))))) + fTemp4))) + (fRec10[1] * (((fConst1 * (fRec8[0] * (((fRec8[0] * (fConst57 + (fConst58 * fRec9[0]))) + (fConst56 * fRec9[0])) + fConst55))) + fTemp3) + fConst14))) + (fRec10[2] * (((fConst1 * (fRec8[0] * (fConst51 + ((fRec8[0] * (fConst54 + (fConst53 * fRec9[0]))) + (fConst52 * fRec9[0]))))) + (fConst49 * fRec9[0])) + fConst50))) + (fRec10[3] * (fConst48 + ((fConst1 * (fRec8[0] * (fConst47 + ((fRec8[0] * (fConst46 + (fConst45 * fRec9[0]))) + (fConst44 * fRec9[0]))))) + (fConst42 * fRec9[0]))))) + (fRec10[4] * (fConst39 + (fTemp4 + (fConst1 * (fRec8[0] * (((fRec8[0] * (fConst38 + (fConst37 * fRec9[0]))) + (fConst35 * fRec9[0])) + fConst36))))))) + (fRec10[5] * (fConst14 + (fTemp3 + (fConst1 * (fRec8[0] * (fConst8 + ((fRec8[0] * (fConst11 + (fConst10 * fRec9[0]))) + (fConst9 * fRec9[0]))))))))) / fTemp2)) - (fTemp1 + fRec7[2]));
		...
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec11[0] + fRec6[0]) - 3.571981)) - 117.70440740740739);
		...
		fRec1[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec12[0] + fRec2[0]) - 3.571981)) - 117.70440740740739);
