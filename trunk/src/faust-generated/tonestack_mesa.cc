...
#define fslider2 (*fslider2_)
	...
	double 	fSlow19 = ((fSlow0 * ((2.5703125000000003e-10 + fSlow6) - fSlow5)) + (fSlow18 * ((7.343750000000001e-10 + fSlow7) - (7.343750000000001e-10 * fSlow0))));
	double 	fSlow20 = (fConst1 * fSlow19);
	double 	fSlow21 = (((9.187500000000001e-07 * fSlow18) + (fSlow0 * (3.0182812500000004e-06 - fSlow1))) + (fSlow2 * (2.48125e-06 + (2.9448437500000007e-05 * fSlow0))));
	double 	fSlow22 = (fSlow21 + 2.48125e-07);
	...
	double 	fSlow29 = (fSlow28 + (fConst2 * (2.48125e-07 + (fSlow21 + fSlow26))));
	double 	fSlow30 = (fSlow28 - (fConst2 * (2.48125e-07 + (fSlow21 + fSlow20))));
