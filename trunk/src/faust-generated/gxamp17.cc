...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec18[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec19[0] + fRec19[2])) + (fRec44[0] + (1.8508996845035413 * fRec19[1]))) + -2.617753)))) + -153.04618518518518);
		...
		fRec9[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec10[0] + fRec10[2])) + (fRec46[0] + (1.8508996845035413 * fRec10[1]))) + -1.887332)))) + -124.17786666666666);
		...
		fRec0[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec1[0] + fRec1[2])) + (fRec47[0] + (1.8508996845035413 * fRec1[1]))) + -1.2569619999999999)))) + -96.711951219512201);
		fRec48[0] = (fSlow3 + (0.999 * fRec48[1]));
		buf[i] = FAUSTFLOAT((0.025000000000000001 * (fRec0[0] * fRec48[0])));
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
		fRec6[1] = fRec6[0];
		fRec8[1] = fRec8[0];
