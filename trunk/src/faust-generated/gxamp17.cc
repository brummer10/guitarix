...
#define fVslider3 (*fVslider3_)
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		fRec23[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double(((fTemp33 + (fRec49[0] + fTemp34)) + -2.617753)))) + -153.04618518518518);
		...
		double fTemp39 = ((fTemp38 + fTemp37) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec12[1]))) + 100000.0));
		fVec10[0] = fTemp39;
		fRec51[0] = (fConst14 * ((1500.0 * (fTemp39 + fVec10[1])) - (fConst15 * fRec51[1])));
		fRec12[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp37 + (fRec51[0] + fTemp38)) + -1.887332)))) + -124.17786666666666);
		...
		double fTemp42 = ((fTemp41 + fTemp40) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec1[1]))) + 100000.0));
		fVec11[0] = fTemp42;
		fRec52[0] = (fConst9 * ((820.0 * (fTemp42 + fVec11[1])) - (fConst10 * fRec52[1])));
		fRec1[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double(((fTemp40 + (fRec52[0] + fTemp41)) + -1.2569619999999999)))) + -96.711951219512201);
