namespace gxamp17 {
// generated from file '../src/faust/gxamp17.dsp'
...
void compute(int count, float *input0, float *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp25 = (fRec11[1] - 2.5e+02);
		fVec5[0] = fTemp25;
		...
		fRec11[0] = Ftube6(0, ((fTemp14 * ((fRec35[0] * (0.024937655860349125 + (fSlow14 * ((0.0997506234413965 - (0.0997506234413965 * fabs((0.024937655860349125 * (fRec35[0] * fTemp14))))) - 0.024937655860349125)))) + (fSlow12 * fRec22[0]))) + ((0.5 * (fTemp26 * (1 - (0.3333333333333333 * faustpower<2>(fTemp26))))) + (fRec34[0] + (fSlow11 * fRec12[0])))));
		fRec10[0] = ((fConst60 * ((fConst35 * fRec11[1]) + (fConst0 * fRec11[0]))) + (fConst2 * fRec10[1]));
		double fTemp27 = (fRec37[1] - 2.5e+02);
		fVec6[0] = fTemp27;
		fRec38[0] = ((fConst64 * (fVec6[0] + fVec6[1])) + (fConst63 * fRec38[1]));
		fRec37[0] = Ftube6(1, (fRec38[0] + fRec9[1]));
		...
		double fTemp31 = (fRec2[1] - 2.5e+02);
		fVec10[0] = fTemp31;
		fRec43[0] = ((fConst69 * (fVec10[0] + fVec10[1])) + (fConst68 * fRec43[1]));
		fRec2[0] = Ftube6(1, (fRec43[0] + fRec3[0]));
