...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp35 = (fTemp34 + fTemp33) / (double(Ranode(int(TUBE_TABLE_12AT7_68k), double(fRec25[1]))) + 100000.0);
		fVec8[0] = fTemp35;
		fRec51[0] = fConst71 * (2700.0 * (fTemp35 + fVec8[1]) - fConst72 * fRec51[1]);
		fRec25[0] = double(Ftube(int(TUBE_TABLE_12AT7_68k), double(fTemp33 + fRec51[0] + fTemp34 + -2.617753))) + -153.04618518518518;
		...
		double fTemp39 = (fTemp38 + fTemp37) / (double(Ranode(int(TUBE_TABLE_12AT7_250k), double(fRec13[1]))) + 100000.0);
		fVec10[0] = fTemp39;
		fRec54[0] = fConst17 * (1500.0 * (fTemp39 + fVec10[1]) - fConst18 * fRec54[1]);
		fRec13[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp37 + fRec54[0] + fTemp38 + -1.887332))) + -124.17786666666666;
		...
		fRec1[0] = double(Ftube(int(TUBE_TABLE_12AT7_250k), double(fTemp40 + fRec56[0] + fTemp41 + -1.2569619999999999))) + -96.711951219512201;
