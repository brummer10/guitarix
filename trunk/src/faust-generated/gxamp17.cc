...
#define fVslider3 (*fVslider3_)
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp33 = (fTemp31 + fTemp32) / (Ranode(TUBE_TABLE_12AT7_68k, fRec20[1]) + 1e+05);
		fVec7[0] = fTemp33;
		fRec46[0] = fConst64 * (2.7e+03 * (fTemp33 + fVec7[1]) - fConst63 * fRec46[1]);
		fRec20[0] = Ftube(TUBE_TABLE_12AT7_68k, fTemp32 + fRec46[0] + fTemp31 + -2.617753) + -153.04618518518518;
		...
		double fTemp37 = (fTemp35 + fTemp36) / (Ranode(TUBE_TABLE_12AT7_250k, fRec49[1]) + 1e+05);
		fVec8[0] = fTemp37;
		fRec52[0] = fConst67 * (1.5e+03 * (fTemp37 + fVec8[1]) - fConst66 * fRec52[1]);
		fRec49[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp36 + fRec52[0] + fTemp35 + -1.887332) + -124.17786666666666;
		...
		double fTemp42 = (fTemp40 + fTemp41) / (Ranode(TUBE_TABLE_12AT7_250k, fRec13[1]) + 1e+05);
		fVec10[0] = fTemp42;
		fRec54[0] = fConst67 * (1.5e+03 * (fTemp42 + fVec10[1]) - fConst66 * fRec54[1]);
		fRec13[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp41 + fRec54[0] + fTemp40 + -1.887332) + -124.17786666666666;
		...
		double fTemp46 = (fTemp44 + fTemp45) / (Ranode(TUBE_TABLE_12AT7_250k, fRec1[1]) + 1e+05);
		fVec11[0] = fTemp46;
		fRec56[0] = fConst6 * (8.2e+02 * (fTemp46 + fVec11[1]) - fConst5 * fRec56[1]);
		fRec1[0] = Ftube(TUBE_TABLE_12AT7_250k, fTemp45 + fRec56[0] + fTemp44 + -1.256962) + -96.7119512195122;
