...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst82 = std::tan((1643.0529578274618 / fConst0));
	...
	fConst86 = mydsp_faustpower2_f(fConst82);
	fConst87 = (1.0 / fConst86);
	fConst88 = (fConst83 + 1.0);
...
#define fCheckbox4 (*fCheckbox4_)
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		output0[i] = FAUSTFLOAT((iSlow0 ? fTemp63 : (double(input0[i]) + fTemp63)));
		fVec0[1] = fVec0[0];
		iVec1[1] = iVec1[0];
		fRec2[1] = fRec2[0];
		iRec0[1] = iRec0[0];
