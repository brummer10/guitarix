...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp3 = (2.0 * fRec11[1]);
		fRec12[0] = ((0.993 * fRec12[1]) + fSlow2);
		double fTemp4 = (2.49252253398618e-07 + (fConst1 * (fConst5 + (fConst3 * fRec12[0]))));
		double fTemp5 = (2.0 * fRec17[1]);
		double fTemp6 = (2.0 * fRec21[1]);
		double fTemp7 = (2.0 * fRec25[1]);
		...
		fRec25[0] = ((fConst56 * (fRec27[0] * (((((((((fConst55 * fRec26[0]) + (fConst54 * fRec26[1])) + (fConst53 * fRec26[2])) + (fConst52 * fRec26[3])) + (fConst51 * fRec26[4])) + (fConst50 * fRec26[5])) + (fConst47 * fRec26[6])) + (fConst44 * fRec26[7])) + (fConst41 * fRec26[8])))) - (fTemp7 + fRec25[2]));
		double fTemp8 = (fRec25[2] + (fRec25[0] + fTemp7));
		fVec0[0] = fTemp8;
		fRec24[0] = ((1.0000000000000002 * (fVec0[0] + fVec0[1])) - (0.9999999999999998 * fRec24[1]));
		fRec28[0] = ((fConst60 * fRec28[1]) + (fConst59 * (fRec23[1] + fRec23[2])));
		fRec23[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec28[0] + fRec24[0]) - 3.571981)) - 117.70440740740739);
		fRec22[0] = ((fConst65 * fRec22[1]) + (fConst64 * ((fConst61 * fRec23[0]) + (fConst62 * fRec23[1]))));
		fRec21[0] = (fRec22[0] - (fTemp6 + fRec21[2]));
		double fTemp9 = (fRec21[2] + (fRec21[0] + fTemp6));
		fVec1[0] = fTemp9;
		fRec20[0] = ((1.0000000000000002 * (fVec1[0] + fVec1[1])) - (0.9999999999999998 * fRec20[1]));
		fRec29[0] = ((fConst60 * fRec29[1]) + (fConst59 * (fRec19[1] + fRec19[2])));
		fRec19[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec29[0] + fRec20[0]) - 3.571981)) - 117.70440740740739);
		fRec18[0] = ((fConst65 * fRec18[1]) + (fConst64 * ((fConst61 * fRec19[0]) + (fConst62 * fRec19[1]))));
		fRec17[0] = (fRec18[0] - (fTemp5 + fRec17[2]));
		double fTemp10 = (fRec17[2] + (fRec17[0] + fTemp5));
		fVec2[0] = fTemp10;
		fRec16[0] = ((1.0000000000000002 * (fVec2[0] + fVec2[1])) - (0.9999999999999998 * fRec16[1]));
		fRec30[0] = ((fConst60 * fRec30[1]) + (fConst59 * (fRec15[1] + fRec15[2])));
		fRec15[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec30[0] + fRec16[0]) - 3.571981)) - 117.70440740740739);
		fRec14[0] = ((fConst65 * fRec14[1]) + (fConst64 * ((fConst61 * fRec15[0]) + (fConst62 * fRec15[1]))));
		fRec13[0] = (fRec14[0] - ((((fRec13[1] * (7.47756760195853e-07 + (fConst1 * (fConst15 + (fConst14 * fRec12[0]))))) + (fRec13[2] * (7.47756760195853e-07 + (fConst1 * (fConst13 + (fConst11 * fRec12[0])))))) + (fRec13[3] * (2.49252253398618e-07 + (fConst1 * (fConst9 + (fConst8 * fRec12[0])))))) / fTemp4));
		fRec11[0] = ((fConst21 * ((fRec27[0] * ((((fRec13[0] * ((fConst71 * fRec12[0]) + fConst70)) + (0.1 * (fRec13[1] * (fConst69 + (fConst1 * (0 - (1.03607375306884e-12 * fRec12[0]))))))) + (fRec13[2] * (fConst68 + (fConst66 * fRec12[0])))) + (0.1 * (fRec13[3] * (fConst7 + (fConst1 * (0 - (3.45357917689612e-13 * fRec12[0])))))))) / fTemp4)) - (fTemp3 + fRec11[2]));
		double fTemp11 = (fRec11[2] + (fRec11[0] + fTemp3));
		fVec3[0] = fTemp11;
		fRec10[0] = ((1.0000000000000002 * (fVec3[0] + fVec3[1])) - (0.9999999999999998 * fRec10[1]));
		fRec31[0] = ((fConst60 * fRec31[1]) + (fConst59 * (fRec9[1] + fRec9[2])));
		fRec9[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec31[0] + fRec10[0]) - 3.571981)) - 117.70440740740739);
		fRec8[0] = ((fConst65 * fRec8[1]) + (fConst64 * ((fConst61 * fRec9[0]) + (fConst62 * fRec9[1]))));
		fRec7[0] = (fRec8[0] - (fTemp2 + fRec7[2]));
		double fTemp12 = (fRec7[2] + (fRec7[0] + fTemp2));
		fVec4[0] = fTemp12;
		fRec6[0] = ((1.0000000000000002 * (fVec4[0] + fVec4[1])) - (0.9999999999999998 * fRec6[1]));
		fRec32[0] = ((fConst60 * fRec32[1]) + (fConst59 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec32[0] + fRec6[0]) - 3.571981)) - 117.70440740740739);
		fRec4[0] = ((fConst65 * fRec4[1]) + (fConst64 * ((fConst61 * fRec5[0]) + (fConst62 * fRec5[1]))));
		fRec3[0] = (fRec4[0] - (fTemp1 + fRec3[2]));
		double fTemp13 = (fRec3[2] + (fRec3[0] + fTemp1));
		fVec5[0] = fTemp13;
		fRec2[0] = ((1.0000000000000002 * (fVec5[0] + fVec5[1])) - (0.9999999999999998 * fRec2[1]));
		fRec33[0] = ((fConst60 * fRec33[1]) + (fConst59 * (fRec1[1] + fRec1[2])));
		fRec1[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec33[0] + fRec2[0]) - 3.571981)) - 117.70440740740739);
