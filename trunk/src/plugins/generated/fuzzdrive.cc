...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst50 = ((0.5 * (fConst20 * ((fConst20 * (1.64126469795529e-29 + (9.07159590649613e-39 * fConst20))) - 9.17208598672714e-23))) + (1.32343844239659e-16 + (fConst20 * (4.03311563739464e-20 + (fConst20 * ((8.20590226560988e-39 * fConst20) - 3.96129387282593e-27))))));
