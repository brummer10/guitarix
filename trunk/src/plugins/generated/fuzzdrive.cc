...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec2[0] = ((fSlow1 * fTemp1) - (fConst37 * ((((((((fConst35 * fRec2[1]) + (fConst34 * fRec2[2])) + (fConst33 * fRec2[3])) + (fConst32 * fRec2[4])) + (fConst31 * fRec2[5])) + (fConst27 * fRec2[6])) + (fConst23 * fRec2[7])) + (fConst18 * fRec2[8]))));
		fRec3[0] = ((0.993 * fRec3[1]) + fSlow2);
		fRec1[0] = ((0.4 * min(2.7514, max(-2.4514, (fConst55 * (fRec3[0] * (((((((((fConst54 * fRec2[0]) + (fConst53 * fRec2[1])) + (fConst52 * fRec2[2])) + (fConst51 * fRec2[3])) + (fConst50 * fRec2[4])) + (fConst49 * fRec2[5])) + (fConst46 * fRec2[6])) + (fConst43 * fRec2[7])) + (fConst40 * fRec2[8]))))))) - ((((fRec1[1] * (7.47756760195853e-07 + (fConst0 * (fConst14 + (fConst13 * fRec0[0]))))) + (fRec1[2] * (7.47756760195853e-07 + (fConst0 * (fConst12 + (fConst10 * fRec0[0])))))) + (fRec1[3] * (2.49252253398618e-07 + (fConst0 * (fConst8 + (fConst7 * fRec0[0])))))) / fTemp0));
		output0[i] = (FAUSTFLOAT)((fSlow3 * fTemp1) + (0.4 * min(2.7514, max(-2.4514, (fConst20 * ((fRec3[0] * ((((fRec1[0] * ((fConst61 * fRec0[0]) + fConst60)) + (0.1 * (fRec1[1] * (fConst59 + (fConst0 * (0 - (1.03607375306884e-12 * fRec0[0]))))))) + (fRec1[2] * (fConst58 + (fConst56 * fRec0[0])))) + (0.1 * (fRec1[3] * (fConst6 + (fConst0 * (0 - (3.45357917689612e-13 * fRec0[0])))))))) / fTemp0))))));
		// post processing
...
{
	reg.registerVar("fuzzdrive.Distortion",N_("Drive"),"S","",&fslider0, 0.5, 0.0, 0.99, 0.01);
	reg.registerVar("fuzzdrive.Level",N_("Level"),"S","",&fslider2, 0.5, 0.0, 1.0, 0.01);
	reg.registerVar("fuzzdrive.wet_dry",N_("wet/dry"),"S",N_("percentage of processed signal in output signal"),&fslider1, 1e+02, 0.0, 1e+02, 1.0);
	return 0;
}
