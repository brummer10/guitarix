...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; (i0 < ReCount); i0 = (i0 + 1)) {
		...
		double fElse0 = (fTemp7 + fRec0[1]);
		fRec0[0] = (iTemp0 ? fElse0 : fTemp7);
		...
		fVec4[0] = fTemp14;
		fRec14[0] = (fConst3 * ((fTemp14 - fVec4[1]) + (fConst4 * fRec14[1])));
		...
		fVec6[0] = fTemp21;
		fRec25[0] = (fConst3 * ((fTemp21 - fVec6[1]) + (fConst4 * fRec25[1])));
		double fTemp22 = std::max<double>(fConst1, std::fabs(fRec25[0]));
		double fElse6 = (fTemp22 + fRec22[1]);
		fRec22[0] = (iTemp16 ? fElse6 : fTemp22);
		int iElse7 = (iRec23[1] + 1);
		iRec23[0] = (iTemp16 ? iElse7 : 1);
		double fThen8 = (0.000244140625 * fRec22[1]);
		fRec24[0] = (iTemp16 ? fRec24[1] : fThen8);
		...
		fVec8[0] = fTemp27;
		fRec35[0] = (fConst3 * ((fTemp27 - fVec8[1]) + (fConst4 * fRec35[1])));
		double fTemp28 = std::max<double>(fConst1, std::fabs(fRec35[0]));
		double fElse9 = (fTemp28 + fRec32[1]);
		fRec32[0] = (iTemp23 ? fElse9 : fTemp28);
		int iElse10 = (iRec33[1] + 1);
		iRec33[0] = (iTemp23 ? iElse10 : 1);
		double fThen11 = (0.000244140625 * fRec32[1]);
		fRec34[0] = (iTemp23 ? fRec34[1] : fThen11);
		...
		fVec9[0] = fTemp31;
		fRec44[0] = (fConst3 * ((fTemp31 - fVec9[1]) + (fConst4 * fRec44[1])));
		double fTemp32 = std::max<double>(fConst1, std::fabs(fRec44[0]));
		double fElse12 = (fTemp32 + fRec41[1]);
		fRec41[0] = (iTemp29 ? fElse12 : fTemp32);
		int iElse13 = (iRec42[1] + 1);
		iRec42[0] = (iTemp29 ? iElse13 : 1);
		double fThen14 = (0.000244140625 * fRec41[1]);
		fRec43[0] = (iTemp29 ? fRec43[1] : fThen14);
