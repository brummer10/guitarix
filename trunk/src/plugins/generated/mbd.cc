...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fSlow7 = (fSlow5 + 1.0000000000000004) / fSlow1 + 1.0;
	...
	double fSlow14 = (fSlow13 + -1.0000000000000004) / fSlow9 + 1.0;
	double fSlow15 = (fSlow13 + 1.0000000000000004) / fSlow9 + 1.0;
	double fSlow16 = 1.0 / fSlow15;
	double fSlow17 = std::tan(fConst2 * double(fHslider2));
	...
	double fSlow22 = (fSlow21 + -1.0000000000000004) / fSlow17 + 1.0;
	double fSlow23 = (fSlow21 + 1.0000000000000004) / fSlow17 + 1.0;
	double fSlow24 = 1.0 / fSlow23;
	double fSlow25 = std::tan(fConst2 * double(fHslider3));
	...
	double fSlow30 = (fSlow29 + -1.0000000000000004) / fSlow25 + 1.0;
	double fSlow31 = (fSlow29 + 1.0000000000000004) / fSlow25 + 1.0;
	double fSlow32 = 1.0 / fSlow31;
	double fSlow33 = 1.0 - fSlow29;
	double fSlow34 = fSlow29 + 1.0;
	double fSlow35 = 1.0 / fSlow34;
	double fSlow36 = 1.0 - fSlow21;
	double fSlow37 = fSlow21 + 1.0;
	double fSlow38 = 1.0 / fSlow37;
	double fSlow39 = 1.0 - fSlow13;
	double fSlow40 = fSlow13 + 1.0;
	double fSlow41 = 1.0 / fSlow40;
	double fSlow42 = 1.0 - fSlow5;
	double fSlow43 = fSlow5 + 1.0;
	double fSlow44 = 1.0 / fSlow43;
	double fSlow45 = std::pow(1e+01, 2.0 * double(fHslider4)) / fSlow7;
	double fSlow46 = 0.0010000000000000009 * double(fHslider5);
	double fSlow47 = 1.0 / (fSlow1 * fSlow15);
	double fSlow48 = 0.0 - 1.0 / (fSlow1 * fSlow43);
	double fSlow49 = 0.0 - 2.0 / fSlow2;
	double fSlow50 = std::pow(1e+01, 2.0 * double(fHslider6)) / fSlow7;
	double fSlow51 = 0.0010000000000000009 * double(fHslider7);
	double fSlow52 = 1.0 - fSlow42 / fSlow1;
	double fSlow53 = 1.0 / (fSlow43 / fSlow1 + 1.0);
	double fSlow54 = 1.0 / (fSlow9 * fSlow23);
	double fSlow55 = 0.0 - 1.0 / (fSlow9 * fSlow40);
	double fSlow56 = 0.0 - 2.0 / fSlow10;
	double fSlow57 = std::pow(1e+01, 2.0 * double(fHslider8));
	double fSlow58 = 0.0010000000000000009 * double(fHslider9);
	double fSlow59 = 1.0 - fSlow39 / fSlow9;
	double fSlow60 = 1.0 / (fSlow40 / fSlow9 + 1.0);
	double fSlow61 = 1.0 / (fSlow31 * fSlow17);
	double fSlow62 = 0.0 - 1.0 / (fSlow17 * fSlow37);
	double fSlow63 = 0.0 - 2.0 / fSlow18;
	double fSlow64 = std::pow(1e+01, 2.0 * double(fHslider10));
	double fSlow65 = 0.0010000000000000009 * double(fHslider11);
	double fSlow66 = 1.0 - fSlow36 / fSlow17;
	double fSlow67 = 1.0 / (fSlow37 / fSlow17 + 1.0);
	double fSlow68 = 0.0 - 1.0 / (fSlow25 * fSlow34);
	double fSlow69 = 0.0 - 2.0 / fSlow26;
	double fSlow70 = std::pow(1e+01, 2.0 * double(fHslider12));
	double fSlow71 = 0.0010000000000000009 * double(fHslider13);
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		fVec1[0] = fTemp1;
		fRec12[0] = 0.0 - fSlow35 * (fSlow33 * fRec12[1] - (fTemp1 + fVec1[1]));
		fRec11[0] = fRec12[0] - fSlow32 * (fSlow30 * fRec11[2] + fSlow28 * fRec11[1]);
		double fTemp2 = fRec11[2] + fRec11[0] + 2.0 * fRec11[1];
		double fTemp3 = fSlow32 * fTemp2;
		fVec2[0] = fTemp3;
		fRec10[0] = 0.0 - fSlow38 * (fSlow36 * fRec10[1] - (fTemp3 + fVec2[1]));
		fRec9[0] = fRec10[0] - fSlow24 * (fSlow22 * fRec9[2] + fSlow20 * fRec9[1]);
		double fTemp4 = fRec9[2] + fRec9[0] + 2.0 * fRec9[1];
		double fTemp5 = fSlow24 * fTemp4;
		fVec3[0] = fTemp5;
		fRec8[0] = 0.0 - fSlow41 * (fSlow39 * fRec8[1] - (fTemp5 + fVec3[1]));
		...
		fVec4[0] = fTemp7;
		fRec6[0] = 0.0 - fSlow44 * (fSlow42 * fRec6[1] - (fTemp7 + fVec4[1]));
		fRec5[0] = fRec6[0] - fSlow8 * (fSlow6 * fRec5[2] + fSlow4 * fRec5[1]);
		fRec14[0] = fSlow46 + 0.999 * fRec14[1];
		double fTemp8 = std::max<double>(-1.0, std::min<double>(1.0, fRec14[0] + fSlow45 * (fRec5[2] + fRec5[0] + 2.0 * fRec5[1])));
		...
		fRec1[0] = ((iTemp0) ? fTemp10 + fRec1[1] : fTemp10);
		iRec2[0] = ((iTemp0) ? iRec2[1] + 1 : 1);
		fRec3[0] = ((iTemp0) ? fRec3[1] : 0.000244140625 * fRec1[1]);
		fVbargraph0 = FAUSTFLOAT(fRec3[0]);
		int iTemp11 = iRec16[1] < 4096;
		fRec20[0] = fSlow48 * fVec4[1] - fSlow44 * (fSlow42 * fRec20[1] - fSlow47 * fTemp6);
		fRec19[0] = fRec20[0] - fSlow8 * (fSlow6 * fRec19[2] + fSlow4 * fRec19[1]);
		fRec21[0] = fSlow51 + 0.999 * fRec21[1];
		double fTemp12 = std::max<double>(-1.0, std::min<double>(1.0, fRec21[0] + fSlow50 * (fSlow3 * fRec19[0] + fSlow49 * fRec19[1] + fSlow3 * fRec19[2])));
		double fTemp13 = fTemp12 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp12));
		fVec6[0] = fTemp13;
		fRec18[0] = fConst4 * (fTemp13 - fVec6[1] + fConst3 * fRec18[1]);
		double fTemp14 = std::max<double>(fConst1, std::fabs(fRec18[0]));
		fRec15[0] = ((iTemp11) ? fTemp14 + fRec15[1] : fTemp14);
		iRec16[0] = ((iTemp11) ? iRec16[1] + 1 : 1);
		fRec17[0] = ((iTemp11) ? fRec17[1] : 0.000244140625 * fRec15[1]);
		fVbargraph1 = FAUSTFLOAT(fRec17[0]);
		int iTemp15 = iRec23[1] < 4096;
		double fTemp16 = fSlow4 * fRec26[1];
		fRec28[0] = fSlow55 * fVec3[1] - fSlow41 * (fSlow39 * fRec28[1] - fSlow54 * fTemp4);
		fRec27[0] = fRec28[0] - fSlow16 * (fSlow14 * fRec27[2] + fSlow12 * fRec27[1]);
		fRec26[0] = fSlow16 * (fSlow11 * fRec27[0] + fSlow56 * fRec27[1] + fSlow11 * fRec27[2]) - fSlow53 * (fSlow52 * fRec26[2] + fTemp16);
		fRec29[0] = fSlow58 + 0.999 * fRec29[1];
		double fTemp17 = std::max<double>(-1.0, std::min<double>(1.0, fRec29[0] + fSlow57 * (fRec26[2] + fSlow53 * (fTemp16 + fSlow52 * fRec26[0]))));
		double fTemp18 = fTemp17 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp17));
		fVec7[0] = fTemp18;
		fRec25[0] = fConst4 * (fTemp18 - fVec7[1] + fConst3 * fRec25[1]);
		double fTemp19 = std::max<double>(fConst1, std::fabs(fRec25[0]));
		fRec22[0] = ((iTemp15) ? fTemp19 + fRec22[1] : fTemp19);
		iRec23[0] = ((iTemp15) ? iRec23[1] + 1 : 1);
		fRec24[0] = ((iTemp15) ? fRec24[1] : 0.000244140625 * fRec22[1]);
		fVbargraph2 = FAUSTFLOAT(fRec24[0]);
		int iTemp20 = iRec31[1] < 4096;
		double fTemp21 = fSlow4 * fRec34[1];
		double fTemp22 = fSlow12 * fRec35[1];
		fRec37[0] = fSlow62 * fVec2[1] - fSlow38 * (fSlow36 * fRec37[1] - fSlow61 * fTemp2);
		fRec36[0] = fRec37[0] - fSlow24 * (fSlow22 * fRec36[2] + fSlow20 * fRec36[1]);
		fRec35[0] = fSlow24 * (fSlow19 * fRec36[0] + fSlow63 * fRec36[1] + fSlow19 * fRec36[2]) - fSlow60 * (fSlow59 * fRec35[2] + fTemp22);
		fRec34[0] = fRec35[2] + fSlow60 * (fTemp22 + fSlow59 * fRec35[0]) - fSlow53 * (fSlow52 * fRec34[2] + fTemp21);
		fRec38[0] = fSlow65 + 0.999 * fRec38[1];
		double fTemp23 = std::max<double>(-1.0, std::min<double>(1.0, fRec38[0] + fSlow64 * (fRec34[2] + fSlow53 * (fTemp21 + fSlow52 * fRec34[0]))));
		double fTemp24 = fTemp23 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp23));
		fVec8[0] = fTemp24;
		fRec33[0] = fConst4 * (fTemp24 - fVec8[1] + fConst3 * fRec33[1]);
		double fTemp25 = std::max<double>(fConst1, std::fabs(fRec33[0]));
		fRec30[0] = ((iTemp20) ? fTemp25 + fRec30[1] : fTemp25);
		iRec31[0] = ((iTemp20) ? iRec31[1] + 1 : 1);
		fRec32[0] = ((iTemp20) ? fRec32[1] : 0.000244140625 * fRec30[1]);
		fVbargraph3 = FAUSTFLOAT(fRec32[0]);
		int iTemp26 = iRec40[1] < 4096;
		double fTemp27 = fSlow4 * fRec43[1];
		double fTemp28 = fSlow12 * fRec44[1];
		double fTemp29 = fSlow20 * fRec45[1];
		fRec47[0] = fSlow68 * fVec1[1] - fSlow35 * (fSlow33 * fRec47[1] - fSlow29 * fTemp1);
		fRec46[0] = fRec47[0] - fSlow32 * (fSlow30 * fRec46[2] + fSlow28 * fRec46[1]);
		fRec45[0] = fSlow32 * (fSlow27 * fRec46[0] + fSlow69 * fRec46[1] + fSlow27 * fRec46[2]) - fSlow67 * (fSlow66 * fRec45[2] + fTemp29);
		fRec44[0] = fRec45[2] + fSlow67 * (fTemp29 + fSlow66 * fRec45[0]) - fSlow60 * (fSlow59 * fRec44[2] + fTemp28);
		fRec43[0] = fRec44[2] + fSlow60 * (fTemp28 + fSlow59 * fRec44[0]) - fSlow53 * (fSlow52 * fRec43[2] + fTemp27);
		fRec48[0] = fSlow71 + 0.999 * fRec48[1];
		double fTemp30 = std::max<double>(-1.0, std::min<double>(1.0, fRec48[0] + fSlow70 * (fRec43[2] + fSlow53 * (fTemp27 + fSlow52 * fRec43[0]))));
		double fTemp31 = fTemp30 * (1.0 - 0.3333333333333333 * mydsp_faustpower2_f(fTemp30));
		fVec9[0] = fTemp31;
		fRec42[0] = fConst4 * (fTemp31 - fVec9[1] + fConst3 * fRec42[1]);
		double fTemp32 = std::max<double>(fConst1, std::fabs(fRec42[0]));
		fRec39[0] = ((iTemp26) ? fTemp32 + fRec39[1] : fTemp32);
		iRec40[0] = ((iTemp26) ? iRec40[1] + 1 : 1);
		fRec41[0] = ((iTemp26) ? fRec41[1] : 0.000244140625 * fRec39[1]);
