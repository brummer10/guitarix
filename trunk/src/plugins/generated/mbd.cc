...
void always_inline Dsp::compute(int count, float *input0, float *output0)
{
	...
	double 	fSlow23 = (0.0010000000000000009 * fslider2);
	double 	fSlow24 = (0.0010000000000000009 * fslider3);
	double 	fSlow25 = (0 - fSlow12);
	double 	fSlow26 = (2 * (0 - fSlow10));
	double 	fSlow27 = (0.0010000000000000009 * fslider4);
	double 	fSlow28 = (0.0010000000000000009 * fslider5);
	...
	double 	fSlow42 = (0.0010000000000000009 * fslider7);
	double 	fSlow43 = (0.0010000000000000009 * fslider8);
	...
	double 	fSlow56 = (0.0010000000000000009 * fslider10);
	double 	fSlow57 = (0.0010000000000000009 * fslider11);
	double 	fSlow58 = (0.0010000000000000009 * fslider12);
	double 	fSlow59 = (0.0010000000000000009 * fslider13);
	double 	fSlow60 = (0.0010000000000000009 * pow(10,(0.05 * fslider14)));
	for (int i=0; i<count; i++) {
		...
		fRec5[0] = (fSlow23 + (0.999 * fRec5[1]));
		fRec6[0] = (fSlow24 + (0.999 * fRec6[1]));
		double fTemp3 = max((double)-1, min((double)1, (fRec6[0] + (fSlow6 * (pow(1e+01,(2 * fRec5[0])) * (((fSlow1 * fRec0[0]) + (fSlow22 * fRec0[1])) + (fSlow1 * fRec0[2])))))));
		fRec8[0] = ((fSlow18 * ((fSlow25 * fVec1[1]) + (fSlow12 * fVec1[0]))) + (fSlow17 * fRec8[1]));
		fRec7[0] = (fRec8[0] - (fSlow15 * ((fSlow13 * fRec7[2]) + (fSlow11 * fRec7[1]))));
		fRec9[0] = (fSlow27 + (0.999 * fRec9[1]));
		fRec10[0] = (fSlow28 + (0.999 * fRec10[1]));
		double fTemp4 = max((double)-1, min((double)1, (fRec10[0] + (fSlow15 * (pow(1e+01,(2 * fRec9[0])) * (((fSlow10 * fRec7[0]) + (fSlow26 * fRec7[1])) + (fSlow10 * fRec7[2])))))));
		fRec14[0] = ((fSlow21 * fTemp1) + (fSlow8 * fRec14[1]));
		fRec13[0] = (fRec14[0] - (fSlow6 * ((fSlow4 * fRec13[2]) + (fSlow2 * fRec13[1]))));
		double fTemp5 = (fRec13[2] + (fRec13[0] + (2 * fRec13[1])));
		fVec3[0] = (fSlow6 * fTemp5);
		fRec12[0] = ((fSlow40 * ((fSlow39 * fVec3[1]) + (fSlow38 * fTemp5))) + (fSlow37 * fRec12[1]));
		fRec11[0] = (fRec12[0] - (fSlow35 * ((fSlow33 * fRec11[2]) + (fSlow31 * fRec11[1]))));
		fRec15[0] = (fSlow42 + (0.999 * fRec15[1]));
		fRec16[0] = (fSlow43 + (0.999 * fRec16[1]));
		double fTemp6 = max((double)-1, min((double)1, (fRec16[0] + (fSlow35 * (pow(1e+01,(2 * fRec15[0])) * (((fSlow30 * fRec11[0]) + (fSlow41 * fRec11[1])) + (fSlow30 * fRec11[2])))))));
		fRec20[0] = ((fSlow40 * fTemp1) + (fSlow37 * fRec20[1]));
		fRec19[0] = (fRec20[0] - (fSlow35 * ((fSlow33 * fRec19[2]) + (fSlow31 * fRec19[1]))));
		double fTemp7 = (fRec19[2] + (fRec19[0] + (2 * fRec19[1])));
		fVec4[0] = (fSlow35 * fTemp7);
		fRec18[0] = ((fSlow54 * ((fSlow53 * fVec4[1]) + (fSlow52 * fTemp7))) + (fSlow51 * fRec18[1]));
		fRec17[0] = (fRec18[0] - (fSlow49 * ((fSlow48 * fRec17[2]) + (fSlow46 * fRec17[1]))));
		fRec21[0] = (fSlow56 + (0.999 * fRec21[1]));
		fRec22[0] = (fSlow57 + (0.999 * fRec22[1]));
		double fTemp8 = max((double)-1, min((double)1, (fRec22[0] + (fSlow49 * (pow(1e+01,(2 * fRec21[0])) * (((fSlow45 * fRec17[0]) + (fSlow55 * fRec17[1])) + (fSlow45 * fRec17[2])))))));
		fRec24[0] = ((fSlow54 * fTemp1) + (fSlow51 * fRec24[1]));
		fRec23[0] = (fRec24[0] - (fSlow49 * ((fSlow48 * fRec23[2]) + (fSlow46 * fRec23[1]))));
		fRec25[0] = (fSlow58 + (0.999 * fRec25[1]));
		fRec26[0] = (fSlow59 + (0.999 * fRec26[1]));
		double fTemp9 = max((double)-1, min((double)1, (fRec26[0] + (fSlow49 * (pow(1e+01,(2 * fRec25[0])) * (fRec23[2] + (fRec23[0] + (2 * fRec23[1]))))))));
		fRec27[0] = (fSlow60 + (0.999 * fRec27[1]));
		output0[i] = (FAUSTFLOAT)(fRec27[0] * ((fTemp9 * (1 - (0.3333333333333333 * faustpower<2>(fTemp9)))) + ((fTemp8 * (1 - (0.3333333333333333 * faustpower<2>(fTemp8)))) + ((fTemp6 * (1 - (0.3333333333333333 * faustpower<2>(fTemp6)))) + ((fTemp4 * (1 - (0.3333333333333333 * faustpower<2>(fTemp4)))) + (fTemp3 * (1 - (0.3333333333333333 * faustpower<2>(fTemp3)))))))));
		// post processing
		fRec27[1] = fRec27[0];
		fRec26[1] = fRec26[0];
		fRec25[1] = fRec25[0];
