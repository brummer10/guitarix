...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp3 = (1.07025933546545e-08 + ((fConst7 * fRec8[0]) + (fConst1 * ((fRec9[0] * (fConst6 + (fConst5 * fRec8[0]))) + fConst3))));
		double fTemp4 = (1.65780932898435e-16 * fRec8[0]);
		fRec10[0] = ((fSlow0 * fTemp0) - (((((fRec10[1] * (4.2810373418618e-08 + ((fConst32 * fRec8[0]) + (fConst1 * ((fRec9[0] * (fConst31 + (fConst30 * fRec8[0]))) + fConst29))))) + (fRec10[2] * (6.4215560127927e-08 + ((fConst28 * fRec8[0]) + (fConst17 * (fConst27 + (fRec9[0] * (fConst26 + (fConst24 * fRec8[0]))))))))) + (fRec10[3] * (4.2810373418618e-08 + ((fConst22 * fRec8[0]) + (fConst1 * ((fRec9[0] * (fConst21 + (fConst20 * fRec8[0]))) + fConst18)))))) + (fRec10[4] * (1.07025933546545e-08 + ((fConst15 * fRec8[0]) + (fConst1 * ((fRec9[0] * (fConst14 + (fConst13 * fRec8[0]))) + fConst12)))))) / fTemp3));
		double fTemp5 = (3.3156186579687e-16 * fRec8[0]);
		double fTemp6 = (1.55382382721868e-13 + fTemp5);
		double fTemp7 = ((0 - fTemp5) - 1.55382382721868e-13);
		fRec11[0] = ((0.993 * fRec11[1]) + fSlow4);
		fRec7[0] = ((fConst17 * ((fRec11[0] * (((((fRec10[0] * ((fConst34 + (fConst33 * fRec8[0])) + (fConst1 * (fRec9[0] * (7.76911913609341e-14 + fTemp4))))) + (fConst1 * (fRec10[1] * (fTemp6 + (fRec9[0] * fTemp7))))) + (fRec10[2] * (7.77265055388254e-10 + (1.65856287867935e-12 * fRec8[0])))) + (fConst1 * (fRec10[3] * (fTemp7 + (fRec9[0] * fTemp6))))) + (fRec10[4] * ((fConst11 + (fConst9 * fRec8[0])) + (fConst1 * (fRec9[0] * ((0 - fTemp4) - 7.76911913609341e-14))))))) / fTemp3)) - (fTemp2 + fRec7[2]));
		double fTemp8 = (fRec7[2] + (fRec7[0] + fTemp2));
		fVec0[0] = fTemp8;
		fRec6[0] = ((1.0000000000000002 * (fVec0[0] + fVec0[1])) - (0.9999999999999998 * fRec6[1]));
		fRec12[0] = ((fConst38 * fRec12[1]) + (fConst37 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec12[0] + fRec6[0]) - 5.571981)) - 43.63033333333331);
		fRec4[0] = ((fConst43 * fRec4[1]) + (fConst42 * ((fConst39 * fRec5[0]) + (fConst40 * fRec5[1]))));
		...
		fRec13[0] = ((fConst38 * fRec13[1]) + (fConst37 * (fRec1[1] + fRec1[2])));
		fRec1[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec13[0] + fRec2[0]) - 5.571981)) - 43.63033333333331);
