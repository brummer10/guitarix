...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp2 = (6.02046684079309e-07 + ((fConst13 * fRec8[0]) + (fConst1 * ((fRec9[0] * (((fRec9[0] * (fConst11 + (fConst10 * fRec8[0]))) + (fConst9 * fRec8[0])) + fConst6)) + fConst3))));
		double fTemp3 = (1.00499515996459e-12 * fRec8[0]);
		fRec10[0] = ((double)input0[i] - ((((fRec10[1] * (1.80614005223793e-06 + ((fConst37 * fRec8[0]) + (fConst1 * ((fRec9[0] * (((fRec9[0] * (fConst36 + (fConst35 * fRec8[0]))) + (fConst34 * fRec8[0])) + fConst32)) + fConst30))))) + (fRec10[2] * (1.80614005223793e-06 + ((fConst29 * fRec8[0]) + (fConst1 * (fConst27 + (fRec9[0] * (fConst25 + ((fRec9[0] * (fConst24 + (fConst22 * fRec8[0]))) + (fConst21 * fRec8[0])))))))))) + (fRec10[3] * (6.02046684079309e-07 + ((fConst19 * fRec8[0]) + (fConst1 * ((fRec9[0] * (((fRec9[0] * (fConst18 + (fConst17 * fRec8[0]))) + (fConst16 * fRec8[0])) + fConst15)) + fConst14)))))) / fTemp2));
		double fTemp4 = (3.01498547989378e-12 * fRec8[0]);
		fRec11[0] = ((0.993 * fRec11[1]) + fSlow2);
		fRec7[0] = ((fConst38 * (((fRec9[0] * fRec11[0]) * ((((fRec10[0] * (fTemp3 - 1.18589428875822e-12)) + (fRec10[1] * (3.55768286627466e-12 + (0 - fTemp4)))) + (fRec10[2] * (fTemp4 - 3.55768286627466e-12))) + (fRec10[3] * (1.18589428875822e-12 + (0 - fTemp3))))) / fTemp2)) - (fTemp1 + fRec7[2]));
		...
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec12[0] + fRec6[0]) - 3.571981)) - 117.70440740740739);
