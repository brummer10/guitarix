...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i = 0; (i < ReCount); i = (i + 1)) {
		...
		double fTemp2 = double(Ftrany(int(TRANY_TABLE_KT88_68k), double(((fTemp1 + (2700.0 * (fTemp1 / (double(Rtrany(int(TRANY_TABLE_KT88_68k), double(fRecCl5[1]))) + 100000.0)))) + -5.5628950000000001))));
		fRecCl5[0] = ((fTemp2 + (0.0020603314814814817 * (double(Rtrany(int(TRANY_TABLE_KT88_68k), double(fTemp2))) + 100000.0))) + -250.0);
		...
		double fTemp4 = double(Ftrany(int(TRANY_TABLE_KT88_68k), double(((fTemp3 + (2700.0 * (fTemp3 / (double(Rtrany(int(TRANY_TABLE_KT88_68k), double(fRecCl1[1]))) + 100000.0)))) + -5.5628950000000001))));
		fRecCl1[0] = ((fTemp4 + (0.0020603314814814817 * (double(Rtrany(int(TRANY_TABLE_KT88_68k), double(fTemp4))) + 100000.0))) + -250.0);
