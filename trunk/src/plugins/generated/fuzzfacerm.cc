...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst19 = 2.23179427996828e-12 * fConst0;
	fConst20 = fConst19 + -2.84573463334658e-11;
	double fConst21 = 2.27734110200845e-12 * fConst0;
	...
	double fConst61 = 6.69538283990485e-12 * fConst0;
	fConst62 = 2.84573463334658e-11 - fConst61;
	double fConst63 = 6.83202330602535e-12 * fConst0;
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		output0[i0] = FAUSTFLOAT((fRec2[0] * (fConst24 * fRec1[0] * (fTemp1 + fRec1[0] * (fTemp2 + -4.57075782744711e-14) + -2.23163352373398e-12) + fConst23 * (fConst68 + fConst67 * fRec0[0])) + fRec2[1] * (fConst24 * fRec1[0] * (fRec1[0] * (0.0 - fTemp3 + 1.37122734823413e-13) - fTemp4 + 6.69490057120194e-12) + fConst23 * (fConst66 + fConst65 * fRec0[0])) + fRec2[2] * (fConst24 * fRec1[0] * (fTemp4 + fRec1[0] * (fTemp3 + -1.37122734823413e-13) + -6.69490057120194e-12) + fConst23 * (fConst64 + fConst62 * fRec0[0])) + fRec2[3] * (fConst24 * fRec1[0] * (fRec1[0] * (0.0 - fTemp2 + 4.57075782744711e-14) - fTemp1 + 2.23163352373398e-12) + fConst23 * (fConst22 + fConst20 * fRec0[0]))) / fTemp0);
		fRec0[1] = fRec0[0];
		fRec1[1] = fRec1[0];
