...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst83 = 8.4412399684057e-14 * fConst0;
	fConst84 = fConst16 * (6.459042388838901e-13 - fConst83);
	fConst85 = 1.240862275355639e-13 * fConst0;
