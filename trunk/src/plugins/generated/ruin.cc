...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	double fConst19 = 3.23341143501596e-10 * fConst0;
	fConst20 = fConst19 + 1.83849805831657e-06;
	double fConst21 = 2.50211258533327e-10 * fConst0;
