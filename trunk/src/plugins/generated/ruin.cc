...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst56 = (0.4651423962661957 * faustpower<3>(fConst1));
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fVec0[0] = fTemp6;
		fRec7[0] = ((fConst56 * (fVec0[0] + fVec0[1])) - (0.8605695850647829 * fRec7[1]));
		fRec6[0] = (fRec7[0] - ((1.8405051250752198 * fRec6[1]) + (0.8612942439318627 * fRec6[2])));
		fRec11[0] = ((fConst60 * fRec11[1]) + (fConst59 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftrany(TRANY_TABLE_SVEL34_250k, ((fRec11[0] + (0.9254498422517706 * (fRec6[2] + (fRec6[0] + (2.0 * fRec6[1]))))) - 3.571981)) - 117.70440740740739);
