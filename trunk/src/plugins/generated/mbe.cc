...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		double fTemp14 = ((fRec25[1] != 0.0) ? (((fRec26[1] > 0.0) & (fRec26[1] < 1.0)) ? fRec25[1] : 0.0) : (((fRec26[1] == 0.0) & (fSlow50 != fRec27[1])) ? fConst4 : (((fRec26[1] == 1.0) & (fSlow50 != fRec28[1])) ? fConst5 : 0.0)));
		fRec25[0] = fTemp14;
		...
		fRec14[0] = (iTemp9 ? (fTemp17 + fRec14[1]) : fTemp17);
		iRec15[0] = (iTemp9 ? (iRec15[1] + 1) : 1);
		fRec16[0] = (iTemp9 ? fRec16[1] : (0.000244140625 * fRec14[1]));
		...
		double fTemp22 = ((fRec39[1] != 0.0) ? (((fRec40[1] > 0.0) & (fRec40[1] < 1.0)) ? fRec39[1] : 0.0) : (((fRec40[1] == 0.0) & (fSlow59 != fRec41[1])) ? fConst4 : (((fRec40[1] == 1.0) & (fSlow59 != fRec42[1])) ? fConst5 : 0.0)));
		fRec39[0] = fTemp22;
		...
		fRec29[0] = (iTemp18 ? (fTemp25 + fRec29[1]) : fTemp25);
		iRec30[0] = (iTemp18 ? (iRec30[1] + 1) : 1);
		fRec31[0] = (iTemp18 ? fRec31[1] : (0.000244140625 * fRec29[1]));
		fVbargraph2 = FAUSTFLOAT(fRec31[0]);
		int iTemp26 = (iRec44[1] < 4096);
		fRec47[0] = (fSlow60 + (0.999 * fRec47[1]));
		double fTemp27 = ((fRec48[1] != 0.0) ? (((fRec49[1] > 0.0) & (fRec49[1] < 1.0)) ? fRec48[1] : 0.0) : (((fRec49[1] == 0.0) & (fSlow61 != fRec50[1])) ? fConst4 : (((fRec49[1] == 1.0) & (fSlow61 != fRec51[1])) ? fConst5 : 0.0)));
		fRec48[0] = fTemp27;
		...
		fRec43[0] = (iTemp26 ? (fTemp32 + fRec43[1]) : fTemp32);
		iRec44[0] = (iTemp26 ? (iRec44[1] + 1) : 1);
		fRec45[0] = (iTemp26 ? fRec45[1] : (0.000244140625 * fRec43[1]));
		fVbargraph3 = FAUSTFLOAT(fRec45[0]);
		int iTemp33 = (iRec57[1] < 4096);
		fRec60[0] = (fSlow68 + (0.999 * fRec60[1]));
		double fTemp34 = ((fRec61[1] != 0.0) ? (((fRec62[1] > 0.0) & (fRec62[1] < 1.0)) ? fRec61[1] : 0.0) : (((fRec62[1] == 0.0) & (fSlow69 != fRec63[1])) ? fConst4 : (((fRec62[1] == 1.0) & (fSlow69 != fRec64[1])) ? fConst5 : 0.0)));
		fRec61[0] = fTemp34;
		...
		fRec56[0] = (iTemp33 ? (fTemp37 + fRec56[1]) : fTemp37);
