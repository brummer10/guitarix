...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec0[0] = ((iTemp0) ? fTemp11 + fRec0[1] : fTemp11);
		...
		fRec17[0] = ((iTemp12) ? fTemp16 + fRec17[1] : fTemp16);
		iRec18[0] = ((iTemp12) ? iRec18[1] + 1 : 1);
		fRec19[0] = ((iTemp12) ? fRec19[1] : 0.000244140625 * fRec17[1]);
		...
		fRec28[0] = ((iTemp17) ? fTemp22 + fRec28[1] : fTemp22);
		iRec29[0] = ((iTemp17) ? iRec29[1] + 1 : 1);
		fRec30[0] = ((iTemp17) ? fRec30[1] : 0.000244140625 * fRec28[1]);
		...
		fRec40[0] = ((iTemp23) ? fTemp29 + fRec40[1] : fTemp29);
		iRec41[0] = ((iTemp23) ? iRec41[1] + 1 : 1);
		fRec42[0] = ((iTemp23) ? fRec42[1] : 0.000244140625 * fRec40[1]);
		...
		fRec53[0] = ((iTemp30) ? fTemp37 + fRec53[1] : fTemp37);
		iRec54[0] = ((iTemp30) ? iRec54[1] + 1 : 1);
		fRec55[0] = ((iTemp30) ? fRec55[1] : 0.000244140625 * fRec53[1]);
...
{
	reg.registerFloatVar("mbe.crossover_b1_b2",N_("Crossover B1-B2 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider0, 8e+01, 2e+01, 2e+04, 1.08, 0);
	reg.registerFloatVar("mbe.crossover_b2_b3",N_("Crossover B2-B3 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider1, 2.1e+02, 2e+01, 2e+04, 1.08, 0);
	reg.registerFloatVar("mbe.crossover_b3_b4",N_("Crossover B3-B4 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider2, 1.7e+03, 2e+01, 2e+04, 1.08, 0);
	reg.registerFloatVar("mbe.crossover_b4_b5",N_("Crossover B4-B5 (hz)"),"SL",N_("Crossover fi.bandpass frequency"),&fHslider3, 5e+03, 2e+01, 2e+04, 1.08, 0);
	reg.registerFloatVar("mbe.percent1","","S","",&fHslider5, 1e+01, 0.0, 1e+02, 0.1, 0);
	reg.registerFloatVar("mbe.percent2","","S","",&fHslider7, 3e+01, 0.0, 1e+02, 0.1, 0);
	reg.registerFloatVar("mbe.percent3","","S","",&fHslider9, 45.0, 0.0, 1e+02, 0.1, 0);
	reg.registerFloatVar("mbe.percent4","","S","",&fHslider11, 2e+01, 0.0, 1e+02, 0.1, 0);
	reg.registerFloatVar("mbe.percent5","","S","",&fHslider13, 0.0, 0.0, 1e+02, 0.1, 0);
	reg.registerFloatVar("mbe.time1","","S",N_("Echo in Beats per Minute"),&fHslider4, 3e+01, 24.0, 3.6e+02, 1.0, 0);
	reg.registerFloatVar("mbe.time2","","S",N_("Echo in Beats per Minute"),&fHslider6, 6e+01, 24.0, 3.6e+02, 1.0, 0);
	reg.registerFloatVar("mbe.time3","","S",N_("Echo in Beats per Minute"),&fHslider8, 1.2e+02, 24.0, 3.6e+02, 1.0, 0);
	reg.registerFloatVar("mbe.time4","","S",N_("Echo in Beats per Minute"),&fHslider10, 1.5e+02, 24.0, 3.6e+02, 1.0, 0);
	reg.registerFloatVar("mbe.time5","","S",N_("Echo in Beats per Minute"),&fHslider12, 2.4e+02, 24.0, 3.6e+02, 1.0, 0);
	reg.registerFloatVar("mbe.v1","","SOLN","",&fVbargraph0, 0, -7e+01, 5.0, 0, 0);
	reg.registerFloatVar("mbe.v2","","SOLN","",&fVbargraph1, 0, -7e+01, 5.0, 0, 0);
	reg.registerFloatVar("mbe.v3","","SOLN","",&fVbargraph2, 0, -7e+01, 5.0, 0, 0);
	reg.registerFloatVar("mbe.v4","","SOLN","",&fVbargraph3, 0, -7e+01, 5.0, 0, 0);
	reg.registerFloatVar("mbe.v5","","SOLN","",&fVbargraph4, 0, -7e+01, 5.0, 0, 0);
	return 0;
}
