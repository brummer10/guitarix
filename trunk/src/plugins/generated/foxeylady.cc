...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp3 = ((fRec12[0] * ((fConst1 * (fConst7 + (fConst5 * fRec12[0]))) - 3.1163949818756e-12)) + fConst3);
		fRec13[0] = ((0.993 * fRec13[1]) + fSlow1);
		fRec14[0] = ((double)input0[i] - (((((((fRec14[1] * ((fRec12[0] * ((fConst1 * (fConst40 + (fConst39 * fRec12[0]))) - 1.86983698912536e-11)) + fConst38)) + (fRec14[2] * ((fRec12[0] * ((fConst1 * (fConst37 + (fConst36 * fRec12[0]))) - 4.6745924728134e-11)) + fConst35))) + (fRec14[3] * ((fRec12[0] * ((fConst20 * (fConst34 + (fConst33 * fRec12[0]))) - 6.23278996375121e-11)) + fConst32))) + (fRec14[4] * ((fRec12[0] * ((fConst1 * (fConst31 + (fConst29 * fRec12[0]))) - 4.6745924728134e-11)) + fConst27))) + (fRec14[5] * ((fRec12[0] * ((fConst1 * (fConst25 + (fConst23 * fRec12[0]))) - 1.86983698912536e-11)) + fConst21))) + (fRec14[6] * ((fRec12[0] * ((fConst1 * (fConst18 + (fConst17 * fRec12[0]))) - 3.1163949818756e-12)) + fConst16))) / fTemp3));
		fRec11[0] = ((fConst20 * ((((((((fRec14[0] * (((fRec12[0] * (fConst72 + (fConst71 * fRec13[0]))) + (fConst70 * fRec13[0])) + fConst69)) + (fRec14[1] * (((fRec12[0] * (fConst68 + (fConst67 * fRec13[0]))) + (fConst66 * fRec13[0])) + fConst65))) + (fRec14[2] * (((fRec12[0] * (fConst64 + (fConst63 * fRec13[0]))) + (fConst62 * fRec13[0])) + fConst61))) + (fRec14[3] * (((fRec12[0] * (fConst60 + (fConst59 * fRec13[0]))) + (fConst58 * fRec13[0])) + fConst57))) + (fRec14[4] * (((fRec12[0] * (fConst56 + (fConst54 * fRec13[0]))) + (fConst52 * fRec13[0])) + fConst50))) + (fRec14[5] * (((fRec12[0] * (fConst48 + (fConst46 * fRec13[0]))) + (fConst44 * fRec13[0])) + fConst42))) + (fRec14[6] * (((fRec12[0] * (fConst15 + (fConst13 * fRec13[0]))) + (fConst11 * fRec13[0])) + fConst9))) / fTemp3)) - (fTemp2 + fRec11[2]));
