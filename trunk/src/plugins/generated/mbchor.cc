  ...
  public:
	...
	void fillmydspSIG0(int count, double* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iRec8[0] = iRec8[1] + 1;
			table[i1] = std::sin(9.587379924285257e-05 * double(iRec8[0] + -1));
			iRec8[1] = iRec8[0];
		}
	}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fSlow40 = fConst3 * double(fHslider4);
	double fSlow41 = 0.1 * double(fHslider5);
	double fSlow42 = 0.0010000000000000009 * double(fHslider6);
	double fSlow43 = double(fHslider7);
	double fSlow44 = (fSlow22 + -1.0000000000000004) / fSlow18 + 1.0;
	double fSlow45 = (fSlow22 + 1.0000000000000004) / fSlow18 + 1.0;
	double fSlow46 = 1.0 / fSlow45;
	double fSlow47 = 1.0 / (fSlow33 * fSlow18);
	double fSlow48 = 1.0 / fSlow25;
	double fSlow49 = 0.0 - 1.0 / (fSlow18 * fSlow25);
	double fSlow50 = 0.0 - 2.0 / fSlow19;
	double fSlow51 = fConst3 * double(fHslider8);
	double fSlow52 = 0.1 * double(fHslider9);
	double fSlow53 = 0.0010000000000000009 * double(fHslider10);
	double fSlow54 = double(fHslider11);
	double fSlow55 = (fSlow13 + -1.0000000000000004) / fSlow9 + 1.0;
	double fSlow56 = (fSlow13 + 1.0000000000000004) / fSlow9 + 1.0;
	double fSlow57 = 1.0 / fSlow56;
	double fSlow58 = 1.0 / (fSlow9 * fSlow45);
	double fSlow59 = 1.0 / fSlow16;
	double fSlow60 = 0.0 - 1.0 / (fSlow9 * fSlow16);
	double fSlow61 = 0.0 - 2.0 / fSlow10;
	double fSlow62 = fConst3 * double(fHslider12);
	double fSlow63 = 0.1 * double(fHslider13);
	double fSlow64 = 0.0010000000000000009 * double(fHslider14);
	double fSlow65 = double(fHslider15);
	double fSlow66 = (fSlow4 + -1.0000000000000004) / fSlow0 + 1.0;
	double fSlow67 = 1.0 / ((fSlow4 + 1.0000000000000004) / fSlow0 + 1.0);
	double fSlow68 = 1.0 / (fSlow0 * fSlow56);
	double fSlow69 = 1.0 / fSlow7;
	double fSlow70 = 0.0 - 1.0 / (fSlow0 * fSlow7);
	double fSlow71 = 0.0 - 2.0 / fSlow1;
	double fSlow72 = fConst3 * double(fHslider16);
	double fSlow73 = 0.1 * double(fHslider17);
	double fSlow74 = 0.0010000000000000009 * double(fHslider18);
	double fSlow75 = double(fHslider19);
	double fSlow76 = fConst3 * double(fHslider20);
	double fSlow77 = 0.1 * double(fHslider21);
	double fSlow78 = 0.0010000000000000009 * double(fHslider22);
	double fSlow79 = double(fHslider23);
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp5 = fRec3[2] + fSlow8 * (fTemp1 + fSlow6 * fRec3[0]);
		fVec1[IOTA0 & 131071] = fTemp5;
		fRec9[0] = fSlow40 + (fRec9[1] - std::floor(fSlow40 + fRec9[1]));
		double fTemp6 = 65536.0 * (fRec9[0] - std::floor(fRec9[0]));
		double fTemp7 = std::floor(fTemp6);
		int iTemp8 = int(fTemp7);
		fRec10[0] = fSlow42 + 0.999 * fRec10[1];
		double fTemp9 = fConst4 * fRec10[0] * (fSlow41 * ((fTemp7 + (1.0 - fTemp6)) * ftbl0mydspSIG0[iTemp8 & 65535] + (fTemp6 - fTemp7) * ftbl0mydspSIG0[(iTemp8 + 1) & 65535]) + 1.0);
		int iTemp10 = int(fTemp9);
		double fTemp11 = std::floor(fTemp9);
		double fTemp12 = fSlow43 * (fTemp5 + fSlow43 * (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp10))) & 131071] * (fTemp11 + (1.0 - fTemp9)) + (fTemp9 - fTemp11) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp10 + 1))) & 131071]));
		...
		double fTemp15 = fSlow3 * fRec14[1];
		double fTemp16 = fSlow12 * fRec15[1];
		fRec19[0] = 0.0 - fSlow37 * (fSlow35 * fRec19[1] - (fTemp4 + fVec0[1]));
		fRec18[0] = fRec19[0] - fSlow34 * (fSlow32 * fRec18[2] + fSlow30 * fRec18[1]);
		double fTemp17 = fRec18[2] + fRec18[0] + 2.0 * fRec18[1];
		double fTemp18 = fSlow34 * fTemp17;
		fVec2[0] = fTemp18;
		fRec17[0] = fSlow49 * fVec2[1] - fSlow48 * (fSlow23 * fRec17[1] - fSlow47 * fTemp17);
		fRec16[0] = fRec17[0] - fSlow46 * (fSlow44 * fRec16[2] + fSlow21 * fRec16[1]);
		fRec15[0] = fSlow46 * (fSlow20 * fRec16[0] + fSlow50 * fRec16[1] + fSlow20 * fRec16[2]) - fSlow17 * (fSlow15 * fRec15[2] + fTemp16);
		fRec14[0] = fRec15[2] + fSlow17 * (fTemp16 + fSlow15 * fRec15[0]) - fSlow8 * (fSlow6 * fRec14[2] + fTemp15);
		double fTemp19 = fRec14[2] + fSlow8 * (fTemp15 + fSlow6 * fRec14[0]);
		fVec3[IOTA0 & 131071] = fTemp19;
		fRec20[0] = fSlow51 + (fRec20[1] - std::floor(fSlow51 + fRec20[1]));
		double fTemp20 = 65536.0 * (fRec20[0] - std::floor(fRec20[0]));
		double fTemp21 = std::floor(fTemp20);
		int iTemp22 = int(fTemp21);
		fRec21[0] = fSlow53 + 0.999 * fRec21[1];
		double fTemp23 = fConst4 * fRec21[0] * (fSlow52 * ((fTemp21 + (1.0 - fTemp20)) * ftbl0mydspSIG0[iTemp22 & 65535] + (fTemp20 - fTemp21) * ftbl0mydspSIG0[(iTemp22 + 1) & 65535]) + 1.0);
		int iTemp24 = int(fTemp23);
		double fTemp25 = std::floor(fTemp23);
		double fTemp26 = fSlow54 * (fTemp19 + fSlow54 * (fVec3[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp24))) & 131071] * (fTemp25 + (1.0 - fTemp23)) + (fTemp23 - fTemp25) * fVec3[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp24 + 1))) & 131071]));
		...
		double fTemp29 = fSlow3 * fRec25[1];
		fRec29[0] = 0.0 - fSlow48 * (fSlow23 * fRec29[1] - (fTemp18 + fVec2[1]));
		fRec28[0] = fRec29[0] - fSlow46 * (fSlow44 * fRec28[2] + fSlow21 * fRec28[1]);
		double fTemp30 = fRec28[2] + fRec28[0] + 2.0 * fRec28[1];
		double fTemp31 = fSlow46 * fTemp30;
		fVec4[0] = fTemp31;
		fRec27[0] = fSlow60 * fVec4[1] - fSlow59 * (fSlow14 * fRec27[1] - fSlow58 * fTemp30);
		fRec26[0] = fRec27[0] - fSlow57 * (fSlow55 * fRec26[2] + fSlow12 * fRec26[1]);
		fRec25[0] = fSlow57 * (fSlow11 * fRec26[0] + fSlow61 * fRec26[1] + fSlow11 * fRec26[2]) - fSlow8 * (fSlow6 * fRec25[2] + fTemp29);
		double fTemp32 = fRec25[2] + fSlow8 * (fTemp29 + fSlow6 * fRec25[0]);
		fVec5[IOTA0 & 131071] = fTemp32;
		fRec30[0] = fSlow62 + (fRec30[1] - std::floor(fSlow62 + fRec30[1]));
		double fTemp33 = 65536.0 * (fRec30[0] - std::floor(fRec30[0]));
		double fTemp34 = std::floor(fTemp33);
		int iTemp35 = int(fTemp34);
		fRec31[0] = fSlow64 + 0.999 * fRec31[1];
		double fTemp36 = fConst4 * fRec31[0] * (fSlow63 * ((fTemp34 + (1.0 - fTemp33)) * ftbl0mydspSIG0[iTemp35 & 65535] + (fTemp33 - fTemp34) * ftbl0mydspSIG0[(iTemp35 + 1) & 65535]) + 1.0);
		int iTemp37 = int(fTemp36);
		double fTemp38 = std::floor(fTemp36);
		double fTemp39 = fSlow65 * (fTemp32 + fSlow65 * (fVec5[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp37))) & 131071] * (fTemp38 + (1.0 - fTemp36)) + (fTemp36 - fTemp38) * fVec5[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp37 + 1))) & 131071]));
		...
		fRec38[0] = 0.0 - fSlow59 * (fSlow14 * fRec38[1] - (fTemp31 + fVec4[1]));
		fRec37[0] = fRec38[0] - fSlow57 * (fSlow55 * fRec37[2] + fSlow12 * fRec37[1]);
		double fTemp42 = fRec37[2] + fRec37[0] + 2.0 * fRec37[1];
		double fTemp43 = fSlow57 * fTemp42;
		fVec6[0] = fTemp43;
		fRec36[0] = fSlow70 * fVec6[1] - fSlow69 * (fSlow5 * fRec36[1] - fSlow68 * fTemp42);
		fRec35[0] = fRec36[0] - fSlow67 * (fSlow66 * fRec35[2] + fSlow3 * fRec35[1]);
		double fTemp44 = fSlow67 * (fSlow2 * fRec35[0] + fSlow71 * fRec35[1] + fSlow2 * fRec35[2]);
		fVec7[IOTA0 & 131071] = fTemp44;
		fRec39[0] = fSlow72 + (fRec39[1] - std::floor(fSlow72 + fRec39[1]));
		double fTemp45 = 65536.0 * (fRec39[0] - std::floor(fRec39[0]));
		double fTemp46 = std::floor(fTemp45);
		int iTemp47 = int(fTemp46);
		fRec40[0] = fSlow74 + 0.999 * fRec40[1];
		double fTemp48 = fConst4 * fRec40[0] * (fSlow73 * ((fTemp46 + (1.0 - fTemp45)) * ftbl0mydspSIG0[iTemp47 & 65535] + (fTemp45 - fTemp46) * ftbl0mydspSIG0[(iTemp47 + 1) & 65535]) + 1.0);
		int iTemp49 = int(fTemp48);
		double fTemp50 = std::floor(fTemp48);
		double fTemp51 = fSlow75 * (fTemp44 + fSlow75 * (fVec7[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49))) & 131071] * (fTemp50 + (1.0 - fTemp48)) + (fTemp48 - fTemp50) * fVec7[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49 + 1))) & 131071]));
		...
		fRec45[0] = 0.0 - fSlow69 * (fSlow5 * fRec45[1] - (fTemp43 + fVec6[1]));
		fRec44[0] = fRec45[0] - fSlow67 * (fSlow66 * fRec44[2] + fSlow3 * fRec44[1]);
		double fTemp54 = fSlow67 * (fRec44[2] + fRec44[0] + 2.0 * fRec44[1]);
		fVec8[IOTA0 & 131071] = fTemp54;
		fRec46[0] = fSlow76 + (fRec46[1] - std::floor(fSlow76 + fRec46[1]));
		double fTemp55 = 65536.0 * (fRec46[0] - std::floor(fRec46[0]));
		double fTemp56 = std::floor(fTemp55);
		int iTemp57 = int(fTemp56);
		fRec47[0] = fSlow78 + 0.999 * fRec47[1];
		double fTemp58 = fConst4 * fRec47[0] * (fSlow77 * ((fTemp56 + (1.0 - fTemp55)) * ftbl0mydspSIG0[iTemp57 & 65535] + (fTemp55 - fTemp56) * ftbl0mydspSIG0[(iTemp57 + 1) & 65535]) + 1.0);
		int iTemp59 = int(fTemp58);
		double fTemp60 = std::floor(fTemp58);
		double fTemp61 = fSlow79 * (fTemp54 + fSlow79 * (fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp59))) & 131071] * (fTemp60 + (1.0 - fTemp58)) + (fTemp58 - fTemp60) * fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp59 + 1))) & 131071]));
		...
		output0[i0] = FAUSTFLOAT(fTemp61 + fTemp51 + fTemp39 + fTemp26 + fTemp4 + fTemp12);
		fVec0[1] = fVec0[0];
		fRec7[1] = fRec7[0];
		fRec6[2] = fRec6[1];
		fRec6[1] = fRec6[0];
