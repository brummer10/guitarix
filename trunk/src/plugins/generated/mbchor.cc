...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp12 = fSlow0 * (fTemp5 + fSlow0 * (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp10))) & 131071] * (fTemp11 + 1.0 - fTemp9) + (fTemp9 - fTemp11) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp10 + 1))) & 131071]));
		double fTemp13 = std::max<double>(fConst1, std::fabs(fTemp12));
		double fElse0 = fTemp13 + fRec0[1];
		fRec0[0] = ((iTemp1) ? fElse0 : fTemp13);
		...
		double fTemp26 = fSlow44 * (fTemp19 + fSlow44 * (fVec3[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp24))) & 131071] * (fTemp25 + 1.0 - fTemp23) + (fTemp23 - fTemp25) * fVec3[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp24 + 1))) & 131071]));
		double fTemp27 = std::max<double>(fConst1, std::fabs(fTemp26));
		double fElse3 = fTemp27 + fRec11[1];
		fRec11[0] = ((iTemp14) ? fElse3 : fTemp27);
		int iElse4 = iRec12[1] + 1;
		iRec12[0] = ((iTemp14) ? iElse4 : 1);
		double fThen5 = 0.000244140625 * fRec11[1];
		fRec13[0] = ((iTemp14) ? fRec13[1] : fThen5);
		...
		double fTemp39 = fSlow55 * (fTemp32 + fSlow55 * (fVec5[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp37))) & 131071] * (fTemp38 + 1.0 - fTemp36) + (fTemp36 - fTemp38) * fVec5[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp37 + 1))) & 131071]));
		double fTemp40 = std::max<double>(fConst1, std::fabs(fTemp39));
		double fElse6 = fTemp40 + fRec22[1];
		fRec22[0] = ((iTemp28) ? fElse6 : fTemp40);
		int iElse7 = iRec23[1] + 1;
		iRec23[0] = ((iTemp28) ? iElse7 : 1);
		double fThen8 = 0.000244140625 * fRec22[1];
		fRec24[0] = ((iTemp28) ? fRec24[1] : fThen8);
		...
		double fTemp51 = fSlow66 * (fTemp44 + fSlow66 * (fVec7[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49))) & 131071] * (fTemp50 + 1.0 - fTemp48) + (fTemp48 - fTemp50) * fVec7[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49 + 1))) & 131071]));
		double fTemp52 = std::max<double>(fConst1, std::fabs(fTemp51));
		double fElse9 = fTemp52 + fRec32[1];
		fRec32[0] = ((iTemp41) ? fElse9 : fTemp52);
		int iElse10 = iRec33[1] + 1;
		iRec33[0] = ((iTemp41) ? iElse10 : 1);
		double fThen11 = 0.000244140625 * fRec32[1];
		fRec34[0] = ((iTemp41) ? fRec34[1] : fThen11);
		...
		double fTemp61 = fSlow76 * (fTemp54 + fSlow76 * (fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp59))) & 131071] * (fTemp60 + 1.0 - fTemp58) + (fTemp58 - fTemp60) * fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp59 + 1))) & 131071]));
		double fTemp62 = std::max<double>(fConst1, std::fabs(fTemp61));
		double fElse12 = fTemp62 + fRec41[1];
		fRec41[0] = ((iTemp53) ? fElse12 : fTemp62);
		int iElse13 = iRec42[1] + 1;
		iRec42[0] = ((iTemp53) ? iElse13 : 1);
		double fThen14 = 0.000244140625 * fRec41[1];
		fRec43[0] = ((iTemp53) ? fRec43[1] : fThen14);
