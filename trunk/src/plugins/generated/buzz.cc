...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst10 = (1.0 / tan((270.1769682087222 / fConst0)));
	fConst11 = (1 + fConst10);
	fConst12 = (0 - ((1 - fConst10) / fConst11));
	fConst13 = (0.027 / fConst11);
	fConst14 = (1.0 / tan((34.55751918948772 / fConst0)));
	fConst15 = (0 - fConst14);
	fConst16 = (1 + fConst14);
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = ((fSlow1 * fTemp0) - (fConst8 * (((fConst6 * fRec9[1]) + (fConst5 * fRec9[2])) + (fConst3 * fRec9[3]))));
		double fTemp1 = ((fRec8[0] * ((1.14404299012556e-12 * fRec9[2]) + (3.81347663375185e-13 * fRec9[0]))) + ((fRec9[1] * (0 - (1.14404299012556e-12 * fRec8[0]))) + (fRec9[3] * (0 - (3.81347663375185e-13 * fRec8[0])))));
		fVec0[0] = fTemp1;
		...
		fRec10[0] = ((fConst13 * (fRec5[1] + fRec5[2])) + (fConst12 * fRec10[1]));
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec10[0] + (0.9254498422517706 * (fRec6[0] + (fRec6[2] + (2.0 * fRec6[1]))))) - 5.571981)) - 43.63033333333331);
		...
		fRec11[0] = ((fConst13 * (fRec1[1] + fRec1[2])) + (fConst12 * fRec11[1]));
		fRec1[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec11[0] + (0.9254498422517706 * (fRec2[0] + (fRec2[2] + (2.0 * fRec2[1]))))) - 5.571981)) - 43.63033333333331);
...
{
	reg.registerVar("buzz.Level",N_("Level"),"S","",&fslider0, 0.5, 0.0, 1.0, 0.01);
	reg.registerVar("buzz.wet_dry",N_("Wet/Dry"),"S",N_("percentage of processed signal in output signal"),&fslider1, 1e+02, 0.0, 1e+02, 1.0);
	return 0;
}
