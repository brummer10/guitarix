...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	double fConst2 = 4.3388468105506801e-10 * fConst0;
	double fConst3 = fConst0 * (fConst2 + 6.8680901344593704e-09) + 2.6522670215943701e-08;
	fConst4 = fConst1 / fConst3;
	double fConst5 = 3.6868885846545499e-10 * fConst0;
	fConst6 = 1.0 / (fConst0 * (fConst5 + 3.0348555108869402e-06) + 0.00486780557301784);
	double fConst7 = 3.9204879585950002e-10 * fConst0;
	fConst8 = 1.0 / (fConst0 * (fConst7 + 2.0047872746271098e-06) + 0.00048978515761155495);
	double fConst9 = 7.6673121439986096e-12 * fConst0;
	fConst10 = fConst0 * (fConst9 + -3.9949085717896201e-05);
	double fConst11 = 2.0828770493449602e-05 * fConst0;
	...
	double fConst16 = 1.2821120020392999e-10 * fConst0;
	fConst17 = fConst16 + -6.2652181541007596e-07;
	double fConst18 = 1.12312054615984e-09 * fConst0;
	fConst19 = fConst18 + -2.8621970465474001e-06;
	double fConst20 = 1.1344651981412601e-09 * fConst0;
	...
	double fConst25 = 2.26293387153501e-14 * fConst0;
	fConst26 = fConst25 + -1.17905906929765e-07;
	double fConst27 = 2.26293387153501e-12 * fConst0;
	...
	fConst32 = fConst0 * (fConst7 + -2.0047872746271098e-06) + 0.00048978515761155495;
	fConst33 = 0.0 - 1.53346242879972e-11 * fConst1;
	fConst34 = fConst0 * (fConst9 + 3.9949085717896201e-05);
	double fConst35 = 7.3737771693091102e-10 * fConst1;
	fConst36 = 0.0097356111460356904 - fConst35;
	fConst37 = fConst0 * (fConst5 + -3.0348555108869402e-06) + 0.00486780557301784;
	...
	fConst43 = fConst0 * (fConst2 + -6.8680901344593704e-09) + 2.6522670215943701e-08;
	clear_state_f();
}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		fRec4[0] = double(buf[i0]) - fConst12 * (fConst15 * fRec4[2] + 0.000438032628543473 * fRec4[1]);
		...
		buf[i0] = FAUSTFLOAT(fConst4 * (fRec0[0] * fTemp2 + 3.4865179804685599e-09 * fRec7[0] * fRec0[1] + fRec0[2] * fTemp2));
		fRec4[2] = fRec4[1];
		fRec4[1] = fRec4[0];
		fRec5[1] = fRec5[0];
		fRec3[2] = fRec3[1];
