...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<ReCount; i++) {
		...
		fRec3[0] = ((0.3183098861837907 * atan((fConst0 * (((fConst0 * (fRec5[1] * (0 - (4.52586774307001e-14 + (4.52586774307001e-12 * fRec4[0]))))) + ((fRec5[0] * (fConst38 + (fConst37 * fRec4[0]))) + (fRec5[2] * (fConst28 + (fConst26 * fRec4[0]))))) / fTemp1)))) - (fConst18 * ((fConst17 * fRec3[1]) + (fConst16 * fRec3[2]))));
...
{
	reg.registerVar("bmp.Sustain",N_("Sustain"),"S","",&fslider1, 0.5, 0.0, 1.0, 0.01);
	reg.registerVar("bmp.Tone",N_("Tone"),"S","",&fslider0, 0.5, 0.0, 1.0, 0.01);
	reg.registerVar("bmp.Volume",N_("Volume"),"S","",&fslider2, 0.5, 0.0, 1.0, 0.01);
	return 0;
}
