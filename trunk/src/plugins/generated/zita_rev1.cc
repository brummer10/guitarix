...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerVar("zita_rev1.equalizer1.eq1_freq",N_("Freq"),"S",N_("Center-frequency of second-order Regalia-Mitra peaking equalizer section 1"),&fslider8, 315.0, 4e+01, 2.5e+03, 1.0);
	...
	reg.registerVar("zita_rev1.equalizer2.eq2_freq",N_("Freq"),"S",N_("Center-frequency of second-order Regalia-Mitra peaking equalizer section 2"),&fslider10, 315.0, 4e+01, 2.5e+03, 1.0);
