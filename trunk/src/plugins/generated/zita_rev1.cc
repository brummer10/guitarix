...
b.openVerticalBox("");
{
    ...
    {
    b.create_mid_rackknob(PARAM("input.in_delay"), "In Delay");

	b.create_mid_rackknob(PARAM("decay_times.low_rt60"), "Low");
	b.create_small_rackknob(PARAM("decay_times.lf_x"), "Freq X");
	b.create_mid_rackknob(PARAM("decay_times.mid_rt60"), "Mid");
	b.create_mid_rackknob(PARAM("decay_times.hf_damping"), "HF Damping");

	b.create_mid_rackknob(PARAM("output.dry_wet_mix"), "Dry/Wet");
	}
    b.closeBox();
	...
	b.create_mid_rackknob(PARAM("output.level"), "Level");
	}
    b.closeBox();
}
b.closeBox();
