...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp3 = (3.01537219493083e-17 + (fConst1 * (fConst8 + (fConst6 * fRec13[0]))));
		fRec14[0] = ((fSlow0 * fTemp0) - (((((((((fRec14[1] * (2.41229775594467e-16 + (fConst1 * (fConst35 + (fConst34 * fRec13[0]))))) + (fRec14[2] * (8.44304214580633e-16 + (fConst1 * (fConst33 + (fConst32 * fRec13[0])))))) + (fRec14[3] * (1.68860842916127e-15 + (fConst1 * (fConst31 + (fConst30 * fRec13[0])))))) + (fRec14[4] * (2.11076053645158e-15 + (fConst16 * (fConst29 + (fConst28 * fRec13[0])))))) + (fRec14[5] * (1.68860842916127e-15 + (fConst1 * (fConst27 + (fConst25 * fRec13[0])))))) + (fRec14[6] * (8.44304214580633e-16 + (fConst1 * (fConst23 + (fConst21 * fRec13[0])))))) + (fRec14[7] * (2.41229775594467e-16 + (fConst1 * (fConst19 + (fConst17 * fRec13[0])))))) + (fRec14[8] * (3.01537219493083e-17 + (fConst1 * (fConst14 + (fConst13 * fRec13[0])))))) / fTemp3));
		double fTemp4 = (fConst60 * ((((((((((fRec14[0] * (fConst59 + (fConst58 * fRec13[0]))) + (fRec14[1] * (fConst57 + (fConst56 * fRec13[0])))) + (fRec14[2] * (fConst55 + (fConst54 * fRec13[0])))) + (fRec14[3] * (fConst53 + (fConst52 * fRec13[0])))) + (fConst1 * (fRec14[4] * (fConst51 + (fConst50 * fRec13[0]))))) + (fRec14[5] * (fConst49 + (fConst47 * fRec13[0])))) + (fRec14[6] * (fConst45 + (fConst42 * fRec13[0])))) + (fRec14[7] * (fConst39 + (fConst37 * fRec13[0])))) + (fRec14[8] * (fConst12 + (fConst10 * fRec13[0])))) / fTemp3));
		double fTemp5 = fabs(fTemp4);
		fRec12[0] = ((fConst61 * max(fTemp5, fRec12[1])) + (fConst62 * fTemp5));
		fRec11[0] = ((fConst63 * fRec11[1]) + (fConst64 * fRec12[0]));
		fRec15[0] = ((0.993 * fRec15[1]) + fSlow4);
		double fTemp6 = ((iSlow5==0)? fRec15[0] : ((iSlow5==1)?max(0.09, min(0.9, fRec11[0])):(1 - max(0.09, min(0.9, (0.5 * (1 + fRec8[0])))))) );
		double fTemp7 = (8.05126427163433e-17 + (fConst1 * ((fTemp6 * (fConst68 + (fConst66 * fTemp6))) + fConst3)));
		fRec16[0] = (fTemp4 - (((((((fRec16[1] * (4.8307585629806e-16 + (fConst1 * ((fTemp6 * (fConst98 + (fConst97 * fTemp6))) + fConst96)))) + (fRec16[2] * (1.20768964074515e-15 + (fConst1 * ((fTemp6 * (fConst95 + (fConst94 * fTemp6))) + fConst93))))) + (fRec16[3] * (1.61025285432687e-15 + (fConst16 * ((fTemp6 * (fConst92 + (fConst91 * fTemp6))) + fConst90))))) + (fRec16[4] * (1.20768964074515e-15 + (fConst1 * ((fTemp6 * (fConst89 + (fConst87 * fTemp6))) + fConst85))))) + (fRec16[5] * (4.8307585629806e-16 + (fConst1 * ((fTemp6 * (fConst83 + (fConst81 * fTemp6))) + fConst79))))) + (fRec16[6] * (8.05126427163433e-17 + (fConst1 * ((fTemp6 * (fConst77 + (fConst76 * fTemp6))) + fConst75))))) / fTemp7));
		fRec7[0] = ((fConst16 * ((((((((fRec16[0] * ((fTemp6 * (fConst122 + (fConst121 * fTemp6))) + fConst120)) + (fRec16[1] * ((fTemp6 * (fConst119 + (fConst118 * fTemp6))) + fConst117))) + (fRec16[2] * ((fTemp6 * (fConst116 + (fConst115 * fTemp6))) + fConst114))) + (fRec16[3] * ((fTemp6 * (fConst113 + (fConst112 * fTemp6))) + fConst111))) + (fRec16[4] * ((fTemp6 * (fConst110 + (fConst108 * fTemp6))) + fConst106))) + (fRec16[5] * ((fTemp6 * (fConst104 + (fConst102 * fTemp6))) + fConst100))) + (fRec16[6] * ((fTemp6 * (fConst74 + (fConst72 * fTemp6))) + fConst70))) / fTemp7)) - (fTemp2 + fRec7[2]));
		double fTemp8 = (fRec7[2] + (fRec7[0] + fTemp2));
		fVec1[0] = fTemp8;
		fRec6[0] = ((1.0000000000000002 * (fVec1[0] + fVec1[1])) - (0.9999999999999998 * fRec6[1]));
		fRec17[0] = ((fConst126 * fRec17[1]) + (fConst125 * (fRec5[1] + fRec5[2])));
		fRec5[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec17[0] + fRec6[0]) - 5.562895)) - 43.96685185185183);
		fRec4[0] = ((fConst131 * fRec4[1]) + (fConst130 * ((fConst127 * fRec5[0]) + (fConst128 * fRec5[1]))));
		...
		fRec18[0] = ((fConst126 * fRec18[1]) + (fConst125 * (fRec1[1] + fRec1[2])));
		fRec1[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec18[0] + fRec2[0]) - 5.562895)) - 43.96685185185183);
