...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst8 = 8.6453768554099601e-54 * fConst0;
	...
	double fConst10 = 7.7135875124018505e-54 * fConst0;
	...
	double fConst12 = 3.02588189939348e-53 * fConst0;
	...
	double fConst14 = 2.6997556293406501e-53 * fConst0;
	...
	double fConst16 = 6.0517637987869703e-53 * fConst0;
	...
	double fConst18 = 5.3995112586813002e-53 * fConst0;
	...
	double fConst28 = 1.0806721069262399e-54 * fConst0;
	...
	double fConst30 = 9.6419843905023102e-55 * fConst0;
	...
	double fConst34 = 2.6226779359819302e-32 * fConst0;
	...
	double fConst46 = fConst0 * (fConst45 + 2.9698826021328998e-25);
	fConst47 = fConst0 * (fConst0 * (fConst46 + -7.6165692516944296e-23) + -3.31234016877595e-21);
	double fConst48 = fConst0 * (fConst42 + -9.2101009866408307e-25);
	fConst49 = fConst5 * (fConst48 + -7.3085528964916198e-22) + 2.4842551265819602e-19;
	double fConst50 = fConst0 * (2.9698826021328998e-25 - fConst45);
	...
	double fConst62 = 3.0207049650607199e-29 * fConst0;
	...
	double fConst69 = 1.0332413167573e-27 * fConst0;
	...
	double fConst75 = 2.5831032918932499e-27 * fConst0;
	...
	double fConst77 = 6.4476851337285599e-28 * fConst0;
	...
	double fConst88 = 5.0345082751012003e-30 * fConst0;
	...
	double fConst90 = 1.72206886126217e-28 * fConst0;
	...
	double fConst92 = 4.29845675581904e-29 * fConst0;
	...
	double fConst97 = 9.6574497270343303e-31 * fConst0;
	...
	double fConst99 = 7.1663335121242097e-31 * fConst0;
	...
	double fConst111 = 1.07495002681863e-29 * fConst0;
	...
	double fConst113 = 1.07712383444435e-29 * fConst0;
	...
	double fConst127 = 1.0 / std::tan(270.1769682087222 / fConst0);
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		fRec14[0] = fConst66 * fRec15[0] + fConst65 * fRec14[1];
		...
		output0[i0] = FAUSTFLOAT(fRec0[0] + fSlow7 * fTemp0);
		iVec0[1] = iVec0[0];
		fRec10[1] = fRec10[0];
