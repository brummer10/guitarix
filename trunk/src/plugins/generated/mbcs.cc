...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerEnumVar("mbcs.Mode1","","S",N_("Compres or Mute the selected band, or Bypass The Compressor"),fslider29_values,&fslider29, 1.0, 1.0, 3.0, 1.0);
	...
	reg.registerEnumVar("mbcs.Mode2","","S",N_("Compres or Mute the selected band, or Bypass The Compressor"),fslider23_values,&fslider23, 1.0, 1.0, 3.0, 1.0);
	...
	reg.registerEnumVar("mbcs.Mode3","","S",N_("Compres or Mute the selected band, or Bypass The Compressor"),fslider16_values,&fslider16, 1.0, 1.0, 3.0, 1.0);
	...
	reg.registerEnumVar("mbcs.Mode4","","S",N_("Compres or Mute the selected band, or Bypass The Compressor"),fslider3_values,&fslider3, 1.0, 1.0, 3.0, 1.0);
	...
	reg.registerEnumVar("mbcs.Mode5","","S",N_("Compres or Mute the selected band, or Bypass The Compressor"),fslider9_values,&fslider9, 1.0, 1.0, 3.0, 1.0);
