...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fSlow34 = 0.0010000000000000009 * std::pow(1e+01, 0.05 * double(fVslider0));
	double fSlow35 = fConst3 / double(fHslider4);
	double fSlow36 = (fSlow19 + -1.0000000000000004) / fSlow16 + 1.0;
	double fSlow37 = (fSlow19 + 1.0000000000000004) / fSlow16 + 1.0;
	double fSlow38 = 1.0 / fSlow37;
	double fSlow39 = 1.0 / fSlow22;
	double fSlow40 = 1.0 / (fSlow17 * fSlow37);
	double fSlow41 = 0.0010000000000000009 * std::pow(1e+01, 0.05 * double(fVslider1));
	double fSlow42 = fConst3 / double(fHslider5);
	double fSlow43 = (fSlow11 + -1.0000000000000004) / fSlow8 + 1.0;
	double fSlow44 = (fSlow11 + 1.0000000000000004) / fSlow8 + 1.0;
	double fSlow45 = 1.0 / fSlow44;
	double fSlow46 = 1.0 / fSlow14;
	double fSlow47 = 1.0 / (fSlow9 * fSlow44);
	double fSlow48 = 0.0010000000000000009 * std::pow(1e+01, 0.05 * double(fVslider2));
	double fSlow49 = fConst3 / double(fHslider6);
	double fSlow50 = (fSlow3 + -1.0000000000000004) / fSlow0 + 1.0;
	double fSlow51 = (fSlow3 + 1.0000000000000004) / fSlow0 + 1.0;
	...
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp5 = fRec8[0] * (fRec3[2] + fSlow7 * (fTemp1 + fSlow5 * fRec3[0]));
		fVec1[IOTA0 & 524287] = fTemp5;
		double fTemp6 = ((fRec9[1] != 0.0) ? (((fRec10[1] > 0.0) & (fRec10[1] < 1.0)) ? fRec9[1] : 0.0) : (((fRec10[1] == 0.0) & (fSlow35 != fRec11[1])) ? fConst4 : (((fRec10[1] == 1.0) & (fSlow35 != fRec12[1])) ? -fConst4 : 0.0)));
		fRec9[0] = fTemp6;
		fRec10[0] = std::max<double>(0.0, std::min<double>(1.0, fRec10[1] + fTemp6));
		fRec11[0] = (((fRec10[1] >= 1.0) & (fRec12[1] != fSlow35)) ? fSlow35 : fRec11[1]);
		fRec12[0] = (((fRec10[1] <= 0.0) & (fRec11[1] != fSlow35)) ? fSlow35 : fRec12[1]);
		...
		double fTemp11 = fSlow2 * fRec16[1];
		double fTemp12 = fSlow10 * fRec17[1];
		fRec21[0] = -(fSlow32 * (fSlow31 * fRec21[1] - (fTemp4 + fVec0[1])));
		fRec20[0] = fRec21[0] - fSlow30 * (fSlow28 * fRec20[2] + fSlow26 * fRec20[1]);
		double fTemp13 = fSlow30 * (fRec20[2] + fRec20[0] + 2.0 * fRec20[1]);
		fVec2[0] = fTemp13;
		fRec19[0] = -(fSlow39 * (fSlow20 * fRec19[1] - fSlow19 * (fTemp13 - fVec2[1])));
		fRec18[0] = fRec19[0] - fSlow38 * (fSlow36 * fRec18[2] + fSlow18 * fRec18[1]);
		fRec17[0] = fSlow40 * (fRec18[2] + (fRec18[0] - 2.0 * fRec18[1])) - fSlow15 * (fSlow13 * fRec17[2] + fTemp12);
		fRec16[0] = fRec17[2] + fSlow15 * (fTemp12 + fSlow13 * fRec17[0]) - fSlow7 * (fSlow5 * fRec16[2] + fTemp11);
		fRec22[0] = fSlow41 + 0.999 * fRec22[1];
		double fTemp14 = fRec22[0] * (fRec16[2] + fSlow7 * (fTemp11 + fSlow5 * fRec16[0]));
		fVec3[IOTA0 & 524287] = fTemp14;
		double fTemp15 = ((fRec23[1] != 0.0) ? (((fRec24[1] > 0.0) & (fRec24[1] < 1.0)) ? fRec23[1] : 0.0) : (((fRec24[1] == 0.0) & (fSlow42 != fRec25[1])) ? fConst4 : (((fRec24[1] == 1.0) & (fSlow42 != fRec26[1])) ? -fConst4 : 0.0)));
		fRec23[0] = fTemp15;
		fRec24[0] = std::max<double>(0.0, std::min<double>(1.0, fRec24[1] + fTemp15));
		fRec25[0] = (((fRec24[1] >= 1.0) & (fRec26[1] != fSlow42)) ? fSlow42 : fRec25[1]);
		fRec26[0] = (((fRec24[1] <= 0.0) & (fRec25[1] != fSlow42)) ? fSlow42 : fRec26[1]);
		double fTemp16 = fVec3[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec25[0])))) & 524287];
		double fTemp17 = fTemp16 + fRec24[0] * (fVec3[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec26[0])))) & 524287] - fTemp16);
		double fTemp18 = std::max<double>(fConst1, std::fabs(fTemp17));
		fRec13[0] = ((iTemp10) ? fTemp18 + fRec13[1] : fTemp18);
		iRec14[0] = ((iTemp10) ? iRec14[1] + 1 : 1);
		fRec15[0] = ((iTemp10) ? fRec15[1] : 0.000244140625 * fRec13[1]);
		fVbargraph1 = FAUSTFLOAT(fRec15[0]);
		int iTemp19 = iRec28[1] < 4096;
		double fTemp20 = fSlow2 * fRec30[1];
		fRec34[0] = -(fSlow39 * (fSlow20 * fRec34[1] - (fTemp13 + fVec2[1])));
		fRec33[0] = fRec34[0] - fSlow38 * (fSlow36 * fRec33[2] + fSlow18 * fRec33[1]);
		double fTemp21 = fSlow38 * (fRec33[2] + fRec33[0] + 2.0 * fRec33[1]);
		fVec4[0] = fTemp21;
		fRec32[0] = -(fSlow46 * (fSlow12 * fRec32[1] - fSlow11 * (fTemp21 - fVec4[1])));
		fRec31[0] = fRec32[0] - fSlow45 * (fSlow43 * fRec31[2] + fSlow10 * fRec31[1]);
		fRec30[0] = fSlow47 * (fRec31[2] + (fRec31[0] - 2.0 * fRec31[1])) - fSlow7 * (fSlow5 * fRec30[2] + fTemp20);
		fRec35[0] = fSlow48 + 0.999 * fRec35[1];
		double fTemp22 = fRec35[0] * (fRec30[2] + fSlow7 * (fTemp20 + fSlow5 * fRec30[0]));
		fVec5[IOTA0 & 524287] = fTemp22;
		double fTemp23 = ((fRec36[1] != 0.0) ? (((fRec37[1] > 0.0) & (fRec37[1] < 1.0)) ? fRec36[1] : 0.0) : (((fRec37[1] == 0.0) & (fSlow49 != fRec38[1])) ? fConst4 : (((fRec37[1] == 1.0) & (fSlow49 != fRec39[1])) ? -fConst4 : 0.0)));
		fRec36[0] = fTemp23;
		fRec37[0] = std::max<double>(0.0, std::min<double>(1.0, fRec37[1] + fTemp23));
		fRec38[0] = (((fRec37[1] >= 1.0) & (fRec39[1] != fSlow49)) ? fSlow49 : fRec38[1]);
		fRec39[0] = (((fRec37[1] <= 0.0) & (fRec38[1] != fSlow49)) ? fSlow49 : fRec39[1]);
		double fTemp24 = fVec5[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec38[0])))) & 524287];
		double fTemp25 = fTemp24 + fRec37[0] * (fVec5[(IOTA0 - int(std::min<double>(262144.0, std::max<double>(0.0, fRec39[0])))) & 524287] - fTemp24);
		double fTemp26 = std::max<double>(fConst1, std::fabs(fTemp25));
		fRec27[0] = ((iTemp19) ? fTemp26 + fRec27[1] : fTemp26);
		iRec28[0] = ((iTemp19) ? iRec28[1] + 1 : 1);
		fRec29[0] = ((iTemp19) ? fRec29[1] : 0.000244140625 * fRec27[1]);
		fVbargraph2 = FAUSTFLOAT(fRec29[0]);
		int iTemp27 = iRec41[1] < 4096;
		fRec46[0] = -(fSlow46 * (fSlow12 * fRec46[1] - (fTemp21 + fVec4[1])));
		...
		fRec40[0] = ((iTemp27) ? fTemp33 + fRec40[1] : fTemp33);
		iRec41[0] = ((iTemp27) ? iRec41[1] + 1 : 1);
