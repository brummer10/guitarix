...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fSlow47 = (1.0 / (fSlow15 * fSlow4));
	...
	double fSlow55 = (1.0 / (fSlow24 * fSlow43));
	...
	double fSlow62 = (1.0 / (fSlow33 * fSlow51));
	...
	for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
		...
		double fTemp2 = (double(input0[i0]) + fRec10[0]);
		fVec1[0] = fTemp2;
		...
		double fElse0 = (fTemp7 + fRec1[1]);
		fRec1[0] = (iTemp0 ? fElse0 : fTemp7);
		int iElse1 = (iRec2[1] + 1);
		iRec2[0] = (iTemp0 ? iElse1 : 1);
		double fThen2 = (0.000244140625 * fRec1[1]);
		fRec3[0] = (iTemp0 ? fRec3[1] : fThen2);
		...
		double fElse3 = (fTemp15 + fRec11[1]);
		fRec11[0] = (iTemp8 ? fElse3 : fTemp15);
		int iElse4 = (iRec12[1] + 1);
		iRec12[0] = (iTemp8 ? iElse4 : 1);
		double fThen5 = (0.000244140625 * fRec11[1]);
		fRec13[0] = (iTemp8 ? fRec13[1] : fThen5);
		...
		double fElse6 = (fTemp22 + fRec21[1]);
		fRec21[0] = (iTemp16 ? fElse6 : fTemp22);
		int iElse7 = (iRec22[1] + 1);
		iRec22[0] = (iTemp16 ? iElse7 : 1);
		double fThen8 = (0.000244140625 * fRec21[1]);
		fRec23[0] = (iTemp16 ? fRec23[1] : fThen8);
		...
		double fElse9 = (fTemp28 + fRec30[1]);
		fRec30[0] = (iTemp23 ? fElse9 : fTemp28);
		int iElse10 = (iRec31[1] + 1);
		iRec31[0] = (iTemp23 ? iElse10 : 1);
		double fThen11 = (0.000244140625 * fRec30[1]);
		fRec32[0] = (iTemp23 ? fRec32[1] : fThen11);
		...
		double fElse12 = (fTemp32 + fRec38[1]);
		fRec38[0] = (iTemp29 ? fElse12 : fTemp32);
		int iElse13 = (iRec39[1] + 1);
		iRec39[0] = (iTemp29 ? iElse13 : 1);
		double fThen14 = (0.000244140625 * fRec38[1]);
		fRec40[0] = (iTemp29 ? fRec40[1] : fThen14);
		fVbargraph4 = FAUSTFLOAT(fRec40[0]);
		output0[i0] = FAUSTFLOAT((fRec0[0] * ((((fTemp6 + fTemp14) + fTemp21) + fTemp27) + fTemp31)));
		iVec0[1] = iVec0[0];
		fRec0[1] = fRec0[0];
		fRec4[1] = fRec4[0];
		fRec10[1] = fRec10[0];
