...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec5[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec12[0] + fRec6[0]) - 5.562895)) - 43.96685185185183);
		fRec4[0] = ((fConst200 * fRec4[1]) + (fConst199 * ((fConst196 * fRec5[0]) + (fConst197 * fRec5[1]))));
		fRec3[0] = (fRec4[0] - (fTemp1 + fRec3[2]));
		double fTemp5 = (fRec3[2] + (fRec3[0] + fTemp1));
		fVec1[0] = fTemp5;
		...
		fRec1[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec13[0] + fRec2[0]) - 5.562895)) - 43.96685185185183);
