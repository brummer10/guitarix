...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst191 = faustpower<3>(fConst1);
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp1 = (2.30862500009197e-13 + ((fRec5[0] * (5.24210944616705e-13 + (fConst1 * (((fRec4[0] * (fConst19 + (fConst17 * fRec4[0]))) + (fRec5[0] * (fConst15 + (fConst1 * (fRec4[0] * (fConst13 + (fConst11 * fRec4[0]))))))) + fConst9)))) + (fConst1 * ((fRec4[0] * (fConst7 + (fConst5 * fRec4[0]))) + fConst3))));
		fRec6[0] = ((0.993 * fRec6[1]) + fSlow4);
		fRec7[0] = ((fSlow0 * fTemp0) - ((((((fRec7[1] * (1.15431250004598e-12 + ((fRec5[0] * (2.62105472308353e-12 + (fConst1 * (((fRec4[0] * (fConst106 + (fConst105 * fRec4[0]))) + (fRec5[0] * (fConst104 + (fConst1 * (fRec4[0] * (fConst103 + (fConst102 * fRec4[0]))))))) + fConst101)))) + (fConst1 * ((fRec4[0] * (fConst100 + (fConst99 * fRec4[0]))) + fConst98))))) + (fRec7[2] * (2.30862500009197e-12 + ((fRec5[0] * (5.24210944616705e-12 + (fConst1 * (((fRec4[0] * (fConst97 + (fConst96 * fRec4[0]))) + (fRec5[0] * (fConst95 + (fConst1 * (fRec4[0] * (fConst94 + (fConst93 * fRec4[0]))))))) + fConst92)))) + (fConst1 * ((fRec4[0] * (fConst91 + (fConst90 * fRec4[0]))) + fConst89)))))) + (fRec7[3] * (2.30862500009197e-12 + ((fRec5[0] * (5.24210944616705e-12 + (fConst1 * (((fRec4[0] * (fConst88 + (fConst86 * fRec4[0]))) + (fRec5[0] * (fConst84 + (fConst1 * (fRec4[0] * (fConst82 + (fConst80 * fRec4[0]))))))) + fConst78)))) + (fConst1 * ((fRec4[0] * (fConst76 + (fConst74 * fRec4[0]))) + fConst72)))))) + (fRec7[4] * (1.15431250004598e-12 + ((fRec5[0] * (2.62105472308353e-12 + (fConst1 * (((fRec4[0] * (fConst70 + (fConst68 * fRec4[0]))) + (fRec5[0] * (fConst66 + (fConst1 * (fRec4[0] * (fConst64 + (fConst62 * fRec4[0]))))))) + fConst60)))) + (fConst1 * ((fRec4[0] * (fConst58 + (fConst56 * fRec4[0]))) + fConst54)))))) + (fRec7[5] * (2.30862500009197e-13 + ((fRec5[0] * (5.24210944616705e-13 + (fConst1 * (((fRec4[0] * (fConst52 + (fConst51 * fRec4[0]))) + (fRec5[0] * (fConst50 + (fConst1 * (fRec4[0] * (fConst49 + (fConst48 * fRec4[0]))))))) + fConst47)))) + (fConst1 * ((fRec4[0] * (fConst46 + (fConst45 * fRec4[0]))) + fConst44)))))) / fTemp1));
		fRec8[0] = ((fConst195 * fRec8[1]) + (fConst194 * (fRec3[1] + fRec3[2])));
		fRec3[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec8[0] + (fConst191 * (((((((fRec7[0] * ((((fRec5[0] * (fConst190 + ((fConst1 * (fRec4[0] * (fConst189 + ((fRec4[0] * (fConst188 + (fConst187 * fRec6[0]))) + (fConst186 * fRec6[0]))))) + (fConst185 * fRec6[0])))) + (fConst1 * (fRec4[0] * (((fRec4[0] * (fConst184 + (fConst183 * fRec6[0]))) + (fConst182 * fRec6[0])) + fConst181)))) + (fConst180 * fRec6[0])) + fConst179)) + (fRec7[1] * ((((fRec5[0] * (((fConst1 * (fRec4[0] * (((fRec4[0] * (fConst178 + (fConst177 * fRec6[0]))) + (fConst176 * fRec6[0])) + fConst175))) + (fConst174 * fRec6[0])) + fConst173)) + (fConst1 * (fRec4[0] * (((fRec4[0] * (fConst172 + (fConst171 * fRec6[0]))) + (fConst170 * fRec6[0])) + fConst169)))) + (fConst168 * fRec6[0])) + fConst167))) + (fRec7[2] * ((((fRec5[0] * (((fConst1 * (fRec4[0] * (fConst166 + ((fRec4[0] * (fConst165 + (fConst164 * fRec6[0]))) + (fConst163 * fRec6[0]))))) + (fConst162 * fRec6[0])) + fConst161)) + (fConst1 * (fRec4[0] * (((fRec4[0] * (fConst160 + (fConst159 * fRec6[0]))) + (fConst158 * fRec6[0])) + fConst157)))) + (fConst156 * fRec6[0])) + fConst155))) + (fRec7[3] * ((((fRec5[0] * (fConst154 + ((fConst1 * (fRec4[0] * (((fRec4[0] * (fConst152 + (fConst150 * fRec6[0]))) + (fConst148 * fRec6[0])) + fConst146))) + (fConst144 * fRec6[0])))) + (fConst1 * (fRec4[0] * (fConst142 + ((fRec4[0] * (fConst140 + (fConst138 * fRec6[0]))) + (fConst136 * fRec6[0])))))) + (fConst134 * fRec6[0])) + fConst132))) + (fRec7[4] * (fConst130 + (((fRec5[0] * (((fConst1 * (fRec4[0] * (((fRec4[0] * (fConst128 + (fConst126 * fRec6[0]))) + (fConst124 * fRec6[0])) + fConst122))) + (fConst120 * fRec6[0])) + fConst118)) + (fConst1 * (fRec4[0] * (((fRec4[0] * (fConst116 + (fConst114 * fRec6[0]))) + (fConst112 * fRec6[0])) + fConst110)))) + (fConst108 * fRec6[0]))))) + (fRec7[5] * ((((fRec5[0] * (((fConst1 * (fRec4[0] * (((fRec4[0] * (fConst43 + (fConst41 * fRec6[0]))) + (fConst39 * fRec6[0])) + fConst37))) + (fConst35 * fRec6[0])) + fConst33)) + (fConst1 * (fRec4[0] * (fConst31 + ((fRec4[0] * (fConst29 + (fConst27 * fRec6[0]))) + (fConst25 * fRec6[0])))))) + (fConst23 * fRec6[0])) + fConst21))) / fTemp1))) - 5.562895)) - 43.96685185185183);
		fRec2[0] = ((fConst200 * fRec2[1]) + (fConst199 * ((fConst196 * fRec3[0]) + (fConst197 * fRec3[1]))));
		fRec9[0] = ((fConst195 * fRec9[1]) + (fConst194 * (fRec1[1] + fRec1[2])));
		fRec1[0] = (Ftrany(TRANY_TABLE_KT88_68k, ((fRec9[0] + fRec2[0]) - 5.562895)) - 43.96685185185183);
