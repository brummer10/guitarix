...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec9[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec17[0] + fRec10[0]) - 3.571981)) - 117.70440740740739);
		fRec8[0] = ((fConst179 * fRec8[1]) + (fConst178 * ((fConst175 * fRec9[0]) + (fConst176 * fRec9[1]))));
		fRec7[0] = (fRec8[0] - (fRec7[2] + fTemp2));
		double fTemp6 = (fTemp2 + (fRec7[0] + fRec7[2]));
		fVec1[0] = fTemp6;
		...
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec18[0] + fRec6[0]) - 3.571981)) - 117.70440740740739);
		fRec4[0] = ((fConst179 * fRec4[1]) + (fConst178 * ((fConst175 * fRec5[0]) + (fConst176 * fRec5[1]))));
		fRec3[0] = (fRec4[0] - (fTemp1 + fRec3[2]));
		double fTemp7 = (fRec3[2] + (fRec3[0] + fTemp1));
		fVec2[0] = fTemp7;
		...
		fRec1[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec19[0] + fRec2[0]) - 3.571981)) - 117.70440740740739);
