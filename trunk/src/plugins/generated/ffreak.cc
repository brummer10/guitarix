...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	fConst12 = 6.54379653368279e-24 * fConst0;
	...
	fConst54 = 3.92706159921519e-23 * fConst0;
	fConst55 = fConst0 * (fConst0 * (fConst0 * (2.33637823995467e-19 - fConst54) + -9.37831383212842e-17) + -2.2395439003671e-14) + 2.09428469678622e-14;
	fConst56 = 4.02110307987707e-23 * fConst0;
	fConst57 = fConst0 * (fConst0 * (fConst0 * (fConst56 + -2.38679939536519e-19) + 9.44004344622607e-17) + 2.24958749395835e-14) + -8.81352359124856e-14;
	fConst58 = 2.7923299189887e-23 * fConst0;
	fConst59 = fConst5 * (fConst0 * (fConst0 * (fConst58 + -1.02635765875996e-19) + 3.19454127568422e-17) + 2.62717307381708e-15);
	fConst60 = 2.85919794064914e-23 * fConst0;
	fConst61 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.04700508226387e-19 - fConst60) + -3.20489931550843e-17) + -2.65988017960028e-15) + 7.88151922145125e-15);
	fConst62 = fConst5 * (fConst0 * (fConst0 * (2.2673537861441e-19 - fConst54) + -7.35486357301917e-17) + -3.92585764869989e-15);
	fConst63 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst56 + -2.31612201055921e-19) + 7.37353569889037e-17) + 4.00054450346227e-15) + -1.17775729460997e-14);
	fConst64 = 3.27189826684139e-23 * fConst0;
	fConst65 = fConst0 * (fConst0 * (fConst0 * (fConst64 + -1.74534751099098e-19) + 1.85568523263077e-17) + 1.66102929456909e-16) + -1.50114464615909e-16;
	fConst66 = 3.35026616739297e-23 * fConst0;
	fConst67 = fConst0 * (fConst0 * (fConst0 * (1.78734806481567e-19 - fConst66) + -1.90595008624394e-17) + -1.88638248347695e-16) + 6.52018766806119e-16;
	fConst68 = 2.32647723789572e-23 * fConst0;
	fConst69 = fConst5 * (fConst0 * (fConst0 * (7.1203189810368e-20 - fConst68) + -2.32762902199933e-18) + -1.88310920685508e-17);
	fConst70 = 2.38220058927942e-23 * fConst0;
	fConst71 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst70 + -7.29225942723227e-20) + 2.40711435730575e-18) + 2.16097599157672e-17) + -5.64932762056525e-17);
	fConst72 = fConst5 * (fConst0 * (fConst0 * (fConst64 + -1.68783861150297e-19) + 3.66325429672487e-18) + 2.81398235873665e-17);
	fConst73 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.72846172283149e-19 - fConst66) + -3.80725717138185e-18) + -3.24770777204501e-17) + 8.44194707620995e-17);
	fConst74 = 7.85412319843037e-23 * fConst0;
	fConst75 = fConst0 * (fConst0 * (fConst0 * (fConst74 + -1.55758549330311e-19) + -1.87566276642568e-16) + 4.4790878007342e-14) + 1.39618979785748e-14;
	fConst76 = 8.04220615975415e-23 * fConst0;
	fConst77 = fConst0 * (fConst0 * (fConst0 * (1.59119959691012e-19 - fConst76) + 1.88800868924521e-16) + -4.49917498791669e-14) + -5.87568239416571e-14;
	fConst78 = 5.5846598379774e-23 * fConst0;
	fConst79 = fConst5 * (fConst0 * (fConst0 * (6.84238439173306e-20 - fConst78) + 6.38908255136844e-17) + -5.25434614763417e-15);
	fConst80 = 5.71839588129828e-23 * fConst0;
	fConst81 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst80 + -6.98003388175915e-20) + -6.40979863101685e-17) + 5.31976035920056e-15) + 5.25434614763417e-15);
	fConst82 = fConst5 * (fConst0 * (fConst0 * (fConst74 + -1.51156919076274e-19) + -1.47097271460383e-16) + 7.85171529739978e-15);
	fConst83 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (1.54408134037281e-19 - fConst76) + 1.47470713977807e-16) + -8.00108900692453e-15) + -7.85171529739978e-15);
	fConst84 = 6.54379653368279e-23 * fConst0;
	fConst85 = fConst0 * (fConst0 * (fConst0 * (1.16356500732732e-19 - fConst84) + 3.71137046526153e-17) + -3.32205858913818e-16) + -1.00076309743939e-16;
	fConst86 = 6.70053233478593e-23 * fConst0;
	fConst87 = fConst0 * (fConst0 * (fConst0 * (fConst86 + -1.19156537654378e-19) + -3.81190017248788e-17) + 3.7727649669539e-16) + 4.34679177870746e-16;
	fConst88 = 4.65295447579144e-23 * fConst0;
	fConst89 = fConst5 * (fConst0 * (fConst0 * (fConst88 + -4.7468793206912e-20) + -4.65525804399867e-18) + 3.76621841371017e-17);
	fConst90 = 4.76440117855883e-23 * fConst0;
	fConst91 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (4.86150628482151e-20 - fConst90) + 4.8142287146115e-18) + -4.32195198315344e-17) + -3.76621841371017e-17);
	fConst92 = fConst5 * (fConst0 * (fConst0 * (1.12522574100198e-19 - fConst84) + 7.32650859344974e-18) + -5.6279647174733e-17);
	fConst93 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst86 + -1.15230781522099e-19) + -7.6145143427637e-18) + 6.49541554409002e-17) + 5.6279647174733e-17);
	fConst94 = fConst5 * (fConst0 * (fConst0 * (fConst78 + 6.84238439173306e-20) + -6.38908255136844e-17) + -5.25434614763417e-15);
	fConst95 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-6.98003388175915e-20 - fConst80) + 6.40979863101685e-17) + 5.31976035920056e-15) + -5.25434614763417e-15);
	fConst96 = fConst5 * (fConst0 * (fConst0 * (-1.51156919076274e-19 - fConst74) + 1.47097271460383e-16) + 7.85171529739978e-15);
	fConst97 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst76 + 1.54408134037281e-19) + -1.47470713977807e-16) + -8.00108900692453e-15) + 7.85171529739978e-15);
	fConst98 = fConst0 * (fConst0 * (fConst0 * (fConst84 + 1.16356500732732e-19) + -3.71137046526153e-17) + -3.32205858913818e-16) + 1.00076309743939e-16;
	fConst99 = fConst0 * (fConst0 * (fConst0 * (-1.19156537654378e-19 - fConst86) + 3.81190017248788e-17) + 3.7727649669539e-16) + -4.34679177870746e-16;
	fConst100 = fConst5 * (fConst0 * (fConst0 * (-4.7468793206912e-20 - fConst88) + 4.65525804399867e-18) + 3.76621841371017e-17);
	fConst101 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst90 + 4.86150628482151e-20) + -4.8142287146115e-18) + -4.32195198315344e-17) + 3.76621841371017e-17);
	fConst102 = fConst5 * (fConst0 * (fConst0 * (fConst84 + 1.12522574100198e-19) + -7.32650859344974e-18) + -5.6279647174733e-17);
	fConst103 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-1.15230781522099e-19 - fConst86) + 7.6145143427637e-18) + 6.49541554409002e-17) + -5.6279647174733e-17);
	fConst104 = fConst0 * (fConst0 * (fConst0 * (-1.55758549330311e-19 - fConst74) + 1.87566276642568e-16) + 4.4790878007342e-14) + -1.39618979785748e-14;
	fConst105 = fConst0 * (fConst0 * (fConst0 * (fConst76 + 1.59119959691012e-19) + -1.88800868924521e-16) + -4.49917498791669e-14) + 5.87568239416571e-14;
	fConst106 = fConst5 * (fConst0 * (fConst0 * (-1.02635765875996e-19 - fConst58) + -3.19454127568422e-17) + 2.62717307381708e-15);
	fConst107 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst60 + 1.04700508226387e-19) + 3.20489931550843e-17) + -2.65988017960028e-15) + -7.88151922145125e-15);
	fConst108 = fConst5 * (fConst0 * (fConst0 * (fConst54 + 2.2673537861441e-19) + 7.35486357301917e-17) + -3.92585764869989e-15);
	fConst109 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-2.31612201055921e-19 - fConst56) + -7.37353569889037e-17) + 4.00054450346227e-15) + 1.17775729460997e-14);
	fConst110 = fConst0 * (fConst0 * (fConst0 * (-1.74534751099098e-19 - fConst64) + -1.85568523263077e-17) + 1.66102929456909e-16) + 1.50114464615909e-16;
	fConst111 = fConst0 * (fConst0 * (fConst0 * (fConst66 + 1.78734806481567e-19) + 1.90595008624394e-17) + -1.88638248347695e-16) + -6.52018766806119e-16;
	fConst112 = fConst5 * (fConst0 * (fConst0 * (fConst68 + 7.1203189810368e-20) + 2.32762902199933e-18) + -1.88310920685508e-17);
	fConst113 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (-7.29225942723227e-20 - fConst70) + -2.40711435730575e-18) + 2.16097599157672e-17) + 5.64932762056525e-17);
	fConst114 = fConst5 * (fConst0 * (fConst0 * (-1.68783861150297e-19 - fConst64) + -3.66325429672487e-18) + 2.81398235873665e-17);
	fConst115 = fConst0 * (fConst0 * (fConst0 * (fConst0 * (fConst66 + 1.72846172283149e-19) + 3.80725717138185e-18) + -3.24770777204501e-17) + -8.44194707620995e-17);
	fConst116 = fConst0 * (fConst0 * (fConst0 * (fConst54 + 2.33637823995467e-19) + 9.37831383212842e-17) + -2.2395439003671e-14) + -2.09428469678622e-14;
	fConst117 = fConst0 * (fConst0 * (fConst0 * (-2.38679939536519e-19 - fConst56) + -9.44004344622607e-17) + 2.24958749395835e-14) + 8.81352359124856e-14;
	fConst118 = 5.63260410005403e-18 * fConst0;
	...
	fConst148 = 5.40124372383451e-18 * fConst0;
