...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerVar("ffreak.Volume",N_("Volume"),"S","",&fslider4, 0.5, 0.0, 1.0, 0.01);
	reg.registerVar("ffreak.wet_dry",N_("wet/dry"),"S",N_("percentage of processed signal in output signal"),&fslider3, 1e+02, 0.0, 1e+02, 1.0);
	return 0;
}
