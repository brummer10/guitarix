...
inline void Dsp::init(unsigned int sample_rate)
{
	...
	double fConst1 = 9.91377586985301e-24 * fConst0;
	double fConst2 = fConst0 * (fConst0 * (-9.36483991458906e-20 - fConst1) + -1.70486053448624e-16) + -2.12307123308889e-15;
	double fConst3 = 5.11091507074998e-24 * fConst0;
	double fConst4 = fConst0 * (fConst0 * (fConst3 + 6.98874158230498e-20) + 1.4095256819997e-16) + 1.75646845862514e-15;
	double fConst5 = mydsp_faustpower2_f(fConst0);
	fConst6 = fConst5 * (fConst4 + fConst2);
	double fConst7 = 5.07545362580621e-24 * fConst0;
	double fConst8 = fConst0 * (fConst0 * (fConst0 * (-7.00613593632107e-20 - fConst7) + -1.47460849525455e-16) + -2.81034919192636e-15) + -1.29152092545966e-14;
	double fConst9 = 9.84499037599778e-24 * fConst0;
	double fConst10 = fConst0 * (fConst0 * (fConst0 * (fConst9 + 9.42766173980015e-20) + 1.78421312766784e-16) + 3.39775512445924e-15) + 1.56108178903595e-14;
	fConst11 = fConst0 * (fConst10 + fConst8);
	double fConst12 = 1.03973026841637e-24 * fConst0;
	double fConst13 = fConst0 * (fConst0 * (-5.71785438210912e-20 - fConst12) + -1.41224926366503e-16) + -3.77185698680303e-15;
	double fConst14 = 1.58888527196851e-24 * fConst0;
	double fConst15 = fConst0 * (fConst0 * (fConst14 + 6.14378170525581e-20) + 1.4867852143994e-16) + 4.14135154627774e-15;
	fConst16 = fConst0 * (fConst0 * (fConst15 + fConst13) + 4.997034139323402e-15);
	double fConst17 = 3.9514408494262e-27 * fConst0;
	double fConst18 = 4.07249439024394e-27 * fConst0;
	...
	double fConst21 = 3.9514408494262e-29 * fConst0;
	...
	double fConst41 = 7.94442635984257e-24 * fConst0;
	double fConst42 = 5.19865134208184e-24 * fConst0;
	...
	double fConst52 = 1.58888527196851e-23 * fConst0;
	double fConst53 = 1.03973026841637e-23 * fConst0;
	...
	double fConst65 = 1.9757204247131e-26 * fConst0;
	double fConst66 = 2.03624719512197e-26 * fConst0;
	...
	double fConst69 = 2.03624719512197e-28 * fConst0;
	fConst70 = fConst0 * (fConst69 + 4.02356549528453e-22 + (-3.78902721530964e-22 - fConst68));
	double fConst71 = 4.07249439024394e-26 * fConst0;
	double fConst72 = 3.9514408494262e-26 * fConst0;
	...
	double fConst74 = 4.07249439024394e-28 * fConst0;
	double fConst75 = 3.9514408494262e-28 * fConst0;
