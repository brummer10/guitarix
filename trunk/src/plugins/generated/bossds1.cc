...
inline void Dsp::init(unsigned int RsamplingFreq)
{
	...
	double fConst27 = 3.0314296262996e-10 * fConst0;
	fConst28 = fConst0 * (fConst27 + -3.38397180940322e-09);
	double fConst29 = 1.49503874539434e-11 * fConst0;
	fConst30 = fConst0 * (fConst29 + 1.66555708487018e-05);
	fConst31 = fConst0 * (fConst27 + -1.59012835323858e-05);
	fConst32 = fConst0 * (fConst29 + -7.50903344506575e-07);
	fConst33 = fConst0 * (fConst27 + 3.38397180940322e-09);
	fConst34 = fConst0 * (fConst29 + -1.66555708487018e-05);
	double fConst35 = 3.53982651634833e-10 * fConst0;
	fConst36 = fConst0 * (fConst35 + -2.38582349500046e-07) + 1.94656546234155e-05;
	fConst37 = fConst0 * (-2.38582349500046e-07 - fConst35) + 5.83969638702466e-05;
	fConst38 = fConst0 * (2.38582349500046e-07 - fConst35) + 5.83969638702466e-05;
	fConst39 = 1.0 / (fConst0 * (fConst35 + 2.38582349500046e-07) + 1.94656546234155e-05);
	double fConst40 = 2.08223456923865e-05 * fConst0;
	double fConst41 = fConst40 + 0.000527406765446517;
	fConst42 = (0.000527406765446517 - fConst40) / fConst41;
	fConst43 = 2.06179485600366e-05 * fConst0;
	fConst44 = 0.0 - fConst43;
	fConst45 = 1.0 / fConst41;
	fConst46 = 5.51041967277497e-09 * fConst3;
	fConst47 = 0.0 - fConst46;
	fConst48 = fConst0 * (fConst27 + 1.59012835323858e-05);
	fConst49 = fConst0 * (fConst29 + 7.50903344506575e-07);
	fConst50 = 1.89077966855745e-05 * fConst0;
	fConst51 = 0.0 - fConst50;
	fConst52 = 1.0 / fConst25;
	fConst53 = 9.4e-08 * fConst0;
	fConst54 = 0.45081801796277066 / fConst22;
	fConst55 = 4.37684801272465e-10 * fConst3;
	fConst56 = fConst55 + 0.00107562519972983;
	fConst57 = fConst0 * (5.20602596669238e-08 - fConst12) + 0.000537812599864916;
	fConst58 = fConst0 * (fConst12 + 2.33324618325395e-07);
	double fConst59 = 4.26031359768866e-10 * fConst0;
	fConst60 = fConst0 * (fConst59 + -2.06011295826338e-10);
	fConst61 = 0.0 - 8.52062719537733e-10 * fConst3;
	fConst62 = fConst0 * (fConst59 + 2.06011295826338e-10);
	clear_state_f();
}
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i0 = 0; i0 < ReCount; i0 = i0 + 1) {
		...
		double fTemp2 = fConst30 + fRec5[0] * (fConst28 + fTemp1) + 0.000169198590470162;
		double fTemp3 = fConst3 * (fRec5[0] * (6.36186700167807e-10 * fRec5[0] + -6.0628592525992e-10) + -2.99007749078869e-11);
		fRec8[0] = double(buf[i0]) - fConst42 * fRec8[1];
		fRec7[0] = fConst45 * (fConst44 * fRec8[1] + fConst43 * fRec8[0]) - fConst39 * (fConst38 * fRec7[1] + fConst37 * fRec7[2] + fConst36 * fRec7[3]);
		fRec6[0] = fConst39 * (fConst47 * fRec7[0] + fConst46 * fRec7[1] + fConst46 * fRec7[2] + fConst47 * fRec7[3]) - (fRec6[1] * (fTemp3 + 0.000338397180940324) + fRec6[2] * (fConst34 + fRec5[0] * (fConst33 + fTemp1) + 0.000169198590470162)) / fTemp2;
		fRec4[0] = 0.3183098861837907 * std::atan((fRec6[0] * (fConst49 + fRec5[0] * (fConst48 + fTemp1) + 0.000169198590470161) + fRec6[1] * (fTemp3 + 0.000338397180940323) + fRec6[2] * (fConst32 + fRec5[0] * (fConst31 + fTemp1) + 0.000169198590470161)) / fTemp2) - fConst26 * fRec4[1];
		double fTemp4 = fConst52 * (fConst51 * fRec4[1] + fConst50 * fRec4[0]);
		double fTemp5 = opamp(fTemp4);
		double fTemp6 = 1.0 - fRec5[0];
		double fTemp7 = fConst53 * (1e+05 * fTemp6 + 4.7e+03);
		double fTemp8 = fConst53 * (1e+05 * (fTemp6 + fRec5[0] + 1.0) + 4.7e+03);
		...
		fRec2[0] = fConst54 * (fRec3[0] + fRec3[1]) - (fRec2[1] * (fRec1[0] * (fConst20 * fRec1[0] + 0.00107562519972983 - fConst19) + 0.00229710517654303 - fConst18) + fRec2[2] * (fConst17 + fRec1[0] * (fConst16 + fConst15 * fRec1[0] + 0.000537812599864916) + 0.00114855258827151)) / fTemp0;
		fRec0[0] = (fRec2[0] * (fConst58 + fConst57 * fRec1[0] + 0.000182856283954071) + fRec2[1] * (fConst56 * fRec1[0] + 0.000365712567908143 - fConst55) + fRec2[2] * (fConst14 + fConst13 * fRec1[0] + 0.000182856283954071)) / fTemp0 - fConst5 * (fConst4 * fRec0[1] + fConst2 * fRec0[2]);
		fRec10[0] = fSlow2 + 0.993 * fRec10[1];
		buf[i0] = FAUSTFLOAT(fConst5 * fRec10[0] * (fConst62 * fRec0[0] + fConst61 * fRec0[1] + fConst60 * fRec0[2]));
		fRec1[1] = fRec1[0];
		fRec5[1] = fRec5[0];
		fRec8[1] = fRec8[0];
