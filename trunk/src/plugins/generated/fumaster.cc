...
inline void Dsp::init(unsigned int samplingFreq)
{
	...
	fConst51 = (0.1 * (0 - (1.03791509739679e-18 + (2.83550541032623e-26 * fConst18))));
...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		fRec5[0] = (Ftrany(TRANY_TABLE_7199P_68k, ((fRec9[0] + (fConst65 * ((((((((fRec8[0] * (fConst64 + ((fConst1 * (fRec6[0] * (fConst63 + (fConst62 * fRec7[0])))) + (fConst61 * fRec7[0])))) + (fRec8[1] * (((fConst1 * (fRec6[0] * (fConst60 + (fConst59 * fRec7[0])))) + (fConst58 * fRec7[0])) + fConst57))) + (fRec8[2] * (((fConst1 * (fRec6[0] * (fConst56 + (fConst55 * fRec7[0])))) + (fConst54 * fRec7[0])) + fConst53))) + (fRec8[3] * (fConst52 + ((fConst18 * (fRec6[0] * (2.83550541032623e-28 + (2.83550541032623e-26 * fRec7[0])))) + (fConst51 * fRec7[0]))))) + (fRec8[4] * (((fConst1 * (fRec6[0] * (fConst50 + (fConst49 * fRec7[0])))) + (fConst48 * fRec7[0])) + fConst46))) + (fRec8[5] * (((fConst1 * (fRec6[0] * (fConst44 + (fConst43 * fRec7[0])))) + (fConst42 * fRec7[0])) + fConst40))) + (fRec8[6] * (((fConst1 * (fRec6[0] * (fConst13 + (fConst12 * fRec7[0])))) + (fConst11 * fRec7[0])) + fConst9))) / fTemp1))) - 3.571981)) - 117.70440740740739);
