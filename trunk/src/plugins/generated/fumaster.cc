...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i=0; i<count; i++) {
		...
		double fTemp4 = (5.42437371078787e-14 + (fConst1 * ((fRec12[0] * (fConst7 + (fConst5 * fRec12[0]))) + fConst3)));
		fRec13[0] = ((0.993 * fRec13[1]) + fSlow3);
		fRec14[0] = ((fSlow0 * fTemp0) - (((((((fRec14[1] * (3.25462422647273e-13 + (fConst1 * ((fRec12[0] * (fConst38 + (fConst37 * fRec12[0]))) + fConst36)))) + (fRec14[2] * (8.13656056618181e-13 + (fConst1 * ((fRec12[0] * (fConst35 + (fConst34 * fRec12[0]))) + fConst33))))) + (fRec14[3] * (1.08487474215758e-12 + (fConst18 * ((fRec12[0] * (fConst32 + (fConst31 * fRec12[0]))) + fConst30))))) + (fRec14[4] * (8.13656056618181e-13 + (fConst1 * ((fRec12[0] * (fConst29 + (fConst27 * fRec12[0]))) + fConst25))))) + (fRec14[5] * (3.25462422647273e-13 + (fConst1 * ((fRec12[0] * (fConst23 + (fConst21 * fRec12[0]))) + fConst19))))) + (fRec14[6] * (5.42437371078787e-14 + (fConst1 * ((fRec12[0] * (fConst16 + (fConst15 * fRec12[0]))) + fConst14))))) / fTemp4));
		fRec11[0] = ((fConst65 * ((((((((fRec14[0] * (fConst64 + ((fConst1 * (fRec12[0] * (fConst63 + (fConst62 * fRec13[0])))) + (fConst61 * fRec13[0])))) + (fRec14[1] * (((fConst1 * (fRec12[0] * (fConst60 + (fConst59 * fRec13[0])))) + (fConst58 * fRec13[0])) + fConst57))) + (fRec14[2] * (((fConst1 * (fRec12[0] * (fConst56 + (fConst55 * fRec13[0])))) + (fConst54 * fRec13[0])) + fConst53))) + (fRec14[3] * (((fConst18 * (fRec12[0] * (2.83550541032623e-28 + (2.83550541032623e-26 * fRec13[0])))) + (fConst52 * fRec13[0])) + fConst51))) + (fRec14[4] * (((fConst1 * (fRec12[0] * (fConst50 + (fConst49 * fRec13[0])))) + (fConst48 * fRec13[0])) + fConst46))) + (fRec14[5] * (((fConst1 * (fRec12[0] * (fConst44 + (fConst43 * fRec13[0])))) + (fConst42 * fRec13[0])) + fConst40))) + (fRec14[6] * (((fConst1 * (fRec12[0] * (fConst13 + (fConst12 * fRec13[0])))) + (fConst11 * fRec13[0])) + fConst9))) / fTemp4)) - (fTemp3 + fRec11[2]));
		...
		double fTemp6 = (fRec7[2] + (fRec7[0] + fTemp2));
		fVec1[0] = fTemp6;
