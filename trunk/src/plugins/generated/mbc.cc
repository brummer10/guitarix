...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	for (int i = 0; (i < count); i = (i + 1)) {
		...
		fRec23[0] = fRec24[0];
		fRec22[0] = ((fRec22[1] * fSlow73) + (fSlow74 * (std::max<double>((fSlow59 + (20.0 * std::log10(fRec23[0]))), 0.0) * fSlow80)));
		double fTemp20 = (fSlow58 * (fRec15[0] * (iSlow62 ? fTemp16 : (fTemp17 * std::pow(10.0, (0.050000000000000003 * fRec22[0]))))));
		...
		fRec35[0] = fRec36[0];
		fRec34[0] = ((fRec34[1] * fSlow97) + (fSlow98 * (std::max<double>((fSlow83 + (20.0 * std::log10(fRec35[0]))), 0.0) * fSlow104)));
		double fTemp30 = (fSlow82 * (fRec28[0] * (iSlow86 ? fTemp26 : (fTemp27 * std::pow(10.0, (0.050000000000000003 * fRec34[0]))))));
		...
		fRec46[0] = fRec47[0];
		fRec45[0] = ((fRec45[1] * fSlow120) + (fSlow121 * (std::max<double>((fSlow107 + (20.0 * std::log10(fRec46[0]))), 0.0) * fSlow127)));
		double fTemp39 = (fSlow106 * (fRec40[0] * (iSlow110 ? fTemp35 : (fTemp36 * std::pow(10.0, (0.050000000000000003 * fRec45[0]))))));
		...
		fRec55[0] = fRec56[0];
		fRec54[0] = ((fRec54[1] * fSlow137) + (fSlow138 * (std::max<double>((fSlow130 + (20.0 * std::log10(fRec55[0]))), 0.0) * fSlow144)));
		double fTemp46 = (fSlow129 * (fRec51[0] * (iSlow133 ? fTemp42 : (fTemp43 * std::pow(10.0, (0.050000000000000003 * fRec54[0]))))));
