...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerVar("mbc.show_always_crossover_b1_b2",N_("Crossover B1-B2 (hz)"),"S",N_("Crossover bandpass frequency"),&fslider22, 8e+01, 2e+01, 2e+04, 1.0);
	...
	reg.registerVar("mbc.show_always_crossover_b2_b3",N_("Crossover B2-B3 (hz)"),"S",N_("Crossover bandpass frequency"),&fslider15, 2.1e+02, 2e+01, 2e+04, 1.0);
	...
	reg.registerVar("mbc.show_always_crossover_b4_b5",N_("Crossover B4-B5 (hz)"),"S",N_("Crossover bandpass frequency"),&fslider2, 5e+03, 2e+01, 2e+04, 1.0);
	reg.registerVar("mbc.show_always_crossover_b3_b4",N_("Crossover B3-B4 (hz)"),"S",N_("Crossover bandpass frequency"),&fslider1, 1.7e+03, 2e+01, 2e+04, 1.0);
