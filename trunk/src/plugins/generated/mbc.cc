...
void always_inline Dsp::compute(int count, FAUSTFLOAT *input0, FAUSTFLOAT *output0)
{
	...
	double fThen4 = std::exp(0.0 - fConst1 / ((iSlow52) ? 1.0 : fSlow47));
	double fSlow53 = ((iSlow52) ? 0.0 : fThen4);
	double fSlow54 = double(fHslider9);
	int iSlow55 = std::fabs(fSlow54) < 2.2204460492503131e-16;
	double fThen6 = std::exp(0.0 - fConst1 / ((iSlow55) ? 1.0 : fSlow54));
	double fSlow56 = ((iSlow55) ? 0.0 : fThen6);
	...
	double fThen14 = std::exp(0.0 - fConst1 / ((iSlow73) ? 1.0 : fSlow72));
	double fSlow74 = ((iSlow73) ? 0.0 : fThen14);
	double fSlow75 = 1.0 - fSlow74;
	int iSlow76 = std::fabs(fSlow71) < 2.2204460492503131e-16;
	double fThen16 = std::exp(0.0 - fConst1 / ((iSlow76) ? 1.0 : fSlow71));
	double fSlow77 = ((iSlow76) ? 0.0 : fThen16);
	double fSlow78 = double(fHslider15);
	int iSlow79 = std::fabs(fSlow78) < 2.2204460492503131e-16;
	double fThen18 = std::exp(0.0 - fConst1 / ((iSlow79) ? 1.0 : fSlow78));
	double fSlow80 = ((iSlow79) ? 0.0 : fThen18);
	...
	double fThen26 = std::exp(0.0 - fConst1 / ((iSlow97) ? 1.0 : fSlow96));
	double fSlow98 = ((iSlow97) ? 0.0 : fThen26);
	double fSlow99 = 1.0 - fSlow98;
	int iSlow100 = std::fabs(fSlow95) < 2.2204460492503131e-16;
	double fThen28 = std::exp(0.0 - fConst1 / ((iSlow100) ? 1.0 : fSlow95));
	double fSlow101 = ((iSlow100) ? 0.0 : fThen28);
	double fSlow102 = double(fHslider21);
	int iSlow103 = std::fabs(fSlow102) < 2.2204460492503131e-16;
	double fThen30 = std::exp(0.0 - fConst1 / ((iSlow103) ? 1.0 : fSlow102));
	double fSlow104 = ((iSlow103) ? 0.0 : fThen30);
	...
	double fThen38 = std::exp(0.0 - fConst1 / ((iSlow120) ? 1.0 : fSlow119));
	double fSlow121 = ((iSlow120) ? 0.0 : fThen38);
	double fSlow122 = 1.0 - fSlow121;
	int iSlow123 = std::fabs(fSlow118) < 2.2204460492503131e-16;
	double fThen40 = std::exp(0.0 - fConst1 / ((iSlow123) ? 1.0 : fSlow118));
	double fSlow124 = ((iSlow123) ? 0.0 : fThen40);
	double fSlow125 = double(fHslider27);
	int iSlow126 = std::fabs(fSlow125) < 2.2204460492503131e-16;
	double fThen42 = std::exp(0.0 - fConst1 / ((iSlow126) ? 1.0 : fSlow125));
	double fSlow127 = ((iSlow126) ? 0.0 : fThen42);
	...
	double fThen50 = std::exp(0.0 - fConst1 / ((iSlow137) ? 1.0 : fSlow136));
	double fSlow138 = ((iSlow137) ? 0.0 : fThen50);
	double fSlow139 = 1.0 - fSlow138;
	int iSlow140 = std::fabs(fSlow135) < 2.2204460492503131e-16;
	double fThen52 = std::exp(0.0 - fConst1 / ((iSlow140) ? 1.0 : fSlow135));
	double fSlow141 = ((iSlow140) ? 0.0 : fThen52);
	double fSlow142 = double(fHslider33);
	int iSlow143 = std::fabs(fSlow142) < 2.2204460492503131e-16;
	double fThen54 = std::exp(0.0 - fConst1 / ((iSlow143) ? 1.0 : fSlow142));
	double fSlow144 = ((iSlow143) ? 0.0 : fThen54);
	for (int i0 = 0; i0 < count; i0 = i0 + 1) {
		...
		double fTemp8 = ((fRec10[1] > fTemp7) ? fSlow56 : fSlow53);
		fRec11[0] = fTemp7 * (1.0 - fTemp8) + fTemp8 * fRec11[1];
		fRec10[0] = fRec11[0];
		...
		double fTemp19 = ((fRec23[1] > fTemp18) ? fSlow80 : fSlow77);
		fRec24[0] = fTemp18 * (1.0 - fTemp19) + fTemp19 * fRec24[1];
		fRec23[0] = fRec24[0];
		fRec22[0] = fSlow70 * fSlow75 * std::max<double>(fSlow59 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec23[0])), 0.0) + fSlow74 * fRec22[1];
		...
		double fTemp29 = ((fRec35[1] > fTemp28) ? fSlow104 : fSlow101);
		fRec36[0] = fTemp28 * (1.0 - fTemp29) + fTemp29 * fRec36[1];
		fRec35[0] = fRec36[0];
		fRec34[0] = fSlow94 * fSlow99 * std::max<double>(fSlow83 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec35[0])), 0.0) + fSlow98 * fRec34[1];
		...
		double fTemp38 = ((fRec46[1] > fTemp37) ? fSlow127 : fSlow124);
		fRec47[0] = fTemp37 * (1.0 - fTemp38) + fTemp38 * fRec47[1];
		fRec46[0] = fRec47[0];
		fRec45[0] = fSlow117 * fSlow122 * std::max<double>(fSlow107 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec46[0])), 0.0) + fSlow121 * fRec45[1];
		...
		double fTemp45 = ((fRec55[1] > fTemp44) ? fSlow144 : fSlow141);
		fRec56[0] = fTemp44 * (1.0 - fTemp45) + fTemp45 * fRec56[1];
		fRec55[0] = fRec56[0];
		fRec54[0] = fSlow134 * fSlow139 * std::max<double>(fSlow130 + 20.0 * std::log10(std::max<double>(2.2250738585072014e-308, fRec55[0])), 0.0) + fSlow138 * fRec54[1];
...
int Dsp::register_par(const ParamReg& reg)
{
	...
	reg.registerFloatVar("mbc.Ratio1","","S",N_("Compression ratio"),&fHslider31, 2.0, 1.0, 100.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbc.Ratio2","","S",N_("Compression ratio"),&fHslider25, 2.0, 1.0, 100.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbc.Ratio3","","S",N_("Compression ratio"),&fHslider19, 2.0, 1.0, 100.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbc.Ratio4","","S",N_("Compression ratio"),&fHslider13, 2.0, 1.0, 100.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbc.Ratio5","","S",N_("Compression ratio"),&fHslider7, 2.0, 1.0, 100.0, 0.10000000000000001, 0);
	reg.registerFloatVar("mbc.Attack1","","S",N_("Time before the compressor starts to kick in"),&fHslider32, 0.012, 0.001, 1.0, 0.001, 0);
	reg.registerFloatVar("mbc.Attack2","","S",N_("Time before the compressor starts to kick in"),&fHslider26, 0.012, 0.001, 1.0, 0.001, 0);
	reg.registerFloatVar("mbc.Attack3","","S",N_("Time before the compressor starts to kick in"),&fHslider20, 0.012, 0.001, 1.0, 0.001, 0);
	reg.registerFloatVar("mbc.Attack4","","S",N_("Time before the compressor starts to kick in"),&fHslider14, 0.012, 0.001, 1.0, 0.001, 0);
	reg.registerFloatVar("mbc.Attack5","","S",N_("Time before the compressor starts to kick in"),&fHslider8, 0.012, 0.001, 1.0, 0.001, 0);
