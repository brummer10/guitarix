...
public:
    ...
    virtual void buildUserInterface(UI* interface)
    {
        ...
        interface->addNumEntry("knee", &fentrycom1, 3.000000f, 0.000000f, 20.000000f, 0.100000f);
        interface->addNumEntry("ratio", &fentrycom2, 2.000000f, 1.000000f, 20.000000f, 0.100000f);
        interface->addNumEntry("threshold", &fentrycom0, -20.000000f, -96.000000f, 10.000000f, 0.100000f);
        interface->closeBox();
        interface->openVerticalBox("envelop");
        interface->addHorizontalSlider("attack", &fslidercom0, 2.000000e-03f, 0.000000f, 1.000000f, 1.000000e-03f);
        interface->addHorizontalSlider("release", &fslidercom1, 0.500000f, 0.000000f, 10.000000f, 1.000000e-02f);
        interface->closeBox();
        interface->closeBox();
        interface->closeBox();
        interface->closeBox();
